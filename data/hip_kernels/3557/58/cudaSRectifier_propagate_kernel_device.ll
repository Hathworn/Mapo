; ModuleID = '../data/hip_kernels/3557/58/main.cu'
source_filename = "../data/hip_kernels/3557/58/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z31cudaSRectifier_propagate_kernelPfS_jff(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2, float %3, float %4) local_unnamed_addr #0 {
...
34:                                               ; preds = %28
  %35 = tail call float @llvm.minnum.f32(float %32, float %4)
  %36 = fmul contract float %32, %3
  %37 = select contract i1 %33, float %35, float %36
  br label %41

38:                                               ; preds = %28
  %39 = select contract i1 %33, float 1.000000e+00, float %3
  %40 = fmul contract float %32, %39
  br label %41

; ModuleID = '../data/hip_kernels/3557/82/main.cu'
source_filename = "../data/hip_kernels/3557/82/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z20cudaSquantize_kernelPfS_jffjb(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2, float %3, float %4, i32 %5, i1 %6) local_unnamed_addr #0 {
...
35:                                               ; preds = %29, %35
  ...
  %40 = fcmp contract olt float %39, %3
  %41 = fcmp contract ogt float %39, %4
  %42 = select contract i1 %41, float %4, float %39
  %43 = select contract i1 %40, float %3, float %42
  %44 = fsub contract float %43, %3
  %45 = fdiv contract float %44, %33
  %46 = tail call float @llvm.round.f32(float %45)
  %47 = select i1 %6, float %45, float %46
  %48 = fptosi float %47 to i32
  %49 = sitofp i32 %48 to float
  %50 = fmul contract float %33, %49
  %51 = fadd contract float %50, %3
  %52 = getelementptr inbounds float, float addrspace(1)* %1, i64 %37
...
55:                                               ; preds = %27, %55
  ...
  %60 = fcmp contract oge float %59, 0.000000e+00
  %61 = select contract i1 %60, float 1.000000e+00, float -1.000000e+00

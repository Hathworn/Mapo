...
352:                                              ; preds = %283, %352
  %353 = phi i32 [ %359, %352 ], [ %109, %283 ]
  %354 = phi i32 [ %358, %352 ], [ %284, %283 ]
  %355 = sext i32 %353 to i64
  %356 = getelementptr inbounds i32, i32 addrspace(1)* %15, i64 %355
  %357 = load i32, i32 addrspace(1)* %356, align 4, !tbaa !7
  %358 = add i32 %357, %354
  %359 = add nuw nsw i32 %353, 1
  %360 = icmp ult i32 %359, %5
  br i1 %360, label %352, label %332, !llvm.loop !18

361:                                              ; preds = %338, %361
  %362 = phi i32 [ 0, %338 ], [ %417, %361 ]
  %363 = shl i32 %362, 1
  %364 = add i32 %341, %363
  %365 = add i32 %363, %344
  %366 = zext i32 %364 to i64
  %367 = getelementptr inbounds float, float addrspace(1)* %20, i64 %366
  %368 = load float, float addrspace(1)* %367, align 4, !tbaa !11
  %369 = or i32 %364, 1
  %370 = zext i32 %369 to i64
  %371 = getelementptr inbounds float, float addrspace(1)* %20, i64 %370
  %372 = load float, float addrspace(1)* %371, align 4, !tbaa !11
  %373 = fpext float %368 to double
  %374 = fadd contract double %373, 5.000000e-01
  %375 = fmul contract double %374, %185
  %376 = fadd contract double %375, %345
  %377 = fdiv contract double %376, %101
  %378 = fptrunc double %377 to float
  %379 = zext i32 %365 to i64
  %380 = getelementptr inbounds float, float addrspace(1)* %25, i64 %379
  store float %378, float addrspace(1)* %380, align 4, !tbaa !11
  %381 = fpext float %372 to double
  %382 = fadd contract double %381, 5.000000e-01
  %383 = fmul contract double %382, %161
  %384 = fadd contract double %383, %346
  %385 = fdiv contract double %384, %100
  %386 = fptrunc double %385 to float
  %387 = or i32 %365, 1
  %388 = zext i32 %387 to i64
  %389 = getelementptr inbounds float, float addrspace(1)* %25, i64 %388
  store float %386, float addrspace(1)* %389, align 4, !tbaa !11
  %390 = add i32 %348, %362
  ...
  %417 = add nuw i32 %362, 1
  %418 = icmp eq i32 %417, %336
  br i1 %418, label %419, label %361, !llvm.loop !19

419:                                              ; preds = %361, %332, %245

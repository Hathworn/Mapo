; ModuleID = '../data/hip_kernels/3557/88/main.cu'
source_filename = "../data/hip_kernels/3557/88/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z15cudaSpow_kerneljfPKfPf(i32 %0, float %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture writeonly %3) local_unnamed_addr #0 {
...
44:                                               ; preds = %24, %44
  ...
  %212 = getelementptr inbounds float, float addrspace(1)* %3, i64 %46
  store float %211, float addrspace(1)* %212, align 4, !tbaa !16
  %213 = add i32 %45, %22
  %214 = icmp ult i32 %213, %0
...
215:                                              ; preds = %24, %215
  ...
  %241 = getelementptr inbounds float, float addrspace(1)* %3, i64 %217
  store float %240, float addrspace(1)* %241, align 4, !tbaa !16
  %242 = add i32 %216, %22
  %243 = icmp ult i32 %242, %0

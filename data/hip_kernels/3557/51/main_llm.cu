...
#include "cudaSReduceIndex_kernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
cudaSReduceIndex_kernel<<<gridBlock, threadBlock>>>(inputSize,inputBatchOffset,outputBatchOffset,valueThreshold,inputs,outputMap,scores);

; ModuleID = '../data/hip_kernels/3557/12/main.cu'
source_filename = "../data/hip_kernels/3557/12/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [30 x i8] c"keys[%d]=%d indicesX[%d]:%d  \00", align 1
...
define protected amdgpu_kernel void @_Z21cudaSgatherI2I_kernelPKiS0_S0_S0_PiS1_S1_j(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture readonly %2, i32 addrspace(1)* nocapture readonly %3, i32 addrspace(1)* nocapture writeonly %4, i32 addrspace(1)* nocapture writeonly %5, i32 addrspace(1)* nocapture writeonly %6, i32 %7) local_unnamed_addr #1 {
...
20:                                               ; preds = %8
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([30 x i8], [30 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %34, label %38
...
479:                                              ; preds = %468, %34
  ...
  %492 = and i64 %491, -225
  %493 = or i64 %492, 32
  %494 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %493, i64 noundef %482, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %495 = extractelement <2 x i64> %494, i64 0
  %496 = zext i32 %25 to i64
  %497 = and i64 %495, -227
  %498 = or i64 %497, 34
  %499 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %498, i64 noundef %496, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %500 = sext i32 %23 to i64
  %501 = getelementptr inbounds i32, i32 addrspace(1)* %1, i64 %500
  %502 = load i32, i32 addrspace(1)* %501, align 4, !tbaa !7
  %503 = getelementptr inbounds i32, i32 addrspace(1)* %4, i64 %21
  store i32 %502, i32 addrspace(1)* %503, align 4, !tbaa !7
  %504 = getelementptr inbounds i32, i32 addrspace(1)* %2, i64 %500
  %505 = load i32, i32 addrspace(1)* %504, align 4, !tbaa !7
  %506 = getelementptr inbounds i32, i32 addrspace(1)* %5, i64 %21
  store i32 %505, i32 addrspace(1)* %506, align 4, !tbaa !7
  %507 = getelementptr inbounds i32, i32 addrspace(1)* %3, i64 %500
  %508 = load i32, i32 addrspace(1)* %507, align 4, !tbaa !7
  %509 = getelementptr inbounds i32, i32 addrspace(1)* %6, i64 %21

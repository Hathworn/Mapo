; ModuleID = '../data/hip_kernels/741/1/main.cu'
source_filename = "../data/hip_kernels/741/1/main.cu"
...
define protected amdgpu_kernel void @_Z16atomicInc_kerneljjPfPjS0_(i32 %0, i32 %1, float addrspace(1)* nocapture readnone %2, i32 addrspace(1)* nocapture %3, i32 addrspace(1)* nocapture %4) local_unnamed_addr #1 {
...
493:                                              ; preds = %486, %968
  ...
  %495 = tail call i32 @llvm.amdgcn.atomic.inc.i32.p1i32(i32 addrspace(1)* %488, i32 10, i32 2, i32 4, i1 false)
...
declare i32 @llvm.amdgcn.atomic.inc.i32.p1i32(i32 addrspace(1)* nocapture, i32, i32 immarg, i32 immarg, i1 immarg) #10

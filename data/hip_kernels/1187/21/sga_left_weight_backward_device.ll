; ModuleID = '../data/hip_kernels/1187/21/main.cu'
source_filename = "../data/hip_kernels/1187/21/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z24sga_left_weight_backwardiPKfS0_S0_iiiiPf(i32 %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, i32 %4, i32 %5, i32 %6, i32 %7, float addrspace(1)* nocapture %8) local_unnamed_addr #0 {
...
491:                                              ; preds = %468, %472, %328, %59
  ...
  br i1 %494, label %630, label %495

495:                                              ; preds = %491
  %496 = shl nsw i32 %22, 1
  %497 = add nsw i32 %28, %496
  %498 = sext i32 %497 to i64
  %499 = getelementptr inbounds float, float addrspace(1)* %8, i64 %498
  %500 = load float, float addrspace(1)* %499, align 4, !tbaa !7
  %501 = add i32 %6, -1
  %502 = and i32 %6, 7
  %503 = icmp ult i32 %501, 7
  br i1 %503, label %608, label %504
...
506:                                              ; preds = %506, %504
  %507 = phi float [ %500, %504 ], [ %604, %506 ]
  %508 = phi i32 [ 0, %504 ], [ %605, %506 ]
  %509 = phi i32 [ 0, %504 ], [ %606, %506 ]
  %510 = mul nsw i32 %508, %22
  %511 = add nsw i32 %510, %26
  %512 = sext i32 %511 to i64
  %513 = getelementptr inbounds float, float addrspace(1)* %3, i64 %512
  %514 = load float, float addrspace(1)* %513, align 4, !tbaa !7
  %515 = add nsw i32 %511, 2
  %516 = sext i32 %515 to i64
  %517 = getelementptr inbounds float, float addrspace(1)* %2, i64 %516
  %518 = load float, float addrspace(1)* %517, align 4, !tbaa !7
  %519 = fmul contract float %514, %518
  %520 = fadd contract float %507, %519
  store float %520, float addrspace(1)* %499, align 4, !tbaa !7
  %521 = or i32 %508, 1
  %522 = mul nsw i32 %521, %22
  %523 = add nsw i32 %522, %26
  %524 = sext i32 %523 to i64
  %525 = getelementptr inbounds float, float addrspace(1)* %3, i64 %524
  ...
  store float %532, float addrspace(1)* %499, align 4, !tbaa !7
  %533 = or i32 %508, 2
  %534 = mul nsw i32 %533, %22
  %535 = add nsw i32 %534, %26
  %536 = sext i32 %535 to i64
  %537 = getelementptr inbounds float, float addrspace(1)* %3, i64 %536
  %538 = load float, float addrspace(1)* %537, align 4, !tbaa !7
  %539 = add nsw i32 %535, 2
  %540 = sext i32 %539 to i64
  %541 = getelementptr inbounds float, float addrspace(1)* %2, i64 %540
  %542 = load float, float addrspace(1)* %541, align 4, !tbaa !7
  %543 = fmul contract float %538, %542
  %544 = fadd contract float %532, %543
  store float %544, float addrspace(1)* %499, align 4, !tbaa !7
  %545 = or i32 %508, 3
  %546 = mul nsw i32 %545, %22
  %547 = add nsw i32 %546, %26
  %548 = sext i32 %547 to i64
  %549 = getelementptr inbounds float, float addrspace(1)* %3, i64 %548
  %550 = load float, float addrspace(1)* %549, align 4, !tbaa !7
  %551 = add nsw i32 %547, 2
  %552 = sext i32 %551 to i64
  %553 = getelementptr inbounds float, float addrspace(1)* %2, i64 %552
  %554 = load float, float addrspace(1)* %553, align 4, !tbaa !7
  %555 = fmul contract float %550, %554
  %556 = fadd contract float %544, %555
  store float %556, float addrspace(1)* %499, align 4, !tbaa !7
  %557 = or i32 %508, 4
  %558 = mul nsw i32 %557, %22
  %559 = add nsw i32 %558, %26
  %560 = sext i32 %559 to i64
  %561 = getelementptr inbounds float, float addrspace(1)* %3, i64 %560
  %562 = load float, float addrspace(1)* %561, align 4, !tbaa !7
  %563 = add nsw i32 %559, 2
  ...
  store float %568, float addrspace(1)* %499, align 4, !tbaa !7
  %569 = or i32 %508, 5
  %570 = mul nsw i32 %569, %22
  %571 = add nsw i32 %570, %26
  %572 = sext i32 %571 to i64
  %573 = getelementptr inbounds float, float addrspace(1)* %3, i64 %572
  %574 = load float, float addrspace(1)* %573, align 4, !tbaa !7
  %575 = add nsw i32 %571, 2
  %576 = sext i32 %575 to i64
  %577 = getelementptr inbounds float, float addrspace(1)* %2, i64 %576
  %578 = load float, float addrspace(1)* %577, align 4, !tbaa !7
  %579 = fmul contract float %574, %578
  %580 = fadd contract float %568, %579
  store float %580, float addrspace(1)* %499, align 4, !tbaa !7
  %581 = or i32 %508, 6
  %582 = mul nsw i32 %581, %22
  %583 = add nsw i32 %582, %26
  %584 = sext i32 %583 to i64
  %585 = getelementptr inbounds float, float addrspace(1)* %3, i64 %584
  ...
  store float %592, float addrspace(1)* %499, align 4, !tbaa !7
  %593 = or i32 %508, 7
  %594 = mul nsw i32 %593, %22
  %595 = add nsw i32 %594, %26
  %596 = sext i32 %595 to i64
  %597 = getelementptr inbounds float, float addrspace(1)* %3, i64 %596
  %598 = load float, float addrspace(1)* %597, align 4, !tbaa !7
  %599 = add nsw i32 %595, 2
  %600 = sext i32 %599 to i64
  %601 = getelementptr inbounds float, float addrspace(1)* %2, i64 %600
  %602 = load float, float addrspace(1)* %601, align 4, !tbaa !7
  %603 = fmul contract float %598, %602
  %604 = fadd contract float %592, %603
  store float %604, float addrspace(1)* %499, align 4, !tbaa !7
  %605 = add nuw nsw i32 %508, 8
  %606 = add i32 %509, 8
  %607 = icmp eq i32 %606, %505
  br i1 %607, label %608, label %506, !llvm.loop !21

608:                                              ; preds = %506, %495
  %609 = phi float [ %500, %495 ], [ %604, %506 ]
  %610 = phi i32 [ 0, %495 ], [ %605, %506 ]
  %611 = icmp eq i32 %502, 0
  br i1 %611, label %630, label %612

612:                                              ; preds = %608, %612
  %613 = phi float [ %626, %612 ], [ %609, %608 ]
  %614 = phi i32 [ %627, %612 ], [ %610, %608 ]
  %615 = phi i32 [ %628, %612 ], [ 0, %608 ]
  %616 = mul nsw i32 %614, %22
  %617 = add nsw i32 %616, %26
  %618 = sext i32 %617 to i64
  %619 = getelementptr inbounds float, float addrspace(1)* %3, i64 %618
  ...
  store float %626, float addrspace(1)* %499, align 4, !tbaa !7
  %627 = add nuw nsw i32 %614, 1
  %628 = add i32 %615, 1
  %629 = icmp eq i32 %628, %502
  br i1 %629, label %630, label %612, !llvm.loop !22

630:                                              ; preds = %608, %612, %491, %9
  ret void
}

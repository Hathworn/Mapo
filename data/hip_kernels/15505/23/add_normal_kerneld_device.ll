; ModuleID = '../data/hip_kernels/15505/23/main.cu'
source_filename = "../data/hip_kernels/15505/23/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z18add_normal_kerneldiPdidd(i32 %0, double addrspace(1)* nocapture %1, i32 %2, double %3, double %4) local_unnamed_addr #0 {
...
245:                                              ; preds = %34, %37
  ...
  %258 = load double, double addrspace(1)* %257, align 8, !tbaa !5
  %259 = fadd contract double %258, %256
  store double %259, double addrspace(1)* %257, align 8, !tbaa !5
  %260 = add nuw i64 %24, 1
  %261 = icmp eq i64 %260, %22
  br i1 %261, label %262, label %23, !llvm.loop !9

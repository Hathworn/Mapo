; ModuleID = '../data/hip_kernels/15505/40/main.cu'
source_filename = "../data/hip_kernels/15505/40/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z11pow_kerneldPdid(double addrspace(1)* nocapture %0, i32 %1, double %2) local_unnamed_addr #0 {
...
14:                                               ; preds = %3
  ...
  %137 = fmul double %134, %2
  %138 = fneg double %137
  %139 = tail call double @llvm.fma.f64(double %2, double %134, double %138)
  %140 = tail call double @llvm.fma.f64(double %2, double %136, double %139)
  ...
  %176 = tail call double @llvm.fabs.f64(double %2)
  %177 = tail call double @llvm.trunc.f64(double %176)
  ...
  %189 = fcmp olt double %17, 0.000000e+00
  %190 = and i1 %188, %189
  %191 = select i1 %190, double -0.000000e+00, double 0.000000e+00
  %192 = tail call double @llvm.copysign.f64(double %175, double %191)
  %193 = fcmp uge double %17, 0.000000e+00
  %194 = icmp ne i32 %187, 0
  %195 = select i1 %193, i1 true, i1 %194
  %196 = select i1 %195, double %192, double 0x7FF8000000000000
  %197 = fcmp oeq double %176, 0x7FF0000000000000
  %198 = fcmp oeq double %18, 1.000000e+00
  %199 = fadd double %18, -1.000000e+00
  %200 = bitcast double %2 to <2 x i32>
  %201 = extractelement <2 x i32> %200, i64 1
  %202 = bitcast double %199 to <2 x i32>
  %203 = extractelement <2 x i32> %202, i64 1
  %204 = xor i32 %203, %201
  %205 = icmp sgt i32 %204, -1
  %206 = select i1 %205, double 0x7FF0000000000000, double 0.000000e+00
  %207 = select i1 %198, double %18, double %206
  %208 = select i1 %197, double %207, double %196
  %209 = fcmp oeq double %18, 0x7FF0000000000000
  %210 = fcmp oeq double %17, 0.000000e+00
  %211 = or i1 %210, %209
  %212 = fcmp olt double %2, 0.000000e+00
  %213 = xor i1 %212, %210
  %214 = select i1 %213, double 0.000000e+00, double 0x7FF0000000000000
  %215 = select i1 %188, double %17, double 0.000000e+00
  %216 = tail call double @llvm.copysign.f64(double %214, double %215)
  %217 = select i1 %211, double %216, double %208
  %218 = fcmp uno double %17, %2
  %219 = select i1 %218, double 0x7FF8000000000000, double %217
  %220 = fcmp oeq double %17, 1.000000e+00
  %221 = fcmp oeq double %2, 0.000000e+00
  %222 = or i1 %221, %220
  %223 = select i1 %222, double 1.000000e+00, double %219
  store double %223, double addrspace(1)* %16, align 8, !tbaa !7
  br label %224

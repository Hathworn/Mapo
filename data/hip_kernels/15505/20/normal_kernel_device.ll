; ModuleID = '../data/hip_kernels/15505/20/main.cu'
source_filename = "../data/hip_kernels/15505/20/main.cu"
...
define protected amdgpu_kernel void @_Z13normal_kerneliPfiff(i32 %0, float addrspace(1)* nocapture writeonly %1, i32 %2, float %3, float %4) local_unnamed_addr #0 {
...
98:                                               ; preds = %23, %34
  ...
  br i1 %112, label %113, label %23, !llvm.loop !9

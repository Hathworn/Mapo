; ModuleID = '../data/hip_kernels/8660/5/main.cu'
source_filename = "../data/hip_kernels/8660/5/main.cu"
...
33:                                               ; preds = %33, %31
  %34 = phi float [ 0.000000e+00, %31 ], [ %131, %33 ]
  %35 = phi i32 [ 0, %31 ], [ %132, %33 ]
  %36 = phi i32 [ 0, %31 ], [ %133, %33 ]
  %37 = add nsw i32 %35, %27
...
135:                                              ; preds = %33, %28
  ...
  %137 = phi float [ 0.000000e+00, %28 ], [ %131, %33 ]
  %138 = phi i32 [ 0, %28 ], [ %132, %33 ]
  %139 = icmp eq i32 %29, 0
  br i1 %139, label %158, label %140

140:                                              ; preds = %135, %140
  %141 = phi float [ %154, %140 ], [ %137, %135 ]
  %142 = phi i32 [ %155, %140 ], [ %138, %135 ]
  %143 = phi i32 [ %156, %140 ], [ 0, %135 ]
  %144 = add nsw i32 %142, %27
...
158:                                              ; preds = %135, %140, %25
  %159 = phi float [ 0.000000e+00, %25 ], [ %136, %135 ], [ %154, %140 ]

...
#include "updateGradInputVarScaleKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
updateGradInputVarScaleKernel<<<gridBlock, threadBlock>>>(gradOutputIntData,gradInputData,h,w,nWindows,xMin,xMax,yMin,yMax);

...
#include "yMinDeltaIntegralReplicateKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
yMinDeltaIntegralReplicateKernel<<<gridBlock, threadBlock>>>(intData,tmpArray,nWindows,h,w,xMin,xMax,yMin,strideH,strideW);

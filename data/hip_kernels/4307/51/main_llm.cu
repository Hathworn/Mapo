...
#include "xMaxDeltaIntegralFracKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
xMaxDeltaIntegralFracKernel<<<gridBlock, threadBlock>>>(intData,tmpArray,nWindows,h,w,xMax,yMin,yMax,inData,inDataStrideRow);

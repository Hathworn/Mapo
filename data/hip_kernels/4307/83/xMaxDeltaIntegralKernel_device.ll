; ModuleID = '../data/hip_kernels/4307/83/main.cu'
source_filename = "../data/hip_kernels/4307/83/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z23xMaxDeltaIntegralKernelPKfiPfiiiiiS0_S0_S0_(float addrspace(1)* nocapture readonly %0, i32 %1, float addrspace(1)* nocapture writeonly %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, float addrspace(1)* nocapture readonly %8, float addrspace(1)* nocapture readonly %9, float addrspace(1)* nocapture readonly %10) local_unnamed_addr #0 {
...
34:                                               ; preds = %11
  ...
  %47 = getelementptr inbounds float, float addrspace(1)* %9, i64 %46
  ...
  %52 = getelementptr inbounds float, float addrspace(1)* %8, i64 %46
  %53 = load float, float addrspace(1)* %52, align 4, !tbaa !5, !amdgpu.noclobber !9
  %54 = tail call float @llvm.floor.f32(float %53)
  %55 = fptosi float %54 to i32
  %56 = getelementptr inbounds float, float addrspace(1)* %10, i64 %46

...
#include "yMaxDeltaIntegralReplicateKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
yMaxDeltaIntegralReplicateKernel<<<gridBlock, threadBlock>>>(intData,tmpArray,nWindows,h,w,xMin,xMax,yMax,strideH,strideW);

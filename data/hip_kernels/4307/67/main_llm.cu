...
#include "yMaxDeltaIntegralReplicateFracKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
yMaxDeltaIntegralReplicateFracKernel<<<gridBlock, threadBlock>>>(intData,tmpArray,nWindows,h,w,xMin,xMax,yMax,inData,inDataStrideRow,strideH,strideW);

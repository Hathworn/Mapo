...
#include "yMaxDeltaIntegralFracKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
yMaxDeltaIntegralFracKernel<<<gridBlock, threadBlock>>>(intData,tmpArray,nWindows,h,w,xMin,xMax,yMax,inData,inDataStrideRow);

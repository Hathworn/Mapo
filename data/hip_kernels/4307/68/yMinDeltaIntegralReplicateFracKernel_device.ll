; ModuleID = '../data/hip_kernels/4307/68/main.cu'
source_filename = "../data/hip_kernels/4307/68/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z36yMinDeltaIntegralReplicateFracKernelPKfPfiiiS0_S0_S0_S0_iii(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture %1, i32 %2, i32 %3, i32 %4, float addrspace(1)* nocapture readonly %5, float addrspace(1)* nocapture readonly %6, float addrspace(1)* nocapture readonly %7, float addrspace(1)* nocapture readonly %8, i32 %9, i32 %10, i32 %11) local_unnamed_addr #0 {
  %13 = add nsw i32 %3, -1
  %14 = add i32 %13, %10
  %15 = sdiv i32 %14, %10
  %16 = add nsw i32 %4, -1
...
37:                                               ; preds = %12
  ...
  %52 = fsub contract float %51, %47
  %53 = fadd contract float %52, 1.000000e+00
  %54 = getelementptr inbounds float, float addrspace(1)* %7, i64 %45
  ...
  %65 = add i32 %40, %58
  %66 = add i32 %65, 1
  %67 = icmp ugt i32 %65, 2147483646
  %68 = add nsw i32 %39, %50
...
71:                                               ; preds = %37
  %72 = add i32 %38, %50
  %73 = tail call i32 @llvm.smin.i32(i32 %13, i32 %72)
  %74 = tail call i32 @llvm.smax.i32(i32 %73, i32 0)
  %75 = mul nsw i32 %74, %9
  %76 = tail call i32 @llvm.smin.i32(i32 %16, i32 %65)
...
82:                                               ; preds = %37, %71
  ...
  %86 = select i1 %67, i1 true, i1 %85
  br i1 %86, label %97, label %87

87:                                               ; preds = %82
  %88 = tail call i32 @llvm.smin.i32(i32 %13, i32 %84)
  %89 = tail call i32 @llvm.smax.i32(i32 %88, i32 0)
  %90 = mul nsw i32 %89, %9
  %91 = tail call i32 @llvm.smin.i32(i32 %16, i32 %65)
...
97:                                               ; preds = %82, %87
  ...
  %99 = icmp slt i32 %68, %3
  %100 = select contract i1 %99, float %53, float 1.000000e+00
  %101 = fmul contract float %100, %83
  %102 = fadd contract float %101, 0.000000e+00
  %103 = icmp slt i32 %84, 1
  %104 = select contract i1 %103, float 1.000000e+00, float %64
  %105 = fmul contract float %104, %98
  %106 = fadd contract float %102, %105
  %107 = tail call i32 @llvm.smin.i32(i32 %84, i32 %3)
  %108 = tail call i32 @llvm.smax.i32(i32 %107, i32 0)
  %109 = add nsw i32 %4, 1
  %110 = mul nsw i32 %108, %109
  %111 = tail call i32 @llvm.smin.i32(i32 %66, i32 %4)
  ...
  %125 = tail call i32 @llvm.smin.i32(i32 %68, i32 %3)
  ...
  %138 = icmp ult i32 %65, 2147483647
  %139 = icmp slt i32 %66, %4

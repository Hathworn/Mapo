...
#include "yMinDeltaIntegralReplicateFracKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
yMinDeltaIntegralReplicateFracKernel<<<gridBlock, threadBlock>>>(intData,tmpArray,nWindows,h,w,xMin,xMax,yMin,inData,inDataStrideRow,strideH,strideW);

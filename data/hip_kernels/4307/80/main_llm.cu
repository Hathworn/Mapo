...
#include "xMinDeltaIntegralFracKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
xMinDeltaIntegralFracKernel<<<gridBlock, threadBlock>>>(intData,intDataStrideChannel,tmpArray,batchSize,nInputPlane,nWindows,h,w,xMin,yMin,yMax,inData,inDataStrideRow,inDataStrideChannel);

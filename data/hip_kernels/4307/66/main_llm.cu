...
#include "xMinDeltaIntegralReplicateFracKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
xMinDeltaIntegralReplicateFracKernel<<<gridBlock, threadBlock>>>(intData,tmpArray,nWindows,h,w,xMin,yMin,yMax,inData,inDataStrideRow,strideH,strideW);

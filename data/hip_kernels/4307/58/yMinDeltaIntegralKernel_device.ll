; ModuleID = '../data/hip_kernels/4307/58/main.cu'
source_filename = "../data/hip_kernels/4307/58/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z23yMinDeltaIntegralKernelPKfPfiiiS0_S0_S0_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture %1, i32 %2, i32 %3, i32 %4, float addrspace(1)* nocapture readonly %5, float addrspace(1)* nocapture readonly %6, float addrspace(1)* nocapture readonly %7) local_unnamed_addr #0 {
...
28:                                               ; preds = %8
  ...
  %39 = getelementptr inbounds float, float addrspace(1)* %7, i64 %33
  ...
  %44 = getelementptr inbounds float, float addrspace(1)* %6, i64 %33
  ...
  %62 = add nsw i32 %4, -1
  %63 = tail call i32 @llvm.smin.i32(i32 %53, i32 %62)
  ...
  %78 = fsub contract float %69, %77
  %79 = add nsw i32 %73, %64
  ...
  %84 = icmp ult i32 %53, 2147483647
  %85 = icmp slt i32 %54, %4

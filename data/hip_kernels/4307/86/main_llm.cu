...
#include "yMinDeltaIntegralKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
yMinDeltaIntegralKernel<<<gridBlock, threadBlock>>>(intData,intDataStrideChannel,tmpArray,batchSize,nInputPlane,nWindows,h,w,xMin,xMax,yMin);

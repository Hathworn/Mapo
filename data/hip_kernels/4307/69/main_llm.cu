...
#include "xMaxDeltaIntegralReplicateKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
xMaxDeltaIntegralReplicateKernel<<<gridBlock, threadBlock>>>(intData,tmpArray,nWindows,h,w,xMax,yMin,yMax,strideH,strideW);

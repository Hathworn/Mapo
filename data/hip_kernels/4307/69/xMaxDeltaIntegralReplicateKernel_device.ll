; ModuleID = '../data/hip_kernels/4307/69/main.cu'
source_filename = "../data/hip_kernels/4307/69/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z32xMaxDeltaIntegralReplicateKernelPKfPfiiiS0_S0_S0_ii(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3, i32 %4, float addrspace(1)* nocapture readonly %5, float addrspace(1)* nocapture readonly %6, float addrspace(1)* nocapture readonly %7, i32 %8, i32 %9) local_unnamed_addr #0 {
  %11 = add nsw i32 %3, -1
  %12 = add i32 %11, %8
  %13 = sdiv i32 %12, %8
  %14 = add nsw i32 %4, -1
...
35:                                               ; preds = %10
  ...
  %50 = getelementptr inbounds float, float addrspace(1)* %5, i64 %44
  ...
  %72 = tail call i32 @llvm.smin.i32(i32 %58, i32 %3)
  ...
  %80 = add nsw i32 %39, %49
  %81 = tail call i32 @llvm.smin.i32(i32 %80, i32 %4)
  ...
  %93 = icmp sgt i32 %58, 0
  %94 = icmp slt i32 %58, %3

...
#include "xMaxDeltaIntegralReplicateFracKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
xMaxDeltaIntegralReplicateFracKernel<<<gridBlock, threadBlock>>>(intData,tmpArray,nWindows,h,w,xMax,yMin,yMax,inData,inDataStrideRow,strideH,strideW);

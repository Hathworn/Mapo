; ModuleID = '../data/hip_kernels/8661/2/main.cu'
source_filename = "../data/hip_kernels/8661/2/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [6 x i8] c"Hello\00", align 1
...
define protected amdgpu_kernel void @_Z11childKernelv() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([6 x i8], [6 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %9, label %13

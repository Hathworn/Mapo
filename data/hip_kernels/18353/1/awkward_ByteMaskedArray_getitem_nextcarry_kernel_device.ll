; ModuleID = '../data/hip_kernels/18353/1/main.cu'
source_filename = "../data/hip_kernels/18353/1/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z48awkward_ByteMaskedArray_getitem_nextcarry_kernelPlS_Pal(i64 addrspace(1)* nocapture readonly %0, i64 addrspace(1)* nocapture writeonly %1, i8 addrspace(1)* nocapture readonly %2, i64 %3) local_unnamed_addr #0 {
...
44:                                               ; preds = %4
  %45 = getelementptr inbounds i8, i8 addrspace(1)* %2, i64 %42
  %46 = load i8, i8 addrspace(1)* %45, align 1, !tbaa !17, !amdgpu.noclobber !14
  %47 = icmp eq i8 %46, 0
  br i1 %47, label %53, label %48

48:                                               ; preds = %44
  %49 = getelementptr inbounds i64, i64 addrspace(1)* %0, i64 %42
  %50 = load i64, i64 addrspace(1)* %49, align 8, !tbaa !20, !amdgpu.noclobber !14
  %51 = add nsw i64 %50, -1
  %52 = getelementptr inbounds i64, i64 addrspace(1)* %1, i64 %51
  store i64 %42, i64 addrspace(1)* %52, align 8, !tbaa !20
  br label %53

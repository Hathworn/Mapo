; ModuleID = '../data/hip_kernels/18353/4/main.cu'
source_filename = "../data/hip_kernels/18353/4/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z62awkward_ByteMaskedArray_getitem_nextcarry_outindex_filter_maskPabl(i8 addrspace(1)* nocapture %0, i1 %1, i64 %2) local_unnamed_addr #0 {
...
43:                                               ; preds = %3
  %44 = getelementptr inbounds i8, i8 addrspace(1)* %0, i64 %41
  %45 = load i8, i8 addrspace(1)* %44, align 1, !tbaa !17, !amdgpu.noclobber !14
  %46 = icmp eq i8 %45, 0
  %47 = xor i1 %46, %1
  br i1 %47, label %48, label %49

48:                                               ; preds = %43
  store i8 1, i8 addrspace(1)* %44, align 1, !tbaa !17
  br label %49

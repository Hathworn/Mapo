; ModuleID = '../data/hip_kernels/15692/4/main.cu'
source_filename = "../data/hip_kernels/15692/4/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn writeonly
define protected amdgpu_kernel void @_Z6kernelPhi(i8 addrspace(1)* nocapture writeonly %0, i32 %1) local_unnamed_addr #0 {
  ...
  %22 = add i32 %21, %15
  %23 = udiv i32 %12, %9
  %24 = add nsw i32 %14, -500
  %25 = sitofp i32 %24 to float
  %26 = add nsw i32 %22, -500
...
171:                                              ; preds = %58, %65
  ...
  %206 = shl nsw i32 %180, 2
  %207 = sext i32 %206 to i64
  %208 = getelementptr inbounds i8, i8 addrspace(1)* %0, i64 %207
  store i8 %205, i8 addrspace(1)* %208, align 1, !tbaa !17
  %209 = add nuw nsw i32 %206, 1
  %210 = sext i32 %209 to i64
  %211 = getelementptr inbounds i8, i8 addrspace(1)* %0, i64 %210
  store i8 %205, i8 addrspace(1)* %211, align 1, !tbaa !17
  %212 = add nuw nsw i32 %206, 2
  %213 = sext i32 %212 to i64
  %214 = getelementptr inbounds i8, i8 addrspace(1)* %0, i64 %213
  store i8 %205, i8 addrspace(1)* %214, align 1, !tbaa !17
  %215 = add nuw nsw i32 %206, 3
  %216 = sext i32 %215 to i64
  %217 = getelementptr inbounds i8, i8 addrspace(1)* %0, i64 %216
  store i8 -1, i8 addrspace(1)* %217, align 1, !tbaa !17
  ret void
}

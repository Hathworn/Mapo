; ModuleID = '../data/hip_kernels/4844/37/main.cu'
source_filename = "../data/hip_kernels/4844/37/main.cu"
...
define protected amdgpu_kernel void @_Z9KerResetyjjP15HIP_vector_typeIfLj3EE(i32 %0, i32 %1, %struct.HIP_vector_type addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
...
14:                                               ; preds = %3
  ...
  %17 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %2, i64 %16, i32 0, i32 0, i32 0, i32 0, i64 1

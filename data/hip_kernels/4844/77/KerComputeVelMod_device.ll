; ModuleID = '../data/hip_kernels/4844/77/main.cu'
source_filename = "../data/hip_kernels/4844/77/main.cu"
...
define protected amdgpu_kernel void @_Z16KerComputeVelModjPK15HIP_vector_typeIfLj4EEPf(i32 %0, %struct.HIP_vector_type addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {

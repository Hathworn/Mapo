; ModuleID = '../data/hip_kernels/17567/0/main.cu'
source_filename = "../data/hip_kernels/17567/0/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [24 x i8] c"Hello, World from GPU!\0A\00", align 1
...
define protected amdgpu_kernel void @_Z12helloFromGPUv() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([24 x i8], [24 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %9, label %13

; ModuleID = '../data/hip_kernels/12708/0/main.cu'
source_filename = "../data/hip_kernels/12708/0/main.cu"
...
define protected amdgpu_kernel void @_Z4initPii(i32 addrspace(1)* nocapture writeonly %0, i32 %1) local_unnamed_addr #0 {
...
10:                                               ; preds = %2, %10
  %11 = phi i32 [ %14, %10 ], [ %6, %2 ]
  %12 = sext i32 %11 to i64
  %13 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %12
  store i32 2147483647, i32 addrspace(1)* %13, align 4, !tbaa !5

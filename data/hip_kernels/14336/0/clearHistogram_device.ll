; ModuleID = '../data/hip_kernels/14336/0/main.cu'
source_filename = "../data/hip_kernels/14336/0/main.cu"
...
define protected amdgpu_kernel void @_Z14clearHistogramPjj(i32 addrspace(1)* nocapture writeonly %0, i32 %1) local_unnamed_addr #0 {

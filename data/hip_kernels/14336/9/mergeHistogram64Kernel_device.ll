; ModuleID = '../data/hip_kernels/14336/9/main.cu'
source_filename = "../data/hip_kernels/14336/9/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ22mergeHistogram64KernelPjS_jE4data = internal unnamed_addr addrspace(3) global [128 x i32] undef, align 16
...
8:                                                ; preds = %12, %3
  %9 = phi i32 [ 0, %3 ], [ %20, %12 ]
  %10 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %4
...
23:                                               ; preds = %8
  ...
  %25 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %24
...
31:                                               ; preds = %29
  ...
  %33 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %32
...
39:                                               ; preds = %37
  ...
  %41 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %40
...
47:                                               ; preds = %45
  ...
  %49 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %48
...
55:                                               ; preds = %53
  ...
  %57 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %56
...
63:                                               ; preds = %61
  ...
  %65 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %64
...
71:                                               ; preds = %69
  ...
  %73 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %72
  ...
  %77 = load i32, i32 addrspace(3)* getelementptr inbounds ([128 x i32], [128 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 0), align 16, !tbaa !5

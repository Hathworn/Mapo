; ModuleID = '../data/hip_kernels/8588/5/main.cu'
source_filename = "../data/hip_kernels/8588/5/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z19totalWithThreadSyncPfS_i(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
17:                                               ; preds = %35, %3
  %18 = icmp eq i32 %4, 0
  br i1 %18, label %37, label %43

19:                                               ; preds = %14, %35
  %20 = phi i32 [ %10, %14 ], [ %21, %35 ]
  %21 = lshr i32 %20, 1
...
30:                                               ; preds = %23, %26
  %31 = phi float [ %29, %26 ], [ 0.000000e+00, %23 ]
  %32 = phi float addrspace(1)* [ %28, %26 ], [ %16, %23 ]
...
35:                                               ; preds = %30, %19
  ...
  br i1 %36, label %17, label %19, !llvm.loop !11

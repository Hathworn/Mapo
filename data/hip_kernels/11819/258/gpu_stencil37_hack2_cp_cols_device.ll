; ModuleID = '../data/hip_kernels/11819/258/main.cu'
source_filename = "../data/hip_kernels/11819/258/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z27gpu_stencil37_hack2_cp_colsPdS_S_S_iiiiiiiiiiii(double addrspace(1)* nocapture readonly %0, double addrspace(1)* nocapture readnone %1, double addrspace(1)* nocapture writeonly %2, double addrspace(1)* nocapture readnone %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 %10, i32 %11, i32 %12, i32 %13, i32 %14, i32 %15) local_unnamed_addr #0 {
  ...
  %27 = mul i32 %26, %13
  %28 = getelementptr inbounds i8, i8 addrspace(4)* %19, i64 12
  %29 = bitcast i8 addrspace(4)* %28 to i32 addrspace(4)*
  %30 = load i32, i32 addrspace(4)* %29, align 4, !tbaa !6
  %31 = getelementptr i8, i8 addrspace(4)* %19, i64 4

...
#include "SigmoidProbPolynomProbsImpl_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
SigmoidProbPolynomProbsImpl<<<gridBlock, threadBlock>>>(features,batchSize,splits,conditions,polynomOffsets,polynomCount,lambda,probs);

; ModuleID = '../data/hip_kernels/13945/8/main.cu'
source_filename = "../data/hip_kernels/13945/8/main.cu"
...
define protected amdgpu_kernel void @_Z22transposeCoarseGrainedPfS_ii(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3) local_unnamed_addr #0 {
  ...
  %19 = getelementptr inbounds [16 x [17 x float]], [16 x [17 x float]] addrspace(3)* @_ZZ22transposeCoarseGrainedPfS_iiE5block, i32 0, i32 %10, i32 %7

; ModuleID = '../data/hip_kernels/2532/8/main.cu'
source_filename = "../data/hip_kernels/2532/8/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z8updF_SoAPfS_S_S_ffii(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, float %4, float %5, i32 %6, i32 %7) local_unnamed_addr #0 {
...
66:                                               ; preds = %60, %57
  ...
  %71 = fmul contract float %67, %4
  %72 = fadd contract float %70, %71
  %73 = fmul contract float %4, %5
  %74 = getelementptr inbounds float, float addrspace(1)* %3, i64 %68
  ...
  %78 = fadd contract float %73, 1.000000e+00
  %79 = fdiv contract float %77, %78
  store float %79, float addrspace(1)* %69, align 4, !tbaa !7
  br label %80

; ModuleID = '../data/hip_kernels/2532/9/main.cu'
source_filename = "../data/hip_kernels/2532/9/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z8updZ_SoAPfS_S_ffii(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture %1, float addrspace(1)* nocapture readonly %2, float %3, float %4, i32 %5, i32 %6) local_unnamed_addr #0 {
...
52:                                               ; preds = %46, %42
  ...
  %88 = fdiv contract float 1.000000e+00, %86
  %89 = select i1 %87, float 1.000000e+00, float %88
  %90 = fmul contract float %57, %89
  store float %90, float addrspace(1)* %54, align 4, !tbaa !7
  %91 = fmul contract float %61, %89
  store float %91, float addrspace(1)* %58, align 4, !tbaa !7
  br label %92

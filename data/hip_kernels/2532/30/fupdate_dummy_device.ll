; ModuleID = '../data/hip_kernels/2532/30/main.cu'
source_filename = "../data/hip_kernels/2532/30/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z13fupdate_dummyPfS_S_S_fii(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, float %4, i32 %5, i32 %6) local_unnamed_addr #0 {
...
40:                                               ; preds = %36, %28
  %41 = phi float [ 0.000000e+00, %28 ], [ %39, %36 ]
  %42 = add nsw i32 %6, -1
  %43 = icmp eq i32 %24, %42
  %44 = select i1 %43, float -0.000000e+00, float %33
  %45 = fadd contract float %44, %41
  %46 = getelementptr inbounds float, float addrspace(1)* %3, i64 %31
  %47 = load float, float addrspace(1)* %46, align 4, !tbaa !7, !amdgpu.noclobber !5
  %48 = fmul contract float %47, %4
  %49 = fsub contract float %45, %48
  %50 = getelementptr inbounds float, float addrspace(1)* %0, i64 %31

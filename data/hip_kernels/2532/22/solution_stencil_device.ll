; ModuleID = '../data/hip_kernels/2532/22/main.cu'
source_filename = "../data/hip_kernels/2532/22/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z16solution_stencilPfS_S_fii(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture %2, float %3, i32 %4, i32 %5) local_unnamed_addr #0 {
...
37:                                               ; preds = %32, %29
  %38 = phi float [ %36, %32 ], [ 0.000000e+00, %29 ]
...
40:                                               ; preds = %37
  ...
  %45 = fsub contract float %38, %44
  br label %46

46:                                               ; preds = %40, %37
  %47 = phi float [ %45, %40 ], [ %38, %37 ]
  %48 = add nsw i32 %5, -1
...
50:                                               ; preds = %46
  ...
  %54 = fadd contract float %47, %53
  br label %55

55:                                               ; preds = %50, %46
  %56 = phi float [ %54, %50 ], [ %47, %46 ]
...
64:                                               ; preds = %58, %55
  ...
  %69 = fmul contract float %65, %3
  %70 = fsub contract float %68, %69
  store float %70, float addrspace(1)* %67, align 4, !tbaa !7
  br label %71

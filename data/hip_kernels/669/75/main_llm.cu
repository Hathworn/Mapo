...
#include "findCentroidsAtomicFreeLocal_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
findCentroidsAtomicFreeLocal<<<gridBlock, threadBlock>>>(afLocal,responses,nPixels,cluster,centroidMass,centroidCount);

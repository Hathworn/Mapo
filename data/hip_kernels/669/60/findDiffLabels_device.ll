; ModuleID = '../data/hip_kernels/669/60/main.cu'
source_filename = "../data/hip_kernels/669/60/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ14findDiffLabelsPfiiiPiS0_E12localChanges = internal addrspace(3) global i32 undef, align 4

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z14findDiffLabelsPfiiiPiS0_(float addrspace(1)* nocapture readonly %0, i32 %1, i32 %2, i32 %3, i32 addrspace(1)* nocapture %4, i32 addrspace(1)* nocapture %5) local_unnamed_addr #0 {
...
24:                                               ; preds = %53, %19
  ...
  %28 = phi i32 [ 0, %19 ], [ %122, %53 ]
  %29 = phi i32 [ -1, %19 ], [ %119, %53 ]
  %30 = icmp eq i32 %20, 0
...
47:                                               ; preds = %24, %31, %17
  ...
  br i1 %52, label %127, label %125

53:                                               ; preds = %53, %22
  %54 = phi i32 [ %15, %22 ], [ %121, %53 ]
  %55 = phi float [ 1.000000e+07, %22 ], [ %120, %53 ]
  %56 = phi i32 [ 0, %22 ], [ %122, %53 ]
  %57 = phi i32 [ -1, %22 ], [ %119, %53 ]
  ...
  %122 = add nuw nsw i32 %56, 8
  %123 = add i32 %58, 8
  %124 = icmp eq i32 %123, %23
  br i1 %124, label %24, label %53, !llvm.loop !15

125:                                              ; preds = %47
  %126 = tail call i32 @llvm.amdgcn.atomic.inc.i32.p3i32(i32 addrspace(3)* @_ZZ14findDiffLabelsPfiiiPiS0_E12localChanges, i32 10000000, i32 2, i32 4, i1 false)
  br label %127
...
127:                                              ; preds = %47, %125, %6
  ...
  %128 = icmp eq i32 %14, 0
  br i1 %128, label %129, label %132

129:                                              ; preds = %127
  %130 = load i32, i32 addrspace(3)* @_ZZ14findDiffLabelsPfiiiPiS0_E12localChanges, align 4, !tbaa !13
  %131 = atomicrmw add i32 addrspace(1)* %5, i32 %130 syncscope("agent-one-as") monotonic, align 4
  br label %132

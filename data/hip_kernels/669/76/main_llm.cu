...
#include "findCentroidsAtomicFreeReduce_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
findCentroidsAtomicFreeReduce<<<gridBlock, threadBlock>>>(afLocal,responses,nPixels,cluster,centroidMass,centroidCount);

; ModuleID = '../data/hip_kernels/1989/0/main.cu'
source_filename = "../data/hip_kernels/1989/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ16brent_kung_scan_PfS_iE2XY = internal unnamed_addr addrspace(3) global [2048 x float] undef, align 16
...
15:                                               ; preds = %3
  ...
  %19 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %5
...
23:                                               ; preds = %20
  ...
  %27 = add nuw nsw i32 %5, %10
  %28 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %27
  store float %26, float addrspace(3)* %28, align 4, !tbaa !7
  br label %29

29:                                               ; preds = %23, %20
  %30 = shl nuw nsw i32 %5, 1
...
40:                                               ; preds = %35
  %41 = sub i32 %38, %36
  %42 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %41
  %43 = load float, float addrspace(3)* %42, align 4, !tbaa !7
  %44 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %38
...
50:                                               ; preds = %32
  ...
  %52 = add nsw i32 %33, -1
  %53 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %52
  %54 = load float, float addrspace(3)* %53, align 4, !tbaa !7
  %55 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %51
...
61:                                               ; preds = %58
  ...
  %63 = add nsw i32 %59, -1
  %64 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %63
  %65 = load float, float addrspace(3)* %64, align 4, !tbaa !7
  %66 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %62
...
72:                                               ; preds = %69
  ...
  %74 = add nsw i32 %70, -1
  %75 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %74
  %76 = load float, float addrspace(3)* %75, align 4, !tbaa !7
  %77 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %73
...
83:                                               ; preds = %80
  ...
  %85 = add nsw i32 %81, -1
  %86 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %85
  %87 = load float, float addrspace(3)* %86, align 4, !tbaa !7
  %88 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %84
...
91:                                               ; preds = %83, %80
  ...
  %93 = icmp ult i32 %5, 31
  br i1 %93, label %94, label %102

94:                                               ; preds = %91
  %95 = add nuw nsw i32 %92, 31
  %96 = add nsw i32 %92, -1
  %97 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %96
  %98 = load float, float addrspace(3)* %97, align 4, !tbaa !7
  %99 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %95
...
102:                                              ; preds = %94, %91
  ...
  %104 = icmp ult i32 %5, 63
  br i1 %104, label %105, label %113

105:                                              ; preds = %102
  %106 = add nuw nsw i32 %103, 15
  %107 = add nsw i32 %103, -1
  %108 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %107
  %109 = load float, float addrspace(3)* %108, align 4, !tbaa !7
  %110 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %106
...
113:                                              ; preds = %105, %102
  ...
  %115 = icmp ult i32 %5, 127
  br i1 %115, label %116, label %124

116:                                              ; preds = %113
  %117 = add nuw nsw i32 %114, 7
  %118 = add nsw i32 %114, -1
  %119 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %118
  %120 = load float, float addrspace(3)* %119, align 4, !tbaa !7
  %121 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %117
...
124:                                              ; preds = %116, %113
  ...
  %126 = icmp ult i32 %5, 255
  br i1 %126, label %127, label %135

127:                                              ; preds = %124
  %128 = add nuw nsw i32 %125, 3
  %129 = add nsw i32 %125, -1
  %130 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %129
  %131 = load float, float addrspace(3)* %130, align 4, !tbaa !7
  %132 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %128
...
135:                                              ; preds = %127, %124
  ...
  %137 = icmp ult i32 %5, 511
  br i1 %137, label %138, label %146

138:                                              ; preds = %135
  %139 = add nuw nsw i32 %136, 1
  %140 = add nsw i32 %136, -1
  %141 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %140
  %142 = load float, float addrspace(3)* %141, align 4, !tbaa !7
  %143 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %139
...
146:                                              ; preds = %138, %135
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %147 = icmp eq i32 %5, 1023
  br i1 %147, label %155, label %148

148:                                              ; preds = %146
  %149 = add nuw nsw i32 %30, 1
  %150 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %149
  %151 = load float, float addrspace(3)* %150, align 4, !tbaa !7
  %152 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %31
...
156:                                              ; preds = %155
  %157 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %5
...
162:                                              ; preds = %161
  %163 = add nuw nsw i32 %5, %10
  %164 = getelementptr inbounds [2048 x float], [2048 x float] addrspace(3)* @_ZZ16brent_kung_scan_PfS_iE2XY, i32 0, i32 %163

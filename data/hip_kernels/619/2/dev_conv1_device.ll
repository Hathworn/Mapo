; ModuleID = '../data/hip_kernels/619/2/main.cu'
source_filename = "../data/hip_kernels/619/2/main.cu"
...
@_ZZ9dev_conv1PfS_iPKfiE5block = internal unnamed_addr addrspace(3) global [256 x float] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z9dev_conv1PfS_iPKfi(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2, float addrspace(1)* nocapture readonly %3, i32 %4) local_unnamed_addr #0 {
  %6 = add nsw i32 %4, -1
  %7 = sub i32 257, %4
  %8 = sdiv i32 %6, -2
...
24:                                               ; preds = %5, %19
  %25 = phi contract float [ %23, %19 ], [ 0.000000e+00, %5 ]
  %26 = getelementptr inbounds [256 x float], [256 x float] addrspace(3)* @_ZZ9dev_conv1PfS_iPKfiE5block, i32 0, i32 %11
...
38:                                               ; preds = %62, %33
  %39 = phi float [ undef, %33 ], [ %136, %62 ]
  %40 = phi i32 [ 0, %33 ], [ %137, %62 ]
  %41 = phi float [ 0.000000e+00, %33 ], [ %136, %62 ]
  %42 = icmp eq i32 %34, 0
  br i1 %42, label %58, label %43

43:                                               ; preds = %38, %43
  %44 = phi i32 [ %55, %43 ], [ %40, %38 ]
  %45 = phi float [ %54, %43 ], [ %41, %38 ]
  %46 = phi i32 [ %56, %43 ], [ 0, %38 ]
  %47 = add nuw i32 %44, %11
  %48 = getelementptr inbounds [256 x float], [256 x float] addrspace(3)* @_ZZ9dev_conv1PfS_iPKfiE5block, i32 0, i32 %47
  ...
  br i1 %57, label %58, label %43, !llvm.loop !10

58:                                               ; preds = %38, %43, %31
  %59 = phi float [ 0.000000e+00, %31 ], [ %39, %38 ], [ %54, %43 ]
  %60 = sext i32 %27 to i64
  %61 = getelementptr inbounds float, float addrspace(1)* %1, i64 %60
  store float %59, float addrspace(1)* %61, align 4, !tbaa !5
  br label %140

62:                                               ; preds = %62, %36
  %63 = phi i32 [ 0, %36 ], [ %137, %62 ]
  %64 = phi float [ 0.000000e+00, %36 ], [ %136, %62 ]
  %65 = phi i32 [ 0, %36 ], [ %138, %62 ]
  %66 = add nuw i32 %63, %11
  %67 = getelementptr inbounds [256 x float], [256 x float] addrspace(3)* @_ZZ9dev_conv1PfS_iPKfiE5block, i32 0, i32 %66
  ...
  %74 = or i32 %63, 1
  %75 = add nuw i32 %74, %11
  %76 = getelementptr inbounds [256 x float], [256 x float] addrspace(3)* @_ZZ9dev_conv1PfS_iPKfiE5block, i32 0, i32 %75
  ...
  %83 = or i32 %63, 2
  %84 = add nuw i32 %83, %11
  %85 = getelementptr inbounds [256 x float], [256 x float] addrspace(3)* @_ZZ9dev_conv1PfS_iPKfiE5block, i32 0, i32 %84
  ...
  %92 = or i32 %63, 3
  %93 = add nuw i32 %92, %11
  %94 = getelementptr inbounds [256 x float], [256 x float] addrspace(3)* @_ZZ9dev_conv1PfS_iPKfiE5block, i32 0, i32 %93
  ...
  %101 = or i32 %63, 4
  %102 = add nuw i32 %101, %11
  %103 = getelementptr inbounds [256 x float], [256 x float] addrspace(3)* @_ZZ9dev_conv1PfS_iPKfiE5block, i32 0, i32 %102
  ...
  %110 = or i32 %63, 5
  %111 = add nuw i32 %110, %11
  %112 = getelementptr inbounds [256 x float], [256 x float] addrspace(3)* @_ZZ9dev_conv1PfS_iPKfiE5block, i32 0, i32 %111
  ...
  %119 = or i32 %63, 6
  %120 = add nuw i32 %119, %11
  %121 = getelementptr inbounds [256 x float], [256 x float] addrspace(3)* @_ZZ9dev_conv1PfS_iPKfiE5block, i32 0, i32 %120
  ...
  %128 = or i32 %63, 7
  %129 = add nuw i32 %128, %11
  %130 = getelementptr inbounds [256 x float], [256 x float] addrspace(3)* @_ZZ9dev_conv1PfS_iPKfiE5block, i32 0, i32 %129
  ...
  br i1 %139, label %38, label %62, !llvm.loop !12

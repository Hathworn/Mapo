; ModuleID = '../data/hip_kernels/619/7/main.cu'
source_filename = "../data/hip_kernels/619/7/main.cu"
...
define protected amdgpu_kernel void @_Z9dev_mean3PfS_ii(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3) local_unnamed_addr #0 {
...
42:                                               ; preds = %68, %41
  %43 = phi float [ undef, %41 ], [ %134, %68 ]
  %44 = phi i32 [ 0, %41 ], [ %135, %68 ]
  %45 = phi float [ 0.000000e+00, %41 ], [ %134, %68 ]
  br i1 %37, label %60, label %46

46:                                               ; preds = %42, %46
  %47 = phi i32 [ %57, %46 ], [ %44, %42 ]
  %48 = phi float [ %56, %46 ], [ %45, %42 ]
  %49 = phi i32 [ %58, %46 ], [ 0, %42 ]
  %50 = add i32 %47, %30
  %51 = mul i32 %50, %2
  %52 = add i32 %51, %40
  ...
  br i1 %59, label %60, label %46, !llvm.loop !20

60:                                               ; preds = %42, %46, %39
  %61 = phi float [ 0.000000e+00, %39 ], [ %43, %42 ], [ %56, %46 ]
  %62 = fdiv contract float %61, %32
  %63 = add i32 %40, %33
  %64 = zext i32 %63 to i64
  %65 = getelementptr inbounds float, float addrspace(1)* %1, i64 %64
  store float %62, float addrspace(1)* %65, align 4, !tbaa !16
  %66 = add nsw i32 %40, %26
  %67 = icmp slt i32 %66, %2
  br i1 %67, label %39, label %38, !llvm.loop !22

68:                                               ; preds = %41, %68
  %69 = phi i32 [ %135, %68 ], [ 0, %41 ]
  %70 = phi float [ %134, %68 ], [ 0.000000e+00, %41 ]
  %71 = phi i32 [ %136, %68 ], [ 0, %41 ]
  %72 = add i32 %69, %30
  %73 = mul i32 %72, %2
  %74 = add i32 %73, %40
  ...
  %135 = add nuw nsw i32 %69, 8
  %136 = add i32 %71, 8
  %137 = icmp eq i32 %136, %36
  br i1 %137, label %42, label %68, !llvm.loop !24
}

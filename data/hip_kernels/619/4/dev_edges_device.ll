; ModuleID = '../data/hip_kernels/619/4/main.cu'
source_filename = "../data/hip_kernels/619/4/main.cu"
...
define protected amdgpu_kernel void @_Z9dev_edgesPfiii(float addrspace(1)* nocapture %0, i32 %1, i32 %2, i32 %3) local_unnamed_addr #0 {
...
49:                                               ; preds = %32
  ...
  %52 = tail call float @llvm.minnum.f32(float %51, float 1.250000e+02)
  %53 = fdiv contract float %52, 1.250000e+02
  br label %67

54:                                               ; preds = %32
  %55 = fmul contract float %48, %48
  %56 = fmul contract float %55, %48
  %57 = fmul contract float %56, %48
  %58 = tail call float @llvm.minnum.f32(float %57, float 1.296000e+03)
  %59 = fdiv contract float %58, 1.296000e+03
  br label %67

60:                                               ; preds = %32
  %61 = fmul contract float %48, %48
  %62 = fmul contract float %61, %48
  %63 = fmul contract float %62, %48
  %64 = fmul contract float %63, %48
  %65 = tail call float @llvm.minnum.f32(float %64, float 7.776000e+03)
  %66 = fdiv contract float %65, 7.776000e+03
  br label %67

67:                                               ; preds = %54, %60, %49
  %68 = phi float [ %53, %49 ], [ %59, %54 ], [ %66, %60 ]
  ...
  store float %72, float addrspace(1)* %70, align 4, !tbaa !16
  %73 = add nsw i32 %33, %26
  %74 = icmp slt i32 %73, %1
  br i1 %74, label %32, label %31, !llvm.loop !20
}

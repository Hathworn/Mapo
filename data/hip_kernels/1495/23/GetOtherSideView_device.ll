; ModuleID = '../data/hip_kernels/1495/23/main.cu'
source_filename = "../data/hip_kernels/1495/23/main.cu"
...
$_ZL16GetOtherSideViewPfS_iii = comdat any

@.str = private unnamed_addr addrspace(4) constant [16 x i8] c"\E7\AF\84\E5\9C\8D\E6\9C\89\E9\8C\AF!!\0A\00", align 1
...
define amdgpu_kernel void @_ZL16GetOtherSideViewPfS_iii(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3, i32 %4) local_unnamed_addr #1 comdat {
...
17:                                               ; preds = %5
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([16 x i8], [16 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %26, label %30
...
470:                                              ; preds = %5
  ...
  %477 = add i32 %476, %475
  %478 = mul i32 %477, %4
  %479 = icmp sgt i32 %4, 0
  br i1 %479, label %480, label %502

480:                                              ; preds = %470
  %481 = and i32 %4, 7
  %482 = icmp ult i32 %4, 8
...
485:                                              ; preds = %508, %480
  %486 = phi float [ undef, %480 ], [ %558, %508 ]
  %487 = phi i32 [ 0, %480 ], [ %559, %508 ]
  %488 = phi float [ 0.000000e+00, %480 ], [ %558, %508 ]
  %489 = icmp eq i32 %481, 0
  br i1 %489, label %502, label %490

490:                                              ; preds = %485, %490
  %491 = phi i32 [ %499, %490 ], [ %487, %485 ]
  %492 = phi float [ %498, %490 ], [ %488, %485 ]
  %493 = phi i32 [ %500, %490 ], [ 0, %485 ]
  %494 = add nsw i32 %491, %478
  %495 = sext i32 %494 to i64
  %496 = getelementptr inbounds float, float addrspace(1)* %0, i64 %495
  %497 = load float, float addrspace(1)* %496, align 4, !tbaa !14, !amdgpu.noclobber !5
  %498 = fadd contract float %492, %497
  %499 = add nuw nsw i32 %491, 1
  %500 = add i32 %493, 1
  %501 = icmp eq i32 %500, %481
  br i1 %501, label %502, label %490, !llvm.loop !18

502:                                              ; preds = %485, %490, %470
  %503 = phi float [ 0.000000e+00, %470 ], [ %486, %485 ], [ %498, %490 ]
  %504 = mul nsw i32 %475, %2
  %505 = add nsw i32 %504, %473
  %506 = sext i32 %505 to i64
  %507 = getelementptr inbounds float, float addrspace(1)* %1, i64 %506
  store float %503, float addrspace(1)* %507, align 4, !tbaa !14
  br label %562

508:                                              ; preds = %508, %483
  %509 = phi i32 [ 0, %483 ], [ %559, %508 ]
  %510 = phi float [ 0.000000e+00, %483 ], [ %558, %508 ]
  %511 = phi i32 [ 0, %483 ], [ %560, %508 ]
  %512 = add nsw i32 %509, %478
  %513 = sext i32 %512 to i64
  %514 = getelementptr inbounds float, float addrspace(1)* %0, i64 %513
  %515 = load float, float addrspace(1)* %514, align 4, !tbaa !14, !amdgpu.noclobber !5
  %516 = fadd contract float %510, %515
  %517 = or i32 %509, 1
  %518 = add nsw i32 %517, %478
  %519 = sext i32 %518 to i64
  %520 = getelementptr inbounds float, float addrspace(1)* %0, i64 %519
  %521 = load float, float addrspace(1)* %520, align 4, !tbaa !14, !amdgpu.noclobber !5
  %522 = fadd contract float %516, %521
  %523 = or i32 %509, 2
  %524 = add nsw i32 %523, %478
  ...
  %529 = or i32 %509, 3
  %530 = add nsw i32 %529, %478
  %531 = sext i32 %530 to i64
  %532 = getelementptr inbounds float, float addrspace(1)* %0, i64 %531
  %533 = load float, float addrspace(1)* %532, align 4, !tbaa !14, !amdgpu.noclobber !5
  %534 = fadd contract float %528, %533
  %535 = or i32 %509, 4
  %536 = add nsw i32 %535, %478
  ...
  %540 = fadd contract float %534, %539
  %541 = or i32 %509, 5
  %542 = add nsw i32 %541, %478
  ...
  %546 = fadd contract float %540, %545
  %547 = or i32 %509, 6
  %548 = add nsw i32 %547, %478
  ...
  %552 = fadd contract float %546, %551
  %553 = or i32 %509, 7
  %554 = add nsw i32 %553, %478
  %555 = sext i32 %554 to i64
  %556 = getelementptr inbounds float, float addrspace(1)* %0, i64 %555
  %557 = load float, float addrspace(1)* %556, align 4, !tbaa !14, !amdgpu.noclobber !5
  %558 = fadd contract float %552, %557
  %559 = add nuw nsw i32 %509, 8
  %560 = add i32 %511, 8
  %561 = icmp eq i32 %560, %484
  br i1 %561, label %485, label %508, !llvm.loop !19

562:                                              ; preds = %459, %26, %502
  ret void
}

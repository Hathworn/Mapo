; ModuleID = '../data/hip_kernels/1495/28/main.cu'
source_filename = "../data/hip_kernels/1495/28/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

$_ZL19ReverseBackScanDataPiiii = comdat any

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define amdgpu_kernel void @_ZL19ReverseBackScanDataPiiii(i32 addrspace(1)* nocapture %0, i32 %1, i32 %2, i32 %3) local_unnamed_addr #0 comdat {
  ...
  %20 = add i32 %16, %19
  %21 = getelementptr inbounds i8, i8 addrspace(4)* %8, i64 20
  %22 = bitcast i8 addrspace(4)* %21 to i32 addrspace(4)*
  %23 = load i32, i32 addrspace(4)* %22, align 4, !tbaa !15
  %24 = getelementptr i8, i8 addrspace(4)* %8, i64 8
  ...
  %43 = add i32 %42, %38
  %44 = add i32 %43, %37
  %45 = getelementptr inbounds i8, i8 addrspace(4)* %8, i64 16
  %46 = bitcast i8 addrspace(4)* %45 to i32 addrspace(4)*
  %47 = load i32, i32 addrspace(4)* %46, align 8, !tbaa !17
  %48 = getelementptr i8, i8 addrspace(4)* %8, i64 6
  %49 = bitcast i8 addrspace(4)* %48 to i16 addrspace(4)*
  %50 = load i16, i16 addrspace(4)* %49, align 2, !range !13, !invariant.load !14
  ...
  %65 = load i32, i32 addrspace(1)* %64, align 4, !tbaa !18, !amdgpu.noclobber !14
  %66 = sext i32 %62 to i64
  %67 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %66
  %68 = load i32, i32 addrspace(1)* %67, align 4, !tbaa !18, !amdgpu.noclobber !14
  store i32 %68, i32 addrspace(1)* %64, align 4, !tbaa !18
  store i32 %65, i32 addrspace(1)* %67, align 4, !tbaa !18
  ret void
}

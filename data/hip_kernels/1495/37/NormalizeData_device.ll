; ModuleID = '../data/hip_kernels/1495/37/main.cu'
source_filename = "../data/hip_kernels/1495/37/main.cu"
...
$_ZL13NormalizeDataPfffi = comdat any

@.str = private unnamed_addr addrspace(4) constant [29 x i8] c"Normaliza Data \E8\B6\85\E5\87\BA\E7\AF\84\E5\9C\8D\0A\00", align 1
...
define amdgpu_kernel void @_ZL13NormalizeDataPfffi(float addrspace(1)* nocapture %0, float %1, float %2, i32 %3) local_unnamed_addr #1 comdat {
  ...
  %18 = add i32 %14, %17
  %19 = mul i32 %18, %5
  %20 = getelementptr inbounds i8, i8 addrspace(4)* %6, i64 20
  %21 = bitcast i8 addrspace(4)* %20 to i32 addrspace(4)*
  %22 = load i32, i32 addrspace(4)* %21, align 4, !tbaa !15
  ...
  br i1 %40, label %494, label %41

41:                                               ; preds = %4
  %42 = tail call i8 addrspace(4)* @llvm.amdgcn.implicitarg.ptr()
  %43 = getelementptr inbounds i8, i8 addrspace(4)* %42, i64 24
  %44 = bitcast i8 addrspace(4)* %43 to i64 addrspace(4)*
  %45 = load i64, i64 addrspace(4)* %44, align 8, !tbaa !17
  %46 = inttoptr i64 %45 to i8 addrspace(1)*
  %47 = addrspacecast i8 addrspace(1)* %46 to i8*
  %48 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %47, i64 noundef 33, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %49 = extractelement <2 x i64> %48, i64 0
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([29 x i8], [29 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %50, label %54

50:                                               ; preds = %41
  %51 = and i64 %49, -227
  %52 = or i64 %51, 34
  %53 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %47, i64 noundef %52, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  br label %507
...
72:                                               ; preds = %57
  %73 = load i8, i8 addrspace(4)* %59, align 1, !tbaa !18
  ...
  %101 = load i8, i8 addrspace(4)* %100, align 1, !tbaa !18
  %102 = zext i8 %101 to i64
  %103 = shl nuw nsw i64 %102, 48
  %104 = or i64 %99, %103
  %105 = getelementptr inbounds i8, i8 addrspace(4)* %59, i64 7
  %106 = load i8, i8 addrspace(4)* %105, align 1, !tbaa !18
...
112:                                              ; preds = %70, %112
  ...
  %117 = load i8, i8 addrspace(4)* %116, align 1, !tbaa !18
  ...
  br i1 %124, label %125, label %112, !llvm.loop !19
...
132:                                              ; preds = %125
  %133 = load i8, i8 addrspace(4)* %126, align 1, !tbaa !18
  ...
  %161 = load i8, i8 addrspace(4)* %160, align 1, !tbaa !18
  %162 = zext i8 %161 to i64
  %163 = shl nuw nsw i64 %162, 48
  %164 = or i64 %159, %163
  %165 = getelementptr inbounds i8, i8 addrspace(4)* %126, i64 7
  %166 = load i8, i8 addrspace(4)* %165, align 1, !tbaa !18
...
172:                                              ; preds = %130, %172
  ...
  %177 = load i8, i8 addrspace(4)* %176, align 1, !tbaa !18
...
192:                                              ; preds = %185
  %193 = load i8, i8 addrspace(4)* %186, align 1, !tbaa !18
  ...
  %221 = load i8, i8 addrspace(4)* %220, align 1, !tbaa !18
  %222 = zext i8 %221 to i64
  %223 = shl nuw nsw i64 %222, 48
  %224 = or i64 %219, %223
  %225 = getelementptr inbounds i8, i8 addrspace(4)* %186, i64 7
  %226 = load i8, i8 addrspace(4)* %225, align 1, !tbaa !18
...
232:                                              ; preds = %190, %232
  ...
  %237 = load i8, i8 addrspace(4)* %236, align 1, !tbaa !18
...
252:                                              ; preds = %245
  %253 = load i8, i8 addrspace(4)* %246, align 1, !tbaa !18
  ...
  %281 = load i8, i8 addrspace(4)* %280, align 1, !tbaa !18
  %282 = zext i8 %281 to i64
  %283 = shl nuw nsw i64 %282, 48
  %284 = or i64 %279, %283
  %285 = getelementptr inbounds i8, i8 addrspace(4)* %246, i64 7
  %286 = load i8, i8 addrspace(4)* %285, align 1, !tbaa !18
...
292:                                              ; preds = %250, %292
  ...
  %297 = load i8, i8 addrspace(4)* %296, align 1, !tbaa !18
...
312:                                              ; preds = %305
  %313 = load i8, i8 addrspace(4)* %306, align 1, !tbaa !18
  ...
  %341 = load i8, i8 addrspace(4)* %340, align 1, !tbaa !18
  %342 = zext i8 %341 to i64
  %343 = shl nuw nsw i64 %342, 48
  %344 = or i64 %339, %343
  %345 = getelementptr inbounds i8, i8 addrspace(4)* %306, i64 7
  %346 = load i8, i8 addrspace(4)* %345, align 1, !tbaa !18
...
352:                                              ; preds = %310, %352
  ...
  %357 = load i8, i8 addrspace(4)* %356, align 1, !tbaa !18
...
372:                                              ; preds = %365
  %373 = load i8, i8 addrspace(4)* %366, align 1, !tbaa !18
  ...
  %401 = load i8, i8 addrspace(4)* %400, align 1, !tbaa !18
  %402 = zext i8 %401 to i64
  %403 = shl nuw nsw i64 %402, 48
  %404 = or i64 %399, %403
  %405 = getelementptr inbounds i8, i8 addrspace(4)* %366, i64 7
  %406 = load i8, i8 addrspace(4)* %405, align 1, !tbaa !18
...
412:                                              ; preds = %370, %412
  ...
  %417 = load i8, i8 addrspace(4)* %416, align 1, !tbaa !18
...
432:                                              ; preds = %425
  %433 = load i8, i8 addrspace(4)* %426, align 1, !tbaa !18
...
470:                                              ; preds = %430, %470
  ...
  %475 = load i8, i8 addrspace(4)* %474, align 1, !tbaa !18
...
483:                                              ; preds = %470, %432, %430
  ...
  %488 = and i64 %68, -225
  %489 = or i64 %488, %487
  %490 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %47, i64 noundef %489, i64 noundef %128, i64 noundef %188, i64 noundef %248, i64 noundef %308, i64 noundef %368, i64 noundef %428, i64 noundef %484) #10
  %491 = sub i64 %58, %66
  %492 = getelementptr inbounds i8, i8 addrspace(4)* %59, i64 %66
  %493 = icmp eq i64 %491, 0
  br i1 %493, label %507, label %57

494:                                              ; preds = %4
  %495 = sext i32 %39 to i64
  %496 = getelementptr inbounds float, float addrspace(1)* %0, i64 %495
  %497 = load float, float addrspace(1)* %496, align 4, !tbaa !21, !amdgpu.noclobber !14
  %498 = fcmp contract olt float %497, %2
  br i1 %498, label %499, label %500

499:                                              ; preds = %494
  store float 0.000000e+00, float addrspace(1)* %496, align 4, !tbaa !21
  br label %507

500:                                              ; preds = %494
  %501 = fcmp contract ogt float %497, %1
  br i1 %501, label %502, label %503

502:                                              ; preds = %500
  store float 1.000000e+00, float addrspace(1)* %496, align 4, !tbaa !21
  br label %507

503:                                              ; preds = %500
  %504 = fsub contract float %497, %2
  %505 = fsub contract float %1, %2
  %506 = fdiv contract float %504, %505
  store float %506, float addrspace(1)* %496, align 4, !tbaa !21
  br label %507

507:                                              ; preds = %483, %50, %499, %503, %502
  ret void
}

; ModuleID = '../data/hip_kernels/1495/51/main.cu'
source_filename = "../data/hip_kernels/1495/51/main.cu"
...
$_ZL25CombineTwoChannels_SinglePiS_iii = comdat any
...
define amdgpu_kernel void @_ZL25CombineTwoChannels_SinglePiS_iii(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3, i32 %4) local_unnamed_addr #1 comdat {
...
497:                                              ; preds = %5
  ...
  %501 = mul i32 %500, %499
  %502 = sub i32 %498, %501
  %503 = shl nsw i32 %500, 1
  %504 = mul nsw i32 %503, %41
  %505 = add nsw i32 %504, %502
  %506 = sext i32 %505 to i64
  %507 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %506
  %508 = load i32, i32 addrspace(1)* %507, align 4, !tbaa !21, !amdgpu.noclobber !14
  ...
  %514 = load i32, i32 addrspace(1)* %513, align 4, !tbaa !21, !amdgpu.noclobber !14
  %515 = add nsw i32 %514, %508
  %516 = sdiv i32 %515, 2
  %517 = sext i32 %40 to i64
  %518 = getelementptr inbounds i32, i32 addrspace(1)* %1, i64 %517
  store i32 %516, i32 addrspace(1)* %518, align 4, !tbaa !21
  br label %519

519:                                              ; preds = %486, %53, %497
  ret void
}

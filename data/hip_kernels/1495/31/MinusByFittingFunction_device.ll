; ModuleID = '../data/hip_kernels/1495/31/main.cu'
source_filename = "../data/hip_kernels/1495/31/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

$_ZL22MinusByFittingFunctionPiPfi = comdat any

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define amdgpu_kernel void @_ZL22MinusByFittingFunctionPiPfi(i32 addrspace(1)* nocapture %0, float addrspace(1)* nocapture readonly %1, i32 %2) local_unnamed_addr #0 comdat {
  ...
  %35 = add i32 %33, %34
  %36 = mul i32 %35, %12
  %37 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !16
  %38 = add i32 %36, %37
  %39 = srem i32 %38, %2
  ...
  %45 = load i32, i32 addrspace(1)* %44, align 4, !tbaa !21, !amdgpu.noclobber !14
  %46 = sitofp i32 %45 to float
  %47 = fsub contract float %46, %42
  %48 = fptosi float %47 to i32
  store i32 %48, i32 addrspace(1)* %44, align 4, !tbaa !21
  ret void
}

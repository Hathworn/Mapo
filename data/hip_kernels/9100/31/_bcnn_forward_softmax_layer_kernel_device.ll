; ModuleID = '../data/hip_kernels/9100/31/main.cu'
source_filename = "../data/hip_kernels/9100/31/main.cu"
...
140:                                              ; preds = %140, %60
  %141 = phi i32 [ 0, %60 ], [ %185, %140 ]
  %142 = phi float [ 0.000000e+00, %60 ], [ %184, %140 ]
  %143 = phi i32 [ 0, %60 ], [ %186, %140 ]
  %144 = add nsw i32 %141, %57
  ...
  %148 = fsub contract float %147, %55
  ...
  %163 = fadd contract float %142, %162
  %164 = or i32 %141, 1
  ...
  %169 = fsub contract float %168, %55
  ...
  %184 = fadd contract float %163, %183
  %185 = add nuw nsw i32 %141, 2
  %186 = add i32 %143, 2
  %187 = icmp eq i32 %186, %61
  br i1 %187, label %188, label %140, !llvm.loop !24

188:                                              ; preds = %140, %56
  %189 = phi float [ undef, %56 ], [ %184, %140 ]
  %190 = phi i32 [ 0, %56 ], [ %185, %140 ]
  %191 = phi float [ 0.000000e+00, %56 ], [ %184, %140 ]
  %192 = icmp eq i32 %58, 0
  br i1 %192, label %214, label %193

193:                                              ; preds = %188
  %194 = add nsw i32 %190, %57
...
214:                                              ; preds = %193, %188, %54
  %215 = phi float [ 0.000000e+00, %54 ], [ %189, %188 ], [ %213, %193 ]
  %216 = fcmp contract une float %215, 0.000000e+00
  br i1 %216, label %217, label %231

217:                                              ; preds = %214
  %218 = tail call i1 @llvm.amdgcn.class.f32(float %215, i32 144)
...
231:                                              ; preds = %214, %217
  %232 = phi float [ %230, %217 ], [ -1.000000e+02, %214 ]

...
#include "normal_eqs_disparity_GPU_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
normal_eqs_disparity_GPU<<<gridBlock, threadBlock>>>(d_CD,d_disparity_compact,d_Zbuffer_normals_compact,d_ind_disparity_Zbuffer,fx,fy,ox,oy,b,n_cols,d_n_values_disparity,d_start_ind_disparity,w_disp);

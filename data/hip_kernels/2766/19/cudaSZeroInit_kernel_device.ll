; ModuleID = '../data/hip_kernels/2766/19/main.cu'
source_filename = "../data/hip_kernels/2766/19/main.cu"
...
define protected amdgpu_kernel void @_Z20cudaSZeroInit_kerneljPf(i32 %0, float addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
...
23:                                               ; preds = %2, %23
  ...
  br i1 %28, label %23, label %22, !llvm.loop !20
}

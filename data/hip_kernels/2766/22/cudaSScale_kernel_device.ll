; ModuleID = '../data/hip_kernels/2766/22/main.cu'
source_filename = "../data/hip_kernels/2766/22/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z17cudaSScale_kerneljPffffS_(i32 %0, float addrspace(1)* nocapture readonly %1, float %2, float %3, float %4, float addrspace(1)* nocapture %5) local_unnamed_addr #0 {
...
27:                                               ; preds = %6
  br i1 %26, label %42, label %52

28:                                               ; preds = %6
  br i1 %26, label %29, label %52

29:                                               ; preds = %28, %29
  %30 = phi i32 [ %40, %29 ], [ %18, %28 ]
  ...
  %36 = getelementptr inbounds float, float addrspace(1)* %5, i64 %31
  %37 = load float, float addrspace(1)* %36, align 4, !tbaa !16
  %38 = fmul contract float %37, %4
  %39 = fadd contract float %35, %38
  store float %39, float addrspace(1)* %36, align 4, !tbaa !16
  %40 = add i32 %30, %24
  %41 = icmp ult i32 %40, %0
  br i1 %41, label %29, label %52, !llvm.loop !20

42:                                               ; preds = %27, %42
  %43 = phi i32 [ %50, %42 ], [ %18, %27 ]
  ...
  %48 = fadd contract float %47, %3
  %49 = getelementptr inbounds float, float addrspace(1)* %5, i64 %44
  store float %48, float addrspace(1)* %49, align 4, !tbaa !16
  %50 = add i32 %43, %24
  %51 = icmp ult i32 %50, %0
  br i1 %51, label %42, label %52, !llvm.loop !22

52:                                               ; preds = %42, %29, %27, %28
  ret void
}

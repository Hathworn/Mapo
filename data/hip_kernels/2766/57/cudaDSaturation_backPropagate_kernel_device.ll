; ModuleID = '../data/hip_kernels/2766/57/main.cu'
source_filename = "../data/hip_kernels/2766/57/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z36cudaDSaturation_backPropagate_kernelPdS_jid(double addrspace(1)* nocapture readonly %0, double addrspace(1)* nocapture %1, i32 %2, i32 %3, double %4) local_unnamed_addr #0 {
...
25:                                               ; preds = %5
  ...
  %33 = fcmp contract une double %4, 0.000000e+00
...
50:                                               ; preds = %49
  ...
  %54 = fcmp contract ogt double %53, %34
  %55 = fcmp contract olt double %53, %4
  %56 = and i1 %54, %55
  %57 = select contract i1 %56, double 1.000000e+00, double 0.000000e+00
  %58 = getelementptr inbounds double, double addrspace(1)* %1, i64 %51
  %59 = load double, double addrspace(1)* %58, align 8, !tbaa !16
  %60 = fmul contract double %59, %57
  store double %60, double addrspace(1)* %58, align 8, !tbaa !16
  br label %61

61:                                               ; preds = %49, %50
  %62 = add i32 %37, %23
  %63 = icmp ult i32 %62, %2
  br i1 %63, label %36, label %35, !llvm.loop !20
}

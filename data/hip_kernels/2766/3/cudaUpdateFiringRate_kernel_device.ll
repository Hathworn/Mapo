; ModuleID = '../data/hip_kernels/2766/3/main.cu'
source_filename = "../data/hip_kernels/2766/3/main.cu"
...
define protected amdgpu_kernel void @_Z27cudaUpdateFiringRate_kernelPjS_jjj(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3, i32 %4) local_unnamed_addr #0 {
  %6 = mul i32 %3, %2
  %7 = mul i32 %6, %4

; ModuleID = '../data/hip_kernels/2766/18/main.cu'
source_filename = "../data/hip_kernels/2766/18/main.cu"
...
define protected amdgpu_kernel void @_Z20cudaUZeroInit_kerneljPj(i32 %0, i32 addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
...
23:                                               ; preds = %2, %23
  ...
  store i32 0, i32 addrspace(1)* %26, align 4, !tbaa !16
  %27 = add i32 %24, %20

; ModuleID = '../data/hip_kernels/2766/50/main.cu'
source_filename = "../data/hip_kernels/2766/50/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z35cudaSRectifier_backPropagate_kernelPfS_jfif(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture %1, i32 %2, float %3, i32 %4, float %5) local_unnamed_addr #0 {
...
26:                                               ; preds = %6
  ...
  %34 = fcmp contract ogt float %5, 0.000000e+00
  br label %36
...
53:                                               ; preds = %49
  %54 = fcmp contract ogt float %52, %5
  %55 = fcmp contract ogt float %52, 0.000000e+00
  %56 = select contract i1 %55, float 1.000000e+00, float %3
  %57 = select contract i1 %54, float 0.000000e+00, float %56
  br label %61

58:                                               ; preds = %49
  %59 = fcmp contract ogt float %52, 0.000000e+00
  %60 = select contract i1 %59, float 1.000000e+00, float %3
  br label %61

61:                                               ; preds = %53, %58
  %62 = phi float [ %57, %53 ], [ %60, %58 ]
  %63 = getelementptr inbounds float, float addrspace(1)* %1, i64 %50
  %64 = load float, float addrspace(1)* %63, align 4, !tbaa !16
  %65 = fmul contract float %64, %62
  store float %65, float addrspace(1)* %63, align 4, !tbaa !16
  %66 = add i32 %37, %24

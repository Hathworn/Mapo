; ModuleID = '../data/hip_kernels/305/0/main.cu'
source_filename = "../data/hip_kernels/305/0/main.cu"
...
define protected amdgpu_kernel void @_Z7anyLeftPiS_i(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {

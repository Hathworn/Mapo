; ModuleID = '../data/hip_kernels/10121/3/main.cu'
source_filename = "../data/hip_kernels/10121/3/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [27 x i8] c"Found %d on %d position %d\00", align 1
...
define protected amdgpu_kernel void @_Z6reducePiiS_(i32 addrspace(1)* nocapture readonly %0, i32 %1, i32 addrspace(1)* nocapture %2) local_unnamed_addr #1 {
  ...
  %16 = icmp eq i32 %15, %1
  br i1 %16, label %17, label %489

17:                                               ; preds = %3
  %18 = load i32, i32 addrspace(1)* %2, align 4, !tbaa !7, !amdgpu.noclobber !5
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([27 x i8], [27 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %27, label %31

27:                                               ; preds = %17
  %28 = and i64 %26, -225
  %29 = or i64 %28, 32
  %30 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %24, i64 noundef %29, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #11
  br label %472
...
461:                                              ; preds = %448, %410, %408
  ...
  %466 = and i64 %46, -225
  %467 = or i64 %466, %465
  %468 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %24, i64 noundef %467, i64 noundef %106, i64 noundef %166, i64 noundef %226, i64 noundef %286, i64 noundef %346, i64 noundef %406, i64 noundef %462) #11
  %469 = sub i64 %36, %44
...
472:                                              ; preds = %461, %27
  ...
  %475 = zext i32 %1 to i64
  %476 = and i64 %474, -225
  %477 = or i64 %476, 32
  %478 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %24, i64 noundef %477, i64 noundef %475, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #11
  %479 = extractelement <2 x i64> %478, i64 0
  %480 = zext i32 %12 to i64
  %481 = and i64 %479, -225
  %482 = or i64 %481, 32
  %483 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %24, i64 noundef %482, i64 noundef %480, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #11
  %484 = extractelement <2 x i64> %483, i64 0
  %485 = zext i32 %18 to i64
  %486 = and i64 %484, -227
  %487 = or i64 %486, 34
  %488 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %24, i64 noundef %487, i64 noundef %485, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #11
  store i32 %12, i32 addrspace(1)* %2, align 4, !tbaa !7
  br label %489

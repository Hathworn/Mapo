; ModuleID = '../data/hip_kernels/497/10/main.cu'
source_filename = "../data/hip_kernels/497/10/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z11compute_invPKiS0_PKfiS2_Pf(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, i32 %3, float addrspace(1)* nocapture readonly %4, float addrspace(1)* nocapture writeonly %5) local_unnamed_addr #0 {
...
26:                                               ; preds = %17, %26
  %27 = phi float [ %39, %26 ], [ 0.000000e+00, %17 ]
  %28 = phi i32 [ %40, %26 ], [ %20, %17 ]
...
42:                                               ; preds = %26
  %43 = fadd contract float %39, 0x3FC3333300000000
  br label %44

44:                                               ; preds = %42, %17
  %45 = phi float [ 0x3FC3333300000000, %17 ], [ %43, %42 ]
  %46 = getelementptr inbounds float, float addrspace(1)* %5, i64 %18
  store float %45, float addrspace(1)* %46, align 4, !tbaa !11
  br label %47

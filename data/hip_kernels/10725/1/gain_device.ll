; ModuleID = '../data/hip_kernels/10725/1/main.cu'
source_filename = "../data/hip_kernels/10725/1/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z4gainiifffPfS_(i32 %0, i32 %1, float %2, float %3, float %4, float addrspace(1)* nocapture readonly %5, float addrspace(1)* nocapture writeonly %6) local_unnamed_addr #0 {
...
28:                                               ; preds = %7
  ...
  %36 = getelementptr inbounds float, float addrspace(1)* %6, i64 %32
  store float %35, float addrspace(1)* %36, align 4, !tbaa !7
  %37 = add nuw nsw i32 %31, 1
  %38 = sext i32 %37 to i64
  %39 = getelementptr inbounds float, float addrspace(1)* %5, i64 %38
  %40 = load float, float addrspace(1)* %39, align 4, !tbaa !7
  %41 = fmul contract float %40, %3
  %42 = getelementptr inbounds float, float addrspace(1)* %6, i64 %38

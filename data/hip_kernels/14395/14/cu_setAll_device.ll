; ModuleID = '../data/hip_kernels/14395/14/main.cu'
source_filename = "../data/hip_kernels/14395/14/main.cu"
...
define protected amdgpu_kernel void @_Z9cu_setAllPffi(float addrspace(1)* nocapture writeonly %0, float %1, i32 %2) local_unnamed_addr #0 {
...
23:                                               ; preds = %3, %23
  %24 = phi i32 [ %27, %23 ], [ %15, %3 ]
  %25 = sext i32 %24 to i64
  %26 = getelementptr inbounds float, float addrspace(1)* %0, i64 %25
  store float %1, float addrspace(1)* %26, align 4, !tbaa !16

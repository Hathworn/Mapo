; ModuleID = '../data/hip_kernels/7745/1/main.cu'
source_filename = "../data/hip_kernels/7745/1/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ19calc_entropy_atomicPfS_iE3sum = internal addrspace(3) global float undef, align 4
@_ZZ19calc_entropy_atomicPfS_iE7entropy = internal addrspace(3) global float undef, align 4

; Function Attrs: convergent mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z19calc_entropy_atomicPfS_i(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
9:                                                ; preds = %3
  store float 0.000000e+00, float addrspace(3)* @_ZZ19calc_entropy_atomicPfS_iE3sum, align 4, !tbaa !5
  br label %10
...
10:                                               ; preds = %9, %3
  ...
  %45 = atomicrmw fadd float addrspace(3)* @_ZZ19calc_entropy_atomicPfS_iE3sum, float %44 syncscope("agent-one-as") monotonic, align 4
  fence syncscope("workgroup") release
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
...
46:                                               ; preds = %10
  store float 0.000000e+00, float addrspace(3)* @_ZZ19calc_entropy_atomicPfS_iE7entropy, align 4, !tbaa !5
  br label %47
...
47:                                               ; preds = %46, %10
  ...
  %49 = load float, float addrspace(3)* @_ZZ19calc_entropy_atomicPfS_iE3sum, align 4, !tbaa !5
  ...
  %59 = atomicrmw fadd float addrspace(3)* @_ZZ19calc_entropy_atomicPfS_iE7entropy, float %58 syncscope("agent-one-as") monotonic, align 4
  fence syncscope("workgroup") release
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
...
60:                                               ; preds = %47
  %61 = load float, float addrspace(3)* @_ZZ19calc_entropy_atomicPfS_iE7entropy, align 4, !tbaa !5

; ModuleID = '../data/hip_kernels/15781/2/main.cu'
source_filename = "../data/hip_kernels/15781/2/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z21convertRGBtoGrayScalePhS_iii(i8 addrspace(1)* nocapture readonly %0, i8 addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3, i32 %4) local_unnamed_addr #0 {
...
26:                                               ; preds = %5
  ...
  %41 = uitofp i8 %32 to float
  %42 = fmul contract float %41, 0x3FCAE147A0000000
  %43 = uitofp i8 %36 to float
  %44 = fmul contract float %43, 0x3FE6B851E0000000
  %45 = fadd contract float %42, %44
  %46 = uitofp i8 %40 to float
  %47 = fmul contract float %46, 0x3FB1EB8520000000
  ...
  store i8 %49, i8 addrspace(1)* %51, align 1, !tbaa !7
  br label %52

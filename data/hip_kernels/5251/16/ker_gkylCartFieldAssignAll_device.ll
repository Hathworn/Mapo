; ModuleID = '../data/hip_kernels/5251/16/main.cu'
source_filename = "../data/hip_kernels/5251/16/main.cu"
...
define protected amdgpu_kernel void @_Z26ker_gkylCartFieldAssignAlljjdPd(i32 %0, i32 %1, double %2, double addrspace(1)* nocapture writeonly %3) local_unnamed_addr #0 {
...
28:                                               ; preds = %20, %28
  %29 = phi i32 [ %17, %20 ], [ %32, %28 ]
  %30 = sext i32 %29 to i64
  %31 = getelementptr inbounds double, double addrspace(1)* %3, i64 %30
  store double %2, double addrspace(1)* %31, align 8, !tbaa !16
  %32 = add i32 %26, %29
  %33 = icmp ult i32 %32, %18
  br i1 %33, label %28, label %27, !llvm.loop !20
}

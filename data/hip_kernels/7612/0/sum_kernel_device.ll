; ModuleID = '../data/hip_kernels/7612/0/main.cu'
source_filename = "../data/hip_kernels/7612/0/main.cu"
...
define protected amdgpu_kernel void @_Z10sum_kernelPfS_i(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, i32 %2) local_unnamed_addr #0 {
  ...
  %9 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @sdata, i32 0, i32 %5
  ...
  %14 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @sdata, i32 0, i32 %10
  store float %13, float addrspace(3)* %14, align 4, !tbaa !5
  fence syncscope("workgroup") release
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %15 = load float, float addrspace(3)* %9, align 4, !tbaa !5
  %16 = load float, float addrspace(3)* %14, align 4, !tbaa !5
  %17 = fadd contract float %15, %16
  store float %17, float addrspace(3)* %9, align 4, !tbaa !5
  fence syncscope("workgroup") release
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire

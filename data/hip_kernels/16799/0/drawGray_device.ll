; ModuleID = '../data/hip_kernels/16799/0/main.cu'
source_filename = "../data/hip_kernels/16799/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z8drawGrayPhPKf(i8 addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %34 = fdiv contract double %33, 5.000000e+01
  %35 = fadd contract double %34, 5.000000e-01
  %36 = fptrunc double %35 to float
  %37 = fcmp contract olt float %36, 0.000000e+00
  %38 = select i1 %37, float 0.000000e+00, float %36
  %39 = fcmp contract ogt float %38, 1.000000e+00
  ...
  store i8 %42, i8 addrspace(1)* %45, align 1, !tbaa !20
  %46 = add nuw nsw i32 %43, 1
  %47 = sext i32 %46 to i64
  %48 = getelementptr inbounds i8, i8 addrspace(1)* %0, i64 %47
  store i8 %42, i8 addrspace(1)* %48, align 1, !tbaa !20
  %49 = add nuw nsw i32 %43, 2
  %50 = sext i32 %49 to i64
  %51 = getelementptr inbounds i8, i8 addrspace(1)* %0, i64 %50
  store i8 %42, i8 addrspace(1)* %51, align 1, !tbaa !20
  %52 = add nuw nsw i32 %43, 3
  %53 = sext i32 %52 to i64
  %54 = getelementptr inbounds i8, i8 addrspace(1)* %0, i64 %53
  store i8 -1, i8 addrspace(1)* %54, align 1, !tbaa !20
  ret void
}

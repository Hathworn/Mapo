; ModuleID = '../data/hip_kernels/1944/17/main.cu'
source_filename = "../data/hip_kernels/1944/17/main.cu"
...
define protected amdgpu_kernel void @_Z14cudaKernelMeshP15HIP_vector_typeIfLj4EEjjf(%struct.HIP_vector_type addrspace(1)* nocapture writeonly %0, i32 %1, i32 %2, float %3) local_unnamed_addr #0 {
...
272:                                              ; preds = %159, %166
  ...
  %318 = insertelement <4 x float> <float poison, float poison, float poison, float 0xC7E01FE000000000>, float %29, i64 0

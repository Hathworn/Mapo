; ModuleID = '../data/hip_kernels/3190/1/main.cu'
source_filename = "../data/hip_kernels/3190/1/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn writeonly
define protected amdgpu_kernel void @_Z10windowHannPfi(float addrspace(1)* nocapture writeonly %0, i32 %1) local_unnamed_addr #0 {
...
135:                                              ; preds = %22, %29
  ...
  %157 = fadd contract float %155, 1.000000e+00
  %158 = fmul contract float %157, 5.000000e-01
  %159 = select i1 %156, float %158, float 0x7FF8000000000000
  %160 = sext i32 %11 to i64
  %161 = getelementptr inbounds float, float addrspace(1)* %0, i64 %160
  store float %159, float addrspace(1)* %161, align 4, !tbaa !8
  br label %162

; ModuleID = '../data/hip_kernels/12214/28/main.cu'
source_filename = "../data/hip_kernels/12214/28/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z4copyPfPKfi(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, i32 %2) local_unnamed_addr #0 {
...
25:                                               ; preds = %17, %25
  ...
  store float %37, float addrspace(1)* %40, align 4, !tbaa !16
  %41 = add nsw i32 %27, 2
  ...
  store float %44, float addrspace(1)* %47, align 4, !tbaa !16
  %48 = add nsw i32 %27, 3

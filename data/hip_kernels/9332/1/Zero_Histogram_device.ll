; ModuleID = '../data/hip_kernels/9332/1/main.cu'
source_filename = "../data/hip_kernels/9332/1/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [57 x i8] c"ERROR: Out of rawBinSums[] bounds, calling: %d, max: %d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z14Zero_HistogramPijj(i32 addrspace(1)* nocapture writeonly %0, i32 %1, i32 %2) local_unnamed_addr #1 {
...
25:                                               ; preds = %3
  ...
  %29 = load i64, i64 addrspace(4)* %28, align 8, !tbaa !7
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([57 x i8], [57 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %34, label %38
...
42:                                               ; preds = %468, %38
  %43 = phi i64 [ select (i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([57 x i8], [57 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), i64 0, i64 add (i64 ptrtoint (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([57 x i8], [57 x i8] addrspace(4)* @.str, i64 0, i64 56) to i8*) to i64), i64 add (i64 sub (i64 0, i64 ptrtoint ([57 x i8]* addrspacecast ([57 x i8] addrspace(4)* @.str to [57 x i8]*) to i64)), i64 1))), %38 ], [ %476, %468 ]
  %44 = phi i8 addrspace(4)* [ getelementptr inbounds ([57 x i8], [57 x i8] addrspace(4)* @.str, i64 0, i64 0), %38 ], [ %477, %468 ]
...
57:                                               ; preds = %42
  %58 = load i8, i8 addrspace(4)* %44, align 1, !tbaa !11
...
117:                                              ; preds = %110
  %118 = load i8, i8 addrspace(4)* %111, align 1, !tbaa !11
...
177:                                              ; preds = %170
  %178 = load i8, i8 addrspace(4)* %171, align 1, !tbaa !11
...
237:                                              ; preds = %230
  %238 = load i8, i8 addrspace(4)* %231, align 1, !tbaa !11
...
297:                                              ; preds = %290
  %298 = load i8, i8 addrspace(4)* %291, align 1, !tbaa !11
...
357:                                              ; preds = %350
  %358 = load i8, i8 addrspace(4)* %351, align 1, !tbaa !11
...
417:                                              ; preds = %410
  %418 = load i8, i8 addrspace(4)* %411, align 1, !tbaa !11
...
455:                                              ; preds = %415, %455
  ...
  %460 = load i8, i8 addrspace(4)* %459, align 1, !tbaa !11
...
491:                                              ; preds = %479, %3
  %492 = sext i32 %22 to i64
  %493 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %492
  store i32 0, i32 addrspace(1)* %493, align 4, !tbaa !14
  ret void
}

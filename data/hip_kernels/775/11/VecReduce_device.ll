; ModuleID = '../data/hip_kernels/775/11/main.cu'
source_filename = "../data/hip_kernels/775/11/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@d_Total = protected addrspace(1) externally_initialized global float 0.000000e+00, align 4
@sdata = external hidden local_unnamed_addr addrspace(3) global [0 x float], align 4
@llvm.compiler.used = appending addrspace(1) global [1 x i8*] [i8* addrspacecast (i8 addrspace(1)* bitcast (float addrspace(1)* @d_Total to i8 addrspace(1)*) to i8*)], section "llvm.metadata"

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z9VecReducePfS_i(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readnone %1, i32 %2) local_unnamed_addr #0 {
...
18:                                               ; preds = %3, %14
  ...
  %20 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @sdata, i32 0, i32 %4
...
36:                                               ; preds = %22
  ...
  %38 = atomicrmw fadd float addrspace(1)* @d_Total, float %37 syncscope("agent-one-as") monotonic, align 4
  br label %39

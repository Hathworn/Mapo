; ModuleID = '../data/hip_kernels/775/10/main.cu'
source_filename = "../data/hip_kernels/775/10/main.cu"
...
define protected amdgpu_kernel void @_Z9VecReducePfS_i(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {

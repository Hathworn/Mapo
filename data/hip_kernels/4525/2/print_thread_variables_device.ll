; ModuleID = '../data/hip_kernels/4525/2/main.cu'
source_filename = "../data/hip_kernels/4525/2/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [74 x i8] c"Thread{%d,%d,%d}, Block{%d,%d,%d}, BlockDim{%d,%d,%d}, GridDim{%d,%d,%d}\0A\00", align 1
...
define protected amdgpu_kernel void @_Z22print_thread_variablesv() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([74 x i8], [74 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %34, label %38

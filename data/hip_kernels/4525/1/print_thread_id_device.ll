; ModuleID = '../data/hip_kernels/4525/1/main.cu'
source_filename = "../data/hip_kernels/4525/1/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [28 x i8] c"Hello Cuda tid[%d, %d, %d]\0A\00", align 1
...
define protected amdgpu_kernel void @_Z15print_thread_idv() local_unnamed_addr #1 {
  ...
  %8 = getelementptr i8, i8 addrspace(4)* %1, i64 8
  ...
  %14 = load i64, i64 addrspace(4)* %13, align 8, !tbaa !6
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([28 x i8], [28 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %19, label %23
...
82:                                               ; preds = %40, %82
  ...
  %87 = load i8, i8 addrspace(4)* %86, align 1, !tbaa !10
...
142:                                              ; preds = %100, %142
  ...
  %147 = load i8, i8 addrspace(4)* %146, align 1, !tbaa !10
...
202:                                              ; preds = %160, %202
  ...
  %207 = load i8, i8 addrspace(4)* %206, align 1, !tbaa !10
...
262:                                              ; preds = %220, %262
  ...
  %267 = load i8, i8 addrspace(4)* %266, align 1, !tbaa !10
...
322:                                              ; preds = %280, %322
  ...
  %327 = load i8, i8 addrspace(4)* %326, align 1, !tbaa !10
...
382:                                              ; preds = %340, %382
  ...
  %387 = load i8, i8 addrspace(4)* %386, align 1, !tbaa !10
...
440:                                              ; preds = %400, %440
  ...
  %445 = load i8, i8 addrspace(4)* %444, align 1, !tbaa !10
...
464:                                              ; preds = %453, %19
  ...
  %466 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !13
  %467 = tail call i32 @llvm.amdgcn.workgroup.id.x()
  %468 = zext i16 %4 to i32
  %469 = mul i32 %467, %468
  %470 = add i32 %469, %466
  %471 = tail call i32 @llvm.amdgcn.workitem.id.y(), !range !13
  %472 = tail call i32 @llvm.amdgcn.workgroup.id.y()
  %473 = zext i16 %7 to i32
  %474 = mul i32 %472, %473
  %475 = add i32 %474, %471
  %476 = tail call i32 @llvm.amdgcn.workitem.id.z(), !range !13
  %477 = tail call i32 @llvm.amdgcn.workgroup.id.z()
  %478 = zext i16 %10 to i32
  %479 = mul i32 %477, %478
  %480 = add i32 %479, %476
  %481 = extractelement <2 x i64> %465, i64 0
  ...
  %488 = and i64 %486, -225
  %489 = or i64 %488, 32
  %490 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %16, i64 noundef %489, i64 noundef %487, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %491 = extractelement <2 x i64> %490, i64 0
  %492 = zext i32 %480 to i64
  %493 = and i64 %491, -227
  %494 = or i64 %493, 34
  %495 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %16, i64 noundef %494, i64 noundef %492, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

; ModuleID = '../data/hip_kernels/15063/0/main.cu'
source_filename = "../data/hip_kernels/15063/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z9CalcInputPfS_S_i(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2, i32 %3) local_unnamed_addr #0 {
  ...
  store float 0.000000e+00, float addrspace(1)* %15, align 4, !tbaa !7
  %16 = getelementptr inbounds float, float addrspace(1)* %0, i64 %14
  %17 = load float, float addrspace(1)* %16, align 4, !tbaa !7
  %18 = getelementptr inbounds float, float addrspace(1)* %1, i64 %14
  %19 = load float, float addrspace(1)* %18, align 4, !tbaa !7
  %20 = fmul contract float %17, %19
  %21 = fadd contract float %20, 0.000000e+00
  store float %21, float addrspace(1)* %15, align 4, !tbaa !7
  %22 = add nsw i32 %13, 1
  ...
  store float %29, float addrspace(1)* %15, align 4, !tbaa !7
  ...
  store float %36, float addrspace(1)* %15, align 4, !tbaa !7
  %37 = add nsw i32 %3, 1
  ...
  store float %45, float addrspace(1)* %15, align 4, !tbaa !7
  ret void
}

; ModuleID = '../data/hip_kernels/18004/6/main.cu'
source_filename = "../data/hip_kernels/18004/6/main.cu"
...
1611:                                             ; preds = %1600, %1602
  ...
  %1613 = fdiv contract float %1612, 8.100000e+01
  %1614 = fptoui float %1613 to i8
  %1615 = add nsw i32 %720, %30
  %1616 = sext i32 %1615 to i64
  %1617 = getelementptr inbounds i8, i8 addrspace(1)* %1, i64 %1616
  store i8 %1614, i8 addrspace(1)* %1617, align 1, !tbaa !7
  %1618 = add nuw nsw i32 %720, 1
  %1619 = icmp eq i32 %1618, %5
  br i1 %1619, label %721, label %719, !llvm.loop !12
}

...
hipFree(0);
__ADAGradm<<<gridBlock, threadBlock>>>(nrows,ncols,mm,um,ssq,momentum,mu,mask,maskr,nw,ve,nve,ts,nts,lr,nlr,langevin,eps,doupdate,rstates);

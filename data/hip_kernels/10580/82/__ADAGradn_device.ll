; ModuleID = '../data/hip_kernels/10580/82/main.cu'
source_filename = "../data/hip_kernels/10580/82/main.cu"
...
467:                                              ; preds = %463, %385
  ...
  %475 = fsub contract float %474, %472
  %476 = fmul contract float %475, %6
  %477 = fadd contract float %474, %476
  %478 = fadd contract float %167, %477
  br i1 %137, label %479, label %485

479:                                              ; preds = %467
  %480 = sext i32 %141 to i64
  %481 = select i1 %138, i64 %480, i64 %142
  %482 = getelementptr inbounds float, float addrspace(1)* %7, i64 %481
  %483 = load float, float addrspace(1)* %482, align 4, !tbaa !17
  %484 = fmul contract float %478, %483
  br label %485

485:                                              ; preds = %479, %467
  %486 = phi float [ %478, %467 ], [ %484, %479 ]
  store float %486, float addrspace(1)* %166, align 4, !tbaa !17
  br label %487

487:                                              ; preds = %139, %485
  %488 = add nsw i32 %140, %54
  %489 = icmp slt i32 %488, %108
  br i1 %489, label %139, label %490, !llvm.loop !29

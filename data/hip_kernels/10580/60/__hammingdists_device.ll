; ModuleID = '../data/hip_kernels/10580/60/main.cu'
source_filename = "../data/hip_kernels/10580/60/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [50 x i8] c"__hammingdists() not defined for CUDA Arch < 300\0A\00", align 1
...
define protected amdgpu_kernel void @_Z14__hammingdistsPiS_S_S_S_i(i32 addrspace(1)* nocapture readnone %0, i32 addrspace(1)* nocapture readnone %1, i32 addrspace(1)* nocapture readnone %2, i32 addrspace(1)* nocapture readnone %3, i32 addrspace(1)* nocapture readnone %4, i32 %5) local_unnamed_addr #1 {
  ...
  %10 = load i64, i64 addrspace(4)* %9, align 8, !tbaa !4
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([50 x i8], [50 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %15, label %19
...
37:                                               ; preds = %22
  %38 = load i8, i8 addrspace(4)* %24, align 1, !tbaa !8
...
77:                                               ; preds = %35, %77
  ...
  %82 = load i8, i8 addrspace(4)* %81, align 1, !tbaa !8
  ...
  br i1 %89, label %90, label %77, !llvm.loop !9
...
97:                                               ; preds = %90
  %98 = load i8, i8 addrspace(4)* %91, align 1, !tbaa !8
...
137:                                              ; preds = %95, %137
  ...
  %142 = load i8, i8 addrspace(4)* %141, align 1, !tbaa !8
...
197:                                              ; preds = %155, %197
  ...
  %202 = load i8, i8 addrspace(4)* %201, align 1, !tbaa !8
...
217:                                              ; preds = %210
  %218 = load i8, i8 addrspace(4)* %211, align 1, !tbaa !8
...
257:                                              ; preds = %215, %257
  ...
  %262 = load i8, i8 addrspace(4)* %261, align 1, !tbaa !8
...
277:                                              ; preds = %270
  %278 = load i8, i8 addrspace(4)* %271, align 1, !tbaa !8
...
317:                                              ; preds = %275, %317
  ...
  %322 = load i8, i8 addrspace(4)* %321, align 1, !tbaa !8
...
337:                                              ; preds = %330
  %338 = load i8, i8 addrspace(4)* %331, align 1, !tbaa !8
...
377:                                              ; preds = %335, %377
  ...
  %382 = load i8, i8 addrspace(4)* %381, align 1, !tbaa !8
...
397:                                              ; preds = %390
  %398 = load i8, i8 addrspace(4)* %391, align 1, !tbaa !8
...
435:                                              ; preds = %395, %435
  ...
  %440 = load i8, i8 addrspace(4)* %439, align 1, !tbaa !8

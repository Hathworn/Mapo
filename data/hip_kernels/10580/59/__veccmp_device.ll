; ModuleID = '../data/hip_kernels/10580/59/main.cu'
source_filename = "../data/hip_kernels/10580/59/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [44 x i8] c"__veccmp() not defined for CUDA Arch < 300\0A\00", align 1
...
define protected amdgpu_kernel void @_Z8__veccmpPiS_S_(i32 addrspace(1)* nocapture readnone %0, i32 addrspace(1)* nocapture readnone %1, i32 addrspace(1)* nocapture readnone %2) local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([44 x i8], [44 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %12, label %16

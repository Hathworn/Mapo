; ModuleID = '../data/hip_kernels/4694/11/main.cu'
source_filename = "../data/hip_kernels/4694/11/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z41reduction_interleaved_unrolling_blocks8_1PiS_i(i32 addrspace(1)* nocapture %0, i32 addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
67:                                               ; preds = %80, %62
  %68 = icmp eq i32 %4, 0
  br i1 %68, label %82, label %86

69:                                               ; preds = %64, %80
  %70 = phi i32 [ %9, %64 ], [ %71, %80 ]
  %71 = lshr i32 %70, 1
...
80:                                               ; preds = %73, %69
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %81 = icmp ult i32 %70, 4
  br i1 %81, label %67, label %69, !llvm.loop !11

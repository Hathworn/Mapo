; ModuleID = '../data/hip_kernels/4694/70/main.cu'
source_filename = "../data/hip_kernels/4694/70/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [70 x i8] c"tid : %d, bid.x : %d, bid.y : %d, gid : %d, warp_id : %d, gbid : %d \0A\00", align 1
...
define protected amdgpu_kernel void @_Z22print_details_of_warpsv() local_unnamed_addr #1 {
  ...
  %5 = load i32, i32 addrspace(4)* %4, align 4, !tbaa !4
  %6 = getelementptr i8, i8 addrspace(4)* %2, i64 4
  %7 = bitcast i8 addrspace(4)* %6 to i16 addrspace(4)*
  %8 = load i16, i16 addrspace(4)* %7, align 4, !range !13, !invariant.load !14
  %9 = zext i16 %8 to i32
  %10 = udiv i32 %5, %9
  ...
  %16 = load i64, i64 addrspace(4)* %15, align 8, !tbaa !16
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([70 x i8], [70 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %21, label %25
...
29:                                               ; preds = %455, %25
  %30 = phi i64 [ select (i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([70 x i8], [70 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), i64 0, i64 add (i64 ptrtoint (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([70 x i8], [70 x i8] addrspace(4)* @.str, i64 0, i64 69) to i8*) to i64), i64 add (i64 sub (i64 0, i64 ptrtoint ([70 x i8]* addrspacecast ([70 x i8] addrspace(4)* @.str to [70 x i8]*) to i64)), i64 1))), %25 ], [ %463, %455 ]
  %31 = phi i8 addrspace(4)* [ getelementptr inbounds ([70 x i8], [70 x i8] addrspace(4)* @.str, i64 0, i64 0), %25 ], [ %464, %455 ]
...
104:                                              ; preds = %97
  %105 = load i8, i8 addrspace(4)* %98, align 1, !tbaa !17
...
164:                                              ; preds = %157
  %165 = load i8, i8 addrspace(4)* %158, align 1, !tbaa !17
...
224:                                              ; preds = %217
  %225 = load i8, i8 addrspace(4)* %218, align 1, !tbaa !17
...
284:                                              ; preds = %277
  %285 = load i8, i8 addrspace(4)* %278, align 1, !tbaa !17
...
344:                                              ; preds = %337
  %345 = load i8, i8 addrspace(4)* %338, align 1, !tbaa !17
...
404:                                              ; preds = %397
  %405 = load i8, i8 addrspace(4)* %398, align 1, !tbaa !17
...
442:                                              ; preds = %402, %442
  ...
  %447 = load i8, i8 addrspace(4)* %446, align 1, !tbaa !17
...
466:                                              ; preds = %455, %21
  ...
  %475 = add i32 %474, %12
  %476 = lshr i32 %12, 5
  %477 = extractelement <2 x i64> %467, i64 0
  %478 = zext i32 %12 to i64
  %479 = and i64 %477, -225
  %480 = or i64 %479, 32
  %481 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %18, i64 noundef %480, i64 noundef %478, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %482 = extractelement <2 x i64> %481, i64 0
  %483 = zext i32 %11 to i64
  %484 = and i64 %482, -225
  %485 = or i64 %484, 32
  %486 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %18, i64 noundef %485, i64 noundef %483, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %487 = extractelement <2 x i64> %486, i64 0
  %488 = zext i32 %1 to i64
  %489 = and i64 %487, -225
  %490 = or i64 %489, 32
  %491 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %18, i64 noundef %490, i64 noundef %488, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %492 = extractelement <2 x i64> %491, i64 0
  %493 = zext i32 %475 to i64
  %494 = and i64 %492, -225
  %495 = or i64 %494, 32
  %496 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %18, i64 noundef %495, i64 noundef %493, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %497 = extractelement <2 x i64> %496, i64 0
  %498 = zext i32 %476 to i64
  %499 = and i64 %497, -225
  %500 = or i64 %499, 32
  %501 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %18, i64 noundef %500, i64 noundef %498, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %502 = extractelement <2 x i64> %501, i64 0
  %503 = zext i32 %473 to i64
  %504 = and i64 %502, -227
  %505 = or i64 %504, 34
  %506 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %18, i64 noundef %505, i64 noundef %503, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

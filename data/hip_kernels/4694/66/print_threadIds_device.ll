; ModuleID = '../data/hip_kernels/4694/66/main.cu'
source_filename = "../data/hip_kernels/4694/66/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [55 x i8] c"threadIdx.x : %d, threadIdx.y : %d, threadIdx.z : %d \0A\00", align 1
...
define protected amdgpu_kernel void @_Z15print_threadIdsv() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([55 x i8], [55 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %9, label %13
...
17:                                               ; preds = %443, %13
  %18 = phi i64 [ select (i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([55 x i8], [55 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), i64 0, i64 add (i64 ptrtoint (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([55 x i8], [55 x i8] addrspace(4)* @.str, i64 0, i64 54) to i8*) to i64), i64 add (i64 sub (i64 0, i64 ptrtoint ([55 x i8]* addrspacecast ([55 x i8] addrspace(4)* @.str to [55 x i8]*) to i64)), i64 1))), %13 ], [ %451, %443 ]
  %19 = phi i8 addrspace(4)* [ getelementptr inbounds ([55 x i8], [55 x i8] addrspace(4)* @.str, i64 0, i64 0), %13 ], [ %452, %443 ]
...
454:                                              ; preds = %443, %9
  ...
  %456 = tail call i32 @llvm.amdgcn.workitem.id.z(), !range !11
  %457 = tail call i32 @llvm.amdgcn.workitem.id.y(), !range !11
  %458 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !11
  %459 = extractelement <2 x i64> %455, i64 0
  %460 = zext i32 %458 to i64
  %461 = and i64 %459, -225
  %462 = or i64 %461, 32
  %463 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %6, i64 noundef %462, i64 noundef %460, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %464 = extractelement <2 x i64> %463, i64 0
  %465 = zext i32 %457 to i64
  %466 = and i64 %464, -225
  %467 = or i64 %466, 32
  %468 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %6, i64 noundef %467, i64 noundef %465, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %469 = extractelement <2 x i64> %468, i64 0
  %470 = zext i32 %456 to i64
  %471 = and i64 %469, -227
  %472 = or i64 %471, 34
  %473 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %6, i64 noundef %472, i64 noundef %470, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

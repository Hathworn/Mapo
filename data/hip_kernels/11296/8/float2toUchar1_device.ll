; ModuleID = '../data/hip_kernels/11296/8/main.cu'
source_filename = "../data/hip_kernels/11296/8/main.cu"
...
%union.anon.2 = type { <1 x i8> }

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z14float2toUchar1P15HIP_vector_typeIfLj2EEPS_IhLj1EEiii(%struct.HIP_vector_type addrspace(1)* nocapture readonly %0, %struct.HIP_vector_type.0 addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3, i32 %4) local_unnamed_addr #0 {
  ...
  %33 = getelementptr inbounds %struct.HIP_vector_type.0, %struct.HIP_vector_type.0 addrspace(1)* %1, i64 %25, i32 0, i32 0, i32 0, i64 0
  store i8 %32, i8 addrspace(1)* %33, align 1
  ret void
}

; ModuleID = '../data/hip_kernels/11296/10/main.cu'
source_filename = "../data/hip_kernels/11296/10/main.cu"
...
define protected amdgpu_kernel void @_Z14float1toUchar1P15HIP_vector_typeIfLj1EEPS_IhLj1EEii(%struct.HIP_vector_type addrspace(1)* nocapture readonly %0, %struct.HIP_vector_type.0 addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3) local_unnamed_addr #0 {
  ...
  store i8 %27, i8 addrspace(1)* %28, align 1
  ret void
}

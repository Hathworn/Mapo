...
#include "MHDComputedUy_CUDA3_kernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
MHDComputedUy_CUDA3_kernel<<<gridBlock, threadBlock>>>(FluxD,FluxS1,FluxS2,FluxS3,FluxTau,FluxBx,FluxBy,FluxBz,FluxPhi,dUD,dUS1,dUS2,dUS3,dUTau,dUBx,dUBy,dUBz,dUPhi,dtdx,size,dim0,dim1,dim2);

...
#include "HydroComputedUx_CUDA3_kernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
HydroComputedUx_CUDA3_kernel<<<gridBlock, threadBlock>>>(FluxD,FluxS1,FluxS2,FluxS3,FluxTau,dUD,dUS1,dUS2,dUS3,dUTau,dtdx,size);

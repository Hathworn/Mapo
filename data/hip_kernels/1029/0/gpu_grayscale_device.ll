; ModuleID = '../data/hip_kernels/1029/0/main.cu'
source_filename = "../data/hip_kernels/1029/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z13gpu_grayscaleiiPfS_(i32 %0, i32 %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture writeonly %3) local_unnamed_addr #0 {
...
25:                                               ; preds = %4
  ...
  %32 = fmul contract float %31, 0x3FB27BB300000000
  %33 = getelementptr inbounds float, float addrspace(1)* %30, i64 1
  %34 = load float, float addrspace(1)* %33, align 4, !tbaa !7, !amdgpu.noclobber !5
  %35 = fmul contract float %34, 0x3FE6E2EB20000000
  %36 = fadd contract float %32, %35
  %37 = getelementptr inbounds float, float addrspace(1)* %30, i64 2
  %38 = load float, float addrspace(1)* %37, align 4, !tbaa !7, !amdgpu.noclobber !5
  %39 = fmul contract float %38, 0x3FCB367A00000000

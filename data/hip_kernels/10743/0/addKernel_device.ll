; ModuleID = '../data/hip_kernels/10743/0/main.cu'
source_filename = "../data/hip_kernels/10743/0/main.cu"
...
define protected amdgpu_kernel void @_Z9addKernelPiPKiS1_(i32 addrspace(1)* nocapture writeonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %12 = load i32, i32 addrspace(1)* %6, align 4, !tbaa !5
  %13 = load i32, i32 addrspace(1)* %8, align 4, !tbaa !5
  %14 = sub nsw i32 %12, %13
  store i32 %14, i32 addrspace(1)* %11, align 4, !tbaa !5
  ret void
}

; ModuleID = '../data/hip_kernels/8850/25/main.cu'
source_filename = "../data/hip_kernels/8850/25/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ16sd_t_s1_7_kerneliiiiiiiiiiiiiiiPdS_S_iiE6t2_shm = internal unnamed_addr addrspace(3) global [512 x double] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z16sd_t_s1_7_kerneliiiiiiiiiiiiiiiPdS_S_ii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 %10, i32 %11, i32 %12, i32 %13, i32 %14, double addrspace(1)* nocapture %15, double addrspace(1)* nocapture readonly %16, double addrspace(1)* nocapture readonly %17, i32 %18, i32 %19) local_unnamed_addr #0 {
...
56:                                               ; preds = %24, %56
  ...
  %61 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_7_kerneliiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %57
...
101:                                              ; preds = %97, %101
  ...
  %105 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_7_kerneliiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %104
  ...
  %117 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_7_kerneliiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %116
  ...
  %129 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_7_kerneliiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %128
  ...
  %141 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_7_kerneliiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %140
...
156:                                              ; preds = %154, %156
  ...
  %160 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_7_kerneliiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %159

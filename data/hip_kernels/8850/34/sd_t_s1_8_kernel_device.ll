; ModuleID = '../data/hip_kernels/8850/34/main.cu'
source_filename = "../data/hip_kernels/8850/34/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ16sd_t_s1_8_kerneliiiiiiiiiiiiiiiPdS_S_iiE6t2_shm = internal unnamed_addr addrspace(3) global [512 x double] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z16sd_t_s1_8_kerneliiiiiiiiiiiiiiiPdS_S_ii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 %10, i32 %11, i32 %12, i32 %13, i32 %14, double addrspace(1)* nocapture %15, double addrspace(1)* nocapture readonly %16, double addrspace(1)* nocapture readonly %17, i32 %18, i32 %19) local_unnamed_addr #0 {
...
56:                                               ; preds = %24, %56
  ...
  %59 = getelementptr inbounds double, double addrspace(1)* %16, i64 %58
  %60 = load double, double addrspace(1)* %59, align 8, !tbaa !16, !amdgpu.noclobber !6
  %61 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_8_kerneliiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %57
...
82:                                               ; preds = %65
  ...
  %89 = getelementptr inbounds double, double addrspace(1)* %17, i64 %88
...
101:                                              ; preds = %97, %101
  ...
  %105 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_8_kerneliiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %104
  ...
  %112 = getelementptr inbounds double, double addrspace(1)* %15, i64 %111
  %113 = load double, double addrspace(1)* %112, align 8, !tbaa !16
  %114 = fsub contract double %113, %108
  store double %114, double addrspace(1)* %112, align 8, !tbaa !16
  %115 = or i32 %102, 1
  %116 = add nsw i32 %115, %98
  %117 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_8_kerneliiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %116
  ...
  %124 = getelementptr inbounds double, double addrspace(1)* %15, i64 %123
  %125 = load double, double addrspace(1)* %124, align 8, !tbaa !16
  %126 = fsub contract double %125, %120
  store double %126, double addrspace(1)* %124, align 8, !tbaa !16
  %127 = or i32 %102, 2
  %128 = add nsw i32 %127, %98
  %129 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_8_kerneliiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %128
  ...
  %136 = getelementptr inbounds double, double addrspace(1)* %15, i64 %135
  ...
  %141 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_8_kerneliiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %140
  ...
  %148 = getelementptr inbounds double, double addrspace(1)* %15, i64 %147
  %149 = load double, double addrspace(1)* %148, align 8, !tbaa !16
  %150 = fsub contract double %149, %144
...
156:                                              ; preds = %154, %156
  ...
  %160 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_8_kerneliiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %159
  ...
  %167 = getelementptr inbounds double, double addrspace(1)* %15, i64 %166
  %168 = load double, double addrspace(1)* %167, align 8, !tbaa !16
  %169 = fsub contract double %168, %163

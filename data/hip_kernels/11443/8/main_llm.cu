...
#include "computeSphereVertexDistancesKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
computeSphereVertexDistancesKernel<<<gridBlock, threadBlock>>>(V,dist,NEIGHBOR,NBOFFSETS,nNeighbors,nVertices,circumference);

; ModuleID = '../data/hip_kernels/3879/16/main.cu'
source_filename = "../data/hip_kernels/3879/16/main.cu"
...
define protected amdgpu_kernel void @_Z25kernel_init_column_matrixPim(i32 addrspace(1)* nocapture writeonly %0, i64 %1) local_unnamed_addr #0 {
...
45:                                               ; preds = %41
  ...
  %50 = mul nuw nsw i32 %42, 60000
  br label %51

51:                                               ; preds = %45, %51
  %52 = phi i32 [ %43, %45 ], [ %56, %51 ]
  %53 = add i32 %52, %50
  %54 = zext i32 %52 to i64
  %55 = getelementptr inbounds i32, i32 addrspace(1)* %49, i64 %54
  store i32 %53, i32 addrspace(1)* %55, align 4, !tbaa !17
  %56 = add i32 %52, %33
  %57 = icmp ult i32 %56, 60000
  br i1 %57, label %51, label %58, !llvm.loop !21

58:                                               ; preds = %51, %41
  %59 = phi i32 [ %43, %41 ], [ %56, %51 ]
  %60 = add i32 %42, %27

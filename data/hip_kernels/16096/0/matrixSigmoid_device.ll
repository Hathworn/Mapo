; ModuleID = '../data/hip_kernels/16096/0/main.cu'
source_filename = "../data/hip_kernels/16096/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z13matrixSigmoidPdS_ii(double addrspace(1)* nocapture readonly %0, double addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3) local_unnamed_addr #0 {
...
25:                                               ; preds = %4
  ...
  %31 = fneg contract double %30
  %32 = fmul double %30, 0xBFF71547652B82FE
  ...
  %50 = fcmp olt double %30, -1.024000e+03
  %51 = fcmp ogt double %30, 1.075000e+03
  %52 = fadd contract double %49, 1.000000e+00
  %53 = fdiv contract double 1.000000e+00, %52
  %54 = select i1 %50, double 0.000000e+00, double %53
  %55 = select i1 %51, double 1.000000e+00, double %54
  %56 = getelementptr inbounds double, double addrspace(1)* %1, i64 %28

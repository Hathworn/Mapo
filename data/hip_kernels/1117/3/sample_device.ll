; ModuleID = '../data/hip_kernels/1117/3/main.cu'
source_filename = "../data/hip_kernels/1117/3/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [18 x i8] c"a=%d, b=%d, c=%d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z6samplev() local_unnamed_addr #1 {
...
10:                                               ; preds = %0
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([18 x i8], [18 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %19, label %23
...
42:                                               ; preds = %27
  %43 = load i8, i8 addrspace(4)* %29, align 1, !tbaa !9
  ...
  %76 = load i8, i8 addrspace(4)* %75, align 1, !tbaa !9
...
82:                                               ; preds = %40, %82
  ...
  %87 = load i8, i8 addrspace(4)* %86, align 1, !tbaa !9
...
102:                                              ; preds = %95
  %103 = load i8, i8 addrspace(4)* %96, align 1, !tbaa !9
  ...
  %136 = load i8, i8 addrspace(4)* %135, align 1, !tbaa !9
...
142:                                              ; preds = %100, %142
  ...
  %147 = load i8, i8 addrspace(4)* %146, align 1, !tbaa !9
...
162:                                              ; preds = %155
  %163 = load i8, i8 addrspace(4)* %156, align 1, !tbaa !9
  ...
  %196 = load i8, i8 addrspace(4)* %195, align 1, !tbaa !9
...
202:                                              ; preds = %160, %202
  ...
  %207 = load i8, i8 addrspace(4)* %206, align 1, !tbaa !9
...
222:                                              ; preds = %215
  %223 = load i8, i8 addrspace(4)* %216, align 1, !tbaa !9
  ...
  %256 = load i8, i8 addrspace(4)* %255, align 1, !tbaa !9
...
262:                                              ; preds = %220, %262
  ...
  %267 = load i8, i8 addrspace(4)* %266, align 1, !tbaa !9
...
282:                                              ; preds = %275
  %283 = load i8, i8 addrspace(4)* %276, align 1, !tbaa !9
  ...
  %316 = load i8, i8 addrspace(4)* %315, align 1, !tbaa !9
...
322:                                              ; preds = %280, %322
  ...
  %327 = load i8, i8 addrspace(4)* %326, align 1, !tbaa !9
...
342:                                              ; preds = %335
  %343 = load i8, i8 addrspace(4)* %336, align 1, !tbaa !9
  ...
  %376 = load i8, i8 addrspace(4)* %375, align 1, !tbaa !9
...
382:                                              ; preds = %340, %382
  ...
  %387 = load i8, i8 addrspace(4)* %386, align 1, !tbaa !9
...
402:                                              ; preds = %395
  %403 = load i8, i8 addrspace(4)* %396, align 1, !tbaa !9
  ...
  %436 = load i8, i8 addrspace(4)* %435, align 1, !tbaa !9
...
440:                                              ; preds = %400, %440
  ...
  %445 = load i8, i8 addrspace(4)* %444, align 1, !tbaa !9

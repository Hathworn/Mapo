; ModuleID = '../data/hip_kernels/2890/36/main.cu'
source_filename = "../data/hip_kernels/2890/36/main.cu"
...
define protected amdgpu_kernel void @_Z30MedianFilterWithMask3x3_KernelPfPKfiiiPKb(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3, i32 %4, i8 addrspace(1)* nocapture readonly %5) local_unnamed_addr #1 {
  %7 = alloca [9 x float], align 16, addrspace(5)
...
96:                                               ; preds = %28
  %97 = bitcast [9 x float] addrspace(5)* %7 to i8 addrspace(5)*
  call void @llvm.lifetime.start.p5i8(i64 36, i8 addrspace(5)* %97) #5
  call void @llvm.memset.p5i8.i64(i8 addrspace(5)* noundef align 16 dereferenceable(36) %97, i8 0, i64 36, i1 false)
  %98 = icmp sgt i32 %4, 0
...
115:                                              ; preds = %181, %96
  call void @llvm.lifetime.end.p5i8(i64 36, i8 addrspace(5)* %97) #5
  br label %202
...
138:                                              ; preds = %130
  ...
  %145 = getelementptr inbounds [9 x float], [9 x float] addrspace(5)* %7, i32 0, i32 %132
...
156:                                              ; preds = %165, %150
  %157 = getelementptr inbounds [9 x float], [9 x float] addrspace(5)* %7, i32 0, i32 %152
  %158 = load float, float addrspace(5)* %157, align 4, !tbaa !12
  br label %181

159:                                              ; preds = %154, %165
  %160 = phi i32 [ %163, %165 ], [ 0, %154 ]
  %161 = getelementptr inbounds [9 x float], [9 x float] addrspace(5)* %7, i32 0, i32 %160
...
165:                                              ; preds = %170, %159
  ...
  %168 = getelementptr inbounds [9 x float], [9 x float] addrspace(5)* %7, i32 0, i32 %167
...
170:                                              ; preds = %159, %170
  ...
  %174 = getelementptr inbounds [9 x float], [9 x float] addrspace(5)* %7, i32 0, i32 %171

...
const double *g_mass = NULL;
hipMalloc(&g_mass, XSIZE*YSIZE);
...
hipFree(0);
gpu_find_vac<<<gridBlock,threadBlock>>>(num_atoms,correlation_step,g_mass,g_vx,g_vy,g_vz,g_vx_all,g_vy_all,g_vz_all,g_vac_x,g_vac_y,g_vac_z);

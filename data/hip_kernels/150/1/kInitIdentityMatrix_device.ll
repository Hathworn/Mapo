; ModuleID = '../data/hip_kernels/150/1/main.cu'
source_filename = "../data/hip_kernels/150/1/main.cu"
...
define protected amdgpu_kernel void @_Z19kInitIdentityMatrixPfii(float addrspace(1)* nocapture writeonly %0, i32 %1, i32 %2) local_unnamed_addr #0 {
...
25:                                               ; preds = %9, %25
  ...
  %35 = select i1 %32, float 1.000000e+00, float 0.000000e+00
  store float %35, float addrspace(1)* %34, align 4, !tbaa !16
  %36 = add i32 %23, %26

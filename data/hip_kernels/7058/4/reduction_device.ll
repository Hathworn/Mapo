; ModuleID = '../data/hip_kernels/7058/4/main.cu'
source_filename = "../data/hip_kernels/7058/4/main.cu"
...
25:                                               ; preds = %19
  %26 = add i32 %20, %10
  %27 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ9reductionPiS_E7s_array, i32 0, i32 %26
...
33:                                               ; preds = %17
  %34 = load i32, i32 addrspace(3)* getelementptr inbounds ([256 x i32], [256 x i32] addrspace(3)* @_ZZ9reductionPiS_E7s_array, i32 0, i32 0), align 16, !tbaa !7

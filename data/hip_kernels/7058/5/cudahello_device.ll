; ModuleID = '../data/hip_kernels/7058/5/main.cu'
source_filename = "../data/hip_kernels/7058/5/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [42 x i8] c"Hola Mundo! Soy el hilo %d del bloque %d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z9cudahellov() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([42 x i8], [42 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %9, label %13

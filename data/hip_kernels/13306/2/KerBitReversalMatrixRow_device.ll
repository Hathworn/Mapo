; ModuleID = '../data/hip_kernels/13306/2/main.cu'
source_filename = "../data/hip_kernels/13306/2/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

$_ZL23KerBitReversalMatrixRowPfS_S_S_ii = comdat any

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define amdgpu_kernel void @_ZL23KerBitReversalMatrixRowPfS_S_S_ii(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, i32 %4, i32 %5) local_unnamed_addr #0 comdat {
...
84:                                               ; preds = %48
  ...
  store float %95, float addrspace(1)* %89, align 4, !tbaa !11
  %96 = getelementptr inbounds float, float addrspace(1)* %3, i64 %93
  %97 = load float, float addrspace(1)* %96, align 4, !tbaa !11
  store float %97, float addrspace(1)* %91, align 4, !tbaa !11
  %98 = getelementptr inbounds float, float addrspace(1)* %0, i64 %93
  store float %90, float addrspace(1)* %98, align 4, !tbaa !11
  %99 = getelementptr inbounds float, float addrspace(1)* %1, i64 %93
  store float %92, float addrspace(1)* %99, align 4, !tbaa !11
  br label %100

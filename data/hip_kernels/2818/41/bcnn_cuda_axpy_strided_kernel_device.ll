; ModuleID = '../data/hip_kernels/2818/41/main.cu'
source_filename = "../data/hip_kernels/2818/41/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z29bcnn_cuda_axpy_strided_kerneliifPfS_iiiiiiiiiii(i32 %0, i32 %1, float %2, float addrspace(1)* nocapture readonly %3, float addrspace(1)* nocapture %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 %10, i32 %11, i32 %12, i32 %13, i32 %14, i32 %15) local_unnamed_addr #0 {
...
38:                                               ; preds = %16
  ...
  %75 = load float, float addrspace(1)* %74, align 4, !tbaa !16, !amdgpu.noclobber !14
  %76 = fadd contract float %75, %72
  store float %76, float addrspace(1)* %74, align 4, !tbaa !16
  br label %77

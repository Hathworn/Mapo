; ModuleID = '../data/hip_kernels/2818/40/main.cu'
source_filename = "../data/hip_kernels/2818/40/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part = internal unnamed_addr addrspace(3) global [1024 x float] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z23bcnn_grad_scales_kernelPfS_iiiS_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3, i32 %4, float addrspace(1)* nocapture %5) local_unnamed_addr #0 {
...
172:                                              ; preds = %168, %6
  ...
  %174 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %8
...
180:                                              ; preds = %180, %176
  ...
  %183 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %181
  %184 = load float, float addrspace(3)* %183, align 16, !tbaa !5
  %185 = fadd contract float %184, %182
  %186 = or i32 %181, 1
  %187 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %186
  %188 = load float, float addrspace(3)* %187, align 4, !tbaa !5
  %189 = fadd contract float %188, %185
  %190 = or i32 %181, 2
  %191 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %190
  %192 = load float, float addrspace(3)* %191, align 8, !tbaa !5
  %193 = fadd contract float %192, %189
  %194 = or i32 %181, 3
  %195 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %194
  %196 = load float, float addrspace(3)* %195, align 4, !tbaa !5
  %197 = fadd contract float %196, %193
  %198 = or i32 %181, 4
  %199 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %198
  %200 = load float, float addrspace(3)* %199, align 16, !tbaa !5
  %201 = fadd contract float %200, %197
  %202 = or i32 %181, 5
  %203 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %202
  %204 = load float, float addrspace(3)* %203, align 4, !tbaa !5
  %205 = fadd contract float %204, %201
  %206 = or i32 %181, 6
  %207 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %206
  %208 = load float, float addrspace(3)* %207, align 8, !tbaa !5
  %209 = fadd contract float %208, %205
  %210 = or i32 %181, 7
  %211 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %210
  %212 = load float, float addrspace(3)* %211, align 4, !tbaa !5
  %213 = fadd contract float %212, %209
  %214 = or i32 %181, 8
  %215 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %214
  %216 = load float, float addrspace(3)* %215, align 16, !tbaa !5
  %217 = fadd contract float %216, %213
  %218 = or i32 %181, 9
  %219 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %218
  %220 = load float, float addrspace(3)* %219, align 4, !tbaa !5
  %221 = fadd contract float %220, %217
  %222 = or i32 %181, 10
  %223 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %222
  %224 = load float, float addrspace(3)* %223, align 8, !tbaa !5
  %225 = fadd contract float %224, %221
  %226 = or i32 %181, 11
  %227 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %226
  %228 = load float, float addrspace(3)* %227, align 4, !tbaa !5
  %229 = fadd contract float %228, %225
  %230 = or i32 %181, 12
  %231 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %230
  %232 = load float, float addrspace(3)* %231, align 16, !tbaa !5
  %233 = fadd contract float %232, %229
  %234 = or i32 %181, 13
  %235 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %234
  %236 = load float, float addrspace(3)* %235, align 4, !tbaa !5
  %237 = fadd contract float %236, %233
  %238 = or i32 %181, 14
  %239 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %238
  %240 = load float, float addrspace(3)* %239, align 8, !tbaa !5
  %241 = fadd contract float %240, %237
  %242 = or i32 %181, 15
  %243 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ23bcnn_grad_scales_kernelPfS_iiiS_E4part, i32 0, i32 %242

; ModuleID = '../data/hip_kernels/7402/28/main.cu'
source_filename = "../data/hip_kernels/7402/28/main.cu"
...
@_ZZ9ScaleDownPfS_iiiiE5inrow = internal unnamed_addr addrspace(3) global [164 x float] undef, align 16
@_ZZ9ScaleDownPfS_iiiiE4brow = internal unnamed_addr addrspace(3) global [400 x float] undef, align 16
...
17:                                               ; preds = %6
  ...
  %23 = add nsw i32 %22, -1
  %24 = mul nsw i32 %23, %3
  %25 = getelementptr inbounds [20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 %7
  store i32 %24, i32 addrspace(3)* %25, align 4, !tbaa !5
  %26 = add nsw i32 %20, -4
  %27 = sdiv i32 %26, 2
  %28 = mul nsw i32 %27, %5
  %29 = getelementptr inbounds [20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE6yWrite, i32 0, i32 %7
  store i32 %28, i32 addrspace(3)* %29, align 4, !tbaa !5
  br label %30
...
30:                                               ; preds = %17, %6
  ...
  %37 = getelementptr inbounds [164 x float], [164 x float] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5inrow, i32 0, i32 %7
  ...
  %41 = getelementptr inbounds [164 x float], [164 x float] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5inrow, i32 0, i32 %40
  %42 = add nuw nsw i32 %40, 4
  %43 = getelementptr inbounds [164 x float], [164 x float] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5inrow, i32 0, i32 %42
  ...
  %46 = getelementptr inbounds [164 x float], [164 x float] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5inrow, i32 0, i32 %45
  %47 = add nuw nsw i32 %40, 3
  %48 = getelementptr inbounds [164 x float], [164 x float] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5inrow, i32 0, i32 %47
  ...
  %51 = getelementptr inbounds [164 x float], [164 x float] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5inrow, i32 0, i32 %50
  %52 = getelementptr inbounds [400 x float], [400 x float] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE4brow, i32 0, i32 %7
  %53 = getelementptr inbounds [400 x float], [400 x float] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE4brow, i32 0, i32 %9
  %54 = getelementptr inbounds [400 x float], [400 x float] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE4brow, i32 0, i32 %11
  %55 = getelementptr inbounds [400 x float], [400 x float] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE4brow, i32 0, i32 %8
  %56 = getelementptr inbounds [400 x float], [400 x float] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE4brow, i32 0, i32 %10
  %57 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 0), align 16, !tbaa !5
...
75:                                               ; preds = %62, %30
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %76 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 1), align 4, !tbaa !5
...
94:                                               ; preds = %81, %75
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %95 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 2), align 8, !tbaa !5
...
113:                                              ; preds = %100, %94
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %114 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 3), align 4, !tbaa !5
...
132:                                              ; preds = %119, %113
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %133 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 4), align 16, !tbaa !5
  %134 = add nsw i32 %133, %36
...
152:                                              ; preds = %151
  ...
  %165 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE6yWrite, i32 0, i32 4), align 16, !tbaa !5
...
169:                                              ; preds = %151, %152
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %170 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 5), align 4, !tbaa !5
  %171 = add nsw i32 %170, %36
...
188:                                              ; preds = %175, %169
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %189 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 6), align 8, !tbaa !5
...
208:                                              ; preds = %207
  ...
  %221 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE6yWrite, i32 0, i32 6), align 8, !tbaa !5
...
225:                                              ; preds = %207, %208
  %226 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 7), align 4, !tbaa !5
  %227 = add nsw i32 %226, %36
...
244:                                              ; preds = %231, %225
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %245 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 8), align 16, !tbaa !5
  %246 = add nsw i32 %245, %36
...
264:                                              ; preds = %263
  ...
  %277 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE6yWrite, i32 0, i32 8), align 16, !tbaa !5
...
281:                                              ; preds = %263, %264
  %282 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 9), align 4, !tbaa !5
  %283 = add nsw i32 %282, %36
...
300:                                              ; preds = %287, %281
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %301 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 10), align 8, !tbaa !5
  %302 = add nsw i32 %301, %36
...
320:                                              ; preds = %319
  ...
  %333 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE6yWrite, i32 0, i32 10), align 8, !tbaa !5
...
337:                                              ; preds = %319, %320
  %338 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 11), align 4, !tbaa !5
  %339 = add nsw i32 %338, %36
...
356:                                              ; preds = %343, %337
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %357 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 12), align 16, !tbaa !5
  %358 = add nsw i32 %357, %36
...
376:                                              ; preds = %375
  ...
  %389 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE6yWrite, i32 0, i32 12), align 16, !tbaa !5
...
393:                                              ; preds = %375, %376
  %394 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 13), align 4, !tbaa !5
...
412:                                              ; preds = %399, %393
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %413 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 14), align 8, !tbaa !5
  %414 = add nsw i32 %413, %36
...
432:                                              ; preds = %431
  ...
  %445 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE6yWrite, i32 0, i32 14), align 8, !tbaa !5
...
449:                                              ; preds = %432, %431
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %450 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 15), align 4, !tbaa !5
  %451 = add nsw i32 %450, %36
...
468:                                              ; preds = %455, %449
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %469 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 16), align 16, !tbaa !5
  %470 = add nsw i32 %469, %36
...
488:                                              ; preds = %487
  ...
  %501 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE6yWrite, i32 0, i32 16), align 16, !tbaa !5
...
505:                                              ; preds = %487, %488
  %506 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 17), align 4, !tbaa !5
  %507 = add nsw i32 %506, %36
...
524:                                              ; preds = %511, %505
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %525 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 18), align 8, !tbaa !5
  %526 = add nsw i32 %525, %36
...
544:                                              ; preds = %543
  ...
  %557 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE6yWrite, i32 0, i32 18), align 8, !tbaa !5
...
561:                                              ; preds = %543, %544
  %562 = load i32, i32 addrspace(3)* getelementptr inbounds ([20 x i32], [20 x i32] addrspace(3)* @_ZZ9ScaleDownPfS_iiiiE5yRead, i32 0, i32 19), align 4, !tbaa !5
  %563 = add nsw i32 %562, %36

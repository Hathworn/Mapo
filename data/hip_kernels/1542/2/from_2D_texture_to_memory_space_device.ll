; ModuleID = '/home/LiuS/LS-CAT-HIP/data/hip_kernels/1542/2/from_2D_texture_to_memory_space.cu'
source_filename = "/home/LiuS/LS-CAT-HIP/data/hip_kernels/1542/2/from_2D_texture_to_memory_space.cu"
...
@.str = private unnamed_addr addrspace(4) constant [59 x i8] c"Thread %u %u, reading value %4f, and writing to index %3u\0A\00", align 1
...
define protected amdgpu_kernel void @_Z31from_2D_texture_to_memory_spaceP13__hip_texturePfmm(%struct.__hip_texture addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i64 %2, i64 %3) local_unnamed_addr #1 {
...
30:                                               ; preds = %4
  ...
  %71 = tail call i8 addrspace(4)* @llvm.amdgcn.implicitarg.ptr()
  %72 = getelementptr inbounds i8, i8 addrspace(4)* %71, i64 24
  %73 = bitcast i8 addrspace(4)* %72 to i64 addrspace(4)*
  %74 = load i64, i64 addrspace(4)* %73, align 8, !tbaa !12
  %75 = inttoptr i64 %74 to i8 addrspace(1)*
  %76 = addrspacecast i8 addrspace(1)* %75 to i8*
  %77 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %76, i64 noundef 33, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #11
  %78 = extractelement <2 x i64> %77, i64 0
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([59 x i8], [59 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %79, label %83

79:                                               ; preds = %30
  %80 = and i64 %78, -225
  %81 = or i64 %80, 32
  %82 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %76, i64 noundef %81, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #11
  br label %524
...
87:                                               ; preds = %513, %83
  %88 = phi i64 [ select (i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([59 x i8], [59 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), i64 0, i64 add (i64 ptrtoint (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([59 x i8], [59 x i8] addrspace(4)* @.str, i64 0, i64 58) to i8*) to i64), i64 add (i64 sub (i64 0, i64 ptrtoint ([59 x i8]* addrspacecast ([59 x i8] addrspace(4)* @.str to [59 x i8]*) to i64)), i64 1))), %83 ], [ %521, %513 ]
  %89 = phi i8 addrspace(4)* [ getelementptr inbounds ([59 x i8], [59 x i8] addrspace(4)* @.str, i64 0, i64 0), %83 ], [ %522, %513 ]
...
102:                                              ; preds = %87
  %103 = load i8, i8 addrspace(4)* %89, align 1, !tbaa !11
...
142:                                              ; preds = %100, %142
  ...
  br i1 %154, label %155, label %142, !llvm.loop !14
...
462:                                              ; preds = %455
  %463 = load i8, i8 addrspace(4)* %456, align 1, !tbaa !11
...
500:                                              ; preds = %460, %500
  ...
  %505 = load i8, i8 addrspace(4)* %504, align 1, !tbaa !11
...
513:                                              ; preds = %500, %462, %460
  ...
  %518 = and i64 %98, -225
  %519 = or i64 %518, %517
  %520 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %76, i64 noundef %519, i64 noundef %158, i64 noundef %218, i64 noundef %278, i64 noundef %338, i64 noundef %398, i64 noundef %458, i64 noundef %514) #11
  %521 = sub i64 %88, %96
...
524:                                              ; preds = %513, %79
  ...
  %527 = and i64 %526, -225
  %528 = or i64 %527, 32
  %529 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %76, i64 noundef %528, i64 noundef %25, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #11
  %530 = extractelement <2 x i64> %529, i64 0
  %531 = and i64 %530, -225
  %532 = or i64 %531, 32
  %533 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %76, i64 noundef %532, i64 noundef %27, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #11
  %534 = extractelement <2 x i64> %533, i64 0
  %535 = bitcast double %70 to i64
  %536 = and i64 %534, -225
  %537 = or i64 %536, 32
  %538 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %76, i64 noundef %537, i64 noundef %535, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #11
  %539 = extractelement <2 x i64> %538, i64 0
  %540 = zext i32 %24 to i64
  %541 = and i64 %539, -227
  %542 = or i64 %541, 34
  %543 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %76, i64 noundef %542, i64 noundef %540, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #11
  %544 = getelementptr inbounds float, float addrspace(1)* %1, i64 %540
  store float %69, float addrspace(1)* %544, align 4, !tbaa !16
  br label %545
...
define internal fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %0, i64 noundef %1, i64 noundef %2, i64 noundef %3, i64 noundef %4, i64 noundef %5, i64 noundef %6, i64 noundef %7, i64 noundef %8) unnamed_addr #4 {
  ...
  store i32 2, i32 addrspace(5)* %11, align 4, !tbaa !7
  ...
  store i32 %29, i32 addrspace(5)* %20, align 4, !tbaa !7
  %30 = load i32, i32 addrspace(5)* %20, align 4, !tbaa !7
  %31 = call i32 asm sideeffect "; ockl readfirstlane hoisting hack $0", "=v,0"(i32 %30) #11, !srcloc !22
  store i32 %31, i32 addrspace(5)* %20, align 4, !tbaa !7
  %32 = bitcast i32 addrspace(5)* %21 to i8 addrspace(5)*
  call void @llvm.lifetime.start.p5i8(i64 4, i8 addrspace(5)* %32) #7
  %33 = load i32, i32 addrspace(5)* %20, align 4, !tbaa !7
  %34 = call i32 @llvm.amdgcn.readfirstlane(i32 %33)
  store i32 %34, i32 addrspace(5)* %21, align 4, !tbaa !7
  ...
  %40 = load i32, i32 addrspace(5)* %20, align 4, !tbaa !7
  %41 = load i32, i32 addrspace(5)* %21, align 4, !tbaa !7
...
68:                                               ; preds = %9, %65
  ...
  %99 = load i32, i32 addrspace(5)* %11, align 4, !tbaa !7
  ...
  %108 = load i32, i32 addrspace(5)* %20, align 4, !tbaa !7
  %109 = load i32, i32 addrspace(5)* %21, align 4, !tbaa !7
...
116:                                              ; preds = %68, %112
  ...
  %128 = load i32, i32 addrspace(5)* %20, align 4, !tbaa !7
  %129 = load i32, i32 addrspace(5)* %21, align 4, !tbaa !7
...
163:                                              ; preds = %116, %147, %156
  ...
  %168 = load i32, i32 addrspace(5)* %21, align 4, !tbaa !7
...
180:                                              ; preds = %175
  ...
  %190 = load i32, i32 addrspace(5)* %20, align 4, !tbaa !7
  %191 = load i32, i32 addrspace(5)* %21, align 4, !tbaa !7
...
declare float @llvm.amdgcn.image.sample.lz.2d.f32.f32(i32 immarg, float, float, <8 x i32>, <4 x i32>, i1 immarg, i32 immarg, i32 immarg) #10

attributes #0 = { argmemonly mustprogress nocallback nofree nosync nounwind willreturn }
attributes #1 = { convergent norecurse nounwind "amdgpu-flat-work-group-size"="1,256" "frame-pointer"="none" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="gfx906" "target-features"="+16-bit-insts,+ci-insts,+dl-insts,+dot1-insts,+dot2-insts,+dot7-insts,+dpp,+flat-address-space,+gfx8-insts,+gfx9-insts,+s-memrealtime,+s-memtime-inst,+sramecc" "uniform-work-group-size"="true" }
...
!22 = !{i64 2662}
!23 = !{!24, !21, i64 0}
!24 = !{!"", !21, i64 0, !21, i64 8, !25, i64 16, !13, i64 24, !13, i64 32, !13, i64 40}
!25 = !{!"hsa_signal_s", !13, i64 0}
!26 = !{!24, !13, i64 40}
!27 = !{!24, !21, i64 8}
!28 = !{!"exec"}
!29 = !{!30, !8, i64 16}
!30 = !{!"", !13, i64 0, !13, i64 8, !8, i64 16, !8, i64 20}
!31 = !{!30, !13, i64 8}
!32 = !{!30, !8, i64 20}
!33 = !{!30, !13, i64 0}
!34 = !{!35, !13, i64 16}
!35 = !{!"amd_signal_s", !13, i64 0, !9, i64 8, !13, i64 16, !8, i64 24, !8, i64 28, !13, i64 32, !13, i64 40, !9, i64 48, !9, i64 56}
!36 = !{!35, !8, i64 24}

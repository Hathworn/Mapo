; ModuleID = '../data/hip_kernels/5330/2/main.cu'
source_filename = "../data/hip_kernels/5330/2/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z20ca_backward_kernel_fPKfS0_S0_Pfiiii(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readnone %2, float addrspace(1)* nocapture %3, i32 %4, i32 %5, i32 %6, i32 %7) local_unnamed_addr #0 {
...
194:                                              ; preds = %190
  ...
  %197 = add i32 %88, %196
  %198 = mul nsw i32 %197, %26
  %199 = mul nsw i32 %191, %7
  %200 = add i32 %199, %17
  %201 = add i32 %200, %198
...
240:                                              ; preds = %237
  ...
  %243 = add i32 %88, %242
  %244 = mul nsw i32 %243, %26
  %245 = mul nsw i32 %238, %7
  %246 = add i32 %245, %17
  %247 = add i32 %246, %244

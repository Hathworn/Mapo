; ModuleID = '../data/hip_kernels/24/2/main.cu'
source_filename = "../data/hip_kernels/24/2/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ15transposeKernelPfS_E4tile = internal unnamed_addr addrspace(3) global [32 x [33 x float]] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z15transposeKernelPfS_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
  ...
  %30 = getelementptr inbounds [32 x [33 x float]], [32 x [33 x float]] addrspace(3)* @_ZZ15transposeKernelPfS_E4tile, i32 0, i32 %9, i32 %5
  ...
  %38 = getelementptr inbounds [32 x [33 x float]], [32 x [33 x float]] addrspace(3)* @_ZZ15transposeKernelPfS_E4tile, i32 0, i32 %31, i32 %5
  ...
  %46 = getelementptr inbounds [32 x [33 x float]], [32 x [33 x float]] addrspace(3)* @_ZZ15transposeKernelPfS_E4tile, i32 0, i32 %39, i32 %5
  ...
  %54 = getelementptr inbounds [32 x [33 x float]], [32 x [33 x float]] addrspace(3)* @_ZZ15transposeKernelPfS_E4tile, i32 0, i32 %47, i32 %5
  store float %53, float addrspace(3)* %54, align 4, !tbaa !16
  fence syncscope("workgroup") release
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %55 = add i32 %8, %5
  %56 = getelementptr inbounds [32 x [33 x float]], [32 x [33 x float]] addrspace(3)* @_ZZ15transposeKernelPfS_E4tile, i32 0, i32 %5, i32 %9
  ...
  %63 = getelementptr inbounds [32 x [33 x float]], [32 x [33 x float]] addrspace(3)* @_ZZ15transposeKernelPfS_E4tile, i32 0, i32 %5, i32 %31
  ...
  %70 = getelementptr inbounds [32 x [33 x float]], [32 x [33 x float]] addrspace(3)* @_ZZ15transposeKernelPfS_E4tile, i32 0, i32 %5, i32 %39
  ...
  %77 = getelementptr inbounds [32 x [33 x float]], [32 x [33 x float]] addrspace(3)* @_ZZ15transposeKernelPfS_E4tile, i32 0, i32 %5, i32 %47

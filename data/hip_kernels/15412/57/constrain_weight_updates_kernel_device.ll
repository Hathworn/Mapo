; ModuleID = '../data/hip_kernels/15412/57/main.cu'
source_filename = "../data/hip_kernels/15412/57/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z31constrain_weight_updates_kernelifPfS_(i32 %0, float %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture %3) local_unnamed_addr #0 {
...
26:                                               ; preds = %4
  ...
  %31 = load float, float addrspace(1)* %30, align 4, !tbaa !16, !amdgpu.noclobber !14
  %32 = tail call float @llvm.fabs.f32(float %31)
  %33 = fmul contract float %29, %1
  %34 = tail call float @llvm.fabs.f32(float %33)
  %35 = fcmp contract ogt float %32, %34
  br i1 %35, label %36, label %41

36:                                               ; preds = %26
  %37 = fcmp contract oeq float %31, 0.000000e+00
  %38 = fdiv contract float %32, %31
  %39 = select contract i1 %37, float 0.000000e+00, float %38

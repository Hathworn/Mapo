; ModuleID = '../data/hip_kernels/15412/113/main.cu'
source_filename = "../data/hip_kernels/15412/113/main.cu"
...
162:                                              ; preds = %137, %143, %157, %158, %159, %160, %161
  ...
  %178 = fpext float %10 to double
  br label %179

179:                                              ; preds = %35, %162
  %180 = phi float [ %169, %162 ], [ %86, %35 ]
  %181 = phi float [ %173, %162 ], [ %92, %35 ]
  %182 = phi float [ %177, %162 ], [ %99, %35 ]
  %183 = phi double [ %178, %162 ], [ 0.000000e+00, %35 ]
  %184 = fmul contract float %180, %9
  %185 = fadd contract float %184, %8
  %186 = fpext float %185 to double
  %187 = fpext float %45 to double
  %188 = fadd contract double %187, -5.000000e-01
  %189 = fmul contract double %188, %183
  %190 = fadd contract double %189, %186
  %191 = fptrunc double %190 to float
  store float %191, float addrspace(1)* %85, align 4, !tbaa !16
  %192 = fmul contract float %181, %9
  %193 = fadd contract float %192, %8
  %194 = fpext float %193 to double
  %195 = fpext float %47 to double
  %196 = fadd contract double %195, -5.000000e-01
  %197 = fmul contract double %196, %183
  %198 = fadd contract double %197, %194
  %199 = fptrunc double %198 to float
  store float %199, float addrspace(1)* %91, align 4, !tbaa !16
  %200 = fmul contract float %182, %9
  %201 = fadd contract float %200, %8
  %202 = fpext float %201 to double
  %203 = fpext float %49 to double
  %204 = fadd contract double %203, -5.000000e-01
  %205 = fmul contract double %204, %183
  %206 = fadd contract double %205, %202
  %207 = fptrunc double %206 to float
  store float %207, float addrspace(1)* %98, align 4, !tbaa !16
  br label %208

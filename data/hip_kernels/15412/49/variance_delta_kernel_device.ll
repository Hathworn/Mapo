; ModuleID = '../data/hip_kernels/15412/49/main.cu'
source_filename = "../data/hip_kernels/15412/49/main.cu"
...
167:                                              ; preds = %163, %30
  ...
  %170 = fadd contract float %169, 0x3EB0C6F7A0000000
  ...
  %316 = select i1 %314, float %315, float 0x7FF8000000000000
  %317 = fcmp oeq float %171, 0x7FF0000000000000
  %318 = fcmp oeq float %170, 0.000000e+00
  %319 = select i1 %317, float 0.000000e+00, float %316
  %320 = select i1 %318, float 0x7FF0000000000000, float %319
  %321 = fcmp uno float %170, 0.000000e+00
  %322 = select i1 %321, float 0x7FF8000000000000, float %320
  %323 = fcmp oeq float %170, 1.000000e+00
  %324 = select i1 %323, float 1.000000e+00, float %322
  %325 = fpext float %324 to double
  %326 = fmul contract double %325, -5.000000e-01
  %327 = load float, float addrspace(1)* %32, align 4, !tbaa !16
  %328 = fpext float %327 to double
  %329 = fmul contract double %326, %328
  %330 = fptrunc double %329 to float
  store float %330, float addrspace(1)* %32, align 4, !tbaa !16
  br label %331

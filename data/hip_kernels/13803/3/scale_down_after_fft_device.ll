; ModuleID = '../data/hip_kernels/13803/3/main.cu'
source_filename = "../data/hip_kernels/13803/3/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z20scale_down_after_fftPfS_S_ii(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture %1, float addrspace(1)* nocapture %2, i32 %3, i32 %4) local_unnamed_addr #0 {
  ...
  %28 = mul i32 %23, %27
  %29 = tail call i32 @llvm.amdgcn.workitem.id.z(), !range !6
  %30 = add i32 %28, %29
  %31 = icmp slt i32 %14, %3
  %32 = icmp slt i32 %22, %3
  %33 = select i1 %31, i1 %32, i1 false
  %34 = icmp slt i32 %30, %3
...
36:                                               ; preds = %5
  ...
  %51 = fdiv contract float %50, %41
  store float %51, float addrspace(1)* %49, align 4, !tbaa !7
  br label %52

; ModuleID = '../data/hip_kernels/3285/6/main.cu'
source_filename = "../data/hip_kernels/3285/6/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [89 x i8] c"blockIdx:(%d, %d, %d) threadIdx:(%d, %d, %d) blockDim:(%d, %d, %d) gridDim:(%d, %d, %d)\0A\00", align 1
...
479:                                              ; preds = %468, %34
  ...
  %492 = add i32 %23, %491
  %493 = tail call i32 @llvm.amdgcn.workitem.id.z(), !range !21
  %494 = tail call i32 @llvm.amdgcn.workitem.id.y(), !range !21
  %495 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !21
  %496 = tail call i32 @llvm.amdgcn.workgroup.id.z()
  %497 = tail call i32 @llvm.amdgcn.workgroup.id.y()
  %498 = tail call i32 @llvm.amdgcn.workgroup.id.x()

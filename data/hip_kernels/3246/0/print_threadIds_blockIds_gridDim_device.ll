; ModuleID = '../data/hip_kernels/3246/0/main.cu'
source_filename = "../data/hip_kernels/3246/0/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [143 x i8] c"threadIdx.x: %d, threadIdx.y: %d, threadIdx.z: %d,blockIdx.x: %d, blockIdx.y: %d, blockIdx.z: %d,gridDim.x: %d, gridDim.y: %d, gridDim.z: %d \0A\00", align 1
...
define protected amdgpu_kernel void @_Z32print_threadIds_blockIds_gridDimv() local_unnamed_addr #1 {
  ...
  %8 = zext i16 %7 to i32
  %9 = udiv i32 %4, %8
  %10 = getelementptr inbounds i8, i8 addrspace(4)* %1, i64 16
  %11 = bitcast i8 addrspace(4)* %10 to i32 addrspace(4)*
  %12 = load i32, i32 addrspace(4)* %11, align 8, !tbaa !15
  %13 = getelementptr i8, i8 addrspace(4)* %1, i64 6
  %14 = bitcast i8 addrspace(4)* %13 to i16 addrspace(4)*
  %15 = load i16, i16 addrspace(4)* %14, align 2, !range !13, !invariant.load !14
  %16 = zext i16 %15 to i32
  %17 = udiv i32 %12, %16
  %18 = getelementptr inbounds i8, i8 addrspace(4)* %1, i64 20
  %19 = bitcast i8 addrspace(4)* %18 to i32 addrspace(4)*
  %20 = load i32, i32 addrspace(4)* %19, align 4, !tbaa !16
  %21 = getelementptr i8, i8 addrspace(4)* %1, i64 8
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([143 x i8], [143 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %43, label %34

34:                                               ; preds = %0, %34
  %35 = phi i8 addrspace(4)* [ %36, %34 ], [ getelementptr inbounds ([143 x i8], [143 x i8] addrspace(4)* @.str, i64 0, i64 0), %0 ]
...
39:                                               ; preds = %34
  ...
  %42 = add i64 %41, add (i64 sub (i64 0, i64 ptrtoint ([143 x i8]* addrspacecast ([143 x i8] addrspace(4)* @.str to [143 x i8]*) to i64)), i64 1)
  br label %43

43:                                               ; preds = %39, %0
  %44 = phi i64 [ %42, %39 ], [ 0, %0 ]
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([143 x i8], [143 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %45, label %49
...
53:                                               ; preds = %479, %49
  ...
  %55 = phi i8 addrspace(4)* [ getelementptr inbounds ([143 x i8], [143 x i8] addrspace(4)* @.str, i64 0, i64 0), %49 ], [ %488, %479 ]
...
490:                                              ; preds = %479, %45
  ...
  %492 = mul i32 %25, %24
  %493 = icmp ugt i32 %20, %492
  %494 = zext i1 %493 to i32
  %495 = add i32 %25, %494
  %496 = mul i32 %17, %16
  %497 = icmp ugt i32 %12, %496
  %498 = zext i1 %497 to i32
  %499 = add i32 %17, %498
  %500 = mul i32 %9, %8
  %501 = icmp ugt i32 %4, %500
...
!24 = !{i64 2662}
!25 = !{!26, !11, i64 0}
!26 = !{!"", !11, i64 0, !11, i64 8, !12, i64 16, !10, i64 24, !10, i64 32, !10, i64 40}
!27 = !{!26, !10, i64 40}
!28 = !{!26, !11, i64 8}
!29 = !{!"exec"}
!30 = !{!31, !9, i64 16}
!31 = !{!"", !10, i64 0, !10, i64 8, !9, i64 16, !9, i64 20}
!32 = !{!31, !10, i64 8}
!33 = !{!31, !9, i64 20}
!34 = !{!31, !10, i64 0}
!35 = !{!36, !10, i64 16}
!36 = !{!"amd_signal_s", !10, i64 0, !7, i64 8, !10, i64 16, !9, i64 24, !9, i64 28, !10, i64 32, !10, i64 40, !7, i64 48, !7, i64 56}
!37 = !{!36, !9, i64 24}

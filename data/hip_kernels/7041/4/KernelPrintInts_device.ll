; ModuleID = '../data/hip_kernels/7041/4/main.cu'
source_filename = "../data/hip_kernels/7041/4/main.cu"
...
define protected amdgpu_kernel void @_Z15KernelPrintIntsPKii(i32 addrspace(1)* nocapture readonly %0, i32 %1) local_unnamed_addr #1 {
  %3 = icmp sgt i32 %1, 0
...
12:                                               ; preds = %4, %464
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([4 x i8], [4 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %19, label %23

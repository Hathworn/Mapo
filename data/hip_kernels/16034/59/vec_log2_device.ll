; ModuleID = '../data/hip_kernels/16034/59/main.cu'
source_filename = "../data/hip_kernels/16034/59/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @vec_log2(i32 %0, double addrspace(1)* nocapture writeonly %1, double addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
...
32:                                               ; preds = %3
  ...
  %88 = fmul double %84, 0x3FF71547652B82FE
  %89 = fneg double %88
  %90 = tail call double @llvm.fma.f64(double %84, double 0x3FF71547652B82FE, double %89)
  %91 = tail call double @llvm.fma.f64(double %86, double 0x3FF71547652B82FE, double %90)
  %92 = tail call double @llvm.fma.f64(double %84, double 0x3C7777D0FFDA0D24, double %91)
  %93 = fadd double %88, %92
  %94 = fsub double %93, %88
  %95 = fsub double %92, %94
  %96 = fadd double %93, %87
  %97 = fsub double %96, %87
  %98 = fsub double %97, %96
  %99 = fadd double %98, %87
  %100 = fsub double %93, %97
  %101 = fadd double %100, %99
  %102 = fadd double %95, %101
  %103 = fadd double %96, %102
  %104 = tail call double @llvm.fabs.f64(double %35) #3
  %105 = fcmp oeq double %104, 0x7FF0000000000000
  %106 = select i1 %105, double %35, double %103
  %107 = fcmp olt double %35, 0.000000e+00
  %108 = select i1 %107, double 0x7FF8000000000000, double %106
  %109 = fcmp oeq double %35, 0.000000e+00
  %110 = select i1 %109, double 0xFFF0000000000000, double %108
  %111 = getelementptr inbounds double, double addrspace(1)* %1, i64 %33

; ModuleID = '../data/hip_kernels/16034/115/main.cu'
source_filename = "../data/hip_kernels/16034/115/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @vec_divScalarMany_f(i32 %0, i32 %1, float addrspace(1)* nocapture writeonly %2, double addrspace(1)* nocapture writeonly %3, float addrspace(1)* nocapture readonly %4, float addrspace(1)* nocapture readonly %5) local_unnamed_addr #0 {
...
41:                                               ; preds = %35
  ...
  %45 = fdiv contract float %44, %39
  %46 = getelementptr inbounds float, float addrspace(1)* %2, i64 %42
  store float %45, float addrspace(1)* %46, align 4, !tbaa !16
  %47 = getelementptr inbounds double, double addrspace(1)* %3, i64 %42
  %48 = fpext float %45 to double
  store double %48, double addrspace(1)* %47, align 8, !tbaa !20
  br label %49

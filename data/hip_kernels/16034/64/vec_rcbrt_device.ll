; ModuleID = '../data/hip_kernels/16034/64/main.cu'
source_filename = "../data/hip_kernels/16034/64/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @vec_rcbrt(i32 %0, double addrspace(1)* nocapture writeonly %1, double addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
...
32:                                               ; preds = %3
  ...
  %46 = fmul float %45, 0xBFD5555560000000
  ...
  %53 = tail call double @llvm.fma.f64(double %52, double 0x3FCC71C71C71C8B2, double 0x3FD5555555555685)
  %54 = fmul double %52, %53
  %55 = tail call double @llvm.fma.f64(double %48, double %54, double %48)
  %56 = sub nsw i32 0, %41
  %57 = tail call double @llvm.amdgcn.ldexp.f64(double %55, i32 %56)
  %58 = tail call i1 @llvm.amdgcn.class.f64(double %43, i32 512)
  ...
  %62 = tail call double @llvm.copysign.f64(double %61, double %35)
  %63 = getelementptr inbounds double, double addrspace(1)* %1, i64 %33
  store double %62, double addrspace(1)* %63, align 8, !tbaa !16
  br label %64

...
#include "vec_computePSF_signalN2_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
vec_computePSF_signalN2<<<gridBlock, threadBlock>>>(n,divide,sparseIndexEvenShiftOutput,sparseIndexOddShiftOutput,fft,sparseIndexEvenShiftOutputNext,sparseIndexOddShiftOutputNext,psffft);

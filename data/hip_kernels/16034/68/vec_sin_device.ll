; ModuleID = '../data/hip_kernels/16034/68/main.cu'
source_filename = "../data/hip_kernels/16034/68/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @vec_sin(i32 %0, double addrspace(1)* nocapture writeonly %1, double addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
...
133:                                              ; preds = %38, %57
  ...
  %165 = select i1 %164, double %162, double %151
  %166 = bitcast double %165 to <2 x i32>
  %167 = shl i32 %136, 30
  %168 = bitcast double %35 to <2 x i32>
  %169 = extractelement <2 x i32> %168, i64 1
  %170 = xor i32 %167, %169
  %171 = and i32 %170, -2147483648
  %172 = extractelement <2 x i32> %166, i64 1
  %173 = xor i32 %172, %171
  %174 = insertelement <2 x i32> %166, i32 %173, i64 1
  %175 = tail call i1 @llvm.amdgcn.class.f64(double %36, i32 504)
  %176 = select i1 %175, <2 x i32> %174, <2 x i32> <i32 0, i32 2146959360>
  %177 = getelementptr inbounds double, double addrspace(1)* %1, i64 %33
  %178 = bitcast double addrspace(1)* %177 to <2 x i32> addrspace(1)*
  store <2 x i32> %176, <2 x i32> addrspace(1)* %178, align 8, !tbaa !16
  br label %179

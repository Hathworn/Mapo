...
#include "vec_computePSF_phaseNMany_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
vec_computePSF_phaseNMany<<<gridBlock, threadBlock>>>(n,sizePart,sizeTot,kx,ky,kz,pupil,phase,position,sparseIndexEvenDisk,sparseIndexOddDisk,fft,many);

; ModuleID = '../data/hip_kernels/16034/57/main.cu'
source_filename = "../data/hip_kernels/16034/57/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @vec_log10(i32 %0, double addrspace(1)* nocapture writeonly %1, double addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
...
32:                                               ; preds = %3
  ...
  %88 = fmul double %87, 0x3FD34413509F79FF
  %89 = fneg double %88
  %90 = tail call double @llvm.fma.f64(double %87, double 0x3FD34413509F79FF, double %89)
  %91 = tail call double @llvm.fma.f64(double %87, double 0xBC49DC1DA994FD21, double %90)
  %92 = fadd double %88, %91
  %93 = fsub double %92, %88
  %94 = fsub double %91, %93
  %95 = fmul double %84, 0x3FDBCB7B1526E50E
  %96 = fneg double %95
  %97 = tail call double @llvm.fma.f64(double %84, double 0x3FDBCB7B1526E50E, double %96)
  %98 = tail call double @llvm.fma.f64(double %86, double 0x3FDBCB7B1526E50E, double %97)
  %99 = tail call double @llvm.fma.f64(double %84, double 0x3C695355BAAAFAD3, double %98)
  %100 = fadd double %95, %99
  %101 = fsub double %100, %95
  %102 = fsub double %99, %101
  %103 = fadd double %92, %100
  %104 = fsub double %103, %92
  %105 = fsub double %103, %104
  %106 = fsub double %92, %105
  %107 = fsub double %100, %104
  %108 = fadd double %107, %106
  %109 = fadd double %94, %102
  %110 = fsub double %109, %94
  ...
  %121 = tail call double @llvm.fabs.f64(double %35) #3
  %122 = fcmp oeq double %121, 0x7FF0000000000000
  %123 = select i1 %122, double %35, double %120
  %124 = fcmp olt double %35, 0.000000e+00
  %125 = select i1 %124, double 0x7FF8000000000000, double %123
  %126 = fcmp oeq double %35, 0.000000e+00
  %127 = select i1 %126, double 0xFFF0000000000000, double %125
  %128 = getelementptr inbounds double, double addrspace(1)* %1, i64 %33

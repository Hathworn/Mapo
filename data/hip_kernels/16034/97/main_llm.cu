...
#include "vec_computePSF_signalN_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
vec_computePSF_signalN<<<gridBlock, threadBlock>>>(n,result,divide,sparseIndexEvenShiftOutput,sparseIndexOddShiftOutput,fft);

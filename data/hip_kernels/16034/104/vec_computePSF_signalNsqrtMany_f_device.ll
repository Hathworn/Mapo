; ModuleID = '../data/hip_kernels/16034/104/main.cu'
source_filename = "../data/hip_kernels/16034/104/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @vec_computePSF_signalNsqrtMany_f(i32 %0, i32 %1, float addrspace(1)* nocapture writeonly %2, float addrspace(1)* nocapture readonly %3, float %4, i32 addrspace(1)* nocapture readonly %5, i32 addrspace(1)* nocapture readonly %6) local_unnamed_addr #0 {
...
37:                                               ; preds = %7
  ...
  %47 = load float, float addrspace(1)* %46, align 4, !tbaa !20, !amdgpu.noclobber !6
  %48 = fdiv contract float %47, %4
  ...
  %54 = load float, float addrspace(1)* %53, align 4, !tbaa !20, !amdgpu.noclobber !6
  %55 = fdiv contract float %54, %4
  %56 = fmul contract float %48, %48
  ...
  store float %79, float addrspace(1)* %81, align 4, !tbaa !20
  br label %82

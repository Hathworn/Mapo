; ModuleID = '../data/hip_kernels/16034/112/main.cu'
source_filename = "../data/hip_kernels/16034/112/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @vec_computeModelMany1_scmos(i32 %0, i32 %1, double addrspace(1)* nocapture writeonly %2, double addrspace(1)* nocapture readonly %3, double addrspace(1)* nocapture readonly %4, double %5, double addrspace(1)* nocapture readonly %6) local_unnamed_addr #0 {
...
36:                                               ; preds = %7
  ...
  %49 = fadd contract double %48, %5
  %50 = sext i32 %41 to i64
  %51 = getelementptr inbounds double, double addrspace(1)* %6, i64 %50
  %52 = load double, double addrspace(1)* %51, align 8, !tbaa !16, !amdgpu.noclobber !6
  %53 = fadd contract double %52, %49
  %54 = getelementptr inbounds double, double addrspace(1)* %2, i64 %42

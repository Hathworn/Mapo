; ModuleID = '../data/hip_kernels/16034/99/main.cu'
source_filename = "../data/hip_kernels/16034/99/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @vec_computePSF_signalN2Many(i32 %0, i32 %1, i32 %2, double %3, i32 addrspace(1)* nocapture readonly %4, i32 addrspace(1)* nocapture readonly %5, double addrspace(1)* nocapture readonly %6, i32 addrspace(1)* nocapture readonly %7, i32 addrspace(1)* nocapture readonly %8, double addrspace(1)* nocapture writeonly %9) local_unnamed_addr #0 {
...
39:                                               ; preds = %10
  ...
  %52 = load double, double addrspace(1)* %51, align 8, !tbaa !20, !amdgpu.noclobber !6
  %53 = fdiv contract double %52, %3
  ...
  %58 = getelementptr inbounds double, double addrspace(1)* %6, i64 %57
  %59 = load double, double addrspace(1)* %58, align 8, !tbaa !20, !amdgpu.noclobber !6
  %60 = fdiv contract double %59, %3
  %61 = fmul contract double %53, %53
  %62 = fmul contract double %60, %60
  ...
  %70 = getelementptr inbounds double, double addrspace(1)* %9, i64 %69
  store double %63, double addrspace(1)* %70, align 8, !tbaa !20
  ...
  %75 = getelementptr inbounds double, double addrspace(1)* %9, i64 %74
  store double 0.000000e+00, double addrspace(1)* %75, align 8, !tbaa !20
  br label %76

; ModuleID = '../data/hip_kernels/16034/69/main.cu'
source_filename = "../data/hip_kernels/16034/69/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @vec_sinh(i32 %0, double addrspace(1)* nocapture writeonly %1, double addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
...
32:                                               ; preds = %3
  ...
  %155 = fsub double %109, %153
  %156 = fsub double %109, %155
  %157 = fsub double %156, %153
  %158 = fadd double %110, %157
  ...
  %163 = fcmp olt double %36, 0x3E40000000000000
  %164 = select i1 %163, double %36, double %162
  %165 = tail call double @llvm.copysign.f64(double %164, double %35)
  %166 = getelementptr inbounds double, double addrspace(1)* %1, i64 %33
  store double %165, double addrspace(1)* %166, align 8, !tbaa !16
  br label %167

; ModuleID = '../data/hip_kernels/16034/42/main.cu'
source_filename = "../data/hip_kernels/16034/42/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @vec_cospi(i32 %0, double addrspace(1)* nocapture writeonly %1, double addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
...
32:                                               ; preds = %3
  ...
  %65 = and i32 %47, 1
  %66 = icmp eq i32 %65, 0
  %67 = select i1 %66, double %63, double %64
  %68 = bitcast double %67 to <2 x i32>
  %69 = shl i32 %47, 30
  %70 = and i32 %69, -2147483648
  %71 = extractelement <2 x i32> %68, i64 1
  %72 = xor i32 %71, %70
  %73 = insertelement <2 x i32> %68, i32 %72, i64 1
  %74 = tail call i1 @llvm.amdgcn.class.f64(double %36, i32 504)
  %75 = select i1 %74, <2 x i32> %73, <2 x i32> <i32 0, i32 2146959360>
  %76 = getelementptr inbounds double, double addrspace(1)* %1, i64 %33
  %77 = bitcast double addrspace(1)* %76 to <2 x i32> addrspace(1)*
  store <2 x i32> %75, <2 x i32> addrspace(1)* %77, align 8, !tbaa !16
  br label %78

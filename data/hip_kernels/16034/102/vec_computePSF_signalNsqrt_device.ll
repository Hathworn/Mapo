; ModuleID = '../data/hip_kernels/16034/102/main.cu'
source_filename = "../data/hip_kernels/16034/102/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @vec_computePSF_signalNsqrt(i32 %0, double addrspace(1)* nocapture writeonly %1, double addrspace(1)* nocapture readonly %2, double %3, i32 addrspace(1)* nocapture readonly %4, i32 addrspace(1)* nocapture readonly %5) local_unnamed_addr #0 {
...
35:                                               ; preds = %6
  ...
  %41 = load double, double addrspace(1)* %40, align 8, !tbaa !20, !amdgpu.noclobber !6
  %42 = fdiv contract double %41, %3
  %43 = getelementptr inbounds i32, i32 addrspace(1)* %5, i64 %36
  ...
  %48 = fdiv contract double %47, %3
  %49 = fmul contract double %42, %42
  %50 = fmul contract double %48, %48
  ...
  %74 = getelementptr inbounds double, double addrspace(1)* %1, i64 %36
  store double %73, double addrspace(1)* %74, align 8, !tbaa !20
  br label %75

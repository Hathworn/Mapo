...
#include "prepareDiagonalPottsProblems8ADMM_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
prepareDiagonalPottsProblems8ADMM<<<gridBlock, threadBlock>>>(in,u,v,w_,z,weights,weightsPrime,lam2,lam4,lam6,mu,w,h,nc);

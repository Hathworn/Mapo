...
#include "prepareHorizontalPottsProblems8ADMM_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
prepareHorizontalPottsProblems8ADMM<<<gridBlock, threadBlock>>>(in,u,v,w_,z,weights,weightsPrime,lam1,lam2,lam3,mu,w,h,nc);

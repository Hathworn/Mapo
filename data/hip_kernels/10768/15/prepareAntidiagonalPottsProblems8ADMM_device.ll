; ModuleID = '../data/hip_kernels/10768/15/main.cu'
source_filename = "../data/hip_kernels/10768/15/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z37prepareAntidiagonalPottsProblems8ADMMPfS_S_S_S_S_S_S_S_S_fjjj(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, float addrspace(1)* nocapture writeonly %4, float addrspace(1)* nocapture readonly %5, float addrspace(1)* nocapture readonly %6, float addrspace(1)* nocapture readonly %7, float addrspace(1)* nocapture readonly %8, float addrspace(1)* nocapture readonly %9, float %10, i32 %11, i32 %12, i32 %13) local_unnamed_addr #0 {
...
45:                                               ; preds = %14
  ...
  %64 = getelementptr inbounds float, float addrspace(1)* %3, i64 %54
  ...
  %71 = getelementptr inbounds float, float addrspace(1)* %8, i64 %54
  %72 = load float, float addrspace(1)* %71, align 4, !tbaa !7, !amdgpu.noclobber !6
  %73 = fadd contract float %70, %72
  %74 = getelementptr inbounds float, float addrspace(1)* %9, i64 %54
  ...
  %79 = getelementptr inbounds float, float addrspace(1)* %6, i64 %51
  %80 = load float, float addrspace(1)* %79, align 4, !tbaa !7, !amdgpu.noclobber !6
  %81 = fdiv contract float %78, %80
  %82 = getelementptr inbounds float, float addrspace(1)* %4, i64 %54

...
#include "prepareAntidiagonalPottsProblems8ADMM_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
prepareAntidiagonalPottsProblems8ADMM<<<gridBlock, threadBlock>>>(in,u,v,w_,z,weights,weightsPrime,lam3,lam5,lam6,mu,w,h,nc);

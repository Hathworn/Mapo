; ModuleID = '../data/hip_kernels/10768/19/main.cu'
source_filename = "../data/hip_kernels/10768/19/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z35updateLagrangeMultiplierKernel4ADMMPfS_S_S_fjjj(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture %2, float addrspace(1)* nocapture writeonly %3, float %4, i32 %5, i32 %6, i32 %7) local_unnamed_addr #0 {
  ...
  %24 = mul i32 %19, %23
  %25 = add i32 %24, %18
  %26 = tail call i32 @llvm.amdgcn.workitem.id.z(), !range !4
  %27 = tail call i32 @llvm.amdgcn.workgroup.id.z()
  %28 = getelementptr i8, i8 addrspace(4)* %10, i64 8

...
#include "BernoulliNBLearnKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
BernoulliNBLearnKernel<<<gridBlock, threadBlock>>>(feature_probs,class_count_,d_row_sums,n_samples_,n_classes_,n_features_);

; ModuleID = '../data/hip_kernels/17141/0/main.cu'
source_filename = "../data/hip_kernels/17141/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z19GaussianNBSumKernelPKfPKiPfPijjj(float addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture %2, i32 addrspace(1)* nocapture %3, i32 %4, i32 %5, i32 %6) local_unnamed_addr #0 {
...
97:                                               ; preds = %97, %30
  ...
  store i32 %117, i32 addrspace(1)* %115, align 4, !tbaa !7
  %118 = or i32 %98, 1
  ...
  %134 = getelementptr inbounds i32, i32 addrspace(1)* %3, i64 %133
  ...
  store i32 %155, i32 addrspace(1)* %153, align 4, !tbaa !7
  %156 = or i32 %98, 3
  ...
  %172 = getelementptr inbounds i32, i32 addrspace(1)* %3, i64 %171
...
181:                                              ; preds = %178, %181
  ...
  %199 = getelementptr inbounds i32, i32 addrspace(1)* %3, i64 %198
  %200 = load i32, i32 addrspace(1)* %199, align 4, !tbaa !7
  %201 = add nsw i32 %200, 1
  store i32 %201, i32 addrspace(1)* %199, align 4, !tbaa !7
...
208:                                              ; preds = %205, %208
  ...
  %213 = load i32, i32 addrspace(1)* %212, align 4, !tbaa !7
  %214 = mul i32 %209, %6
  %215 = add i32 %214, %16

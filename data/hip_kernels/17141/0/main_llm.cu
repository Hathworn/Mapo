...
#include "GaussianNBSumKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
GaussianNBSumKernel<<<gridBlock, threadBlock>>>(d_data,d_labels,feature_means_,class_count_,n_samples_,n_classes_,n_features_);

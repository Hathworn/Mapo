; ModuleID = '../data/hip_kernels/18325/3/main.cu'
source_filename = "../data/hip_kernels/18325/3/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [135 x i8] c"blockIdx.x: %d, blockIdx.y: %d, blockIdx: %d, blockDim.x: %d, blockDim.y: %d, blockDim: %d, gridDim.x: %d, gridDim.y: %d, girdDim: %d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z13print_detailsv() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([135 x i8], [135 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %43, label %34

34:                                               ; preds = %0, %34
  %35 = phi i8 addrspace(4)* [ %36, %34 ], [ getelementptr inbounds ([135 x i8], [135 x i8] addrspace(4)* @.str, i64 0, i64 0), %0 ]
...
39:                                               ; preds = %34
  ...
  %42 = add i64 %41, add (i64 sub (i64 0, i64 ptrtoint ([135 x i8]* addrspacecast ([135 x i8] addrspace(4)* @.str to [135 x i8]*) to i64)), i64 1)
  br label %43

43:                                               ; preds = %39, %0
  %44 = phi i64 [ %42, %39 ], [ 0, %0 ]
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([135 x i8], [135 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %45, label %49
...
53:                                               ; preds = %479, %49
  ...
  %55 = phi i8 addrspace(4)* [ getelementptr inbounds ([135 x i8], [135 x i8] addrspace(4)* @.str, i64 0, i64 0), %49 ], [ %488, %479 ]
...
490:                                              ; preds = %479, %45
  ...
  %507 = extractelement <2 x i64> %491, i64 0
  %508 = zext i32 %506 to i64
  %509 = and i64 %507, -225
  %510 = or i64 %509, 32
  %511 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %510, i64 noundef %508, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %512 = extractelement <2 x i64> %511, i64 0
  %513 = zext i32 %505 to i64
  %514 = and i64 %512, -225
  %515 = or i64 %514, 32
  %516 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %515, i64 noundef %513, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %517 = extractelement <2 x i64> %516, i64 0
  %518 = zext i32 %504 to i64
  %519 = and i64 %517, -225
  %520 = or i64 %519, 32
  %521 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %520, i64 noundef %518, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %522 = extractelement <2 x i64> %521, i64 0
  %523 = zext i16 %4 to i64
  %524 = and i64 %522, -225
  %525 = or i64 %524, 32
  %526 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %525, i64 noundef %523, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %527 = extractelement <2 x i64> %526, i64 0
  %528 = zext i16 %11 to i64
  %529 = and i64 %527, -225
  %530 = or i64 %529, 32
  %531 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %530, i64 noundef %528, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %532 = extractelement <2 x i64> %531, i64 0
  %533 = zext i16 %18 to i64
  %534 = and i64 %532, -225
  %535 = or i64 %534, 32
  %536 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %535, i64 noundef %533, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %537 = extractelement <2 x i64> %536, i64 0
  %538 = zext i32 %503 to i64
  %539 = and i64 %537, -225
  %540 = or i64 %539, 32
  %541 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %540, i64 noundef %538, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %542 = extractelement <2 x i64> %541, i64 0
  %543 = zext i32 %499 to i64
  %544 = and i64 %542, -225
  %545 = or i64 %544, 32
  %546 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %545, i64 noundef %543, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %547 = extractelement <2 x i64> %546, i64 0
  %548 = zext i32 %495 to i64
  %549 = and i64 %547, -227
  %550 = or i64 %549, 34
  %551 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %550, i64 noundef %548, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}
...
!23 = !{i64 2662}
!24 = !{!25, !13, i64 0}
!25 = !{!"", !13, i64 0, !13, i64 8, !14, i64 16, !12, i64 24, !12, i64 32, !12, i64 40}
!26 = !{!25, !12, i64 40}
!27 = !{!25, !13, i64 8}
!28 = !{!"exec"}
!29 = !{!30, !11, i64 16}
!30 = !{!"", !12, i64 0, !12, i64 8, !11, i64 16, !11, i64 20}
!31 = !{!30, !12, i64 8}
!32 = !{!30, !11, i64 20}
!33 = !{!30, !12, i64 0}
!34 = !{!35, !12, i64 16}
!35 = !{!"amd_signal_s", !12, i64 0, !9, i64 8, !12, i64 16, !11, i64 24, !11, i64 28, !12, i64 32, !12, i64 40, !9, i64 48, !9, i64 56}
!36 = !{!35, !11, i64 24}

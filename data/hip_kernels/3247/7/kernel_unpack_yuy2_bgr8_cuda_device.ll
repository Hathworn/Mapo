; ModuleID = '../data/hip_kernels/3247/7/main.cu'
source_filename = "../data/hip_kernels/3247/7/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z28kernel_unpack_yuy2_bgr8_cudaPKhPhi(i8 addrspace(1)* nocapture readonly %0, i8 addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
23:                                               ; preds = %3, %23
  ...
  store i8 %54, i8 addrspace(1)* %57, align 1, !tbaa !16
  %58 = mul nsw i32 %43, -100
  ...
  store i8 %64, i8 addrspace(1)* %67, align 1, !tbaa !16
  %68 = mul nsw i32 %43, 516
  %69 = add nsw i32 %49, %68
  %70 = ashr i32 %69, 8
  %71 = tail call i32 @llvm.smax.i32(i32 %70, i32 0)
  %72 = tail call i32 @llvm.smin.i32(i32 %71, i32 255)
  %73 = trunc i32 %72 to i8
  %74 = sext i32 %45 to i64
  %75 = getelementptr inbounds i8, i8 addrspace(1)* %1, i64 %74
  store i8 %73, i8 addrspace(1)* %75, align 1, !tbaa !16

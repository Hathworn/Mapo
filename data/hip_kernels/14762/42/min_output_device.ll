; ModuleID = '../data/hip_kernels/14762/42/main.cu'
source_filename = "../data/hip_kernels/14762/42/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z10min_outputPfS_S_ll(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, float addrspace(1)* nocapture writeonly %2, i64 %3, i64 %4) local_unnamed_addr #0 {
...
29:                                               ; preds = %29, %27
  ...
  %36 = fcmp contract olt float %35, %32
  ...
  %42 = fcmp contract olt float %41, %37
  ...
  %48 = fcmp contract olt float %47, %43
  ...
  %54 = fcmp contract olt float %53, %49
  ...
  %60 = fcmp contract olt float %59, %55
  ...
  %66 = fcmp contract olt float %65, %61
  ...
  %72 = fcmp contract olt float %71, %67
  ...
  %78 = fcmp contract olt float %77, %73
...
91:                                               ; preds = %84, %91
  ...
  %98 = fcmp contract olt float %97, %94

; ModuleID = '../data/hip_kernels/14762/36/main.cu'
source_filename = "../data/hip_kernels/14762/36/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z20adaptivemaxgradinputPfS_S_S_iiiii(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8) local_unnamed_addr #0 {
...
51:                                               ; preds = %45, %95
  %52 = phi i32 [ %27, %45 ], [ %96, %95 ]
  br i1 %48, label %53, label %95
...
67:                                               ; preds = %53, %67
  ...
  store float %92, float addrspace(1)* %90, align 4, !tbaa !16
  %93 = add nuw nsw i32 %68, %16
  %94 = icmp slt i32 %93, %8
  br i1 %94, label %67, label %95, !llvm.loop !20

95:                                               ; preds = %67, %51
  %96 = add nsw i32 %52, %33
  %97 = icmp slt i32 %96, %7
  br i1 %97, label %51, label %98, !llvm.loop !22

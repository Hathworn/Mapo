; ModuleID = '../data/hip_kernels/415/3/main.cu'
source_filename = "../data/hip_kernels/415/3/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z15reduceUnrollingPiS_j(i32 addrspace(1)* nocapture %0, i32 addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
16:                                               ; preds = %3
  ...
  store i32 %23, i32 addrspace(1)* %21, align 4, !tbaa !7
  br label %24
...
35:                                               ; preds = %31
  ...
  %40 = load i32, i32 addrspace(1)* %28, align 4, !tbaa !7
  %41 = add nsw i32 %40, %39
  store i32 %41, i32 addrspace(1)* %28, align 4, !tbaa !7
  br label %42
...
42:                                               ; preds = %35, %31
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %43 = icmp ult i32 %32, 4
  br i1 %43, label %29, label %31, !llvm.loop !11

; ModuleID = '../data/hip_kernels/415/5/main.cu'
source_filename = "../data/hip_kernels/415/5/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z15reduceUnrollingPiS_jj(i32 addrspace(1)* nocapture %0, i32 addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3) local_unnamed_addr #0 {
...
30:                                               ; preds = %30, %28
  ...
  store i32 %39, i32 addrspace(1)* %23, align 4, !tbaa !7
  ...
  store i32 %46, i32 addrspace(1)* %23, align 4, !tbaa !7
  ...
  store i32 %53, i32 addrspace(1)* %23, align 4, !tbaa !7
  ...
  store i32 %60, i32 addrspace(1)* %23, align 4, !tbaa !7
  ...
  store i32 %67, i32 addrspace(1)* %23, align 4, !tbaa !7
  ...
  store i32 %74, i32 addrspace(1)* %23, align 4, !tbaa !7
  ...
  store i32 %81, i32 addrspace(1)* %23, align 4, !tbaa !7
...
92:                                               ; preds = %30, %21
  %93 = phi i32 [ %24, %21 ], [ %88, %30 ]
  %94 = phi i32 [ 1, %21 ], [ %89, %30 ]
  %95 = icmp eq i32 %26, 0
  br i1 %95, label %109, label %96

96:                                               ; preds = %92, %96
  %97 = phi i32 [ %105, %96 ], [ %93, %92 ]
  ...
  store i32 %105, i32 addrspace(1)* %23, align 4, !tbaa !7
...
120:                                              ; preds = %116
  ...
  %125 = load i32, i32 addrspace(1)* %113, align 4, !tbaa !7
  %126 = add nsw i32 %125, %124
  store i32 %126, i32 addrspace(1)* %113, align 4, !tbaa !7
  br label %127
...
129:                                              ; preds = %114
  ...
  store i32 %132, i32 addrspace(1)* %134, align 4, !tbaa !7
  br label %135

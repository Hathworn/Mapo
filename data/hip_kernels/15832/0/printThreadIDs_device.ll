; ModuleID = '../data/hip_kernels/15832/0/main.cu'
source_filename = "../data/hip_kernels/15832/0/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [41 x i8] c"\0A threadIdx.x : %d,   threadIdx.y :  %d \00", align 1
...
define protected amdgpu_kernel void @_Z14printThreadIDsv() local_unnamed_addr #1 {

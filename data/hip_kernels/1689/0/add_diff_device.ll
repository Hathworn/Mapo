; ModuleID = '../data/hip_kernels/1689/0/main.cu'
source_filename = "../data/hip_kernels/1689/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z8add_diffPfPKfS1_fi(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float %3, i32 %4) local_unnamed_addr #0 {
...
16:                                               ; preds = %5
  ...
  %24 = getelementptr inbounds float, float addrspace(1)* %0, i64 %17
  %25 = load float, float addrspace(1)* %24, align 4, !tbaa !7, !amdgpu.noclobber !5
  %26 = fadd contract float %25, %23
  store float %26, float addrspace(1)* %24, align 4, !tbaa !7
  br label %27

; ModuleID = '../data/hip_kernels/6430/0/main.cu'
source_filename = "../data/hip_kernels/6430/0/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [26 x i8] c"Hello World from GPU! %d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z10cuda_hellov() local_unnamed_addr #1 {
  ...
  %4 = load i32, i32 addrspace(4)* %3, align 4, !tbaa !4
  %5 = getelementptr i8, i8 addrspace(4)* %1, i64 4
  %6 = bitcast i8 addrspace(4)* %5 to i16 addrspace(4)*
  %7 = load i16, i16 addrspace(4)* %6, align 4, !range !13, !invariant.load !14
  %8 = zext i16 %7 to i32
  %9 = udiv i32 %4, %8
  ...
  %13 = load i64, i64 addrspace(4)* %12, align 8, !tbaa !15
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([26 x i8], [26 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %18, label %22
...
81:                                               ; preds = %39, %81
  ...
  %86 = load i8, i8 addrspace(4)* %85, align 1, !tbaa !16
...
141:                                              ; preds = %99, %141
  ...
  %146 = load i8, i8 addrspace(4)* %145, align 1, !tbaa !16
...
201:                                              ; preds = %159, %201
  ...
  %206 = load i8, i8 addrspace(4)* %205, align 1, !tbaa !16
...
261:                                              ; preds = %219, %261
  ...
  %266 = load i8, i8 addrspace(4)* %265, align 1, !tbaa !16
...
321:                                              ; preds = %279, %321
  ...
  %326 = load i8, i8 addrspace(4)* %325, align 1, !tbaa !16
...
381:                                              ; preds = %339, %381
  ...
  %386 = load i8, i8 addrspace(4)* %385, align 1, !tbaa !16
...
463:                                              ; preds = %452, %18
  ...
  %465 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !19
  %466 = mul i32 %9, %8
  %467 = icmp ugt i32 %4, %466
  %468 = zext i1 %467 to i32
  %469 = add i32 %9, %468
  %470 = mul i32 %469, %465
  %471 = extractelement <2 x i64> %464, i64 0
  %472 = zext i32 %470 to i64
  %473 = and i64 %471, -227
  %474 = or i64 %473, 34
  %475 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %15, i64 noundef %474, i64 noundef %472, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

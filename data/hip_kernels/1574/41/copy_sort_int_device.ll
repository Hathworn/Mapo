; ModuleID = '../data/hip_kernels/1574/41/main.cu'
source_filename = "../data/hip_kernels/1574/41/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z13copy_sort_intPKiPKjjPi(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 %2, i32 addrspace(1)* nocapture writeonly %3) local_unnamed_addr #0 {
  %5 = icmp eq i32 %2, 0
...
14:                                               ; preds = %11, %14
  ...
  store i32 %19, i32 addrspace(1)* %23, align 4, !tbaa !4
...
28:                                               ; preds = %28, %9
  ...
  store i32 %33, i32 addrspace(1)* %37, align 4, !tbaa !4
  %38 = or i32 %29, 1
  ...
  %45 = getelementptr inbounds i32, i32 addrspace(1)* %3, i64 %44
  store i32 %41, i32 addrspace(1)* %45, align 4, !tbaa !4
  %46 = or i32 %29, 2
  ...
  store i32 %49, i32 addrspace(1)* %53, align 4, !tbaa !4
  %54 = or i32 %29, 3
  ...
  store i32 %57, i32 addrspace(1)* %61, align 4, !tbaa !4
  %62 = or i32 %29, 4
  ...
  store i32 %65, i32 addrspace(1)* %69, align 4, !tbaa !4
  %70 = or i32 %29, 5
  ...
  store i32 %73, i32 addrspace(1)* %77, align 4, !tbaa !4
  %78 = or i32 %29, 6
  ...
  %85 = getelementptr inbounds i32, i32 addrspace(1)* %3, i64 %84
  store i32 %81, i32 addrspace(1)* %85, align 4, !tbaa !4
  %86 = or i32 %29, 7
  ...
  store i32 %89, i32 addrspace(1)* %93, align 4, !tbaa !4

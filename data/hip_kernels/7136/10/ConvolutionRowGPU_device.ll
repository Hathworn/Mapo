; ModuleID = '../data/hip_kernels/7136/10/main.cu'
source_filename = "../data/hip_kernels/7136/10/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z17ConvolutionRowGPUPfS_S_i(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, i32 %3) local_unnamed_addr #0 {
...
19:                                               ; preds = %7, %37
  %20 = phi i32 [ %9, %7 ], [ %39, %37 ]
  %21 = phi float [ 0.000000e+00, %7 ], [ %38, %37 ]
  %22 = add nsw i32 %20, %5
...
26:                                               ; preds = %19
  ...
  %36 = fadd contract float %21, %35
  br label %37

37:                                               ; preds = %26, %19
  %38 = phi float [ %36, %26 ], [ %21, %19 ]

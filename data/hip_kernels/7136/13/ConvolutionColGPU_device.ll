; ModuleID = '../data/hip_kernels/7136/13/main.cu'
source_filename = "../data/hip_kernels/7136/13/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z17ConvolutionColGPUPfS_S_iii(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, i32 %3, i32 %4, i32 %5) local_unnamed_addr #0 {
...
31:                                               ; preds = %25, %50
  ...
  %33 = phi float [ 0.000000e+00, %25 ], [ %51, %50 ]
...
50:                                               ; preds = %38, %31
  %51 = phi float [ %49, %38 ], [ %33, %31 ]
  store float %51, float addrspace(1)* %30, align 4, !tbaa !7
  %52 = add i32 %32, 1
  %53 = icmp eq i32 %32, %5

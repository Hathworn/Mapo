; ModuleID = '../data/hip_kernels/71/0/main.cu'
source_filename = "../data/hip_kernels/71/0/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [84 x i8] c"thread_id (%d, %d) block_id (%d, %d) coordinate (%d, %d) global index %2d ival %2d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z16printThreadIndexPiii(i32 addrspace(1)* nocapture readonly %0, i32 %1, i32 %2) local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([84 x i8], [84 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %34, label %38
...
42:                                               ; preds = %468, %38
  %43 = phi i64 [ select (i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([84 x i8], [84 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), i64 0, i64 add (i64 ptrtoint (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([84 x i8], [84 x i8] addrspace(4)* @.str, i64 0, i64 83) to i8*) to i64), i64 add (i64 sub (i64 0, i64 ptrtoint ([84 x i8]* addrspacecast ([84 x i8] addrspace(4)* @.str to [84 x i8]*) to i64)), i64 1))), %38 ], [ %476, %468 ]
  %44 = phi i8 addrspace(4)* [ getelementptr inbounds ([84 x i8], [84 x i8] addrspace(4)* @.str, i64 0, i64 0), %38 ], [ %477, %468 ]

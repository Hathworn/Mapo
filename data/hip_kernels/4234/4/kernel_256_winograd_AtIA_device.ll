; ModuleID = '../data/hip_kernels/4234/4/main.cu'
source_filename = "../data/hip_kernels/4234/4/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ24kernel_256_winograd_AtIAPfS_S_S_E4bias = internal unnamed_addr addrspace(3) global float undef, align 4
@_ZZ24kernel_256_winograd_AtIAPfS_S_S_E5scale = internal unnamed_addr addrspace(3) global float undef, align 4
@input = external hidden local_unnamed_addr addrspace(3) global [0 x float], align 4

; Function Attrs: convergent mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z24kernel_256_winograd_AtIAPfS_S_S_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture writeonly %3) local_unnamed_addr #0 {
  ...
  store float %24, float addrspace(3)* @_ZZ24kernel_256_winograd_AtIAPfS_S_S_E4bias, align 4, !tbaa !5
  ...
  store float %26, float addrspace(3)* @_ZZ24kernel_256_winograd_AtIAPfS_S_S_E5scale, align 4, !tbaa !5
...
112:                                              ; preds = %111
  %113 = load float, float addrspace(3)* @_ZZ24kernel_256_winograd_AtIAPfS_S_S_E5scale, align 4, !tbaa !5
...
133:                                              ; preds = %111
  %134 = load float, float addrspace(3)* @_ZZ24kernel_256_winograd_AtIAPfS_S_S_E5scale, align 4, !tbaa !5
  %135 = or i32 %10, 1
...
155:                                              ; preds = %153
  %156 = load float, float addrspace(3)* @_ZZ24kernel_256_winograd_AtIAPfS_S_S_E5scale, align 4, !tbaa !5
  %157 = or i32 %10, 1
...
177:                                              ; preds = %175
  %178 = load float, float addrspace(3)* @_ZZ24kernel_256_winograd_AtIAPfS_S_S_E5scale, align 4, !tbaa !5
  %179 = or i32 %10, 1
...
201:                                              ; preds = %177, %155, %133, %112
  ...
  %203 = phi i32 [ 1024, %177 ], [ 768, %155 ], [ 512, %133 ], [ 256, %112 ]
  %204 = load float, float addrspace(3)* @_ZZ24kernel_256_winograd_AtIAPfS_S_S_E4bias, align 4, !tbaa !5
  ...
  %208 = shl i32 %6, 10
  %209 = shl i32 %5, 14
  %210 = shl nuw nsw i32 %9, 12
  %211 = add nuw nsw i32 %210, 4096
  %212 = add i32 %209, %211
  %213 = add i32 %8, %203
  %214 = add i32 %213, %208
  %215 = add i32 %214, %212

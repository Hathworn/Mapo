; ModuleID = '../data/hip_kernels/1971/33/main.cu'
source_filename = "../data/hip_kernels/1971/33/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z20kernel_updateweightsiPdS_S_d(i32 %0, double addrspace(1)* nocapture writeonly %1, double addrspace(1)* nocapture readonly %2, double addrspace(1)* nocapture writeonly %3, double %4) local_unnamed_addr #0 {
...
16:                                               ; preds = %5
  %17 = fadd contract double %4, 1.000000e+00
  ...
  %22 = fadd contract double %21, %4
  %23 = fdiv contract double %17, %22
  %24 = getelementptr inbounds double, double addrspace(1)* %1, i64 %18
  store double %23, double addrspace(1)* %24, align 8, !tbaa !7
  %25 = tail call double @llvm.amdgcn.frexp.mant.f64(double %23)
  %26 = fcmp olt double %25, 0x3FE5555555555555
  %27 = zext i1 %26 to i32
  %28 = tail call double @llvm.amdgcn.ldexp.f64(double %25, i32 %27)
  %29 = tail call i32 @llvm.amdgcn.frexp.exp.i32.f64(double %23)
  ...
  %102 = tail call double @llvm.fabs.f64(double %23) #3
  %103 = fcmp oeq double %102, 0x7FF0000000000000
  %104 = select i1 %103, double %23, double %101
  %105 = fcmp olt double %23, 0.000000e+00
  %106 = select i1 %105, double 0x7FF8000000000000, double %104
  %107 = fcmp oeq double %23, 0.000000e+00
  %108 = select i1 %107, double 0xFFF0000000000000, double %106
  %109 = fsub contract double %23, %108
  %110 = getelementptr inbounds double, double addrspace(1)* %3, i64 %18
  store double %109, double addrspace(1)* %110, align 8, !tbaa !7
  br label %111

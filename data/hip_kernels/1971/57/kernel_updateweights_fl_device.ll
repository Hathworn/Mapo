; ModuleID = '../data/hip_kernels/1971/57/main.cu'
source_filename = "../data/hip_kernels/1971/57/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z23kernel_updateweights_fliPfS_S_f(i32 %0, float addrspace(1)* nocapture writeonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture writeonly %3, float %4) local_unnamed_addr #0 {
...
16:                                               ; preds = %5
  %17 = fadd contract float %4, 1.000000e+00
  ...
  %22 = fadd contract float %21, %4
  %23 = fdiv contract float %17, %22
  ...
  %37 = fsub float %35, %36
  %38 = fsub contract float %23, %37
  %39 = getelementptr inbounds float, float addrspace(1)* %3, i64 %18

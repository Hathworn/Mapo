; ModuleID = '../data/hip_kernels/16252/3/main.cu'
source_filename = "../data/hip_kernels/16252/3/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z32MatrixMultiplication__CudaKernelPiS_S_i(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture writeonly %2, i32 %3) local_unnamed_addr #0 {
...
33:                                               ; preds = %61, %28
  %34 = phi i32 [ undef, %28 ], [ %159, %61 ]
  %35 = phi i32 [ 0, %28 ], [ %160, %61 ]
  %36 = phi i32 [ 0, %28 ], [ %159, %61 ]
  %37 = icmp eq i32 %29, 0
  br i1 %37, label %56, label %38

38:                                               ; preds = %33, %38
  %39 = phi i32 [ %53, %38 ], [ %35, %33 ]
  %40 = phi i32 [ %52, %38 ], [ %36, %33 ]

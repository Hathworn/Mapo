; ModuleID = '../data/hip_kernels/11197/35/main.cu'
source_filename = "../data/hip_kernels/11197/35/main.cu"
...
27:                                               ; preds = %22
  ...
  %145 = fmul float %139, 0.000000e+00
  %146 = tail call float @llvm.fma.f32(float %141, float 2.000000e+00, float %145)
  %147 = fadd float %144, %146
  %148 = fadd float %142, %147
  %149 = fsub float %148, %142
  %150 = fsub float %147, %149
  %151 = tail call float @llvm.fabs.f32(float %142) #4
  %152 = fcmp oeq float %151, 0x7FF0000000000000
  %153 = select i1 %152, float %142, float %148
  %154 = tail call float @llvm.fabs.f32(float %153) #4
  ...
  %176 = tail call float @llvm.fabs.f32(float %174) #4
  ...
  %180 = fcmp oeq float %34, 0x7FF0000000000000
  %181 = fcmp oeq float %33, 0.000000e+00
  %182 = select i1 %180, float 0x7FF0000000000000, float %179
  %183 = select i1 %181, float 0.000000e+00, float %182
  %184 = fcmp uno float %33, 0.000000e+00

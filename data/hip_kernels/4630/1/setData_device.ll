; ModuleID = '../data/hip_kernels/4630/1/main.cu'
source_filename = "../data/hip_kernels/4630/1/main.cu"
...
define protected amdgpu_kernel void @_Z7setDataPii(i32 addrspace(1)* nocapture writeonly %0, i32 %1) local_unnamed_addr #0 {
...
24:                                               ; preds = %16, %24
  ...
  store i32 1, i32 addrspace(1)* %29, align 4, !tbaa !16
  %30 = add i32 %22, %25

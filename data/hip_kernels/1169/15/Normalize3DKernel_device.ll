; ModuleID = '../data/hip_kernels/1169/15/main.cu'
source_filename = "../data/hip_kernels/1169/15/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z17Normalize3DKernelPKtPKfS2_Pffiii(i16 addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture writeonly %3, float %4, i32 %5, i32 %6, i32 %7) local_unnamed_addr #0 {
  ...
  %31 = mul i32 %26, %30
  %32 = tail call i32 @llvm.amdgcn.workitem.id.z(), !range !6
  %33 = add i32 %31, %32
  %34 = mul nsw i32 %33, %6
  ...
  %42 = fcmp contract ult float %41, %4
  br i1 %42, label %51, label %43

43:                                               ; preds = %8
  %44 = getelementptr inbounds float, float addrspace(1)* %1, i64 %38
  %45 = load float, float addrspace(1)* %44, align 4, !tbaa !11, !amdgpu.noclobber !5
  %46 = fsub contract float %41, %45
  %47 = getelementptr inbounds float, float addrspace(1)* %2, i64 %38
  %48 = load float, float addrspace(1)* %47, align 4, !tbaa !11, !amdgpu.noclobber !5
  %49 = fsub contract float %48, %45
  %50 = fdiv contract float %46, %49
  br label %51

51:                                               ; preds = %8, %43
  %52 = phi contract float [ %50, %43 ], [ 0.000000e+00, %8 ]
  %53 = getelementptr inbounds float, float addrspace(1)* %3, i64 %38

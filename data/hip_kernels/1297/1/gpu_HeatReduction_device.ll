; ModuleID = '../data/hip_kernels/1297/1/main.cu'
source_filename = "../data/hip_kernels/1297/1/main.cu"
...
define protected amdgpu_kernel void @_Z17gpu_HeatReductionPfS_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {

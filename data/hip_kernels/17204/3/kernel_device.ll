; ModuleID = '../data/hip_kernels/17204/3/main.cu'
source_filename = "../data/hip_kernels/17204/3/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn writeonly
define protected amdgpu_kernel void @_Z6kernelPfS_S_m(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture writeonly %1, float addrspace(1)* nocapture writeonly %2, i64 %3) local_unnamed_addr #0 {
...
34:                                               ; preds = %4
  %35 = getelementptr inbounds float, float addrspace(1)* %0, i64 %32
  store float 5.000000e-01, float addrspace(1)* %35, align 4, !tbaa !16
  %36 = getelementptr inbounds float, float addrspace(1)* %2, i64 %32
  store float 0x3FE6666660000000, float addrspace(1)* %36, align 4, !tbaa !16
  %37 = getelementptr inbounds float, float addrspace(1)* %1, i64 %32
  store float 0x3FC99999A0000000, float addrspace(1)* %37, align 4, !tbaa !16
  br label %38

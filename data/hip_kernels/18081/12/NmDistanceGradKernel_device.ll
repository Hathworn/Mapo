; ModuleID = '../data/hip_kernels/18081/12/main.cu'
source_filename = "../data/hip_kernels/18081/12/main.cu"
...
53:                                               ; preds = %39, %53
  ...
  %65 = getelementptr inbounds i32, i32 addrspace(1)* %6, i64 %64
  %66 = load i32, i32 addrspace(1)* %65, align 4, !tbaa !23
  ...
  %76 = getelementptr inbounds float, float addrspace(1)* %5, i64 %64
  %77 = load float, float addrspace(1)* %76, align 4, !tbaa !19
  %78 = fmul contract float %77, 2.000000e+00
  %79 = getelementptr inbounds float, float addrspace(1)* %7, i64 %57
  %80 = fsub contract float %59, %71
  %81 = fmul contract float %80, %78
  %82 = atomicrmw fadd float addrspace(1)* %79, float %81 syncscope("agent-one-as") monotonic, align 4
  %83 = getelementptr inbounds float, float addrspace(1)* %7, i64 %61
  %84 = fsub contract float %63, %75
  %85 = fmul contract float %84, %78
  %86 = atomicrmw fadd float addrspace(1)* %83, float %85 syncscope("agent-one-as") monotonic, align 4
  %87 = getelementptr inbounds float, float addrspace(1)* %8, i64 %69
  %88 = fneg contract float %81
  %89 = atomicrmw fadd float addrspace(1)* %87, float %88 syncscope("agent-one-as") monotonic, align 4
  %90 = getelementptr inbounds float, float addrspace(1)* %8, i64 %73
  %91 = fneg contract float %85
  %92 = atomicrmw fadd float addrspace(1)* %90, float %91 syncscope("agent-one-as") monotonic, align 4
  %93 = add i32 %48, %54
  %94 = icmp slt i32 %93, %1
  br i1 %94, label %53, label %49, !llvm.loop !25
}

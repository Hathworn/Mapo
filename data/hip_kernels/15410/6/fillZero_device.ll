; ModuleID = '../data/hip_kernels/15410/6/main.cu'
source_filename = "../data/hip_kernels/15410/6/main.cu"
...
define protected amdgpu_kernel void @_Z8fillZeroPii(i32 addrspace(1)* nocapture writeonly %0, i32 %1) local_unnamed_addr #0 {

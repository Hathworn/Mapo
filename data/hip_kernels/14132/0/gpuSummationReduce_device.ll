; ModuleID = '../data/hip_kernels/14132/0/main.cu'
source_filename = "../data/hip_kernels/14132/0/main.cu"
...
define protected amdgpu_kernel void @_Z18gpuSummationReducePfS_i(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
30:                                               ; preds = %24
  %31 = add i32 %25, %4
  %32 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @sdata, i32 0, i32 %31
...
38:                                               ; preds = %22
  %39 = load float, float addrspace(3)* getelementptr inbounds ([0 x float], [0 x float] addrspace(3)* @sdata, i32 0, i32 0), align 4, !tbaa !7

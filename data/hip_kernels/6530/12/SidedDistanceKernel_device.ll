; ModuleID = '../data/hip_kernels/6530/12/main.cu'
source_filename = "../data/hip_kernels/6530/12/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf = internal unnamed_addr addrspace(3) global [1536 x float] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z19SidedDistanceKerneliiPKfiS0_PfPi(i32 %0, i32 %1, float addrspace(1)* nocapture readonly %2, i32 %3, float addrspace(1)* nocapture readonly %4, float addrspace(1)* nocapture %5, i32 addrspace(1)* nocapture writeonly %6) local_unnamed_addr #0 {
...
71:                                               ; preds = %53, %71
  ...
  %77 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %72
...
98:                                               ; preds = %82, %98
  ...
  %103 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %102
  %104 = load float, float addrspace(3)* %103, align 16, !tbaa !18
  %105 = fsub contract float %104, %88
  %106 = or i32 %102, 1
  %107 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %106
  %108 = load float, float addrspace(3)* %107, align 4, !tbaa !18
  %109 = fsub contract float %108, %92
  %110 = or i32 %102, 2
  %111 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %110
  ...
  %125 = or i32 %102, 3
  %126 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %125
  %127 = load float, float addrspace(3)* %126, align 4, !tbaa !18
  %128 = fsub contract float %127, %88
  %129 = add nuw nsw i32 %102, 4
  %130 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %129
  %131 = load float, float addrspace(3)* %130, align 16, !tbaa !18
  %132 = fsub contract float %131, %92
  %133 = add nuw nsw i32 %102, 5
  %134 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %133
  ...
  %147 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %146
  %148 = load float, float addrspace(3)* %147, align 8, !tbaa !18
  %149 = fsub contract float %148, %88
  %150 = add nuw nsw i32 %102, 7
  %151 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %150
  %152 = load float, float addrspace(3)* %151, align 4, !tbaa !18
  %153 = fsub contract float %152, %92
  %154 = add nuw nsw i32 %102, 8
  %155 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %154
  ...
  %168 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %167
  %169 = load float, float addrspace(3)* %168, align 4, !tbaa !18
  %170 = fsub contract float %169, %88
  %171 = add nuw nsw i32 %102, 10
  %172 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %171
  %173 = load float, float addrspace(3)* %172, align 8, !tbaa !18
  %174 = fsub contract float %173, %92
  %175 = add nuw nsw i32 %102, 11
  %176 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %175
...
190:                                              ; preds = %97, %190
  ...
  %195 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %194
  %196 = load float, float addrspace(3)* %195, align 16, !tbaa !18
  %197 = fsub contract float %196, %88
  %198 = or i32 %194, 1
  %199 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %198
  %200 = load float, float addrspace(3)* %199, align 4, !tbaa !18
  %201 = fsub contract float %200, %92
  %202 = or i32 %194, 2
  %203 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %202
  ...
  %217 = or i32 %194, 3
  %218 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %217
  %219 = load float, float addrspace(3)* %218, align 4, !tbaa !18
  %220 = fsub contract float %219, %88
  %221 = add nuw nsw i32 %194, 4
  %222 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %221
  %223 = load float, float addrspace(3)* %222, align 16, !tbaa !18
  %224 = fsub contract float %223, %92
  %225 = add nuw nsw i32 %194, 5
  %226 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %225
  ...
  %239 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %238
  %240 = load float, float addrspace(3)* %239, align 8, !tbaa !18
  %241 = fsub contract float %240, %88
  %242 = add nuw nsw i32 %194, 7
  %243 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %242
  %244 = load float, float addrspace(3)* %243, align 4, !tbaa !18
  %245 = fsub contract float %244, %92
  %246 = add nuw nsw i32 %194, 8
  %247 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %246
  ...
  %260 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %259
  %261 = load float, float addrspace(3)* %260, align 4, !tbaa !18
  %262 = fsub contract float %261, %88
  %263 = add nuw nsw i32 %194, 10
  %264 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %263
  %265 = load float, float addrspace(3)* %264, align 8, !tbaa !18
  %266 = fsub contract float %265, %92
  %267 = add nuw nsw i32 %194, 11
  %268 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %267
...
289:                                              ; preds = %282, %289
  ...
  %294 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %293
  %295 = load float, float addrspace(3)* %294, align 4, !tbaa !18
  %296 = fsub contract float %295, %88
  %297 = add nsw i32 %293, 1
  %298 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %297
  %299 = load float, float addrspace(3)* %298, align 4, !tbaa !18
  %300 = fsub contract float %299, %92
  %301 = add nsw i32 %293, 2
  %302 = getelementptr inbounds [1536 x float], [1536 x float] addrspace(3)* @_ZZ19SidedDistanceKerneliiPKfiS0_PfPiE3buf, i32 0, i32 %301

; ModuleID = '../data/hip_kernels/18210/18/main.cu'
source_filename = "../data/hip_kernels/18210/18/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [81 x i8] c"thread: %d, %d %d\0Ablock Idxs: %d, %d %d\0Ablock Dims: %d, %d %d\0Agrid: %d, %d %d\0A\0A\0A\00", align 1
...
define protected amdgpu_kernel void @_Z8showgridv() local_unnamed_addr #1 {

; ModuleID = '../data/hip_kernels/9310/23/main.cu'
source_filename = "../data/hip_kernels/9310/23/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

$_ZL14kernelFindMax3PKiiPi = comdat any

@cache = external hidden local_unnamed_addr addrspace(3) global [0 x i32], align 4

; Function Attrs: convergent mustprogress norecurse nounwind
define amdgpu_kernel void @_ZL14kernelFindMax3PKiiPi(i32 addrspace(1)* nocapture readonly %0, i32 %1, i32 addrspace(1)* nocapture %2) local_unnamed_addr #0 comdat {
...
28:                                               ; preds = %24
  ...
  %30 = xor i32 %26, %4
  %31 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @cache, i32 0, i32 %30
...
36:                                               ; preds = %22
  ...
  %38 = atomicrmw max i32 addrspace(1)* %2, i32 %37 syncscope("agent-one-as") monotonic, align 4
  br label %39

; ModuleID = '../data/hip_kernels/14521/7/main.cu'
source_filename = "../data/hip_kernels/14521/7/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z8Kernel02iiiPfS_S_(i32 %0, i32 %1, i32 %2, float addrspace(1)* nocapture readonly %3, float addrspace(1)* nocapture readonly %4, float addrspace(1)* nocapture writeonly %5) local_unnamed_addr #0 {
...
35:                                               ; preds = %64, %29
  %36 = phi float [ undef, %29 ], [ %162, %64 ]
  %37 = phi i32 [ 0, %29 ], [ %163, %64 ]
  %38 = phi float [ 0.000000e+00, %29 ], [ %162, %64 ]
  %39 = icmp eq i32 %31, 0
...
64:                                               ; preds = %64, %33
  ...
  %66 = phi float [ 0.000000e+00, %33 ], [ %162, %64 ]

; ModuleID = '../data/hip_kernels/3929/4/main.cu'
source_filename = "../data/hip_kernels/3929/4/main.cu"
...
define protected amdgpu_kernel void @_Z27setTensorCheckPatternKernelPjj(i32 addrspace(1)* nocapture writeonly %0, i32 %1) local_unnamed_addr #0 {
...
24:                                               ; preds = %16, %24
  ...
  store i32 %25, i32 addrspace(1)* %27, align 4, !tbaa !16
  %28 = add i32 %22, %25

; ModuleID = '../data/hip_kernels/18348/0/main.cu'
source_filename = "../data/hip_kernels/18348/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z15pw_copy_rc_cu_zPKdPdi(double addrspace(1)* nocapture readonly %0, double addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
25:                                               ; preds = %3
  ...
  store double %28, double addrspace(1)* %31, align 8, !tbaa !16
  %32 = add nuw nsw i32 %29, 1
  %33 = sext i32 %32 to i64
  %34 = getelementptr inbounds double, double addrspace(1)* %1, i64 %33
  store double 0.000000e+00, double addrspace(1)* %34, align 8, !tbaa !16
  br label %35

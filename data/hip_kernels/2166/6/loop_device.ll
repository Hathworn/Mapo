; ModuleID = '../data/hip_kernels/2166/6/main.cu'
source_filename = "../data/hip_kernels/2166/6/main.cu"
...
define protected amdgpu_kernel void @_Z4loopv() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([29 x i8], [29 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %9, label %13

; ModuleID = '../data/hip_kernels/11560/0/main.cu'
source_filename = "../data/hip_kernels/11560/0/main.cu"
...
5:                                                ; preds = %5, %2
  ...
  %38 = load i32, i32 addrspace(1)* %1, align 4, !tbaa !4
  %39 = add nsw i32 %37, %38
  store i32 %39, i32 addrspace(1)* %0, align 4, !tbaa !4
  %40 = load i32, i32 addrspace(1)* %1, align 4, !tbaa !4
  %41 = add nsw i32 %39, %40
  store i32 %41, i32 addrspace(1)* %0, align 4, !tbaa !4
  %42 = load i32, i32 addrspace(1)* %1, align 4, !tbaa !4
  %43 = add nsw i32 %41, %42
  store i32 %43, i32 addrspace(1)* %0, align 4, !tbaa !4
  %44 = load i32, i32 addrspace(1)* %1, align 4, !tbaa !4
  %45 = add nsw i32 %43, %44
  store i32 %45, i32 addrspace(1)* %0, align 4, !tbaa !4
  %46 = load i32, i32 addrspace(1)* %1, align 4, !tbaa !4
  %47 = add nsw i32 %45, %46
  store i32 %47, i32 addrspace(1)* %0, align 4, !tbaa !4
  %48 = load i32, i32 addrspace(1)* %1, align 4, !tbaa !4
  %49 = add nsw i32 %47, %48
  store i32 %49, i32 addrspace(1)* %0, align 4, !tbaa !4
  %50 = load i32, i32 addrspace(1)* %1, align 4, !tbaa !4
  %51 = add nsw i32 %49, %50
  store i32 %51, i32 addrspace(1)* %0, align 4, !tbaa !4
  %52 = load i32, i32 addrspace(1)* %1, align 4, !tbaa !4
  %53 = add nsw i32 %51, %52
  store i32 %53, i32 addrspace(1)* %0, align 4, !tbaa !4
  %54 = load i32, i32 addrspace(1)* %1, align 4, !tbaa !4
  %55 = add nsw i32 %53, %54
  store i32 %55, i32 addrspace(1)* %0, align 4, !tbaa !4
  %56 = load i32, i32 addrspace(1)* %1, align 4, !tbaa !4
  %57 = add nsw i32 %55, %56
  store i32 %57, i32 addrspace(1)* %0, align 4, !tbaa !4
  %58 = add nuw nsw i32 %7, 25
  %59 = icmp eq i32 %58, 12000000
  br i1 %59, label %4, label %5, !llvm.loop !8
}

; ModuleID = '../data/hip_kernels/1085/1/main.cu'
source_filename = "../data/hip_kernels/1085/1/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [33 x i8] c"Hello World from GPU thread %d!\0A\00", align 1

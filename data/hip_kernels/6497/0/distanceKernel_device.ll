; ModuleID = '../data/hip_kernels/6497/0/main.cu'
source_filename = "../data/hip_kernels/6497/0/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [36 x i8] c"i = %2d: dist from %f to %f is %f.\0A\00", align 1
...
define protected amdgpu_kernel void @_Z14distanceKernelPffi(float addrspace(1)* nocapture writeonly %0, float %1, i32 %2) local_unnamed_addr #1 {
  ...
  %16 = fdiv contract float %13, %15
  %17 = fsub contract float %1, %16
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([36 x i8], [36 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %50, label %54
...
58:                                               ; preds = %484, %54
  %59 = phi i64 [ select (i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([36 x i8], [36 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), i64 0, i64 add (i64 ptrtoint (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([36 x i8], [36 x i8] addrspace(4)* @.str, i64 0, i64 35) to i8*) to i64), i64 add (i64 sub (i64 0, i64 ptrtoint ([36 x i8]* addrspacecast ([36 x i8] addrspace(4)* @.str to [36 x i8]*) to i64)), i64 1))), %54 ], [ %492, %484 ]
  %60 = phi i8 addrspace(4)* [ getelementptr inbounds ([36 x i8], [36 x i8] addrspace(4)* @.str, i64 0, i64 0), %54 ], [ %493, %484 ]
...
484:                                              ; preds = %471, %433, %431
  ...
  %489 = and i64 %69, -225
  %490 = or i64 %489, %488
  %491 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %47, i64 noundef %490, i64 noundef %129, i64 noundef %189, i64 noundef %249, i64 noundef %309, i64 noundef %369, i64 noundef %429, i64 noundef %485) #10
  %492 = sub i64 %59, %67
...
495:                                              ; preds = %484, %50
  ...
  %497 = fpext float %1 to double
  %498 = fpext float %16 to double
  %499 = fpext float %39 to double
  %500 = extractelement <2 x i64> %496, i64 0
  %501 = zext i32 %12 to i64
  %502 = and i64 %500, -225
  %503 = or i64 %502, 32
  %504 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %47, i64 noundef %503, i64 noundef %501, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %505 = extractelement <2 x i64> %504, i64 0
  %506 = bitcast double %497 to i64
  %507 = and i64 %505, -225
  %508 = or i64 %507, 32
  %509 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %47, i64 noundef %508, i64 noundef %506, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %510 = extractelement <2 x i64> %509, i64 0
  %511 = bitcast double %498 to i64
  %512 = and i64 %510, -225
  %513 = or i64 %512, 32
  %514 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %47, i64 noundef %513, i64 noundef %511, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %515 = extractelement <2 x i64> %514, i64 0
  %516 = bitcast double %499 to i64
  %517 = and i64 %515, -227
  %518 = or i64 %517, 34
  %519 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %47, i64 noundef %518, i64 noundef %516, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

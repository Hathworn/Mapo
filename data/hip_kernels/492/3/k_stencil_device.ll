; ModuleID = '../data/hip_kernels/492/3/main.cu'
source_filename = "../data/hip_kernels/492/3/main.cu"
...
define protected amdgpu_kernel void @_Z9k_stencilPiS_i(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
32:                                               ; preds = %29
  ...
  %42 = add nuw nsw i32 %4, 3
  %43 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @s, i32 0, i32 %42
  %44 = load i32, i32 addrspace(3)* %43, align 4, !tbaa !7
  %45 = add nsw i32 %44, %41
  %46 = getelementptr inbounds i32, i32 addrspace(1)* %1, i64 %15

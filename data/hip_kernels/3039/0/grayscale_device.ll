; ModuleID = '../data/hip_kernels/3039/0/main.cu'
source_filename = "../data/hip_kernels/3039/0/main.cu"
...
26:                                               ; preds = %5
  ...
  %40 = fmul contract double %39, 7.152000e-01
  %41 = fadd contract double %40, 0.000000e+00
  %42 = uitofp i8 %38 to double
  %43 = fmul contract double %42, 7.220000e-02
  %44 = fadd contract double %41, %43
  %45 = fptoui double %44 to i8
  %46 = getelementptr inbounds i8, i8 addrspace(1)* %1, i64 %36
  store i8 %45, i8 addrspace(1)* %46, align 1, !tbaa !7
  %47 = getelementptr inbounds i8, i8 addrspace(1)* %1, i64 %32
  store i8 %45, i8 addrspace(1)* %47, align 1, !tbaa !7
  %48 = getelementptr inbounds i8, i8 addrspace(1)* %1, i64 %30
  store i8 %45, i8 addrspace(1)* %48, align 1, !tbaa !7
  br label %49

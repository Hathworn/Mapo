; ModuleID = '../data/hip_kernels/3039/3/main.cu'
source_filename = "../data/hip_kernels/3039/3/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [10 x i8] c"res = %f\0A\00", align 1
...
define protected amdgpu_kernel void @_Z6kernelv() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([10 x i8], [10 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %9, label %13
...
454:                                              ; preds = %443, %9
  ...
  %457 = and i64 %456, -227
  %458 = or i64 %457, 34
  %459 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %6, i64 noundef %458, i64 noundef 4613937818241073152, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

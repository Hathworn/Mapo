; ModuleID = '../data/hip_kernels/3039/1/main.cu'
source_filename = "../data/hip_kernels/3039/1/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [43 x i8] c"GPU bockIdx %i threadIdx %i: Hello World!\0A\00", align 1
...
define protected amdgpu_kernel void @_Z6kernelv() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([43 x i8], [43 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %9, label %13
...
17:                                               ; preds = %443, %13
  %18 = phi i64 [ select (i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([43 x i8], [43 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), i64 0, i64 add (i64 ptrtoint (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([43 x i8], [43 x i8] addrspace(4)* @.str, i64 0, i64 42) to i8*) to i64), i64 add (i64 sub (i64 0, i64 ptrtoint ([43 x i8]* addrspacecast ([43 x i8] addrspace(4)* @.str to [43 x i8]*) to i64)), i64 1))), %13 ], [ %451, %443 ]
  %19 = phi i8 addrspace(4)* [ getelementptr inbounds ([43 x i8], [43 x i8] addrspace(4)* @.str, i64 0, i64 0), %13 ], [ %452, %443 ]

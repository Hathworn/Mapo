; ModuleID = '../data/hip_kernels/17434/0/main.cu'
source_filename = "../data/hip_kernels/17434/0/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [62 x i8] c"Houston, we have a problem in section [%d,%d] From Apollo 13\0A\00", align 1
...
define protected amdgpu_kernel void @_Z9print_gpuv() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([62 x i8], [62 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %9, label %13
...
454:                                              ; preds = %443, %9
  ...
  %456 = tail call i32 @llvm.amdgcn.workgroup.id.x()
  %457 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !11
  %458 = extractelement <2 x i64> %455, i64 0
  %459 = zext i32 %457 to i64
  %460 = and i64 %458, -225
  %461 = or i64 %460, 32
  %462 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %6, i64 noundef %461, i64 noundef %459, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %463 = extractelement <2 x i64> %462, i64 0
  %464 = zext i32 %456 to i64
  %465 = and i64 %463, -227
  %466 = or i64 %465, 34
  %467 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %6, i64 noundef %466, i64 noundef %464, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

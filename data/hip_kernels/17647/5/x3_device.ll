; ModuleID = '../data/hip_kernels/17647/5/main.cu'
source_filename = "../data/hip_kernels/17647/5/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z2x3Piii(i32 addrspace(1)* nocapture %0, i32 %1, i32 %2) local_unnamed_addr #0 {
...
24:                                               ; preds = %3, %35
  %25 = phi i32 [ %36, %35 ], [ %21, %3 ]
  %26 = sext i32 %25 to i64
  %27 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %26
  %28 = load i32, i32 addrspace(1)* %27, align 4, !tbaa !16
  %29 = icmp sgt i32 %28, %1
  %30 = tail call i32 @llvm.smin.i32(i32 %28, i32 %1)
  %31 = icmp slt i32 %30, %22
  %32 = or i1 %29, %31
  br i1 %32, label %33, label %35

33:                                               ; preds = %24
  %34 = tail call i32 @llvm.smax.i32(i32 %30, i32 %22)
  store i32 %34, i32 addrspace(1)* %27, align 4, !tbaa !16
  br label %35

35:                                               ; preds = %24, %33
  %36 = add nsw i32 %25, %19

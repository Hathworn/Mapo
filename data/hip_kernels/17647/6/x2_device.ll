; ModuleID = '../data/hip_kernels/17647/6/main.cu'
source_filename = "../data/hip_kernels/17647/6/main.cu"
...
define protected amdgpu_kernel void @_Z2x2Pffi(float addrspace(1)* nocapture writeonly %0, float %1, i32 %2) local_unnamed_addr #0 {

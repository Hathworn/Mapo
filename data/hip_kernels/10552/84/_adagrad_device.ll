; ModuleID = '../data/hip_kernels/10552/84/main.cu'
source_filename = "../data/hip_kernels/10552/84/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z8_adagradifPfS_(i32 %0, float %1, float addrspace(1)* nocapture %2, float addrspace(1)* nocapture %3) local_unnamed_addr #0 {
...
25:                                               ; preds = %18, %25
  ...
  %55 = fadd contract float %54, %1
  %56 = load float, float addrspace(1)* %28, align 4, !tbaa !16
  %57 = fdiv contract float %56, %55
  store float %57, float addrspace(1)* %28, align 4, !tbaa !16
  %58 = add i32 %24, %26
  %59 = icmp slt i32 %58, %0
  br i1 %59, label %25, label %60, !llvm.loop !20

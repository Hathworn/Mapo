; ModuleID = '../data/hip_kernels/10552/80/main.cu'
source_filename = "../data/hip_kernels/10552/80/main.cu"
...
define protected amdgpu_kernel void @_Z5_fillifPf(i32 %0, float %1, float addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {

; ModuleID = '../data/hip_kernels/10552/16/main.cu'
source_filename = "../data/hip_kernels/10552/16/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z7_adam32iidddPfS_S_(i32 %0, i32 %1, double %2, double %3, double %4, float addrspace(1)* nocapture %5, float addrspace(1)* nocapture %6, float addrspace(1)* nocapture %7) local_unnamed_addr #0 {
...
427:                                              ; preds = %22, %427
  %428 = phi i32 [ %20, %22 ], [ %480, %427 ]
  %429 = sext i32 %428 to i64
  %430 = getelementptr inbounds float, float addrspace(1)* %5, i64 %429
  %431 = load float, float addrspace(1)* %430, align 4, !tbaa !16
  %432 = fpext float %431 to double
  %433 = fmul contract double %432, %3
  %434 = getelementptr inbounds float, float addrspace(1)* %7, i64 %429
  %435 = load float, float addrspace(1)* %434, align 4, !tbaa !16
  %436 = fpext float %435 to double
  %437 = fmul contract double %23, %436
  %438 = fadd contract double %433, %437
  %439 = fptrunc double %438 to float
  store float %439, float addrspace(1)* %430, align 4, !tbaa !16
  %440 = getelementptr inbounds float, float addrspace(1)* %6, i64 %429
  %441 = load float, float addrspace(1)* %440, align 4, !tbaa !16
  %442 = fpext float %441 to double
  %443 = fmul contract double %442, %4
  %444 = load float, float addrspace(1)* %434, align 4, !tbaa !16
  %445 = fmul contract float %444, %444
  %446 = fpext float %445 to double
  %447 = fmul contract double %24, %446
  %448 = fadd contract double %443, %447
  %449 = fptrunc double %448 to float
  store float %449, float addrspace(1)* %440, align 4, !tbaa !16
  %450 = load float, float addrspace(1)* %430, align 4, !tbaa !16
  %451 = fpext float %450 to double
  %452 = fdiv contract double %451, %232
  %453 = fpext float %449 to double
  %454 = fdiv contract double %453, %420
  %455 = fcmp olt double %454, 0x1000000000000000
  %456 = select i1 %455, double 0x4FF0000000000000, double 1.000000e+00
  %457 = fmul double %454, %456
  %458 = tail call double @llvm.amdgcn.rsq.f64(double %457)
  %459 = fmul double %457, %458
  %460 = fmul double %458, 5.000000e-01
  %461 = fneg double %460
  %462 = tail call double @llvm.fma.f64(double %461, double %459, double 5.000000e-01)
  %463 = tail call double @llvm.fma.f64(double %460, double %462, double %460)
  %464 = tail call double @llvm.fma.f64(double %459, double %462, double %459)
  %465 = fneg double %464
  %466 = tail call double @llvm.fma.f64(double %465, double %464, double %457)
  %467 = tail call double @llvm.fma.f64(double %466, double %463, double %464)
  %468 = fneg double %467
  %469 = tail call double @llvm.fma.f64(double %468, double %467, double %457)
  %470 = tail call double @llvm.fma.f64(double %469, double %463, double %467)
  %471 = select i1 %455, double 0x37F0000000000000, double 1.000000e+00
  %472 = fmul double %471, %470
  %473 = fcmp oeq double %457, 0.000000e+00
  %474 = fcmp oeq double %457, 0x7FF0000000000000
  %475 = or i1 %473, %474
  %476 = select i1 %475, double %457, double %472
  %477 = fadd contract double %476, %2
  %478 = fdiv contract double %452, %477
  %479 = fptrunc double %478 to float
  store float %479, float addrspace(1)* %434, align 4, !tbaa !16
  %480 = add i32 %426, %428
  %481 = icmp slt i32 %480, %0
  br i1 %481, label %427, label %482, !llvm.loop !20

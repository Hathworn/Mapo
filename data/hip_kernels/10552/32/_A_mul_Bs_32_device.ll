; ModuleID = '../data/hip_kernels/10552/32/main.cu'
source_filename = "../data/hip_kernels/10552/32/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z12_A_mul_Bs_32iiPfS_PiS0_S_(i32 %0, i32 %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, i32 addrspace(1)* nocapture readonly %4, i32 addrspace(1)* nocapture readonly %5, float addrspace(1)* nocapture %6) local_unnamed_addr #0 {
...
37:                                               ; preds = %33, %37
  ...
  store float 0.000000e+00, float addrspace(1)* %40, align 4, !tbaa !16
  %41 = add nsw i32 %38, 1
...
55:                                               ; preds = %53, %176
  ...
  %60 = add nsw i32 %59, -1
  %61 = getelementptr inbounds float, float addrspace(1)* %3, i64 %57
...
65:                                               ; preds = %64, %65
  ...
  %94 = fmul contract float %62, %93
  %95 = add nsw i32 %89, %35
  %96 = sext i32 %95 to i64
  %97 = getelementptr inbounds float, float addrspace(1)* %6, i64 %96
  %98 = load float, float addrspace(1)* %97, align 4, !tbaa !16
  %99 = fadd contract float %98, %94
  store float %99, float addrspace(1)* %97, align 4, !tbaa !16
  %100 = or i32 %66, 3
  ...
  %105 = fmul contract float %62, %104
  ...
  %110 = fadd contract float %109, %105
  ...
  %116 = fmul contract float %62, %115
  ...
  %121 = fadd contract float %120, %116
  store float %121, float addrspace(1)* %119, align 4, !tbaa !16
  %122 = or i32 %66, 5
  ...
  %127 = fmul contract float %62, %126
  %128 = add nsw i32 %122, %35
  %129 = sext i32 %128 to i64
  %130 = getelementptr inbounds float, float addrspace(1)* %6, i64 %129
  %131 = load float, float addrspace(1)* %130, align 4, !tbaa !16
  %132 = fadd contract float %131, %127
  store float %132, float addrspace(1)* %130, align 4, !tbaa !16
  %133 = or i32 %66, 6
  ...
  %138 = fmul contract float %62, %137
  %139 = add nsw i32 %133, %35
  %140 = sext i32 %139 to i64
  %141 = getelementptr inbounds float, float addrspace(1)* %6, i64 %140
  %142 = load float, float addrspace(1)* %141, align 4, !tbaa !16
  %143 = fadd contract float %142, %138
  ...
  %149 = fmul contract float %62, %148
  ...
  %154 = fadd contract float %153, %149
...
160:                                              ; preds = %158, %160
  ...
  %167 = fmul contract float %62, %166
  ...
  %172 = fadd contract float %171, %167
  store float %172, float addrspace(1)* %170, align 4, !tbaa !16

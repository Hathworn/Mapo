; ModuleID = '../data/hip_kernels/10552/15/main.cu'
source_filename = "../data/hip_kernels/10552/15/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z10_rmsprop32iddPfS_(i32 %0, double %1, double %2, float addrspace(1)* nocapture %3, float addrspace(1)* nocapture %4) local_unnamed_addr #0 {
...
27:                                               ; preds = %19, %27
  ...
  %38 = fmul contract double %37, %36
  %39 = fadd contract double %33, %38
  %40 = fptrunc double %39 to float
  store float %40, float addrspace(1)* %30, align 4, !tbaa !16
  %41 = fpext float %40 to double
  %42 = fadd contract double %41, %1
  ...
  %65 = load float, float addrspace(1)* %34, align 4, !tbaa !16
  %66 = fpext float %65 to double
  %67 = fdiv contract double %66, %64
  %68 = fptrunc double %67 to float
  store float %68, float addrspace(1)* %34, align 4, !tbaa !16
  %69 = add i32 %26, %28
  %70 = icmp slt i32 %69, %0
  br i1 %70, label %27, label %71, !llvm.loop !20

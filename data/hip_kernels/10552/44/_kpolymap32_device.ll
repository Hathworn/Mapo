; ModuleID = '../data/hip_kernels/10552/44/main.cu'
source_filename = "../data/hip_kernels/10552/44/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z11_kpolymap32iPfff(i32 %0, float addrspace(1)* nocapture %1, float %2, float %3) local_unnamed_addr #0 {
...
18:                                               ; preds = %4
  ...
  %20 = tail call float @llvm.trunc.f32(float %19)
  %21 = fcmp oeq float %19, %20
  %22 = zext i1 %21 to i32
  %23 = fmul float %20, 5.000000e-01
  %24 = tail call float @llvm.amdgcn.fract.f32(float %23)
  %25 = tail call i1 @llvm.amdgcn.class.f32(float %23, i32 516)
  ...
  %31 = icmp eq i32 %30, 1
  %32 = icmp ne i32 %30, 0
  %33 = fcmp oeq float %19, 0x7FF0000000000000
  %34 = bitcast float %3 to i32
  %35 = fcmp olt float %3, 0.000000e+00
  %36 = fcmp oeq float %3, 0.000000e+00
  %37 = udiv i32 %14, %11
  %38 = mul i32 %37, %11
  ...
  %41 = add i32 %37, %40
  %42 = mul i32 %41, %11
  br i1 %33, label %214, label %43

43:                                               ; preds = %18, %43
  %44 = phi i32 [ %212, %43 ], [ %16, %18 ]
  ...
  %157 = fmul float %154, %3
  %158 = fneg float %157
  %159 = tail call float @llvm.fma.f32(float %3, float %154, float %158)
  %160 = tail call float @llvm.fma.f32(float %3, float %156, float %159)
  ...
  %197 = select i1 %196, i1 true, i1 %32
...
214:                                              ; preds = %18, %214
  ...
  store float %240, float addrspace(1)* %217, align 4, !tbaa !16
  %241 = add i32 %42, %215

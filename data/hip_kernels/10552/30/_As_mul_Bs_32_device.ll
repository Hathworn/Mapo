; ModuleID = '../data/hip_kernels/10552/30/main.cu'
source_filename = "../data/hip_kernels/10552/30/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z13_As_mul_Bs_32iiPfPiS0_S_S0_S0_S_(i32 %0, i32 %1, float addrspace(1)* nocapture readonly %2, i32 addrspace(1)* nocapture readonly %3, i32 addrspace(1)* nocapture readonly %4, float addrspace(1)* nocapture readonly %5, i32 addrspace(1)* nocapture readonly %6, i32 addrspace(1)* nocapture readonly %7, float addrspace(1)* nocapture %8) local_unnamed_addr #0 {
...
54:                                               ; preds = %51, %87
  ...
  %59 = add nsw i32 %58, -1
  %60 = getelementptr inbounds float, float addrspace(1)* %5, i64 %56
...
72:                                               ; preds = %70, %72
  ...
  %77 = getelementptr inbounds float, float addrspace(1)* %2, i64 %74
  %78 = load float, float addrspace(1)* %77, align 4, !tbaa !16
  %79 = fmul contract float %61, %78
  %80 = add i32 %53, %76
  %81 = sext i32 %80 to i64
  %82 = getelementptr inbounds float, float addrspace(1)* %8, i64 %81
  %83 = load float, float addrspace(1)* %82, align 4, !tbaa !16
  %84 = fadd contract float %83, %79

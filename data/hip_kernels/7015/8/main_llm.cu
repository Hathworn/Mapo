...
#include "kernel_weight_update_2_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
float *dw_ext_arr = NULL;
hipMalloc(&dw_ext_arr, XSIZE*YSIZE);
float eta = 1;
float alpha = 2;
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
...
hipFree(0);
kernel_weight_update_2<<<gridBlock, threadBlock>>>(layer_id,l,s_ext,sw_ext,z_ext_arr,a_ext_arr,t_arr,gjl_ext,w_ext_arr,dw_ext_arr,eta,alpha);

; ModuleID = '../data/hip_kernels/14541/13/main.cu'
source_filename = "../data/hip_kernels/14541/13/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z5gpuMMPfS_S_i(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2, i32 %3) local_unnamed_addr #0 {
...
29:                                               ; preds = %57, %24
  ...
  %32 = phi float [ 0.000000e+00, %24 ], [ %155, %57 ]
  %33 = icmp eq i32 %25, 0
...
57:                                               ; preds = %57, %27
  ...
  %59 = phi float [ 0.000000e+00, %27 ], [ %155, %57 ]
  %60 = phi i32 [ 0, %27 ], [ %157, %57 ]
  %61 = add nsw i32 %58, %23

; ModuleID = '../data/hip_kernels/1564/0/main.cu'
source_filename = "../data/hip_kernels/1564/0/main.cu"
...
@texRef = protected local_unnamed_addr addrspace(1) externally_initialized global %struct.texture undef, align 8

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn writeonly
define protected amdgpu_kernel void @_Z13cuke_gradientPhiimf(i8 addrspace(1)* nocapture writeonly %0, i32 %1, i32 %2, i64 %3, float %4) local_unnamed_addr #0 {
...
26:                                               ; preds = %5
  ...
  %35 = fdiv contract float %34, 6.400000e+02
  store float %35, float addrspace(1)* %33, align 4, !tbaa !7
  %36 = sitofp i32 %22 to float
  %37 = fdiv contract float %36, 4.800000e+02
  %38 = getelementptr inbounds float, float addrspace(1)* %33, i64 1
  store float %37, float addrspace(1)* %38, align 4, !tbaa !7
  %39 = getelementptr inbounds float, float addrspace(1)* %33, i64 2
  store float 0.000000e+00, float addrspace(1)* %39, align 4, !tbaa !7
  %40 = getelementptr inbounds float, float addrspace(1)* %33, i64 3
  store float 1.000000e+00, float addrspace(1)* %40, align 4, !tbaa !7
  br label %41

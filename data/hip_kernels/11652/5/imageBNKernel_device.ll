; ModuleID = '../data/hip_kernels/11652/5/main.cu'
source_filename = "../data/hip_kernels/11652/5/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z13imageBNKernelPhii(i8 addrspace(1)* nocapture %0, i32 %1, i32 %2) local_unnamed_addr #0 {
...
24:                                               ; preds = %3
  ...
  store i8 0, i8 addrspace(1)* %34, align 1, !tbaa !7
  store i8 0, i8 addrspace(1)* %38, align 1, !tbaa !7
  %40 = uitofp i8 %31 to double
  %41 = fmul contract double %40, 2.100000e-01
  %42 = uitofp i8 %35 to double
  %43 = fmul contract double %42, 7.100000e-01
  %44 = fadd contract double %41, %43
  %45 = uitofp i8 %39 to double
  ...
  store i8 %49, i8 addrspace(1)* %52, align 1, !tbaa !7
  br label %53

; ModuleID = '../data/hip_kernels/952/2/main.cu'
source_filename = "../data/hip_kernels/952/2/main.cu"
...
@llvm.compiler.used = appending addrspace(1) global [2 x i8*] [i8* addrspacecast (i8 addrspace(4)* bitcast (double addrspace(4)* @dx to i8 addrspace(4)*) to i8*), i8* addrspacecast (i8 addrspace(4)* bitcast (double addrspace(4)* @dy to i8 addrspace(4)*) to i8*)], section "llvm.metadata"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z10gpu_efieldPdS_S_(double addrspace(1)* nocapture readonly %0, double addrspace(1)* nocapture writeonly %1, double addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  ...
  %42 = fsub contract double %27, %31
  %43 = fmul contract double %42, 5.000000e-01
  %44 = load double, double addrspace(4)* @dx, align 8, !tbaa !7
  %45 = fdiv contract double %43, %44
  %46 = zext i32 %23 to i64
  %47 = getelementptr inbounds double, double addrspace(1)* %1, i64 %46
  store double %45, double addrspace(1)* %47, align 8, !tbaa !7
  %48 = fsub contract double %41, %36
  %49 = fmul contract double %48, 5.000000e-01
  %50 = load double, double addrspace(4)* @dy, align 8, !tbaa !7

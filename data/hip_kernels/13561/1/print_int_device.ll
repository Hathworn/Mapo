; ModuleID = '../data/hip_kernels/13561/1/main.cu'
source_filename = "../data/hip_kernels/13561/1/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [4 x i8] c"%d,\00", align 1
...
define protected amdgpu_kernel void @_Z9print_intPii(i32 addrspace(1)* nocapture readonly %0, i32 %1) local_unnamed_addr #1 {
...
13:                                               ; preds = %2
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([4 x i8], [4 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %25, label %29

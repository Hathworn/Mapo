; ModuleID = '../data/hip_kernels/13561/3/main.cu'
source_filename = "../data/hip_kernels/13561/3/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [5 x i8] c"%ld,\00", align 1
...
define protected amdgpu_kernel void @_Z10print_longPli(i64 addrspace(1)* nocapture readonly %0, i32 %1) local_unnamed_addr #1 {
...
13:                                               ; preds = %2
  ...
  %15 = getelementptr inbounds i64, i64 addrspace(1)* %0, i64 %14
  %16 = load i64, i64 addrspace(1)* %15, align 8, !tbaa !7, !amdgpu.noclobber !5
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([5 x i8], [5 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %25, label %29
...
470:                                              ; preds = %459, %25
  ...
  %473 = and i64 %472, -227
  %474 = or i64 %473, 34
  %475 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %22, i64 noundef %474, i64 noundef %16, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  br label %476

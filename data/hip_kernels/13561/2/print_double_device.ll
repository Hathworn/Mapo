; ModuleID = '../data/hip_kernels/13561/2/main.cu'
source_filename = "../data/hip_kernels/13561/2/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [5 x i8] c"%lf,\00", align 1
...
define protected amdgpu_kernel void @_Z12print_doublePdi(double addrspace(1)* nocapture readonly %0, i32 %1) local_unnamed_addr #1 {
...
13:                                               ; preds = %2
  ...
  %17 = load i64, i64 addrspace(1)* %16, align 8, !tbaa !7, !amdgpu.noclobber !5
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([5 x i8], [5 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %26, label %30
...
471:                                              ; preds = %460, %26
  ...
  %474 = and i64 %473, -227
  %475 = or i64 %474, 34
  %476 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %23, i64 noundef %475, i64 noundef %17, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  br label %477

; ModuleID = '../data/hip_kernels/14970/23/main.cu'
source_filename = "../data/hip_kernels/14970/23/main.cu"
...
42:                                               ; preds = %40
  ...
  %64 = getelementptr inbounds [74 x double], [74 x double] addrspace(3)* @_ZZ10stencil_1diPdS_E4temp, i32 0, i32 %63
  %65 = load double, double addrspace(3)* %64, align 8, !tbaa !7
  %66 = fadd contract double %62, %65
  %67 = add nuw nsw i32 %11, 7
  %68 = getelementptr inbounds [74 x double], [74 x double] addrspace(3)* @_ZZ10stencil_1diPdS_E4temp, i32 0, i32 %67
  %69 = load double, double addrspace(3)* %68, align 8, !tbaa !7
  %70 = fadd contract double %66, %69
  %71 = add nuw nsw i32 %11, 8
  %72 = getelementptr inbounds [74 x double], [74 x double] addrspace(3)* @_ZZ10stencil_1diPdS_E4temp, i32 0, i32 %71
  %73 = load double, double addrspace(3)* %72, align 8, !tbaa !7
  %74 = fadd contract double %70, %73
  %75 = add nuw nsw i32 %11, 9
  %76 = getelementptr inbounds [74 x double], [74 x double] addrspace(3)* @_ZZ10stencil_1diPdS_E4temp, i32 0, i32 %75
  %77 = load double, double addrspace(3)* %76, align 8, !tbaa !7
  %78 = fadd contract double %74, %77
  %79 = add nuw nsw i32 %11, 10
  %80 = getelementptr inbounds [74 x double], [74 x double] addrspace(3)* @_ZZ10stencil_1diPdS_E4temp, i32 0, i32 %79

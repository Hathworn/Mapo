; ModuleID = '../data/hip_kernels/14970/14/main.cu'
source_filename = "../data/hip_kernels/14970/14/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [12 x i8] c"A[%d] = %f\0A\00", align 1
...
define protected amdgpu_kernel void @_Z8printMatPKdi(double addrspace(1)* nocapture readonly %0, i32 %1) local_unnamed_addr #1 {
...
10:                                               ; preds = %2
  ...
  %14 = load i64, i64 addrspace(4)* %13, align 8, !tbaa !5
  %15 = inttoptr i64 %14 to i8 addrspace(1)*
  %16 = addrspacecast i8 addrspace(1)* %15 to i8*
  br label %17

17:                                               ; preds = %10, %470
  %18 = phi i32 [ 0, %10 ], [ %480, %470 ]
  %19 = zext i32 %18 to i64
  %20 = getelementptr inbounds double, double addrspace(1)* %0, i64 %19
  %21 = bitcast double addrspace(1)* %20 to i64 addrspace(1)*
  %22 = load i64, i64 addrspace(1)* %21, align 8, !tbaa !9
  %23 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %16, i64 noundef 33, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %24 = extractelement <2 x i64> %23, i64 0
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([12 x i8], [12 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %25, label %29

25:                                               ; preds = %17
  %26 = and i64 %24, -225
  %27 = or i64 %26, 32
  %28 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %16, i64 noundef %27, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  br label %470
...
88:                                               ; preds = %46, %88
  ...
  %93 = load i8, i8 addrspace(4)* %92, align 1, !tbaa !13
  ...
  br i1 %100, label %101, label %88, !llvm.loop !14
...
148:                                              ; preds = %106, %148
  ...
  %153 = load i8, i8 addrspace(4)* %152, align 1, !tbaa !13
...
208:                                              ; preds = %166, %208
  ...
  %213 = load i8, i8 addrspace(4)* %212, align 1, !tbaa !13
...
268:                                              ; preds = %226, %268
  ...
  %273 = load i8, i8 addrspace(4)* %272, align 1, !tbaa !13
...
328:                                              ; preds = %286, %328
  ...
  %333 = load i8, i8 addrspace(4)* %332, align 1, !tbaa !13
...
388:                                              ; preds = %346, %388
  ...
  %393 = load i8, i8 addrspace(4)* %392, align 1, !tbaa !13
...
446:                                              ; preds = %406, %446
  ...
  %451 = load i8, i8 addrspace(4)* %450, align 1, !tbaa !13
...
459:                                              ; preds = %446, %408, %406
  ...
  %464 = and i64 %44, -225
  %465 = or i64 %464, %463
  %466 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %16, i64 noundef %465, i64 noundef %104, i64 noundef %164, i64 noundef %224, i64 noundef %284, i64 noundef %344, i64 noundef %404, i64 noundef %460) #10
  %467 = sub i64 %34, %42
...
470:                                              ; preds = %459, %25
  ...
  %473 = and i64 %472, -225
  %474 = or i64 %473, 32
  %475 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %16, i64 noundef %474, i64 noundef %19, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %476 = extractelement <2 x i64> %475, i64 0
  %477 = and i64 %476, -227
  %478 = or i64 %477, 34
  %479 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %16, i64 noundef %478, i64 noundef %22, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %480 = add nuw nsw i32 %18, 1
  %481 = icmp eq i32 %480, %1
  br i1 %481, label %482, label %17, !llvm.loop !16

; ModuleID = '../data/hip_kernels/6226/0/main.cu'
source_filename = "../data/hip_kernels/6226/0/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [28 x i8] c"%d : call kernel function.\0A\00", align 1
...
define protected amdgpu_kernel void @_Z9VectorSumPiPKiS1_(i32 addrspace(1)* nocapture writeonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture readonly %2) local_unnamed_addr #1 {
  ...
  %15 = load i64, i64 addrspace(4)* %14, align 8, !tbaa !10
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([28 x i8], [28 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %20, label %24
...
43:                                               ; preds = %28
  %44 = load i8, i8 addrspace(4)* %30, align 1, !tbaa !14
  ...
  %77 = load i8, i8 addrspace(4)* %76, align 1, !tbaa !14
...
83:                                               ; preds = %41, %83
  ...
  %88 = load i8, i8 addrspace(4)* %87, align 1, !tbaa !14
...
103:                                              ; preds = %96
  %104 = load i8, i8 addrspace(4)* %97, align 1, !tbaa !14
  ...
  %137 = load i8, i8 addrspace(4)* %136, align 1, !tbaa !14
...
143:                                              ; preds = %101, %143
  ...
  %148 = load i8, i8 addrspace(4)* %147, align 1, !tbaa !14
...
163:                                              ; preds = %156
  %164 = load i8, i8 addrspace(4)* %157, align 1, !tbaa !14
  ...
  %197 = load i8, i8 addrspace(4)* %196, align 1, !tbaa !14
...
203:                                              ; preds = %161, %203
  ...
  %208 = load i8, i8 addrspace(4)* %207, align 1, !tbaa !14
...
223:                                              ; preds = %216
  %224 = load i8, i8 addrspace(4)* %217, align 1, !tbaa !14
  ...
  %257 = load i8, i8 addrspace(4)* %256, align 1, !tbaa !14
...
263:                                              ; preds = %221, %263
  ...
  %268 = load i8, i8 addrspace(4)* %267, align 1, !tbaa !14
...
283:                                              ; preds = %276
  %284 = load i8, i8 addrspace(4)* %277, align 1, !tbaa !14
  ...
  %317 = load i8, i8 addrspace(4)* %316, align 1, !tbaa !14
...
323:                                              ; preds = %281, %323
  ...
  %328 = load i8, i8 addrspace(4)* %327, align 1, !tbaa !14
...
343:                                              ; preds = %336
  %344 = load i8, i8 addrspace(4)* %337, align 1, !tbaa !14
  ...
  %377 = load i8, i8 addrspace(4)* %376, align 1, !tbaa !14
...
383:                                              ; preds = %341, %383
  ...
  %388 = load i8, i8 addrspace(4)* %387, align 1, !tbaa !14
...
403:                                              ; preds = %396
  %404 = load i8, i8 addrspace(4)* %397, align 1, !tbaa !14
  ...
  %437 = load i8, i8 addrspace(4)* %436, align 1, !tbaa !14
...
465:                                              ; preds = %454, %20
  ...
  %468 = and i64 %467, -227
  %469 = or i64 %468, 34
  %470 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %17, i64 noundef %469, i64 noundef %5, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

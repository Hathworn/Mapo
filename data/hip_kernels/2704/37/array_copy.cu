...
__global__ void array_copy(float*a, float * c, size_t mx, size_t my, size_t mz, size_t sx,size_t sy,size_t sz, size_t ox, size_t oy, size_t oz)  // copies between two memories with different strides
{

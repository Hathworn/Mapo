; ModuleID = '../data/hip_kernels/10738/10/main.cu'
source_filename = "../data/hip_kernels/10738/10/main.cu"
...
define protected amdgpu_kernel void @_Z3addPiS_S_ii(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture writeonly %2, i32 %3, i32 %4) local_unnamed_addr #0 {
  ...
  %28 = getelementptr inbounds i32, i32 addrspace(1)* %1, i64 %25
  %29 = load i32, i32 addrspace(1)* %28, align 4, !tbaa !7, !amdgpu.noclobber !5
  %30 = add nsw i32 %29, %27
  %31 = getelementptr inbounds i32, i32 addrspace(1)* %2, i64 %25

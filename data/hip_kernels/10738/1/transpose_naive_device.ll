; ModuleID = '../data/hip_kernels/10738/1/main.cu'
source_filename = "../data/hip_kernels/10738/1/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z15transpose_naivePfS_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
  ...
  %20 = getelementptr inbounds i8, i8 addrspace(4)* %4, i64 16
...
41:                                               ; preds = %2
  ...
  %46 = load float, float addrspace(1)* %45, align 4, !tbaa !17, !amdgpu.noclobber !5
  %47 = mul nsw i32 %37, %14
  %48 = add nsw i32 %47, %25
  %49 = sext i32 %48 to i64
  %50 = getelementptr inbounds float, float addrspace(1)* %1, i64 %49
  store float %46, float addrspace(1)* %50, align 4, !tbaa !17
  br label %51

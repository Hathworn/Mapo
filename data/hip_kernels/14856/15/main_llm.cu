...
#include "sampleMultinomialWithReplacement_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
sampleMultinomialWithReplacement<<<gridBlock, threadBlock>>>(state,totalSamples,dest,distributions,categories,normDistPrefixSum);

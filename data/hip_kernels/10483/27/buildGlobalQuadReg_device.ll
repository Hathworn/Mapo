; ModuleID = '../data/hip_kernels/10483/27/main.cu'
source_filename = "../data/hip_kernels/10483/27/main.cu"
...
define protected amdgpu_kernel void @_Z18buildGlobalQuadRegiiiiiiiPfS_S_S_(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, float addrspace(1)* nocapture readonly %7, float addrspace(1)* nocapture readonly %8, float addrspace(1)* nocapture readonly %9, float addrspace(1)* nocapture writeonly %10) local_unnamed_addr #1 {
...
326:                                              ; preds = %348, %284
  %327 = phi float [ undef, %284 ], [ %423, %348 ]
  %328 = phi i32 [ 0, %284 ], [ %418, %348 ]
  %329 = phi float [ %283, %284 ], [ %423, %348 ]
...
346:                                              ; preds = %326, %331, %282
  ...
  br i1 %28, label %426, label %433

348:                                              ; preds = %348, %287
  %349 = phi i32 [ 0, %287 ], [ %418, %348 ]
  %350 = phi float [ %283, %287 ], [ %423, %348 ]
  %351 = phi i32 [ 0, %287 ], [ %424, %348 ]
  %352 = zext i32 %349 to i64
  %353 = getelementptr inbounds float, float addrspace(1)* %163, i64 %352
  %354 = load float, float addrspace(1)* %353, align 4, !tbaa !13
  %355 = or i32 %349, 1
  %356 = zext i32 %355 to i64
  %357 = getelementptr inbounds float, float addrspace(1)* %7, i64 %356
  %358 = load float, float addrspace(1)* %357, align 4, !tbaa !13
  %359 = fmul contract float %354, %358
  %360 = fadd contract float %350, %359
  %361 = zext i32 %355 to i64
  %362 = getelementptr inbounds float, float addrspace(1)* %163, i64 %361
  %363 = load float, float addrspace(1)* %362, align 4, !tbaa !13
  %364 = or i32 %349, 2
  %365 = zext i32 %364 to i64
  %366 = getelementptr inbounds float, float addrspace(1)* %7, i64 %365
  %367 = load float, float addrspace(1)* %366, align 4, !tbaa !13
  %368 = fmul contract float %363, %367
  %369 = fadd contract float %360, %368
  %370 = zext i32 %364 to i64
  %371 = getelementptr inbounds float, float addrspace(1)* %163, i64 %370
  %372 = load float, float addrspace(1)* %371, align 4, !tbaa !13
  %373 = or i32 %349, 3
  %374 = zext i32 %373 to i64
  %375 = getelementptr inbounds float, float addrspace(1)* %7, i64 %374
  %376 = load float, float addrspace(1)* %375, align 4, !tbaa !13
  %377 = fmul contract float %372, %376
  %378 = fadd contract float %369, %377
  %379 = zext i32 %373 to i64
  %380 = getelementptr inbounds float, float addrspace(1)* %163, i64 %379
  %381 = load float, float addrspace(1)* %380, align 4, !tbaa !13
  %382 = or i32 %349, 4
  %383 = zext i32 %382 to i64
  %384 = getelementptr inbounds float, float addrspace(1)* %7, i64 %383
  %385 = load float, float addrspace(1)* %384, align 4, !tbaa !13
  %386 = fmul contract float %381, %385
  %387 = fadd contract float %378, %386
  %388 = zext i32 %382 to i64
  %389 = getelementptr inbounds float, float addrspace(1)* %163, i64 %388
  %390 = load float, float addrspace(1)* %389, align 4, !tbaa !13
  %391 = or i32 %349, 5
  %392 = zext i32 %391 to i64
  %393 = getelementptr inbounds float, float addrspace(1)* %7, i64 %392
  %394 = load float, float addrspace(1)* %393, align 4, !tbaa !13
  %395 = fmul contract float %390, %394
  %396 = fadd contract float %387, %395
  %397 = zext i32 %391 to i64
  %398 = getelementptr inbounds float, float addrspace(1)* %163, i64 %397
  %399 = load float, float addrspace(1)* %398, align 4, !tbaa !13
  %400 = or i32 %349, 6
  %401 = zext i32 %400 to i64
  %402 = getelementptr inbounds float, float addrspace(1)* %7, i64 %401
  %403 = load float, float addrspace(1)* %402, align 4, !tbaa !13
  %404 = fmul contract float %399, %403
  %405 = fadd contract float %396, %404
  %406 = zext i32 %400 to i64
  %407 = getelementptr inbounds float, float addrspace(1)* %163, i64 %406
  %408 = load float, float addrspace(1)* %407, align 4, !tbaa !13
  %409 = or i32 %349, 7
  %410 = zext i32 %409 to i64
  %411 = getelementptr inbounds float, float addrspace(1)* %7, i64 %410
  %412 = load float, float addrspace(1)* %411, align 4, !tbaa !13
  %413 = fmul contract float %408, %412
  %414 = fadd contract float %405, %413
  %415 = zext i32 %409 to i64
  %416 = getelementptr inbounds float, float addrspace(1)* %163, i64 %415
  %417 = load float, float addrspace(1)* %416, align 4, !tbaa !13
  %418 = add nuw nsw i32 %349, 8
  %419 = zext i32 %418 to i64
  %420 = getelementptr inbounds float, float addrspace(1)* %7, i64 %419
  %421 = load float, float addrspace(1)* %420, align 4, !tbaa !13
  %422 = fmul contract float %417, %421
  %423 = fadd contract float %414, %422
  %424 = add i32 %351, 8
  %425 = icmp eq i32 %424, %288
  br i1 %425, label %326, label %348, !llvm.loop !18

426:                                              ; preds = %346, %654
  %427 = phi i32 [ %655, %654 ], [ 0, %346 ]
  %428 = phi i32 [ %665, %654 ], [ 0, %346 ]
  %429 = phi float [ %671, %654 ], [ %347, %346 ]
  %430 = zext i32 %427 to i64
  %431 = getelementptr inbounds float, float addrspace(1)* %163, i64 %430
  %432 = load float, float addrspace(1)* %431, align 4, !tbaa !13
  br label %657

433:                                              ; preds = %654, %346
  %434 = phi float [ %347, %346 ], [ %671, %654 ]
  %435 = fcmp contract oge float %434, 0.000000e+00
  %436 = select contract i1 %435, float 0.000000e+00, float %434
  %437 = mul nsw i32 %5, %4
  %438 = mul nsw i32 %2, %1
  %439 = sitofp i32 %2 to double
  %440 = sitofp i32 %1 to double
  %441 = tail call double @llvm.fabs.f64(double %439)
  %442 = tail call double @llvm.amdgcn.frexp.mant.f64(double %441)
  %443 = fcmp olt double %442, 0x3FE5555555555555
  %444 = zext i1 %443 to i32
  %445 = tail call double @llvm.amdgcn.ldexp.f64(double %442, i32 %444)
  %446 = tail call i32 @llvm.amdgcn.frexp.exp.i32.f64(double %441)
  %447 = sub nsw i32 %446, %444
  %448 = fadd double %445, -1.000000e+00
  %449 = fadd double %445, 1.000000e+00
  %450 = fadd double %449, -1.000000e+00
  %451 = fsub double %445, %450
  %452 = tail call double @llvm.amdgcn.rcp.f64(double %449)
  %453 = fneg double %449
  %454 = tail call double @llvm.fma.f64(double %453, double %452, double 1.000000e+00)
  %455 = tail call double @llvm.fma.f64(double %454, double %452, double %452)
  %456 = tail call double @llvm.fma.f64(double %453, double %455, double 1.000000e+00)
  %457 = tail call double @llvm.fma.f64(double %456, double %455, double %455)
  %458 = fmul double %448, %457
  %459 = fmul double %449, %458
  %460 = fneg double %459
  %461 = tail call double @llvm.fma.f64(double %458, double %449, double %460)
  %462 = tail call double @llvm.fma.f64(double %458, double %451, double %461)
  %463 = fadd double %459, %462
  %464 = fsub double %463, %459
  %465 = fsub double %462, %464
  %466 = fsub double %448, %463
  %467 = fsub double %448, %466
  %468 = fsub double %467, %463
  %469 = fsub double %468, %465
  %470 = fadd double %466, %469
  %471 = fmul double %457, %470
  %472 = fadd double %458, %471
  %473 = fsub double %472, %458
  %474 = fsub double %471, %473
  %475 = fmul double %472, %472
  %476 = fneg double %475
  %477 = tail call double @llvm.fma.f64(double %472, double %472, double %476)
  %478 = fmul double %474, 2.000000e+00
  %479 = tail call double @llvm.fma.f64(double %472, double %478, double %477)
  %480 = fadd double %475, %479
  %481 = fsub double %480, %475
  %482 = fsub double %479, %481
  %483 = tail call double @llvm.fma.f64(double %480, double 0x3FBDEE674222DE17, double 0x3FBA6564968915A9)
  %484 = tail call double @llvm.fma.f64(double %480, double %483, double 0x3FBE25E43ABE935A)
  %485 = tail call double @llvm.fma.f64(double %480, double %484, double 0x3FC110EF47E6C9C2)
  %486 = tail call double @llvm.fma.f64(double %480, double %485, double 0x3FC3B13BCFA74449)
  %487 = tail call double @llvm.fma.f64(double %480, double %486, double 0x3FC745D171BF3C30)
  %488 = tail call double @llvm.fma.f64(double %480, double %487, double 0x3FCC71C71C7792CE)
  %489 = tail call double @llvm.fma.f64(double %480, double %488, double 0x3FD24924924920DA)
  %490 = tail call double @llvm.fma.f64(double %480, double %489, double 0x3FD999999999999C)
  %491 = sitofp i32 %447 to double
  ...
  %499 = tail call double @llvm.amdgcn.ldexp.f64(double %472, i32 1)
  %500 = tail call double @llvm.amdgcn.ldexp.f64(double %474, i32 1)
  %501 = fmul double %472, %480
  %502 = fneg double %501
  %503 = tail call double @llvm.fma.f64(double %480, double %472, double %502)
  %504 = tail call double @llvm.fma.f64(double %480, double %474, double %503)
  %505 = tail call double @llvm.fma.f64(double %482, double %472, double %504)
  %506 = fadd double %501, %505
  %507 = fsub double %506, %501
  %508 = fsub double %505, %507
  %509 = fmul double %480, %490
  %510 = fneg double %509
  %511 = tail call double @llvm.fma.f64(double %480, double %490, double %510)
  %512 = tail call double @llvm.fma.f64(double %482, double %490, double %511)
  %513 = fadd double %509, %512
  %514 = fsub double %513, %509
  %515 = fsub double %512, %514
  %516 = fadd double %513, 0x3FE5555555555555
  %517 = fadd double %516, 0xBFE5555555555555
  %518 = fsub double %513, %517
  %519 = fadd double %515, 0x3C8543B0D5DF274D
  %520 = fadd double %519, %518
  %521 = fadd double %516, %520
  %522 = fsub double %521, %516
  %523 = fsub double %520, %522
  %524 = fmul double %506, %521
  %525 = fneg double %524
  %526 = tail call double @llvm.fma.f64(double %506, double %521, double %525)
  %527 = tail call double @llvm.fma.f64(double %506, double %523, double %526)
  %528 = tail call double @llvm.fma.f64(double %508, double %521, double %527)
  %529 = fadd double %524, %528
  %530 = fsub double %529, %524
  %531 = fsub double %528, %530
  %532 = fadd double %499, %529
  %533 = fsub double %532, %499
  %534 = fsub double %529, %533
  %535 = fadd double %500, %531
  %536 = fadd double %535, %534
  %537 = fadd double %532, %536
  %538 = fsub double %537, %532
  %539 = fsub double %536, %538
  %540 = fadd double %496, %537
  %541 = fsub double %540, %496
  %542 = fsub double %540, %541
  %543 = fsub double %496, %542
  %544 = fsub double %537, %541
  %545 = fadd double %544, %543
  %546 = fadd double %498, %539
  %547 = fsub double %546, %498
  %548 = fsub double %546, %547
  %549 = fsub double %498, %548
  %550 = fsub double %539, %547
  %551 = fadd double %550, %549
  %552 = fadd double %546, %545
  %553 = fadd double %540, %552
  %554 = fsub double %553, %540
  %555 = fsub double %552, %554
  %556 = fadd double %551, %555
  %557 = fadd double %553, %556
  %558 = fsub double %557, %553
  %559 = fsub double %556, %558
  %560 = fmul double %557, %440
  %561 = fneg double %560
  %562 = tail call double @llvm.fma.f64(double %440, double %557, double %561)
  %563 = tail call double @llvm.fma.f64(double %440, double %559, double %562)
  %564 = fadd double %560, %563
  %565 = fsub double %564, %560
  %566 = fsub double %563, %565
  %567 = tail call double @llvm.fabs.f64(double %560) #13
  %568 = fcmp oeq double %567, 0x7FF0000000000000
  %569 = select i1 %568, double %560, double %564
  %570 = tail call double @llvm.fabs.f64(double %569) #13
  %571 = fcmp oeq double %570, 0x7FF0000000000000
  %572 = select i1 %571, double 0.000000e+00, double %566
  %573 = fmul double %569, 0x3FF71547652B82FE
  %574 = tail call double @llvm.rint.f64(double %573)
  %575 = fneg double %574
  %576 = tail call double @llvm.fma.f64(double %575, double 0x3FE62E42FEFA39EF, double %569)
  %577 = tail call double @llvm.fma.f64(double %575, double 0x3C7ABC9E3B39803F, double %576)
  %578 = tail call double @llvm.fma.f64(double %577, double 0x3E5ADE156A5DCB37, double 0x3E928AF3FCA7AB0C)
  %579 = tail call double @llvm.fma.f64(double %577, double %578, double 0x3EC71DEE623FDE64)
  %580 = tail call double @llvm.fma.f64(double %577, double %579, double 0x3EFA01997C89E6B0)
  %581 = tail call double @llvm.fma.f64(double %577, double %580, double 0x3F2A01A014761F6E)
  %582 = tail call double @llvm.fma.f64(double %577, double %581, double 0x3F56C16C1852B7B0)
  %583 = tail call double @llvm.fma.f64(double %577, double %582, double 0x3F81111111122322)
  %584 = tail call double @llvm.fma.f64(double %577, double %583, double 0x3FA55555555502A1)
  %585 = tail call double @llvm.fma.f64(double %577, double %584, double 0x3FC5555555555511)
  %586 = tail call double @llvm.fma.f64(double %577, double %585, double 0x3FE000000000000B)
  %587 = tail call double @llvm.fma.f64(double %577, double %586, double 1.000000e+00)
  %588 = tail call double @llvm.fma.f64(double %577, double %587, double 1.000000e+00)
  %589 = fptosi double %574 to i32
  %590 = tail call double @llvm.amdgcn.ldexp.f64(double %588, i32 %589)
  %591 = fcmp ogt double %569, 1.024000e+03
  %592 = select i1 %591, double 0x7FF0000000000000, double %590
  %593 = fcmp olt double %569, -1.075000e+03
  %594 = select i1 %593, double 0.000000e+00, double %592
  %595 = tail call double @llvm.fma.f64(double %594, double %572, double %594)
  %596 = tail call double @llvm.fabs.f64(double %594) #13
  %597 = fcmp oeq double %596, 0x7FF0000000000000
  %598 = select i1 %597, double %594, double %595
  %599 = tail call double @llvm.fabs.f64(double %440)
  %600 = tail call double @llvm.trunc.f64(double %599)
  %601 = fcmp oeq double %599, %600
  %602 = zext i1 %601 to i32
  %603 = fmul double %600, 5.000000e-01
  %604 = tail call double @llvm.amdgcn.fract.f64(double %603)
  %605 = tail call i1 @llvm.amdgcn.class.f64(double %603, i32 516)
  %606 = select i1 %605, double 0.000000e+00, double %604
  %607 = fcmp oeq double %606, 0.000000e+00
  %608 = and i1 %601, %607
  %609 = zext i1 %608 to i32
  %610 = add nuw nsw i32 %609, %602
  %611 = icmp eq i32 %610, 1
  %612 = icmp slt i32 %2, 0
  %613 = and i1 %612, %611
  %614 = select i1 %613, double -0.000000e+00, double 0.000000e+00
  %615 = tail call double @llvm.copysign.f64(double %598, double %614)
  %616 = icmp sgt i32 %2, -1
  %617 = icmp ne i32 %610, 0
  %618 = select i1 %616, i1 true, i1 %617
  %619 = select i1 %618, double %615, double 0x7FF8000000000000
  %620 = fcmp oeq double %599, 0x7FF0000000000000
  %621 = fcmp oeq double %441, 1.000000e+00
  %622 = fadd double %441, -1.000000e+00
  %623 = bitcast double %440 to <2 x i32>
  %624 = extractelement <2 x i32> %623, i64 1
  %625 = bitcast double %622 to <2 x i32>
  %626 = extractelement <2 x i32> %625, i64 1
  %627 = xor i32 %626, %624
  %628 = icmp sgt i32 %627, -1
  %629 = select i1 %628, double 0x7FF0000000000000, double 0.000000e+00
  %630 = select i1 %621, double %441, double %629
  %631 = select i1 %620, double %630, double %619
  %632 = fcmp oeq double %441, 0x7FF0000000000000
  %633 = icmp eq i32 %2, 0
  %634 = or i1 %633, %632
  %635 = icmp slt i32 %1, 0
  %636 = xor i1 %635, %633
  %637 = select i1 %636, double 0.000000e+00, double 0x7FF0000000000000
  %638 = select i1 %611, double %439, double 0.000000e+00
  %639 = tail call double @llvm.copysign.f64(double %637, double %638)
  %640 = select i1 %634, double %639, double %631
  %641 = icmp eq i32 %2, 1
  %642 = icmp eq i32 %1, 0
  %643 = or i1 %642, %641
  %644 = fptosi double %640 to i32
  %645 = shl nsw i32 %644, 1
  %646 = select i1 %643, i32 2, i32 %645
  %647 = add nsw i32 %646, %438
  %648 = add i32 %437, %6
  %649 = mul i32 %647, %648
  %650 = add nsw i32 %649, %438
  %651 = add nsw i32 %650, %20
  %652 = sext i32 %651 to i64
  %653 = getelementptr inbounds float, float addrspace(1)* %10, i64 %652
  store float %436, float addrspace(1)* %653, align 4, !tbaa !13
  tail call fastcc void @__ockl_dm_dealloc(i64 %162) #12
  tail call fastcc void @__ockl_dm_dealloc(i64 %26) #12
  br label %674

654:                                              ; preds = %657
  %655 = add nuw nsw i32 %427, 1
  %656 = icmp eq i32 %655, %1
  br i1 %656, label %433, label %426, !llvm.loop !19

657:                                              ; preds = %426, %657
  %658 = phi i32 [ %427, %426 ], [ %672, %657 ]
  %659 = phi i32 [ %428, %426 ], [ %665, %657 ]
  %660 = phi float [ %429, %426 ], [ %671, %657 ]
  %661 = zext i32 %658 to i64
  %662 = getelementptr inbounds float, float addrspace(1)* %163, i64 %661
  %663 = load float, float addrspace(1)* %662, align 4, !tbaa !13
  %664 = fmul contract float %432, %663
  %665 = add nsw i32 %659, 1
  %666 = add nsw i32 %665, %1
  %667 = sext i32 %666 to i64
  %668 = getelementptr inbounds float, float addrspace(1)* %7, i64 %667
  %669 = load float, float addrspace(1)* %668, align 4, !tbaa !13
  %670 = fmul contract float %664, %669
  %671 = fadd contract float %660, %670
  %672 = add nuw nsw i32 %658, 1
  %673 = icmp slt i32 %672, %1
  br i1 %673, label %657, label %654, !llvm.loop !20

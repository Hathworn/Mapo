; ModuleID = '../data/hip_kernels/10483/30/main.cu'
source_filename = "../data/hip_kernels/10483/30/main.cu"
...
define protected amdgpu_kernel void @_Z16interpolateMultiiiiPfS_S_(i32 %0, i32 %1, i32 %2, float addrspace(1)* nocapture readonly %3, float addrspace(1)* nocapture readonly %4, float addrspace(1)* nocapture writeonly %5) local_unnamed_addr #1 {
...
17:                                               ; preds = %6
  ...
  %23 = tail call fastcc i8 addrspace(1)* @__ockl_dm_alloc(i64 %19) #12
  %24 = ptrtoint i8 addrspace(1)* %23 to i64
  %25 = bitcast i8 addrspace(1)* %23 to float addrspace(1)*
  %26 = add nsw i32 %1, -1
  %27 = sitofp i32 %26 to double
  %28 = fmul double %27, 0x3FE62E42FEFA39EF
  %29 = fneg double %28
  %30 = tail call double @llvm.fma.f64(double %27, double 0x3FE62E42FEFA39EF, double %29)
  %31 = tail call double @llvm.fma.f64(double %27, double 0x3C7ABC9E3B39803F, double %30)
  %32 = fadd double %28, %31
  %33 = fsub double %32, %28
  %34 = fsub double %31, %33
  %35 = tail call double @llvm.fabs.f64(double %28) #13
  %36 = fcmp oeq double %35, 0x7FF0000000000000
  %37 = select i1 %36, double %28, double %32
  %38 = tail call double @llvm.fabs.f64(double %37) #13
  %39 = fcmp oeq double %38, 0x7FF0000000000000
  %40 = select i1 %39, double 0.000000e+00, double %34
  %41 = fmul double %37, 0x3FF71547652B82FE
  %42 = tail call double @llvm.rint.f64(double %41)
  %43 = fneg double %42
  %44 = tail call double @llvm.fma.f64(double %43, double 0x3FE62E42FEFA39EF, double %37)
  ...
  %59 = fcmp ogt double %37, 1.024000e+03
  %60 = select i1 %59, double 0x7FF0000000000000, double %58
  %61 = fcmp olt double %37, -1.075000e+03
  %62 = select i1 %61, double 0.000000e+00, double %60
  %63 = tail call double @llvm.fma.f64(double %62, double %40, double %62)
  %64 = tail call double @llvm.fabs.f64(double %62) #13
  %65 = fcmp oeq double %64, 0x7FF0000000000000
  %66 = select i1 %65, double %62, double %63
  %67 = tail call double @llvm.fabs.f64(double %27)
  %68 = tail call double @llvm.trunc.f64(double %67)
  %69 = fcmp oeq double %67, %68
  %70 = zext i1 %69 to i32
  %71 = fmul double %68, 5.000000e-01
  %72 = tail call double @llvm.amdgcn.fract.f64(double %71)
  %73 = tail call i1 @llvm.amdgcn.class.f64(double %71, i32 516)
  ...
  %79 = icmp eq i32 %78, 1
  %80 = tail call double @llvm.fabs.f64(double %66)
  %81 = fcmp oeq double %67, 0x7FF0000000000000
  %82 = bitcast double %27 to <2 x i32>
  %83 = extractelement <2 x i32> %82, i64 1
  %84 = icmp sgt i32 %83, -1
  %85 = select i1 %84, double 0x7FF0000000000000, double 0.000000e+00
  %86 = select i1 %81, double %85, double %80
  %87 = icmp slt i32 %1, 1
  %88 = icmp eq i32 %26, 0
  ...
  %92 = shl nsw i64 %91, 2
  %93 = tail call fastcc i8 addrspace(1)* @__ockl_dm_alloc(i64 %92) #12
  %94 = ptrtoint i8 addrspace(1)* %93 to i64
  %95 = bitcast i8 addrspace(1)* %93 to float addrspace(1)*
  %96 = tail call fastcc i8 addrspace(1)* @__ockl_dm_alloc(i64 %19) #12
  %97 = ptrtoint i8 addrspace(1)* %96 to i64
  %98 = bitcast i8 addrspace(1)* %96 to i32 addrspace(1)*
  %99 = icmp sgt i32 %1, 0
  br i1 %99, label %102, label %100

100:                                              ; preds = %17
  %101 = mul nsw i32 %15, %1
  br label %107

102:                                              ; preds = %17
  %103 = add nsw i32 %2, -1
  %104 = sitofp i32 %103 to float
  %105 = mul nsw i32 %15, %1
  %106 = add nsw i32 %2, -2
  br label %318

107:                                              ; preds = %349, %100
  %108 = phi i32 [ %101, %100 ], [ %105, %349 ]
  %109 = load i32, i32 addrspace(1)* %98, align 4, !tbaa !7
  ...
  %120 = fsub contract float %119, %112
  %121 = fsub contract float %116, %112
  %122 = fdiv contract float %120, %121
  %123 = icmp sgt i32 %90, 0
...
124:                                              ; preds = %107
  ...
  %129 = tail call double @llvm.amdgcn.frexp.mant.f64(double %128)
  %130 = fcmp olt double %129, 0x3FE5555555555555
  %131 = zext i1 %130 to i32
  %132 = tail call double @llvm.amdgcn.ldexp.f64(double %129, i32 %131)
  %133 = tail call i32 @llvm.amdgcn.frexp.exp.i32.f64(double %128)
  %134 = sub nsw i32 %133, %131
  %135 = fadd double %132, -1.000000e+00
  %136 = fadd double %132, 1.000000e+00
  %137 = fadd double %136, -1.000000e+00
  %138 = fsub double %132, %137
  %139 = tail call double @llvm.amdgcn.rcp.f64(double %136)
  %140 = fneg double %136
  %141 = tail call double @llvm.fma.f64(double %140, double %139, double 1.000000e+00)
  %142 = tail call double @llvm.fma.f64(double %141, double %139, double %139)
  %143 = tail call double @llvm.fma.f64(double %140, double %142, double 1.000000e+00)
  %144 = tail call double @llvm.fma.f64(double %143, double %142, double %142)
  %145 = fmul double %135, %144
  %146 = fmul double %136, %145
  %147 = fneg double %146
  %148 = tail call double @llvm.fma.f64(double %145, double %136, double %147)
  %149 = tail call double @llvm.fma.f64(double %145, double %138, double %148)
  ...
  %163 = fneg double %162
  %164 = tail call double @llvm.fma.f64(double %159, double %159, double %163)
  %165 = fmul double %161, 2.000000e+00
  %166 = tail call double @llvm.fma.f64(double %159, double %165, double %164)
  %167 = fadd double %162, %166
  %168 = fsub double %167, %162
  %169 = fsub double %166, %168
  %170 = tail call double @llvm.fma.f64(double %167, double 0x3FBDEE674222DE17, double 0x3FBA6564968915A9)
  %171 = tail call double @llvm.fma.f64(double %167, double %170, double 0x3FBE25E43ABE935A)
  %172 = tail call double @llvm.fma.f64(double %167, double %171, double 0x3FC110EF47E6C9C2)
  %173 = tail call double @llvm.fma.f64(double %167, double %172, double 0x3FC3B13BCFA74449)
  %174 = tail call double @llvm.fma.f64(double %167, double %173, double 0x3FC745D171BF3C30)
  %175 = tail call double @llvm.fma.f64(double %167, double %174, double 0x3FCC71C71C7792CE)
  %176 = tail call double @llvm.fma.f64(double %167, double %175, double 0x3FD24924924920DA)
  %177 = tail call double @llvm.fma.f64(double %167, double %176, double 0x3FD999999999999C)
  %178 = sitofp i32 %134 to double
  ...
  %186 = tail call double @llvm.amdgcn.ldexp.f64(double %159, i32 1)
  %187 = tail call double @llvm.amdgcn.ldexp.f64(double %161, i32 1)
  %188 = fmul double %159, %167
  %189 = fneg double %188
  %190 = tail call double @llvm.fma.f64(double %167, double %159, double %189)
  %191 = tail call double @llvm.fma.f64(double %167, double %161, double %190)
  %192 = tail call double @llvm.fma.f64(double %169, double %159, double %191)
  %193 = fadd double %188, %192
  %194 = fsub double %193, %188
  %195 = fsub double %192, %194
  %196 = fmul double %167, %177
  %197 = fneg double %196
  %198 = tail call double @llvm.fma.f64(double %167, double %177, double %197)
  %199 = tail call double @llvm.fma.f64(double %169, double %177, double %198)
  %200 = fadd double %196, %199
  %201 = fsub double %200, %196
  %202 = fsub double %199, %201
  %203 = fadd double %200, 0x3FE5555555555555
  %204 = fadd double %203, 0xBFE5555555555555
  %205 = fsub double %200, %204
  %206 = fadd double %202, 0x3C8543B0D5DF274D
  %207 = fadd double %206, %205
  %208 = fadd double %203, %207
  %209 = fsub double %208, %203
  %210 = fsub double %207, %209
  %211 = fmul double %193, %208
  %212 = fneg double %211
  %213 = tail call double @llvm.fma.f64(double %193, double %208, double %212)
  %214 = tail call double @llvm.fma.f64(double %193, double %210, double %213)
  %215 = tail call double @llvm.fma.f64(double %195, double %208, double %214)
  %216 = fadd double %211, %215
  %217 = fsub double %216, %211
  %218 = fsub double %215, %217
  %219 = fadd double %186, %216
  %220 = fsub double %219, %186
  %221 = fsub double %216, %220
  %222 = fadd double %187, %218
  %223 = fadd double %222, %221
  %224 = fadd double %219, %223
  %225 = fsub double %224, %219
  %226 = fsub double %223, %225
  %227 = fadd double %183, %224
  %228 = fsub double %227, %183
  %229 = fsub double %227, %228
  %230 = fsub double %183, %229
  %231 = fsub double %224, %228
  %232 = fadd double %231, %230
  %233 = fadd double %185, %226
  %234 = fsub double %233, %185
  %235 = fsub double %233, %234
  %236 = fsub double %185, %235
  %237 = fsub double %226, %234
  %238 = fadd double %237, %236
  %239 = fadd double %233, %232
  %240 = fadd double %227, %239
  %241 = fsub double %240, %227
  %242 = fsub double %239, %241
  %243 = fadd double %238, %242
  %244 = fadd double %240, %243
  %245 = fsub double %244, %240
  %246 = fsub double %243, %245
  %247 = icmp slt i32 %2, 0
  %248 = icmp sgt i32 %2, -1
  %249 = fcmp oeq double %128, 1.000000e+00
  %250 = fadd double %128, -1.000000e+00
  %251 = bitcast double %250 to <2 x i32>
  %252 = extractelement <2 x i32> %251, i64 1
  %253 = fcmp oeq double %128, 0x7FF0000000000000
  %254 = icmp eq i32 %2, 0
  %255 = or i1 %254, %253
  %256 = icmp eq i32 %2, 1
  %257 = fmul double %244, %27
  %258 = fneg double %257
  %259 = tail call double @llvm.fma.f64(double %27, double %244, double %258)
  %260 = tail call double @llvm.fma.f64(double %27, double %246, double %259)
  %261 = fadd double %257, %260
  %262 = fsub double %261, %257
  %263 = fsub double %260, %262
  %264 = tail call double @llvm.fabs.f64(double %257) #13
  %265 = fcmp oeq double %264, 0x7FF0000000000000
  %266 = select i1 %265, double %257, double %261
  %267 = tail call double @llvm.fabs.f64(double %266) #13
  %268 = fcmp oeq double %267, 0x7FF0000000000000
  %269 = select i1 %268, double 0.000000e+00, double %263
  %270 = fmul double %266, 0x3FF71547652B82FE
  %271 = tail call double @llvm.rint.f64(double %270)
  %272 = fneg double %271
  %273 = tail call double @llvm.fma.f64(double %272, double 0x3FE62E42FEFA39EF, double %266)
  ...
  %287 = tail call double @llvm.amdgcn.ldexp.f64(double %285, i32 %286)
  %288 = fcmp ogt double %266, 1.024000e+03
  %289 = select i1 %288, double 0x7FF0000000000000, double %287
  %290 = fcmp olt double %266, -1.075000e+03
  %291 = select i1 %290, double 0.000000e+00, double %289
  %292 = tail call double @llvm.fma.f64(double %291, double %269, double %291)
  %293 = tail call double @llvm.fabs.f64(double %291) #13
  %294 = fcmp oeq double %293, 0x7FF0000000000000
  %295 = select i1 %294, double %291, double %292
  %296 = and i1 %247, %79
  %297 = select i1 %296, double -0.000000e+00, double 0.000000e+00
  %298 = tail call double @llvm.copysign.f64(double %295, double %297)
  %299 = icmp ne i32 %78, 0
  %300 = select i1 %248, i1 true, i1 %299
  %301 = select i1 %300, double %298, double 0x7FF8000000000000
  %302 = xor i32 %252, %83
  %303 = icmp sgt i32 %302, -1
  %304 = select i1 %303, double 0x7FF0000000000000, double 0.000000e+00
  %305 = select i1 %249, double %128, double %304
  %306 = select i1 %81, double %305, double %301
  %307 = xor i1 %87, %254
  %308 = select i1 %307, double 0.000000e+00, double 0x7FF0000000000000
  %309 = select i1 %79, double %127, double 0.000000e+00
  %310 = tail call double @llvm.copysign.f64(double %308, double %309)
  %311 = select i1 %255, double %310, double %306
  %312 = or i1 %256, %88
  %313 = fptosi double %311 to i32
  %314 = select i1 %312, i32 1, i32 %313
  %315 = mul nsw i32 %113, %314
  %316 = mul nsw i32 %109, %314
  %317 = fsub contract float 1.000000e+00, %122
  br label %353

318:                                              ; preds = %102, %349
  %319 = phi i32 [ 0, %102 ], [ %326, %349 ]
  %320 = mul nsw i32 %319, %2
  %321 = sext i32 %320 to i64
  %322 = getelementptr inbounds float, float addrspace(1)* %3, i64 %321
  %323 = load float, float addrspace(1)* %322, align 4, !tbaa !11
  %324 = zext i32 %319 to i64
  %325 = getelementptr inbounds float, float addrspace(1)* %22, i64 %324
  store float %323, float addrspace(1)* %325, align 4, !tbaa !11
  ...
  %332 = getelementptr inbounds float, float addrspace(1)* %25, i64 %324
  store float %331, float addrspace(1)* %332, align 4, !tbaa !11
  %333 = add nsw i32 %319, %105
  %334 = sext i32 %333 to i64
  %335 = getelementptr inbounds float, float addrspace(1)* %4, i64 %334
  %336 = load float, float addrspace(1)* %335, align 4, !tbaa !11
  %337 = load float, float addrspace(1)* %325, align 4, !tbaa !11
  %338 = fsub contract float %336, %337
  %339 = fmul contract float %338, %104
  %340 = fsub contract float %331, %337
  %341 = fdiv contract float %339, %340
  %342 = fptosi float %341 to i32
  %343 = getelementptr inbounds i32, i32 addrspace(1)* %98, i64 %324
  store i32 %342, i32 addrspace(1)* %343, align 4, !tbaa !7
  %344 = icmp sgt i32 %103, %342
...
347:                                              ; preds = %345, %318
  %348 = phi i32 [ %106, %318 ], [ 0, %345 ]
  store i32 %348, i32 addrspace(1)* %343, align 4, !tbaa !7
  br label %349

349:                                              ; preds = %347, %345
  %350 = icmp eq i32 %326, %1
  br i1 %350, label %107, label %318, !llvm.loop !13

351:                                              ; preds = %355, %107
  %352 = icmp sgt i32 %1, 1
  br i1 %352, label %559, label %555

353:                                              ; preds = %124, %355
  %354 = phi i32 [ 0, %124 ], [ %370, %355 ]
  br i1 %126, label %372, label %355

355:                                              ; preds = %529, %353
  %356 = phi i32 [ %125, %353 ], [ %552, %529 ]
  %357 = add nsw i32 %356, %315
  %358 = add nsw i32 %356, %316
  %359 = sext i32 %358 to i64
  %360 = getelementptr inbounds float, float addrspace(1)* %3, i64 %359
  %361 = load float, float addrspace(1)* %360, align 4, !tbaa !11
  %362 = fmul contract float %317, %361
  ...
  %366 = fmul contract float %122, %365
  %367 = fadd contract float %362, %366
  %368 = zext i32 %354 to i64
  %369 = getelementptr inbounds float, float addrspace(1)* %95, i64 %368
  store float %367, float addrspace(1)* %369, align 4, !tbaa !11
  %370 = add nuw nsw i32 %354, 1
  %371 = icmp eq i32 %370, %90
  br i1 %371, label %351, label %353, !llvm.loop !15

372:                                              ; preds = %353, %529
  %373 = phi i32 [ %553, %529 ], [ 1, %353 ]
  %374 = phi i32 [ %552, %529 ], [ %125, %353 ]
  %375 = sub nsw i32 %1, %373
  %376 = add nsw i32 %375, -1
  %377 = sitofp i32 %376 to double
  %378 = fmul double %377, 0x3FE62E42FEFA39EF
  %379 = fneg double %378
  %380 = tail call double @llvm.fma.f64(double %377, double 0x3FE62E42FEFA39EF, double %379)
  %381 = tail call double @llvm.fma.f64(double %377, double 0x3C7ABC9E3B39803F, double %380)
  %382 = fadd double %378, %381
  %383 = fsub double %382, %378
  %384 = fsub double %381, %383
  %385 = tail call double @llvm.fabs.f64(double %378) #13
  %386 = fcmp oeq double %385, 0x7FF0000000000000
  %387 = select i1 %386, double %378, double %382
  %388 = tail call double @llvm.fabs.f64(double %387) #13
  %389 = fcmp oeq double %388, 0x7FF0000000000000
  %390 = select i1 %389, double 0.000000e+00, double %384
  %391 = fmul double %387, 0x3FF71547652B82FE
  %392 = tail call double @llvm.rint.f64(double %391)
  %393 = fneg double %392
  %394 = tail call double @llvm.fma.f64(double %393, double 0x3FE62E42FEFA39EF, double %387)
  %395 = tail call double @llvm.fma.f64(double %393, double 0x3C7ABC9E3B39803F, double %394)
  %396 = tail call double @llvm.fma.f64(double %395, double 0x3E5ADE156A5DCB37, double 0x3E928AF3FCA7AB0C)
  %397 = tail call double @llvm.fma.f64(double %395, double %396, double 0x3EC71DEE623FDE64)
  %398 = tail call double @llvm.fma.f64(double %395, double %397, double 0x3EFA01997C89E6B0)
  %399 = tail call double @llvm.fma.f64(double %395, double %398, double 0x3F2A01A014761F6E)
  %400 = tail call double @llvm.fma.f64(double %395, double %399, double 0x3F56C16C1852B7B0)
  %401 = tail call double @llvm.fma.f64(double %395, double %400, double 0x3F81111111122322)
  %402 = tail call double @llvm.fma.f64(double %395, double %401, double 0x3FA55555555502A1)
  %403 = tail call double @llvm.fma.f64(double %395, double %402, double 0x3FC5555555555511)
  %404 = tail call double @llvm.fma.f64(double %395, double %403, double 0x3FE000000000000B)
  %405 = tail call double @llvm.fma.f64(double %395, double %404, double 1.000000e+00)
  %406 = tail call double @llvm.fma.f64(double %395, double %405, double 1.000000e+00)
  %407 = fptosi double %392 to i32
  %408 = tail call double @llvm.amdgcn.ldexp.f64(double %406, i32 %407)
  %409 = fcmp ogt double %387, 1.024000e+03
  %410 = select i1 %409, double 0x7FF0000000000000, double %408
  %411 = fcmp olt double %387, -1.075000e+03
  %412 = select i1 %411, double 0.000000e+00, double %410
  %413 = tail call double @llvm.fma.f64(double %412, double %390, double %412)
  %414 = tail call double @llvm.fabs.f64(double %412) #13
  %415 = fcmp oeq double %414, 0x7FF0000000000000
  %416 = select i1 %415, double %412, double %413
  %417 = tail call double @llvm.fabs.f64(double %377)
  %418 = tail call double @llvm.trunc.f64(double %417)
  %419 = fcmp oeq double %417, %418
  %420 = zext i1 %419 to i32
  %421 = fmul double %418, 5.000000e-01
  ...
  %430 = tail call double @llvm.fabs.f64(double %416)
  %431 = fcmp oeq double %417, 0x7FF0000000000000
  %432 = bitcast double %377 to <2 x i32>
  %433 = extractelement <2 x i32> %432, i64 1
  %434 = icmp sgt i32 %433, -1
  %435 = select i1 %434, double 0x7FF0000000000000, double 0.000000e+00
  %436 = select i1 %431, double %435, double %430
  %437 = icmp slt i32 %375, 1
  %438 = icmp eq i32 %376, 0
  %439 = fptosi double %436 to i32
  %440 = select i1 %438, i32 1, i32 %439
  %441 = sdiv i32 %354, %440
  %442 = add nsw i32 %441, 1
  %443 = and i32 %442, -2147483647
  %444 = icmp eq i32 %443, 1
  %445 = zext i32 %373 to i64
  %446 = getelementptr inbounds i32, i32 addrspace(1)* %98, i64 %445
  %447 = load i32, i32 addrspace(1)* %446, align 4, !tbaa !7
  br i1 %444, label %448, label %488

448:                                              ; preds = %372
  %449 = fmul double %244, %377
  %450 = fneg double %449
  %451 = tail call double @llvm.fma.f64(double %377, double %244, double %450)
  %452 = tail call double @llvm.fma.f64(double %377, double %246, double %451)
  %453 = fadd double %449, %452
  %454 = fsub double %453, %449
  %455 = fsub double %452, %454
  %456 = tail call double @llvm.fabs.f64(double %449) #13
  %457 = fcmp oeq double %456, 0x7FF0000000000000
  %458 = select i1 %457, double %449, double %453
  %459 = tail call double @llvm.fabs.f64(double %458) #13
  %460 = fcmp oeq double %459, 0x7FF0000000000000
  %461 = select i1 %460, double 0.000000e+00, double %455
  %462 = fmul double %458, 0x3FF71547652B82FE
  %463 = tail call double @llvm.rint.f64(double %462)
  %464 = fneg double %463
  %465 = tail call double @llvm.fma.f64(double %464, double 0x3FE62E42FEFA39EF, double %458)
  %466 = tail call double @llvm.fma.f64(double %464, double 0x3C7ABC9E3B39803F, double %465)
  %467 = tail call double @llvm.fma.f64(double %466, double 0x3E5ADE156A5DCB37, double 0x3E928AF3FCA7AB0C)
  %468 = tail call double @llvm.fma.f64(double %466, double %467, double 0x3EC71DEE623FDE64)
  %469 = tail call double @llvm.fma.f64(double %466, double %468, double 0x3EFA01997C89E6B0)
  %470 = tail call double @llvm.fma.f64(double %466, double %469, double 0x3F2A01A014761F6E)
  %471 = tail call double @llvm.fma.f64(double %466, double %470, double 0x3F56C16C1852B7B0)
  %472 = tail call double @llvm.fma.f64(double %466, double %471, double 0x3F81111111122322)
  %473 = tail call double @llvm.fma.f64(double %466, double %472, double 0x3FA55555555502A1)
  %474 = tail call double @llvm.fma.f64(double %466, double %473, double 0x3FC5555555555511)
  %475 = tail call double @llvm.fma.f64(double %466, double %474, double 0x3FE000000000000B)
  %476 = tail call double @llvm.fma.f64(double %466, double %475, double 1.000000e+00)
  %477 = tail call double @llvm.fma.f64(double %466, double %476, double 1.000000e+00)
  %478 = fptosi double %463 to i32
  %479 = tail call double @llvm.amdgcn.ldexp.f64(double %477, i32 %478)
  %480 = fcmp ogt double %458, 1.024000e+03
  %481 = select i1 %480, double 0x7FF0000000000000, double %479
  %482 = fcmp olt double %458, -1.075000e+03
  %483 = select i1 %482, double 0.000000e+00, double %481
  %484 = tail call double @llvm.fma.f64(double %483, double %461, double %483)
  %485 = tail call double @llvm.fabs.f64(double %483) #13
...
488:                                              ; preds = %372
  ...
  %490 = fmul double %244, %377
  %491 = fneg double %490
  %492 = tail call double @llvm.fma.f64(double %377, double %244, double %491)
  %493 = tail call double @llvm.fma.f64(double %377, double %246, double %492)
  %494 = fadd double %490, %493
  %495 = fsub double %494, %490
  %496 = fsub double %493, %495
  %497 = tail call double @llvm.fabs.f64(double %490) #13
  %498 = fcmp oeq double %497, 0x7FF0000000000000
  %499 = select i1 %498, double %490, double %494
  %500 = tail call double @llvm.fabs.f64(double %499) #13
  ...
  %526 = tail call double @llvm.fabs.f64(double %524) #13
  %527 = fcmp oeq double %526, 0x7FF0000000000000
  %528 = select i1 %527, double %524, double %525
  br label %529

529:                                              ; preds = %488, %448
  %530 = phi double [ %528, %488 ], [ %487, %448 ]
  %531 = phi i32 [ %489, %488 ], [ %447, %448 ]
  %532 = and i1 %247, %429
  %533 = select i1 %532, double -0.000000e+00, double 0.000000e+00
  %534 = tail call double @llvm.copysign.f64(double %530, double %533)
  %535 = icmp ne i32 %428, 0
  %536 = select i1 %248, i1 true, i1 %535
  %537 = select i1 %536, double %534, double 0x7FF8000000000000
  %538 = xor i32 %433, %252
  %539 = icmp sgt i32 %538, -1
  %540 = select i1 %539, double 0x7FF0000000000000, double 0.000000e+00
  %541 = select i1 %249, double %128, double %540
  %542 = select i1 %431, double %541, double %537
  %543 = xor i1 %254, %437
  %544 = select i1 %543, double 0.000000e+00, double 0x7FF0000000000000
  %545 = select i1 %429, double %127, double 0.000000e+00
  %546 = tail call double @llvm.copysign.f64(double %544, double %545)
  %547 = select i1 %255, double %546, double %542
  %548 = or i1 %256, %438
  %549 = fptosi double %547 to i32
  %550 = select i1 %548, i32 1, i32 %549
  %551 = mul nsw i32 %531, %550
  %552 = add nsw i32 %551, %374
  %553 = add nuw nsw i32 %373, 1
  %554 = icmp eq i32 %553, %1
  br i1 %554, label %355, label %372, !llvm.loop !16

555:                                              ; preds = %706, %351
  tail call fastcc void @__ockl_dm_dealloc(i64 %97) #12
  tail call fastcc void @__ockl_dm_dealloc(i64 %94) #12
  tail call fastcc void @__ockl_dm_dealloc(i64 %24) #12
  tail call fastcc void @__ockl_dm_dealloc(i64 %21) #12
  %556 = load float, float addrspace(1)* %95, align 4, !tbaa !11
  %557 = sext i32 %15 to i64
  %558 = getelementptr inbounds float, float addrspace(1)* %5, i64 %557
  store float %556, float addrspace(1)* %558, align 4, !tbaa !11
  br label %802

559:                                              ; preds = %351, %706
  %560 = phi i32 [ %707, %706 ], [ 1, %351 ]
  %561 = mul nsw i32 %560, %2
  %562 = zext i32 %560 to i64
  %563 = getelementptr inbounds i32, i32 addrspace(1)* %98, i64 %562
  %564 = load i32, i32 addrspace(1)* %563, align 4, !tbaa !7
  ...
  %572 = load float, float addrspace(1)* %571, align 4, !tbaa !11
  %573 = getelementptr inbounds float, float addrspace(1)* %4, i64 %562
  %574 = load float, float addrspace(1)* %573, align 4, !tbaa !11
  %575 = fsub contract float %574, %568
  %576 = fsub contract float %572, %568
  %577 = fdiv contract float %575, %576
  %578 = sitofp i32 %560 to double
  %579 = fmul double %578, 0x3FE62E42FEFA39EF
  %580 = fneg double %579
  %581 = tail call double @llvm.fma.f64(double %578, double 0x3FE62E42FEFA39EF, double %580)
  %582 = tail call double @llvm.fma.f64(double %578, double 0x3C7ABC9E3B39803F, double %581)
  %583 = fadd double %579, %582
  %584 = fsub double %583, %579
  %585 = fsub double %582, %584
  %586 = tail call double @llvm.fabs.f64(double %579) #13
  %587 = fcmp oeq double %586, 0x7FF0000000000000
  %588 = select i1 %587, double %579, double %583
  %589 = tail call double @llvm.fabs.f64(double %588) #13
  %590 = fcmp oeq double %589, 0x7FF0000000000000
  %591 = select i1 %590, double 0.000000e+00, double %585
  %592 = fmul double %588, 0x3FF71547652B82FE
  %593 = tail call double @llvm.rint.f64(double %592)
  %594 = fneg double %593
  %595 = tail call double @llvm.fma.f64(double %594, double 0x3FE62E42FEFA39EF, double %588)
  %596 = tail call double @llvm.fma.f64(double %594, double 0x3C7ABC9E3B39803F, double %595)
  %597 = tail call double @llvm.fma.f64(double %596, double 0x3E5ADE156A5DCB37, double 0x3E928AF3FCA7AB0C)
  %598 = tail call double @llvm.fma.f64(double %596, double %597, double 0x3EC71DEE623FDE64)
  %599 = tail call double @llvm.fma.f64(double %596, double %598, double 0x3EFA01997C89E6B0)
  %600 = tail call double @llvm.fma.f64(double %596, double %599, double 0x3F2A01A014761F6E)
  %601 = tail call double @llvm.fma.f64(double %596, double %600, double 0x3F56C16C1852B7B0)
  %602 = tail call double @llvm.fma.f64(double %596, double %601, double 0x3F81111111122322)
  %603 = tail call double @llvm.fma.f64(double %596, double %602, double 0x3FA55555555502A1)
  %604 = tail call double @llvm.fma.f64(double %596, double %603, double 0x3FC5555555555511)
  %605 = tail call double @llvm.fma.f64(double %596, double %604, double 0x3FE000000000000B)
  %606 = tail call double @llvm.fma.f64(double %596, double %605, double 1.000000e+00)
  %607 = tail call double @llvm.fma.f64(double %596, double %606, double 1.000000e+00)
  %608 = fptosi double %593 to i32
  %609 = tail call double @llvm.amdgcn.ldexp.f64(double %607, i32 %608)
  %610 = fcmp ogt double %588, 1.024000e+03
  %611 = select i1 %610, double 0x7FF0000000000000, double %609
  %612 = fcmp olt double %588, -1.075000e+03
  %613 = select i1 %612, double 0.000000e+00, double %611
  %614 = tail call double @llvm.fma.f64(double %613, double %591, double %613)
  %615 = tail call double @llvm.fabs.f64(double %613) #13
  %616 = fcmp oeq double %615, 0x7FF0000000000000
  %617 = select i1 %616, double %613, double %614
  %618 = tail call double @llvm.fabs.f64(double %578)
  %619 = tail call double @llvm.fabs.f64(double %617)
  %620 = fcmp oeq double %618, 0x7FF0000000000000
  %621 = bitcast double %578 to <2 x i32>
  %622 = extractelement <2 x i32> %621, i64 1
  %623 = icmp sgt i32 %622, -1
  %624 = select i1 %623, double 0x7FF0000000000000, double 0.000000e+00
  %625 = select i1 %620, double %624, double %619
  %626 = fptosi double %625 to i32
  %627 = icmp sgt i32 %626, 0
  br i1 %627, label %628, label %706

628:                                              ; preds = %559
  %629 = sub nsw i32 %1, %560
  %630 = add nsw i32 %629, -2
  %631 = sitofp i32 %630 to double
  %632 = fmul double %631, 0x3FE62E42FEFA39EF
  %633 = fneg double %632
  %634 = tail call double @llvm.fma.f64(double %631, double 0x3FE62E42FEFA39EF, double %633)
  %635 = tail call double @llvm.fma.f64(double %631, double 0x3C7ABC9E3B39803F, double %634)
  %636 = fadd double %632, %635
  %637 = fsub double %636, %632
  %638 = fsub double %635, %637
  %639 = tail call double @llvm.fabs.f64(double %632) #13
  %640 = fcmp oeq double %639, 0x7FF0000000000000
  %641 = select i1 %640, double %632, double %636
  %642 = tail call double @llvm.fabs.f64(double %641) #13
  %643 = fcmp oeq double %642, 0x7FF0000000000000
  %644 = select i1 %643, double 0.000000e+00, double %638
  %645 = fmul double %641, 0x3FF71547652B82FE
  %646 = tail call double @llvm.rint.f64(double %645)
  %647 = fneg double %646
  %648 = tail call double @llvm.fma.f64(double %647, double 0x3FE62E42FEFA39EF, double %641)
  %649 = tail call double @llvm.fma.f64(double %647, double 0x3C7ABC9E3B39803F, double %648)
  %650 = tail call double @llvm.fma.f64(double %649, double 0x3E5ADE156A5DCB37, double 0x3E928AF3FCA7AB0C)
  %651 = tail call double @llvm.fma.f64(double %649, double %650, double 0x3EC71DEE623FDE64)
  %652 = tail call double @llvm.fma.f64(double %649, double %651, double 0x3EFA01997C89E6B0)
  %653 = tail call double @llvm.fma.f64(double %649, double %652, double 0x3F2A01A014761F6E)
  %654 = tail call double @llvm.fma.f64(double %649, double %653, double 0x3F56C16C1852B7B0)
  %655 = tail call double @llvm.fma.f64(double %649, double %654, double 0x3F81111111122322)
  %656 = tail call double @llvm.fma.f64(double %649, double %655, double 0x3FA55555555502A1)
  %657 = tail call double @llvm.fma.f64(double %649, double %656, double 0x3FC5555555555511)
  %658 = tail call double @llvm.fma.f64(double %649, double %657, double 0x3FE000000000000B)
  %659 = tail call double @llvm.fma.f64(double %649, double %658, double 1.000000e+00)
  %660 = tail call double @llvm.fma.f64(double %649, double %659, double 1.000000e+00)
  %661 = fptosi double %646 to i32
  %662 = tail call double @llvm.amdgcn.ldexp.f64(double %660, i32 %661)
  %663 = fcmp ogt double %641, 1.024000e+03
  %664 = select i1 %663, double 0x7FF0000000000000, double %662
  %665 = fcmp olt double %641, -1.075000e+03
  %666 = select i1 %665, double 0.000000e+00, double %664
  %667 = tail call double @llvm.fma.f64(double %666, double %644, double %666)
  %668 = tail call double @llvm.fabs.f64(double %666) #13
  %669 = fcmp oeq double %668, 0x7FF0000000000000
  %670 = select i1 %669, double %666, double %667
  %671 = tail call double @llvm.fabs.f64(double %631)
  %672 = tail call double @llvm.fabs.f64(double %670)
  %673 = fcmp oeq double %671, 0x7FF0000000000000
  %674 = bitcast double %631 to <2 x i32>
  %675 = extractelement <2 x i32> %674, i64 1
  %676 = icmp sgt i32 %675, -1
  %677 = select i1 %676, double 0x7FF0000000000000, double 0.000000e+00
  %678 = select i1 %673, double %677, double %672
  %679 = icmp eq i32 %630, 0
  %680 = fptosi double %678 to i32
  %681 = select i1 %679, i32 1, i32 %680
  %682 = fsub contract float 1.000000e+00, %577
  %683 = and i32 %626, 7
  %684 = icmp ult i32 %626, 8
...
687:                                              ; preds = %709, %628
  %688 = phi i32 [ 0, %628 ], [ %799, %709 ]
  %689 = icmp eq i32 %683, 0
  br i1 %689, label %706, label %690

690:                                              ; preds = %687, %690
  %691 = phi i32 [ %703, %690 ], [ %688, %687 ]
  %692 = phi i32 [ %704, %690 ], [ 0, %687 ]
  %693 = zext i32 %691 to i64
  %694 = getelementptr inbounds float, float addrspace(1)* %95, i64 %693
  %695 = load float, float addrspace(1)* %694, align 4, !tbaa !11
  %696 = fmul contract float %682, %695
  %697 = add nsw i32 %691, %681
  %698 = sext i32 %697 to i64
  %699 = getelementptr inbounds float, float addrspace(1)* %95, i64 %698
  %700 = load float, float addrspace(1)* %699, align 4, !tbaa !11
  %701 = fmul contract float %577, %700
  %702 = fadd contract float %696, %701
  store float %702, float addrspace(1)* %694, align 4, !tbaa !11
  %703 = add nuw nsw i32 %691, 1
  %704 = add i32 %692, 1
  %705 = icmp eq i32 %704, %683
  br i1 %705, label %706, label %690, !llvm.loop !17

706:                                              ; preds = %687, %690, %559
  %707 = add nuw nsw i32 %560, 1
  %708 = icmp eq i32 %707, %1
  br i1 %708, label %555, label %559, !llvm.loop !19

709:                                              ; preds = %709, %685
  %710 = phi i32 [ 0, %685 ], [ %799, %709 ]
  %711 = phi i32 [ 0, %685 ], [ %800, %709 ]
  %712 = zext i32 %710 to i64
  %713 = getelementptr inbounds float, float addrspace(1)* %95, i64 %712
  %714 = load float, float addrspace(1)* %713, align 4, !tbaa !11
  %715 = fmul contract float %682, %714
  %716 = add nsw i32 %710, %681
  %717 = sext i32 %716 to i64
  %718 = getelementptr inbounds float, float addrspace(1)* %95, i64 %717
  %719 = load float, float addrspace(1)* %718, align 4, !tbaa !11
  %720 = fmul contract float %577, %719
  %721 = fadd contract float %715, %720
  store float %721, float addrspace(1)* %713, align 4, !tbaa !11
  %722 = or i32 %710, 1
  %723 = zext i32 %722 to i64
  %724 = getelementptr inbounds float, float addrspace(1)* %95, i64 %723
  %725 = load float, float addrspace(1)* %724, align 4, !tbaa !11
  %726 = fmul contract float %682, %725
  %727 = add nsw i32 %722, %681
  %728 = sext i32 %727 to i64
  %729 = getelementptr inbounds float, float addrspace(1)* %95, i64 %728
  %730 = load float, float addrspace(1)* %729, align 4, !tbaa !11
  %731 = fmul contract float %577, %730
  %732 = fadd contract float %726, %731
  store float %732, float addrspace(1)* %724, align 4, !tbaa !11
  %733 = or i32 %710, 2
  %734 = zext i32 %733 to i64
  %735 = getelementptr inbounds float, float addrspace(1)* %95, i64 %734
  %736 = load float, float addrspace(1)* %735, align 4, !tbaa !11
  %737 = fmul contract float %682, %736
  %738 = add nsw i32 %733, %681
  %739 = sext i32 %738 to i64
  %740 = getelementptr inbounds float, float addrspace(1)* %95, i64 %739
  %741 = load float, float addrspace(1)* %740, align 4, !tbaa !11
  %742 = fmul contract float %577, %741
  %743 = fadd contract float %737, %742
  store float %743, float addrspace(1)* %735, align 4, !tbaa !11
  %744 = or i32 %710, 3
  %745 = zext i32 %744 to i64
  %746 = getelementptr inbounds float, float addrspace(1)* %95, i64 %745
  %747 = load float, float addrspace(1)* %746, align 4, !tbaa !11
  %748 = fmul contract float %682, %747
  %749 = add nsw i32 %744, %681
  %750 = sext i32 %749 to i64
  %751 = getelementptr inbounds float, float addrspace(1)* %95, i64 %750
  %752 = load float, float addrspace(1)* %751, align 4, !tbaa !11
  %753 = fmul contract float %577, %752
  %754 = fadd contract float %748, %753
  store float %754, float addrspace(1)* %746, align 4, !tbaa !11
  %755 = or i32 %710, 4
  %756 = zext i32 %755 to i64
  %757 = getelementptr inbounds float, float addrspace(1)* %95, i64 %756
  %758 = load float, float addrspace(1)* %757, align 4, !tbaa !11
  %759 = fmul contract float %682, %758
  %760 = add nsw i32 %755, %681
  %761 = sext i32 %760 to i64
  %762 = getelementptr inbounds float, float addrspace(1)* %95, i64 %761
  %763 = load float, float addrspace(1)* %762, align 4, !tbaa !11
  %764 = fmul contract float %577, %763
  %765 = fadd contract float %759, %764
  store float %765, float addrspace(1)* %757, align 4, !tbaa !11
  %766 = or i32 %710, 5
  %767 = zext i32 %766 to i64
  %768 = getelementptr inbounds float, float addrspace(1)* %95, i64 %767
  %769 = load float, float addrspace(1)* %768, align 4, !tbaa !11
  %770 = fmul contract float %682, %769
  %771 = add nsw i32 %766, %681
  %772 = sext i32 %771 to i64
  %773 = getelementptr inbounds float, float addrspace(1)* %95, i64 %772
  %774 = load float, float addrspace(1)* %773, align 4, !tbaa !11
  %775 = fmul contract float %577, %774
  %776 = fadd contract float %770, %775
  store float %776, float addrspace(1)* %768, align 4, !tbaa !11
  %777 = or i32 %710, 6
  %778 = zext i32 %777 to i64
  %779 = getelementptr inbounds float, float addrspace(1)* %95, i64 %778
  %780 = load float, float addrspace(1)* %779, align 4, !tbaa !11
  %781 = fmul contract float %682, %780
  %782 = add nsw i32 %777, %681
  %783 = sext i32 %782 to i64
  %784 = getelementptr inbounds float, float addrspace(1)* %95, i64 %783
  %785 = load float, float addrspace(1)* %784, align 4, !tbaa !11
  %786 = fmul contract float %577, %785
  %787 = fadd contract float %781, %786
  store float %787, float addrspace(1)* %779, align 4, !tbaa !11
  %788 = or i32 %710, 7
  %789 = zext i32 %788 to i64
  %790 = getelementptr inbounds float, float addrspace(1)* %95, i64 %789
  %791 = load float, float addrspace(1)* %790, align 4, !tbaa !11
  %792 = fmul contract float %682, %791
  %793 = add nsw i32 %788, %681
  %794 = sext i32 %793 to i64
  %795 = getelementptr inbounds float, float addrspace(1)* %95, i64 %794
  %796 = load float, float addrspace(1)* %795, align 4, !tbaa !11
  %797 = fmul contract float %577, %796
  %798 = fadd contract float %792, %797
  store float %798, float addrspace(1)* %790, align 4, !tbaa !11
  %799 = add nuw nsw i32 %710, 8
  %800 = add i32 %711, 8
  %801 = icmp eq i32 %800, %686
  br i1 %801, label %687, label %709, !llvm.loop !20
...
4:                                                ; preds = %1
  ...
  %8 = load i64, i64 addrspace(4)* %7, align 8, !tbaa !21
  ...
  %12 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %13 = tail call i32 @llvm.read_register.i32(metadata !26) #14
  %14 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 %13, i32 0)
  %15 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 %12, i32 %14)
  %16 = tail call i64 @llvm.read_register.i64(metadata !27) #14
  %17 = icmp eq i32 %15, 0
...
21:                                               ; preds = %1
  ...
  %27 = load i32, i32 addrspace(1)* %26, align 4, !tbaa !32
...
50:                                               ; preds = %101, %21
  ...
  %52 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %51) #12, !srcloc !33
  %53 = icmp eq i32 %51, 0
...
60:                                               ; preds = %54
  %61 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %62 = tail call i32 @llvm.read_register.i32(metadata !26) #14
  %63 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 %62, i32 0)
  %64 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 %61, i32 %63)
  %65 = tail call i64 @llvm.read_register.i64(metadata !27) #14
...
75:                                               ; preds = %71, %60
  ...
  %83 = load i32, i32 addrspace(4)* %49, align 4, !tbaa !34
  %84 = sub i32 %39, %83
  %85 = udiv i32 %84, %48
  %86 = and i32 %85, 31
  %87 = shl nuw i32 1, %86
...
101:                                              ; preds = %93, %75, %54, %50
  ...
  %103 = tail call i32 asm sideeffect "; ockl ballot hoisting hack $0", "=v,0"(i32 %102) #12, !srcloc !36
...
define internal fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %0, i64 noundef %1, i64 noundef %2) unnamed_addr #8 {
  ...
  store i8* %0, i8* addrspace(5)* %4, align 8, !tbaa !37
  store i32 3, i32 addrspace(5)* %5, align 4, !tbaa !39
  store i64 %1, i64 addrspace(5)* %6, align 8, !tbaa !21
  store i64 %2, i64 addrspace(5)* %7, align 8, !tbaa !21
  store i64 0, i64 addrspace(5)* %8, align 8, !tbaa !21
  store i64 0, i64 addrspace(5)* %9, align 8, !tbaa !21
  store i64 0, i64 addrspace(5)* %10, align 8, !tbaa !21
  store i64 0, i64 addrspace(5)* %11, align 8, !tbaa !21
  store i64 0, i64 addrspace(5)* %12, align 8, !tbaa !21
  store i64 0, i64 addrspace(5)* %13, align 8, !tbaa !21
  ...
  store i32 %23, i32 addrspace(5)* %14, align 4, !tbaa !39
  %24 = load i32, i32 addrspace(5)* %14, align 4, !tbaa !39
  %25 = call i32 asm sideeffect "; ockl readfirstlane hoisting hack $0", "=v,0"(i32 %24) #12, !srcloc !40
  store i32 %25, i32 addrspace(5)* %14, align 4, !tbaa !39
  %26 = bitcast i32 addrspace(5)* %15 to i8 addrspace(5)*
  call void @llvm.lifetime.start.p5i8(i64 4, i8 addrspace(5)* %26) #10
  %27 = load i32, i32 addrspace(5)* %14, align 4, !tbaa !39
  %28 = call i32 @llvm.amdgcn.readfirstlane(i32 %27)
  store i32 %28, i32 addrspace(5)* %15, align 4, !tbaa !39
  %29 = bitcast %6 addrspace(1)* addrspace(5)* %16 to i8 addrspace(5)*
  call void @llvm.lifetime.start.p5i8(i64 8, i8 addrspace(5)* %29) #10
  %30 = load i8*, i8* addrspace(5)* %4, align 8, !tbaa !37
  %31 = addrspacecast i8* %30 to %6 addrspace(1)*
  store %6 addrspace(1)* %31, %6 addrspace(1)* addrspace(5)* %16, align 8, !tbaa !37
  %32 = bitcast i64 addrspace(5)* %17 to i8 addrspace(5)*
  call void @llvm.lifetime.start.p5i8(i64 8, i8 addrspace(5)* %32) #10
  %33 = load %6 addrspace(1)*, %6 addrspace(1)* addrspace(5)* %16, align 8, !tbaa !37
  %34 = load i32, i32 addrspace(5)* %14, align 4, !tbaa !39
  %35 = load i32, i32 addrspace(5)* %15, align 4, !tbaa !39
...
37:                                               ; preds = %3
  ...
  %42 = load %7 addrspace(1)*, %7 addrspace(1)* addrspace(1)* %40, align 8, !tbaa !41
  %43 = load i64, i64 addrspace(1)* %41, align 8, !tbaa !44
  %44 = and i64 %43, %39
...
49:                                               ; preds = %49, %37
  ...
  %52 = load %7 addrspace(1)*, %7 addrspace(1)* addrspace(1)* %40, align 8, !tbaa !41
  %53 = load i64, i64 addrspace(1)* %41, align 8, !tbaa !44
  %54 = and i64 %53, %51
...
62:                                               ; preds = %3, %59
  ...
  %72 = or i64 %70, %71
  store i64 %72, i64 addrspace(5)* %17, align 8, !tbaa !21
  %73 = bitcast %7 addrspace(1)* addrspace(5)* %18 to i8 addrspace(5)*
  call void @llvm.lifetime.start.p5i8(i64 8, i8 addrspace(5)* %73) #10
  %74 = load %6 addrspace(1)*, %6 addrspace(1)* addrspace(5)* %16, align 8, !tbaa !37
  %75 = load i64, i64 addrspace(5)* %17, align 8, !tbaa !21
  %76 = getelementptr %6, %6 addrspace(1)* %74, i64 0, i32 0
  %77 = load %7 addrspace(1)*, %7 addrspace(1)* addrspace(1)* %76, align 8, !tbaa !41
  %78 = getelementptr %6, %6 addrspace(1)* %74, i64 0, i32 5
  %79 = load i64, i64 addrspace(1)* %78, align 8, !tbaa !44
  %80 = and i64 %75, %79
  %81 = getelementptr inbounds %7, %7 addrspace(1)* %77, i64 %80
  store %7 addrspace(1)* %81, %7 addrspace(1)* addrspace(5)* %18, align 8, !tbaa !37
  %82 = bitcast %8 addrspace(1)* addrspace(5)* %19 to i8 addrspace(5)*
  call void @llvm.lifetime.start.p5i8(i64 8, i8 addrspace(5)* %82) #10
  %83 = load %6 addrspace(1)*, %6 addrspace(1)* addrspace(5)* %16, align 8, !tbaa !37
  %84 = load i64, i64 addrspace(5)* %17, align 8, !tbaa !21
  %85 = getelementptr %6, %6 addrspace(1)* %83, i64 0, i32 1
  %86 = load %8 addrspace(1)*, %8 addrspace(1)* addrspace(1)* %85, align 8, !tbaa !45
  %87 = getelementptr %6, %6 addrspace(1)* %83, i64 0, i32 5
  %88 = load i64, i64 addrspace(1)* %87, align 8, !tbaa !44
  %89 = and i64 %84, %88
  %90 = getelementptr inbounds %8, %8 addrspace(1)* %86, i64 %89
  store %8 addrspace(1)* %90, %8 addrspace(1)* addrspace(5)* %19, align 8, !tbaa !37
  %91 = load %7 addrspace(1)*, %7 addrspace(1)* addrspace(5)* %18, align 8, !tbaa !37
  %92 = load %8 addrspace(1)*, %8 addrspace(1)* addrspace(5)* %19, align 8, !tbaa !37
  %93 = load i32, i32 addrspace(5)* %5, align 4, !tbaa !39
  %94 = load i64, i64 addrspace(5)* %6, align 8, !tbaa !21
  %95 = load i64, i64 addrspace(5)* %7, align 8, !tbaa !21
  %96 = load i64, i64 addrspace(5)* %8, align 8, !tbaa !21
  %97 = load i64, i64 addrspace(5)* %9, align 8, !tbaa !21
  %98 = load i64, i64 addrspace(5)* %10, align 8, !tbaa !21
  %99 = load i64, i64 addrspace(5)* %11, align 8, !tbaa !21
  %100 = load i64, i64 addrspace(5)* %12, align 8, !tbaa !21
  %101 = load i64, i64 addrspace(5)* %13, align 8, !tbaa !21
  %102 = load i32, i32 addrspace(5)* %14, align 4, !tbaa !39
  %103 = load i32, i32 addrspace(5)* %15, align 4, !tbaa !39
  %104 = call i64 @llvm.read_register.i64(metadata !27) #14
  %105 = icmp eq i32 %102, %103
  br i1 %105, label %106, label %110

106:                                              ; preds = %62
  %107 = getelementptr inbounds %7, %7 addrspace(1)* %91, i64 0, i32 2
  store i32 %93, i32 addrspace(1)* %107, align 8, !tbaa !46
  %108 = getelementptr inbounds %7, %7 addrspace(1)* %91, i64 0, i32 1
  store i64 %104, i64 addrspace(1)* %108, align 8, !tbaa !48
  %109 = getelementptr inbounds %7, %7 addrspace(1)* %91, i64 0, i32 3
  store i32 1, i32 addrspace(1)* %109, align 4, !tbaa !49
  br label %110

110:                                              ; preds = %62, %106
  %111 = zext i32 %102 to i64
  %112 = getelementptr inbounds %8, %8 addrspace(1)* %92, i64 0, i32 0, i64 %111, i64 0
  store i64 %94, i64 addrspace(1)* %112, align 8, !tbaa !21
  %113 = getelementptr inbounds %8, %8 addrspace(1)* %92, i64 0, i32 0, i64 %111, i64 1
  store i64 %95, i64 addrspace(1)* %113, align 8, !tbaa !21
  %114 = getelementptr inbounds %8, %8 addrspace(1)* %92, i64 0, i32 0, i64 %111, i64 2
  store i64 %96, i64 addrspace(1)* %114, align 8, !tbaa !21
  %115 = getelementptr inbounds %8, %8 addrspace(1)* %92, i64 0, i32 0, i64 %111, i64 3
  store i64 %97, i64 addrspace(1)* %115, align 8, !tbaa !21
  %116 = getelementptr inbounds %8, %8 addrspace(1)* %92, i64 0, i32 0, i64 %111, i64 4
  store i64 %98, i64 addrspace(1)* %116, align 8, !tbaa !21
  %117 = getelementptr inbounds %8, %8 addrspace(1)* %92, i64 0, i32 0, i64 %111, i64 5
  store i64 %99, i64 addrspace(1)* %117, align 8, !tbaa !21
  %118 = getelementptr inbounds %8, %8 addrspace(1)* %92, i64 0, i32 0, i64 %111, i64 6
  store i64 %100, i64 addrspace(1)* %118, align 8, !tbaa !21
  %119 = getelementptr inbounds %8, %8 addrspace(1)* %92, i64 0, i32 0, i64 %111, i64 7
  store i64 %101, i64 addrspace(1)* %119, align 8, !tbaa !21
  %120 = load %6 addrspace(1)*, %6 addrspace(1)* addrspace(5)* %16, align 8, !tbaa !37
  %121 = load i64, i64 addrspace(5)* %17, align 8, !tbaa !21
  %122 = load i32, i32 addrspace(5)* %14, align 4, !tbaa !39
  %123 = load i32, i32 addrspace(5)* %15, align 4, !tbaa !39
...
125:                                              ; preds = %110
  ...
  %129 = load %7 addrspace(1)*, %7 addrspace(1)* addrspace(1)* %128, align 8, !tbaa !41
  %130 = getelementptr %6, %6 addrspace(1)* %120, i64 0, i32 5
  %131 = load i64, i64 addrspace(1)* %130, align 8, !tbaa !44
  %132 = and i64 %131, %121
  %133 = getelementptr inbounds %7, %7 addrspace(1)* %129, i64 %132, i32 0
  store i64 %127, i64 addrspace(1)* %133, align 8, !tbaa !50
...
136:                                              ; preds = %136, %125
  ...
  call void @llvm.amdgcn.s.sleep(i32 1)
  store i64 %138, i64 addrspace(1)* %133, align 8, !tbaa !50
...
141:                                              ; preds = %136, %125
  ...
  %148 = load i64, i64 addrspace(1)* %147, align 16, !tbaa !51
...
150:                                              ; preds = %141
  ...
  %153 = load i32, i32 addrspace(1)* %152, align 8, !tbaa !53
...
157:                                              ; preds = %110, %141, %150
  ...
  %159 = load %7 addrspace(1)*, %7 addrspace(1)* addrspace(5)* %18, align 8, !tbaa !37
  %160 = load %8 addrspace(1)*, %8 addrspace(1)* addrspace(5)* %19, align 8, !tbaa !37
  %161 = load i32, i32 addrspace(5)* %14, align 4, !tbaa !39
  %162 = load i32, i32 addrspace(5)* %15, align 4, !tbaa !39
...
174:                                              ; preds = %169
  ...
  %178 = load i64, i64 addrspace(1)* %176, align 8, !tbaa !21
  %179 = load i64, i64 addrspace(1)* %177, align 8, !tbaa !21
  %180 = insertelement <2 x i64> undef, i64 %178, i64 0
  %181 = insertelement <2 x i64> %180, i64 %179, i64 1
  store <2 x i64> %181, <2 x i64> addrspace(5)* %20, align 16, !tbaa !54
  %182 = load %6 addrspace(1)*, %6 addrspace(1)* addrspace(5)* %16, align 8, !tbaa !37
  %183 = load i64, i64 addrspace(5)* %17, align 8, !tbaa !21
  %184 = load i32, i32 addrspace(5)* %14, align 4, !tbaa !39
  %185 = load i32, i32 addrspace(5)* %15, align 4, !tbaa !39
  %186 = icmp eq i32 %184, %185
  br i1 %186, label %187, label %207

187:                                              ; preds = %174
  %188 = getelementptr inbounds %6, %6 addrspace(1)* %182, i64 0, i32 5
  %189 = load i64, i64 addrspace(1)* %188, align 8, !tbaa !44
  %190 = add i64 %189, 1
  %191 = add i64 %190, %183
  ...
  %197 = load %7 addrspace(1)*, %7 addrspace(1)* addrspace(1)* %196, align 8, !tbaa !41
  %198 = and i64 %193, %189
  %199 = getelementptr inbounds %7, %7 addrspace(1)* %197, i64 %198, i32 0
  store i64 %195, i64 addrspace(1)* %199, align 8, !tbaa !50
...
202:                                              ; preds = %202, %187
  ...
  call void @llvm.amdgcn.s.sleep(i32 1)
  store i64 %204, i64 addrspace(1)* %199, align 8, !tbaa !50
...
207:                                              ; preds = %174, %187, %202
  %208 = load <2 x i64>, <2 x i64> addrspace(5)* %20, align 16, !tbaa !54
...
5:                                                ; preds = %3
  ...
  %9 = load i64, i64 addrspace(4)* %8, align 8, !tbaa !21
...
15:                                               ; preds = %5
  %16 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %17 = tail call i32 @llvm.read_register.i32(metadata !26) #14
  %18 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 %17, i32 0)
  %19 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 %16, i32 %18)
  %20 = tail call i64 @llvm.read_register.i64(metadata !27) #14
  %21 = icmp eq i32 %19, 0
...
27:                                               ; preds = %3
  ...
  %30 = tail call i32 @llvm.ctlz.i32(i32 %29, i1 false), !range !55
...
63:                                               ; preds = %1417, %27
  ...
  %66 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %64) #12, !srcloc !33
  %67 = icmp eq i32 %66, 0
...
71:                                               ; preds = %68, %1410
  ...
  %75 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %73) #12, !srcloc !33
  %76 = icmp eq i32 %75, 0
  br i1 %76, label %1410, label %77

77:                                               ; preds = %71
  %78 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %79 = tail call i32 @llvm.read_register.i32(metadata !26) #14
  %80 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 %79, i32 0)
  %81 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 %78, i32 %80)
  %82 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %81) #12, !srcloc !56
  %83 = icmp eq i32 %82, 0
...
90:                                               ; preds = %86
  %91 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %92 = tail call i32 @llvm.read_register.i32(metadata !26) #14
  %93 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 %92, i32 0)
  %94 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 %91, i32 %93)
  %95 = tail call i64 @llvm.read_register.i64(metadata !27) #14
...
98:                                               ; preds = %631, %90
  ...
  %102 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %99) #12, !srcloc !56
...
108:                                              ; preds = %106, %104
  ...
  %113 = load i32, i32 addrspace(4)* %47, align 4, !tbaa !57
  br label %114
...
174:                                              ; preds = %172, %98
  ...
  %176 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %177 = tail call i32 @llvm.read_register.i32(metadata !26) #14
...
180:                                              ; preds = %548, %174
  ...
  %183 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %181) #12, !srcloc !56
...
201:                                              ; preds = %197
  %202 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %203 = tail call i32 @llvm.read_register.i32(metadata !26) #14
  %204 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 %203, i32 0)
  %205 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 %202, i32 %204)
  %206 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %205) #12, !srcloc !56
...
229:                                              ; preds = %228
  %230 = load i64, i64 addrspace(4)* %62, align 8, !tbaa !21
...
246:                                              ; preds = %235
  %247 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %248 = tail call i32 @llvm.read_register.i32(metadata !26) #14
  %249 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 %248, i32 0)
  %250 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 %247, i32 %249)
  %251 = tail call i64 @llvm.read_register.i64(metadata !27) #14
...
256:                                              ; preds = %246, %256
  ...
  store i64 0, i64 addrspace(1)* %259, align 8, !tbaa !21
  %260 = add i32 %257, %253
...
263:                                              ; preds = %262, %295
  ...
  %267 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %266) #12, !srcloc !56
...
276:                                              ; preds = %275
  %277 = load i64, i64 addrspace(4)* %62, align 8, !tbaa !21
...
299:                                              ; preds = %296
  %300 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %301 = tail call i32 @llvm.read_register.i32(metadata !26) #14
...
400:                                              ; preds = %399
  ...
  %402 = load i64, i64 addrspace(1)* getelementptr inbounds (%0, %0 addrspace(1)* @0, i64 0, i32 7), align 8, !tbaa !58
...
407:                                              ; preds = %404, %400
  %408 = load i64, i64 addrspace(4)* %62, align 8, !tbaa !21
...
424:                                              ; preds = %413
  ...
  %426 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %427 = tail call i32 @llvm.read_register.i32(metadata !26) #14
  %428 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 %427, i32 0)
  %429 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 %426, i32 %428)
  %430 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %429) #12, !srcloc !56
  %431 = tail call i64 @llvm.read_register.i64(metadata !27) #14
  %432 = tail call i64 @llvm.ctpop.i64(i64 %431), !range !28
  %433 = trunc i64 %432 to i32
  %434 = load i32, i32 addrspace(4)* %51, align 4, !tbaa !60
  %435 = load i32, i32 addrspace(4)* %52, align 4, !tbaa !61
  %436 = add i32 %435, 31
  %437 = lshr i32 %436, 5
...
440:                                              ; preds = %446, %438
  %441 = mul i32 %434, %433
  %442 = load i32, i32 addrspace(4)* %56, align 4, !tbaa !62
  %443 = mul i32 %434, %430
  %444 = add i32 %442, %443
...
446:                                              ; preds = %438, %446
  ...
  store i32 0, i32 addrspace(1)* %449, align 4, !tbaa !39
  %450 = add i32 %447, %433
...
452:                                              ; preds = %440, %452
  ...
  store i32 %455, i32 addrspace(1)* %458, align 4, !tbaa !39
  %459 = add i32 %453, %441
  %460 = icmp ult i32 %459, %435
  br i1 %460, label %452, label %470

461:                                              ; preds = %424
  %462 = load i32, i32 addrspace(4)* %57, align 4, !tbaa !63
...
464:                                              ; preds = %461, %464
  ...
  store i32 %462, i32 addrspace(1)* %467, align 4, !tbaa !39
  %468 = add i32 %465, %433
...
473:                                              ; preds = %472
  ...
  %479 = load i32, i32 addrspace(1)* %478, align 4, !tbaa !39
  %480 = or i32 %479, %475
  store i32 %480, i32 addrspace(1)* %478, align 4, !tbaa !39
  br label %481

481:                                              ; preds = %473, %472
  %482 = inttoptr i64 %422 to <4 x i32> addrspace(1)*
  store <4 x i32> %59, <4 x i32> addrspace(1)* %482, align 16, !tbaa !54
  br label %483
...
485:                                              ; preds = %547, %483
  ...
  %489 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %488) #12, !srcloc !56
...
505:                                              ; preds = %504
  %506 = load i64, i64 addrspace(4)* %62, align 8, !tbaa !21
...
526:                                              ; preds = %523, %513
  ...
  store i32 %495, i32 addrspace(1)* %484, align 4, !tbaa !32
...
554:                                              ; preds = %552
  %555 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %556 = tail call i32 @llvm.read_register.i32(metadata !26) #14
...
634:                                              ; preds = %86
  %635 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %636 = tail call i32 @llvm.read_register.i32(metadata !26) #14
  %637 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 %636, i32 0)
  %638 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 %635, i32 %637)
  %639 = tail call i64 @llvm.read_register.i64(metadata !27) #14
...
642:                                              ; preds = %1295, %634
  ...
  %646 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %644) #12, !srcloc !56
...
652:                                              ; preds = %649, %642
  ...
  %658 = load i32, i32 addrspace(4)* %657, align 4, !tbaa !64
...
735:                                              ; preds = %731
  %736 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %737 = tail call i32 @llvm.read_register.i32(metadata !26) #14
  %738 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 %737, i32 0)
  %739 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 %736, i32 %738)
  %740 = tail call i64 @llvm.read_register.i64(metadata !27) #14
...
759:                                              ; preds = %1292, %735
  ...
  %763 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %760) #12, !srcloc !56
...
769:                                              ; preds = %767, %765
  ...
  %774 = load i32, i32 addrspace(4)* %745, align 4, !tbaa !57
  br label %775
...
835:                                              ; preds = %833, %759
  ...
  %837 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %838 = tail call i32 @llvm.read_register.i32(metadata !26) #14
...
841:                                              ; preds = %1209, %835
  ...
  %844 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %842) #12, !srcloc !56
...
862:                                              ; preds = %858
  %863 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %864 = tail call i32 @llvm.read_register.i32(metadata !26) #14
  %865 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 %864, i32 0)
  %866 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 %863, i32 %865)
  %867 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %866) #12, !srcloc !56
...
890:                                              ; preds = %889
  %891 = load i64, i64 addrspace(4)* %62, align 8, !tbaa !21
...
907:                                              ; preds = %896
  %908 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %909 = tail call i32 @llvm.read_register.i32(metadata !26) #14
  %910 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 %909, i32 0)
  %911 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 %908, i32 %910)
  %912 = tail call i64 @llvm.read_register.i64(metadata !27) #14
...
917:                                              ; preds = %907, %917
  ...
  store i64 0, i64 addrspace(1)* %920, align 8, !tbaa !21
  %921 = add i32 %918, %914
...
924:                                              ; preds = %923, %956
  ...
  %928 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %927) #12, !srcloc !56
...
937:                                              ; preds = %936
  %938 = load i64, i64 addrspace(4)* %62, align 8, !tbaa !21
...
960:                                              ; preds = %957
  %961 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %962 = tail call i32 @llvm.read_register.i32(metadata !26) #14
...
1061:                                             ; preds = %1060
  ...
  %1063 = load i64, i64 addrspace(1)* getelementptr inbounds (%0, %0 addrspace(1)* @0, i64 0, i32 7), align 8, !tbaa !58
...
1068:                                             ; preds = %1065, %1061
  %1069 = load i64, i64 addrspace(4)* %62, align 8, !tbaa !21
...
1085:                                             ; preds = %1074
  ...
  %1087 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %1088 = tail call i32 @llvm.read_register.i32(metadata !26) #14
  %1089 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 %1088, i32 0)
  %1090 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 %1087, i32 %1089)
  %1091 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %1090) #12, !srcloc !56
  %1092 = tail call i64 @llvm.read_register.i64(metadata !27) #14
  %1093 = tail call i64 @llvm.ctpop.i64(i64 %1092), !range !28
  %1094 = trunc i64 %1093 to i32
  %1095 = load i32, i32 addrspace(4)* %750, align 4, !tbaa !60
  %1096 = load i32, i32 addrspace(4)* %751, align 4, !tbaa !61
...
1101:                                             ; preds = %1107, %1099
  ...
  %1103 = load i32, i32 addrspace(4)* %755, align 4, !tbaa !62
...
1107:                                             ; preds = %1099, %1107
  ...
  store i32 0, i32 addrspace(1)* %1110, align 4, !tbaa !39
...
1113:                                             ; preds = %1101, %1113
  ...
  store i32 %1116, i32 addrspace(1)* %1119, align 4, !tbaa !39
  %1120 = add i32 %1114, %1102
  %1121 = icmp ult i32 %1120, %1096
  br i1 %1121, label %1113, label %1131

1122:                                             ; preds = %1085
  %1123 = load i32, i32 addrspace(4)* %756, align 4, !tbaa !63
...
1125:                                             ; preds = %1122, %1125
  ...
  store i32 %1123, i32 addrspace(1)* %1128, align 4, !tbaa !39
...
1134:                                             ; preds = %1133
  ...
  %1140 = load i32, i32 addrspace(1)* %1139, align 4, !tbaa !39
  %1141 = or i32 %1140, %1136
  store i32 %1141, i32 addrspace(1)* %1139, align 4, !tbaa !39
  br label %1142

1142:                                             ; preds = %1134, %1133
  %1143 = inttoptr i64 %1083 to <4 x i32> addrspace(1)*
  store <4 x i32> %758, <4 x i32> addrspace(1)* %1143, align 16, !tbaa !54
  br label %1144
...
1146:                                             ; preds = %1208, %1144
  ...
  %1150 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %1149) #12, !srcloc !56
...
1166:                                             ; preds = %1165
  %1167 = load i64, i64 addrspace(4)* %62, align 8, !tbaa !21
...
1187:                                             ; preds = %1184, %1174
  ...
  store i32 %1156, i32 addrspace(1)* %1145, align 4, !tbaa !32
...
1215:                                             ; preds = %1213
  %1216 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %1217 = tail call i32 @llvm.read_register.i32(metadata !26) #14
...
1311:                                             ; preds = %1299
  ...
  %1313 = tail call i32 @llvm.read_register.i32(metadata !25) #14
  %1314 = tail call i32 @llvm.read_register.i32(metadata !26) #14
  %1315 = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 %1314, i32 0)
  %1316 = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 %1313, i32 %1315)
  %1317 = tail call i32 asm sideeffect "; O0 $0", "=v,0"(i32 %1316) #12, !srcloc !56
  %1318 = tail call i64 @llvm.read_register.i64(metadata !27) #14
  %1319 = getelementptr inbounds %3, %3 addrspace(1)* %1312, i64 0, i32 1
  %1320 = load atomic i64, i64 addrspace(1)* %1319 seq_cst, align 8, !tbaa !65
...
1330:                                             ; preds = %1325, %1311
  ...
  %1335 = load i32, i32 addrspace(4)* %1334, align 4, !tbaa !61
...
1339:                                             ; preds = %1330
  ...
  %1342 = load i32, i32 addrspace(4)* %1341, align 4, !tbaa !67
...
1365:                                             ; preds = %1357
  %1366 = xor i32 %1363, -1
  %1367 = tail call i32 @llvm.cttz.i32(i32 %1366, i1 false), !range !55
...
1373:                                             ; preds = %1365
  ...
  %1376 = load i32, i32 addrspace(4)* %1347, align 4, !tbaa !34
...
1410:                                             ; preds = %1406, %1299, %71
  ...
  %1414 = tail call i32 asm sideeffect "; ockl ballot hoisting hack $0", "=v,0"(i32 %1412) #12, !srcloc !36
...
1417:                                             ; preds = %1410, %68, %63
  ...
  %1420 = tail call i32 asm sideeffect "; ockl ballot hoisting hack $0", "=v,0"(i32 %1418) #12, !srcloc !36
...
!28 = !{i64 0, i64 65}
!29 = !{!30, !31, i64 0}
!30 = !{!"slab_s", !31, i64 0, !31, i64 4, !23, i64 8, !31, i64 12, !23, i64 16}
!31 = !{!"int", !23, i64 0}
!32 = !{!30, !31, i64 4}
!33 = !{i64 7014}
!34 = !{!35, !31, i64 12}
!35 = !{!"kind_info_s", !31, i64 0, !31, i64 4, !31, i64 8, !31, i64 12, !31, i64 16, !31, i64 20, !31, i64 24, !31, i64 28}
!36 = !{i64 751}
!37 = !{!38, !38, i64 0}
...
!40 = !{i64 2662}
!41 = !{!42, !38, i64 0}
!42 = !{!"", !38, i64 0, !38, i64 8, !43, i64 16, !22, i64 24, !22, i64 32, !22, i64 40}
!43 = !{!"hsa_signal_s", !22, i64 0}
!44 = !{!42, !22, i64 40}
!45 = !{!42, !38, i64 8}
!46 = !{!47, !31, i64 16}
!47 = !{!"", !22, i64 0, !22, i64 8, !31, i64 16, !31, i64 20}
!48 = !{!47, !22, i64 8}
!49 = !{!47, !31, i64 20}
!50 = !{!47, !22, i64 0}
!51 = !{!52, !22, i64 16}
!52 = !{!"amd_signal_s", !22, i64 0, !23, i64 8, !22, i64 16, !31, i64 24, !31, i64 28, !22, i64 32, !22, i64 40, !23, i64 48, !23, i64 56}
!53 = !{!52, !31, i64 24}
!54 = !{!23, !23, i64 0}
!55 = !{i32 0, i32 33}
!56 = !{i64 7137}
!57 = !{!35, !31, i64 8}
!58 = !{!59, !22, i64 108552}
!59 = !{!"heap_s", !23, i64 0, !23, i64 2048, !23, i64 4096, !23, i64 6144, !23, i64 8192, !23, i64 10240, !23, i64 108544, !22, i64 108552, !23, i64 108560, !23, i64 108672}
!60 = !{!35, !31, i64 20}
!61 = !{!35, !31, i64 0}
!62 = !{!35, !31, i64 16}
!63 = !{!35, !31, i64 24}
!64 = !{!35, !31, i64 4}
!65 = !{!66, !23, i64 8}
!66 = !{!"sdata_s", !23, i64 0, !23, i64 8, !23, i64 16}
!67 = !{!35, !31, i64 28}

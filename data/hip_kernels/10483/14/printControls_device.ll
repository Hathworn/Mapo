; ModuleID = '../data/hip_kernels/10483/14/main.cu'
source_filename = "../data/hip_kernels/10483/14/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [7 x i8] c"%d %d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z13printControlsiiiPi(i32 %0, i32 %1, i32 %2, i32 addrspace(1)* nocapture readonly %3) local_unnamed_addr #1 {
  %5 = icmp sgt i32 %2, 0
...
15:                                               ; preds = %6, %468
  %16 = phi i32 [ 0, %6 ], [ %480, %468 ]
  %17 = add nsw i32 %16, %7
  %18 = sext i32 %17 to i64
  %19 = getelementptr inbounds i32, i32 addrspace(1)* %3, i64 %18
  %20 = load i32, i32 addrspace(1)* %19, align 4, !tbaa !8
  %21 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %13, i64 noundef 33, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %22 = extractelement <2 x i64> %21, i64 0
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([7 x i8], [7 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %23, label %27

23:                                               ; preds = %15
  %24 = and i64 %22, -225
  %25 = or i64 %24, 32
  %26 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %13, i64 noundef %25, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  br label %468
...
86:                                               ; preds = %44, %86
  ...
  %91 = load i8, i8 addrspace(4)* %90, align 1, !tbaa !12
  ...
  br i1 %98, label %99, label %86, !llvm.loop !13
...
146:                                              ; preds = %104, %146
  ...
  %151 = load i8, i8 addrspace(4)* %150, align 1, !tbaa !12
...
206:                                              ; preds = %164, %206
  ...
  %211 = load i8, i8 addrspace(4)* %210, align 1, !tbaa !12
...
266:                                              ; preds = %224, %266
  ...
  %271 = load i8, i8 addrspace(4)* %270, align 1, !tbaa !12
...
326:                                              ; preds = %284, %326
  ...
  %331 = load i8, i8 addrspace(4)* %330, align 1, !tbaa !12
...
386:                                              ; preds = %344, %386
  ...
  %391 = load i8, i8 addrspace(4)* %390, align 1, !tbaa !12
...
444:                                              ; preds = %404, %444
  ...
  %449 = load i8, i8 addrspace(4)* %448, align 1, !tbaa !12
...
457:                                              ; preds = %444, %406, %404
  ...
  %462 = and i64 %42, -225
  %463 = or i64 %462, %461
  %464 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %13, i64 noundef %463, i64 noundef %102, i64 noundef %162, i64 noundef %222, i64 noundef %282, i64 noundef %342, i64 noundef %402, i64 noundef %458) #10
  %465 = sub i64 %32, %40
...
468:                                              ; preds = %457, %23
  ...
  %471 = zext i32 %16 to i64
  %472 = and i64 %470, -225
  %473 = or i64 %472, 32
  %474 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %13, i64 noundef %473, i64 noundef %471, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %475 = extractelement <2 x i64> %474, i64 0
  %476 = zext i32 %20 to i64
  %477 = and i64 %475, -227
  %478 = or i64 %477, 34
  %479 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %13, i64 noundef %478, i64 noundef %476, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %480 = add nuw nsw i32 %16, 1
  %481 = icmp eq i32 %480, %2
  br i1 %481, label %14, label %15, !llvm.loop !15
}

; ModuleID = '../data/hip_kernels/11654/7/main.cu'
source_filename = "../data/hip_kernels/11654/7/main.cu"
...
40:                                               ; preds = %4
  ...
  %89 = tail call double @llvm.amdgcn.frexp.mant.f64(double %88)
  %90 = fcmp olt double %89, 0x3FE5555555555555
  %91 = zext i1 %90 to i32
  %92 = tail call double @llvm.amdgcn.ldexp.f64(double %89, i32 %91)
  %93 = tail call i32 @llvm.amdgcn.frexp.exp.i32.f64(double %88)
  %94 = sub nsw i32 %93, %91
  %95 = fadd double %92, -1.000000e+00
  %96 = fadd double %92, 1.000000e+00
  %97 = fadd double %96, -1.000000e+00
  %98 = fsub double %92, %97
  %99 = tail call double @llvm.amdgcn.rcp.f64(double %96)
  %100 = fneg double %96
  %101 = tail call double @llvm.fma.f64(double %100, double %99, double 1.000000e+00)
  %102 = tail call double @llvm.fma.f64(double %101, double %99, double %99)
  %103 = tail call double @llvm.fma.f64(double %100, double %102, double 1.000000e+00)
  %104 = tail call double @llvm.fma.f64(double %103, double %102, double %102)
  %105 = fmul double %95, %104
  %106 = fmul double %96, %105
  %107 = fneg double %106
  %108 = tail call double @llvm.fma.f64(double %105, double %96, double %107)
  %109 = tail call double @llvm.fma.f64(double %105, double %98, double %108)
  %110 = fadd double %106, %109
  %111 = fsub double %110, %106
  %112 = fsub double %109, %111
  %113 = fsub double %95, %110
  ...
  %123 = tail call double @llvm.fma.f64(double %122, double 0x3FC3AB76BF559E2B, double 0x3FC385386B47B09A)
  %124 = tail call double @llvm.fma.f64(double %122, double %123, double 0x3FC7474DD7F4DF2E)
  %125 = tail call double @llvm.fma.f64(double %122, double %124, double 0x3FCC71C016291751)
  %126 = tail call double @llvm.fma.f64(double %122, double %125, double 0x3FD249249B27ACF1)
  %127 = tail call double @llvm.fma.f64(double %122, double %126, double 0x3FD99999998EF7B6)
  %128 = tail call double @llvm.fma.f64(double %122, double %127, double 0x3FE5555555555780)
  %129 = tail call double @llvm.amdgcn.ldexp.f64(double %119, i32 1)
  %130 = tail call double @llvm.amdgcn.ldexp.f64(double %121, i32 1)
  %131 = fmul double %119, %122
  ...
  %148 = fadd double %145, %137
  %149 = fsub double %148, %145
  %150 = fsub double %148, %149
  %151 = fsub double %145, %150
  %152 = fsub double %137, %149
  %153 = fadd double %152, %151
  %154 = fadd double %147, %139
  %155 = fsub double %154, %147
  %156 = fsub double %154, %155
  %157 = fsub double %147, %156
  %158 = fsub double %139, %155
  %159 = fadd double %158, %157
  %160 = fadd double %154, %153
  %161 = fadd double %148, %160
  %162 = fsub double %161, %148
  %163 = fsub double %160, %162
  %164 = fadd double %159, %163
  %165 = fadd double %161, %164
  %166 = tail call double @llvm.fabs.f64(double %88) #3
  %167 = fcmp oeq double %166, 0x7FF0000000000000
  %168 = select i1 %167, double %88, double %165
  %169 = fcmp olt double %88, 0.000000e+00
  %170 = select i1 %169, double 0x7FF8000000000000, double %168
  %171 = fcmp oeq double %88, 0.000000e+00
  %172 = select i1 %171, double 0xFFF0000000000000, double %170
  %173 = fptrunc double %172 to float
  store float %173, float addrspace(1)* %42, align 4, !tbaa !16
  br label %174

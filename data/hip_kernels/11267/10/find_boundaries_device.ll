; ModuleID = '../data/hip_kernels/11267/10/main.cu'
source_filename = "../data/hip_kernels/11267/10/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z15find_boundariesiiPKiPi(i32 %0, i32 %1, i32 addrspace(1)* nocapture readonly %2, i32 addrspace(1)* nocapture writeonly %3) local_unnamed_addr #0 {
...
39:                                               ; preds = %33, %39
  %40 = phi i32 [ %43, %39 ], [ %34, %33 ]
  %41 = sext i32 %40 to i64
  %42 = getelementptr inbounds i32, i32 addrspace(1)* %3, i64 %41
  store i32 %24, i32 addrspace(1)* %42, align 4, !tbaa !16
  %43 = add nsw i32 %40, 1
  %44 = icmp slt i32 %43, %37
  br i1 %44, label %39, label %45, !llvm.loop !20

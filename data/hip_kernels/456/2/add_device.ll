; ModuleID = '../data/hip_kernels/456/2/main.cu'
source_filename = "../data/hip_kernels/456/2/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z3addPfS_S_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
...
19:                                               ; preds = %6, %19
  ...
  %23 = load float, float addrspace(1)* %22, align 4, !tbaa !15
  %24 = getelementptr inbounds float, float addrspace(1)* %1, i64 %21
  %25 = load float, float addrspace(1)* %24, align 4, !tbaa !15
  %26 = fadd contract float %23, %25
  %27 = getelementptr inbounds float, float addrspace(1)* %2, i64 %21
  store float %26, float addrspace(1)* %27, align 4, !tbaa !15
  %28 = add i32 %15, %20
  %29 = add i32 %28, %18

; ModuleID = '../data/hip_kernels/14262/2/main.cu'
source_filename = "../data/hip_kernels/14262/2/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z10matrixNormPfS_S_S_i(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, i32 %4) local_unnamed_addr #0 {
  ...
  %28 = fcmp contract oeq float %27, 0.000000e+00
  %29 = zext i32 %24 to i64
  br i1 %28, label %40, label %30

30:                                               ; preds = %5
  %31 = getelementptr inbounds float, float addrspace(1)* %0, i64 %29
  ...
  %37 = getelementptr inbounds float, float addrspace(1)* %3, i64 %33
  %38 = load float, float addrspace(1)* %37, align 4, !tbaa !7, !amdgpu.noclobber !5
  %39 = fdiv contract float %36, %38
  br label %40

40:                                               ; preds = %5, %30
  %41 = phi float [ %39, %30 ], [ 0.000000e+00, %5 ]
  %42 = getelementptr inbounds float, float addrspace(1)* %1, i64 %29

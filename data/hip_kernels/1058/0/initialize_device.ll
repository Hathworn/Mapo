; ModuleID = '../data/hip_kernels/1058/0/main.cu'
source_filename = "../data/hip_kernels/1058/0/main.cu"
...
define protected amdgpu_kernel void @_Z10initializePfS_S_fii(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture writeonly %1, float addrspace(1)* nocapture writeonly %2, float %3, i32 %4, i32 %5) local_unnamed_addr #0 {
...
23:                                               ; preds = %19, %23
  %24 = phi i32 [ %17, %19 ], [ %33, %23 ]
  %25 = phi i32 [ 0, %19 ], [ %30, %23 ]

; ModuleID = '../data/hip_kernels/7801/62/main.cu'
source_filename = "../data/hip_kernels/7801/62/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @vec_sinf(i64 %0, float addrspace(1)* nocapture writeonly %1, float addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
...
134:                                              ; preds = %20, %28
  ...
  %149 = select i1 %148, float %142, float %146
  %150 = bitcast float %149 to i32
  %151 = shl i32 %137, 30
  %152 = and i32 %151, -2147483648
  %153 = bitcast float %17 to i32
  %154 = xor i32 %135, %153
  %155 = xor i32 %154, %152
  %156 = xor i32 %155, %150
  %157 = bitcast i32 %156 to float
  %158 = tail call i1 @llvm.amdgcn.class.f32(float %18, i32 504)
  %159 = select i1 %158, float %157, float 0x7FF8000000000000
  %160 = getelementptr inbounds float, float addrspace(1)* %1, i64 %13

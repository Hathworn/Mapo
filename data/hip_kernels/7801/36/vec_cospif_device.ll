; ModuleID = '../data/hip_kernels/7801/36/main.cu'
source_filename = "../data/hip_kernels/7801/36/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @vec_cospif(i64 %0, float addrspace(1)* nocapture writeonly %1, float addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
...
15:                                               ; preds = %3
  ...
  %43 = and i32 %29, 1
  %44 = icmp eq i32 %43, 0
  %45 = select i1 %44, float %41, float %42
  %46 = bitcast float %45 to i32
  %47 = shl i32 %29, 30
  %48 = and i32 %47, -2147483648
  %49 = xor i32 %48, %46
  %50 = bitcast i32 %49 to float
  %51 = tail call i1 @llvm.amdgcn.class.f32(float %18, i32 504)
  %52 = select i1 %51, float %50, float 0x7FF8000000000000
  %53 = getelementptr inbounds float, float addrspace(1)* %1, i64 %13

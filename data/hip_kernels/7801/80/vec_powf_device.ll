; ModuleID = '../data/hip_kernels/7801/80/main.cu'
source_filename = "../data/hip_kernels/7801/80/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @vec_powf(i64 %0, float addrspace(1)* nocapture writeonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3) local_unnamed_addr #0 {
...
16:                                               ; preds = %4
  ...
  %136 = tail call float @llvm.fabs.f32(float %129) #3
  %137 = fcmp oeq float %136, 0x7FF0000000000000
  %138 = select i1 %137, float %129, float %133
  %139 = tail call float @llvm.fabs.f32(float %138) #3
  ...
  %161 = tail call float @llvm.fabs.f32(float %159) #3

...
#include "findCentroidsAtomicFreeReduce_64_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
findCentroidsAtomicFreeReduce_64<<<gridBlock, threadBlock>>>(afLocal,responses,nPixels,cluster,centroidMass,centroidCount);

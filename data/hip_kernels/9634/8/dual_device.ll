; ModuleID = '../data/hip_kernels/9634/8/main.cu'
source_filename = "../data/hip_kernels/9634/8/main.cu"
...
34:                                               ; preds = %31
  ...
  %43 = add nsw i32 %27, -1
  %44 = mul nsw i32 %43, %7
  %45 = fneg contract float %32
  br label %46

46:                                               ; preds = %34, %104
  %47 = phi i32 [ 0, %34 ], [ %105, %104 ]
...
77:                                               ; preds = %70, %72
  ...
  %89 = fcmp contract ogt float %88, %32
  br i1 %89, label %90, label %93

90:                                               ; preds = %77
  %91 = fsub contract float %85, %32
  %92 = getelementptr inbounds float, float addrspace(1)* %0, i64 %80
  store float %91, float addrspace(1)* %92, align 4, !tbaa !7
  br label %93

93:                                               ; preds = %90, %77
  %94 = fcmp contract olt float %88, %45
  br i1 %94, label %95, label %98

95:                                               ; preds = %93
  %96 = fadd contract float %32, %85
  %97 = getelementptr inbounds float, float addrspace(1)* %0, i64 %80
  store float %96, float addrspace(1)* %97, align 4, !tbaa !7
  br label %98

98:                                               ; preds = %95, %93
  %99 = tail call float @llvm.fabs.f32(float %88)
  %100 = fcmp contract ugt float %99, %32
  br i1 %100, label %104, label %101

101:                                              ; preds = %98
  %102 = load float, float addrspace(1)* %86, align 4, !tbaa !7
  %103 = getelementptr inbounds float, float addrspace(1)* %0, i64 %80
...
104:                                              ; preds = %98, %101
  ...
  br i1 %106, label %107, label %46, !llvm.loop !11

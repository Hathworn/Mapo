; ModuleID = '../data/hip_kernels/182/3/main.cu'
source_filename = "../data/hip_kernels/182/3/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ3dotPiS_S_E4prod = internal unnamed_addr addrspace(3) global [256 x i32] undef, align 16
...
define protected amdgpu_kernel void @_Z3dotPiS_S_(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture %2) local_unnamed_addr #0 {
  ...
  %19 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ3dotPiS_S_E4prod, i32 0, i32 %11
...
21:                                               ; preds = %3
  %22 = load i32, i32 addrspace(3)* %19, align 4, !tbaa !7
  %23 = shl i32 %22, 8
  %24 = atomicrmw add i32 addrspace(1)* %2, i32 %23 syncscope("agent-one-as") monotonic, align 4
  br label %25

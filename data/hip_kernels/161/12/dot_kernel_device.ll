; ModuleID = '../data/hip_kernels/161/12/main.cu'
source_filename = "../data/hip_kernels/161/12/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ10dot_kernelPKfmmS0_mmmPfmfE4temp = internal unnamed_addr addrspace(3) global [32 x float] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z10dot_kernelPKfmmS0_mmmPfmf(float addrspace(1)* nocapture readonly %0, i64 %1, i64 %2, float addrspace(1)* nocapture readonly %3, i64 %4, i64 %5, i64 %6, float addrspace(1)* nocapture writeonly %7, i64 %8, float %9) local_unnamed_addr #0 {
...
18:                                               ; preds = %10
  ...
  %20 = getelementptr inbounds [32 x float], [32 x float] addrspace(3)* @_ZZ10dot_kernelPKfmmS0_mmmPfmfE4temp, i32 0, i32 %19
...
61:                                               ; preds = %58
  ...
  %64 = getelementptr inbounds [32 x float], [32 x float] addrspace(3)* @_ZZ10dot_kernelPKfmmS0_mmmPfmfE4temp, i32 0, i32 %63
...
71:                                               ; preds = %56
  %72 = load float, float addrspace(3)* getelementptr inbounds ([32 x float], [32 x float] addrspace(3)* @_ZZ10dot_kernelPKfmmS0_mmmPfmfE4temp, i32 0, i32 0), align 16, !tbaa !5
  %73 = mul i64 %14, %8
  %74 = add i64 %73, %12

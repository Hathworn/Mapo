; ModuleID = '../data/hip_kernels/161/0/main.cu'
source_filename = "../data/hip_kernels/161/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ16euclidean_kernelPKfmmS0_mmmPfmfE4temp = internal unnamed_addr addrspace(3) global [32 x float] undef, align 16
...
18:                                               ; preds = %10
  ...
  %20 = getelementptr inbounds [32 x float], [32 x float] addrspace(3)* @_ZZ16euclidean_kernelPKfmmS0_mmmPfmfE4temp, i32 0, i32 %19
...
62:                                               ; preds = %59
  ...
  %65 = getelementptr inbounds [32 x float], [32 x float] addrspace(3)* @_ZZ16euclidean_kernelPKfmmS0_mmmPfmfE4temp, i32 0, i32 %64
...
72:                                               ; preds = %57
  %73 = load float, float addrspace(3)* getelementptr inbounds ([32 x float], [32 x float] addrspace(3)* @_ZZ16euclidean_kernelPKfmmS0_mmmPfmfE4temp, i32 0, i32 0), align 16, !tbaa !5

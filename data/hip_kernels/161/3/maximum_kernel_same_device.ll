; ModuleID = '../data/hip_kernels/161/3/main.cu'
source_filename = "../data/hip_kernels/161/3/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ19maximum_kernel_samePKfmmS0_mmmPfmfE4temp = internal unnamed_addr addrspace(3) global [32 x float] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z19maximum_kernel_samePKfmmS0_mmmPfmf(float addrspace(1)* nocapture readonly %0, i64 %1, i64 %2, float addrspace(1)* nocapture readnone %3, i64 %4, i64 %5, i64 %6, float addrspace(1)* nocapture writeonly %7, i64 %8, float %9) local_unnamed_addr #0 {
...
29:                                               ; preds = %25
  %30 = getelementptr inbounds [32 x float], [32 x float] addrspace(3)* @_ZZ19maximum_kernel_samePKfmmS0_mmmPfmfE4temp, i32 0, i32 %18
...
53:                                               ; preds = %35, %53
  ...
  %64 = tail call float @llvm.maxnum.f32(float %63, float %54)
  %65 = add i64 %55, %42
...
71:                                               ; preds = %68
  %72 = load float, float addrspace(3)* %30, align 4, !tbaa !4
  %73 = trunc i64 %69 to i32
  %74 = add nuw nsw i32 %18, %73
  %75 = getelementptr inbounds [32 x float], [32 x float] addrspace(3)* @_ZZ19maximum_kernel_samePKfmmS0_mmmPfmfE4temp, i32 0, i32 %74
  %76 = load float, float addrspace(3)* %75, align 4, !tbaa !4
  %77 = tail call float @llvm.maxnum.f32(float %72, float %76)
...
81:                                               ; preds = %67
  %82 = load float, float addrspace(3)* getelementptr inbounds ([32 x float], [32 x float] addrspace(3)* @_ZZ19maximum_kernel_samePKfmmS0_mmmPfmfE4temp, i32 0, i32 0), align 16, !tbaa !4
  %83 = mul i64 %14, %8
  %84 = add i64 %83, %12

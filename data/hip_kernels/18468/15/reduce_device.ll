; ModuleID = '../data/hip_kernels/18468/15/main.cu'
source_filename = "../data/hip_kernels/18468/15/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ6reducePfS_E5sdata = internal unnamed_addr addrspace(3) global [256 x float] undef, align 16
...
define protected amdgpu_kernel void @_Z6reducePfS_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
  ...
  %4 = getelementptr inbounds [256 x float], [256 x float] addrspace(3)* @_ZZ6reducePfS_E5sdata, i32 0, i32 %3
...
43:                                               ; preds = %39
  ...
  %45 = getelementptr inbounds [256 x float], [256 x float] addrspace(3)* @_ZZ6reducePfS_E5sdata, i32 0, i32 %44
...
51:                                               ; preds = %37
  %52 = load float, float addrspace(3)* getelementptr inbounds ([256 x float], [256 x float] addrspace(3)* @_ZZ6reducePfS_E5sdata, i32 0, i32 0), align 16, !tbaa !5

; ModuleID = '../data/hip_kernels/18468/4/main.cu'
source_filename = "../data/hip_kernels/18468/4/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [34 x i8] c"Hello from block: %u, thread: %u\0A\00", align 1

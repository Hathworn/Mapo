; ModuleID = '../data/hip_kernels/6730/1/main.cu'
source_filename = "../data/hip_kernels/6730/1/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z6workerPdl(double addrspace(1)* nocapture %0, i64 %1) local_unnamed_addr #0 {
...
14:                                               ; preds = %2
  ...
  %16 = getelementptr inbounds double, double addrspace(1)* %0, i64 %12
  %17 = load double, double addrspace(1)* %16, align 8, !tbaa !7, !amdgpu.noclobber !5
  %18 = fadd contract double %17, %15
  store double %18, double addrspace(1)* %16, align 8, !tbaa !7
  br label %19

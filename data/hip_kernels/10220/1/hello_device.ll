; ModuleID = '../data/hip_kernels/10220/1/main.cu'
source_filename = "../data/hip_kernels/10220/1/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [38 x i8] c"Hello world! blcokid: %d\0Athreadid:%d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z5hellov() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([38 x i8], [38 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %9, label %13
...
17:                                               ; preds = %443, %13
  %18 = phi i64 [ select (i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([38 x i8], [38 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), i64 0, i64 add (i64 ptrtoint (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([38 x i8], [38 x i8] addrspace(4)* @.str, i64 0, i64 37) to i8*) to i64), i64 add (i64 sub (i64 0, i64 ptrtoint ([38 x i8]* addrspacecast ([38 x i8] addrspace(4)* @.str to [38 x i8]*) to i64)), i64 1))), %13 ], [ %451, %443 ]
  %19 = phi i8 addrspace(4)* [ getelementptr inbounds ([38 x i8], [38 x i8] addrspace(4)* @.str, i64 0, i64 0), %13 ], [ %452, %443 ]
...
454:                                              ; preds = %443, %9
  ...
  %457 = tail call i32 @llvm.amdgcn.workgroup.id.x()

; ModuleID = '../data/hip_kernels/2884/28/main.cu'
source_filename = "../data/hip_kernels/2884/28/main.cu"
...
@_ZZ14ScaleDownDensePfS_iiiiE5irows = internal unnamed_addr addrspace(3) global [1360 x float] undef, align 16
@_ZZ14ScaleDownDensePfS_iiiiE5brows = internal unnamed_addr addrspace(3) global [640 x float] undef, align 16
...
23:                                               ; preds = %6
  ...
  %37 = mul nuw nsw i32 %8, 68
  %38 = add nuw nsw i32 %37, %7
  %39 = getelementptr inbounds [1360 x float], [1360 x float] addrspace(3)* @_ZZ14ScaleDownDensePfS_iiiiE5irows, i32 0, i32 %38
...
40:                                               ; preds = %23, %6
  ...
  %41 = icmp ult i32 %7, 32
  %42 = select i1 %21, i1 %41, i1 false
  br i1 %42, label %43, label %67

43:                                               ; preds = %40
  %44 = mul nuw nsw i32 %8, 68
  %45 = shl nuw nsw i32 %7, 1
  %46 = add nuw nsw i32 %44, %45
  %47 = getelementptr inbounds [1360 x float], [1360 x float] addrspace(3)* @_ZZ14ScaleDownDensePfS_iiiiE5irows, i32 0, i32 %46
  ...
  %64 = shl nuw nsw i32 %8, 5
  %65 = add nuw nsw i32 %64, %7
  %66 = getelementptr inbounds [640 x float], [640 x float] addrspace(3)* @_ZZ14ScaleDownDensePfS_iiiiE5brows, i32 0, i32 %65
...
80:                                               ; preds = %67
  %81 = shl nuw nsw i32 %8, 6
  %82 = add nuw nsw i32 %81, %7
  %83 = getelementptr inbounds [640 x float], [640 x float] addrspace(3)* @_ZZ14ScaleDownDensePfS_iiiiE5brows, i32 0, i32 %82
  %84 = load float, float addrspace(3)* %83, align 4, !tbaa !5
  %85 = getelementptr inbounds float, float addrspace(3)* %83, i32 128
  %86 = load float, float addrspace(3)* %85, align 4, !tbaa !5
  %87 = fadd contract float %84, %86
  %88 = fmul contract float %15, %87
  %89 = getelementptr inbounds float, float addrspace(3)* %83, i32 32
  %90 = load float, float addrspace(3)* %89, align 4, !tbaa !5
  %91 = getelementptr inbounds float, float addrspace(3)* %83, i32 96
  ...
  %96 = getelementptr inbounds float, float addrspace(3)* %83, i32 64

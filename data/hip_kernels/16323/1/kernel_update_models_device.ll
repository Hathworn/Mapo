; ModuleID = '../data/hip_kernels/16323/1/main.cu'
source_filename = "../data/hip_kernels/16323/1/main.cu"
...
define protected amdgpu_kernel void @_Z20kernel_update_modelsP15HIP_vector_typeIfLj4EES1_i(%struct.HIP_vector_type addrspace(1)* nocapture readonly %0, %struct.HIP_vector_type addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
16:                                               ; preds = %3
  ...
  %23 = insertelement <4 x float> <float poison, float poison, float poison, float 1.000000e+00>, float %18, i64 0
  ...
  %28 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %1, i64 %27, i32 0, i32 0, i32 0
  store <4 x float> %25, <4 x float> addrspace(1)* %28, align 16

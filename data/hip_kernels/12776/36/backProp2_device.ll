; ModuleID = '../data/hip_kernels/12776/36/main.cu'
source_filename = "../data/hip_kernels/12776/36/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z9backProp2PfS_S_S_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3) local_unnamed_addr #0 {
  ...
  %25 = getelementptr inbounds float, float addrspace(1)* %3, i64 %22
  ...
  %30 = fsub contract double 1.000000e+00, %29
  %31 = fmul contract double %30, %29
  %32 = fmul contract double %31, %28
  ...
  %37 = fmul contract float %36, %33
  %38 = fpext float %37 to double
  %39 = fdiv contract double %38, 6.000000e+03
  ...
  store float %47, float addrspace(1)* %43, align 4, !tbaa !7
  ret void
}

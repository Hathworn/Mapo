; ModuleID = '../data/hip_kernels/15076/0/main.cu'
source_filename = "../data/hip_kernels/15076/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z13kernel_offsetPiS_S_i(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readnone %1, i32 addrspace(1)* nocapture writeonly %2, i32 %3) local_unnamed_addr #0 {
...
29:                                               ; preds = %4, %26
  %30 = phi i64 [ %28, %26 ], [ 1, %4 ]
  %31 = phi i32 [ %13, %26 ], [ 0, %4 ]
  %32 = getelementptr inbounds i32, i32 addrspace(1)* %2, i64 %30
...
36:                                               ; preds = %33
  ...
  %40 = add nsw i32 %39, 1
  store i32 %40, i32 addrspace(1)* %2, align 4, !tbaa !7
  %41 = add nsw i32 %39, 2
  %42 = sext i32 %41 to i64
  %43 = getelementptr inbounds i32, i32 addrspace(1)* %2, i64 %42
  store i32 %3, i32 addrspace(1)* %43, align 4, !tbaa !7
  br label %44

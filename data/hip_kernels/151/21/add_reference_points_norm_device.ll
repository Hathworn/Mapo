; ModuleID = '../data/hip_kernels/151/21/main.cu'
source_filename = "../data/hip_kernels/151/21/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ25add_reference_points_normPfiiiS_E10shared_vec = internal unnamed_addr addrspace(3) global [16 x float] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z25add_reference_points_normPfiiiS_(float addrspace(1)* nocapture %0, i32 %1, i32 %2, i32 %3, float addrspace(1)* nocapture readonly %4) local_unnamed_addr #0 {
...
26:                                               ; preds = %5
  ...
  %30 = getelementptr inbounds [16 x float], [16 x float] addrspace(3)* @_ZZ25add_reference_points_normPfiiiS_E10shared_vec, i32 0, i32 %7
...
34:                                               ; preds = %31
  %35 = getelementptr inbounds [16 x float], [16 x float] addrspace(3)* @_ZZ25add_reference_points_normPfiiiS_E10shared_vec, i32 0, i32 %7

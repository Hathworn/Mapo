; ModuleID = '../data/hip_kernels/151/0/main.cu'
source_filename = "../data/hip_kernels/151/0/main.cu"
...
@texA = protected addrspace(1) externally_initialized global %struct.texture undef, align 8
@llvm.compiler.used = appending addrspace(1) global [1 x i8*] [i8* addrspacecast (i8 addrspace(1)* bitcast (%struct.texture addrspace(1)* @texA to i8 addrspace(1)*) to i8*)], section "llvm.metadata"

; Function Attrs: mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z24cuComputeDistanceTextureiPfiiiS_(i32 %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3, i32 %4, float addrspace(1)* nocapture writeonly %5) local_unnamed_addr #0 {
...
29:                                               ; preds = %27
  %30 = load %struct.__hip_texture*, %struct.__hip_texture* addrspace(1)* getelementptr inbounds (%struct.texture, %struct.texture addrspace(1)* @texA, i64 0, i32 0, i32 11), align 8
  %31 = uitofp i32 %23 to float
  %32 = bitcast %struct.__hip_texture* %30 to i32*
  %33 = addrspacecast i32* %32 to i32 addrspace(4)*
  ...
  %44 = load i32, i32 addrspace(4)* %34, align 4, !tbaa !7
  %45 = and i32 %44, 32768
  %46 = icmp eq i32 %45, 0
  ...
  %54 = load <4 x i32>, <4 x i32> addrspace(4)* %53, align 16, !tbaa !11
  %55 = bitcast %struct.__hip_texture* %30 to <8 x i32>*
  %56 = addrspacecast <8 x i32>* %55 to <8 x i32> addrspace(4)*
  %57 = load <8 x i32>, <8 x i32> addrspace(4)* %56, align 32, !tbaa !11
...
68:                                               ; preds = %100, %29
  %69 = phi float [ undef, %29 ], [ %222, %100 ]
  %70 = phi float [ 0.000000e+00, %29 ], [ %222, %100 ]
  %71 = phi i32 [ 0, %29 ], [ %223, %100 ]
  %72 = icmp eq i32 %64, 0
...
94:                                               ; preds = %68, %73, %27
  %95 = phi float [ 0.000000e+00, %27 ], [ %69, %68 ], [ %90, %73 ]
  %96 = mul i32 %23, %3
  %97 = add i32 %96, %15

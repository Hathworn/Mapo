; ModuleID = '../data/hip_kernels/9255/30/main.cu'
source_filename = "../data/hip_kernels/9255/30/main.cu"
...
define protected amdgpu_kernel void @_Z19kernel_histo_stridePjS_(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture %1) local_unnamed_addr #0 {
  ...
  %19 = add i32 %15, %18
  %20 = mul i32 %19, %9
  %21 = load i32, i32 addrspace(4)* @constant_n_hits, align 4, !tbaa !16
  %22 = load i32, i32 addrspace(4)* @constant_n_test_vertices, align 4, !tbaa !16
  %23 = mul i32 %22, %21
  %24 = icmp ult i32 %14, %23
  br i1 %24, label %25, label %35

25:                                               ; preds = %2, %25
  %26 = phi i32 [ %33, %25 ], [ %14, %2 ]

; ModuleID = '../data/hip_kernels/8568/4/main.cu'
source_filename = "../data/hip_kernels/8568/4/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z7sigmoidPfS_ii(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3) local_unnamed_addr #0 {
...
25:                                               ; preds = %4
  ...
  %32 = fmul float %30, 0xBFF7154760000000
  %33 = tail call float @llvm.rint.f32(float %32)
  %34 = fcmp olt float %30, 0xC0562E4300000000
  %35 = fcmp ogt float %30, 0x4059D1DA00000000
  %36 = fneg float %32
  ...
  %46 = select i1 %35, float 1.000000e+00, float %45
  %47 = select i1 %34, float 0.000000e+00, float %46
  ...
  %51 = fadd contract float %50, %47
  store float %51, float addrspace(1)* %29, align 4, !tbaa !7
  br label %52

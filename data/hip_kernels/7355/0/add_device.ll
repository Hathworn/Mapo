; ModuleID = '../data/hip_kernels/7355/0/main.cu'
source_filename = "../data/hip_kernels/7355/0/main.cu"
...
define protected amdgpu_kernel void @_Z3addPiS_S_(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  ...
  %20 = add i32 %18, %19
  %21 = icmp ult i32 %12, 10000
  %22 = icmp ult i32 %20, 10000
  %23 = select i1 %21, i1 %22, i1 false
  br i1 %23, label %24, label %34

24:                                               ; preds = %3
  %25 = mul nuw nsw i32 %12, 10000

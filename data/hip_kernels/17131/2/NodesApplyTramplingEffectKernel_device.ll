; ModuleID = '../data/hip_kernels/17131/2/main.cu'
source_filename = "../data/hip_kernels/17131/2/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: mustprogress nofree norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z31NodesApplyTramplingEffectKernelPfS_iiff(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3, float %4, float %5) local_unnamed_addr #0 {
...
29:                                               ; preds = %6
  ...
  %36 = fdiv contract float %35, %4
  %37 = tail call float @llvm.fabs.f32(float %36)
  %38 = tail call float @llvm.minnum.f32(float %37, float 1.000000e+00)
  %39 = tail call float @llvm.maxnum.f32(float %38, float 0.000000e+00)
  %40 = fmul contract float %39, 4.000000e+00
  %41 = fsub contract float 6.000000e+00, %40
  %42 = fmul contract float %39, %41
  %43 = fadd contract float %42, -3.000000e+00
  %44 = fmul contract float %39, %43
  %45 = fadd contract float %44, 1.000000e+00
  %46 = getelementptr inbounds float, float addrspace(1)* %0, i64 %33
  %47 = fmul contract float %45, %5
  %48 = atomicrmw fadd float addrspace(1)* %46, float %47 syncscope("agent-one-as") monotonic, align 4
  br label %49

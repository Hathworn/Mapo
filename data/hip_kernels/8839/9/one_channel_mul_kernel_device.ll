; ModuleID = '../data/hip_kernels/8839/9/main.cu'
source_filename = "../data/hip_kernels/8839/9/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z22one_channel_mul_kernelPfS_S_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  ...
  %50 = fsub contract float %40, %49
  %51 = getelementptr inbounds float, float addrspace(1)* %2, i64 %34
  store float %50, float addrspace(1)* %51, align 4, !tbaa !16
  %52 = load float, float addrspace(1)* %35, align 4, !tbaa !16
  %53 = load float, float addrspace(1)* %47, align 4, !tbaa !16
  %54 = fmul contract float %52, %53
  %55 = load float, float addrspace(1)* %43, align 4, !tbaa !16
  %56 = load float, float addrspace(1)* %38, align 4, !tbaa !16
  %57 = fmul contract float %55, %56
  %58 = fadd contract float %54, %57
  %59 = getelementptr inbounds float, float addrspace(1)* %2, i64 %42

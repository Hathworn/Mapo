; ModuleID = '../data/hip_kernels/8839/4/main.cu'
source_filename = "../data/hip_kernels/8839/4/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z28same_num_channels_mul_kernelPfS_S_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  ...
  %35 = getelementptr inbounds float, float addrspace(1)* %1, i64 %32
  ...
  %46 = getelementptr inbounds float, float addrspace(1)* %2, i64 %32
  store float %45, float addrspace(1)* %46, align 4, !tbaa !16
  %47 = load float, float addrspace(1)* %33, align 4, !tbaa !16
  %48 = load float, float addrspace(1)* %42, align 4, !tbaa !16
  %49 = fmul contract float %47, %48
  %50 = load float, float addrspace(1)* %40, align 4, !tbaa !16
  %51 = load float, float addrspace(1)* %35, align 4, !tbaa !16
  %52 = fmul contract float %50, %51
  %53 = fadd contract float %49, %52
  %54 = getelementptr inbounds float, float addrspace(1)* %2, i64 %39

...
int *d_compactedArray = NULL;
hipMalloc(&d_compactedArray, XSIZE*YSIZE);
...
hipFree(0);
scatter<<<gridBlock,threadBlock>>>(d_array,d_predicateArray,d_scanArray,d_compactedArray,d_numberOfElements);

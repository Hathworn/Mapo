; ModuleID = '../data/hip_kernels/1237/10/main.cu'
source_filename = "../data/hip_kernels/1237/10/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z17bitonic_sort_stepPfii(float addrspace(1)* nocapture %0, i32 %1, i32 %2) local_unnamed_addr #0 {
...
24:                                               ; preds = %15
  %25 = fcmp contract ogt float %20, %23
  br i1 %25, label %28, label %29

26:                                               ; preds = %15
  %27 = fcmp contract olt float %20, %23
  br i1 %27, label %28, label %29

28:                                               ; preds = %26, %24
  store float %23, float addrspace(1)* %19, align 4, !tbaa !7

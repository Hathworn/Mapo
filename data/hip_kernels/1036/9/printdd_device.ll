; ModuleID = '../data/hip_kernels/1036/9/main.cu'
source_filename = "../data/hip_kernels/1036/9/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [8 x i8] c"csr %d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z7printddPii(i32 addrspace(1)* nocapture readonly %0, i32 %1) local_unnamed_addr #1 {
  %3 = icmp sgt i32 %1, 0
...
12:                                               ; preds = %4, %464
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([8 x i8], [8 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %19, label %23
...
464:                                              ; preds = %453, %19
  ...
  %467 = zext i32 %16 to i64
  %468 = and i64 %466, -227
  %469 = or i64 %468, 34
  %470 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %10, i64 noundef %469, i64 noundef %467, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %471 = add nuw nsw i32 %13, 1
  %472 = icmp eq i32 %471, %1
  br i1 %472, label %11, label %12, !llvm.loop !15
}

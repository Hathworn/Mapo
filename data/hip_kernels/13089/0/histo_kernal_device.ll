; ModuleID = '../data/hip_kernels/13089/0/main.cu'
source_filename = "../data/hip_kernels/13089/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ12histo_kernalPclPiE4temp = internal addrspace(3) global [256 x i32] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z12histo_kernalPclPi(i8 addrspace(1)* nocapture readonly %0, i64 %1, i32 addrspace(1)* nocapture %2) local_unnamed_addr #0 {
  %4 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !4
  %5 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ12histo_kernalPclPiE4temp, i32 0, i32 %4
...
25:                                               ; preds = %3, %25
  ...
  %31 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ12histo_kernalPclPiE4temp, i32 0, i32 %30

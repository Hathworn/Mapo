; ModuleID = '../data/hip_kernels/4490/6/main.cu'
source_filename = "../data/hip_kernels/4490/6/main.cu"
...
define protected amdgpu_kernel void @_Z32initialize_clause_output_predictPiS_(i32 addrspace(1)* nocapture writeonly %0, i32 addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
...
23:                                               ; preds = %2, %23
  %24 = phi i32 [ %28, %23 ], [ %14, %2 ]
  %25 = sext i32 %24 to i64
  %26 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %25
  store i32 1, i32 addrspace(1)* %26, align 4, !tbaa !16
  %27 = getelementptr inbounds i32, i32 addrspace(1)* %1, i64 %25
  store i32 1, i32 addrspace(1)* %27, align 4, !tbaa !16
  %28 = add nsw i32 %24, %20
  %29 = icmp slt i32 %28, 10000
  br i1 %29, label %23, label %22, !llvm.loop !20
}

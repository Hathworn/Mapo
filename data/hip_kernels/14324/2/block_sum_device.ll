; ModuleID = '../data/hip_kernels/14324/2/main.cu'
source_filename = "../data/hip_kernels/14324/2/main.cu"
...
define protected amdgpu_kernel void @_Z9block_sumPKiPim(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture writeonly %1, i64 %2) local_unnamed_addr #0 {
...
15:                                               ; preds = %3
  %16 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %13
  %17 = load i32, i32 addrspace(1)* %16, align 4, !tbaa !7, !amdgpu.noclobber !5
  br label %18

18:                                               ; preds = %15, %3
  %19 = phi i32 [ %17, %15 ], [ 0, %3 ]
  %20 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @sdata, i32 0, i32 %11
...
36:                                               ; preds = %22
  %37 = load i32, i32 addrspace(3)* getelementptr inbounds ([0 x i32], [0 x i32] addrspace(3)* @sdata, i32 0, i32 0), align 4, !tbaa !7

; ModuleID = '../data/hip_kernels/11713/4/main.cu'
source_filename = "../data/hip_kernels/11713/4/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z13ShortestPath1PfS_iii(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3, i32 %4) local_unnamed_addr #0 {
...
33:                                               ; preds = %5, %49
  %34 = phi i32 [ %50, %49 ], [ %23, %5 ]
  %35 = add nsw i32 %34, %24
  %36 = sub nsw i32 %34, %23
  %37 = mul nsw i32 %36, %2
  %38 = add nsw i32 %37, %14
  %39 = load float, float addrspace(1)* %27, align 4, !tbaa !7
  ...
  %47 = fcmp contract ogt float %39, %46
  br i1 %47, label %48, label %49

48:                                               ; preds = %33
  store float %46, float addrspace(1)* %29, align 4, !tbaa !7
  br label %49

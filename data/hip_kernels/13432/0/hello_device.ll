; ModuleID = '../data/hip_kernels/13432/0/main.cu'
source_filename = "../data/hip_kernels/13432/0/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [42 x i8] c"Hello world! I'm a thread %d in block %d\0A\00", align 1

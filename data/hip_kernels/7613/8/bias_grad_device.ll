; ModuleID = '../data/hip_kernels/7613/8/main.cu'
source_filename = "../data/hip_kernels/7613/8/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z9bias_gradPfS_ii(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture %1, i32 %2, i32 %3) local_unnamed_addr #0 {
...
25:                                               ; preds = %25, %23
  %26 = phi float [ 0.000000e+00, %23 ], [ %75, %25 ]
  ...
  %33 = fadd contract float %32, %26
  store float %33, float addrspace(1)* %17, align 4, !tbaa !7
  %34 = or i32 %27, 1
  ...
  %45 = fadd contract float %44, %39
  store float %45, float addrspace(1)* %17, align 4, !tbaa !7
  %46 = or i32 %27, 3
  ...
  %51 = fadd contract float %50, %45
  store float %51, float addrspace(1)* %17, align 4, !tbaa !7
  %52 = or i32 %27, 4
  ...
  %63 = fadd contract float %62, %57
  store float %63, float addrspace(1)* %17, align 4, !tbaa !7
  %64 = or i32 %27, 6
  ...
  %75 = fadd contract float %74, %69
  store float %75, float addrspace(1)* %17, align 4, !tbaa !7
...
79:                                               ; preds = %25, %19
  %80 = phi float [ 0.000000e+00, %19 ], [ %75, %25 ]
...
83:                                               ; preds = %79, %83
  ...
  %91 = fadd contract float %90, %84
  store float %91, float addrspace(1)* %17, align 4, !tbaa !7

...
const int *dests = NULL;
hipMalloc(&dests, XSIZE*YSIZE);
int *labels = NULL;
...
hipFree(0);
device_BFS<<<gridBlock, threadBlock>>>(edges,dests,labels,visited,c_frontier_tail,c_frontier,p_frontier_tail,p_frontier);

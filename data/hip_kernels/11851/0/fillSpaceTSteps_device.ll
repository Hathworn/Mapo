; ModuleID = '../data/hip_kernels/11851/0/main.cu'
source_filename = "../data/hip_kernels/11851/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: convergent mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z15fillSpaceTStepsiifffPfS_S_(i32 %0, i32 %1, float %2, float %3, float %4, float addrspace(1)* nocapture writeonly %5, float addrspace(1)* nocapture readonly %6, float addrspace(1)* nocapture readonly %7) local_unnamed_addr #0 {
  ...
  %31 = fmul contract float %30, 2.000000e+00
  %32 = getelementptr inbounds float, float addrspace(1)* %7, i64 %28
  ...
  %36 = fdiv contract float %3, %4
  %37 = fmul contract float %36, %3
  %38 = fdiv contract float %37, %4
  ...
  %63 = fmul contract float %30, 4.000000e+00
  %64 = fsub contract float %62, %63
  %65 = fmul contract float %39, %64
  %66 = fadd contract float %34, %65
  %67 = getelementptr inbounds float, float addrspace(1)* %5, i64 %28

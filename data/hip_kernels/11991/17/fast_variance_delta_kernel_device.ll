; ModuleID = '../data/hip_kernels/11991/17/main.cu'
source_filename = "../data/hip_kernels/11991/17/main.cu"
...
206:                                              ; preds = %138
  ...
  %209 = fadd contract float %208, 0x3EB0C6F7A0000000
  ...
  %325 = tail call float @llvm.fabs.f32(float %318) #3
  %326 = fcmp oeq float %325, 0x7FF0000000000000
  %327 = select i1 %326, float %318, float %322
  %328 = tail call float @llvm.fabs.f32(float %327) #3
  ...
  %350 = tail call float @llvm.fabs.f32(float %348) #3
  ...
  %355 = select i1 %353, float %354, float 0x7FF8000000000000
  %356 = fcmp oeq float %210, 0x7FF0000000000000
  %357 = fcmp oeq float %209, 0.000000e+00
  %358 = select i1 %356, float 0.000000e+00, float %355
  %359 = select i1 %357, float 0x7FF0000000000000, float %358
  %360 = fcmp uno float %209, 0.000000e+00
  %361 = select i1 %360, float 0x7FF8000000000000, float %359
  %362 = fcmp oeq float %209, 1.000000e+00
  %363 = select i1 %362, float 1.000000e+00, float %361
  %364 = fpext float %363 to double
  %365 = fmul contract double %364, -5.000000e-01
  %366 = load float, float addrspace(1)* %137, align 4, !tbaa !5
  %367 = fpext float %366 to double
  %368 = fmul contract double %365, %367
  %369 = fptrunc double %368 to float
  store float %369, float addrspace(1)* %137, align 4, !tbaa !5
  br label %370

; ModuleID = '../data/hip_kernels/11991/18/main.cu'
source_filename = "../data/hip_kernels/11991/18/main.cu"
...
119:                                              ; preds = %115, %28
  ...
  %123 = fadd contract float %122, 0x3EB0C6F7A0000000
  ...
  %147 = fpext float %120 to double
  %148 = fmul contract double %146, %147
  %149 = fptrunc double %148 to float
  store float %149, float addrspace(1)* %30, align 4, !tbaa !16
  br label %150

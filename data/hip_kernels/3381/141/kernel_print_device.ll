; ModuleID = '../data/hip_kernels/3381/141/main.cu'
source_filename = "../data/hip_kernels/3381/141/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [11 x i8] c"ulong: %d \00", align 1
@.str.1 = private unnamed_addr addrspace(4) constant [5 x i8] c"%lu \00", align 1
...
define protected amdgpu_kernel void @_Z12kernel_printPKmi(i64 addrspace(1)* nocapture readonly %0, i32 %1) local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([11 x i8], [11 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %11, label %15

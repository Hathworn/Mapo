; ModuleID = '../data/hip_kernels/5280/9/main.cu'
source_filename = "../data/hip_kernels/5280/9/main.cu"
...
define protected amdgpu_kernel void @_Z10set_kernelifPf(i32 %0, float %1, float addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
...
25:                                               ; preds = %17, %25
  %26 = phi i32 [ %15, %17 ], [ %29, %25 ]
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds float, float addrspace(1)* %2, i64 %27
  store float %1, float addrspace(1)* %28, align 4, !tbaa !16
  %29 = add i32 %23, %26
  %30 = icmp slt i32 %29, %0
  br i1 %30, label %25, label %24, !llvm.loop !20
}

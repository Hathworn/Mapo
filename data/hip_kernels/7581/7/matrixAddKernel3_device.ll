; ModuleID = '../data/hip_kernels/7581/7/main.cu'
source_filename = "../data/hip_kernels/7581/7/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z16matrixAddKernel3PfS_S_i(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, i32 %3) local_unnamed_addr #0 {
...
22:                                               ; preds = %22, %20
  ...
  %50 = getelementptr inbounds float, float addrspace(1)* %2, i64 %47
  %51 = load float, float addrspace(1)* %50, align 4, !tbaa !7
  %52 = fadd contract float %49, %51
  %53 = getelementptr inbounds float, float addrspace(1)* %0, i64 %47
  ...
  %63 = getelementptr inbounds float, float addrspace(1)* %0, i64 %57
  ...
  %73 = getelementptr inbounds float, float addrspace(1)* %0, i64 %67
  ...
  %80 = getelementptr inbounds float, float addrspace(1)* %2, i64 %77
  %81 = load float, float addrspace(1)* %80, align 4, !tbaa !7
  %82 = fadd contract float %79, %81
  %83 = getelementptr inbounds float, float addrspace(1)* %0, i64 %77
  ...
  %93 = getelementptr inbounds float, float addrspace(1)* %0, i64 %87
  ...
  %100 = getelementptr inbounds float, float addrspace(1)* %2, i64 %97
  %101 = load float, float addrspace(1)* %100, align 4, !tbaa !7
  %102 = fadd contract float %99, %101
  %103 = getelementptr inbounds float, float addrspace(1)* %0, i64 %97
...
110:                                              ; preds = %107, %110
  ...
  %118 = getelementptr inbounds float, float addrspace(1)* %2, i64 %115
  %119 = load float, float addrspace(1)* %118, align 4, !tbaa !7
  %120 = fadd contract float %117, %119
  %121 = getelementptr inbounds float, float addrspace(1)* %0, i64 %115
  store float %120, float addrspace(1)* %121, align 4, !tbaa !7

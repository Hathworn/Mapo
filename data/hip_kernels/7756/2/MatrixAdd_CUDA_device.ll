; ModuleID = '../data/hip_kernels/7756/2/main.cu'
source_filename = "../data/hip_kernels/7756/2/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z14MatrixAdd_CUDAPiS_S_(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  ...
  %20 = add i32 %18, %19
  %21 = mul nsw i32 %12, 10000
  %22 = sext i32 %21 to i64
  %23 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %22
  %24 = sext i32 %20 to i64
  %25 = getelementptr inbounds i32, i32 addrspace(1)* %23, i64 %24
  %26 = load i32, i32 addrspace(1)* %25, align 4, !tbaa !7, !amdgpu.noclobber !5
  %27 = getelementptr inbounds i32, i32 addrspace(1)* %1, i64 %22
  %28 = getelementptr inbounds i32, i32 addrspace(1)* %27, i64 %24
  %29 = load i32, i32 addrspace(1)* %28, align 4, !tbaa !7, !amdgpu.noclobber !5
  %30 = add nsw i32 %29, %26
  %31 = getelementptr inbounds i32, i32 addrspace(1)* %2, i64 %22
  %32 = getelementptr inbounds i32, i32 addrspace(1)* %31, i64 %24

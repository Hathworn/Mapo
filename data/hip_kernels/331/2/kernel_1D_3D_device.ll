; ModuleID = '../data/hip_kernels/331/2/main.cu'
source_filename = "../data/hip_kernels/331/2/main.cu"
...
define protected amdgpu_kernel void @_Z12kernel_1D_3Dv() local_unnamed_addr #1 {
  ...
  %8 = getelementptr i8, i8 addrspace(4)* %4, i64 6
  %9 = bitcast i8 addrspace(4)* %8 to i16 addrspace(4)*
  %10 = load i16, i16 addrspace(4)* %9, align 2, !range !5, !invariant.load !6
  %11 = getelementptr i8, i8 addrspace(4)* %4, i64 8
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([53 x i8], [53 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %22, label %26
...
467:                                              ; preds = %456, %22
  ...
  %469 = tail call i32 @llvm.amdgcn.workgroup.id.x()
  %470 = zext i16 %13 to i32
  %471 = mul i32 %469, %470
  %472 = add i32 %471, %3
  %473 = zext i16 %10 to i32
  %474 = mul i32 %472, %473
  %475 = add i32 %474, %2
  %476 = zext i16 %7 to i32
  %477 = mul i32 %475, %476
  %478 = add i32 %477, %1
  %479 = extractelement <2 x i64> %468, i64 0
  %480 = zext i32 %1 to i64
  %481 = and i64 %479, -225
  %482 = or i64 %481, 32
  %483 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %19, i64 noundef %482, i64 noundef %480, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %484 = extractelement <2 x i64> %483, i64 0
  %485 = zext i32 %2 to i64
  %486 = and i64 %484, -225
  %487 = or i64 %486, 32
  %488 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %19, i64 noundef %487, i64 noundef %485, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %489 = extractelement <2 x i64> %488, i64 0
  %490 = zext i32 %3 to i64
  %491 = and i64 %489, -225
  %492 = or i64 %491, 32
  %493 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %19, i64 noundef %492, i64 noundef %490, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %494 = extractelement <2 x i64> %493, i64 0
  %495 = zext i32 %478 to i64
  %496 = and i64 %494, -227
  %497 = or i64 %496, 34
  %498 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %19, i64 noundef %497, i64 noundef %495, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

; ModuleID = '../data/hip_kernels/331/5/main.cu'
source_filename = "../data/hip_kernels/331/5/main.cu"
...
define protected amdgpu_kernel void @_Z12kernel_2D_3Dv() local_unnamed_addr #1 {
  ...
  %15 = load i16, i16 addrspace(4)* %14, align 2, !range !14, !invariant.load !15
  %16 = getelementptr i8, i8 addrspace(4)* %4, i64 8
  ...
  %22 = load i64, i64 addrspace(4)* %21, align 8, !tbaa !16
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([53 x i8], [53 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %27, label %31
...
50:                                               ; preds = %35
  %51 = load i8, i8 addrspace(4)* %37, align 1, !tbaa !17
...
110:                                              ; preds = %103
  %111 = load i8, i8 addrspace(4)* %104, align 1, !tbaa !17
...
170:                                              ; preds = %163
  %171 = load i8, i8 addrspace(4)* %164, align 1, !tbaa !17
...
230:                                              ; preds = %223
  %231 = load i8, i8 addrspace(4)* %224, align 1, !tbaa !17
...
290:                                              ; preds = %283
  %291 = load i8, i8 addrspace(4)* %284, align 1, !tbaa !17
...
350:                                              ; preds = %343
  %351 = load i8, i8 addrspace(4)* %344, align 1, !tbaa !17
...
410:                                              ; preds = %403
  %411 = load i8, i8 addrspace(4)* %404, align 1, !tbaa !17
...
472:                                              ; preds = %461, %27
  ...
  %474 = mul i32 %12, %11
  %475 = icmp ugt i32 %7, %474
  %476 = zext i1 %475 to i32
  %477 = add i32 %12, %476
  %478 = tail call i32 @llvm.amdgcn.workgroup.id.y()
  %479 = mul i32 %477, %478
  %480 = tail call i32 @llvm.amdgcn.workgroup.id.x()
  %481 = add i32 %479, %480
  %482 = zext i16 %18 to i32
  %483 = mul i32 %481, %482
  %484 = add i32 %483, %3
  %485 = zext i16 %15 to i32
  %486 = mul i32 %484, %485
  %487 = add i32 %486, %2
  %488 = mul i32 %487, %11
  %489 = add i32 %488, %1
  %490 = extractelement <2 x i64> %473, i64 0
  %491 = zext i32 %1 to i64
  %492 = and i64 %490, -225
  %493 = or i64 %492, 32
  %494 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %24, i64 noundef %493, i64 noundef %491, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %495 = extractelement <2 x i64> %494, i64 0
  %496 = zext i32 %2 to i64
  %497 = and i64 %495, -225
  %498 = or i64 %497, 32
  %499 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %24, i64 noundef %498, i64 noundef %496, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %500 = extractelement <2 x i64> %499, i64 0
  %501 = zext i32 %3 to i64
  %502 = and i64 %500, -225
  %503 = or i64 %502, 32
  %504 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %24, i64 noundef %503, i64 noundef %501, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %505 = extractelement <2 x i64> %504, i64 0
  %506 = zext i32 %489 to i64
  %507 = and i64 %505, -227
  %508 = or i64 %507, 34
  %509 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %24, i64 noundef %508, i64 noundef %506, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}
...
!22 = !{i64 2662}
!23 = !{!24, !12, i64 0}
!24 = !{!"", !12, i64 0, !12, i64 8, !13, i64 16, !11, i64 24, !11, i64 32, !11, i64 40}
!25 = !{!24, !11, i64 40}
!26 = !{!24, !12, i64 8}
!27 = !{!"exec"}
!28 = !{!29, !10, i64 16}
!29 = !{!"", !11, i64 0, !11, i64 8, !10, i64 16, !10, i64 20}
!30 = !{!29, !11, i64 8}
!31 = !{!29, !10, i64 20}
!32 = !{!29, !11, i64 0}
!33 = !{!34, !11, i64 16}
!34 = !{!"amd_signal_s", !11, i64 0, !8, i64 8, !11, i64 16, !10, i64 24, !10, i64 28, !11, i64 32, !11, i64 40, !8, i64 48, !8, i64 56}
!35 = !{!34, !10, i64 24}

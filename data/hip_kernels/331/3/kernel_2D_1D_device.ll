; ModuleID = '../data/hip_kernels/331/3/main.cu'
source_filename = "../data/hip_kernels/331/3/main.cu"
...
define protected amdgpu_kernel void @_Z12kernel_2D_1Dv() local_unnamed_addr #1 {
  ...
  %14 = load i64, i64 addrspace(4)* %13, align 8, !tbaa !16
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([44 x i8], [44 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %19, label %23
...
82:                                               ; preds = %40, %82
  ...
  %87 = load i8, i8 addrspace(4)* %86, align 1, !tbaa !17
...
102:                                              ; preds = %95
  %103 = load i8, i8 addrspace(4)* %96, align 1, !tbaa !17
  %104 = zext i8 %103 to i64
  %105 = getelementptr inbounds i8, i8 addrspace(4)* %96, i64 1
  %106 = load i8, i8 addrspace(4)* %105, align 1, !tbaa !17
...
142:                                              ; preds = %100, %142
  ...
  %147 = load i8, i8 addrspace(4)* %146, align 1, !tbaa !17
...
162:                                              ; preds = %155
  %163 = load i8, i8 addrspace(4)* %156, align 1, !tbaa !17
  %164 = zext i8 %163 to i64
  %165 = getelementptr inbounds i8, i8 addrspace(4)* %156, i64 1
  %166 = load i8, i8 addrspace(4)* %165, align 1, !tbaa !17
...
202:                                              ; preds = %160, %202
  ...
  %207 = load i8, i8 addrspace(4)* %206, align 1, !tbaa !17
...
222:                                              ; preds = %215
  %223 = load i8, i8 addrspace(4)* %216, align 1, !tbaa !17
  %224 = zext i8 %223 to i64
  %225 = getelementptr inbounds i8, i8 addrspace(4)* %216, i64 1
  %226 = load i8, i8 addrspace(4)* %225, align 1, !tbaa !17
...
262:                                              ; preds = %220, %262
  ...
  %267 = load i8, i8 addrspace(4)* %266, align 1, !tbaa !17
...
282:                                              ; preds = %275
  %283 = load i8, i8 addrspace(4)* %276, align 1, !tbaa !17
  %284 = zext i8 %283 to i64
  %285 = getelementptr inbounds i8, i8 addrspace(4)* %276, i64 1
  %286 = load i8, i8 addrspace(4)* %285, align 1, !tbaa !17
...
322:                                              ; preds = %280, %322
  ...
  %327 = load i8, i8 addrspace(4)* %326, align 1, !tbaa !17
...
342:                                              ; preds = %335
  %343 = load i8, i8 addrspace(4)* %336, align 1, !tbaa !17
  %344 = zext i8 %343 to i64
  %345 = getelementptr inbounds i8, i8 addrspace(4)* %336, i64 1
  %346 = load i8, i8 addrspace(4)* %345, align 1, !tbaa !17
...
382:                                              ; preds = %340, %382
  ...
  %387 = load i8, i8 addrspace(4)* %386, align 1, !tbaa !17
...
402:                                              ; preds = %395
  %403 = load i8, i8 addrspace(4)* %396, align 1, !tbaa !17
  %404 = zext i8 %403 to i64
  %405 = getelementptr inbounds i8, i8 addrspace(4)* %396, i64 1
  %406 = load i8, i8 addrspace(4)* %405, align 1, !tbaa !17
...
464:                                              ; preds = %453, %19
  ...
  %466 = mul i32 %10, %9
  %467 = icmp ugt i32 %5, %466
  %468 = zext i1 %467 to i32
  %469 = add i32 %10, %468
  %470 = tail call i32 @llvm.amdgcn.workgroup.id.y()
  %471 = mul i32 %469, %470
  %472 = tail call i32 @llvm.amdgcn.workgroup.id.x()
  %473 = add i32 %471, %472
  %474 = mul i32 %473, %9
  %475 = add i32 %474, %1
  %476 = extractelement <2 x i64> %465, i64 0

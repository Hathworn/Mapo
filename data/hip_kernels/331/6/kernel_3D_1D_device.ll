; ModuleID = '../data/hip_kernels/331/6/main.cu'
source_filename = "../data/hip_kernels/331/6/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [44 x i8] c"Local thread ID: %i   Global thread ID: %i\0A\00", align 1
...
define protected amdgpu_kernel void @_Z12kernel_3D_1Dv() local_unnamed_addr #1 {
  ...
  %3 = getelementptr inbounds i8, i8 addrspace(4)* %2, i64 12
  %4 = bitcast i8 addrspace(4)* %3 to i32 addrspace(4)*
  %5 = load i32, i32 addrspace(4)* %4, align 4, !tbaa !5
  %6 = getelementptr i8, i8 addrspace(4)* %2, i64 4
  %7 = bitcast i8 addrspace(4)* %6 to i16 addrspace(4)*
  %8 = load i16, i16 addrspace(4)* %7, align 4, !range !14, !invariant.load !15
  %9 = zext i16 %8 to i32
  %10 = udiv i32 %5, %9
  %11 = getelementptr inbounds i8, i8 addrspace(4)* %2, i64 16
  %12 = bitcast i8 addrspace(4)* %11 to i32 addrspace(4)*
  %13 = load i32, i32 addrspace(4)* %12, align 8, !tbaa !16
  %14 = getelementptr i8, i8 addrspace(4)* %2, i64 6
  %15 = bitcast i8 addrspace(4)* %14 to i16 addrspace(4)*
  %16 = load i16, i16 addrspace(4)* %15, align 2, !range !14, !invariant.load !15
  ...
  %22 = load i64, i64 addrspace(4)* %21, align 8, !tbaa !17
  %23 = inttoptr i64 %22 to i8 addrspace(1)*
  %24 = addrspacecast i8 addrspace(1)* %23 to i8*
  %25 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %24, i64 noundef 33, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %26 = extractelement <2 x i64> %25, i64 0
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([44 x i8], [44 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %27, label %31

27:                                               ; preds = %0
  %28 = and i64 %26, -225
  %29 = or i64 %28, 32
  %30 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %24, i64 noundef %29, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  br label %472
...
90:                                               ; preds = %48, %90
  ...
  %95 = load i8, i8 addrspace(4)* %94, align 1, !tbaa !18
  ...
  br i1 %102, label %103, label %90, !llvm.loop !19
...
110:                                              ; preds = %103
  %111 = load i8, i8 addrspace(4)* %104, align 1, !tbaa !18
  %112 = zext i8 %111 to i64
  %113 = getelementptr inbounds i8, i8 addrspace(4)* %104, i64 1
  %114 = load i8, i8 addrspace(4)* %113, align 1, !tbaa !18
...
150:                                              ; preds = %108, %150
  ...
  %155 = load i8, i8 addrspace(4)* %154, align 1, !tbaa !18
...
170:                                              ; preds = %163
  %171 = load i8, i8 addrspace(4)* %164, align 1, !tbaa !18
  %172 = zext i8 %171 to i64
  %173 = getelementptr inbounds i8, i8 addrspace(4)* %164, i64 1
  %174 = load i8, i8 addrspace(4)* %173, align 1, !tbaa !18
...
210:                                              ; preds = %168, %210
  ...
  %215 = load i8, i8 addrspace(4)* %214, align 1, !tbaa !18
...
230:                                              ; preds = %223
  %231 = load i8, i8 addrspace(4)* %224, align 1, !tbaa !18
  %232 = zext i8 %231 to i64
  %233 = getelementptr inbounds i8, i8 addrspace(4)* %224, i64 1
  %234 = load i8, i8 addrspace(4)* %233, align 1, !tbaa !18
...
270:                                              ; preds = %228, %270
  ...
  %275 = load i8, i8 addrspace(4)* %274, align 1, !tbaa !18
...
290:                                              ; preds = %283
  %291 = load i8, i8 addrspace(4)* %284, align 1, !tbaa !18
  %292 = zext i8 %291 to i64
  %293 = getelementptr inbounds i8, i8 addrspace(4)* %284, i64 1
  %294 = load i8, i8 addrspace(4)* %293, align 1, !tbaa !18
...
330:                                              ; preds = %288, %330
  ...
  %335 = load i8, i8 addrspace(4)* %334, align 1, !tbaa !18
...
350:                                              ; preds = %343
  %351 = load i8, i8 addrspace(4)* %344, align 1, !tbaa !18
  %352 = zext i8 %351 to i64
  %353 = getelementptr inbounds i8, i8 addrspace(4)* %344, i64 1
  %354 = load i8, i8 addrspace(4)* %353, align 1, !tbaa !18
...
390:                                              ; preds = %348, %390
  ...
  %395 = load i8, i8 addrspace(4)* %394, align 1, !tbaa !18
...
410:                                              ; preds = %403
  %411 = load i8, i8 addrspace(4)* %404, align 1, !tbaa !18
  %412 = zext i8 %411 to i64
  %413 = getelementptr inbounds i8, i8 addrspace(4)* %404, i64 1
  %414 = load i8, i8 addrspace(4)* %413, align 1, !tbaa !18
...
461:                                              ; preds = %448, %410, %408
  ...
  %466 = and i64 %46, -225
  %467 = or i64 %466, %465
  %468 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %24, i64 noundef %467, i64 noundef %106, i64 noundef %166, i64 noundef %226, i64 noundef %286, i64 noundef %346, i64 noundef %406, i64 noundef %462) #10
  %469 = sub i64 %36, %44
...
472:                                              ; preds = %461, %27
  %473 = phi <2 x i64> [ %30, %27 ], [ %468, %461 ]
  %474 = mul i32 %18, %17
  %475 = icmp ugt i32 %13, %474
  %476 = zext i1 %475 to i32
  %477 = add i32 %18, %476
  %478 = tail call i32 @llvm.amdgcn.workgroup.id.z()
  %479 = mul i32 %477, %478
  %480 = tail call i32 @llvm.amdgcn.workgroup.id.y()
  %481 = add i32 %479, %480
  %482 = mul i32 %10, %9
  %483 = icmp ugt i32 %5, %482
  %484 = zext i1 %483 to i32
  %485 = add i32 %10, %484
  %486 = mul i32 %481, %485
  %487 = tail call i32 @llvm.amdgcn.workgroup.id.x()
  %488 = add i32 %486, %487
  %489 = mul i32 %488, %9
  %490 = add i32 %489, %1
  %491 = extractelement <2 x i64> %473, i64 0
  %492 = zext i32 %1 to i64
  %493 = and i64 %491, -225
  %494 = or i64 %493, 32
  %495 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %24, i64 noundef %494, i64 noundef %492, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %496 = extractelement <2 x i64> %495, i64 0
  %497 = zext i32 %490 to i64
  %498 = and i64 %496, -227
  %499 = or i64 %498, 34
  %500 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %24, i64 noundef %499, i64 noundef %497, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

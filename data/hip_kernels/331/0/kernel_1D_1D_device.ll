; ModuleID = '../data/hip_kernels/331/0/main.cu'
source_filename = "../data/hip_kernels/331/0/main.cu"
...
define protected amdgpu_kernel void @_Z12kernel_1D_1Dv() local_unnamed_addr #1 {
  ...
  %5 = load i16, i16 addrspace(4)* %4, align 4, !range !5, !invariant.load !6
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([44 x i8], [44 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %14, label %18
...
37:                                               ; preds = %22
  %38 = load i8, i8 addrspace(4)* %24, align 1, !tbaa !11
  %39 = zext i8 %38 to i64
  %40 = getelementptr inbounds i8, i8 addrspace(4)* %24, i64 1
  %41 = load i8, i8 addrspace(4)* %40, align 1, !tbaa !11
...
97:                                               ; preds = %90
  %98 = load i8, i8 addrspace(4)* %91, align 1, !tbaa !11
...
157:                                              ; preds = %150
  %158 = load i8, i8 addrspace(4)* %151, align 1, !tbaa !11
...
217:                                              ; preds = %210
  %218 = load i8, i8 addrspace(4)* %211, align 1, !tbaa !11
...
277:                                              ; preds = %270
  %278 = load i8, i8 addrspace(4)* %271, align 1, !tbaa !11
...
337:                                              ; preds = %330
  %338 = load i8, i8 addrspace(4)* %331, align 1, !tbaa !11
...
397:                                              ; preds = %390
  %398 = load i8, i8 addrspace(4)* %391, align 1, !tbaa !11
...
459:                                              ; preds = %448, %14
  ...
  %461 = tail call i32 @llvm.amdgcn.workgroup.id.x()
  %462 = zext i16 %5 to i32
  %463 = mul i32 %461, %462
  %464 = add i32 %463, %1
  %465 = extractelement <2 x i64> %460, i64 0
  %466 = zext i32 %1 to i64
  %467 = and i64 %465, -225
  %468 = or i64 %467, 32
  %469 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %11, i64 noundef %468, i64 noundef %466, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %470 = extractelement <2 x i64> %469, i64 0
  %471 = zext i32 %464 to i64
  %472 = and i64 %470, -227
  %473 = or i64 %472, 34
  %474 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %11, i64 noundef %473, i64 noundef %471, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

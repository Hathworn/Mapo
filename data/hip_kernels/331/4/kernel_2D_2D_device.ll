; ModuleID = '../data/hip_kernels/331/4/main.cu'
source_filename = "../data/hip_kernels/331/4/main.cu"
...
define protected amdgpu_kernel void @_Z12kernel_2D_2Dv() local_unnamed_addr #1 {
  ...
  %11 = udiv i32 %6, %10
  %12 = getelementptr i8, i8 addrspace(4)* %3, i64 6
  %13 = bitcast i8 addrspace(4)* %12 to i16 addrspace(4)*
  %14 = load i16, i16 addrspace(4)* %13, align 2, !range !14, !invariant.load !15
  ...
  %18 = load i64, i64 addrspace(4)* %17, align 8, !tbaa !16
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([50 x i8], [50 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %23, label %27
...
106:                                              ; preds = %99
  %107 = load i8, i8 addrspace(4)* %100, align 1, !tbaa !17
  ...
  %125 = load i8, i8 addrspace(4)* %124, align 1, !tbaa !17
...
166:                                              ; preds = %159
  %167 = load i8, i8 addrspace(4)* %160, align 1, !tbaa !17
  ...
  %185 = load i8, i8 addrspace(4)* %184, align 1, !tbaa !17
...
226:                                              ; preds = %219
  %227 = load i8, i8 addrspace(4)* %220, align 1, !tbaa !17
  ...
  %245 = load i8, i8 addrspace(4)* %244, align 1, !tbaa !17
...
286:                                              ; preds = %279
  %287 = load i8, i8 addrspace(4)* %280, align 1, !tbaa !17
  ...
  %305 = load i8, i8 addrspace(4)* %304, align 1, !tbaa !17
...
346:                                              ; preds = %339
  %347 = load i8, i8 addrspace(4)* %340, align 1, !tbaa !17
  ...
  %365 = load i8, i8 addrspace(4)* %364, align 1, !tbaa !17
...
406:                                              ; preds = %399
  %407 = load i8, i8 addrspace(4)* %400, align 1, !tbaa !17
  ...
  %425 = load i8, i8 addrspace(4)* %424, align 1, !tbaa !17
...
468:                                              ; preds = %457, %23
  ...
  %470 = mul i32 %11, %10
  %471 = icmp ugt i32 %6, %470
  %472 = zext i1 %471 to i32
  %473 = add i32 %11, %472
  %474 = tail call i32 @llvm.amdgcn.workgroup.id.y()
  %475 = mul i32 %473, %474
  %476 = tail call i32 @llvm.amdgcn.workgroup.id.x()
  %477 = add i32 %475, %476
  %478 = zext i16 %14 to i32
  %479 = mul i32 %477, %478
  %480 = add i32 %479, %2
  %481 = mul i32 %480, %10
  %482 = add i32 %481, %1
  %483 = extractelement <2 x i64> %469, i64 0
  %484 = zext i32 %1 to i64
  %485 = and i64 %483, -225
  %486 = or i64 %485, 32
  %487 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %20, i64 noundef %486, i64 noundef %484, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %488 = extractelement <2 x i64> %487, i64 0
  %489 = zext i32 %2 to i64
  %490 = and i64 %488, -225
  %491 = or i64 %490, 32
  %492 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %20, i64 noundef %491, i64 noundef %489, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %493 = extractelement <2 x i64> %492, i64 0
  %494 = zext i32 %482 to i64
  %495 = and i64 %493, -227
  %496 = or i64 %495, 34
  %497 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %20, i64 noundef %496, i64 noundef %494, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

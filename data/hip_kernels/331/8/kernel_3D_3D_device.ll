; ModuleID = '../data/hip_kernels/331/8/main.cu'
source_filename = "../data/hip_kernels/331/8/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [53 x i8] c"Local thread IDs: (%i,%i,%i)   Global thread ID: %i\0A\00", align 1
...
define protected amdgpu_kernel void @_Z12kernel_3D_3Dv() local_unnamed_addr #1 {
  ...
  %12 = udiv i32 %7, %11
  %13 = getelementptr inbounds i8, i8 addrspace(4)* %4, i64 16
  %14 = bitcast i8 addrspace(4)* %13 to i32 addrspace(4)*
  %15 = load i32, i32 addrspace(4)* %14, align 8, !tbaa !16
  %16 = getelementptr i8, i8 addrspace(4)* %4, i64 6
  %17 = bitcast i8 addrspace(4)* %16 to i16 addrspace(4)*
  %18 = load i16, i16 addrspace(4)* %17, align 2, !range !14, !invariant.load !15
  %19 = zext i16 %18 to i32
  %20 = udiv i32 %15, %19
  %21 = getelementptr i8, i8 addrspace(4)* %4, i64 8
  %22 = bitcast i8 addrspace(4)* %21 to i16 addrspace(4)*
  %23 = load i16, i16 addrspace(4)* %22, align 4, !range !14, !invariant.load !15
  ...
  %27 = load i64, i64 addrspace(4)* %26, align 8, !tbaa !17
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([53 x i8], [53 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %32, label %36
...
55:                                               ; preds = %40
  %56 = load i8, i8 addrspace(4)* %42, align 1, !tbaa !18
...
95:                                               ; preds = %53, %95
  ...
  %100 = load i8, i8 addrspace(4)* %99, align 1, !tbaa !18
...
115:                                              ; preds = %108
  %116 = load i8, i8 addrspace(4)* %109, align 1, !tbaa !18
...
155:                                              ; preds = %113, %155
  ...
  %160 = load i8, i8 addrspace(4)* %159, align 1, !tbaa !18
...
175:                                              ; preds = %168
  %176 = load i8, i8 addrspace(4)* %169, align 1, !tbaa !18
...
215:                                              ; preds = %173, %215
  ...
  %220 = load i8, i8 addrspace(4)* %219, align 1, !tbaa !18
...
235:                                              ; preds = %228
  %236 = load i8, i8 addrspace(4)* %229, align 1, !tbaa !18
...
275:                                              ; preds = %233, %275
  ...
  %280 = load i8, i8 addrspace(4)* %279, align 1, !tbaa !18
...
295:                                              ; preds = %288
  %296 = load i8, i8 addrspace(4)* %289, align 1, !tbaa !18
...
335:                                              ; preds = %293, %335
  ...
  %340 = load i8, i8 addrspace(4)* %339, align 1, !tbaa !18
...
355:                                              ; preds = %348
  %356 = load i8, i8 addrspace(4)* %349, align 1, !tbaa !18
...
395:                                              ; preds = %353, %395
  ...
  %400 = load i8, i8 addrspace(4)* %399, align 1, !tbaa !18
...
415:                                              ; preds = %408
  %416 = load i8, i8 addrspace(4)* %409, align 1, !tbaa !18
...
477:                                              ; preds = %466, %32
  ...
  %479 = mul i32 %20, %19
  %480 = icmp ugt i32 %15, %479
  %481 = zext i1 %480 to i32
  %482 = add i32 %20, %481
  %483 = tail call i32 @llvm.amdgcn.workgroup.id.z()
  %484 = mul i32 %482, %483
  %485 = tail call i32 @llvm.amdgcn.workgroup.id.y()
  %486 = add i32 %484, %485
  %487 = mul i32 %12, %11
  %488 = icmp ugt i32 %7, %487
  %489 = zext i1 %488 to i32
  %490 = add i32 %12, %489
  %491 = mul i32 %486, %490
  %492 = tail call i32 @llvm.amdgcn.workgroup.id.x()
  %493 = add i32 %491, %492
  %494 = zext i16 %23 to i32
  %495 = mul i32 %493, %494
  %496 = add i32 %495, %3
  %497 = mul i32 %496, %19
  %498 = add i32 %497, %2
  %499 = mul i32 %498, %11
  %500 = add i32 %499, %1
  %501 = extractelement <2 x i64> %478, i64 0
  %502 = zext i32 %1 to i64
  %503 = and i64 %501, -225
  %504 = or i64 %503, 32
  %505 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %29, i64 noundef %504, i64 noundef %502, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %506 = extractelement <2 x i64> %505, i64 0
  %507 = zext i32 %2 to i64
  %508 = and i64 %506, -225
  %509 = or i64 %508, 32
  %510 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %29, i64 noundef %509, i64 noundef %507, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %511 = extractelement <2 x i64> %510, i64 0
  %512 = zext i32 %3 to i64
  %513 = and i64 %511, -225
  %514 = or i64 %513, 32
  %515 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %29, i64 noundef %514, i64 noundef %512, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %516 = extractelement <2 x i64> %515, i64 0
  %517 = zext i32 %500 to i64
  %518 = and i64 %516, -227
  %519 = or i64 %518, 34
  %520 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %29, i64 noundef %519, i64 noundef %517, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

; ModuleID = '../data/hip_kernels/8897/20/main.cu'
source_filename = "../data/hip_kernels/8897/20/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ16sd_t_s1_1_kernelmmmmmmmmmmmmmmmPdS_mmS_E6t2_shm = internal unnamed_addr addrspace(3) global [1024 x double] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z16sd_t_s1_1_kernelmmmmmmmmmmmmmmmPdS_mmS_(i64 %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8, i64 %9, i64 %10, i64 %11, i64 %12, i64 %13, i64 %14, double addrspace(1)* nocapture readonly %15, double addrspace(1)* nocapture readonly %16, i64 %17, i64 %18, double addrspace(1)* nocapture %19) local_unnamed_addr #0 {
...
59:                                               ; preds = %25, %59
  ...
  %61 = getelementptr inbounds double, double addrspace(1)* %15, i64 %60
  %62 = load double, double addrspace(1)* %61, align 8, !tbaa !16, !amdgpu.noclobber !6
  %63 = trunc i64 %60 to i32
  %64 = getelementptr inbounds [1024 x double], [1024 x double] addrspace(3)* @_ZZ16sd_t_s1_1_kernelmmmmmmmmmmmmmmmPdS_mmS_E6t2_shm, i32 0, i32 %63
...
85:                                               ; preds = %68
  ...
  %89 = mul i64 %81, %9
  %90 = add i64 %88, %89
  %91 = getelementptr inbounds double, double addrspace(1)* %16, i64 %90
  %92 = mul i64 %76, %10
  %93 = mul i64 %80, %11
  %94 = add i64 %93, %92
  %95 = mul i64 %81, %13
...
103:                                              ; preds = %99, %103
  ...
  %108 = getelementptr inbounds [1024 x double], [1024 x double] addrspace(3)* @_ZZ16sd_t_s1_1_kernelmmmmmmmmmmmmmmmPdS_mmS_E6t2_shm, i32 0, i32 %107
  ...
  %112 = mul i64 %104, %14
  %113 = add i64 %102, %112
  %114 = getelementptr inbounds double, double addrspace(1)* %19, i64 %113
  %115 = load double, double addrspace(1)* %114, align 8, !tbaa !16
  %116 = fadd contract double %115, %111
  store double %116, double addrspace(1)* %114, align 8, !tbaa !16
  %117 = or i64 %104, 1
  %118 = add i64 %117, %100
  %119 = trunc i64 %118 to i32
  %120 = getelementptr inbounds [1024 x double], [1024 x double] addrspace(3)* @_ZZ16sd_t_s1_1_kernelmmmmmmmmmmmmmmmPdS_mmS_E6t2_shm, i32 0, i32 %119
  ...
  %124 = mul i64 %117, %14
  %125 = add i64 %102, %124
  %126 = getelementptr inbounds double, double addrspace(1)* %19, i64 %125
  %127 = load double, double addrspace(1)* %126, align 8, !tbaa !16
  %128 = fadd contract double %127, %123
  store double %128, double addrspace(1)* %126, align 8, !tbaa !16
  %129 = or i64 %104, 2
  %130 = add i64 %129, %100
  %131 = trunc i64 %130 to i32
  %132 = getelementptr inbounds [1024 x double], [1024 x double] addrspace(3)* @_ZZ16sd_t_s1_1_kernelmmmmmmmmmmmmmmmPdS_mmS_E6t2_shm, i32 0, i32 %131
  ...
  %136 = mul i64 %129, %14
  %137 = add i64 %102, %136
  %138 = getelementptr inbounds double, double addrspace(1)* %19, i64 %137
  %139 = load double, double addrspace(1)* %138, align 8, !tbaa !16
  %140 = fadd contract double %139, %135
  store double %140, double addrspace(1)* %138, align 8, !tbaa !16
  %141 = or i64 %104, 3
  %142 = add i64 %141, %100
  %143 = trunc i64 %142 to i32
  %144 = getelementptr inbounds [1024 x double], [1024 x double] addrspace(3)* @_ZZ16sd_t_s1_1_kernelmmmmmmmmmmmmmmmPdS_mmS_E6t2_shm, i32 0, i32 %143
  ...
  %148 = mul i64 %141, %14
  %149 = add i64 %102, %148
  %150 = getelementptr inbounds double, double addrspace(1)* %19, i64 %149
  %151 = load double, double addrspace(1)* %150, align 8, !tbaa !16
  %152 = fadd contract double %151, %147
...
158:                                              ; preds = %156, %158
  ...
  %163 = getelementptr inbounds [1024 x double], [1024 x double] addrspace(3)* @_ZZ16sd_t_s1_1_kernelmmmmmmmmmmmmmmmPdS_mmS_E6t2_shm, i32 0, i32 %162
  ...
  %167 = mul i64 %159, %14
  %168 = add i64 %102, %167
  %169 = getelementptr inbounds double, double addrspace(1)* %19, i64 %168
  %170 = load double, double addrspace(1)* %169, align 8, !tbaa !16
  %171 = fadd contract double %170, %166

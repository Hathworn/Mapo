; ModuleID = '../data/hip_kernels/8897/31/main.cu'
source_filename = "../data/hip_kernels/8897/31/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ16sd_t_s1_5_kerneliiiiiiiiiiiiiiiiiiPdS_S_iiE6t2_shm = internal unnamed_addr addrspace(3) global [512 x double] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z16sd_t_s1_5_kerneliiiiiiiiiiiiiiiiiiPdS_S_ii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 %10, i32 %11, i32 %12, i32 %13, i32 %14, i32 %15, i32 %16, i32 %17, double addrspace(1)* nocapture %18, double addrspace(1)* nocapture readonly %19, double addrspace(1)* nocapture readonly %20, i32 %21, i32 %22) local_unnamed_addr #0 {
...
59:                                               ; preds = %27, %59
  ...
  %64 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_5_kerneliiiiiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %60
...
112:                                              ; preds = %108, %112
  ...
  %116 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_5_kerneliiiiiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %115
  ...
  %125 = fadd contract double %124, %119
  store double %125, double addrspace(1)* %123, align 8, !tbaa !16
  %126 = or i32 %113, 1
  %127 = add nsw i32 %126, %109
  %128 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_5_kerneliiiiiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %127
  ...
  %137 = fadd contract double %136, %131
  store double %137, double addrspace(1)* %135, align 8, !tbaa !16
  %138 = or i32 %113, 2
  %139 = add nsw i32 %138, %109
  %140 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_5_kerneliiiiiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %139
  ...
  %149 = fadd contract double %148, %143
  store double %149, double addrspace(1)* %147, align 8, !tbaa !16
  %150 = or i32 %113, 3
  %151 = add nsw i32 %150, %109
  %152 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_5_kerneliiiiiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %151
  ...
  %161 = fadd contract double %160, %155
...
167:                                              ; preds = %165, %167
  ...
  %171 = getelementptr inbounds [512 x double], [512 x double] addrspace(3)* @_ZZ16sd_t_s1_5_kerneliiiiiiiiiiiiiiiiiiPdS_S_iiE6t2_shm, i32 0, i32 %170

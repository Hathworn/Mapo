; ModuleID = '../data/hip_kernels/8897/25/main.cu'
source_filename = "../data/hip_kernels/8897/25/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ16sd_t_s1_7_kernelmmmmmmmmmmmmmmmPdS_S_mmE6t2_shm = internal unnamed_addr addrspace(3) global [1024 x double] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z16sd_t_s1_7_kernelmmmmmmmmmmmmmmmPdS_S_mm(i64 %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8, i64 %9, i64 %10, i64 %11, i64 %12, i64 %13, i64 %14, double addrspace(1)* nocapture %15, double addrspace(1)* nocapture readonly %16, double addrspace(1)* nocapture readonly %17, i64 %18, i64 %19) local_unnamed_addr #0 {
...
59:                                               ; preds = %25, %59
  ...
  %64 = getelementptr inbounds [1024 x double], [1024 x double] addrspace(3)* @_ZZ16sd_t_s1_7_kernelmmmmmmmmmmmmmmmPdS_S_mmE6t2_shm, i32 0, i32 %63
...
103:                                              ; preds = %99, %103
  ...
  %108 = getelementptr inbounds [1024 x double], [1024 x double] addrspace(3)* @_ZZ16sd_t_s1_7_kernelmmmmmmmmmmmmmmmPdS_S_mmE6t2_shm, i32 0, i32 %107
  ...
  %120 = getelementptr inbounds [1024 x double], [1024 x double] addrspace(3)* @_ZZ16sd_t_s1_7_kernelmmmmmmmmmmmmmmmPdS_S_mmE6t2_shm, i32 0, i32 %119
  ...
  %132 = getelementptr inbounds [1024 x double], [1024 x double] addrspace(3)* @_ZZ16sd_t_s1_7_kernelmmmmmmmmmmmmmmmPdS_S_mmE6t2_shm, i32 0, i32 %131
  ...
  %144 = getelementptr inbounds [1024 x double], [1024 x double] addrspace(3)* @_ZZ16sd_t_s1_7_kernelmmmmmmmmmmmmmmmPdS_S_mmE6t2_shm, i32 0, i32 %143
...
158:                                              ; preds = %156, %158
  ...
  %163 = getelementptr inbounds [1024 x double], [1024 x double] addrspace(3)* @_ZZ16sd_t_s1_7_kernelmmmmmmmmmmmmmmmPdS_S_mmE6t2_shm, i32 0, i32 %162

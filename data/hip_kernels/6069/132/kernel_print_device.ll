; ModuleID = '../data/hip_kernels/6069/132/main.cu'
source_filename = "../data/hip_kernels/6069/132/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [9 x i8] c"int: %d \00", align 1
@.str.1 = private unnamed_addr addrspace(4) constant [4 x i8] c"%d \00", align 1
...
define protected amdgpu_kernel void @_Z12kernel_printPKii(i32 addrspace(1)* nocapture readonly %0, i32 %1) local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([9 x i8], [9 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %11, label %15
...
19:                                               ; preds = %445, %15
  %20 = phi i64 [ select (i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([9 x i8], [9 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), i64 0, i64 add (i64 ptrtoint (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([9 x i8], [9 x i8] addrspace(4)* @.str, i64 0, i64 8) to i8*) to i64), i64 add (i64 sub (i64 0, i64 ptrtoint ([9 x i8]* addrspacecast ([9 x i8] addrspace(4)* @.str to [9 x i8]*) to i64)), i64 1))), %15 ], [ %453, %445 ]
  %21 = phi i8 addrspace(4)* [ getelementptr inbounds ([9 x i8], [9 x i8] addrspace(4)* @.str, i64 0, i64 0), %15 ], [ %454, %445 ]
...
465:                                              ; preds = %456, %917
  %466 = phi i32 [ %924, %917 ], [ 0, %456 ]
  %467 = zext i32 %466 to i64
  %468 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %467
  %469 = load i32, i32 addrspace(1)* %468, align 4, !tbaa !11
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([4 x i8], [4 x i8] addrspace(4)* @.str.1, i64 0, i64 0) to i8*), i8* null), label %472, label %476
...
480:                                              ; preds = %906, %476
  %481 = phi i64 [ select (i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([4 x i8], [4 x i8] addrspace(4)* @.str.1, i64 0, i64 0) to i8*), i8* null), i64 0, i64 add (i64 ptrtoint (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([4 x i8], [4 x i8] addrspace(4)* @.str.1, i64 0, i64 3) to i8*) to i64), i64 add (i64 sub (i64 0, i64 ptrtoint ([4 x i8]* addrspacecast ([4 x i8] addrspace(4)* @.str.1 to [4 x i8]*) to i64)), i64 1))), %476 ], [ %914, %906 ]
  %482 = phi i8 addrspace(4)* [ getelementptr inbounds ([4 x i8], [4 x i8] addrspace(4)* @.str.1, i64 0, i64 0), %476 ], [ %915, %906 ]
...
917:                                              ; preds = %906, %472
  ...
  %920 = zext i32 %469 to i64
  %921 = and i64 %919, -227
  %922 = or i64 %921, 34
  %923 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %8, i64 noundef %922, i64 noundef %920, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %924 = add nuw nsw i32 %466, 1
  %925 = icmp eq i32 %924, %1
  br i1 %925, label %464, label %465, !llvm.loop !15
}

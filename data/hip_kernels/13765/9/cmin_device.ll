; ModuleID = '../data/hip_kernels/13765/9/main.cu'
source_filename = "../data/hip_kernels/13765/9/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@smin = external hidden local_unnamed_addr addrspace(3) global [0 x float], align 4

; Function Attrs: convergent mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z4cminPfS_i(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
  ...
  %20 = fcmp contract olt float %15, %19
  %21 = select contract i1 %20, float %15, float %19
  %22 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @smin, i32 0, i32 %4
...
26:                                               ; preds = %3
  ...
  %29 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @smin, i32 0, i32 %28
  %30 = load float, float addrspace(3)* %29, align 4, !tbaa !7
  %31 = fcmp contract ogt float %27, %30
...
37:                                               ; preds = %33
  ...
  %40 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @smin, i32 0, i32 %39
  %41 = load float, float addrspace(3)* %40, align 4, !tbaa !7
  %42 = fcmp contract ogt float %38, %41
...
48:                                               ; preds = %44
  ...
  %51 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @smin, i32 0, i32 %50
  %52 = load float, float addrspace(3)* %51, align 4, !tbaa !7
  %53 = fcmp contract ogt float %49, %52
...
59:                                               ; preds = %55
  ...
  %62 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @smin, i32 0, i32 %61
  %63 = load float, float addrspace(3)* %62, align 4, !tbaa !7
  %64 = fcmp contract ogt float %60, %63
...
70:                                               ; preds = %68
  ...
  %73 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @smin, i32 0, i32 %72
  %74 = load float, float addrspace(3)* %73, align 4, !tbaa !7
  %75 = fcmp contract ogt float %71, %74
...
79:                                               ; preds = %77
  ...
  %82 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @smin, i32 0, i32 %81
  %83 = load float, float addrspace(3)* %82, align 4, !tbaa !7
  %84 = fcmp contract ogt float %80, %83
...
88:                                               ; preds = %86
  ...
  %91 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @smin, i32 0, i32 %90
...
97:                                               ; preds = %95
  ...
  %100 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @smin, i32 0, i32 %99
  %101 = load float, float addrspace(3)* %100, align 4, !tbaa !7
  %102 = fcmp contract ogt float %98, %101
...
107:                                              ; preds = %104
  ...
  %109 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @smin, i32 0, i32 %108
  %110 = load float, float addrspace(3)* %109, align 4, !tbaa !7
  %111 = fcmp contract ogt float %106, %110
...
113:                                              ; preds = %104, %112, %107
  ...
  %116 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @smin, i32 0, i32 %115
  %117 = load float, float addrspace(3)* %116, align 4, !tbaa !7
  %118 = fcmp contract ogt float %114, %117
...
123:                                              ; preds = %121
  %124 = load float, float addrspace(3)* getelementptr inbounds ([0 x float], [0 x float] addrspace(3)* @smin, i32 0, i32 0), align 4, !tbaa !7

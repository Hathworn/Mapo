; ModuleID = '../data/hip_kernels/9452/14/main.cu'
source_filename = "../data/hip_kernels/9452/14/main.cu"
...
define protected amdgpu_kernel void @_Z15find_min_kernelPfPKf(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1) local_unnamed_addr #0 {
...
23:                                               ; preds = %19
  ...
  %28 = tail call float @llvm.minnum.f32(float %24, float %27)

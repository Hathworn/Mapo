; ModuleID = '../data/hip_kernels/9068/0/main.cu'
source_filename = "../data/hip_kernels/9068/0/main.cu"
...
define protected amdgpu_kernel void @_Z9addKernelPiPKiS1_(i32 addrspace(1)* nocapture writeonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture readonly %2) local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([4 x i8], [4 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %20, label %24

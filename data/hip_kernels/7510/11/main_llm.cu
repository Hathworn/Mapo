...
hipFree(0);
nesterovKernel<<<gridBlock, threadBlock>>>(numberIterations,parameterIndices,counts,dimension,parameters,gradient,learningRate,momentum,history,backup);

...
hipFree(0);
adagradKernel<<<gridBlock, threadBlock>>>(numberIterations,parameterIndices,counts,dimension,parameters,gradient,learningRate,history,epsilon);

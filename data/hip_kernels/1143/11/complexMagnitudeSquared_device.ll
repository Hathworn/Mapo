; ModuleID = '../data/hip_kernels/1143/11/main.cu'
source_filename = "../data/hip_kernels/1143/11/main.cu"
...
define protected amdgpu_kernel void @_Z23complexMagnitudeSquaredP15HIP_vector_typeIdLj2EEPd(%struct.HIP_vector_type addrspace(1)* nocapture readonly %0, double addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
  ...
  %56 = getelementptr inbounds double, double addrspace(1)* %1, i64 %48
  store double %55, double addrspace(1)* %56, align 8, !tbaa !20
  ret void
}

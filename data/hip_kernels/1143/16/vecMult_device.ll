; ModuleID = '../data/hip_kernels/1143/16/main.cu'
source_filename = "../data/hip_kernels/1143/16/main.cu"
...
define protected amdgpu_kernel void @_Z7vecMultP15HIP_vector_typeIdLj2EEPdS1_(%struct.HIP_vector_type addrspace(1)* nocapture readonly %0, double addrspace(1)* nocapture readonly %1, %struct.HIP_vector_type addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  ...
  %53 = load double, double addrspace(1)* %52, align 8, !tbaa !20, !amdgpu.noclobber !14
  %54 = fmul contract double %51, %53
  %55 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %0, i64 %49, i32 0, i32 0, i32 0, i64 1
  %56 = load double, double addrspace(1)* %55, align 8, !tbaa !17, !amdgpu.noclobber !14
  %57 = fmul contract double %53, %56
  %58 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %2, i64 %49, i32 0, i32 0, i32 0, i64 0
  store double %54, double addrspace(1)* %58, align 16
  %59 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %2, i64 %49, i32 0, i32 0, i32 0, i64 1
  store double %57, double addrspace(1)* %59, align 8
  ret void
}

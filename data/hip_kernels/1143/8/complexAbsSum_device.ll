; ModuleID = '../data/hip_kernels/1143/8/main.cu'
source_filename = "../data/hip_kernels/1143/8/main.cu"
...
define protected amdgpu_kernel void @_Z13complexAbsSumP15HIP_vector_typeIdLj2EES1_Pd(%struct.HIP_vector_type addrspace(1)* nocapture readonly %0, %struct.HIP_vector_type addrspace(1)* nocapture readonly %1, double addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  ...
  %57 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %1, i64 %49, i32 0, i32 0, i32 0, i64 1
  ...
  %85 = getelementptr inbounds double, double addrspace(1)* %2, i64 %49
  store double %84, double addrspace(1)* %85, align 8, !tbaa !20
  ret void
}

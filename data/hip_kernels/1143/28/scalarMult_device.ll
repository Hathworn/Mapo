; ModuleID = '../data/hip_kernels/1143/28/main.cu'
source_filename = "../data/hip_kernels/1143/28/main.cu"
...
define protected amdgpu_kernel void @_Z10scalarMultP15HIP_vector_typeIdLj2EEdS1_(%struct.HIP_vector_type addrspace(1)* nocapture readonly %0, double %1, %struct.HIP_vector_type addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  ...
  %55 = fmul contract double %54, %1
  %56 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %2, i64 %49, i32 0, i32 0, i32 0, i64 0
  store double %52, double addrspace(1)* %56, align 16
  %57 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %2, i64 %49, i32 0, i32 0, i32 0, i64 1
  store double %55, double addrspace(1)* %57, align 8
  ret void
}

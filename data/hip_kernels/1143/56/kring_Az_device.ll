; ModuleID = '../data/hip_kernels/1143/56/main.cu'
source_filename = "../data/hip_kernels/1143/56/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z8kring_AzPdS_S_ddddddddS_(double addrspace(1)* nocapture readonly %0, double addrspace(1)* nocapture readonly %1, double addrspace(1)* nocapture readnone %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double addrspace(1)* nocapture writeonly %11) local_unnamed_addr #0 {
  ...
  %95 = fmul contract double %3, 1.000000e-04
  %96 = fdiv contract double %94, %95
  %97 = fmul double %96, 0x3FF71547652B82FE
  %98 = tail call double @llvm.rint.f64(double %97)
  %99 = fneg double %98
  %100 = tail call double @llvm.fma.f64(double %99, double 0x3FE62E42FEFA39EF, double %96)
  %101 = tail call double @llvm.fma.f64(double %99, double 0x3C7ABC9E3B39803F, double %100)
  %102 = tail call double @llvm.fma.f64(double %101, double 0x3E5ADE156A5DCB37, double 0x3E928AF3FCA7AB0C)
  %103 = tail call double @llvm.fma.f64(double %101, double %102, double 0x3EC71DEE623FDE64)
  %104 = tail call double @llvm.fma.f64(double %101, double %103, double 0x3EFA01997C89E6B0)
  %105 = tail call double @llvm.fma.f64(double %101, double %104, double 0x3F2A01A014761F6E)
  %106 = tail call double @llvm.fma.f64(double %101, double %105, double 0x3F56C16C1852B7B0)
  %107 = tail call double @llvm.fma.f64(double %101, double %106, double 0x3F81111111122322)
  %108 = tail call double @llvm.fma.f64(double %101, double %107, double 0x3FA55555555502A1)
  %109 = tail call double @llvm.fma.f64(double %101, double %108, double 0x3FC5555555555511)
  %110 = tail call double @llvm.fma.f64(double %101, double %109, double 0x3FE000000000000B)
  %111 = tail call double @llvm.fma.f64(double %101, double %110, double 1.000000e+00)
  %112 = tail call double @llvm.fma.f64(double %101, double %111, double 1.000000e+00)
  %113 = fptosi double %98 to i32
  %114 = tail call double @llvm.amdgcn.ldexp.f64(double %112, i32 %113)
  %115 = fcmp ogt double %96, 1.024000e+03
  %116 = select i1 %115, double 0x7FF0000000000000, double %114
  %117 = fcmp olt double %96, -1.075000e+03
  %118 = select i1 %117, double 0.000000e+00, double %116
  %119 = fmul contract double %118, %9
  %120 = fmul contract double %119, 1.000000e-02
  %121 = sext i32 %59 to i64
  %122 = getelementptr inbounds double, double addrspace(1)* %11, i64 %121
  store double %120, double addrspace(1)* %122, align 8, !tbaa !17
  ret void
}

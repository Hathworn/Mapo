; ModuleID = '../data/hip_kernels/1143/26/main.cu'
source_filename = "../data/hip_kernels/1143/26/main.cu"
...
define protected amdgpu_kernel void @_Z9scalarDivP15HIP_vector_typeIdLj2EEdS1_(%struct.HIP_vector_type addrspace(1)* nocapture readonly %0, double %1, %struct.HIP_vector_type addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {

; ModuleID = '../data/hip_kernels/1143/51/main.cu'
source_filename = "../data/hip_kernels/1143/51/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z12krotation_AxPdS_S_ddddddddS_(double addrspace(1)* nocapture readnone %0, double addrspace(1)* nocapture readonly %1, double addrspace(1)* nocapture readnone %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double addrspace(1)* nocapture writeonly %11) local_unnamed_addr #0 {
  ...
  %44 = add i32 %43, %13
  %45 = mul i32 %14, %34
  %46 = getelementptr i8, i8 addrspace(4)* %15, i64 8
  %47 = bitcast i8 addrspace(4)* %46 to i16 addrspace(4)*
  %48 = load i16, i16 addrspace(4)* %47, align 4, !range !13, !invariant.load !14
  %49 = zext i16 %48 to i32
  %50 = mul i32 %44, %49
  %51 = tail call i32 @llvm.amdgcn.workitem.id.y(), !range !16
  %52 = tail call i32 @llvm.amdgcn.workitem.id.z(), !range !16
  %53 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !16
  %54 = add i32 %50, %52
  %55 = mul i32 %54, %34
  %56 = add i32 %55, %51
  %57 = mul i32 %56, %22
  ...
  %63 = fneg contract double %62
  %64 = fmul contract double %63, %9
  %65 = fmul contract double %64, %6
  %66 = sext i32 %58 to i64
  %67 = getelementptr inbounds double, double addrspace(1)* %11, i64 %66
  store double %65, double addrspace(1)* %67, align 8, !tbaa !17
  ret void
}

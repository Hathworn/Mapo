; ModuleID = '../data/hip_kernels/1143/6/main.cu'
source_filename = "../data/hip_kernels/1143/6/main.cu"
...
define protected amdgpu_kernel void @_Z11energy_lsumPdP15HIP_vector_typeIdLj2EES_(double addrspace(1)* nocapture readonly %0, %struct.HIP_vector_type addrspace(1)* nocapture readonly %1, double addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  ...
  %53 = load double, double addrspace(1)* %52, align 16, !tbaa !21, !amdgpu.noclobber !14

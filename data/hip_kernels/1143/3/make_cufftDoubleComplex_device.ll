; ModuleID = '../data/hip_kernels/1143/3/main.cu'
source_filename = "../data/hip_kernels/1143/3/main.cu"
...
define protected amdgpu_kernel void @_Z23make_cufftDoubleComplexPdP15HIP_vector_typeIdLj2EE(double addrspace(1)* nocapture readonly %0, %struct.HIP_vector_type addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
  ...
  %51 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %1, i64 %48, i32 0, i32 0, i32 0, i64 0
  store double %50, double addrspace(1)* %51, align 16, !tbaa !21
  %52 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %1, i64 %48, i32 0, i32 0, i32 0, i64 1
  store double 0.000000e+00, double addrspace(1)* %52, align 8, !tbaa !21
  ret void
}

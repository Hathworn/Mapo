; ModuleID = '../data/hip_kernels/1143/2/main.cu'
source_filename = "../data/hip_kernels/1143/2/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z5is_eqPbS_S_(i8 addrspace(1)* nocapture readonly %0, i8 addrspace(1)* nocapture readonly %1, i8 addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  ...
  %47 = mul i32 %46, %13
  %48 = add i32 %47, %43
  store i8 1, i8 addrspace(1)* %2, align 1, !tbaa !17
  %49 = sext i32 %48 to i64
  %50 = getelementptr inbounds i8, i8 addrspace(1)* %0, i64 %49
  %51 = load i8, i8 addrspace(1)* %50, align 1, !tbaa !17, !range !21
  %52 = getelementptr inbounds i8, i8 addrspace(1)* %1, i64 %49
  %53 = load i8, i8 addrspace(1)* %52, align 1, !tbaa !17, !range !21
  %54 = icmp eq i8 %51, %53
  %55 = zext i1 %54 to i8
  store i8 %55, i8 addrspace(1)* %2, align 1
  ret void
}

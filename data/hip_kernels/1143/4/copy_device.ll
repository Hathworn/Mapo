; ModuleID = '../data/hip_kernels/1143/4/main.cu'
source_filename = "../data/hip_kernels/1143/4/main.cu"
...
define protected amdgpu_kernel void @_Z4copyP15HIP_vector_typeIdLj2EES1_(%struct.HIP_vector_type addrspace(1)* nocapture readonly %0, %struct.HIP_vector_type addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
  ...
  %49 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %0, i64 %48
  %50 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %1, i64 %48

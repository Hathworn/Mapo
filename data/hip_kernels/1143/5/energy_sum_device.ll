; ModuleID = '../data/hip_kernels/1143/5/main.cu'
source_filename = "../data/hip_kernels/1143/5/main.cu"
...
define protected amdgpu_kernel void @_Z10energy_sumP15HIP_vector_typeIdLj2EES1_Pd(%struct.HIP_vector_type addrspace(1)* nocapture readonly %0, %struct.HIP_vector_type addrspace(1)* nocapture readonly %1, double addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  ...
  store double %54, double addrspace(1)* %55, align 8, !tbaa !20
  ret void
}

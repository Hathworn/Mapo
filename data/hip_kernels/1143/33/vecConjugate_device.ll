; ModuleID = '../data/hip_kernels/1143/33/main.cu'
source_filename = "../data/hip_kernels/1143/33/main.cu"
...
define protected amdgpu_kernel void @_Z12vecConjugateP15HIP_vector_typeIdLj2EES1_(%struct.HIP_vector_type addrspace(1)* nocapture readonly %0, %struct.HIP_vector_type addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
  ...
  %51 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %0, i64 %48, i32 0, i32 0, i32 0, i64 1
  %52 = load double, double addrspace(1)* %51, align 8, !tbaa !17, !amdgpu.noclobber !14
  %53 = fneg contract double %52
  %54 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %1, i64 %48, i32 0, i32 0, i32 0, i64 0
  store double %50, double addrspace(1)* %54, align 16
  %55 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %1, i64 %48, i32 0, i32 0, i32 0, i64 1
  store double %53, double addrspace(1)* %55, align 8
  ret void
}

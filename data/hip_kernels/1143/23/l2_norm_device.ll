; ModuleID = '../data/hip_kernels/1143/23/main.cu'
source_filename = "../data/hip_kernels/1143/23/main.cu"
...
define protected amdgpu_kernel void @_Z7l2_normP15HIP_vector_typeIdLj2EES1_Pd(%struct.HIP_vector_type addrspace(1)* nocapture readonly %0, %struct.HIP_vector_type addrspace(1)* nocapture readonly %1, double addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  ...
  %53 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %0, i64 %49, i32 0, i32 0, i32 0, i64 1
  ...
  %57 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %1, i64 %49, i32 0, i32 0, i32 0, i64 0
  ...
  %61 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %1, i64 %49, i32 0, i32 0, i32 0, i64 1
  %62 = load double, double addrspace(1)* %61, align 8, !tbaa !17, !amdgpu.noclobber !14
  %63 = fmul contract double %62, %62
  %64 = fadd contract double %60, %63
  %65 = fcmp olt double %64, 0x1000000000000000
  ...
  %87 = getelementptr inbounds double, double addrspace(1)* %2, i64 %49
  store double %86, double addrspace(1)* %87, align 8, !tbaa !20
  ret void
}

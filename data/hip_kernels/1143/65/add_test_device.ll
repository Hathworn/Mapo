; ModuleID = '../data/hip_kernels/1143/65/main.cu'
source_filename = "../data/hip_kernels/1143/65/main.cu"
...
define protected amdgpu_kernel void @_Z8add_testP15HIP_vector_typeIdLj2EES1_S1_(%struct.HIP_vector_type addrspace(1)* nocapture readonly %0, %struct.HIP_vector_type addrspace(1)* nocapture readonly %1, %struct.HIP_vector_type addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {

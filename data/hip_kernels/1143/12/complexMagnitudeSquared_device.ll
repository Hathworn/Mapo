; ModuleID = '../data/hip_kernels/1143/12/main.cu'
source_filename = "../data/hip_kernels/1143/12/main.cu"
...
define protected amdgpu_kernel void @_Z23complexMagnitudeSquaredP15HIP_vector_typeIdLj2EES1_(%struct.HIP_vector_type addrspace(1)* nocapture readonly %0, %struct.HIP_vector_type addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
  ...
  %56 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %1, i64 %48, i32 0, i32 0, i32 0, i64 0
  store double %55, double addrspace(1)* %56, align 16, !tbaa !17
  %57 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %1, i64 %48, i32 0, i32 0, i32 0, i64 1

; ModuleID = '../data/hip_kernels/1143/52/main.cu'
source_filename = "../data/hip_kernels/1143/52/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z12krotation_AyPdS_S_ddddddddS_(double addrspace(1)* nocapture readonly %0, double addrspace(1)* nocapture readnone %1, double addrspace(1)* nocapture readnone %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double addrspace(1)* nocapture writeonly %11) local_unnamed_addr #0 {
  ...
  %63 = fmul contract double %62, %9
  %64 = fmul contract double %63, %7
  %65 = sext i32 %58 to i64
  %66 = getelementptr inbounds double, double addrspace(1)* %11, i64 %65
  store double %64, double addrspace(1)* %66, align 8, !tbaa !17
  ret void
}

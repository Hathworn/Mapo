; ModuleID = '../data/hip_kernels/1143/50/main.cu'
source_filename = "../data/hip_kernels/1143/50/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn writeonly
define protected amdgpu_kernel void @_Z11kconstant_APdS_S_ddddddddS_(double addrspace(1)* nocapture readnone %0, double addrspace(1)* nocapture readnone %1, double addrspace(1)* nocapture readnone %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double addrspace(1)* nocapture writeonly %11) local_unnamed_addr #0 {
  ...
  %43 = mul i32 %42, %27
  %44 = add i32 %43, %13
  %45 = getelementptr i8, i8 addrspace(4)* %15, i64 8
  %46 = bitcast i8 addrspace(4)* %45 to i16 addrspace(4)*
  %47 = load i16, i16 addrspace(4)* %46, align 4, !range !13, !invariant.load !14
  %48 = zext i16 %47 to i32
  %49 = mul i32 %44, %48
  %50 = tail call i32 @llvm.amdgcn.workitem.id.y(), !range !16
  %51 = tail call i32 @llvm.amdgcn.workitem.id.z(), !range !16
  %52 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !16
  %53 = add i32 %49, %51
  %54 = mul i32 %53, %34
  %55 = add i32 %54, %50
  %56 = mul i32 %55, %22
  ...
  %59 = getelementptr inbounds double, double addrspace(1)* %11, i64 %58
  store double 0.000000e+00, double addrspace(1)* %59, align 8, !tbaa !17
  ret void
}

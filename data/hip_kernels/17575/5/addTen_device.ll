; ModuleID = '../data/hip_kernels/17575/5/main.cu'
source_filename = "../data/hip_kernels/17575/5/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z6addTenPfi(float addrspace(1)* nocapture %0, i32 %1) local_unnamed_addr #0 {
  ...
  %17 = getelementptr inbounds i8, i8 addrspace(4)* %3, i64 16
  ...
  %21 = getelementptr i8, i8 addrspace(4)* %3, i64 8
  %22 = bitcast i8 addrspace(4)* %21 to i16 addrspace(4)*
  %23 = load i16, i16 addrspace(4)* %22, align 4, !range !4, !invariant.load !5
  %24 = zext i16 %23 to i32
  %25 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !16
  %26 = tail call i32 @llvm.amdgcn.workitem.id.y(), !range !16
  %27 = tail call i32 @llvm.amdgcn.workitem.id.z(), !range !16
  %28 = udiv i32 %11, %8
  %29 = mul i32 %28, %8
  %30 = icmp ugt i32 %11, %29
...
49:                                               ; preds = %2
  ...
  %52 = load float, float addrspace(1)* %51, align 4, !tbaa !17, !amdgpu.noclobber !5
  %53 = fadd contract float %52, 1.000000e+01
  store float %53, float addrspace(1)* %51, align 4, !tbaa !17
  br label %54

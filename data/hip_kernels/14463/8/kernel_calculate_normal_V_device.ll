; ModuleID = '../data/hip_kernels/14463/8/main.cu'
source_filename = "../data/hip_kernels/14463/8/main.cu"
...
@d_dx = protected addrspace(4) externally_initialized global float 0.000000e+00, align 4
...
@llvm.compiler.used = appending addrspace(1) global [3 x i8*] [i8* addrspacecast (i8 addrspace(4)* bitcast (i32 addrspace(4)* @d_L to i8 addrspace(4)*) to i8*), i8* addrspacecast (i8 addrspace(4)* bitcast (float addrspace(4)* @d_dx to i8 addrspace(4)*) to i8*), i8* addrspacecast (i8 addrspace(4)* bitcast (float addrspace(4)* @d_scaling to i8 addrspace(4)*) to i8*)], section "llvm.metadata"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z25kernel_calculate_normal_VP15HIP_vector_typeIfLj3EEPf(%struct.HIP_vector_type addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1) local_unnamed_addr #0 {
...
24:                                               ; preds = %2
  ...
  %28 = add i32 %27, %19
  %29 = urem i32 %28, %20
  %30 = load float, float addrspace(4)* @d_scaling, align 4, !tbaa !11
  %31 = mul i32 %11, %20
  %32 = add i32 %31, %19
  ...
  %38 = load float, float addrspace(4)* @d_dx, align 4, !tbaa !11
  %39 = mul i32 %26, %20
  %40 = add i32 %39, %19
  ...
  %52 = fmul contract float %30, %51
  %53 = fsub contract float %52, %37
  %54 = fneg contract float %38
  %55 = fmul contract float %46, %54
  %56 = fmul contract float %38, %38
  %57 = fmul contract float %38, %53
  ...
  %84 = fdiv contract float %55, %83
  %85 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %0, i64 %33, i32 0, i32 0, i32 0, i32 0, i64 0
  store float %84, float addrspace(1)* %85, align 4, !tbaa !13
  %86 = fdiv contract float %56, %83
  %87 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %0, i64 %33, i32 0, i32 0, i32 0, i32 0, i64 1
  store float %86, float addrspace(1)* %87, align 4, !tbaa !13
  %88 = fdiv contract float %57, %83
  %89 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %0, i64 %33, i32 0, i32 0, i32 0, i32 0, i64 2
  store float %88, float addrspace(1)* %89, align 4, !tbaa !13
  br label %90

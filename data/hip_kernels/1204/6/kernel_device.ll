; ModuleID = '../data/hip_kernels/1204/6/main.cu'
source_filename = "../data/hip_kernels/1204/6/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [20 x i8] c"### Array size: %d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z6kernelPfi(float addrspace(1)* nocapture %0, i32 %1) local_unnamed_addr #1 {
...
13:                                               ; preds = %2
  ...
  store float %17, float addrspace(1)* %15, align 4, !tbaa !7
  %18 = icmp eq i32 %11, 0
...
19:                                               ; preds = %13
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([20 x i8], [20 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %28, label %32

; ModuleID = '../data/hip_kernels/1204/4/main.cu'
source_filename = "../data/hip_kernels/1204/4/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z7kernelCiPfS_(i32 %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture %2) local_unnamed_addr #0 {
...
32:                                               ; preds = %23, %117
  ...
  %39 = fcmp contract ule float %36, %38
  %40 = select i1 %39, i1 true, i1 %25
  br i1 %40, label %117, label %41

41:                                               ; preds = %32
  br i1 %28, label %103, label %42
...
42:                                               ; preds = %41, %42
  ...
  br i1 %102, label %103, label %42, !llvm.loop !20

103:                                              ; preds = %42, %41
  %104 = phi i32 [ 0, %41 ], [ %100, %42 ]
  br i1 %30, label %117, label %105

105:                                              ; preds = %103, %105
  %106 = phi i32 [ %114, %105 ], [ %104, %103 ]
  %107 = phi i32 [ %115, %105 ], [ 0, %103 ]
  %108 = zext i32 %106 to i64
  %109 = getelementptr inbounds float, float addrspace(1)* %1, i64 %108
  %110 = load float, float addrspace(1)* %109, align 4, !tbaa !16
  %111 = getelementptr inbounds float, float addrspace(1)* %2, i64 %108
  %112 = load float, float addrspace(1)* %111, align 4, !tbaa !16
  %113 = fadd contract float %110, %112
  store float %113, float addrspace(1)* %37, align 4, !tbaa !16
  %114 = add nuw nsw i32 %106, 1
  %115 = add i32 %107, 1
  %116 = icmp eq i32 %115, %27
  br i1 %116, label %117, label %105, !llvm.loop !22

117:                                              ; preds = %103, %105, %32
  %118 = add nsw i32 %33, %21
  %119 = icmp slt i32 %118, %0
  br i1 %119, label %32, label %31, !llvm.loop !24
}

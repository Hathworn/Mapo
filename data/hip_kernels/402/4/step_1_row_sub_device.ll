; ModuleID = '../data/hip_kernels/402/4/main.cu'
source_filename = "../data/hip_kernels/402/4/main.cu"
...
@min_in_rows = protected addrspace(1) externally_initialized global [1024 x i32] zeroinitializer, align 16
...
@zeros_size_b = protected local_unnamed_addr addrspace(1) externally_initialized global [2 x i32] zeroinitializer, align 4
...
define protected amdgpu_kernel void @_Z14step_1_row_subv() local_unnamed_addr #0 {
  ...
  %15 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(1)* @min_in_rows, i64 0, i64 %14

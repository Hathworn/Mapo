; ModuleID = '../data/hip_kernels/13637/56/main.cu'
source_filename = "../data/hip_kernels/13637/56/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ16kSetSelectedRowsPfS_S_iiiE16targetRowIndices = internal unnamed_addr addrspace(3) global [32 x i32] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z16kSetSelectedRowsPfS_S_iii(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, i32 %3, i32 %4, i32 %5) local_unnamed_addr #0 {
...
13:                                               ; preds = %6
  ...
  %19 = getelementptr inbounds [32 x i32], [32 x i32] addrspace(3)* @_ZZ16kSetSelectedRowsPfS_S_iiiE16targetRowIndices, i32 0, i32 %9
...
33:                                               ; preds = %29, %42
  ...
  %35 = getelementptr inbounds [32 x i32], [32 x i32] addrspace(3)* @_ZZ16kSetSelectedRowsPfS_S_iiiE16targetRowIndices, i32 0, i32 %34

; ModuleID = '../data/hip_kernels/8438/110/main.cu'
source_filename = "../data/hip_kernels/8438/110/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z22elementwise_1D_1D_sqrtPfS_i(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
23:                                               ; preds = %3, %23
  ...
  %49 = getelementptr inbounds float, float addrspace(1)* %1, i64 %25
  store float %48, float addrspace(1)* %49, align 4, !tbaa !16
  %50 = add nsw i32 %24, %21
  %51 = icmp slt i32 %50, %2
  br i1 %51, label %23, label %52, !llvm.loop !20

; ModuleID = '../data/hip_kernels/13520/5/main.cu'
source_filename = "../data/hip_kernels/13520/5/main.cu"
...
define protected amdgpu_kernel void @_Z9SomatorioPfS_l(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i64 %2) local_unnamed_addr #0 {

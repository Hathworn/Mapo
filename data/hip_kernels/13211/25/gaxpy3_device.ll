; ModuleID = '../data/hip_kernels/13211/25/main.cu'
source_filename = "../data/hip_kernels/13211/25/main.cu"
...
define protected amdgpu_kernel void @_Z6gaxpy3iPKdS0_Pd(i32 %0, double addrspace(1)* nocapture readonly %1, double addrspace(1)* nocapture readonly %2, double addrspace(1)* nocapture %3) local_unnamed_addr #1 {
...
22:                                               ; preds = %4
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([4 x i8], [4 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %31, label %35
...
476:                                              ; preds = %465, %31
  ...
  %483 = load double, double addrspace(1)* %1, align 8, !tbaa !14
  %484 = getelementptr inbounds double, double addrspace(1)* %2, i64 %479
  %485 = load double, double addrspace(1)* %484, align 8, !tbaa !14
  %486 = fmul contract double %483, %485
  %487 = getelementptr inbounds double, double addrspace(1)* %3, i64 %479
  %488 = load double, double addrspace(1)* %487, align 8, !tbaa !14
  %489 = fadd contract double %486, %488
  store double %489, double addrspace(1)* %487, align 8, !tbaa !14
  br label %490

...
#include "BFS_kernel_SM_block_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
BFS_kernel_SM_block<<<gridBlock, threadBlock>>>(frontier,frontier2,frontier_len,cost,visited,edgeArray,edgeArrayAux,numVertices,numEdges,frontier_length,num_p_per_mp,w_q_size);

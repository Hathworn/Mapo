...
hipFree(0);
BFS_kernel_multi_block_spill<<<gridBlock, threadBlock>>>(frontier,frontier2,frontier_len,cost,visited,edgeArray,edgeArrayAux,numVertices,numEdges,frontier_length,max_mem);

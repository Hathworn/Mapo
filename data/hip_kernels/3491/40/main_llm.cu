...
#include "BFS_kernel_one_block_spill_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
BFS_kernel_one_block_spill<<<gridBlock, threadBlock>>>(frontier,frontier_len,cost,visited,edgeArray,edgeArrayAux,numVertices,numEdges,frontier_length,max_local_mem);

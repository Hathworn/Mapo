; ModuleID = '../data/hip_kernels/4489/75/main.cu'
source_filename = "../data/hip_kernels/4489/75/main.cu"
...
define protected amdgpu_kernel void @_Z10index_initPiii(i32 addrspace(1)* nocapture writeonly %0, i32 %1, i32 %2) local_unnamed_addr #0 {
...
26:                                               ; preds = %18, %26
  %27 = phi i32 [ %15, %18 ], [ %31, %26 ]
  %28 = srem i32 %27, %2
  %29 = sext i32 %27 to i64
  %30 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %29
  store i32 %28, i32 addrspace(1)* %30, align 4, !tbaa !16
  %31 = add i32 %24, %27

; ModuleID = '../data/hip_kernels/121/137/main.cu'
source_filename = "../data/hip_kernels/121/137/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z15kSoftMaxGradCLSPfPiS_S_jj(float addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture writeonly %3, i32 %4, i32 %5) local_unnamed_addr #0 {
...
28:                                               ; preds = %6, %28
  ...
  %44 = load i32, i32 addrspace(1)* %43, align 4, !tbaa !20, !amdgpu.noclobber !5
  %45 = icmp eq i32 %44, %35
  %46 = uitofp i1 %45 to float
  %47 = fsub contract float %32, %46
  %48 = getelementptr inbounds float, float addrspace(1)* %3, i64 %30
  store float %47, float addrspace(1)* %48, align 4, !tbaa !16
  %49 = add i32 %29, %24
  %50 = icmp ult i32 %49, %25
  br i1 %50, label %28, label %27, !llvm.loop !22
}

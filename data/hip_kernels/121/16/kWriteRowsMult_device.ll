; ModuleID = '../data/hip_kernels/121/16/main.cu'
source_filename = "../data/hip_kernels/121/16/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z14kWriteRowsMultPfS_iiiiff(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture %1, i32 %2, i32 %3, i32 %4, i32 %5, float %6, float %7) local_unnamed_addr #0 {
...
31:                                               ; preds = %24, %31
  %32 = phi i32 [ %22, %24 ], [ %41, %31 ]
  %33 = sext i32 %32 to i64
  %34 = getelementptr inbounds float, float addrspace(1)* %21, i64 %33
  %35 = load float, float addrspace(1)* %34, align 4, !tbaa !7
  %36 = fmul contract float %35, %6
  %37 = getelementptr inbounds float, float addrspace(1)* %15, i64 %33
  %38 = load float, float addrspace(1)* %37, align 4, !tbaa !7
  %39 = fmul contract float %38, %7
  %40 = fadd contract float %36, %39
  store float %40, float addrspace(1)* %34, align 4, !tbaa !7
  %41 = add i32 %32, %29
  %42 = icmp slt i32 %41, %2
  br i1 %42, label %31, label %30, !llvm.loop !11
}

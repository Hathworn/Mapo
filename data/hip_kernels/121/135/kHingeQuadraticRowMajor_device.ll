; ModuleID = '../data/hip_kernels/121/135/main.cu'
source_filename = "../data/hip_kernels/121/135/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z23kHingeQuadraticRowMajorPfS_S_jjf(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2, i32 %3, i32 %4, float %5) local_unnamed_addr #0 {
...
39:                                               ; preds = %34, %39
  ...
  %50 = select contract i1 %49, float %48, float 0.000000e+00
...
62:                                               ; preds = %62, %32
  ...
  %73 = select contract i1 %72, float %71, float 0.000000e+00
  ...
  %86 = select contract i1 %85, float %84, float 0.000000e+00
  ...
  %99 = select contract i1 %98, float %97, float 0.000000e+00
  ...
  %112 = select contract i1 %111, float %110, float 0.000000e+00
  ...
  %125 = select contract i1 %124, float %123, float 0.000000e+00
  ...
  %138 = select contract i1 %137, float %136, float 0.000000e+00
  ...
  %151 = select contract i1 %150, float %149, float 0.000000e+00
  ...
  %164 = select contract i1 %163, float %162, float 0.000000e+00

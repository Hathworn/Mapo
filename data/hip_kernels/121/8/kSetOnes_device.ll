; ModuleID = '../data/hip_kernels/121/8/main.cu'
source_filename = "../data/hip_kernels/121/8/main.cu"
...
define protected amdgpu_kernel void @_Z8kSetOnesPfi(float addrspace(1)* nocapture writeonly %0, i32 %1) local_unnamed_addr #0 {
...
12:                                               ; preds = %5, %12
  ...
  br i1 %17, label %12, label %11, !llvm.loop !11
}

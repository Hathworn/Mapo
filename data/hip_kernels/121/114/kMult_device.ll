; ModuleID = '../data/hip_kernels/121/114/main.cu'
source_filename = "../data/hip_kernels/121/114/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z5kMultPfS_S_jf(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture %2, i32 %3, float %4) local_unnamed_addr #0 {
...
26:                                               ; preds = %5
  br i1 %25, label %39, label %53

27:                                               ; preds = %5
  br i1 %25, label %28, label %53

28:                                               ; preds = %27, %28
  %29 = phi i32 [ %37, %28 ], [ %17, %27 ]
  ...
  br i1 %38, label %28, label %53, !llvm.loop !20

39:                                               ; preds = %26, %39
  %40 = phi i32 [ %51, %39 ], [ %17, %26 ]

; ModuleID = '../data/hip_kernels/121/6/main.cu'
source_filename = "../data/hip_kernels/121/6/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z7kExpandPfS_iiiiiiiiiiiiii(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 %10, i32 %11, i32 %12, i32 %13, i32 %14, i32 %15) local_unnamed_addr #0 {
...
80:                                               ; preds = %77, %80
  %81 = phi i32 [ %45, %77 ], [ %85, %80 ]
  %82 = sext i32 %81 to i64
  %83 = add nsw i64 %82, %67
  %84 = getelementptr inbounds float, float addrspace(1)* %40, i64 %83
  store float 0.000000e+00, float addrspace(1)* %84, align 4, !tbaa !8
  %85 = add i32 %81, %79
  %86 = icmp slt i32 %85, %2
  br i1 %86, label %80, label %101, !llvm.loop !12

87:                                               ; preds = %72
  br i1 %46, label %88, label %101

88:                                               ; preds = %87
  %89 = load i16, i16 addrspace(4)* %49, align 4, !range !6, !invariant.load !7
  %90 = zext i16 %89 to i32
  br label %91

91:                                               ; preds = %88, %91
  %92 = phi i32 [ %45, %88 ], [ %99, %91 ]
  %93 = sext i32 %92 to i64
  %94 = add nsw i64 %93, %70
  %95 = getelementptr inbounds float, float addrspace(1)* %33, i64 %94
  %96 = load float, float addrspace(1)* %95, align 4, !tbaa !8
  %97 = add nsw i64 %93, %67
  %98 = getelementptr inbounds float, float addrspace(1)* %40, i64 %97
  store float %96, float addrspace(1)* %98, align 4, !tbaa !8
  %99 = add i32 %92, %90
  %100 = icmp slt i32 %99, %2
  br i1 %100, label %91, label %101, !llvm.loop !13

101:                                              ; preds = %91, %80, %87, %76
  fence syncscope("workgroup") release
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %102 = add nuw nsw i32 %63, 1
  %103 = icmp eq i32 %102, %9
  br i1 %103, label %59, label %62, !llvm.loop !14
}

; ModuleID = '../data/hip_kernels/121/167/main.cu'
source_filename = "../data/hip_kernels/121/167/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z8kAdagradPfS_fi(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture readonly %1, float %2, i32 %3) local_unnamed_addr #0 {
...
25:                                               ; preds = %4, %25
  ...
  %57 = fadd contract float %56, %2
  store float %57, float addrspace(1)* %28, align 4, !tbaa !16
  %58 = add i32 %26, %22
  %59 = icmp ult i32 %58, %3
  br i1 %59, label %25, label %24, !llvm.loop !20
}

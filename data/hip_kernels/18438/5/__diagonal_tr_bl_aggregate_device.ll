; ModuleID = '../data/hip_kernels/18438/5/main.cu'
source_filename = "../data/hip_kernels/18438/5/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z26__diagonal_tr_bl_aggregatePfS_ii(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3) local_unnamed_addr #0 {
  %5 = add nsw i32 %3, -2
...
25:                                               ; preds = %20, %25
  ...
  %1203 = icmp slt i32 %27, 1
  %1204 = select i1 %1203, i32 %5, i32 %1202
  %1205 = add nuw nsw i32 %26, 1
  %1206 = icmp eq i32 %1205, %2
  br i1 %1206, label %22, label %25, !llvm.loop !13

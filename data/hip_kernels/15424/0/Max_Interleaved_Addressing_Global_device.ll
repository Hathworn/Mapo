; ModuleID = '../data/hip_kernels/15424/0/main.cu'
source_filename = "../data/hip_kernels/15424/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z33Max_Interleaved_Addressing_GlobalPfi(float addrspace(1)* nocapture %0, i32 %1) local_unnamed_addr #0 {
...
24:                                               ; preds = %18
  %25 = load float, float addrspace(1)* %17, align 4, !tbaa !7
  %26 = add nsw i32 %19, %11
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds float, float addrspace(1)* %0, i64 %27
  %29 = load float, float addrspace(1)* %28, align 4, !tbaa !7
  %30 = fcmp contract olt float %25, %29
  %31 = select contract i1 %30, float %29, float %25
  store float %31, float addrspace(1)* %17, align 4, !tbaa !7
  br label %32

; ModuleID = '../data/hip_kernels/817/9/main.cu'
source_filename = "../data/hip_kernels/817/9/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [44 x i8] c"neuron: %d, weighted sum: %.2f, output: %d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z12printNeuronsPiPf(i32 addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1) local_unnamed_addr #1 {
  ...
  %15 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %12
  %16 = load i32, i32 addrspace(1)* %15, align 4, !tbaa !11, !amdgpu.noclobber !5
  ...
  %20 = load i64, i64 addrspace(4)* %19, align 8, !tbaa !13
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([44 x i8], [44 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %25, label %29
...
108:                                              ; preds = %101
  %109 = load i8, i8 addrspace(4)* %102, align 1, !tbaa !17
...
168:                                              ; preds = %161
  %169 = load i8, i8 addrspace(4)* %162, align 1, !tbaa !17
...
228:                                              ; preds = %221
  %229 = load i8, i8 addrspace(4)* %222, align 1, !tbaa !17
...
288:                                              ; preds = %281
  %289 = load i8, i8 addrspace(4)* %282, align 1, !tbaa !17
...
348:                                              ; preds = %341
  %349 = load i8, i8 addrspace(4)* %342, align 1, !tbaa !17
...
408:                                              ; preds = %401
  %409 = load i8, i8 addrspace(4)* %402, align 1, !tbaa !17
...
470:                                              ; preds = %459, %25
  ...
  %472 = fpext float %14 to double
  %473 = extractelement <2 x i64> %471, i64 0
  %474 = zext i32 %11 to i64
  %475 = and i64 %473, -225
  %476 = or i64 %475, 32
  %477 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %22, i64 noundef %476, i64 noundef %474, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %478 = extractelement <2 x i64> %477, i64 0
  %479 = bitcast double %472 to i64
  %480 = and i64 %478, -225
  %481 = or i64 %480, 32
  %482 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %22, i64 noundef %481, i64 noundef %479, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %483 = extractelement <2 x i64> %482, i64 0
  %484 = zext i32 %16 to i64
  %485 = and i64 %483, -227
  %486 = or i64 %485, 34
  %487 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %22, i64 noundef %486, i64 noundef %484, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

...
#include "updateOutputWithTargetMV_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
const long input_stride0 = 1;
const long weight_stride0 = 1;
const long score_stride0 = 1;
long input_size = XSIZE*YSIZE;
float *score = NULL;
...
hipFree(0);
updateOutputWithTargetMV<<<gridBlock, threadBlock>>>(input,weight,bias,mapping,n_class_in_cluster,class_start_indices,target,input_stride0,weight_stride0,score_stride0,input_size,score);

; ModuleID = '../data/hip_kernels/12405/2/main.cu'
source_filename = "../data/hip_kernels/12405/2/main.cu"
...
21:                                               ; preds = %5
  ...
  %29 = fcmp contract ogt double %28, 0.000000e+00
...
33:                                               ; preds = %21, %30
  %34 = phi contract double [ %32, %30 ], [ 0.000000e+00, %21 ]
  %35 = getelementptr inbounds double, double addrspace(1)* %2, i64 %26

; ModuleID = '../data/hip_kernels/2528/9/main.cu'
source_filename = "../data/hip_kernels/2528/9/main.cu"
...
25:                                               ; preds = %19
  %26 = add i32 %20, %3
  %27 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @sdata, i32 0, i32 %26
  %28 = load float, float addrspace(3)* %27, align 4, !tbaa !7
  %29 = load float, float addrspace(3)* %15, align 4, !tbaa !7
...
33:                                               ; preds = %17
  %34 = load float, float addrspace(3)* getelementptr inbounds ([0 x float], [0 x float] addrspace(3)* @sdata, i32 0, i32 0), align 4, !tbaa !7

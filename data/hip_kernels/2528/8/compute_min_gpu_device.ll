; ModuleID = '../data/hip_kernels/2528/8/main.cu'
source_filename = "../data/hip_kernels/2528/8/main.cu"
...
define protected amdgpu_kernel void @_Z15compute_min_gpuPfS_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
...
25:                                               ; preds = %19
  ...
  %30 = tail call float @llvm.minnum.f32(float %26, float %29)

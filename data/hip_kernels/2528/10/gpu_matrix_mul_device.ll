; ModuleID = '../data/hip_kernels/2528/10/main.cu'
source_filename = "../data/hip_kernels/2528/10/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z14gpu_matrix_mulPiS_S_(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
...
26:                                               ; preds = %30
  ...
  store i32 %127, i32 addrspace(1)* %29, align 4, !tbaa !7
  br label %130

30:                                               ; preds = %30, %24
  %31 = phi i32 [ 0, %24 ], [ %128, %30 ]
  %32 = phi i32 [ 0, %24 ], [ %127, %30 ]
  %33 = add nuw nsw i32 %31, %25
  ...
  br i1 %129, label %26, label %30, !llvm.loop !11

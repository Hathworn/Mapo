; ModuleID = '../data/hip_kernels/2/7/main.cu'
source_filename = "../data/hip_kernels/2/7/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z20kernelMagicUpsampleXPfiiS_(float addrspace(1)* nocapture readonly %0, i32 %1, i32 %2, float addrspace(1)* nocapture writeonly %3) local_unnamed_addr #0 {
...
41:                                               ; preds = %25
  %42 = load float, float addrspace(1)* %29, align 4, !tbaa !7
  %43 = add nsw i32 %27, 1
  ...
  %49 = fmul contract double %48, 3.000000e+00
  %50 = add nsw i32 %27, -1
  ...
  %63 = fmul contract float %62, 1.250000e-01
  %64 = or i32 %34, 1
  %65 = sext i32 %64 to i64
  %66 = getelementptr inbounds float, float addrspace(1)* %3, i64 %65
  store float %63, float addrspace(1)* %66, align 4, !tbaa !7
  br label %67

; ModuleID = '../data/hip_kernels/2/5/main.cu'
source_filename = "../data/hip_kernels/2/5/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z13kernelSmoothXPfiiS_(float addrspace(1)* nocapture readonly %0, i32 %1, i32 %2, float addrspace(1)* nocapture writeonly %3) local_unnamed_addr #0 {
...
25:                                               ; preds = %4
  ...
  %53 = fmul contract float %52, 3.750000e-01
  %54 = fadd contract float %48, %53
  %55 = add nsw i32 %35, %26
  ...
  %59 = fmul contract float %58, 2.500000e-01
  %60 = fadd contract float %54, %59
  %61 = add nsw i32 %37, %26
  ...
  %65 = fmul contract float %64, 6.250000e-02
  %66 = fadd contract float %60, %65
  %67 = getelementptr inbounds float, float addrspace(1)* %3, i64 %50

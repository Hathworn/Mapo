; ModuleID = '../data/hip_kernels/977/14/main.cu'
source_filename = "../data/hip_kernels/977/14/main.cu"
...
57:                                               ; preds = %57, %27
  ...
  %141 = load i32, i32 addrspace(1)* %140, align 4, !tbaa !7, !amdgpu.noclobber !6
  ...
  %153 = load i32, i32 addrspace(1)* %152, align 4, !tbaa !7, !amdgpu.noclobber !6

; ModuleID = '../data/hip_kernels/4672/76/main.cu'
source_filename = "../data/hip_kernels/4672/76/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z12fixPVandGainPffi(float addrspace(1)* nocapture %0, float %1, i32 %2) local_unnamed_addr #0 {
...
21:                                               ; preds = %20, %15
  %22 = phi float [ 0.000000e+00, %20 ], [ %18, %15 ]
  ...
  %27 = fcmp contract oeq float %26, -1.000000e+00
  %28 = fmul contract float %22, %1
  %29 = select i1 %27, float 0.000000e+00, float %28
  store float %29, float addrspace(1)* %17, align 4, !tbaa !7
  br label %30

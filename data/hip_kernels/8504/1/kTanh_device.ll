; ModuleID = '../data/hip_kernels/8504/1/main.cu'
source_filename = "../data/hip_kernels/8504/1/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z5kTanhiPKfPf(i32 %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
...
57:                                               ; preds = %32, %40
  ...
  %60 = getelementptr inbounds float, float addrspace(1)* %2, i64 %27
  store float %59, float addrspace(1)* %60, align 4, !tbaa !16
  %61 = add i32 %23, %26
  %62 = icmp slt i32 %61, %0
  br i1 %62, label %25, label %24, !llvm.loop !20
}

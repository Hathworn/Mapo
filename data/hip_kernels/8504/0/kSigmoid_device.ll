; ModuleID = '../data/hip_kernels/8504/0/main.cu'
source_filename = "../data/hip_kernels/8504/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z8kSigmoidiPKfPf(i32 %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
...
25:                                               ; preds = %17, %25
  ...
  %31 = fmul float %29, 0xBFF7154760000000
  %32 = tail call float @llvm.rint.f32(float %31)
  %33 = fcmp olt float %29, 0xC0562E4300000000
  %34 = fcmp ogt float %29, 0x4059D1DA00000000
  %35 = fneg float %31
  ...
  %47 = fdiv contract double 1.000000e+00, %46
  %48 = fptrunc double %47 to float
  %49 = getelementptr inbounds float, float addrspace(1)* %2, i64 %27
  store float %48, float addrspace(1)* %49, align 4, !tbaa !16
  %50 = add i32 %23, %26
  %51 = icmp slt i32 %50, %0
  br i1 %51, label %25, label %24, !llvm.loop !20
}

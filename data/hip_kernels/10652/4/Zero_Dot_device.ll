; ModuleID = '../data/hip_kernels/10652/4/main.cu'
source_filename = "../data/hip_kernels/10652/4/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ8Zero_DotPfS_S_E5cache = internal unnamed_addr addrspace(3) global [256 x float] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z8Zero_DotPfS_S_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
...
24:                                               ; preds = %17, %24
  ...
  %34 = add i32 %23, %26
  %35 = icmp slt i32 %34, 33792
  br i1 %35, label %24, label %36, !llvm.loop !20

36:                                               ; preds = %24, %3
  %37 = phi float [ 0.000000e+00, %3 ], [ %33, %24 ]
  %38 = getelementptr inbounds [256 x float], [256 x float] addrspace(3)* @_ZZ8Zero_DotPfS_S_E5cache, i32 0, i32 %4
...
45:                                               ; preds = %42
  %46 = add nsw i32 %43, %4
  %47 = getelementptr inbounds [256 x float], [256 x float] addrspace(3)* @_ZZ8Zero_DotPfS_S_E5cache, i32 0, i32 %46
...
57:                                               ; preds = %55
  %58 = load float, float addrspace(3)* getelementptr inbounds ([256 x float], [256 x float] addrspace(3)* @_ZZ8Zero_DotPfS_S_E5cache, i32 0, i32 0), align 16, !tbaa !16

; ModuleID = '../data/hip_kernels/3053/0/main.cu'
source_filename = "../data/hip_kernels/3053/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@convolutionKernelStore = protected addrspace(4) externally_initialized global [256 x float] zeroinitializer, align 16
@llvm.compiler.used = appending addrspace(1) global [1 x i8*] [i8* addrspacecast (i8 addrspace(4)* bitcast ([256 x float] addrspace(4)* @convolutionKernelStore to i8 addrspace(4)*) to i8*)], section "llvm.metadata"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z8convolvePhiiiimiiS_(i8 addrspace(1)* nocapture readonly %0, i32 %1, i32 %2, i32 %3, i32 %4, i64 %5, i32 %6, i32 %7, i8 addrspace(1)* nocapture writeonly %8) local_unnamed_addr #0 {
...
81:                                               ; preds = %74, %81
  ...
  %87 = add i64 %86, %5
  %88 = getelementptr inbounds [256 x float], [256 x float] addrspace(4)* @convolutionKernelStore, i64 0, i64 %87
...
108:                                              ; preds = %100, %108
  ...
  %113 = add i64 %112, %5
  %114 = getelementptr inbounds [256 x float], [256 x float] addrspace(4)* @convolutionKernelStore, i64 0, i64 %113
  ...
  %126 = add i64 %125, %5
  %127 = getelementptr inbounds [256 x float], [256 x float] addrspace(4)* @convolutionKernelStore, i64 0, i64 %126
  ...
  %139 = add i64 %138, %5
  %140 = getelementptr inbounds [256 x float], [256 x float] addrspace(4)* @convolutionKernelStore, i64 0, i64 %139
  ...
  %152 = add i64 %151, %5
  %153 = getelementptr inbounds [256 x float], [256 x float] addrspace(4)* @convolutionKernelStore, i64 0, i64 %152
  ...
  %165 = add i64 %164, %5
  %166 = getelementptr inbounds [256 x float], [256 x float] addrspace(4)* @convolutionKernelStore, i64 0, i64 %165
  ...
  %178 = add i64 %177, %5
  %179 = getelementptr inbounds [256 x float], [256 x float] addrspace(4)* @convolutionKernelStore, i64 0, i64 %178
  ...
  %191 = add i64 %190, %5
  %192 = getelementptr inbounds [256 x float], [256 x float] addrspace(4)* @convolutionKernelStore, i64 0, i64 %191
  ...
  %204 = add i64 %203, %5
  %205 = getelementptr inbounds [256 x float], [256 x float] addrspace(4)* @convolutionKernelStore, i64 0, i64 %204

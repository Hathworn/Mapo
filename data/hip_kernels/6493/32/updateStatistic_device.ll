; ModuleID = '../data/hip_kernels/6493/32/main.cu'
source_filename = "../data/hip_kernels/6493/32/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z15updateStatisticiPKfS0_S0_Pf(i32 %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, float addrspace(1)* nocapture %4) local_unnamed_addr #0 {
...
16:                                               ; preds = %5
  ...
  %26 = fmul contract float %25, %23
  %27 = fcmp contract olt float %19, %21
  ...
  store float %32, float addrspace(1)* %29, align 4, !tbaa !7
  br label %33

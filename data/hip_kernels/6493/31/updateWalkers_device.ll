; ModuleID = '../data/hip_kernels/6493/31/main.cu'
source_filename = "../data/hip_kernels/6493/31/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z13updateWalkersiiPKfS0_S0_Pf(i32 %0, i32 %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, float addrspace(1)* nocapture readonly %4, float addrspace(1)* nocapture %5) local_unnamed_addr #0 {
...
27:                                               ; preds = %6
  ...
  %41 = fcmp contract ole float %32, %34
  %42 = uitofp i1 %41 to float
  %43 = getelementptr inbounds float, float addrspace(1)* %5, i64 %37

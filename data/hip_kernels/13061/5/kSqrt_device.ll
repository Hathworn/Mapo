; ModuleID = '../data/hip_kernels/13061/5/main.cu'
source_filename = "../data/hip_kernels/13061/5/main.cu"
...
25:                                               ; preds = %17, %25
  ...
  %51 = getelementptr inbounds float, float addrspace(1)* %1, i64 %27
  store float %50, float addrspace(1)* %51, align 4, !tbaa !16
  %52 = add i32 %23, %26
  %53 = icmp ult i32 %52, %2
  br i1 %53, label %25, label %24, !llvm.loop !20
}

; ModuleID = '../data/hip_kernels/13061/21/main.cu'
source_filename = "../data/hip_kernels/13061/21/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z13kAddTransSlowPfS_S_jjjff(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2, i32 %3, i32 %4, i32 %5, float %6, float %7) local_unnamed_addr #0 {
...
29:                                               ; preds = %8, %29
  ...
  %45 = fmul contract float %44, %7
  %46 = fadd contract float %34, %45
  %47 = getelementptr inbounds float, float addrspace(1)* %2, i64 %31
  store float %46, float addrspace(1)* %47, align 4, !tbaa !16
  %48 = add i32 %30, %26
  %49 = icmp ult i32 %48, %5
  br i1 %49, label %29, label %28, !llvm.loop !20
}

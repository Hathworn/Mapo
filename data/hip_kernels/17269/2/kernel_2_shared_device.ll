; ModuleID = '../data/hip_kernels/17269/2/main.cu'
source_filename = "../data/hip_kernels/17269/2/main.cu"
...
@_ZZ15kernel_2_sharediiPfS_E11temp_answer = internal addrspace(3) global [32 x float] undef, align 16
@.str = private unnamed_addr addrspace(4) constant [14 x i8] c"%d Value %f \0A\00", align 1
...
define protected amdgpu_kernel void @_Z15kernel_2_sharediiPfS_(i32 %0, i32 %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture %3) local_unnamed_addr #1 {
...
8:                                                ; preds = %4
  %9 = getelementptr inbounds [32 x float], [32 x float] addrspace(3)* @_ZZ15kernel_2_sharediiPfS_E11temp_answer, i32 0, i32 %7
...
10:                                               ; preds = %4, %8
  ...
  %15 = load i16, i16 addrspace(4)* %14, align 4, !range !9, !invariant.load !10
  %16 = zext i16 %15 to i32
  %17 = mul i32 %11, %16
  %18 = add i32 %17, %7
  %19 = tail call i32 @llvm.amdgcn.workgroup.id.y()
  %20 = getelementptr i8, i8 addrspace(4)* %12, i64 6
  %21 = bitcast i8 addrspace(4)* %20 to i16 addrspace(4)*
  %22 = load i16, i16 addrspace(4)* %21, align 2, !range !9, !invariant.load !10
  %23 = zext i16 %22 to i32
  %24 = mul i32 %19, %23
  %25 = add i32 %24, %5
  %26 = mul nsw i32 %25, %0
  %27 = add nsw i32 %26, %18
  %28 = getelementptr inbounds [32 x float], [32 x float] addrspace(3)* @_ZZ15kernel_2_sharediiPfS_E11temp_answer, i32 0, i32 %7
  %29 = sext i32 %27 to i64
  %30 = getelementptr inbounds float, float addrspace(1)* %2, i64 %29
  %31 = load float, float addrspace(1)* %30, align 4, !tbaa !5, !amdgpu.noclobber !10
  %32 = atomicrmw fadd float addrspace(3)* %28, float %31 syncscope("agent-one-as") monotonic, align 4
  fence syncscope("workgroup") release
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %33 = icmp ne i32 %11, 1
  ...
  br i1 %38, label %507, label %39

39:                                               ; preds = %10
  %40 = load float, float addrspace(1)* %30, align 4, !tbaa !5, !amdgpu.noclobber !10
  ...
  %45 = load i64, i64 addrspace(4)* %44, align 8, !tbaa !11
  %46 = inttoptr i64 %45 to i8 addrspace(1)*
  %47 = addrspacecast i8 addrspace(1)* %46 to i8*
  %48 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %47, i64 noundef 33, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #11
  %49 = extractelement <2 x i64> %48, i64 0
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([14 x i8], [14 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %50, label %54

50:                                               ; preds = %39
  %51 = and i64 %49, -225
  %52 = or i64 %51, 32
  %53 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %47, i64 noundef %52, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #11
  br label %495
...
73:                                               ; preds = %58
  %74 = load i8, i8 addrspace(4)* %60, align 1, !tbaa !15
  ...
  %102 = load i8, i8 addrspace(4)* %101, align 1, !tbaa !15
...
133:                                              ; preds = %126
  %134 = load i8, i8 addrspace(4)* %127, align 1, !tbaa !15
  ...
  %162 = load i8, i8 addrspace(4)* %161, align 1, !tbaa !15
...
193:                                              ; preds = %186
  %194 = load i8, i8 addrspace(4)* %187, align 1, !tbaa !15
  ...
  %222 = load i8, i8 addrspace(4)* %221, align 1, !tbaa !15
...
253:                                              ; preds = %246
  %254 = load i8, i8 addrspace(4)* %247, align 1, !tbaa !15
  ...
  %282 = load i8, i8 addrspace(4)* %281, align 1, !tbaa !15
...
313:                                              ; preds = %306
  %314 = load i8, i8 addrspace(4)* %307, align 1, !tbaa !15
  ...
  %342 = load i8, i8 addrspace(4)* %341, align 1, !tbaa !15
...
373:                                              ; preds = %366
  %374 = load i8, i8 addrspace(4)* %367, align 1, !tbaa !15
  ...
  %402 = load i8, i8 addrspace(4)* %401, align 1, !tbaa !15
...
433:                                              ; preds = %426
  %434 = load i8, i8 addrspace(4)* %427, align 1, !tbaa !15
  ...
  %467 = load i8, i8 addrspace(4)* %466, align 1, !tbaa !15
...
484:                                              ; preds = %471, %433, %431
  ...
  %489 = and i64 %69, -225
  %490 = or i64 %489, %488
  %491 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %47, i64 noundef %490, i64 noundef %129, i64 noundef %189, i64 noundef %249, i64 noundef %309, i64 noundef %369, i64 noundef %429, i64 noundef %485) #11
  %492 = sub i64 %59, %67
...
495:                                              ; preds = %484, %50
  ...
  %498 = zext i32 %27 to i64
  %499 = and i64 %497, -225
  %500 = or i64 %499, 32
  %501 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %47, i64 noundef %500, i64 noundef %498, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #11
  %502 = extractelement <2 x i64> %501, i64 0
  %503 = bitcast double %41 to i64
  %504 = and i64 %502, -227
  %505 = or i64 %504, 34
  %506 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %47, i64 noundef %505, i64 noundef %503, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #11
  br label %507
...
510:                                              ; preds = %507
  %511 = sext i32 %18 to i64
  %512 = getelementptr inbounds float, float addrspace(1)* %3, i64 %511
  %513 = load float, float addrspace(3)* %28, align 4, !tbaa !5
  %514 = atomicrmw fadd float addrspace(1)* %512, float %513 syncscope("agent-one-as") monotonic, align 4
  br label %515

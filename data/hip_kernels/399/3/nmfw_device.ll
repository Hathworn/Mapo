; ModuleID = '../data/hip_kernels/399/3/main.cu'
source_filename = "../data/hip_kernels/399/3/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z4nmfwPdiiiS_S_S_(double addrspace(1)* nocapture readonly %0, i32 %1, i32 %2, i32 %3, double addrspace(1)* nocapture readonly %4, double addrspace(1)* nocapture readonly %5, double addrspace(1)* nocapture writeonly %6) local_unnamed_addr #0 {
...
37:                                               ; preds = %74, %30
  %38 = phi double [ undef, %30 ], [ %164, %74 ]
  %39 = phi i32 [ 0, %30 ], [ %165, %74 ]
  %40 = phi double [ 0.000000e+00, %30 ], [ %164, %74 ]
  %41 = icmp eq i32 %33, 0
  br i1 %41, label %59, label %42

42:                                               ; preds = %37, %42
  %43 = phi i32 [ %56, %42 ], [ %39, %37 ]
  %44 = phi double [ %55, %42 ], [ %40, %37 ]
...
59:                                               ; preds = %37, %42, %28
  %60 = phi double [ 0.000000e+00, %28 ], [ %38, %37 ], [ %55, %42 ]
  %61 = mul nsw i32 %16, %3
...
74:                                               ; preds = %74, %35
  ...
  %76 = phi double [ 0.000000e+00, %35 ], [ %164, %74 ]
  ...
  %95 = getelementptr inbounds double, double addrspace(1)* %5, i64 %94
  %96 = load double, double addrspace(1)* %95, align 8, !tbaa !7, !amdgpu.noclobber !5
  %97 = fmul contract double %92, %96
  %98 = fadd contract double %87, %97
  %99 = or i32 %75, 2
  ...
  %106 = getelementptr inbounds double, double addrspace(1)* %5, i64 %105
  %107 = load double, double addrspace(1)* %106, align 8, !tbaa !7, !amdgpu.noclobber !5
  %108 = fmul contract double %103, %107
  %109 = fadd contract double %98, %108
  %110 = or i32 %75, 3
  ...
  %120 = fadd contract double %109, %119
  %121 = or i32 %75, 4
  ...
  %128 = getelementptr inbounds double, double addrspace(1)* %5, i64 %127
  %129 = load double, double addrspace(1)* %128, align 8, !tbaa !7, !amdgpu.noclobber !5
  %130 = fmul contract double %125, %129
  %131 = fadd contract double %120, %130
  %132 = or i32 %75, 5
  ...
  %150 = getelementptr inbounds double, double addrspace(1)* %5, i64 %149
  %151 = load double, double addrspace(1)* %150, align 8, !tbaa !7, !amdgpu.noclobber !5
  %152 = fmul contract double %147, %151
  %153 = fadd contract double %142, %152
  %154 = or i32 %75, 7
  %155 = add nsw i32 %154, %31
  %156 = sext i32 %155 to i64
  %157 = getelementptr inbounds double, double addrspace(1)* %0, i64 %156
  ...
  %163 = fmul contract double %158, %162
  %164 = fadd contract double %153, %163
...
168:                                              ; preds = %67, %203
  ...
  %170 = phi double [ 0.000000e+00, %67 ], [ %204, %203 ]
  br i1 %68, label %171, label %203

171:                                              ; preds = %168
  %172 = add nsw i32 %169, %69
  %173 = sext i32 %172 to i64
  %174 = getelementptr inbounds double, double addrspace(1)* %5, i64 %173
  %175 = load double, double addrspace(1)* %174, align 8, !tbaa !7, !amdgpu.noclobber !5
  br i1 %71, label %180, label %207

176:                                              ; preds = %203, %59
  %177 = phi double [ 0.000000e+00, %59 ], [ %204, %203 ]
  fence syncscope("workgroup") release
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %178 = fdiv contract double %66, %177
  %179 = getelementptr inbounds double, double addrspace(1)* %6, i64 %63
  store double %178, double addrspace(1)* %179, align 8, !tbaa !7
  br label %317

180:                                              ; preds = %207, %171
  %181 = phi double [ undef, %171 ], [ %313, %207 ]
  %182 = phi i32 [ 0, %171 ], [ %314, %207 ]
  %183 = phi double [ %170, %171 ], [ %313, %207 ]
  br i1 %73, label %203, label %184

184:                                              ; preds = %180, %184
  %185 = phi i32 [ %200, %184 ], [ %182, %180 ]
  %186 = phi double [ %199, %184 ], [ %183, %180 ]
  %187 = phi i32 [ %201, %184 ], [ 0, %180 ]
  %188 = add nsw i32 %185, %61
  %189 = sext i32 %188 to i64
  %190 = getelementptr inbounds double, double addrspace(1)* %4, i64 %189
  %191 = load double, double addrspace(1)* %190, align 8, !tbaa !7, !amdgpu.noclobber !5
  %192 = mul nsw i32 %185, %2
  %193 = add nsw i32 %192, %169
  %194 = sext i32 %193 to i64
  %195 = getelementptr inbounds double, double addrspace(1)* %5, i64 %194
  %196 = load double, double addrspace(1)* %195, align 8, !tbaa !7, !amdgpu.noclobber !5
  %197 = fmul contract double %191, %196
  %198 = fmul contract double %197, %175
  %199 = fadd contract double %186, %198
...
203:                                              ; preds = %180, %184, %168
  %204 = phi double [ %170, %168 ], [ %181, %180 ], [ %199, %184 ]
...
207:                                              ; preds = %171, %207
  ...
  %209 = phi double [ %313, %207 ], [ %170, %171 ]
  %210 = phi i32 [ %315, %207 ], [ 0, %171 ]
  %211 = add nsw i32 %208, %61
  %212 = sext i32 %211 to i64
  %213 = getelementptr inbounds double, double addrspace(1)* %4, i64 %212
  %214 = load double, double addrspace(1)* %213, align 8, !tbaa !7, !amdgpu.noclobber !5
  %215 = mul nsw i32 %208, %2
  %216 = add nsw i32 %215, %169
  %217 = sext i32 %216 to i64
  %218 = getelementptr inbounds double, double addrspace(1)* %5, i64 %217
  %219 = load double, double addrspace(1)* %218, align 8, !tbaa !7, !amdgpu.noclobber !5
  %220 = fmul contract double %214, %219
  %221 = fmul contract double %220, %175
  %222 = fadd contract double %209, %221
  %223 = or i32 %208, 1
  %224 = add nsw i32 %223, %61
  %225 = sext i32 %224 to i64
  %226 = getelementptr inbounds double, double addrspace(1)* %4, i64 %225
  %227 = load double, double addrspace(1)* %226, align 8, !tbaa !7, !amdgpu.noclobber !5
  %228 = mul nsw i32 %223, %2
  %229 = add nsw i32 %228, %169
  %230 = sext i32 %229 to i64
  %231 = getelementptr inbounds double, double addrspace(1)* %5, i64 %230
  %232 = load double, double addrspace(1)* %231, align 8, !tbaa !7, !amdgpu.noclobber !5
  %233 = fmul contract double %227, %232
  %234 = fmul contract double %233, %175
  %235 = fadd contract double %222, %234
  %236 = or i32 %208, 2
  %237 = add nsw i32 %236, %61
  %238 = sext i32 %237 to i64
  %239 = getelementptr inbounds double, double addrspace(1)* %4, i64 %238
  %240 = load double, double addrspace(1)* %239, align 8, !tbaa !7, !amdgpu.noclobber !5
  %241 = mul nsw i32 %236, %2
  %242 = add nsw i32 %241, %169
  %243 = sext i32 %242 to i64
  %244 = getelementptr inbounds double, double addrspace(1)* %5, i64 %243
  %245 = load double, double addrspace(1)* %244, align 8, !tbaa !7, !amdgpu.noclobber !5
  %246 = fmul contract double %240, %245
  %247 = fmul contract double %246, %175
  %248 = fadd contract double %235, %247
  %249 = or i32 %208, 3
  %250 = add nsw i32 %249, %61
  %251 = sext i32 %250 to i64
  %252 = getelementptr inbounds double, double addrspace(1)* %4, i64 %251
  %253 = load double, double addrspace(1)* %252, align 8, !tbaa !7, !amdgpu.noclobber !5
  %254 = mul nsw i32 %249, %2
  %255 = add nsw i32 %254, %169
  %256 = sext i32 %255 to i64
  %257 = getelementptr inbounds double, double addrspace(1)* %5, i64 %256
  %258 = load double, double addrspace(1)* %257, align 8, !tbaa !7, !amdgpu.noclobber !5
  %259 = fmul contract double %253, %258
  %260 = fmul contract double %259, %175
  %261 = fadd contract double %248, %260
  %262 = or i32 %208, 4
  %263 = add nsw i32 %262, %61
  %264 = sext i32 %263 to i64
  %265 = getelementptr inbounds double, double addrspace(1)* %4, i64 %264
  %266 = load double, double addrspace(1)* %265, align 8, !tbaa !7, !amdgpu.noclobber !5
  %267 = mul nsw i32 %262, %2
  %268 = add nsw i32 %267, %169
  %269 = sext i32 %268 to i64
  %270 = getelementptr inbounds double, double addrspace(1)* %5, i64 %269
  %271 = load double, double addrspace(1)* %270, align 8, !tbaa !7, !amdgpu.noclobber !5
  %272 = fmul contract double %266, %271
  %273 = fmul contract double %272, %175
  %274 = fadd contract double %261, %273
  %275 = or i32 %208, 5
  %276 = add nsw i32 %275, %61
  %277 = sext i32 %276 to i64
  %278 = getelementptr inbounds double, double addrspace(1)* %4, i64 %277
  %279 = load double, double addrspace(1)* %278, align 8, !tbaa !7, !amdgpu.noclobber !5
  %280 = mul nsw i32 %275, %2
  %281 = add nsw i32 %280, %169
  %282 = sext i32 %281 to i64
  %283 = getelementptr inbounds double, double addrspace(1)* %5, i64 %282
  %284 = load double, double addrspace(1)* %283, align 8, !tbaa !7, !amdgpu.noclobber !5
  %285 = fmul contract double %279, %284
  %286 = fmul contract double %285, %175
  %287 = fadd contract double %274, %286
  %288 = or i32 %208, 6
  %289 = add nsw i32 %288, %61
  %290 = sext i32 %289 to i64
  %291 = getelementptr inbounds double, double addrspace(1)* %4, i64 %290
  %292 = load double, double addrspace(1)* %291, align 8, !tbaa !7, !amdgpu.noclobber !5
  %293 = mul nsw i32 %288, %2
  %294 = add nsw i32 %293, %169
  %295 = sext i32 %294 to i64
  %296 = getelementptr inbounds double, double addrspace(1)* %5, i64 %295
  %297 = load double, double addrspace(1)* %296, align 8, !tbaa !7, !amdgpu.noclobber !5
  %298 = fmul contract double %292, %297
  %299 = fmul contract double %298, %175
  %300 = fadd contract double %287, %299
  %301 = or i32 %208, 7
  %302 = add nsw i32 %301, %61
  %303 = sext i32 %302 to i64
  %304 = getelementptr inbounds double, double addrspace(1)* %4, i64 %303
  %305 = load double, double addrspace(1)* %304, align 8, !tbaa !7, !amdgpu.noclobber !5
  %306 = mul nsw i32 %301, %2
  %307 = add nsw i32 %306, %169
  %308 = sext i32 %307 to i64
  %309 = getelementptr inbounds double, double addrspace(1)* %5, i64 %308
  %310 = load double, double addrspace(1)* %309, align 8, !tbaa !7, !amdgpu.noclobber !5
  %311 = fmul contract double %305, %310
  %312 = fmul contract double %311, %175

; ModuleID = '../data/hip_kernels/399/1/main.cu'
source_filename = "../data/hip_kernels/399/1/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z4nmfhPfiiiS_S_S_(float addrspace(1)* nocapture readonly %0, i32 %1, i32 %2, i32 %3, float addrspace(1)* nocapture readonly %4, float addrspace(1)* nocapture readonly %5, float addrspace(1)* nocapture writeonly %6) local_unnamed_addr #0 {
...
35:                                               ; preds = %73, %30
  %36 = phi float [ undef, %30 ], [ %179, %73 ]
  %37 = phi i32 [ 0, %30 ], [ %180, %73 ]
  %38 = phi float [ 0.000000e+00, %30 ], [ %179, %73 ]
  %39 = icmp eq i32 %31, 0
...
73:                                               ; preds = %73, %33
  ...
  %75 = phi float [ 0.000000e+00, %33 ], [ %179, %73 ]
...
183:                                              ; preds = %68, %219
  ...
  %185 = phi float [ %220, %219 ], [ 0.000000e+00, %68 ]
...
192:                                              ; preds = %219, %59
  %193 = phi float [ 0.000000e+00, %59 ], [ %220, %219 ]
  fence syncscope("workgroup") release
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %194 = fdiv contract float %66, %193
  %195 = getelementptr inbounds float, float addrspace(1)* %6, i64 %63
  store float %194, float addrspace(1)* %195, align 4, !tbaa !7
  br label %333

196:                                              ; preds = %223, %186
  %197 = phi float [ undef, %186 ], [ %329, %223 ]
  %198 = phi i32 [ 0, %186 ], [ %330, %223 ]
  %199 = phi float [ %185, %186 ], [ %329, %223 ]
  br i1 %72, label %219, label %200

200:                                              ; preds = %196, %200
  %201 = phi i32 [ %216, %200 ], [ %198, %196 ]
  %202 = phi float [ %215, %200 ], [ %199, %196 ]
  ...
  %208 = load float, float addrspace(1)* %207, align 4, !tbaa !7, !amdgpu.noclobber !5
  %209 = add nsw i32 %204, %184
  %210 = sext i32 %209 to i64
  %211 = getelementptr inbounds float, float addrspace(1)* %4, i64 %210
  %212 = load float, float addrspace(1)* %211, align 4, !tbaa !7, !amdgpu.noclobber !5
  %213 = fmul contract float %208, %212
  %214 = fmul contract float %213, %191
...
219:                                              ; preds = %196, %200, %183
  %220 = phi float [ %185, %183 ], [ %197, %196 ], [ %215, %200 ]
...
223:                                              ; preds = %186, %223
  ...
  %250 = fmul contract float %249, %191
  %251 = fadd contract float %238, %250
  %252 = or i32 %224, 2
  %253 = mul nsw i32 %252, %3
  %254 = add nsw i32 %253, %16
  %255 = sext i32 %254 to i64
  %256 = getelementptr inbounds float, float addrspace(1)* %4, i64 %255
  %257 = load float, float addrspace(1)* %256, align 4, !tbaa !7, !amdgpu.noclobber !5
  %258 = add nsw i32 %253, %184
  %259 = sext i32 %258 to i64
  %260 = getelementptr inbounds float, float addrspace(1)* %4, i64 %259
  %261 = load float, float addrspace(1)* %260, align 4, !tbaa !7, !amdgpu.noclobber !5
  %262 = fmul contract float %257, %261
  %263 = fmul contract float %262, %191
  %264 = fadd contract float %251, %263
  %265 = or i32 %224, 3
  %266 = mul nsw i32 %265, %3
  %267 = add nsw i32 %266, %16
  %268 = sext i32 %267 to i64
  %269 = getelementptr inbounds float, float addrspace(1)* %4, i64 %268
  %270 = load float, float addrspace(1)* %269, align 4, !tbaa !7, !amdgpu.noclobber !5
  %271 = add nsw i32 %266, %184
  %272 = sext i32 %271 to i64
  %273 = getelementptr inbounds float, float addrspace(1)* %4, i64 %272
  %274 = load float, float addrspace(1)* %273, align 4, !tbaa !7, !amdgpu.noclobber !5
  %275 = fmul contract float %270, %274
  %276 = fmul contract float %275, %191
  %277 = fadd contract float %264, %276
  %278 = or i32 %224, 4
  %279 = mul nsw i32 %278, %3
  %280 = add nsw i32 %279, %16
  %281 = sext i32 %280 to i64
  %282 = getelementptr inbounds float, float addrspace(1)* %4, i64 %281
  %283 = load float, float addrspace(1)* %282, align 4, !tbaa !7, !amdgpu.noclobber !5
  %284 = add nsw i32 %279, %184
  %285 = sext i32 %284 to i64
  %286 = getelementptr inbounds float, float addrspace(1)* %4, i64 %285
  %287 = load float, float addrspace(1)* %286, align 4, !tbaa !7, !amdgpu.noclobber !5
  %288 = fmul contract float %283, %287
  %289 = fmul contract float %288, %191
  %290 = fadd contract float %277, %289
  %291 = or i32 %224, 5
  ...
  %299 = getelementptr inbounds float, float addrspace(1)* %4, i64 %298
  %300 = load float, float addrspace(1)* %299, align 4, !tbaa !7, !amdgpu.noclobber !5
  %301 = fmul contract float %296, %300
  %302 = fmul contract float %301, %191
  %303 = fadd contract float %290, %302
  %304 = or i32 %224, 6
  %305 = mul nsw i32 %304, %3
  %306 = add nsw i32 %305, %16
  %307 = sext i32 %306 to i64
  %308 = getelementptr inbounds float, float addrspace(1)* %4, i64 %307
  %309 = load float, float addrspace(1)* %308, align 4, !tbaa !7, !amdgpu.noclobber !5
  %310 = add nsw i32 %305, %184
  %311 = sext i32 %310 to i64
  %312 = getelementptr inbounds float, float addrspace(1)* %4, i64 %311
  %313 = load float, float addrspace(1)* %312, align 4, !tbaa !7, !amdgpu.noclobber !5
  %314 = fmul contract float %309, %313
  %315 = fmul contract float %314, %191
  %316 = fadd contract float %303, %315
  %317 = or i32 %224, 7
  %318 = mul nsw i32 %317, %3
  %319 = add nsw i32 %318, %16
  %320 = sext i32 %319 to i64
  %321 = getelementptr inbounds float, float addrspace(1)* %4, i64 %320
  ...
  %328 = fmul contract float %327, %191
  %329 = fadd contract float %316, %328

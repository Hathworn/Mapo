; ModuleID = '../data/hip_kernels/4933/105/main.cu'
source_filename = "../data/hip_kernels/4933/105/main.cu"
...
@_ZZ10stencil_1dPfS_E4smem = internal unnamed_addr addrspace(3) global [520 x float] undef, align 16
...
define protected amdgpu_kernel void @_Z10stencil_1dPfS_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
  ...
  %16 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %12
...
18:                                               ; preds = %2
  ...
  %23 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %3
  store float %22, float addrspace(3)* %23, align 4, !tbaa !7
  %24 = add nsw i32 %11, 512
  ...
  %28 = add nuw nsw i32 %3, 516
  %29 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %28
...
30:                                               ; preds = %18, %2
  ...
  %33 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %32
  %34 = load float, float addrspace(3)* %33, align 4, !tbaa !7
  %35 = add nuw nsw i32 %3, 3
  %36 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %35
  ...
  %43 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %42
  %44 = load float, float addrspace(3)* %43, align 4, !tbaa !7
  %45 = add nuw nsw i32 %3, 2
  %46 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %45
  ...
  %53 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %52
  %54 = load float, float addrspace(3)* %53, align 4, !tbaa !7
  %55 = add nuw nsw i32 %3, 1
  %56 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %55
  ...
  %63 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %62
  %64 = load float, float addrspace(3)* %63, align 4, !tbaa !7
  %65 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %3

; ModuleID = '../data/hip_kernels/4933/107/main.cu'
source_filename = "../data/hip_kernels/4933/107/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ17stencil_1d_globalPfS_S_E4smem = internal unnamed_addr addrspace(3) global [520 x float] undef, align 16
...
define protected amdgpu_kernel void @_Z17stencil_1d_globalPfS_S_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, float addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %17 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ17stencil_1d_globalPfS_S_E4smem, i32 0, i32 %13
...
19:                                               ; preds = %3
  ...
  %24 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ17stencil_1d_globalPfS_S_E4smem, i32 0, i32 %4
  store float %23, float addrspace(3)* %24, align 4, !tbaa !7
  %25 = add nsw i32 %12, 512
  ...
  %29 = add nuw nsw i32 %4, 516
  %30 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ17stencil_1d_globalPfS_S_E4smem, i32 0, i32 %29
...
31:                                               ; preds = %19, %3
  ...
  %35 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ17stencil_1d_globalPfS_S_E4smem, i32 0, i32 %34
  %36 = load float, float addrspace(3)* %35, align 4, !tbaa !7
  %37 = add nuw nsw i32 %4, 3
  %38 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ17stencil_1d_globalPfS_S_E4smem, i32 0, i32 %37
  ...
  %46 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ17stencil_1d_globalPfS_S_E4smem, i32 0, i32 %45
  %47 = load float, float addrspace(3)* %46, align 4, !tbaa !7
  %48 = add nuw nsw i32 %4, 2
  %49 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ17stencil_1d_globalPfS_S_E4smem, i32 0, i32 %48
  ...
  %57 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ17stencil_1d_globalPfS_S_E4smem, i32 0, i32 %56
  %58 = load float, float addrspace(3)* %57, align 4, !tbaa !7
  %59 = add nuw nsw i32 %4, 1
  %60 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ17stencil_1d_globalPfS_S_E4smem, i32 0, i32 %59
  ...
  %68 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ17stencil_1d_globalPfS_S_E4smem, i32 0, i32 %67
  %69 = load float, float addrspace(3)* %68, align 4, !tbaa !7
  %70 = getelementptr inbounds [520 x float], [520 x float] addrspace(3)* @_ZZ17stencil_1d_globalPfS_S_E4smem, i32 0, i32 %4

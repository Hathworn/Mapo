; ModuleID = '../data/hip_kernels/4933/285/main.cu'
source_filename = "../data/hip_kernels/4933/285/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ10reduceSmemPiS_jE4smem = internal addrspace(3) global [1024 x i32] undef, align 16
...
14:                                               ; preds = %3
  ...
  %20 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ10reduceSmemPiS_jE4smem, i32 0, i32 %4
...
24:                                               ; preds = %14
  ...
  %26 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ10reduceSmemPiS_jE4smem, i32 0, i32 %25
...
34:                                               ; preds = %30
  ...
  %36 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ10reduceSmemPiS_jE4smem, i32 0, i32 %35
...
44:                                               ; preds = %40
  ...
  %46 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ10reduceSmemPiS_jE4smem, i32 0, i32 %45
...
54:                                               ; preds = %50
  ...
  %56 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ10reduceSmemPiS_jE4smem, i32 0, i32 %55
...
62:                                               ; preds = %60
  ...
  %64 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ10reduceSmemPiS_jE4smem, i32 0, i32 %63
  ...
  %71 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ10reduceSmemPiS_jE4smem, i32 0, i32 %70
  ...
  %77 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ10reduceSmemPiS_jE4smem, i32 0, i32 %76
  ...
  %83 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ10reduceSmemPiS_jE4smem, i32 0, i32 %82
  ...
  %89 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ10reduceSmemPiS_jE4smem, i32 0, i32 %88
  ...
  %95 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ10reduceSmemPiS_jE4smem, i32 0, i32 %94
...
102:                                              ; preds = %100
  %103 = load i32, i32 addrspace(3)* getelementptr inbounds ([1024 x i32], [1024 x i32] addrspace(3)* @_ZZ10reduceSmemPiS_jE4smem, i32 0, i32 0), align 16, !tbaa !7

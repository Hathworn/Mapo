; ModuleID = '../data/hip_kernels/4933/128/main.cu'
source_filename = "../data/hip_kernels/4933/128/main.cu"
...
38:                                               ; preds = %17, %3
  ...
  %40 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %4
...
44:                                               ; preds = %38
  ...
  %46 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %45
...
82:                                               ; preds = %80
  ...
  %84 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %83
  ...
  %91 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %90
  ...
  %97 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %96
  ...
  %103 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %102
  ...
  %109 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %108
  ...
  %115 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %114
...
122:                                              ; preds = %120
  %123 = load i32, i32 addrspace(3)* getelementptr inbounds ([1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 0), align 16, !tbaa !7

; ModuleID = '../data/hip_kernels/4933/6/main.cu'
source_filename = "../data/hip_kernels/4933/6/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [43 x i8] c"Hello from GPU - block: %d - thread: %d. \0A\00", align 1

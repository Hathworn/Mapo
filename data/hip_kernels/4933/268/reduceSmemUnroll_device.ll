; ModuleID = '../data/hip_kernels/4933/268/main.cu'
source_filename = "../data/hip_kernels/4933/268/main.cu"
...
41:                                               ; preds = %17, %3
  ...
  %43 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %4
...
47:                                               ; preds = %41
  ...
  %49 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %48
...
57:                                               ; preds = %53
  ...
  %59 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %58
...
67:                                               ; preds = %63
  ...
  %69 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %68
...
77:                                               ; preds = %73
  ...
  %79 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %78
...
85:                                               ; preds = %83
  ...
  %87 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %86
  ...
  %100 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %99
  ...
  %106 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %105
  ...
  %112 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %111
  ...
  %118 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %117
...
125:                                              ; preds = %123
  %126 = load i32, i32 addrspace(3)* getelementptr inbounds ([1024 x i32], [1024 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 0), align 16, !tbaa !7

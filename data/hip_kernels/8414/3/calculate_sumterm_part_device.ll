; ModuleID = '../data/hip_kernels/8414/3/main.cu'
source_filename = "../data/hip_kernels/8414/3/main.cu"
...
define protected amdgpu_kernel void @_Z22calculate_sumterm_partP15HIP_vector_typeIdLj2EES1_PKS0_PKdPKhjjdjj(%struct.HIP_vector_type addrspace(1)* nocapture %0, %struct.HIP_vector_type addrspace(1)* nocapture %1, %struct.HIP_vector_type addrspace(1)* nocapture readonly %2, double addrspace(1)* nocapture readonly %3, i8 addrspace(1)* nocapture readonly %4, i32 %5, i32 %6, double %7, i32 %8, i32 %9) local_unnamed_addr #0 {
...
25:                                               ; preds = %10, %25
  ...
  %55 = load double, double addrspace(1)* %54, align 16, !tbaa !7
  ...
  %62 = load double, double addrspace(1)* %61, align 16, !tbaa !7
  ...
  %69 = load double, double addrspace(1)* %68, align 16, !tbaa !7
  ...
  %76 = load double, double addrspace(1)* %75, align 16, !tbaa !7
  ...
  %80 = fmul contract double %79, %7
  %81 = fmul contract double %55, %62
  %82 = fmul contract double %81, %69
  %83 = fmul contract double %57, %64
  %84 = fmul contract double %83, %69
  %85 = fsub contract double %82, %84
  %86 = fmul contract double %55, %64
  %87 = fmul contract double %86, %71
  %88 = fadd contract double %85, %87
  %89 = fmul contract double %57, %62
  %90 = fmul contract double %89, %71
  %91 = fadd contract double %90, %88
  %92 = fmul contract double %80, %91
  %93 = fadd contract double %76, %92
  store double %93, double addrspace(1)* %75, align 16, !tbaa !7
  ...
  %96 = load double, double addrspace(1)* %78, align 8, !tbaa !10
  %97 = fmul contract double %96, %7
  %98 = fmul contract double %86, %69
  %99 = fmul contract double %89, %69
  %100 = fadd contract double %98, %99
  %101 = fmul contract double %81, %71
  %102 = fsub contract double %100, %101
  %103 = fmul contract double %83, %71
  %104 = fadd contract double %103, %102
  %105 = fmul contract double %104, %97
  %106 = fadd contract double %95, %105
  store double %106, double addrspace(1)* %94, align 8, !tbaa !7
  %107 = mul i32 %51, %9
  %108 = add i32 %107, %73
  ...
  %111 = load double, double addrspace(1)* %110, align 16, !tbaa !7
  %112 = load double, double addrspace(1)* %78, align 8, !tbaa !10
  %113 = fmul contract double %62, %69
  %114 = fmul contract double %64, %71
  %115 = fadd contract double %113, %114
  %116 = fmul contract double %115, %112
  %117 = fadd contract double %111, %116
  store double %117, double addrspace(1)* %110, align 16, !tbaa !7
  ...
  %120 = load double, double addrspace(1)* %78, align 8, !tbaa !10
  %121 = fmul contract double %64, %69
  %122 = fmul contract double %62, %71
  %123 = fsub contract double %121, %122
  %124 = fmul contract double %123, %120
  %125 = fadd contract double %119, %124
  store double %125, double addrspace(1)* %118, align 8, !tbaa !7

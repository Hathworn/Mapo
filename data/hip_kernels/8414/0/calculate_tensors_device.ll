; ModuleID = '../data/hip_kernels/8414/0/main.cu'
source_filename = "../data/hip_kernels/8414/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z17calculate_tensorsPdPKdS1_ii(double addrspace(1)* nocapture %0, double addrspace(1)* nocapture readonly %1, double addrspace(1)* nocapture readonly %2, i32 %3, i32 %4) local_unnamed_addr #0 {
...
35:                                               ; preds = %19
  %36 = getelementptr inbounds double, double addrspace(1)* %0, i64 %34
  %37 = and i32 %4, 3
  %38 = icmp ult i32 %4, 4
  %39 = and i32 %4, -4
  %40 = icmp eq i32 %37, 0
...
41:                                               ; preds = %35, %96
  ...
  %43 = mul nsw i32 %42, %3
  %44 = load double, double addrspace(1)* %36, align 8, !tbaa !7
...
45:                                               ; preds = %96, %19
  ...
  %50 = getelementptr inbounds double, double addrspace(1)* %2, i64 %49
  ...
  %61 = getelementptr inbounds double, double addrspace(1)* %0, i64 %34
  %62 = load double, double addrspace(1)* %61, align 8, !tbaa !7
  %63 = fdiv contract double %62, %60
  store double %63, double addrspace(1)* %61, align 8, !tbaa !7
  br label %197

64:                                               ; preds = %99, %41
  %65 = phi double [ %44, %41 ], [ %193, %99 ]
  %66 = phi i32 [ 0, %41 ], [ %194, %99 ]
  br i1 %40, label %96, label %67

67:                                               ; preds = %64, %67
  %68 = phi double [ %92, %67 ], [ %65, %64 ]
  ...
  %92 = fadd contract double %68, %91
  store double %92, double addrspace(1)* %36, align 8, !tbaa !7
...
99:                                               ; preds = %41, %99
  ...
  %118 = fmul contract double %113, %117
  %119 = add i32 %104, %30
  ...
  %124 = fadd contract double %100, %123
  store double %124, double addrspace(1)* %36, align 8, !tbaa !7
  %125 = or i32 %101, 1
  %126 = mul i32 %17, %125
  %127 = add i32 %126, %43
  %128 = add i32 %127, %24
  ...
  %140 = load double, double addrspace(1)* %139, align 8, !tbaa !7
  ...
  %147 = fadd contract double %124, %146
  store double %147, double addrspace(1)* %36, align 8, !tbaa !7
  %148 = or i32 %101, 2
  %149 = mul i32 %17, %148
  %150 = add i32 %149, %43
  %151 = add i32 %150, %24
  ...
  %182 = fmul contract double %177, %181
  %183 = add i32 %173, %32
  %184 = zext i32 %183 to i64
  %185 = getelementptr inbounds double, double addrspace(1)* %1, i64 %184
  %186 = load double, double addrspace(1)* %185, align 8, !tbaa !7
  %187 = fmul contract double %182, %186
  %188 = add i32 %173, %30
  %189 = zext i32 %188 to i64
  %190 = getelementptr inbounds double, double addrspace(1)* %1, i64 %189
  %191 = load double, double addrspace(1)* %190, align 8, !tbaa !7
  %192 = fmul contract double %187, %191
  %193 = fadd contract double %170, %192
  store double %193, double addrspace(1)* %36, align 8, !tbaa !7

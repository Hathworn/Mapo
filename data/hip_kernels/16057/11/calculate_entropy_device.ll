; ModuleID = '../data/hip_kernels/16057/11/main.cu'
source_filename = "../data/hip_kernels/16057/11/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [12 x i8] c"entropy %f\0A\00", align 1
...
define protected amdgpu_kernel void @_Z17calculate_entropyPfS_ifi(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture %1, i32 %2, float %3, i32 %4) local_unnamed_addr #1 {
...
26:                                               ; preds = %5
  ...
  %30 = fcmp contract une float %29, 0.000000e+00
  br i1 %30, label %31, label %48

31:                                               ; preds = %26
  %32 = tail call i1 @llvm.amdgcn.class.f32(float %29, i32 144)
  %33 = select i1 %32, float 0x41F0000000000000, float 1.000000e+00
  %34 = fmul float %29, %33
  %35 = tail call float @llvm.log2.f32(float %34)
  %36 = fmul float %35, 0x3FD3441340000000
  %37 = tail call i1 @llvm.amdgcn.class.f32(float %35, i32 519)
  %38 = fneg float %36
  %39 = tail call float @llvm.fma.f32(float %35, float 0x3FD3441340000000, float %38)
  %40 = tail call float @llvm.fma.f32(float %35, float 0x3E509F79E0000000, float %39)
  %41 = fadd float %36, %40
  %42 = select i1 %37, float %35, float %41
  %43 = select i1 %32, float 0x4023441360000000, float 0.000000e+00
  %44 = fsub float %42, %43
  %45 = fneg contract float %29
  %46 = fmul contract float %44, %45
  %47 = getelementptr inbounds float, float addrspace(1)* %1, i64 %27
...
53:                                               ; preds = %68, %48
  %54 = icmp eq i32 %24, 0
  br i1 %54, label %70, label %533

55:                                               ; preds = %50, %68
  %56 = phi i32 [ 1, %50 ], [ %57, %68 ]
  %57 = shl nsw i32 %56, 1
  %58 = add i32 %57, 1023
  %59 = and i32 %58, %6
  %60 = icmp eq i32 %59, 0
...
61:                                               ; preds = %55
  ...
  %66 = load float, float addrspace(1)* %52, align 4, !tbaa !7
  %67 = fadd contract float %65, %66
  store float %67, float addrspace(1)* %52, align 4, !tbaa !7
  br label %68
...
68:                                               ; preds = %61, %55
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %69 = icmp slt i32 %57, %4
  br i1 %69, label %55, label %53, !llvm.loop !11

70:                                               ; preds = %53
  %71 = load float, float addrspace(1)* %1, align 4, !tbaa !7
  ...
  %76 = load i64, i64 addrspace(4)* %75, align 8, !tbaa !13
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([12 x i8], [12 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %81, label %85
...
104:                                              ; preds = %89
  %105 = load i8, i8 addrspace(4)* %91, align 1, !tbaa !17
...
464:                                              ; preds = %457
  %465 = load i8, i8 addrspace(4)* %458, align 1, !tbaa !17
...
502:                                              ; preds = %462, %502
  ...
  %507 = load i8, i8 addrspace(4)* %506, align 1, !tbaa !17

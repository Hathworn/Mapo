; ModuleID = '../data/hip_kernels/16057/28/main.cu'
source_filename = "../data/hip_kernels/16057/28/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [3 x i8] c"%f\00", align 1
...
define protected amdgpu_kernel void @_Z6JumlahPfS_(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture readonly %1) local_unnamed_addr #1 {
  ...
  br i1 %12, label %13, label %476

13:                                               ; preds = %2
  %14 = load float, float addrspace(1)* %1, align 4, !tbaa !7, !amdgpu.noclobber !5
  ...
  %19 = load i64, i64 addrspace(4)* %18, align 8, !tbaa !11
  %20 = inttoptr i64 %19 to i8 addrspace(1)*
  %21 = addrspacecast i8 addrspace(1)* %20 to i8*
  %22 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %21, i64 noundef 33, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %23 = extractelement <2 x i64> %22, i64 0
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([3 x i8], [3 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %24, label %28

24:                                               ; preds = %13
  %25 = and i64 %23, -225
  %26 = or i64 %25, 32
  %27 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %21, i64 noundef %26, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  br label %469
...
107:                                              ; preds = %100
  %108 = load i8, i8 addrspace(4)* %101, align 1, !tbaa !15
...
167:                                              ; preds = %160
  %168 = load i8, i8 addrspace(4)* %161, align 1, !tbaa !15
...
227:                                              ; preds = %220
  %228 = load i8, i8 addrspace(4)* %221, align 1, !tbaa !15
...
287:                                              ; preds = %280
  %288 = load i8, i8 addrspace(4)* %281, align 1, !tbaa !15
...
347:                                              ; preds = %340
  %348 = load i8, i8 addrspace(4)* %341, align 1, !tbaa !15
...
407:                                              ; preds = %400
  %408 = load i8, i8 addrspace(4)* %401, align 1, !tbaa !15
...
458:                                              ; preds = %445, %407, %405
  ...
  %463 = and i64 %43, -225
  %464 = or i64 %463, %462
  %465 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %21, i64 noundef %464, i64 noundef %103, i64 noundef %163, i64 noundef %223, i64 noundef %283, i64 noundef %343, i64 noundef %403, i64 noundef %459) #10
  %466 = sub i64 %33, %41
...
469:                                              ; preds = %458, %24
  ...
  %472 = bitcast double %15 to i64
  %473 = and i64 %471, -227
  %474 = or i64 %473, 34
  %475 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %21, i64 noundef %474, i64 noundef %472, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  br label %476

476:                                              ; preds = %469, %2
  %477 = sext i32 %11 to i64
  %478 = getelementptr inbounds float, float addrspace(1)* %1, i64 %477
  %479 = load float, float addrspace(1)* %478, align 4, !tbaa !7
  %480 = atomicrmw fadd float addrspace(1)* %0, float %479 syncscope("agent-one-as") monotonic, align 4
  ret void
}

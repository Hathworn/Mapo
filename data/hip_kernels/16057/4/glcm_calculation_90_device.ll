; ModuleID = '../data/hip_kernels/16057/4/main.cu'
source_filename = "../data/hip_kernels/16057/4/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z19glcm_calculation_90PiS_iii(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture %1, i32 %2, i32 %3, i32 %4) local_unnamed_addr #0 {
...
47:                                               ; preds = %38
  %48 = load i32, i32 addrspace(1)* %29, align 4, !tbaa !7
  %49 = mul nsw i32 %48, %4
...
62:                                               ; preds = %55
  %63 = load i32, i32 addrspace(1)* %29, align 4, !tbaa !7
  %64 = mul nsw i32 %63, %4
...
77:                                               ; preds = %70
  %78 = load i32, i32 addrspace(1)* %29, align 4, !tbaa !7
  %79 = mul nsw i32 %78, %4
...
92:                                               ; preds = %85
  %93 = load i32, i32 addrspace(1)* %29, align 4, !tbaa !7
  %94 = mul nsw i32 %93, %4
...
115:                                              ; preds = %106
  %116 = load i32, i32 addrspace(1)* %29, align 4, !tbaa !7

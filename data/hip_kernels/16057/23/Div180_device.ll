; ModuleID = '../data/hip_kernels/16057/23/main.cu'
source_filename = "../data/hip_kernels/16057/23/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: mustprogress nofree norecurse nounwind
define protected amdgpu_kernel void @_Z6Div180PiS_iii(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture %1, i32 %2, i32 %3, i32 %4) local_unnamed_addr #0 {
...
56:                                               ; preds = %51
  %57 = load i32, i32 addrspace(1)* %29, align 4, !tbaa !7
  %58 = mul nsw i32 %57, %2
  ...
  %64 = load i32, i32 addrspace(1)* %35, align 4, !tbaa !7
  %65 = mul nsw i32 %64, %2
...
82:                                               ; preds = %77
  %83 = load i32, i32 addrspace(1)* %29, align 4, !tbaa !7
  %84 = mul nsw i32 %83, %2
  ...
  %90 = load i32, i32 addrspace(1)* %35, align 4, !tbaa !7
  %91 = mul nsw i32 %90, %2
...
106:                                              ; preds = %101
  %107 = load i32, i32 addrspace(1)* %29, align 4, !tbaa !7
  ...
  %114 = load i32, i32 addrspace(1)* %35, align 4, !tbaa !7

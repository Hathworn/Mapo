; ModuleID = '../data/hip_kernels/13936/9/main.cu'
source_filename = "../data/hip_kernels/13936/9/main.cu"
...
@ushort2_tex = protected addrspace(1) externally_initialized global %struct.texture.2 undef, align 8
@llvm.compiler.used = appending addrspace(1) global [1 x i8*] [i8* addrspacecast (i8 addrspace(1)* bitcast (%struct.texture.2 addrspace(1)* @ushort2_tex to i8 addrspace(1)*) to i8*)], section "llvm.metadata"

; Function Attrs: mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z17Thumbnail_ushort2Piii(i32 addrspace(1)* nocapture %0, i32 %1, i32 %2) local_unnamed_addr #0 {
...
24:                                               ; preds = %3
  %25 = load %struct.__hip_texture*, %struct.__hip_texture* addrspace(1)* getelementptr inbounds (%struct.texture.2, %struct.texture.2 addrspace(1)* @ushort2_tex, i64 0, i32 0, i32 11), align 8
  ...
  %68 = extractelement <4 x i32> %66, i64 1
  %69 = and i32 %68, 65408
  %70 = and i32 %67, 65408

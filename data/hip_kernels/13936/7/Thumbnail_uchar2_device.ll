; ModuleID = '../data/hip_kernels/13936/7/main.cu'
source_filename = "../data/hip_kernels/13936/7/main.cu"
...
define protected amdgpu_kernel void @_Z16Thumbnail_uchar2Piii(i32 addrspace(1)* nocapture %0, i32 %1, i32 %2) local_unnamed_addr #0 {
...
24:                                               ; preds = %3
  %25 = load %struct.__hip_texture*, %struct.__hip_texture* addrspace(1)* getelementptr inbounds (%struct.texture.0, %struct.texture.0 addrspace(1)* @uchar2_tex, i64 0, i32 0, i32 11), align 8

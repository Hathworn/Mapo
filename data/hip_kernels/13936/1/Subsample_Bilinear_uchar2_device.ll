; ModuleID = '../data/hip_kernels/13936/1/main.cu'
source_filename = "../data/hip_kernels/13936/1/main.cu"
...
@uchar2_tex = protected addrspace(1) externally_initialized global %struct.texture.0 undef, align 8
...
@llvm.compiler.used = appending addrspace(1) global [1 x i8*] [i8* addrspacecast (i8 addrspace(1)* bitcast (%struct.texture.0 addrspace(1)* @uchar2_tex to i8 addrspace(1)*) to i8*)], section "llvm.metadata"

; Function Attrs: mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z25Subsample_Bilinear_uchar2P15HIP_vector_typeIhLj2EEiiiii(%struct.HIP_vector_type addrspace(1)* nocapture writeonly %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) local_unnamed_addr #0 {
...
27:                                               ; preds = %6
  ...
  %52 = load %struct.__hip_texture*, %struct.__hip_texture* addrspace(1)* getelementptr inbounds (%struct.texture.0, %struct.texture.0 addrspace(1)* @uchar2_tex, i64 0, i32 0, i32 11), align 8

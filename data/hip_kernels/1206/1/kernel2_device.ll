; ModuleID = '../data/hip_kernels/1206/1/main.cu'
source_filename = "../data/hip_kernels/1206/1/main.cu"
...
define protected amdgpu_kernel void @_Z7kernel2iPi(i32 %0, i32 addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
  %3 = icmp sgt i32 %0, 0
...
12:                                               ; preds = %9, %12
  ...
  store i32 %13, i32 addrspace(1)* %16, align 4, !tbaa !4

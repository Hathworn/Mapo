; ModuleID = '../data/hip_kernels/6809/14/main.cu'
source_filename = "../data/hip_kernels/6809/14/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z3AddPfmmff(float addrspace(1)* nocapture %0, i64 %1, i64 %2, float %3, float %4) local_unnamed_addr #0 {
...
32:                                               ; preds = %20, %32
  ...
  %43 = fadd contract float %38, %42
  store float %43, float addrspace(1)* %40, align 4, !tbaa !16
  %44 = add i32 %30, %34
  %45 = sext i32 %44 to i64
  %46 = icmp ult i64 %45, %2
  br i1 %46, label %32, label %31, !llvm.loop !20
}

; ModuleID = '../data/hip_kernels/6809/30/main.cu'
source_filename = "../data/hip_kernels/6809/30/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z11GreaterThanPfPbmmm(float addrspace(1)* nocapture readonly %0, i8 addrspace(1)* nocapture writeonly %1, i64 %2, i64 %3, i64 %4) local_unnamed_addr #0 {
...
33:                                               ; preds = %20, %33
  ...
  %45 = zext i1 %42 to i8
  store i8 %45, i8 addrspace(1)* %44, align 1, !tbaa !20
  %46 = add i32 %31, %35
  %47 = sext i32 %46 to i64
  %48 = icmp ult i64 %47, %4
  br i1 %48, label %33, label %32, !llvm.loop !22
}

; ModuleID = '../data/hip_kernels/12709/0/main.cu'
source_filename = "../data/hip_kernels/12709/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z18matMul_CUDA_doublePdiS_S_(double addrspace(1)* nocapture %0, i32 %1, double addrspace(1)* nocapture readonly %2, double addrspace(1)* nocapture readonly %3) local_unnamed_addr #0 {
...
18:                                               ; preds = %4
  ...
  %22 = load double, double addrspace(1)* %21, align 8, !tbaa !7
  %23 = and i32 %1, 3
  %24 = icmp ult i32 %1, 4
...
27:                                               ; preds = %27, %25
  ...
  %39 = getelementptr inbounds double, double addrspace(1)* %3, i64 %38
  %40 = load double, double addrspace(1)* %39, align 8, !tbaa !7
  %41 = fmul contract double %35, %40
  %42 = fadd contract double %28, %41
  store double %42, double addrspace(1)* %21, align 8, !tbaa !7
  %43 = or i32 %29, 1
  %44 = add i32 %43, %13
  %45 = sub i32 %44, %19
  ...
  store double %55, double addrspace(1)* %21, align 8, !tbaa !7
  %56 = or i32 %29, 2
  %57 = add i32 %56, %13
  %58 = sub i32 %57, %19
  ...
  %68 = fadd contract double %55, %67
  store double %68, double addrspace(1)* %21, align 8, !tbaa !7
  %69 = or i32 %29, 3
  %70 = add i32 %69, %13
  %71 = sub i32 %70, %19
  ...
  %80 = fmul contract double %74, %79
  %81 = fadd contract double %68, %80
  store double %81, double addrspace(1)* %21, align 8, !tbaa !7
...
85:                                               ; preds = %27, %18
  %86 = phi double [ %22, %18 ], [ %81, %27 ]
  %87 = phi i32 [ 0, %18 ], [ %82, %27 ]
  %88 = icmp eq i32 %23, 0
  br i1 %88, label %108, label %89

89:                                               ; preds = %85, %89
  %90 = phi double [ %104, %89 ], [ %86, %85 ]
  ...
  %101 = getelementptr inbounds double, double addrspace(1)* %3, i64 %100
  %102 = load double, double addrspace(1)* %101, align 8, !tbaa !7
  %103 = fmul contract double %97, %102
  %104 = fadd contract double %90, %103
  store double %104, double addrspace(1)* %21, align 8, !tbaa !7

; ModuleID = '../data/hip_kernels/191/10/main.cu'
source_filename = "../data/hip_kernels/191/10/main.cu"
...
@dprs_r8 = external hidden local_unnamed_addr addrspace(3) global [0 x double], align 8
...
define protected amdgpu_kernel void @_Z26gpu_array_dot_product_r8__mPKdS0_PVd(i64 %0, double addrspace(1)* nocapture readonly %1, double addrspace(1)* nocapture readonly %2, double addrspace(1)* %3) local_unnamed_addr #0 {
  %5 = addrspacecast double addrspace(1)* %3 to double*
...
28:                                               ; preds = %20, %28
  %29 = phi double [ 0.000000e+00, %20 ], [ %36, %28 ]
  ...
  %33 = getelementptr inbounds double, double addrspace(1)* %2, i64 %30
...
39:                                               ; preds = %28, %4
  %40 = phi double [ 0.000000e+00, %4 ], [ %36, %28 ]
  %41 = getelementptr inbounds [0 x double], [0 x double] addrspace(3)* @dprs_r8, i32 0, i32 %16
...
49:                                               ; preds = %43
  %50 = getelementptr inbounds [0 x double], [0 x double] addrspace(3)* @dprs_r8, i32 0, i32 %47
  %51 = load double, double addrspace(3)* %50, align 8, !tbaa !16
  %52 = getelementptr inbounds [0 x double], [0 x double] addrspace(3)* @dprs_r8, i32 0, i32 %46
  %53 = load double, double addrspace(3)* %52, align 8, !tbaa !16
  %54 = fadd contract double %51, %53
  store double %54, double addrspace(3)* %52, align 8, !tbaa !16
  br label %55
...
62:                                               ; preds = %59
  %63 = load double, double addrspace(3)* getelementptr inbounds ([0 x double], [0 x double] addrspace(3)* @dprs_r8, i32 0, i32 0), align 8, !tbaa !16
  %64 = load volatile double, double* %5, align 8, !tbaa !16
  %65 = fadd contract double %63, %64
  store volatile double %65, double* %5, align 8, !tbaa !16

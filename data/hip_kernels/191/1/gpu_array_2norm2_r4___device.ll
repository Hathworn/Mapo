; ModuleID = '../data/hip_kernels/191/1/main.cu'
source_filename = "../data/hip_kernels/191/1/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@thread_norms2_r4 = external hidden local_unnamed_addr addrspace(3) global [0 x float], align 4

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z21gpu_array_2norm2_r4__mPKfPf(i64 %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture %2) local_unnamed_addr #0 {
...
25:                                               ; preds = %3, %25
  %26 = phi float [ %31, %25 ], [ 0.000000e+00, %3 ]
...
34:                                               ; preds = %25, %3
  %35 = phi float [ 0.000000e+00, %3 ], [ %31, %25 ]
  %36 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @thread_norms2_r4, i32 0, i32 %21
  store float %35, float addrspace(3)* %36, align 4, !tbaa !16
...
38:                                               ; preds = %34
  %39 = load float, float addrspace(3)* getelementptr inbounds ([0 x float], [0 x float] addrspace(3)* @thread_norms2_r4, i32 0, i32 0), align 4, !tbaa !16
  %40 = zext i32 %17 to i64
  %41 = getelementptr inbounds float, float addrspace(1)* %2, i64 %40
  store float %39, float addrspace(1)* %41, align 4, !tbaa !16
...
51:                                               ; preds = %51, %49
  %52 = phi float [ %39, %49 ], [ %93, %51 ]
  %53 = phi i64 [ 1, %49 ], [ %94, %51 ]
  %54 = phi i64 [ 0, %49 ], [ %95, %51 ]
  %55 = trunc i64 %53 to i32
  %56 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @thread_norms2_r4, i32 0, i32 %55
  %57 = load float, float addrspace(3)* %56, align 4, !tbaa !16
  %58 = fadd contract float %57, %52
  %59 = trunc i64 %53 to i32
  %60 = add i32 %59, 1
  %61 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @thread_norms2_r4, i32 0, i32 %60
  %62 = load float, float addrspace(3)* %61, align 4, !tbaa !16
  %63 = fadd contract float %62, %58
  %64 = trunc i64 %53 to i32
  %65 = add i32 %64, 2
  %66 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @thread_norms2_r4, i32 0, i32 %65
  %67 = load float, float addrspace(3)* %66, align 4, !tbaa !16
  %68 = fadd contract float %67, %63
  %69 = trunc i64 %53 to i32
  %70 = add i32 %69, 3
  %71 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @thread_norms2_r4, i32 0, i32 %70
  %72 = load float, float addrspace(3)* %71, align 4, !tbaa !16
  %73 = fadd contract float %72, %68
  %74 = trunc i64 %53 to i32
  %75 = add i32 %74, 4
  %76 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @thread_norms2_r4, i32 0, i32 %75
  %77 = load float, float addrspace(3)* %76, align 4, !tbaa !16
  %78 = fadd contract float %77, %73
  %79 = trunc i64 %53 to i32
  %80 = add i32 %79, 5
  %81 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @thread_norms2_r4, i32 0, i32 %80
  %82 = load float, float addrspace(3)* %81, align 4, !tbaa !16
  %83 = fadd contract float %82, %78
  %84 = trunc i64 %53 to i32
  %85 = add i32 %84, 6
  %86 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @thread_norms2_r4, i32 0, i32 %85
  %87 = load float, float addrspace(3)* %86, align 4, !tbaa !16
  %88 = fadd contract float %87, %83
  %89 = trunc i64 %53 to i32
  %90 = add i32 %89, 7
  %91 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @thread_norms2_r4, i32 0, i32 %90
...
97:                                               ; preds = %51, %44
  %98 = phi float [ undef, %44 ], [ %93, %51 ]
  %99 = phi float [ %39, %44 ], [ %93, %51 ]
  %100 = phi i64 [ 1, %44 ], [ %94, %51 ]
  %101 = icmp eq i64 %47, 0
  br i1 %101, label %113, label %102

102:                                              ; preds = %97, %102
  %103 = phi float [ %109, %102 ], [ %99, %97 ]
  %104 = phi i64 [ %110, %102 ], [ %100, %97 ]
  %105 = phi i64 [ %111, %102 ], [ 0, %97 ]
  %106 = trunc i64 %104 to i32
  %107 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @thread_norms2_r4, i32 0, i32 %106
  %108 = load float, float addrspace(3)* %107, align 4, !tbaa !16
  %109 = fadd contract float %108, %103
...
113:                                              ; preds = %102, %97
  %114 = phi float [ %98, %97 ], [ %109, %102 ]
  store float %114, float addrspace(1)* %41, align 4, !tbaa !16
  br label %115

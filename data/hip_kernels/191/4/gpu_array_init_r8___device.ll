; ModuleID = '../data/hip_kernels/191/4/main.cu'
source_filename = "../data/hip_kernels/191/4/main.cu"
...
define protected amdgpu_kernel void @_Z19gpu_array_init_r8__mPdd(i64 %0, double addrspace(1)* nocapture writeonly %1, double %2) local_unnamed_addr #0 {
...
26:                                               ; preds = %3, %26
  %27 = phi i64 [ %29, %26 ], [ %16, %3 ]
  %28 = getelementptr inbounds double, double addrspace(1)* %1, i64 %27
  store double %2, double addrspace(1)* %28, align 8, !tbaa !16
  %29 = add i64 %27, %23
  %30 = icmp ult i64 %29, %0
  br i1 %30, label %26, label %25, !llvm.loop !20
}

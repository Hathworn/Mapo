; ModuleID = '../data/hip_kernels/191/3/main.cu'
source_filename = "../data/hip_kernels/191/3/main.cu"
...
define protected amdgpu_kernel void @_Z19gpu_array_init_r4__mPff(i64 %0, float addrspace(1)* nocapture writeonly %1, float %2) local_unnamed_addr #0 {
...
26:                                               ; preds = %3, %26
  ...
  store float %2, float addrspace(1)* %28, align 4, !tbaa !16
  %29 = add i64 %27, %23

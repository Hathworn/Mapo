; ModuleID = '../data/hip_kernels/18086/3/main.cu'
source_filename = "../data/hip_kernels/18086/3/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z11cuda_dividePfS_S_ii(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, i32 %3, i32 %4) local_unnamed_addr #0 {
...
26:                                               ; preds = %5
  ...
  %33 = fcmp contract ogt double %32, 0x3E7AD7F29ABCAF48
  br i1 %33, label %34, label %38

34:                                               ; preds = %26
  %35 = getelementptr inbounds float, float addrspace(1)* %1, i64 %29
  %36 = load float, float addrspace(1)* %35, align 4, !tbaa !7, !amdgpu.noclobber !6
  %37 = fdiv contract float %36, %31
  br label %38

38:                                               ; preds = %26, %34
  %39 = phi float [ %37, %34 ], [ 0.000000e+00, %26 ]
  %40 = getelementptr inbounds float, float addrspace(1)* %0, i64 %29

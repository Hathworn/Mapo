; ModuleID = '../data/hip_kernels/11832/145/main.cu'
source_filename = "../data/hip_kernels/11832/145/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ22transposeSmemUnrollPadPfS_iiE4tile = internal unnamed_addr addrspace(3) global [544 x float] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z22transposeSmemUnrollPadPfS_ii(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3) local_unnamed_addr #0 {
...
40:                                               ; preds = %4
  ...
  %48 = getelementptr inbounds [544 x float], [544 x float] addrspace(3)* @_ZZ22transposeSmemUnrollPadPfS_iiE4tile, i32 0, i32 %44
  ...
  %53 = add nuw nsw i32 %44, 16
  %54 = getelementptr inbounds [544 x float], [544 x float] addrspace(3)* @_ZZ22transposeSmemUnrollPadPfS_iiE4tile, i32 0, i32 %53
  ...
  %57 = getelementptr inbounds [544 x float], [544 x float] addrspace(3)* @_ZZ22transposeSmemUnrollPadPfS_iiE4tile, i32 0, i32 %56
  ...
  %62 = getelementptr inbounds [544 x float], [544 x float] addrspace(3)* @_ZZ22transposeSmemUnrollPadPfS_iiE4tile, i32 0, i32 %61

; ModuleID = '../data/hip_kernels/11832/28/main.cu'
source_filename = "../data/hip_kernels/11832/28/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [81 x i8] c"thread_id (%d,%d) block_id (%d,%d) coordinate (%d,%d) global index %2d ival %2d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z16printThreadIndexPiii(i32 addrspace(1)* nocapture readonly %0, i32 %1, i32 %2) local_unnamed_addr #1 {
  ...
  %29 = load i64, i64 addrspace(4)* %28, align 8, !tbaa !11
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([81 x i8], [81 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %34, label %38
...
42:                                               ; preds = %468, %38
  %43 = phi i64 [ select (i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([81 x i8], [81 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), i64 0, i64 add (i64 ptrtoint (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([81 x i8], [81 x i8] addrspace(4)* @.str, i64 0, i64 80) to i8*) to i64), i64 add (i64 sub (i64 0, i64 ptrtoint ([81 x i8]* addrspacecast ([81 x i8] addrspace(4)* @.str to [81 x i8]*) to i64)), i64 1))), %38 ], [ %476, %468 ]
  %44 = phi i8 addrspace(4)* [ getelementptr inbounds ([81 x i8], [81 x i8] addrspace(4)* @.str, i64 0, i64 0), %38 ], [ %477, %468 ]
...
57:                                               ; preds = %42
  %58 = load i8, i8 addrspace(4)* %44, align 1, !tbaa !15
  %59 = zext i8 %58 to i64
  %60 = getelementptr inbounds i8, i8 addrspace(4)* %44, i64 1
  %61 = load i8, i8 addrspace(4)* %60, align 1, !tbaa !15
...
117:                                              ; preds = %110
  %118 = load i8, i8 addrspace(4)* %111, align 1, !tbaa !15
...
177:                                              ; preds = %170
  %178 = load i8, i8 addrspace(4)* %171, align 1, !tbaa !15
...
237:                                              ; preds = %230
  %238 = load i8, i8 addrspace(4)* %231, align 1, !tbaa !15
...
297:                                              ; preds = %290
  %298 = load i8, i8 addrspace(4)* %291, align 1, !tbaa !15
...
357:                                              ; preds = %350
  %358 = load i8, i8 addrspace(4)* %351, align 1, !tbaa !15
...
417:                                              ; preds = %410
  %418 = load i8, i8 addrspace(4)* %411, align 1, !tbaa !15
...
455:                                              ; preds = %415, %455
  ...
  %460 = load i8, i8 addrspace(4)* %459, align 1, !tbaa !15
...
479:                                              ; preds = %468, %34
  ...
  %482 = zext i32 %4 to i64
  %483 = and i64 %481, -225
  %484 = or i64 %483, 32
  %485 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %484, i64 noundef %482, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %486 = extractelement <2 x i64> %485, i64 0
  %487 = zext i32 %13 to i64
  %488 = and i64 %486, -225
  %489 = or i64 %488, 32
  %490 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %489, i64 noundef %487, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %491 = extractelement <2 x i64> %490, i64 0
  %492 = zext i32 %5 to i64
  %493 = and i64 %491, -225
  %494 = or i64 %493, 32
  %495 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %494, i64 noundef %492, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %496 = extractelement <2 x i64> %495, i64 0
  %497 = zext i32 %14 to i64
  %498 = and i64 %496, -225
  %499 = or i64 %498, 32
  %500 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %499, i64 noundef %497, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %501 = extractelement <2 x i64> %500, i64 0
  %502 = zext i32 %12 to i64
  %503 = and i64 %501, -225
  %504 = or i64 %503, 32
  %505 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %504, i64 noundef %502, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %506 = extractelement <2 x i64> %505, i64 0
  %507 = zext i32 %20 to i64
  %508 = and i64 %506, -225
  %509 = or i64 %508, 32
  %510 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %509, i64 noundef %507, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %511 = extractelement <2 x i64> %510, i64 0
  %512 = and i64 %511, -225
  %513 = or i64 %512, 32
  %514 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %31, i64 noundef %513, i64 noundef %23, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10

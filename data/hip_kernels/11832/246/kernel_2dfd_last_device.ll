; ModuleID = '../data/hip_kernels/11832/246/main.cu'
source_filename = "../data/hip_kernels/11832/246/main.cu"
...
@_ZZ16kernel_2dfd_lastPfS_iiiE4tile = internal unnamed_addr addrspace(3) global [24 x float] undef, align 16
...
define protected amdgpu_kernel void @_Z16kernel_2dfd_lastPfS_iii(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3, i32 %4) local_unnamed_addr #0 {
...
19:                                               ; preds = %5
  ...
  %66 = getelementptr inbounds [24 x float], [24 x float] addrspace(3)* @_ZZ16kernel_2dfd_lastPfS_iiiE4tile, i32 0, i32 %13
  %67 = add nuw nsw i32 %13, 20
  %68 = getelementptr inbounds [24 x float], [24 x float] addrspace(3)* @_ZZ16kernel_2dfd_lastPfS_iiiE4tile, i32 0, i32 %67
  %69 = getelementptr inbounds [24 x float], [24 x float] addrspace(3)* @_ZZ16kernel_2dfd_lastPfS_iiiE4tile, i32 0, i32 %20
  ...
  %77 = getelementptr inbounds [24 x float], [24 x float] addrspace(3)* @_ZZ16kernel_2dfd_lastPfS_iiiE4tile, i32 0, i32 %76
  %78 = add nuw nsw i32 %13, 5
  %79 = getelementptr inbounds [24 x float], [24 x float] addrspace(3)* @_ZZ16kernel_2dfd_lastPfS_iiiE4tile, i32 0, i32 %78
  ...
  %82 = getelementptr inbounds [24 x float], [24 x float] addrspace(3)* @_ZZ16kernel_2dfd_lastPfS_iiiE4tile, i32 0, i32 %81
  %83 = add nuw nsw i32 %13, 6
  %84 = getelementptr inbounds [24 x float], [24 x float] addrspace(3)* @_ZZ16kernel_2dfd_lastPfS_iiiE4tile, i32 0, i32 %83
  ...
  %87 = getelementptr inbounds [24 x float], [24 x float] addrspace(3)* @_ZZ16kernel_2dfd_lastPfS_iiiE4tile, i32 0, i32 %86
  %88 = add nuw nsw i32 %13, 7
  %89 = getelementptr inbounds [24 x float], [24 x float] addrspace(3)* @_ZZ16kernel_2dfd_lastPfS_iiiE4tile, i32 0, i32 %88
  ...
  %92 = getelementptr inbounds [24 x float], [24 x float] addrspace(3)* @_ZZ16kernel_2dfd_lastPfS_iiiE4tile, i32 0, i32 %91
  br label %94

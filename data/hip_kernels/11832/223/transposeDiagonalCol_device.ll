; ModuleID = '../data/hip_kernels/11832/223/main.cu'
source_filename = "../data/hip_kernels/11832/223/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z20transposeDiagonalColPfS_ii(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3) local_unnamed_addr #0 {
  ...
  %24 = add i32 %22, %23
  %25 = getelementptr i8, i8 addrspace(4)* %8, i64 6
  %26 = bitcast i8 addrspace(4)* %25 to i16 addrspace(4)*
  %27 = load i16, i16 addrspace(4)* %26, align 2, !range !13, !invariant.load !14
  %28 = zext i16 %27 to i32
  %29 = mul i32 %5, %28
  %30 = tail call i32 @llvm.amdgcn.workitem.id.y(), !range !15
  %31 = add i32 %29, %30
  %32 = icmp ult i32 %24, %2
...
35:                                               ; preds = %4
  ...
  store float %40, float addrspace(1)* %44, align 4, !tbaa !16
  br label %45

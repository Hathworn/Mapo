; ModuleID = '../data/hip_kernels/11832/212/main.cu'
source_filename = "../data/hip_kernels/11832/212/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z31reduceCompleteUnrollWarps8FloatPfS_j(float addrspace(1)* %0, float addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
19:                                               ; preds = %3
  ...
  %55 = fadd contract float %22, %26
  %56 = fadd contract float %55, %31
  %57 = fadd contract float %56, %36
  %58 = fadd contract float %57, %41
  %59 = fadd contract float %58, %46
  %60 = fadd contract float %59, %51
  %61 = fadd contract float %60, %54
  store float %61, float addrspace(1)* %21, align 4, !tbaa !7
  br label %62
...
66:                                               ; preds = %62
  ...
  %72 = getelementptr inbounds float, float addrspace(1)* %15, i64 %71
...
79:                                               ; preds = %75
  ...
  %82 = getelementptr inbounds float, float addrspace(1)* %15, i64 %81
  ...
  store float %87, float addrspace(1)* %85, align 4, !tbaa !7
  br label %88
...
92:                                               ; preds = %88
  ...
  %95 = getelementptr inbounds float, float addrspace(1)* %15, i64 %94
  %96 = load float, float addrspace(1)* %95, align 4, !tbaa !7
  %97 = zext i32 %4 to i64
  %98 = getelementptr inbounds float, float addrspace(1)* %15, i64 %97
...
105:                                              ; preds = %101
  ...
  %108 = getelementptr inbounds float, float addrspace(1)* %15, i64 %107
  %109 = load float, float addrspace(1)* %108, align 4, !tbaa !7
  %110 = zext i32 %4 to i64
  %111 = getelementptr inbounds float, float addrspace(1)* %15, i64 %110
  %112 = load float, float addrspace(1)* %111, align 4, !tbaa !7
  %113 = fadd contract float %109, %112
  store float %113, float addrspace(1)* %111, align 4, !tbaa !7
  br label %114
...
116:                                              ; preds = %114
  ...
  %120 = addrspacecast float addrspace(1)* %119 to float*
  %121 = load volatile float, float* %120, align 4, !tbaa !7
  %122 = zext i32 %4 to i64
  %123 = getelementptr inbounds float, float addrspace(1)* %15, i64 %122
  %124 = addrspacecast float addrspace(1)* %123 to float*
  %125 = load volatile float, float* %124, align 4, !tbaa !7
  %126 = fadd contract float %121, %125
  store volatile float %126, float* %124, align 4, !tbaa !7
  ...
  %131 = load volatile float, float* %130, align 4, !tbaa !7
  %132 = load volatile float, float* %124, align 4, !tbaa !7
  %133 = fadd contract float %131, %132
  store volatile float %133, float* %124, align 4, !tbaa !7
  %134 = add nuw nsw i32 %4, 8
  %135 = zext i32 %134 to i64
  %136 = getelementptr inbounds float, float addrspace(1)* %15, i64 %135
  %137 = addrspacecast float addrspace(1)* %136 to float*
  %138 = load volatile float, float* %137, align 4, !tbaa !7
  %139 = load volatile float, float* %124, align 4, !tbaa !7
  %140 = fadd contract float %138, %139
  store volatile float %140, float* %124, align 4, !tbaa !7
  %141 = add nuw nsw i32 %4, 4
  %142 = zext i32 %141 to i64
  %143 = getelementptr inbounds float, float addrspace(1)* %15, i64 %142
  %144 = addrspacecast float addrspace(1)* %143 to float*
  %145 = load volatile float, float* %144, align 4, !tbaa !7
  %146 = load volatile float, float* %124, align 4, !tbaa !7
  %147 = fadd contract float %145, %146
  store volatile float %147, float* %124, align 4, !tbaa !7
  %148 = add nuw nsw i32 %4, 2
  %149 = zext i32 %148 to i64
  %150 = getelementptr inbounds float, float addrspace(1)* %15, i64 %149
  %151 = addrspacecast float addrspace(1)* %150 to float*
  %152 = load volatile float, float* %151, align 4, !tbaa !7
  %153 = load volatile float, float* %124, align 4, !tbaa !7
  %154 = fadd contract float %152, %153
  store volatile float %154, float* %124, align 4, !tbaa !7
  %155 = add nuw nsw i32 %4, 1
  %156 = zext i32 %155 to i64
  %157 = getelementptr inbounds float, float addrspace(1)* %15, i64 %156
  %158 = addrspacecast float addrspace(1)* %157 to float*
  %159 = load volatile float, float* %158, align 4, !tbaa !7
  %160 = load volatile float, float* %124, align 4, !tbaa !7
  %161 = fadd contract float %159, %160
  store volatile float %161, float* %124, align 4, !tbaa !7
  br label %162
...
164:                                              ; preds = %162
  %165 = load float, float addrspace(1)* %15, align 4, !tbaa !7

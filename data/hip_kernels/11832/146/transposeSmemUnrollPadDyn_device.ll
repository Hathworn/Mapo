; ModuleID = '../data/hip_kernels/11832/146/main.cu'
source_filename = "../data/hip_kernels/11832/146/main.cu"
...
define protected amdgpu_kernel void @_Z25transposeSmemUnrollPadDynPfS_ii(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3) local_unnamed_addr #0 {
...
42:                                               ; preds = %4
  ...
  %49 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @tile, i32 0, i32 %45
  ...
  %54 = add nuw nsw i32 %45, 16
  %55 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @tile, i32 0, i32 %54
  store float %53, float addrspace(3)* %55, align 4, !tbaa !7
  fence syncscope("workgroup") release
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %56 = mul nuw nsw i32 %31, %43
  %57 = add nuw nsw i32 %56, %29
  %58 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @tile, i32 0, i32 %57
  ...
  %62 = add nuw nsw i32 %57, 16
  %63 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @tile, i32 0, i32 %62

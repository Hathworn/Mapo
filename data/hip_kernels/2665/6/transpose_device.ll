; ModuleID = '../data/hip_kernels/2665/6/main.cu'
source_filename = "../data/hip_kernels/2665/6/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z9transposeiPd(i32 %0, double addrspace(1)* nocapture %1) local_unnamed_addr #0 {
...
34:                                               ; preds = %2
  ...
  %37 = load double, double addrspace(1)* %36, align 8, !tbaa !16, !amdgpu.noclobber !14
  %38 = mul nsw i32 %32, %0
  %39 = add nsw i32 %38, %30
  %40 = sext i32 %39 to i64
  %41 = getelementptr inbounds double, double addrspace(1)* %1, i64 %40
  %42 = load double, double addrspace(1)* %41, align 8, !tbaa !16, !amdgpu.noclobber !14
  store double %42, double addrspace(1)* %36, align 8, !tbaa !16
  store double %37, double addrspace(1)* %41, align 8, !tbaa !16
  br label %43

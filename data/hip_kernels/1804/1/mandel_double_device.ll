; ModuleID = '../data/hip_kernels/1804/1/main.cu'
source_filename = "../data/hip_kernels/1804/1/main.cu"
...
define protected amdgpu_kernel void @mandel_double(%struct.HIP_vector_type addrspace(1)* nocapture writeonly %0, i32 %1, i32 %2, i32 %3, i32 %4, double %5, double %6, double %7, i32 %8) local_unnamed_addr #0 {
...
41:                                               ; preds = %9
  %42 = shl nsw i32 %8, 8
  %43 = fdiv contract double 1.000000e+00, %7
...
49:                                               ; preds = %41
  %50 = fmul contract double %43, %46
  %51 = fdiv contract double %50, %44
  br label %52

52:                                               ; preds = %49, %41
  %53 = phi double [ %43, %49 ], [ %47, %41 ]
  %54 = phi double [ %51, %49 ], [ %43, %41 ]
  %55 = fmul contract double %54, 2.000000e+00
  %56 = add nsw i32 %3, -1
  %57 = sitofp i32 %56 to double
  %58 = fdiv contract double %55, %57
  %59 = fmul contract double %53, 2.000000e+00
  %60 = add nsw i32 %4, -1
  %61 = sitofp i32 %60 to double
  %62 = fdiv contract double %59, %61
  %63 = fsub contract double %5, %54
  %64 = fsub contract double %6, %53
  %65 = sitofp i32 %21 to double
  %66 = fmul contract double %58, %65
  %67 = fadd contract double %63, %66
  %68 = sitofp i32 %29 to double
...
72:                                               ; preds = %52, %98
  ...
  %77 = phi double [ %100, %98 ], [ %70, %52 ]
  %78 = phi double [ %99, %98 ], [ %67, %52 ]
  %79 = fmul contract double %78, %78
  %80 = fmul contract double %77, %77
  %81 = fadd contract double %79, %80
  %82 = fcmp contract ule double %81, 4.000000e+00
...
92:                                               ; preds = %72
  %93 = fmul contract double %78, 2.000000e+00
  %94 = fmul contract double %93, %77
  %95 = fadd contract double %70, %94
  %96 = fsub contract double %79, %80
  %97 = fadd contract double %67, %96
  br label %98

98:                                               ; preds = %92, %83
  %99 = phi double [ %78, %83 ], [ %97, %92 ]
  %100 = phi double [ %77, %83 ], [ %95, %92 ]

...
#include "kBoundingBoxSoftMaxGrad_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
kBoundingBoxSoftMaxGrad<<<gridBlock, threadBlock>>>(mat,bbox,label,seg,indices,width_offset,height_offset,size,width,height,depth,scale_width,scale_height,grad);

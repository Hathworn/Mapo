; ModuleID = '../data/hip_kernels/359/5/main.cu'
source_filename = "../data/hip_kernels/359/5/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z4dualPfS_S_S_j(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, i32 %4) local_unnamed_addr #0 {
  ...
  store float 0.000000e+00, float addrspace(1)* %25, align 4, !tbaa !16
...
28:                                               ; preds = %5, %28
  ...
  %38 = fadd contract float %37, %35
  store float %38, float addrspace(1)* %36, align 4, !tbaa !16
  %39 = fmul contract float %35, %35
  %40 = load float, float addrspace(1)* %25, align 4, !tbaa !16
  %41 = fadd contract float %39, %40
  store float %41, float addrspace(1)* %25, align 4, !tbaa !16
  %42 = add i32 %29, %23
  %43 = icmp ult i32 %42, %4
  br i1 %43, label %28, label %27, !llvm.loop !20
}

; ModuleID = '../data/hip_kernels/359/0/main.cu'
source_filename = "../data/hip_kernels/359/0/main.cu"
...
define protected amdgpu_kernel void @_Z7vecInitPfjf(float addrspace(1)* nocapture writeonly %0, i32 %1, float %2) local_unnamed_addr #0 {
...
24:                                               ; preds = %3, %24
  ...
  store float %2, float addrspace(1)* %27, align 4, !tbaa !16
  %28 = add i32 %25, %21

; ModuleID = '../data/hip_kernels/5094/7/main.cu'
source_filename = "../data/hip_kernels/5094/7/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z8spread_zPdS_(double addrspace(1)* nocapture %0, double addrspace(1)* nocapture readnone %1) local_unnamed_addr #0 {
  ...
  %26 = getelementptr inbounds i8, i8 addrspace(4)* %4, i64 16
  %27 = bitcast i8 addrspace(4)* %26 to i32 addrspace(4)*
  %28 = load i32, i32 addrspace(4)* %27, align 8, !tbaa !20
  %29 = getelementptr i8, i8 addrspace(4)* %4, i64 6
  ...
  store double %25, double addrspace(1)* %42, align 8, !tbaa !16
  store double 0.000000e+00, double addrspace(1)* %24, align 8, !tbaa !16
  ret void
}

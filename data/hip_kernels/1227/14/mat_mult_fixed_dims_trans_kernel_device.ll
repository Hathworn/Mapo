; ModuleID = '../data/hip_kernels/1227/14/main.cu'
source_filename = "../data/hip_kernels/1227/14/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ32mat_mult_fixed_dims_trans_kernelPiS_S_E4smem = internal unnamed_addr addrspace(3) global [128 x i32] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z32mat_mult_fixed_dims_trans_kernelPiS_S_(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  ...
  %19 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ32mat_mult_fixed_dims_trans_kernelPiS_S_E4smem, i32 0, i32 %18
...
62:                                               ; preds = %58
  ...
  %65 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ32mat_mult_fixed_dims_trans_kernelPiS_S_E4smem, i32 0, i32 %64

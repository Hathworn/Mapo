; ModuleID = '../data/hip_kernels/17763/4/main.cu'
source_filename = "../data/hip_kernels/17763/4/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [31 x i8] c"Hello, world from the device!\0A\00", align 1
...
define protected amdgpu_kernel void @_Z12hello_kernelv() local_unnamed_addr #1 {

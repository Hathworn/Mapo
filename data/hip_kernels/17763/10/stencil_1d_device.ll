; ModuleID = '../data/hip_kernels/17763/10/main.cu'
source_filename = "../data/hip_kernels/17763/10/main.cu"
...
define protected amdgpu_kernel void @_Z10stencil_1dPiS_(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
  ...
  %17 = getelementptr inbounds [262 x i32], [262 x i32] addrspace(3)* @_ZZ10stencil_1dPiS_E4temp, i32 0, i32 %13

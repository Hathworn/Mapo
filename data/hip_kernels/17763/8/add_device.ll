; ModuleID = '../data/hip_kernels/17763/8/main.cu'
source_filename = "../data/hip_kernels/17763/8/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [11 x i8] c"Result %d \00", align 1
...
define protected amdgpu_kernel void @_Z3addPiS_S_(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture writeonly %2) local_unnamed_addr #1 {
  ...
  %10 = load i64, i64 addrspace(4)* %9, align 8, !tbaa !9
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([11 x i8], [11 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %15, label %19
...
78:                                               ; preds = %36, %78
  ...
  %83 = load i8, i8 addrspace(4)* %82, align 1, !tbaa !13
...
138:                                              ; preds = %96, %138
  ...
  %143 = load i8, i8 addrspace(4)* %142, align 1, !tbaa !13
...
198:                                              ; preds = %156, %198
  ...
  %203 = load i8, i8 addrspace(4)* %202, align 1, !tbaa !13
...
258:                                              ; preds = %216, %258
  ...
  %263 = load i8, i8 addrspace(4)* %262, align 1, !tbaa !13
...
318:                                              ; preds = %276, %318
  ...
  %323 = load i8, i8 addrspace(4)* %322, align 1, !tbaa !13
...
378:                                              ; preds = %336, %378
  ...
  %383 = load i8, i8 addrspace(4)* %382, align 1, !tbaa !13
...
436:                                              ; preds = %396, %436
  ...
  %441 = load i8, i8 addrspace(4)* %440, align 1, !tbaa !13

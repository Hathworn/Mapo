; ModuleID = '../data/hip_kernels/565/5/main.cu'
source_filename = "../data/hip_kernels/565/5/main.cu"
...
42:                                               ; preds = %40
  ...
  %65 = getelementptr inbounds [266 x double], [266 x double] addrspace(3)* @_ZZ10stencil_1diPdS_E4temp, i32 0, i32 %64
  %66 = load double, double addrspace(3)* %65, align 8, !tbaa !7
  %67 = fadd contract double %63, %66
  %68 = add nuw nsw i32 %11, 7
  %69 = getelementptr inbounds [266 x double], [266 x double] addrspace(3)* @_ZZ10stencil_1diPdS_E4temp, i32 0, i32 %68
  %70 = load double, double addrspace(3)* %69, align 8, !tbaa !7
  %71 = fadd contract double %67, %70
  %72 = add nuw nsw i32 %11, 8
  %73 = getelementptr inbounds [266 x double], [266 x double] addrspace(3)* @_ZZ10stencil_1diPdS_E4temp, i32 0, i32 %72
  %74 = load double, double addrspace(3)* %73, align 8, !tbaa !7
  %75 = fadd contract double %71, %74
  %76 = add nuw nsw i32 %11, 9
  %77 = getelementptr inbounds [266 x double], [266 x double] addrspace(3)* @_ZZ10stencil_1diPdS_E4temp, i32 0, i32 %76
  %78 = load double, double addrspace(3)* %77, align 8, !tbaa !7
  %79 = fadd contract double %75, %78
  %80 = add nuw nsw i32 %11, 10
  %81 = getelementptr inbounds [266 x double], [266 x double] addrspace(3)* @_ZZ10stencil_1diPdS_E4temp, i32 0, i32 %80

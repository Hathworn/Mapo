; ModuleID = '../data/hip_kernels/13757/4/main.cu'
source_filename = "../data/hip_kernels/13757/4/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ6gpuDotPfS_S_iE5cache = internal unnamed_addr addrspace(3) global [128 x float] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z6gpuDotPfS_S_i(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, i32 %3) local_unnamed_addr #0 {
...
37:                                               ; preds = %25, %4
  ...
  %39 = getelementptr inbounds [128 x float], [128 x float] addrspace(3)* @_ZZ6gpuDotPfS_S_iE5cache, i32 0, i32 %15
...
46:                                               ; preds = %43
  ...
  %48 = getelementptr inbounds [128 x float], [128 x float] addrspace(3)* @_ZZ6gpuDotPfS_S_iE5cache, i32 0, i32 %47
...
58:                                               ; preds = %56
  %59 = load float, float addrspace(3)* getelementptr inbounds ([128 x float], [128 x float] addrspace(3)* @_ZZ6gpuDotPfS_S_iE5cache, i32 0, i32 0), align 16, !tbaa !16

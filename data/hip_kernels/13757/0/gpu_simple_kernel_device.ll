; ModuleID = '../data/hip_kernels/13757/0/main.cu'
source_filename = "../data/hip_kernels/13757/0/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [54 x i8] c"thread: %3d - block: %3d - threadIdx: %3d, warp: %3d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z17gpu_simple_kernelPfS_S_i(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2, i32 %3) local_unnamed_addr #1 {
...
15:                                               ; preds = %4
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([54 x i8], [54 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %25, label %29
...
470:                                              ; preds = %459, %25
  ...
  %488 = zext i32 %16 to i64
  %489 = and i64 %487, -227
  %490 = or i64 %489, 34
  %491 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %22, i64 noundef %490, i64 noundef %488, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %492 = sext i32 %13 to i64
  %493 = getelementptr inbounds float, float addrspace(1)* %0, i64 %492
  %494 = load float, float addrspace(1)* %493, align 4, !tbaa !14
  %495 = getelementptr inbounds float, float addrspace(1)* %1, i64 %492
  %496 = load float, float addrspace(1)* %495, align 4, !tbaa !14
  %497 = fmul contract float %494, %496
  %498 = getelementptr inbounds float, float addrspace(1)* %2, i64 %492
  store float %497, float addrspace(1)* %498, align 4, !tbaa !14
  br label %499

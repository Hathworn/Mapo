; ModuleID = '../data/hip_kernels/258/21/main.cu'
source_filename = "../data/hip_kernels/258/21/main.cu"
...
define protected amdgpu_kernel void @_Z6vecEpsPfi(float addrspace(1)* nocapture %0, i32 %1) local_unnamed_addr #0 {
  ...
  %16 = fcmp contract olt double %15, 2.220400e-16
  %17 = icmp slt i32 %11, %1
  %18 = select i1 %16, i1 %17, i1 false
  br i1 %18, label %19, label %20

19:                                               ; preds = %2
  store float 0x3CAFFFD480000000, float addrspace(1)* %13, align 4, !tbaa !7
  br label %20

; ModuleID = '../data/hip_kernels/16163/15/main.cu'
source_filename = "../data/hip_kernels/16163/15/main.cu"
...
define protected amdgpu_kernel void @_Z16set_array_doublePddm(double addrspace(1)* nocapture writeonly %0, double %1, i64 %2) local_unnamed_addr #0 {
...
26:                                               ; preds = %18, %26
  %27 = phi i64 [ %16, %18 ], [ %29, %26 ]
  %28 = getelementptr inbounds double, double addrspace(1)* %0, i64 %27
  store double %1, double addrspace(1)* %28, align 8, !tbaa !16
  %29 = add i64 %27, %25
  %30 = icmp ult i64 %29, %2
  br i1 %30, label %26, label %31, !llvm.loop !20

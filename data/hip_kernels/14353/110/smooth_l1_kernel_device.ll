; ModuleID = '../data/hip_kernels/14353/110/main.cu'
source_filename = "../data/hip_kernels/14353/110/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z16smooth_l1_kerneliPfS_S_S_(i32 %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture writeonly %3, float addrspace(1)* nocapture writeonly %4) local_unnamed_addr #0 {
...
27:                                               ; preds = %5
  ...
  %35 = fcmp contract olt float %34, 1.000000e+00
  br i1 %35, label %36, label %39

36:                                               ; preds = %27
  %37 = fmul contract float %33, %33
  %38 = getelementptr inbounds float, float addrspace(1)* %4, i64 %28
  store float %37, float addrspace(1)* %38, align 4, !tbaa !16
  br label %45

39:                                               ; preds = %27
  %40 = fmul contract float %34, 2.000000e+00
  %41 = fadd contract float %40, -1.000000e+00
  %42 = getelementptr inbounds float, float addrspace(1)* %4, i64 %28
  store float %41, float addrspace(1)* %42, align 4, !tbaa !16
  %43 = fcmp contract ogt float %33, 0.000000e+00
  %44 = select i1 %43, float 1.000000e+00, float -1.000000e+00
  br label %45

45:                                               ; preds = %39, %36
  %46 = phi float [ %33, %36 ], [ %44, %39 ]
  %47 = getelementptr inbounds float, float addrspace(1)* %3, i64 %28

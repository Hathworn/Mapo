; ModuleID = '../data/hip_kernels/14353/113/main.cu'
source_filename = "../data/hip_kernels/14353/113/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z19weighted_sum_kerneliPfS_S_S_(i32 %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* readonly %2, float addrspace(1)* nocapture readonly %3, float addrspace(1)* nocapture writeonly %4) local_unnamed_addr #0 {
...
27:                                               ; preds = %5
  ...
  %34 = fsub contract float 1.000000e+00, %30
  %35 = icmp eq float addrspace(1)* %2, addrspacecast (float* null to float addrspace(1)*)
  br i1 %35, label %39, label %36

36:                                               ; preds = %27
  %37 = getelementptr inbounds float, float addrspace(1)* %2, i64 %28
  %38 = load float, float addrspace(1)* %37, align 4, !tbaa !16, !amdgpu.noclobber !14
  br label %39

39:                                               ; preds = %27, %36
  %40 = phi contract float [ %38, %36 ], [ 0.000000e+00, %27 ]
  %41 = fmul contract float %34, %40
  %42 = fadd contract float %33, %41
  %43 = getelementptr inbounds float, float addrspace(1)* %4, i64 %28

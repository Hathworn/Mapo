; ModuleID = '../data/hip_kernels/14353/114/main.cu'
source_filename = "../data/hip_kernels/14353/114/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z21weighted_delta_kerneliPfS_S_S_S_S_S_(i32 %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, float addrspace(1)* %4, float addrspace(1)* nocapture %5, float addrspace(1)* nocapture %6, float addrspace(1)* nocapture readonly %7) local_unnamed_addr #0 {
...
33:                                               ; preds = %30
  %34 = getelementptr inbounds float, float addrspace(1)* %7, i64 %32
  ...
  %39 = getelementptr inbounds float, float addrspace(1)* %4, i64 %32
...
42:                                               ; preds = %30, %33
  %43 = getelementptr inbounds float, float addrspace(1)* %7, i64 %32
  ...
  %49 = getelementptr inbounds float, float addrspace(1)* %5, i64 %32
  %50 = load float, float addrspace(1)* %49, align 4, !tbaa !16
  %51 = fadd contract float %50, %48
  store float %51, float addrspace(1)* %49, align 4, !tbaa !16
  %52 = load float, float addrspace(1)* %43, align 4, !tbaa !16
  %53 = getelementptr inbounds float, float addrspace(1)* %1, i64 %32
  %54 = load float, float addrspace(1)* %53, align 4, !tbaa !16
  %55 = fmul contract float %52, %54
  %56 = getelementptr inbounds float, float addrspace(1)* %2, i64 %32
  %57 = load float, float addrspace(1)* %56, align 4, !tbaa !16
  %58 = fmul contract float %52, %57
  %59 = fsub contract float %55, %58
  %60 = getelementptr inbounds float, float addrspace(1)* %6, i64 %32

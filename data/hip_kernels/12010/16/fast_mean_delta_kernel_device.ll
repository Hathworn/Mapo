; ModuleID = '../data/hip_kernels/12010/16/main.cu'
source_filename = "../data/hip_kernels/12010/16/main.cu"
...
221:                                              ; preds = %153
  ...
  %224 = fadd contract float %223, 0x3EB0C6F7A0000000
  ...
  %247 = fdiv contract double -1.000000e+00, %246
  %248 = fpext float %218 to double
  %249 = fmul contract double %247, %248
  %250 = fptrunc double %249 to float
  store float %250, float addrspace(1)* %152, align 4, !tbaa !5
  br label %251

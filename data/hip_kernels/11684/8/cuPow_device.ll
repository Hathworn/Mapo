; ModuleID = '../data/hip_kernels/11684/8/main.cu'
source_filename = "../data/hip_kernels/11684/8/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @cuPow(i32 %0, float addrspace(1)* nocapture readonly %1, float %2, float addrspace(1)* nocapture writeonly %3) local_unnamed_addr #0 {
...
15:                                               ; preds = %4
  ...
  %127 = fmul float %124, %2
  %128 = fneg float %127
  %129 = tail call float @llvm.fma.f32(float %2, float %124, float %128)
  %130 = tail call float @llvm.fma.f32(float %2, float %126, float %129)
  ...
  %162 = tail call float @llvm.fabs.f32(float %2)
...
193:                                              ; preds = %15, %184
  ...
  %197 = or i1 %196, %195
  %198 = fcmp olt float %2, 0.000000e+00
  %199 = xor i1 %198, %196

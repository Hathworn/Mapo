; ModuleID = '../data/hip_kernels/15315/1/main.cu'
source_filename = "../data/hip_kernels/15315/1/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [43 x i8] c"Hola mundo! Soy un thread en el bloque %d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z4holav() local_unnamed_addr #1 {

; ModuleID = '../data/hip_kernels/381/3/main.cu'
source_filename = "../data/hip_kernels/381/3/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z25forwardDifference2DKerneliiPKfPfS1_(i32 %0, i32 %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture writeonly %3, float addrspace(1)* nocapture writeonly %4) local_unnamed_addr #0 {
...
56:                                               ; preds = %45, %56
  ...
  %67 = getelementptr inbounds float, float addrspace(1)* %3, i64 %63
  store float %66, float addrspace(1)* %67, align 4, !tbaa !19
  %68 = add i32 %58, %1
  %69 = zext i32 %68 to i64
  %70 = getelementptr inbounds float, float addrspace(1)* %2, i64 %69
  %71 = load float, float addrspace(1)* %70, align 4, !tbaa !19
  %72 = load float, float addrspace(1)* %64, align 4, !tbaa !19
  ...
  br i1 %76, label %56, label %53, !llvm.loop !23
}

; ModuleID = '../data/hip_kernels/15199/0/main.cu'
source_filename = "../data/hip_kernels/15199/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z13vector_add_cuPfS_S_i(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, i32 %3) local_unnamed_addr #0 {
  %5 = icmp sgt i32 %3, 0
...
14:                                               ; preds = %11, %14
  ...
  %23 = getelementptr inbounds float, float addrspace(1)* %0, i64 %17
...
28:                                               ; preds = %28, %9
  ...
  %34 = getelementptr inbounds float, float addrspace(1)* %2, i64 %31
  %35 = load float, float addrspace(1)* %34, align 4, !tbaa !4
  %36 = fadd contract float %33, %35
  %37 = getelementptr inbounds float, float addrspace(1)* %0, i64 %31
  ...
  %45 = getelementptr inbounds float, float addrspace(1)* %0, i64 %39
  ...
  %61 = getelementptr inbounds float, float addrspace(1)* %0, i64 %55
  ...
  %77 = getelementptr inbounds float, float addrspace(1)* %0, i64 %71
  ...
  %85 = getelementptr inbounds float, float addrspace(1)* %0, i64 %79

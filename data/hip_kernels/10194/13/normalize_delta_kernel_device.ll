; ModuleID = '../data/hip_kernels/10194/13/main.cu'
source_filename = "../data/hip_kernels/10194/13/main.cu"
...
32:                                               ; preds = %10
  ...
  %63 = fadd contract float %62, 0x3EB0C6F7A0000000
  %64 = fpext float %63 to double
  %65 = fdiv contract double %38, %64
  %66 = getelementptr inbounds float, float addrspace(1)* %5, i64 %39
  %67 = load float, float addrspace(1)* %66, align 4, !tbaa !16, !amdgpu.noclobber !14
  %68 = fpext float %67 to double
  %69 = fmul contract double %68, 2.000000e+00
  %70 = getelementptr inbounds float, float addrspace(1)* %1, i64 %35
  %71 = load float, float addrspace(1)* %70, align 4, !tbaa !16, !amdgpu.noclobber !14
  %72 = getelementptr inbounds float, float addrspace(1)* %2, i64 %39
  %73 = load float, float addrspace(1)* %72, align 4, !tbaa !16, !amdgpu.noclobber !14
  %74 = fsub contract float %71, %73
  %75 = fpext float %74 to double
  %76 = fmul contract double %69, %75
  %77 = mul nsw i32 %8, %6
  %78 = sitofp i32 %77 to double
  %79 = fdiv contract double %76, %78
  %80 = fadd contract double %79, %65
  %81 = getelementptr inbounds float, float addrspace(1)* %4, i64 %39
  %82 = load float, float addrspace(1)* %81, align 4, !tbaa !16, !amdgpu.noclobber !14
  %83 = sitofp i32 %77 to float
  %84 = fdiv contract float %82, %83
  %85 = fpext float %84 to double
  %86 = fadd contract double %80, %85
  %87 = fptrunc double %86 to float
  store float %87, float addrspace(1)* %36, align 4, !tbaa !16
  br label %88

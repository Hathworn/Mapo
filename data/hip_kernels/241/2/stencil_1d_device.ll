; ModuleID = '../data/hip_kernels/241/2/main.cu'
source_filename = "../data/hip_kernels/241/2/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ10stencil_1dPiS_E4temp = internal unnamed_addr addrspace(3) global [22 x i32] undef, align 16
...
define protected amdgpu_kernel void @_Z10stencil_1dPiS_(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
  ...
  %17 = getelementptr inbounds [22 x i32], [22 x i32] addrspace(3)* @_ZZ10stencil_1dPiS_E4temp, i32 0, i32 %13
...
20:                                               ; preds = %2
  ...
  %23 = getelementptr inbounds [22 x i32], [22 x i32] addrspace(3)* @_ZZ10stencil_1dPiS_E4temp, i32 0, i32 %3
  ...
  %28 = add nuw nsw i32 %3, 19
  %29 = getelementptr inbounds [22 x i32], [22 x i32] addrspace(3)* @_ZZ10stencil_1dPiS_E4temp, i32 0, i32 %28
...
30:                                               ; preds = %2, %20
  ...
  %31 = getelementptr inbounds [22 x i32], [22 x i32] addrspace(3)* @_ZZ10stencil_1dPiS_E4temp, i32 0, i32 %3
  %32 = load i32, i32 addrspace(3)* %31, align 4, !tbaa !7
  %33 = add nuw nsw i32 %3, 1
  %34 = getelementptr inbounds [22 x i32], [22 x i32] addrspace(3)* @_ZZ10stencil_1dPiS_E4temp, i32 0, i32 %33
  %35 = load i32, i32 addrspace(3)* %34, align 4, !tbaa !7
  %36 = add nsw i32 %35, %32
  %37 = add nuw nsw i32 %3, 2
  %38 = getelementptr inbounds [22 x i32], [22 x i32] addrspace(3)* @_ZZ10stencil_1dPiS_E4temp, i32 0, i32 %37
  %39 = load i32, i32 addrspace(3)* %38, align 4, !tbaa !7
  %40 = add nsw i32 %39, %36
  %41 = load i32, i32 addrspace(3)* %17, align 4, !tbaa !7
  %42 = add nsw i32 %41, %40
  %43 = add nuw nsw i32 %3, 4
  %44 = getelementptr inbounds [22 x i32], [22 x i32] addrspace(3)* @_ZZ10stencil_1dPiS_E4temp, i32 0, i32 %43
  %45 = load i32, i32 addrspace(3)* %44, align 4, !tbaa !7
  %46 = add nsw i32 %45, %42
  %47 = add nuw nsw i32 %3, 5
  %48 = getelementptr inbounds [22 x i32], [22 x i32] addrspace(3)* @_ZZ10stencil_1dPiS_E4temp, i32 0, i32 %47
  %49 = load i32, i32 addrspace(3)* %48, align 4, !tbaa !7
  %50 = add nsw i32 %49, %46
  %51 = add nuw nsw i32 %3, 6
  %52 = getelementptr inbounds [22 x i32], [22 x i32] addrspace(3)* @_ZZ10stencil_1dPiS_E4temp, i32 0, i32 %51

; ModuleID = '../data/hip_kernels/6580/12/main.cu'
source_filename = "../data/hip_kernels/6580/12/main.cu"
...
define protected amdgpu_kernel void @_Z21updateBiasKernel_reluPfS_iif(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture %1, i32 %2, i32 %3, float %4) local_unnamed_addr #0 {

...
#include "ConditionCFLKernel2D1_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
int nsec = 1;
int nrad = 1;
double *Vresidual = NULL;
hipMalloc(&Vresidual, XSIZE*YSIZE);
double *Vtheta = NULL;
...
hipFree(0);
ConditionCFLKernel2D1<<<gridBlock, threadBlock>>>(Rsup,Rinf,Rmed,nsec,nrad,Vresidual,Vtheta,Vmoy,FastTransport,SoundSpeed,Vrad,DT2D);

...
hipFree(0);
Substep2Kernel<<<gridBlock, threadBlock>>>(Dens,VradInt,VthetaInt,TemperInt,nrad,nsec,invdiffRmed,invdiffRsup,DensInt,Adiabatic,Rmed,dt,VradNew,VthetaNew,Energy,EnergyInt);

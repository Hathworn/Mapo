; ModuleID = '../data/hip_kernels/1213/25/main.cu'
source_filename = "../data/hip_kernels/1213/25/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z5decatPfS_S_S_S_iiiii(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, float addrspace(1)* nocapture writeonly %2, float addrspace(1)* nocapture writeonly %3, float addrspace(1)* nocapture writeonly %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9) local_unnamed_addr #0 {
...
47:                                               ; preds = %45
  ...
  store float %54, float addrspace(1)* %61, align 4, !tbaa !7
  br label %87
...
79:                                               ; preds = %62
  ...
  store float %70, float addrspace(1)* %86, align 4, !tbaa !7
  br label %87

87:                                               ; preds = %47, %79, %71, %36
  %88 = add nuw nsw i32 %34, 1
  %89 = icmp eq i32 %88, %22
  br i1 %89, label %90, label %33, !llvm.loop !11

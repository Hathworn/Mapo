; ModuleID = '../data/hip_kernels/1213/40/main.cu'
source_filename = "../data/hip_kernels/1213/40/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z5decatPfS_S_S_mmmmmS_i(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture writeonly %1, float addrspace(1)* nocapture writeonly %2, float addrspace(1)* nocapture writeonly %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8, float addrspace(1)* nocapture readonly %9, i32 %10) local_unnamed_addr #0 {
...
45:                                               ; preds = %37
  %46 = getelementptr inbounds float, float addrspace(1)* %9, i64 %38
  %47 = load float, float addrspace(1)* %46, align 4, !tbaa !16
  %48 = mul i64 %39, %4
  %49 = add i64 %43, %48
  %50 = getelementptr inbounds float, float addrspace(1)* %0, i64 %49
  store float %47, float addrspace(1)* %50, align 4, !tbaa !16
  br label %74
...
53:                                               ; preds = %51
  %54 = getelementptr inbounds float, float addrspace(1)* %9, i64 %38
...
64:                                               ; preds = %60
  ...
  store float %63, float addrspace(1)* %68, align 4, !tbaa !16
  br label %74
...
69:                                               ; preds = %60
  ...
  store float %63, float addrspace(1)* %73, align 4, !tbaa !16
  br label %74

74:                                               ; preds = %53, %69, %64, %45
  %75 = add i64 %38, %36
  %76 = icmp ult i64 %75, %8
  br i1 %76, label %37, label %77, !llvm.loop !20

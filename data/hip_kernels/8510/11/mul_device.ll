; ModuleID = '../data/hip_kernels/8510/11/main.cu'
source_filename = "../data/hip_kernels/8510/11/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [34 x i8] c"CUDA KERNEL MUL %ld * %ld = %ld \0A\00", align 1
...
define protected amdgpu_kernel void @_Z3muliPlS_S_(i32 %0, i64 addrspace(1)* nocapture readonly %1, i64 addrspace(1)* nocapture readonly %2, i64 addrspace(1)* nocapture writeonly %3) local_unnamed_addr #1 {

...
#include "kernel_push_stochastic2_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
kernel_push_stochastic2<<<gridBlock, threadBlock>>>(g_terminate,g_relabel_mask,g_push_reser,s_push_reser,d_stochastic,g_block_num,width1);

...
#include "kernel_push1_atomic_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
kernel_push1_atomic<<<gridBlock, threadBlock>>>(g_left_weight,g_right_weight,g_down_weight,g_up_weight,g_sink_weight,g_push_reser,g_pull_left,g_pull_right,g_pull_down,g_pull_up,g_relabel_mask,g_graph_height,g_height_write,graph_size,width,rows,graph_size1,width1,rows1);

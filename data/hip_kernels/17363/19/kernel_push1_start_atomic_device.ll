...
define protected amdgpu_kernel void @_Z25kernel_push1_start_atomicPiS_S_S_S_S_S_S_S_iiiiiiS_S_S_Pb(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture readonly %2, i32 addrspace(1)* nocapture readonly %3, i32 addrspace(1)* nocapture %4, i32 addrspace(1)* nocapture %5, i32 addrspace(1)* nocapture %6, i32 addrspace(1)* nocapture readonly %7, i32 addrspace(1)* nocapture writeonly %8, i32 %9, i32 %10, i32 %11, i32 %12, i32 %13, i32 %14, i32 addrspace(1)* nocapture readnone %15, i32 addrspace(1)* nocapture readnone %16, i32 addrspace(1)* nocapture readnone %17, i8 addrspace(1)* nocapture readnone %18) local_unnamed_addr #0 {
  ...
  %50 = getelementptr inbounds [356 x i32], [356 x i32] addrspace(3)* @_ZZ25kernel_push1_start_atomicPiS_S_S_S_S_S_S_S_iiiiiiS_S_S_PbE9height_fn, i32 0, i32 %46
...
55:                                               ; preds = %19
  ...
  %61 = getelementptr inbounds [356 x i32], [356 x i32] addrspace(3)* @_ZZ25kernel_push1_start_atomicPiS_S_S_S_S_S_S_S_iiiiiiS_S_S_PbE9height_fn, i32 0, i32 %60
...
66:                                               ; preds = %62
  ...
  %71 = getelementptr inbounds [356 x i32], [356 x i32] addrspace(3)* @_ZZ25kernel_push1_start_atomicPiS_S_S_S_S_S_S_S_iiiiiiS_S_S_PbE9height_fn, i32 0, i32 %45
...
77:                                               ; preds = %72
  ...
  %83 = getelementptr inbounds [356 x i32], [356 x i32] addrspace(3)* @_ZZ25kernel_push1_start_atomicPiS_S_S_S_S_S_S_S_iiiiiiS_S_S_PbE9height_fn, i32 0, i32 %82
...
88:                                               ; preds = %84
  ...
  %94 = getelementptr inbounds [356 x i32], [356 x i32] addrspace(3)* @_ZZ25kernel_push1_start_atomicPiS_S_S_S_S_S_S_S_iiiiiiS_S_S_PbE9height_fn, i32 0, i32 %93
...
131:                                              ; preds = %126
  ...
  %133 = getelementptr inbounds [356 x i32], [356 x i32] addrspace(3)* @_ZZ25kernel_push1_start_atomicPiS_S_S_S_S_S_S_S_iiiiiiS_S_S_PbE9height_fn, i32 0, i32 %45
...
139:                                              ; preds = %131
  ...
  %141 = getelementptr inbounds [356 x i32], [356 x i32] addrspace(3)* @_ZZ25kernel_push1_start_atomicPiS_S_S_S_S_S_S_S_iiiiiiS_S_S_PbE9height_fn, i32 0, i32 %140
...
149:                                              ; preds = %145, %139
  ...
  %151 = getelementptr inbounds [356 x i32], [356 x i32] addrspace(3)* @_ZZ25kernel_push1_start_atomicPiS_S_S_S_S_S_S_S_iiiiiiS_S_S_PbE9height_fn, i32 0, i32 %150
...
159:                                              ; preds = %155, %149
  ...
  %161 = getelementptr inbounds [356 x i32], [356 x i32] addrspace(3)* @_ZZ25kernel_push1_start_atomicPiS_S_S_S_S_S_S_S_iiiiiiS_S_S_PbE9height_fn, i32 0, i32 %160
...
193:                                              ; preds = %191
  %194 = getelementptr inbounds [356 x i32], [356 x i32] addrspace(3)* @_ZZ25kernel_push1_start_atomicPiS_S_S_S_S_S_S_S_iiiiiiS_S_S_PbE9height_fn, i32 0, i32 %45
...
202:                                              ; preds = %197
  ...
  %204 = getelementptr inbounds [356 x i32], [356 x i32] addrspace(3)* @_ZZ25kernel_push1_start_atomicPiS_S_S_S_S_S_S_S_iiiiiiS_S_S_PbE9height_fn, i32 0, i32 %203
...
212:                                              ; preds = %207
  ...
  %214 = getelementptr inbounds [356 x i32], [356 x i32] addrspace(3)* @_ZZ25kernel_push1_start_atomicPiS_S_S_S_S_S_S_S_iiiiiiS_S_S_PbE9height_fn, i32 0, i32 %213
...
222:                                              ; preds = %217
  ...
  %224 = getelementptr inbounds [356 x i32], [356 x i32] addrspace(3)* @_ZZ25kernel_push1_start_atomicPiS_S_S_S_S_S_S_S_iiiiiiS_S_S_PbE9height_fn, i32 0, i32 %223

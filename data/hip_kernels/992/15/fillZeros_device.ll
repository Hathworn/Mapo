; ModuleID = '../data/hip_kernels/992/15/main.cu'
source_filename = "../data/hip_kernels/992/15/main.cu"
...
define protected amdgpu_kernel void @_Z9fillZerosPfi(float addrspace(1)* nocapture writeonly %0, i32 %1) local_unnamed_addr #0 {

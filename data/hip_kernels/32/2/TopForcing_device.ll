; ModuleID = '../data/hip_kernels/32/2/main.cu'
source_filename = "../data/hip_kernels/32/2/main.cu"
...
define protected amdgpu_kernel void @_Z10TopForcingdPdi(double %0, double addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
24:                                               ; preds = %17, %24
  %25 = phi i32 [ %15, %17 ], [ %28, %24 ]
  %26 = sext i32 %25 to i64
  %27 = getelementptr inbounds double, double addrspace(1)* %1, i64 %26
  store double %0, double addrspace(1)* %27, align 8, !tbaa !16
  %28 = add i32 %23, %25

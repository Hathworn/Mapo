; ModuleID = '../data/hip_kernels/795/5/main.cu'
source_filename = "../data/hip_kernels/795/5/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z14GPUKernel_IqdbiiiPdS_(i32 %0, i32 %1, i32 %2, double addrspace(1)* nocapture readonly %3, double addrspace(1)* nocapture writeonly %4) local_unnamed_addr #0 {
...
43:                                               ; preds = %33
  ...
  %50 = load double, double addrspace(1)* %49, align 8, !tbaa !16, !amdgpu.noclobber !14
  %51 = sext i32 %47 to i64
  %52 = getelementptr inbounds double, double addrspace(1)* %4, i64 %51
  store double %50, double addrspace(1)* %52, align 8, !tbaa !16
  br label %53

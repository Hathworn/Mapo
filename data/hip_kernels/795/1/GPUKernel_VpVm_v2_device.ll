; ModuleID = '../data/hip_kernels/795/1/main.cu'
source_filename = "../data/hip_kernels/795/1/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z17GPUKernel_VpVm_v2iiiPdS_S_(i32 %0, i32 %1, i32 %2, double addrspace(1)* nocapture readonly %3, double addrspace(1)* nocapture writeonly %4, double addrspace(1)* nocapture writeonly %5) local_unnamed_addr #0 {
  ...
  %23 = add i32 %21, %22
  %24 = getelementptr i8, i8 addrspace(4)* %8, i64 4
...
40:                                               ; preds = %33
  ...
  %49 = load double, double addrspace(1)* %48, align 8, !tbaa !16, !amdgpu.noclobber !14
  %50 = mul nsw i32 %36, %2
  %51 = add nsw i32 %50, %38
  %52 = sext i32 %51 to i64
  %53 = getelementptr inbounds double, double addrspace(1)* %3, i64 %52
  %54 = load double, double addrspace(1)* %53, align 8, !tbaa !16, !amdgpu.noclobber !14
  %55 = fadd contract double %49, %54
  %56 = sext i32 %44 to i64
  %57 = getelementptr inbounds double, double addrspace(1)* %4, i64 %56
  store double %55, double addrspace(1)* %57, align 8, !tbaa !16
  %58 = load double, double addrspace(1)* %48, align 8, !tbaa !16
  %59 = load double, double addrspace(1)* %53, align 8, !tbaa !16
  %60 = fsub contract double %58, %59
  %61 = getelementptr inbounds double, double addrspace(1)* %5, i64 %56

; ModuleID = '../data/hip_kernels/15733/6/main.cu'
source_filename = "../data/hip_kernels/15733/6/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ14tile_MatrixMulPiS_S_iiE1A = internal unnamed_addr addrspace(3) global [1024 x i32] undef, align 16
@_ZZ14tile_MatrixMulPiS_S_iiE1B = internal unnamed_addr addrspace(3) global [1024 x i32] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z14tile_MatrixMulPiS_S_ii(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture writeonly %2, i32 %3, i32 %4) local_unnamed_addr #0 {
...
17:                                               ; preds = %5
  ...
  %19 = mul nsw i32 %7, %4
  %20 = add nsw i32 %19, %6
  %21 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1A, i32 0, i32 %20
  %22 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1B, i32 0, i32 %20
  %23 = icmp sgt i32 %4, 0
  %24 = and i32 %4, 7
  %25 = icmp ult i32 %4, 8
  %26 = and i32 %4, -8
...
52:                                               ; preds = %48, %52
  ...
  %57 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1A, i32 0, i32 %56
  %58 = load i32, i32 addrspace(3)* %57, align 4, !tbaa !5
  %59 = mul nsw i32 %53, %4
  %60 = add nsw i32 %59, %6
  %61 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1B, i32 0, i32 %60
...
72:                                               ; preds = %47, %72
  ...
  %77 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1A, i32 0, i32 %76
  %78 = load i32, i32 addrspace(3)* %77, align 4, !tbaa !5
  %79 = mul nsw i32 %73, %4
  %80 = add nsw i32 %79, %6
  %81 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1B, i32 0, i32 %80
  %82 = load i32, i32 addrspace(3)* %81, align 4, !tbaa !5
  %83 = mul nsw i32 %82, %78
  %84 = add nsw i32 %83, %74
  %85 = or i32 %73, 1
  %86 = add nsw i32 %85, %19
  %87 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1A, i32 0, i32 %86
  %88 = load i32, i32 addrspace(3)* %87, align 4, !tbaa !5
  %89 = mul nsw i32 %85, %4
  %90 = add nsw i32 %89, %6
  %91 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1B, i32 0, i32 %90
  %92 = load i32, i32 addrspace(3)* %91, align 4, !tbaa !5
  %93 = mul nsw i32 %92, %88
  %94 = add nsw i32 %93, %84
  %95 = or i32 %73, 2
  %96 = add nsw i32 %95, %19
  %97 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1A, i32 0, i32 %96
  %98 = load i32, i32 addrspace(3)* %97, align 4, !tbaa !5
  %99 = mul nsw i32 %95, %4
  %100 = add nsw i32 %99, %6
  %101 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1B, i32 0, i32 %100
  %102 = load i32, i32 addrspace(3)* %101, align 4, !tbaa !5
  %103 = mul nsw i32 %102, %98
  %104 = add nsw i32 %103, %94
  %105 = or i32 %73, 3
  %106 = add nsw i32 %105, %19
  %107 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1A, i32 0, i32 %106
  %108 = load i32, i32 addrspace(3)* %107, align 4, !tbaa !5
  %109 = mul nsw i32 %105, %4
  %110 = add nsw i32 %109, %6
  %111 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1B, i32 0, i32 %110
  %112 = load i32, i32 addrspace(3)* %111, align 4, !tbaa !5
  %113 = mul nsw i32 %112, %108
  %114 = add nsw i32 %113, %104
  %115 = or i32 %73, 4
  %116 = add nsw i32 %115, %19
  %117 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1A, i32 0, i32 %116
  %118 = load i32, i32 addrspace(3)* %117, align 4, !tbaa !5
  %119 = mul nsw i32 %115, %4
  %120 = add nsw i32 %119, %6
  %121 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1B, i32 0, i32 %120
  %122 = load i32, i32 addrspace(3)* %121, align 4, !tbaa !5
  %123 = mul nsw i32 %122, %118
  %124 = add nsw i32 %123, %114
  %125 = or i32 %73, 5
  %126 = add nsw i32 %125, %19
  %127 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1A, i32 0, i32 %126
  %128 = load i32, i32 addrspace(3)* %127, align 4, !tbaa !5
  %129 = mul nsw i32 %125, %4
  %130 = add nsw i32 %129, %6
  %131 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1B, i32 0, i32 %130
  %132 = load i32, i32 addrspace(3)* %131, align 4, !tbaa !5
  %133 = mul nsw i32 %132, %128
  %134 = add nsw i32 %133, %124
  %135 = or i32 %73, 6
  %136 = add nsw i32 %135, %19
  %137 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1A, i32 0, i32 %136
  %138 = load i32, i32 addrspace(3)* %137, align 4, !tbaa !5
  %139 = mul nsw i32 %135, %4
  %140 = add nsw i32 %139, %6
  %141 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1B, i32 0, i32 %140
  %142 = load i32, i32 addrspace(3)* %141, align 4, !tbaa !5
  %143 = mul nsw i32 %142, %138
  %144 = add nsw i32 %143, %134
  %145 = or i32 %73, 7
  %146 = add nsw i32 %145, %19
  %147 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1A, i32 0, i32 %146
  %148 = load i32, i32 addrspace(3)* %147, align 4, !tbaa !5
  %149 = mul nsw i32 %145, %4
  %150 = add nsw i32 %149, %6
  %151 = getelementptr inbounds [1024 x i32], [1024 x i32] addrspace(3)* @_ZZ14tile_MatrixMulPiS_S_iiE1B, i32 0, i32 %150

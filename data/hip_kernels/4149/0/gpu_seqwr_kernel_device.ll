; ModuleID = '../data/hip_kernels/4149/0/main.cu'
source_filename = "../data/hip_kernels/4149/0/main.cu"
...
define protected amdgpu_kernel void @_Z16gpu_seqwr_kernelPimm(i32 addrspace(1)* nocapture writeonly %0, i64 %1, i64 %2) local_unnamed_addr #0 {
  %4 = icmp eq i64 %1, 0

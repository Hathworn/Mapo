; ModuleID = '../data/hip_kernels/3467/0/main.cu'
source_filename = "../data/hip_kernels/3467/0/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [30 x i8] c"Hello World from Thread %d !\0A\00", align 1
...
define protected amdgpu_kernel void @_Z11hello_worldv() local_unnamed_addr #1 {

...
#include "vanrossum_get_indices_to_apply_stdp_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
vanrossum_get_indices_to_apply_stdp<<<gridBlock, threadBlock>>>(d_postsyns,d_last_spike_time_of_each_neuron,d_time_of_last_spike_to_reach_synapse,d_index_of_last_afferent_synapse_to_spike,d_isindexed_ltd_synapse_spike,d_index_of_first_synapse_spiked_after_postneuron,currtime,d_plastic_synapse_indices,total_number_of_plastic_synapses);

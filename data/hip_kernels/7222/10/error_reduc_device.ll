; ModuleID = '../data/hip_kernels/7222/10/main.cu'
source_filename = "../data/hip_kernels/7222/10/main.cu"
...
@_ZZ11error_reducPdiE8error_ds = internal unnamed_addr addrspace(3) global [55 x double] undef, align 16
@.str = private unnamed_addr addrspace(4) constant [15 x i8] c"GPU Error: %f\0A\00", align 1
...
define protected amdgpu_kernel void @_Z11error_reducPdi(double addrspace(1)* nocapture %0, i32 %1) local_unnamed_addr #1 {
  ...
  %7 = getelementptr inbounds [55 x double], [55 x double] addrspace(3)* @_ZZ11error_reducPdiE8error_ds, i32 0, i32 %3
  store double %6, double addrspace(3)* %7, align 8, !tbaa !5
...
9:                                                ; preds = %2
  %10 = load double, double addrspace(3)* %7, align 8, !tbaa !5
  %11 = fdiv contract double %10, 5.500000e+01
  store double %11, double addrspace(3)* %7, align 8, !tbaa !5
  %12 = fmul contract double %11, 1.000000e+02
  ...
  %16 = load i64, i64 addrspace(4)* %15, align 8, !tbaa !10
...
442:                                              ; preds = %402, %442
  ...
  %447 = load i8, i8 addrspace(4)* %446, align 1, !tbaa !14
...
473:                                              ; preds = %466, %2
  store double 0.000000e+00, double addrspace(1)* %5, align 8, !tbaa !5
  ret void
}

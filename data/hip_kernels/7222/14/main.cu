...
hipFree(0);
update<<<gridBlock, threadBlock>>>(weights_in_d,weights_h_d,weights_out_d,weights_in_delta_d,weights_h_delta_d,weights_out_delta_d,error_d);

; ModuleID = '../data/hip_kernels/8177/1/main.cu'
source_filename = "../data/hip_kernels/8177/1/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ8dotCuda3PfS_S_E5cache = internal unnamed_addr addrspace(3) global [1024 x float] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z8dotCuda3PfS_S_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  ...
  %19 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ8dotCuda3PfS_S_E5cache, i32 0, i32 %11
...
27:                                               ; preds = %23
  ...
  %29 = getelementptr inbounds [1024 x float], [1024 x float] addrspace(3)* @_ZZ8dotCuda3PfS_S_E5cache, i32 0, i32 %28
...
35:                                               ; preds = %21
  %36 = load float, float addrspace(3)* getelementptr inbounds ([1024 x float], [1024 x float] addrspace(3)* @_ZZ8dotCuda3PfS_S_E5cache, i32 0, i32 0), align 16, !tbaa !7

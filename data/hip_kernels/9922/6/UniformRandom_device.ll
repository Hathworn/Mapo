; ModuleID = '../data/hip_kernels/9922/6/main.cu'
source_filename = "../data/hip_kernels/9922/6/main.cu"
...
define protected amdgpu_kernel void @_Z13UniformRandomPdP12hiprandState(double addrspace(1)* nocapture writeonly %0, %struct.hiprandState addrspace(1)* nocapture %1) local_unnamed_addr #1 {
  ...
  %40 = getelementptr inbounds double, double addrspace(1)* %0, i64 %6
  store double %39, double addrspace(1)* %40, align 8, !tbaa !4

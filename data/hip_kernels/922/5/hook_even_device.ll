; ModuleID = '../data/hip_kernels/922/5/main.cu'
source_filename = "../data/hip_kernels/922/5/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

%struct.Edge = type { i64 }

@_ZZ9hook_evenPiP4EdgeiPbS2_E10block_flag = internal unnamed_addr addrspace(3) global i8 undef, align 1

; Function Attrs: convergent mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z9hook_evenPiP4EdgeiPbS2_(i32 addrspace(1)* nocapture %0, %struct.Edge addrspace(1)* nocapture readonly %1, i32 %2, i8 addrspace(1)* nocapture writeonly %3, i8 addrspace(1)* nocapture %4) local_unnamed_addr #0 {
...
16:                                               ; preds = %5
  store i8 0, i8 addrspace(3)* @_ZZ9hook_evenPiP4EdgeiPbS2_E10block_flag, align 1, !tbaa !7
  br label %17
...
36:                                               ; preds = %24
  ...
  store i8 1, i8 addrspace(3)* @_ZZ9hook_evenPiP4EdgeiPbS2_E10block_flag, align 1, !tbaa !7
  br label %41
...
41:                                               ; preds = %19, %36, %35, %17
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %42 = load i8, i8 addrspace(3)* @_ZZ9hook_evenPiP4EdgeiPbS2_E10block_flag, align 1
  %43 = icmp eq i8 %42, 0

; ModuleID = '../data/hip_kernels/12756/21/main.cu'
source_filename = "../data/hip_kernels/12756/21/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z17conflictDetectionPiS_S_iiS_(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture readonly %2, i32 %3, i32 %4, i32 addrspace(1)* nocapture writeonly %5) local_unnamed_addr #0 {
...
30:                                               ; preds = %17, %25
  %31 = phi i32 [ %29, %25 ], [ %4, %17 ]
  %32 = icmp slt i32 %22, %31
  br i1 %32, label %35, label %48

33:                                               ; preds = %35
  %34 = icmp slt i32 %45, %31
  br i1 %34, label %35, label %48, !llvm.loop !11

35:                                               ; preds = %30, %33
  %36 = phi i32 [ %45, %33 ], [ %22, %30 ]
...
46:                                               ; preds = %35
  %47 = getelementptr inbounds i32, i32 addrspace(1)* %5, i64 %18
  store i32 1, i32 addrspace(1)* %47, align 4, !tbaa !7
  br label %48

; ModuleID = '../data/hip_kernels/12756/18/main.cu'
source_filename = "../data/hip_kernels/12756/18/main.cu"
...
define protected amdgpu_kernel void @_Z10degreeCalcPiS_S_ii(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture %2, i32 %3, i32 %4) local_unnamed_addr #1 {
...
27:                                               ; preds = %16, %22
  %28 = phi i32 [ %26, %22 ], [ %4, %16 ]
  %29 = sub nsw i32 %28, %19
  %30 = getelementptr inbounds i32, i32 addrspace(1)* %2, i64 %17
  %31 = atomicrmw add i32 addrspace(1)* %30, i32 %29 syncscope("agent-one-as") monotonic, align 4
  %32 = icmp sgt i32 %28, %19
  br i1 %32, label %33, label %44

33:                                               ; preds = %27, %33
  %34 = phi i32 [ %42, %33 ], [ %19, %27 ]
  ...
  %41 = atomicrmw add i32 addrspace(1)* %40, i32 1 syncscope("agent-one-as") monotonic, align 4
  %42 = add nsw i32 %34, 1

; ModuleID = '../data/hip_kernels/12756/4/main.cu'
source_filename = "../data/hip_kernels/12756/4/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [27 x i8] c"Thread = %d ; i = %d ; %f\0A\00", align 1
...
28:                                               ; preds = %16, %508
  ...
  %35 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %23, i64 noundef 33, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %36 = extractelement <2 x i64> %35, i64 0
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([27 x i8], [27 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %37, label %41
...
60:                                               ; preds = %45
  %61 = load i8, i8 addrspace(4)* %47, align 1, !tbaa !15
...
100:                                              ; preds = %58, %100
  ...
  %105 = load i8, i8 addrspace(4)* %104, align 1, !tbaa !15
...
120:                                              ; preds = %113
  %121 = load i8, i8 addrspace(4)* %114, align 1, !tbaa !15
...
160:                                              ; preds = %118, %160
  ...
  %165 = load i8, i8 addrspace(4)* %164, align 1, !tbaa !15
...
180:                                              ; preds = %173
  %181 = load i8, i8 addrspace(4)* %174, align 1, !tbaa !15
...
220:                                              ; preds = %178, %220
  ...
  %225 = load i8, i8 addrspace(4)* %224, align 1, !tbaa !15
...
240:                                              ; preds = %233
  %241 = load i8, i8 addrspace(4)* %234, align 1, !tbaa !15
...
280:                                              ; preds = %238, %280
  ...
  %285 = load i8, i8 addrspace(4)* %284, align 1, !tbaa !15
...
300:                                              ; preds = %293
  %301 = load i8, i8 addrspace(4)* %294, align 1, !tbaa !15
...
340:                                              ; preds = %298, %340
  ...
  %345 = load i8, i8 addrspace(4)* %344, align 1, !tbaa !15
...
360:                                              ; preds = %353
  %361 = load i8, i8 addrspace(4)* %354, align 1, !tbaa !15
...
400:                                              ; preds = %358, %400
  ...
  %405 = load i8, i8 addrspace(4)* %404, align 1, !tbaa !15
...
420:                                              ; preds = %413
  %421 = load i8, i8 addrspace(4)* %414, align 1, !tbaa !15
...
482:                                              ; preds = %471, %37
  ...
  %485 = and i64 %484, -225
  %486 = or i64 %485, 32
  %487 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %23, i64 noundef %486, i64 noundef %24, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %488 = extractelement <2 x i64> %487, i64 0
  %489 = zext i32 %30 to i64
  %490 = and i64 %488, -225
  %491 = or i64 %490, 32
  %492 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %23, i64 noundef %491, i64 noundef %489, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %493 = extractelement <2 x i64> %492, i64 0
  %494 = bitcast double %34 to i64
  %495 = and i64 %493, -227
  %496 = or i64 %495, 34
  %497 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %23, i64 noundef %496, i64 noundef %494, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %498 = add nsw i32 %29, %25
  %499 = sext i32 %498 to i64
  %500 = getelementptr inbounds float, float addrspace(1)* %0, i64 %499
  %501 = load float, float addrspace(1)* %500, align 4, !tbaa !11
  %502 = fcmp contract oeq float %501, 1.000000e+00
  br i1 %502, label %503, label %508

503:                                              ; preds = %482
  %504 = load float, float addrspace(1)* %27, align 4, !tbaa !11
  %505 = load float, float addrspace(1)* %32, align 4, !tbaa !11
  %506 = fcmp contract oeq float %504, %505
  br i1 %506, label %507, label %508

507:                                              ; preds = %503
  store float -1.000000e+00, float addrspace(1)* %27, align 4, !tbaa !11
  br label %510

508:                                              ; preds = %482, %503
  %509 = icmp eq i32 %30, %2
  br i1 %509, label %510, label %28, !llvm.loop !18

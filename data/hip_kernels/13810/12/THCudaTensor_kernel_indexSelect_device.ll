; ModuleID = '../data/hip_kernels/13810/12/main.cu'
source_filename = "../data/hip_kernels/13810/12/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z31THCudaTensor_kernel_indexSelectPfS_PlS_lilll(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, i64 addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, i64 %4, i32 %5, i64 %6, i64 %7, i64 %8) local_unnamed_addr #0 {
...
39:                                               ; preds = %92, %37
  ...
  %43 = getelementptr inbounds float, float addrspace(1)* %3, i64 %38
  ...
  %53 = mul nsw i64 %36, %38
  %54 = add nsw i64 %53, %52
  %55 = getelementptr inbounds float, float addrspace(1)* %0, i64 %54
  store float %51, float addrspace(1)* %55, align 4, !tbaa !11

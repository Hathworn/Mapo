; ModuleID = '../data/hip_kernels/12578/8/main.cu'
source_filename = "../data/hip_kernels/12578/8/main.cu"
...
@ushort_tex = protected addrspace(1) externally_initialized global %struct.texture.1 undef, align 8
@ushort2_tex = protected local_unnamed_addr addrspace(1) externally_initialized global %struct.texture.2 undef, align 8
@llvm.compiler.used = appending addrspace(1) global [1 x i8*] [i8* addrspacecast (i8 addrspace(1)* bitcast (%struct.texture.1 addrspace(1)* @ushort_tex to i8 addrspace(1)*) to i8*)], section "llvm.metadata"

; Function Attrs: mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z16Thumbnail_ushortPiii(i32 addrspace(1)* nocapture %0, i32 %1, i32 %2) local_unnamed_addr #0 {
...
24:                                               ; preds = %3
  %25 = load %struct.__hip_texture*, %struct.__hip_texture* addrspace(1)* getelementptr inbounds (%struct.texture.1, %struct.texture.1 addrspace(1)* @ushort_tex, i64 0, i32 0, i32 11), align 8
  ...
  %71 = atomicrmw add i32 addrspace(1)* %70, i32 1 syncscope("agent-one-as") monotonic, align 4
  br label %72

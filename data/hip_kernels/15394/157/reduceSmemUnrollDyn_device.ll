; ModuleID = '../data/hip_kernels/15394/157/main.cu'
source_filename = "../data/hip_kernels/15394/157/main.cu"
...
48:                                               ; preds = %43, %3
  ...
  %50 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @smem, i32 0, i32 %4
...
54:                                               ; preds = %48
  ...
  %56 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @smem, i32 0, i32 %55
...
64:                                               ; preds = %60
  ...
  %66 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @smem, i32 0, i32 %65
...
74:                                               ; preds = %70
  ...
  %76 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @smem, i32 0, i32 %75
...
92:                                               ; preds = %90
  ...
  %94 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @smem, i32 0, i32 %93
  ...
  %119 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @smem, i32 0, i32 %118
  ...
  %125 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @smem, i32 0, i32 %124
...
132:                                              ; preds = %130
  %133 = load i32, i32 addrspace(3)* getelementptr inbounds ([0 x i32], [0 x i32] addrspace(3)* @smem, i32 0, i32 0), align 4, !tbaa !7

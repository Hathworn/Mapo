; ModuleID = '../data/hip_kernels/15394/156/main.cu'
source_filename = "../data/hip_kernels/15394/156/main.cu"
...
48:                                               ; preds = %43, %3
  ...
  %50 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %4
...
84:                                               ; preds = %80
  ...
  %86 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %85
...
92:                                               ; preds = %90
  ...
  %101 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %100
  ...
  %107 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %106
  ...
  %113 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %112
  ...
  %119 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %118
  ...
  %125 = getelementptr inbounds [128 x i32], [128 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 %124
...
132:                                              ; preds = %130
  %133 = load i32, i32 addrspace(3)* getelementptr inbounds ([128 x i32], [128 x i32] addrspace(3)* @_ZZ16reduceSmemUnrollPiS_jE4smem, i32 0, i32 0), align 16, !tbaa !7

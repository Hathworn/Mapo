; ModuleID = '../data/hip_kernels/15394/132/main.cu'
source_filename = "../data/hip_kernels/15394/132/main.cu"
...
@_ZZ10stencil_1dPfS_iE4smem = internal unnamed_addr addrspace(3) global [40 x float] undef, align 16
...
17:                                               ; preds = %3
  ...
  %19 = getelementptr inbounds [40 x float], [40 x float] addrspace(3)* @_ZZ10stencil_1dPfS_iE4smem, i32 0, i32 %18
  %20 = icmp ult i32 %14, 4
  %21 = getelementptr inbounds [40 x float], [40 x float] addrspace(3)* @_ZZ10stencil_1dPfS_iE4smem, i32 0, i32 %14
  %22 = add nuw nsw i32 %14, 36
  %23 = getelementptr inbounds [40 x float], [40 x float] addrspace(3)* @_ZZ10stencil_1dPfS_iE4smem, i32 0, i32 %22
  %24 = udiv i32 %12, %9
  %25 = mul i32 %24, %9
  ...
  %32 = getelementptr inbounds [40 x float], [40 x float] addrspace(3)* @_ZZ10stencil_1dPfS_iE4smem, i32 0, i32 %31
  %33 = add nuw nsw i32 %14, 3
  %34 = getelementptr inbounds [40 x float], [40 x float] addrspace(3)* @_ZZ10stencil_1dPfS_iE4smem, i32 0, i32 %33
  ...
  %37 = getelementptr inbounds [40 x float], [40 x float] addrspace(3)* @_ZZ10stencil_1dPfS_iE4smem, i32 0, i32 %36
  %38 = add nuw nsw i32 %14, 2
  %39 = getelementptr inbounds [40 x float], [40 x float] addrspace(3)* @_ZZ10stencil_1dPfS_iE4smem, i32 0, i32 %38
  ...
  %42 = getelementptr inbounds [40 x float], [40 x float] addrspace(3)* @_ZZ10stencil_1dPfS_iE4smem, i32 0, i32 %41
  %43 = add nuw nsw i32 %14, 1
  %44 = getelementptr inbounds [40 x float], [40 x float] addrspace(3)* @_ZZ10stencil_1dPfS_iE4smem, i32 0, i32 %43
  ...
  %47 = getelementptr inbounds [40 x float], [40 x float] addrspace(3)* @_ZZ10stencil_1dPfS_iE4smem, i32 0, i32 %46
  br label %48

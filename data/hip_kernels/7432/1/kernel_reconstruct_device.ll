; ModuleID = '../data/hip_kernels/7432/1/main.cu'
source_filename = "../data/hip_kernels/7432/1/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [18 x i8] c"Hello reconstruct\00", align 1
...
define protected amdgpu_kernel void @_Z18kernel_reconstructPdS_S_S_d(double addrspace(1)* nocapture readnone %0, double addrspace(1)* nocapture readnone %1, double addrspace(1)* nocapture readnone %2, double addrspace(1)* nocapture readnone %3, double %4) local_unnamed_addr #1 {
  %6 = tail call i32 @llvm.amdgcn.workgroup.id.x()
  %7 = icmp eq i32 %6, 0
  %8 = tail call i32 @llvm.amdgcn.workitem.id.y()
  %9 = icmp eq i32 %8, 0
  %10 = select i1 %7, i1 %9, i1 false
  %11 = tail call i32 @llvm.amdgcn.workitem.id.z()
  %12 = icmp eq i32 %11, 0
...
14:                                               ; preds = %5
  ...
  %18 = load i64, i64 addrspace(4)* %17, align 8, !tbaa !4
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([18 x i8], [18 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %23, label %27
...
45:                                               ; preds = %30
  %46 = load i8, i8 addrspace(4)* %32, align 1, !tbaa !8
...
85:                                               ; preds = %43, %85
  ...
  %90 = load i8, i8 addrspace(4)* %89, align 1, !tbaa !8
  ...
  br i1 %97, label %98, label %85, !llvm.loop !9
...
105:                                              ; preds = %98
  %106 = load i8, i8 addrspace(4)* %99, align 1, !tbaa !8
  ...
  %134 = load i8, i8 addrspace(4)* %133, align 1, !tbaa !8
...
145:                                              ; preds = %103, %145
  ...
  %150 = load i8, i8 addrspace(4)* %149, align 1, !tbaa !8
...
165:                                              ; preds = %158
  %166 = load i8, i8 addrspace(4)* %159, align 1, !tbaa !8
  ...
  %194 = load i8, i8 addrspace(4)* %193, align 1, !tbaa !8
...
205:                                              ; preds = %163, %205
  ...
  %210 = load i8, i8 addrspace(4)* %209, align 1, !tbaa !8
...
225:                                              ; preds = %218
  %226 = load i8, i8 addrspace(4)* %219, align 1, !tbaa !8
  ...
  %254 = load i8, i8 addrspace(4)* %253, align 1, !tbaa !8
...
265:                                              ; preds = %223, %265
  ...
  %270 = load i8, i8 addrspace(4)* %269, align 1, !tbaa !8
...
285:                                              ; preds = %278
  %286 = load i8, i8 addrspace(4)* %279, align 1, !tbaa !8
  ...
  %314 = load i8, i8 addrspace(4)* %313, align 1, !tbaa !8
...
325:                                              ; preds = %283, %325
  ...
  %330 = load i8, i8 addrspace(4)* %329, align 1, !tbaa !8
...
345:                                              ; preds = %338
  %346 = load i8, i8 addrspace(4)* %339, align 1, !tbaa !8
  ...
  %374 = load i8, i8 addrspace(4)* %373, align 1, !tbaa !8
...
385:                                              ; preds = %343, %385
  ...
  %390 = load i8, i8 addrspace(4)* %389, align 1, !tbaa !8
...
405:                                              ; preds = %398
  %406 = load i8, i8 addrspace(4)* %399, align 1, !tbaa !8
...
443:                                              ; preds = %403, %443
  ...
  %448 = load i8, i8 addrspace(4)* %447, align 1, !tbaa !8
...
456:                                              ; preds = %443, %405, %403
  ...
  %461 = and i64 %41, -225
  %462 = or i64 %461, %460
  %463 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %20, i64 noundef %462, i64 noundef %101, i64 noundef %161, i64 noundef %221, i64 noundef %281, i64 noundef %341, i64 noundef %401, i64 noundef %457) #10
  %464 = sub i64 %31, %39

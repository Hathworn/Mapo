; ModuleID = '../data/hip_kernels/6/13/main.cu'
source_filename = "../data/hip_kernels/6/13/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z17bankConflictsReadPfiPy(float addrspace(1)* nocapture readnone %0, i32 %1, i64 addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
  %4 = tail call i64 @llvm.amdgcn.s.memtime()
  %5 = tail call i64 @llvm.amdgcn.s.memtime()
  %6 = sub i64 %5, %4
  store i64 %6, i64 addrspace(1)* %2, align 8, !tbaa !4
  ret void
}

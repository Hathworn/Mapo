; ModuleID = '../data/hip_kernels/6/11/main.cu'
source_filename = "../data/hip_kernels/6/11/main.cu"
...
define protected amdgpu_kernel void @_Z19SharedMem2RegistersPfi(float addrspace(1)* nocapture writeonly %0, i32 %1) local_unnamed_addr #0 {
...
23:                                               ; preds = %29
  %24 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @s_memoryA, i32 0, i32 %30
  %25 = load float, float addrspace(3)* %24, align 4, !tbaa !16
  br label %26

26:                                               ; preds = %23, %2
  %27 = phi float [ %25, %23 ], [ undef, %2 ]
  %28 = icmp eq i32 %14, 0
  br i1 %28, label %33, label %34

29:                                               ; preds = %2, %29
  %30 = phi i32 [ %31, %29 ], [ %14, %2 ]
  %31 = add nsw i32 %30, %20
  %32 = icmp slt i32 %31, %21
  br i1 %32, label %29, label %23, !llvm.loop !20

33:                                               ; preds = %26
  store float %27, float addrspace(1)* %0, align 4, !tbaa !16
  br label %34

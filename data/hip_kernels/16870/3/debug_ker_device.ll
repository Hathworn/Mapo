; ModuleID = '../data/hip_kernels/16870/3/main.cu'
source_filename = "../data/hip_kernels/16870/3/main.cu"
...
define protected amdgpu_kernel void @_Z9debug_kerPfi(float addrspace(1)* nocapture readonly %0, i32 %1) local_unnamed_addr #1 {
  %3 = sext i32 %1 to i64
  %4 = getelementptr inbounds float, float addrspace(1)* %0, i64 %3
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([7 x i8], [7 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %14, label %18
...
459:                                              ; preds = %448, %14
  ...
  %461 = fpext float %5 to double
  %462 = extractelement <2 x i64> %460, i64 0
  %463 = zext i32 %1 to i64
  %464 = and i64 %462, -225
  %465 = or i64 %464, 32
  %466 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %11, i64 noundef %465, i64 noundef %463, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %467 = extractelement <2 x i64> %466, i64 0
  %468 = bitcast double %461 to i64
  %469 = and i64 %467, -227
  %470 = or i64 %469, 34
  %471 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %11, i64 noundef %470, i64 noundef %468, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

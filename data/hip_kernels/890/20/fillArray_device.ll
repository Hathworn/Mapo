; ModuleID = '../data/hip_kernels/890/20/main.cu'
source_filename = "../data/hip_kernels/890/20/main.cu"
...
define protected amdgpu_kernel void @_Z9fillArrayPai(i8 addrspace(1)* nocapture writeonly %0, i32 %1) local_unnamed_addr #0 {
...
25:                                               ; preds = %2, %146
  %26 = phi i32 [ %169, %146 ], [ 0, %2 ]
  %27 = zext i32 %26 to i64
  %28 = mul nuw nsw i64 %27, %22
  %29 = add nuw i64 %28, %15
  %30 = uitofp i64 %29 to float
  %31 = fdiv contract float %30, 1.000000e+02
...
40:                                               ; preds = %25
  ...
  %115 = xor i32 %109, %112
  %116 = xor i32 %110, %112
  %117 = tail call i32 @llvm.ctlz.i32(i32 %114, i1 false), !range !16
  ...
  %128 = tail call i32 @llvm.ctlz.i32(i32 %127, i1 false), !range !16
...
146:                                              ; preds = %33, %40
  ...
  %166 = fmul contract float %165, 3.000000e+01
  %167 = fptosi float %166 to i8
  %168 = getelementptr inbounds i8, i8 addrspace(1)* %0, i64 %29
  store i8 %167, i8 addrspace(1)* %168, align 1, !tbaa !17
  %169 = add nuw nsw i32 %26, 1
  %170 = icmp eq i32 %169, %1
  br i1 %170, label %24, label %25, !llvm.loop !20
}

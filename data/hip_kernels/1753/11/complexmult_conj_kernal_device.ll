; ModuleID = '../data/hip_kernels/1753/11/main.cu'
source_filename = "../data/hip_kernels/1753/11/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z23complexmult_conj_kernalPfPKfi(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture readonly %1, i32 %2) local_unnamed_addr #0 {
...
26:                                               ; preds = %3
  ...
  %33 = load float, float addrspace(1)* %32, align 4, !tbaa !16, !amdgpu.noclobber !15
  ...
  %38 = fmul contract float %30, %35
  %39 = fmul contract float %33, %37
  %40 = fadd contract float %38, %39
  store float %40, float addrspace(1)* %29, align 4, !tbaa !16
  %41 = fmul contract float %33, %35
  %42 = fmul contract float %30, %37

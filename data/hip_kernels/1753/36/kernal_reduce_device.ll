; ModuleID = '../data/hip_kernels/1753/36/main.cu'
source_filename = "../data/hip_kernels/1753/36/main.cu"
...
define protected amdgpu_kernel void @_Z13kernal_reducePfS_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
  ...
  %21 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @sdata, i32 0, i32 %3
...
29:                                               ; preds = %25
  ...
  %33 = load float, float addrspace(3)* %21, align 4, !tbaa !7
  %34 = fadd contract float %32, %33
  store float %34, float addrspace(3)* %21, align 4, !tbaa !7
  br label %35
...
35:                                               ; preds = %29, %25
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %36 = icmp ult i32 %26, 4
  br i1 %36, label %23, label %25, !llvm.loop !11

37:                                               ; preds = %23
  %38 = load float, float addrspace(3)* getelementptr inbounds ([0 x float], [0 x float] addrspace(3)* @sdata, i32 0, i32 0), align 4, !tbaa !7

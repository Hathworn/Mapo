; ModuleID = '../data/hip_kernels/8192/343/main.cu'
source_filename = "../data/hip_kernels/8192/343/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z25ExponentialFunctionKernelfPfS_i(float %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2, i32 %3) local_unnamed_addr #0 {
...
26:                                               ; preds = %4
  ...
  %138 = fmul float %135, %0
  %139 = fneg float %138
  %140 = tail call float @llvm.fma.f32(float %0, float %135, float %139)
  %141 = tail call float @llvm.fma.f32(float %0, float %137, float %140)
  ...
  %173 = tail call float @llvm.fabs.f32(float %0)
...
204:                                              ; preds = %26, %195
  ...
  %208 = or i1 %207, %206
  %209 = fcmp olt float %0, 0.000000e+00
  %210 = xor i1 %209, %207
  ...
  %221 = getelementptr inbounds float, float addrspace(1)* %2, i64 %27

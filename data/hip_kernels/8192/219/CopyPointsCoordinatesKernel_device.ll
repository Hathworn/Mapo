; ModuleID = '../data/hip_kernels/8192/219/main.cu'
source_filename = "../data/hip_kernels/8192/219/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z27CopyPointsCoordinatesKernelPfPifffS_ii(float addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, float %2, float %3, float %4, float addrspace(1)* nocapture writeonly %5, i32 %6, i32 %7) local_unnamed_addr #0 {
...
30:                                               ; preds = %8
  ...
  %46 = icmp eq i32 %45, 0
  %47 = select i1 %46, float %2, float %34
  %48 = select i1 %46, float %3, float %38
  %49 = select i1 %46, float %4, float %42
  %50 = add nsw i32 %31, %6
  %51 = sext i32 %50 to i64
  %52 = getelementptr inbounds float, float addrspace(1)* %5, i64 %51
  store float %47, float addrspace(1)* %52, align 4, !tbaa !16
  %53 = add nsw i32 %50, 1
  %54 = sext i32 %53 to i64
  %55 = getelementptr inbounds float, float addrspace(1)* %5, i64 %54
  store float %48, float addrspace(1)* %55, align 4, !tbaa !16
  %56 = add nsw i32 %50, 2
  %57 = sext i32 %56 to i64
  %58 = getelementptr inbounds float, float addrspace(1)* %5, i64 %57
  store float %49, float addrspace(1)* %58, align 4, !tbaa !16
  br label %59

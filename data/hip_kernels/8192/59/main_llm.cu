...
#include "ChangeRecurrentWeightsKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
float *recurrentWeightDeltas = NULL;
hipMalloc(&recurrentWeightDeltas, XSIZE*YSIZE);
...
hipFree(0);
ChangeRecurrentWeightsKernel<<<gridBlock, threadBlock>>>(recurrentWeights,recurrentWeightDeltas,outputWeights,outputDeltas,recurrentWeightRTRLDerivatives,trainingRate,momentum);

; ModuleID = '../data/hip_kernels/8192/45/main.cu'
source_filename = "../data/hip_kernels/8192/45/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z31LSTMCellInputGradientKernelBPTTPfS_S_S_iii(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture writeonly %3, i32 %4, i32 %5, i32 %6) local_unnamed_addr #0 {
...
32:                                               ; preds = %7
  ...
  %41 = icmp slt i32 %37, %28
  %42 = xor i1 %39, true
  %43 = select i1 %42, i1 %41, i1 false
  %44 = icmp eq i32 %37, %28
  %45 = uitofp i1 %40 to float
  %46 = sext i32 %37 to i64
  %47 = select i1 %40, i64 %46, i64 0
  ...
  %51 = uitofp i1 %43 to float
  %52 = sub nsw i32 %37, %4
  %53 = sext i32 %52 to i64
  %54 = select i1 %43, i64 %53, i64 0
  ...
  %57 = fmul contract float %56, %51
  %58 = fadd contract float %50, %57
  %59 = uitofp i1 %44 to float

; ModuleID = '../data/hip_kernels/4472/12/main.cu'
source_filename = "../data/hip_kernels/4472/12/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [48 x i8] c"ERROR at index = %d, expected = %f, actual: %f\0A\00", align 1
...
define protected amdgpu_kernel void @_Z20check_results_kernelidPd(i32 %0, double %1, double addrspace(1)* nocapture readonly %2) local_unnamed_addr #1 {
...
14:                                               ; preds = %3
  ...
  %16 = getelementptr inbounds double, double addrspace(1)* %2, i64 %15
  %17 = load double, double addrspace(1)* %16, align 8, !tbaa !7, !amdgpu.noclobber !5
  %18 = fcmp contract une double %17, %1
  br i1 %18, label %19, label %490
...
19:                                               ; preds = %14
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([48 x i8], [48 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %28, label %32
...
473:                                              ; preds = %462, %28
  ...
  %476 = zext i32 %12 to i64
  %477 = and i64 %475, -225
  %478 = or i64 %477, 32
  %479 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %25, i64 noundef %478, i64 noundef %476, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %480 = extractelement <2 x i64> %479, i64 0
  %481 = bitcast double %1 to i64
  %482 = and i64 %480, -225
  %483 = or i64 %482, 32
  %484 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %25, i64 noundef %483, i64 noundef %481, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %485 = extractelement <2 x i64> %484, i64 0
  %486 = bitcast double %17 to i64
  %487 = and i64 %485, -227
  %488 = or i64 %487, 34
  %489 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %25, i64 noundef %488, i64 noundef %486, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  br label %490

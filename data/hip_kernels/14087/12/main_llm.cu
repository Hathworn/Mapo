...
#include "cuda_graph_maxpool_bprop_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
cuda_graph_maxpool_bprop<<<gridBlock, threadBlock>>>(gradInput,gradOutput,indices,nClusters,dim,nClustersPerThread);

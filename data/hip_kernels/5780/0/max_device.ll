; ModuleID = '../data/hip_kernels/5780/0/main.cu'
source_filename = "../data/hip_kernels/5780/0/main.cu"
...
define protected amdgpu_kernel void @_Z3maxPiS_(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture %1) local_unnamed_addr #1 {
...
33:                                               ; preds = %31
  ...
  %39 = atomicrmw max i32 addrspace(1)* %1, i32 %38 syncscope("agent-one-as") monotonic, align 4

; ModuleID = '../data/hip_kernels/14356/5/main.cu'
source_filename = "../data/hip_kernels/14356/5/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @fHadamard(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2, i64 %3) local_unnamed_addr #0 {
  ...
  %29 = add i32 %25, %28
  %30 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !16
  %31 = mul i32 %29, %30
...
39:                                               ; preds = %4
  ...
  %41 = load float, float addrspace(1)* %40, align 4, !tbaa !17, !amdgpu.noclobber !14
  %42 = getelementptr inbounds float, float addrspace(1)* %1, i64 %37
  %43 = load float, float addrspace(1)* %42, align 4, !tbaa !17, !amdgpu.noclobber !14
  %44 = fmul contract float %41, %43
  %45 = getelementptr inbounds float, float addrspace(1)* %2, i64 %37
  store float %44, float addrspace(1)* %45, align 4, !tbaa !17
  br label %46

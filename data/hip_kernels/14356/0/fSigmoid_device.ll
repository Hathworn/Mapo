; ModuleID = '../data/hip_kernels/14356/0/main.cu'
source_filename = "../data/hip_kernels/14356/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @fSigmoid(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i64 %2) local_unnamed_addr #0 {
...
38:                                               ; preds = %3
  ...
  %41 = fneg contract float %40
  %42 = fmul float %40, 0xBFF7154760000000
  %43 = tail call float @llvm.rint.f32(float %42)
  %44 = fcmp olt float %40, 0xC0562E4300000000
  %45 = fcmp ogt float %40, 0x4059D1DA00000000
  %46 = fneg float %42
  %47 = tail call float @llvm.fma.f32(float %41, float 0x3FF7154760000000, float %46)
  %48 = tail call float @llvm.fma.f32(float %41, float 0x3E54AE0BE0000000, float %47)
  %49 = fsub float %42, %43
  %50 = fadd float %48, %49
  %51 = tail call float @llvm.exp2.f32(float %50)
  %52 = fptosi float %43 to i32
  ...
  %56 = select i1 %45, float 1.000000e+00, float %55
  %57 = select i1 %44, float 0.000000e+00, float %56
  %58 = getelementptr inbounds float, float addrspace(1)* %1, i64 %36
  store float %57, float addrspace(1)* %58, align 4, !tbaa !17
  br label %59

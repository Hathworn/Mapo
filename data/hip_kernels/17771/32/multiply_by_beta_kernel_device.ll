; ModuleID = '../data/hip_kernels/17771/32/main.cu'
source_filename = "../data/hip_kernels/17771/32/main.cu"
...
define protected amdgpu_kernel void @_Z23multiply_by_beta_kernelPfS_f(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, float %2) local_unnamed_addr #0 {
...
37:                                               ; preds = %31
  ...
  %45 = fmul contract float %44, %2
  %46 = getelementptr inbounds float, float addrspace(1)* %1, i64 %42
  store float %45, float addrspace(1)* %46, align 4, !tbaa !10
  br label %47

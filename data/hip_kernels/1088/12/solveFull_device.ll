; ModuleID = '../data/hip_kernels/1088/12/main.cu'
source_filename = "../data/hip_kernels/1088/12/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

$_ZL9solveFullPdS_S_ii = comdat any

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define amdgpu_kernel void @_ZL9solveFullPdS_S_ii(double addrspace(1)* nocapture %0, double addrspace(1)* nocapture readonly %1, double addrspace(1)* nocapture readonly %2, i32 %3, i32 %4) local_unnamed_addr #0 comdat {
...
25:                                               ; preds = %5
  ...
  %42 = getelementptr inbounds double, double addrspace(1)* %1, i64 %39
  %43 = load double, double addrspace(1)* %42, align 8, !tbaa !7, !amdgpu.noclobber !5
  %44 = fmul contract double %38, %43
  %45 = getelementptr inbounds double, double addrspace(1)* %2, i64 %39
  %46 = load double, double addrspace(1)* %45, align 8, !tbaa !7, !amdgpu.noclobber !5
  %47 = fmul contract double %33, %46
  %48 = fadd contract double %44, %47
  %49 = fsub contract double %41, %48
  store double %49, double addrspace(1)* %40, align 8, !tbaa !7
  br label %50

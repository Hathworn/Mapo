...
#include "cunnx_WindowGate_updateGradInput_kernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
cunnx_WindowGate_updateGradInput_kernel<<<gridBlock, threadBlock>>>(gradInput,error,targetCentroids,centroids,input,outputIndice,output,gradOutput,inputSize,outputSize,outputWindowSize,c,d,e,lr);

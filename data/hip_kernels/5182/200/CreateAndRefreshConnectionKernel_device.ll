; ModuleID = '../data/hip_kernels/5182/200/main.cu'
source_filename = "../data/hip_kernels/5182/200/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn writeonly
define protected amdgpu_kernel void @_Z32CreateAndRefreshConnectionKerneliiPiS_i(i32 %0, i32 %1, i32 addrspace(1)* nocapture writeonly %2, i32 addrspace(1)* nocapture writeonly %3, i32 %4) local_unnamed_addr #0 {
...
27:                                               ; preds = %5
  ...
  store i32 1, i32 addrspace(1)* %31, align 4, !tbaa !16
  %32 = getelementptr inbounds i32, i32 addrspace(1)* %3, i64 %30
  store i32 0, i32 addrspace(1)* %32, align 4, !tbaa !16
  %33 = mul nsw i32 %4, %1
  %34 = add nsw i32 %33, %0
  %35 = sext i32 %34 to i64
  %36 = getelementptr inbounds i32, i32 addrspace(1)* %2, i64 %35
  store i32 1, i32 addrspace(1)* %36, align 4, !tbaa !16
  %37 = getelementptr inbounds i32, i32 addrspace(1)* %3, i64 %35

; ModuleID = '../data/hip_kernels/5182/297/main.cu'
source_filename = "../data/hip_kernels/5182/297/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z19FillAdjacencyMatrixPfS_iiii(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3, i32 %4, i32 %5) local_unnamed_addr #0 {
...
43:                                               ; preds = %36
  ...
  %53 = fcmp contract une float %52, %48
...
54:                                               ; preds = %43
  ...
  %59 = fcmp contract une float %58, %48
  br i1 %59, label %60, label %74

60:                                               ; preds = %54, %43
  %61 = phi float [ %52, %43 ], [ %58, %54 ]
  %62 = phi float addrspace(1)* [ %51, %43 ], [ %57, %54 ]
  %63 = fptosi float %61 to i32
  %64 = mul nsw i32 %47, %5
  %65 = add nsw i32 %64, %63
  %66 = sext i32 %65 to i64
  %67 = getelementptr inbounds float, float addrspace(1)* %0, i64 %66
  store float 1.000000e+00, float addrspace(1)* %67, align 4, !tbaa !16
  %68 = load float, float addrspace(1)* %62, align 4, !tbaa !16
  %69 = fptosi float %68 to i32
  %70 = mul nsw i32 %69, %5
  %71 = add nsw i32 %70, %47
  %72 = sext i32 %71 to i64
  %73 = getelementptr inbounds float, float addrspace(1)* %0, i64 %72
  store float 1.000000e+00, float addrspace(1)* %73, align 4, !tbaa !16
  br label %74

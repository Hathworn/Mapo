; ModuleID = '../data/hip_kernels/5182/350/main.cu'
source_filename = "../data/hip_kernels/5182/350/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z24PrepareDerivativesKernelPfS_S_ii(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture %1, float addrspace(1)* nocapture %2, i32 %3, i32 %4) local_unnamed_addr #0 {
...
28:                                               ; preds = %5
  ...
  %32 = fmul contract float %31, 1.000000e+05
  ...
  %37 = fmul contract float %36, 1.000000e+05
  %38 = getelementptr inbounds float, float addrspace(1)* %0, i64 %29
  %39 = load float, float addrspace(1)* %38, align 4, !tbaa !16, !amdgpu.noclobber !5
  %40 = getelementptr inbounds float, float addrspace(1)* %1, i64 %29
  %41 = load float, float addrspace(1)* %40, align 4, !tbaa !16, !amdgpu.noclobber !5
  %42 = fsub contract float %39, %41
  %43 = fmul contract float %42, 1.000000e+05
  ...
  %54 = fmul contract float %37, %43
  %55 = shl nsw i32 %26, 2
  %56 = add nsw i32 %25, %55
  %57 = sext i32 %56 to i64
  %58 = getelementptr inbounds float, float addrspace(1)* %2, i64 %57
  store float %54, float addrspace(1)* %58, align 4, !tbaa !16
  %59 = fmul contract float %32, %32
  store float %59, float addrspace(1)* %30, align 4, !tbaa !16
  %60 = fmul contract float %37, %37

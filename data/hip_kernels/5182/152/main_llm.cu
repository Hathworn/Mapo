...
#include "FullyConnectedAdjustMemoryKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
FullyConnectedAdjustMemoryKernel<<<gridBlock, threadBlock>>>(weightsGradPtr,biasGradPtr,weightGradCurvePtr,biasGradCurvePtr,avgWeightGradPtr,avgBiasGradPtr,avgWeightGradVarPtr,avgBiasGradVarPtr,avgWeightGradCurvePtr,avgBiasGradCurvePtr,avgWeightGradCurveVarPtr,avgBiasGradCurveVarPtr,weightMemorySizePtr,biasMemorySizePtr,dropoutMaskPtr,prevLayerSize,thisLayerSize);

; ModuleID = '../data/hip_kernels/5182/94/main.cu'
source_filename = "../data/hip_kernels/5182/94/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z11InterpolatePfS_S_fi(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2, float %3, i32 %4) local_unnamed_addr #0 {
...
27:                                               ; preds = %5
  %28 = fcmp contract ugt float %3, 0.000000e+00
...
33:                                               ; preds = %27
  %34 = fcmp contract ult float %3, 1.000000e+00
...
39:                                               ; preds = %33
  %40 = fsub contract float 1.000000e+00, %3
  ...
  %47 = fmul contract float %46, %3
  %48 = fadd contract float %44, %47
  br label %49

49:                                               ; preds = %35, %39, %29
  %50 = phi i64 [ %30, %29 ], [ %41, %39 ], [ %36, %35 ]
  %51 = phi float [ %32, %29 ], [ %48, %39 ], [ %38, %35 ]
  %52 = getelementptr inbounds float, float addrspace(1)* %2, i64 %50

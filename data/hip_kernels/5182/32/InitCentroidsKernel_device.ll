; ModuleID = '../data/hip_kernels/5182/32/main.cu'
source_filename = "../data/hip_kernels/5182/32/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z19InitCentroidsKernelPfS_ffffi(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, float %2, float %3, float %4, float %5, i32 %6) local_unnamed_addr #0 {
...
29:                                               ; preds = %7
  ...
  %36 = fadd contract float %35, %2
  %37 = getelementptr inbounds float, float addrspace(1)* %0, i64 %32
  store float %36, float addrspace(1)* %37, align 4, !tbaa !16
  %38 = fsub contract float %5, %4

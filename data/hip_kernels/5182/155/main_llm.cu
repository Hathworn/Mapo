...
#include "FullyConnectedShiftKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
FullyConnectedShiftKernel<<<gridBlock, threadBlock>>>(weightPtr,biasPtr,shiftedWeightsPtr,shiftedBiasPtr,avgWeightGradPtr,avgBiasGradPtr,dropoutMaskPtr,prevLayerSize,thisLayerSize);

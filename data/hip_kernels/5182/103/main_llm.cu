...
#include "RBMForwardKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
RBMForwardKernel<<<gridBlock, threadBlock>>>(inputPtr,outputPtr,weightPtr,biasPtr,sigma,prevLayerSize,thisLayerSize,useDropoutMask,useDropout,dropoutRate,dropoutMask);

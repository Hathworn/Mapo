...
#include "LSTMDeltaKernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
LSTMDeltaKernel<<<gridBlock, threadBlock>>>(cellStateErrors,outputGateDeltas,cellStates,outputGateActivations,outputGateActivationDerivatives,deltas,cellCount,cellsPerBlock);

...
#include "atomicmaxgradinput_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
atomicmaxgradinput<<<gridBlock, threadBlock>>>(gradInput,gradOutput,indices_x,indices_y,input_n,input_h,input_w,kH,kW,dH,dW);

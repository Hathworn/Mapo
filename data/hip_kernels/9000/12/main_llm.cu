...
#include "dev_get_potential_at_point_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
dev_get_potential_at_point<<<gridBlock, threadBlock>>>(eps2,eps,xh,yh,zh,xt,yt,zt,phi,n,field_m,fxh,fyh,fzh,fxt,fyt,fzt,n_field);

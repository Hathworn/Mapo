; ModuleID = '../data/hip_kernels/16612/46/main.cu'
source_filename = "../data/hip_kernels/16612/46/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z11wgan_kerneliPfS_S_S_(i32 %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture writeonly %3, float addrspace(1)* nocapture writeonly %4) local_unnamed_addr #0 {
...
27:                                               ; preds = %5
  ...
  %31 = fcmp contract une float %30, 0.000000e+00
  ...
  %35 = select contract i1 %31, float %34, float %33
  %36 = getelementptr inbounds float, float addrspace(1)* %4, i64 %28
  store float %35, float addrspace(1)* %36, align 4, !tbaa !16
  %37 = load float, float addrspace(1)* %29, align 4, !tbaa !16
  %38 = fcmp contract ogt float %37, 0.000000e+00
  %39 = select i1 %38, float 1.000000e+00, float -1.000000e+00
  %40 = getelementptr inbounds float, float addrspace(1)* %3, i64 %28

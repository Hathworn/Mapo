; ModuleID = '../data/hip_kernels/12544/257/main.cu'
source_filename = "../data/hip_kernels/12544/257/main.cu"
...
134:                                              ; preds = %39, %58
  ...
  %167 = select i1 %166, double %152, double %164
  %168 = bitcast double %167 to <2 x i32>
  %169 = shl i32 %137, 30
  %170 = and i32 %169, -2147483648
  %171 = extractelement <2 x i32> %168, i64 1
  %172 = xor i32 %171, %170
  %173 = insertelement <2 x i32> %168, i32 %172, i64 1
  %174 = tail call i1 @llvm.amdgcn.class.f64(double %37, i32 504)
  %175 = select i1 %174, <2 x i32> %173, <2 x i32> <i32 0, i32 2146959360>
  %176 = getelementptr inbounds double, double addrspace(1)* %4, i64 %34
  %177 = bitcast double addrspace(1)* %176 to <2 x i32> addrspace(1)*
  store <2 x i32> %175, <2 x i32> addrspace(1)* %177, align 8, !tbaa !16
  br label %178

178:                                              ; preds = %27, %30, %134
  %179 = add i32 %25, %28
  %180 = icmp slt i32 %179, %0
  br i1 %180, label %27, label %26, !llvm.loop !20
}

; ModuleID = '../data/hip_kernels/12544/183/main.cu'
source_filename = "../data/hip_kernels/12544/183/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z14uniform_doubleiddPd(i32 %0, double %1, double %2, double addrspace(1)* nocapture %3) local_unnamed_addr #0 {
...
24:                                               ; preds = %4, %24
  ...
  %29 = fmul contract double %28, %2
  %30 = fsub contract double 1.000000e+00, %28
  %31 = fmul contract double %30, %1
  %32 = fadd contract double %29, %31
  store double %32, double addrspace(1)* %27, align 8, !tbaa !16

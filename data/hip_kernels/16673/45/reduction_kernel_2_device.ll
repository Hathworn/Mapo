; ModuleID = '../data/hip_kernels/16673/45/main.cu'
source_filename = "../data/hip_kernels/16673/45/main.cu"
...
define protected amdgpu_kernel void @_Z18reduction_kernel_2PfS_j(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, i32 %2) local_unnamed_addr #0 {
...
28:                                               ; preds = %24
  ...
  %30 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @s_data, i32 0, i32 %29
...
36:                                               ; preds = %22
  %37 = load float, float addrspace(3)* getelementptr inbounds ([0 x float], [0 x float] addrspace(3)* @s_data, i32 0, i32 0), align 4, !tbaa !7

; ModuleID = '../data/hip_kernels/16673/44/main.cu'
source_filename = "../data/hip_kernels/16673/44/main.cu"
...
define protected amdgpu_kernel void @_Z18reduction_kernel_1PfS_j(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, i32 %2) local_unnamed_addr #0 {
...
29:                                               ; preds = %24
  %30 = add i32 %27, %25
  %31 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @s_data, i32 0, i32 %30
  %32 = load float, float addrspace(3)* %31, align 4, !tbaa !7
  %33 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @s_data, i32 0, i32 %27
  %34 = load float, float addrspace(3)* %33, align 4, !tbaa !7
  %35 = fadd contract float %32, %34
  store float %35, float addrspace(3)* %33, align 4, !tbaa !7
  br label %36

; ModuleID = '../data/hip_kernels/2416/31/main.cu'
source_filename = "../data/hip_kernels/2416/31/main.cu"
...
17:                                               ; preds = %6
  ...
  %27 = load i32, i32 addrspace(3)* %23, align 4, !tbaa !7
  ...
  store i32 %31, i32 addrspace(3)* %29, align 4
  %32 = getelementptr inbounds i32, i32 addrspace(1)* %2, i64 %20

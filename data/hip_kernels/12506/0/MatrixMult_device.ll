; ModuleID = '../data/hip_kernels/12506/0/main.cu'
source_filename = "../data/hip_kernels/12506/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z10MatrixMultiiiPdS_S_(i32 %0, i32 %1, i32 %2, double addrspace(1)* nocapture readonly %3, double addrspace(1)* nocapture readonly %4, double addrspace(1)* nocapture writeonly %5) local_unnamed_addr #0 {
...
58:                                               ; preds = %35, %40, %27
  ...
  %63 = getelementptr inbounds double, double addrspace(1)* %5, i64 %62
...
64:                                               ; preds = %64, %33
  ...
  %82 = getelementptr inbounds double, double addrspace(1)* %3, i64 %81
  ...
  %99 = getelementptr inbounds double, double addrspace(1)* %4, i64 %98
  ...
  %106 = getelementptr inbounds double, double addrspace(1)* %3, i64 %105
  ...
  %112 = load double, double addrspace(1)* %111, align 8, !tbaa !7, !amdgpu.noclobber !6
  ...
  %123 = getelementptr inbounds double, double addrspace(1)* %4, i64 %122
  %124 = load double, double addrspace(1)* %123, align 8, !tbaa !7, !amdgpu.noclobber !6
  ...
  %131 = load double, double addrspace(1)* %130, align 8, !tbaa !7, !amdgpu.noclobber !6
  %132 = mul nsw i32 %127, %2
  %133 = add nsw i32 %132, %23
  %134 = sext i32 %133 to i64
  %135 = getelementptr inbounds double, double addrspace(1)* %4, i64 %134
  %136 = load double, double addrspace(1)* %135, align 8, !tbaa !7, !amdgpu.noclobber !6
  ...
  %143 = load double, double addrspace(1)* %142, align 8, !tbaa !7, !amdgpu.noclobber !6
  ...
  %155 = load double, double addrspace(1)* %154, align 8, !tbaa !7, !amdgpu.noclobber !6
  %156 = mul nsw i32 %151, %2
  %157 = add nsw i32 %156, %23
  %158 = sext i32 %157 to i64
  %159 = getelementptr inbounds double, double addrspace(1)* %4, i64 %158

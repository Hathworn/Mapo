; ModuleID = '../data/hip_kernels/7806/45/main.cu'
source_filename = "../data/hip_kernels/7806/45/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: mustprogress nofree norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z26kernelFixVertArray_MissingPiiS_(i32 addrspace(1)* nocapture %0, i32 %1, i32 addrspace(1)* nocapture %2) local_unnamed_addr #0 {
...
25:                                               ; preds = %3
  ...
  %30 = load i32, i32 addrspace(1)* %29, align 4, !tbaa !16, !amdgpu.noclobber !14
  %31 = add nsw i32 %26, 5
  %32 = sext i32 %31 to i64
  %33 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %32
  %34 = load i32, i32 addrspace(1)* %33, align 4, !tbaa !16, !amdgpu.noclobber !14
  %35 = add nsw i32 %26, 3
  ...
  %41 = shl i32 %23, 2
  %42 = atomicrmw xchg i32 addrspace(1)* %40, i32 %41 syncscope("agent-one-as") monotonic, align 4
  %43 = add nsw i32 %26, 6
  %44 = sext i32 %43 to i64
  %45 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %44
  store i32 %42, i32 addrspace(1)* %45, align 4, !tbaa !16
  %46 = sext i32 %34 to i64
  %47 = getelementptr inbounds i32, i32 addrspace(1)* %2, i64 %46
  %48 = or i32 %41, 1
  %49 = atomicrmw xchg i32 addrspace(1)* %47, i32 %48 syncscope("agent-one-as") monotonic, align 4
  %50 = add nsw i32 %26, 7
  ...
  %55 = or i32 %41, 2
  %56 = atomicrmw xchg i32 addrspace(1)* %54, i32 %55 syncscope("agent-one-as") monotonic, align 4
  %57 = add nsw i32 %26, 8
  %58 = sext i32 %57 to i64
  %59 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %58
  store i32 %56, i32 addrspace(1)* %59, align 4, !tbaa !16
  br label %60

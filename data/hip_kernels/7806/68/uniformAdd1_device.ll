; ModuleID = '../data/hip_kernels/7806/68/main.cu'
source_filename = "../data/hip_kernels/7806/68/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ11uniformAdd1PiS_iiiE3uni = internal unnamed_addr addrspace(3) global i32 undef, align 4

; Function Attrs: convergent mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z11uniformAdd1PiS_iii(i32 addrspace(1)* nocapture %0, i32 addrspace(1)* nocapture readonly %1, i32 %2, i32 %3, i32 %4) local_unnamed_addr #0 {
...
9:                                                ; preds = %5
  ...
  store i32 %13, i32 addrspace(3)* @_ZZ11uniformAdd1PiS_iiiE3uni, align 4, !tbaa !5
  br label %14
...
14:                                               ; preds = %5, %9
  ...
  %25 = load i32, i32 addrspace(3)* @_ZZ11uniformAdd1PiS_iiiE3uni, align 4, !tbaa !5

; ModuleID = '../data/hip_kernels/2583/0/main.cu'
source_filename = "../data/hip_kernels/2583/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z12updateParamsiiffffPfS_S_S_(i32 %0, i32 %1, float %2, float %3, float %4, float %5, float addrspace(1)* nocapture %6, float addrspace(1)* nocapture readonly %7, float addrspace(1)* nocapture %8, float addrspace(1)* nocapture %9) local_unnamed_addr #0 {
  ...
  %30 = fsub contract float 1.000000e+00, %3
  %31 = fneg contract float %2
  %32 = tail call float @llvm.fabs.f32(float %3)
  ...
  %140 = fmul float %137, %5
  %141 = fneg float %140
  %142 = tail call float @llvm.fma.f32(float %5, float %137, float %141)
  %143 = tail call float @llvm.fma.f32(float %5, float %139, float %142)
  ...
  %175 = tail call float @llvm.fabs.f32(float %5)
...
206:                                              ; preds = %10, %197
  %207 = phi float [ %195, %10 ], [ %205, %197 ]
  %208 = fcmp oeq float %3, 0.000000e+00
  %209 = icmp slt i32 %19, %0
  %210 = icmp slt i32 %27, %1
  %211 = select i1 %209, i1 %210, i1 false
  br i1 %211, label %212, label %249

212:                                              ; preds = %206
  %213 = fcmp oeq float %3, 1.000000e+00
  %214 = fcmp oeq float %5, 0.000000e+00
  %215 = or i1 %213, %214
  %216 = fcmp uno float %3, %5
  %217 = fcmp oeq float %32, 0x7FF0000000000000
  %218 = or i1 %208, %217
  %219 = fcmp olt float %5, 0.000000e+00
  %220 = xor i1 %208, %219
  %221 = select i1 %220, float 0.000000e+00, float 0x7FF0000000000000
  %222 = select i1 %187, float %3, float 0.000000e+00
  %223 = tail call float @llvm.copysign.f32(float %221, float %222)
  %224 = select i1 %218, float %223, float %207
  %225 = fsub contract float 1.000000e+00, %224
  %226 = fdiv contract float 1.000000e+00, %225
  %227 = select i1 %216, float 0x7FF8000000000000, float %226
  %228 = select i1 %215, float 0x7FF0000000000000, float %227
  %229 = fmul contract float %228, %31
  %230 = sext i32 %29 to i64
  %231 = getelementptr inbounds float, float addrspace(1)* %8, i64 %230
  %232 = load float, float addrspace(1)* %231, align 4, !tbaa !7, !amdgpu.noclobber !5
  %233 = getelementptr inbounds float, float addrspace(1)* %7, i64 %230
  %234 = load float, float addrspace(1)* %233, align 4, !tbaa !7, !amdgpu.noclobber !5
  %235 = fmul contract float %30, %234
  %236 = tail call float @llvm.fma.f32(float %3, float %232, float %235)
  store float %236, float addrspace(1)* %231, align 4, !tbaa !7
  %237 = getelementptr inbounds float, float addrspace(1)* %9, i64 %230
  %238 = load float, float addrspace(1)* %237, align 4, !tbaa !7
  %239 = fmul contract float %238, %4
  %240 = load float, float addrspace(1)* %233, align 4, !tbaa !7
  %241 = tail call float @llvm.fabs.f32(float %240)
  %242 = tail call float @llvm.maxnum.f32(float %239, float %241)
  %243 = tail call float @llvm.maxnum.f32(float %242, float 0x3C9CD2B2A0000000)
  store float %243, float addrspace(1)* %237, align 4, !tbaa !7
  %244 = load float, float addrspace(1)* %231, align 4, !tbaa !7
  %245 = fdiv contract float %244, %243
  %246 = getelementptr inbounds float, float addrspace(1)* %6, i64 %230
  %247 = load float, float addrspace(1)* %246, align 4, !tbaa !7
  %248 = tail call float @llvm.fma.f32(float %229, float %245, float %247)
  store float %248, float addrspace(1)* %246, align 4, !tbaa !7
  br label %249

; ModuleID = '../data/hip_kernels/2583/18/main.cu'
source_filename = "../data/hip_kernels/2583/18/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z12cauchyLogErriiPfS_(i32 %0, i32 %1, float addrspace(1)* nocapture %2, float addrspace(1)* nocapture readonly %3) local_unnamed_addr #0 {
...
27:                                               ; preds = %4
  ...
  store float %41, float addrspace(1)* %35, align 4, !tbaa !7
  %42 = fmul contract float %33, 5.000000e-01
  %43 = tail call float @llvm.log.f32(float %42)
  %44 = fneg contract float %43
  store float %44, float addrspace(1)* %31, align 4, !tbaa !7
  br label %45

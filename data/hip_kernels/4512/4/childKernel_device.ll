; ModuleID = '../data/hip_kernels/4512/4/main.cu'
source_filename = "../data/hip_kernels/4512/4/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [49 x i8] c"Parent thread index: %d, child thread index: %d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z11childKerneljPf(i32 %0, float addrspace(1)* nocapture writeonly %1) local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([49 x i8], [49 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %12, label %16
...
20:                                               ; preds = %446, %16
  %21 = phi i64 [ select (i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([49 x i8], [49 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), i64 0, i64 add (i64 ptrtoint (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([49 x i8], [49 x i8] addrspace(4)* @.str, i64 0, i64 48) to i8*) to i64), i64 add (i64 sub (i64 0, i64 ptrtoint ([49 x i8]* addrspacecast ([49 x i8] addrspace(4)* @.str to [49 x i8]*) to i64)), i64 1))), %16 ], [ %454, %446 ]
  %22 = phi i8 addrspace(4)* [ getelementptr inbounds ([49 x i8], [49 x i8] addrspace(4)* @.str, i64 0, i64 0), %16 ], [ %455, %446 ]
...
457:                                              ; preds = %446, %12
  ...
  %469 = uitofp i32 %0 to float
  %470 = uitofp i32 %3 to float
  %471 = fmul contract float %470, 0x3FB99999A0000000
  %472 = fadd contract float %471, %469
  %473 = getelementptr inbounds float, float addrspace(1)* %1, i64 %465
  store float %472, float addrspace(1)* %473, align 4, !tbaa !12
  ret void
}

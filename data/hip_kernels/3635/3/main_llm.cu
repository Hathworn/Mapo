...
#include "psamask_distribute_backward_cuda_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
psamask_distribute_backward_cuda<<<gridBlock, threadBlock>>>(nthreads,feature_H_,feature_W_,mask_H_,mask_W_,half_mask_H_,half_mask_W_,buffer_diff,mask_diff);

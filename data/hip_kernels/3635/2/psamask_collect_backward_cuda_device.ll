; ModuleID = '../data/hip_kernels/3635/2/main.cu'
source_filename = "../data/hip_kernels/3635/2/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z29psamask_collect_backward_cudaiiiiiiiPKfPf(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, float addrspace(1)* nocapture readonly %7, float addrspace(1)* nocapture writeonly %8) local_unnamed_addr #0 {
...
68:                                               ; preds = %71, %33
  ...
  br i1 %70, label %33, label %32, !llvm.loop !16

71:                                               ; preds = %74, %60
  %72 = add nuw nsw i32 %61, 1
  %73 = icmp slt i32 %72, %47
  br i1 %73, label %60, label %68, !llvm.loop !18

74:                                               ; preds = %62, %74
  %75 = phi i32 [ %49, %62 ], [ %91, %74 ]
  %76 = add i32 %65, %75
  %77 = mul nsw i32 %76, %1
  %78 = add i32 %77, %43
  %79 = mul i32 %78, %2
  ...
  store float %83, float addrspace(1)* %90, align 4, !tbaa !19
  %91 = add nuw nsw i32 %75, 1
  %92 = icmp slt i32 %91, %51
  br i1 %92, label %74, label %71, !llvm.loop !23
}

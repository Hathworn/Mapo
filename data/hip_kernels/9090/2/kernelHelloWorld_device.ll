; ModuleID = '../data/hip_kernels/9090/2/main.cu'
source_filename = "../data/hip_kernels/9090/2/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [41 x i8] c"Hello World from thread %d of block %d!\0A\00", align 1
...
define protected amdgpu_kernel void @_Z16kernelHelloWorldv() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([41 x i8], [41 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %9, label %13

...
#include "adaptivemaxgradinput_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
adaptivemaxgradinput<<<gridBlock, threadBlock>>>(gradInput,gradOutput,indices_x,indices_y,input_n,input_h,input_w,output_h,output_w);

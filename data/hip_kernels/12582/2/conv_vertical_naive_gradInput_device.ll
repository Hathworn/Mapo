; ModuleID = '../data/hip_kernels/12582/2/main.cu'
source_filename = "../data/hip_kernels/12582/2/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z29conv_vertical_naive_gradInputiPfPKfS1_iii(i32 %0, float addrspace(1)* nocapture %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, i32 %4, i32 %5, i32 %6) local_unnamed_addr #0 {
...
32:                                               ; preds = %21, %50
  ...
  store float 0.000000e+00, float addrspace(1)* %47, align 4, !tbaa !16
  %48 = add nsw i32 %43, 1
...
50:                                               ; preds = %53, %32
  ...
  br i1 %52, label %32, label %31, !llvm.loop !20

53:                                               ; preds = %32, %53
  %54 = phi float [ %67, %53 ], [ 0.000000e+00, %32 ]
  %55 = phi i32 [ %68, %53 ], [ %48, %32 ]
  ...
  %66 = fmul contract float %59, %65
  %67 = fadd contract float %54, %66
  store float %67, float addrspace(1)* %47, align 4, !tbaa !16
  %68 = add nsw i32 %55, 1
  %69 = icmp slt i32 %68, %45
  br i1 %69, label %53, label %50, !llvm.loop !22
}

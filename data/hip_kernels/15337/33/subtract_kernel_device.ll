; ModuleID = '../data/hip_kernels/15337/33/main.cu'
source_filename = "../data/hip_kernels/15337/33/main.cu"
...
define protected amdgpu_kernel void @_Z15subtract_kernelPfS_S_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
...
31:                                               ; preds = %3
  %32 = load i32, i32 addrspace(4)* getelementptr inbounds (%struct.HIP_vector_type, %struct.HIP_vector_type addrspace(4)* @c_Size, i64 0, i32 0, i32 0, i32 0, i32 0, i64 1), align 4, !tbaa !7
  %33 = icmp ult i32 %20, %32
  %34 = load i32, i32 addrspace(4)* getelementptr inbounds (%struct.HIP_vector_type, %struct.HIP_vector_type addrspace(4)* @c_Size, i64 0, i32 0, i32 0, i32 0, i32 0, i64 2), align 4
...
37:                                               ; preds = %31
  ...
  %44 = load float, float addrspace(1)* %43, align 4, !tbaa !10, !amdgpu.noclobber !5
  ...
  %48 = getelementptr inbounds float, float addrspace(1)* %2, i64 %42
  store float %47, float addrspace(1)* %48, align 4, !tbaa !10
  br label %49

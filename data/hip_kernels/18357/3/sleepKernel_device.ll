; ModuleID = '../data/hip_kernels/18357/3/main.cu'
source_filename = "../data/hip_kernels/18357/3/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z11sleepKernelPdl(double addrspace(1)* nocapture writeonly %0, i64 %1) local_unnamed_addr #0 {
...
8:                                                ; preds = %4
  %9 = tail call i64 @llvm.amdgcn.s.memtime()
  %10 = sub nsw i64 %9, %3
  %11 = sitofp i64 %10 to double
  store double %11, double addrspace(1)* %0, align 8, !tbaa !4
  ret void
}

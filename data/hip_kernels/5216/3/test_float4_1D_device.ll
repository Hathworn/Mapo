; ModuleID = '../data/hip_kernels/5216/3/main.cu'
source_filename = "../data/hip_kernels/5216/3/main.cu"
...
@texture_float4_1D = protected addrspace(1) externally_initialized global %struct.texture.2 undef, align 8
...
@llvm.compiler.used = appending addrspace(1) global [1 x i8*] [i8* addrspacecast (i8 addrspace(1)* bitcast (%struct.texture.2 addrspace(1)* @texture_float4_1D to i8 addrspace(1)*) to i8*)], section "llvm.metadata"

; Function Attrs: mustprogress nofree norecurse nounwind willreturn
define protected amdgpu_kernel void @test_float4_1D(%struct.HIP_vector_type addrspace(1)* nocapture writeonly %0, float %1) local_unnamed_addr #0 {
  %3 = load %struct.__hip_texture*, %struct.__hip_texture* addrspace(1)* getelementptr inbounds (%struct.texture.2, %struct.texture.2 addrspace(1)* @texture_float4_1D, i64 0, i32 0, i32 11), align 8
  ...
  %27 = tail call <4 x float> @llvm.amdgcn.image.sample.lz.1d.v4f32.f32(i32 15, float %26, <8 x i32> %18, <4 x i32> %15, i1 false, i32 0, i32 0)
  %28 = getelementptr inbounds %struct.HIP_vector_type, %struct.HIP_vector_type addrspace(1)* %0, i64 0, i32 0, i32 0, i32 0
...
declare <4 x float> @llvm.amdgcn.image.sample.lz.1d.v4f32.f32(i32 immarg, float, <8 x i32>, <4 x i32>, i1 immarg, i32 immarg, i32 immarg) #3

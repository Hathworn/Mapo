; ModuleID = '../data/hip_kernels/5216/2/main.cu'
source_filename = "../data/hip_kernels/5216/2/main.cu"
...
@texture_float_3D = protected addrspace(1) externally_initialized global %struct.texture.1 undef, align 8
...
@llvm.compiler.used = appending addrspace(1) global [1 x i8*] [i8* addrspacecast (i8 addrspace(1)* bitcast (%struct.texture.1 addrspace(1)* @texture_float_3D to i8 addrspace(1)*) to i8*)], section "llvm.metadata"

; Function Attrs: mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @test_float_3D(float addrspace(1)* nocapture writeonly %0, float %1, float %2, float %3) local_unnamed_addr #0 {
  %5 = load %struct.__hip_texture*, %struct.__hip_texture* addrspace(1)* getelementptr inbounds (%struct.texture.1, %struct.texture.1 addrspace(1)* @texture_float_3D, i64 0, i32 0, i32 11), align 8
  ...
  %53 = tail call float @llvm.amdgcn.image.sample.lz.3d.f32.f32(i32 1, float %52, float %47, float %42, <8 x i32> %37, <4 x i32> %34, i1 false, i32 0, i32 0)
  store float %53, float addrspace(1)* %0, align 4, !tbaa !9
  ret void
}
...
declare float @llvm.amdgcn.image.sample.lz.3d.f32.f32(i32 immarg, float, float, float, <8 x i32>, <4 x i32>, i1 immarg, i32 immarg, i32 immarg) #3

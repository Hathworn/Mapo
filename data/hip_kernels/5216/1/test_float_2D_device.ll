; ModuleID = '../data/hip_kernels/5216/1/main.cu'
source_filename = "../data/hip_kernels/5216/1/main.cu"
...
@texture_float_2D = protected addrspace(1) externally_initialized global %struct.texture.0 undef, align 8
...
@llvm.compiler.used = appending addrspace(1) global [1 x i8*] [i8* addrspacecast (i8 addrspace(1)* bitcast (%struct.texture.0 addrspace(1)* @texture_float_2D to i8 addrspace(1)*) to i8*)], section "llvm.metadata"

; Function Attrs: mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @test_float_2D(float addrspace(1)* nocapture writeonly %0, float %1, float %2) local_unnamed_addr #0 {
  %4 = load %struct.__hip_texture*, %struct.__hip_texture* addrspace(1)* getelementptr inbounds (%struct.texture.0, %struct.texture.0 addrspace(1)* @texture_float_2D, i64 0, i32 0, i32 11), align 8
  ...
  %41 = tail call float @llvm.amdgcn.image.sample.lz.2d.f32.f32(i32 1, float %40, float %35, <8 x i32> %30, <4 x i32> %27, i1 false, i32 0, i32 0)
  store float %41, float addrspace(1)* %0, align 4, !tbaa !9
  ret void
}

; ModuleID = '../data/hip_kernels/2535/4/main.cu'
source_filename = "../data/hip_kernels/2535/4/main.cu"
...
define protected amdgpu_kernel void @_Z21resampleFloat4_KernelP15HIP_vector_typeIfLj4EEjjPKS0_jj(%struct.HIP_vector_type addrspace(1)* nocapture writeonly %0, i32 %1, i32 %2, %struct.HIP_vector_type addrspace(1)* nocapture readonly %3, i32 %4, i32 %5) local_unnamed_addr #0 {
...
49:                                               ; preds = %27
  ...
  %59 = bitcast %struct.HIP_vector_type addrspace(1)* %53 to i8 addrspace(1)*

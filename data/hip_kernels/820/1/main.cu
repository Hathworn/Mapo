...
uint64_cu *d_startInputlist = NULL;
hipMalloc(&d_startInputlist, XSIZE*YSIZE);
...
hipFree(0);
prime_generator<<<gridBlock, threadBlock>>>(d_input_list,d_prime_list,d_startInputlist,d_total_inputsize,d_number_of_primes);

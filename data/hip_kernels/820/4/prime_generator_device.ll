; ModuleID = '../data/hip_kernels/820/4/main.cu'
source_filename = "../data/hip_kernels/820/4/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [21 x i8] c"-------XXXXXX>>> %d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z15prime_generatorPiS_S_S_(i32 addrspace(1)* nocapture writeonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture readnone %2, i32 addrspace(1)* nocapture readonly %3) local_unnamed_addr #1 {
  ...
  %9 = load i64, i64 addrspace(4)* %8, align 8, !tbaa !9
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([21 x i8], [21 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %14, label %18
...
37:                                               ; preds = %22
  %38 = load i8, i8 addrspace(4)* %24, align 1, !tbaa !13
  %39 = zext i8 %38 to i64
  %40 = getelementptr inbounds i8, i8 addrspace(4)* %24, i64 1
  %41 = load i8, i8 addrspace(4)* %40, align 1, !tbaa !13
...
97:                                               ; preds = %90
  %98 = load i8, i8 addrspace(4)* %91, align 1, !tbaa !13
  %99 = zext i8 %98 to i64
  %100 = getelementptr inbounds i8, i8 addrspace(4)* %91, i64 1
  %101 = load i8, i8 addrspace(4)* %100, align 1, !tbaa !13
...
157:                                              ; preds = %150
  %158 = load i8, i8 addrspace(4)* %151, align 1, !tbaa !13
  %159 = zext i8 %158 to i64
  %160 = getelementptr inbounds i8, i8 addrspace(4)* %151, i64 1
  %161 = load i8, i8 addrspace(4)* %160, align 1, !tbaa !13
...
217:                                              ; preds = %210
  %218 = load i8, i8 addrspace(4)* %211, align 1, !tbaa !13
  %219 = zext i8 %218 to i64
  %220 = getelementptr inbounds i8, i8 addrspace(4)* %211, i64 1
  %221 = load i8, i8 addrspace(4)* %220, align 1, !tbaa !13
...
277:                                              ; preds = %270
  %278 = load i8, i8 addrspace(4)* %271, align 1, !tbaa !13
  %279 = zext i8 %278 to i64
  %280 = getelementptr inbounds i8, i8 addrspace(4)* %271, i64 1
  %281 = load i8, i8 addrspace(4)* %280, align 1, !tbaa !13
...
337:                                              ; preds = %330
  %338 = load i8, i8 addrspace(4)* %331, align 1, !tbaa !13
  %339 = zext i8 %338 to i64
  %340 = getelementptr inbounds i8, i8 addrspace(4)* %331, i64 1
  %341 = load i8, i8 addrspace(4)* %340, align 1, !tbaa !13
...
397:                                              ; preds = %390
  %398 = load i8, i8 addrspace(4)* %391, align 1, !tbaa !13
  %399 = zext i8 %398 to i64
  %400 = getelementptr inbounds i8, i8 addrspace(4)* %391, i64 1
  %401 = load i8, i8 addrspace(4)* %400, align 1, !tbaa !13
...
435:                                              ; preds = %395, %435
  ...
  %440 = load i8, i8 addrspace(4)* %439, align 1, !tbaa !13
...
459:                                              ; preds = %448, %14
  ...
  %466 = tail call i32 @llvm.amdgcn.workgroup.id.x()
  %467 = tail call align 4 dereferenceable(64) i8 addrspace(4)* @llvm.amdgcn.dispatch.ptr()
  %468 = getelementptr i8, i8 addrspace(4)* %467, i64 4
  %469 = bitcast i8 addrspace(4)* %468 to i16 addrspace(4)*
  %470 = load i16, i16 addrspace(4)* %469, align 4, !range !16, !invariant.load !8
  %471 = zext i16 %470 to i32
  %472 = mul i32 %466, %471
  %473 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !17
  %474 = add i32 %472, %473
  %475 = sext i32 %474 to i64
  %476 = getelementptr inbounds i32, i32 addrspace(1)* %1, i64 %475
  %477 = load i32, i32 addrspace(1)* %476, align 4, !tbaa !4
  %478 = load i32, i32 addrspace(1)* %3, align 4, !tbaa !4
  %479 = mul nsw i32 %478, %478
...
482:                                              ; preds = %459, %489
  %483 = phi i32 [ %490, %489 ], [ %478, %459 ]
  %484 = srem i32 %483, %477
  %485 = icmp eq i32 %484, 0
  br i1 %485, label %486, label %489

486:                                              ; preds = %482
  %487 = sext i32 %483 to i64
  %488 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %487
  store i32 1, i32 addrspace(1)* %488, align 4, !tbaa !4
  br label %489

489:                                              ; preds = %482, %486
  %490 = add nsw i32 %483, 1
  %491 = icmp slt i32 %490, %479
  br i1 %491, label %482, label %481, !llvm.loop !18
}
...
!24 = !{i64 2662}
!25 = !{!26, !21, i64 0}
!26 = !{!"", !21, i64 0, !21, i64 8, !27, i64 16, !10, i64 24, !10, i64 32, !10, i64 40}
!27 = !{!"hsa_signal_s", !10, i64 0}
!28 = !{!26, !10, i64 40}
!29 = !{!26, !21, i64 8}
!30 = !{!"exec"}
!31 = !{!32, !23, i64 16}
!32 = !{!"", !10, i64 0, !10, i64 8, !23, i64 16, !23, i64 20}
!33 = !{!32, !10, i64 8}
!34 = !{!32, !23, i64 20}
!35 = !{!32, !10, i64 0}
!36 = !{!37, !10, i64 16}
!37 = !{!"amd_signal_s", !10, i64 0, !11, i64 8, !10, i64 16, !23, i64 24, !23, i64 28, !10, i64 32, !10, i64 40, !11, i64 48, !11, i64 56}
!38 = !{!37, !23, i64 24}

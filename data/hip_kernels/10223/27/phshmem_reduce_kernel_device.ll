; ModuleID = '../data/hip_kernels/10223/27/main.cu'
source_filename = "../data/hip_kernels/10223/27/main.cu"
...
define protected amdgpu_kernel void @_Z21phshmem_reduce_kernelPfPKf(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1) local_unnamed_addr #0 {

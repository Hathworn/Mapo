; ModuleID = '../data/hip_kernels/6394/1/main.cu'
source_filename = "../data/hip_kernels/6394/1/main.cu"
...
define protected amdgpu_kernel void @_Z27initializeFloat1DpopulationPfiiP12hiprandStatei(float addrspace(1)* nocapture writeonly %0, i32 %1, i32 %2, %struct.hiprandState addrspace(1)* nocapture %3, i32 %4) local_unnamed_addr #0 {

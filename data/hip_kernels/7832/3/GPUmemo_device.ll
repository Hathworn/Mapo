; ModuleID = '../data/hip_kernels/7832/3/main.cu'
source_filename = "../data/hip_kernels/7832/3/main.cu"
...
@_ZZ7GPUmemoPfiE5trace = internal unnamed_addr addrspace(3) global float* undef, align 8
...
define protected amdgpu_kernel void @_Z7GPUmemoPfi(float addrspace(1)* nocapture readonly %0, i32 %1) local_unnamed_addr #1 {
  %3 = sext i32 %1 to i64
  %4 = shl nsw i64 %3, 2
  %5 = tail call fastcc i8 addrspace(1)* @__ockl_dm_alloc(i64 %4) #11
  %6 = ptrtoint i8 addrspace(1)* %5 to i64
  %7 = inttoptr i64 %6 to i8*
  store i8* %7, i8* addrspace(3)* bitcast (float* addrspace(3)* @_ZZ7GPUmemoPfiE5trace to i8* addrspace(3)*), align 8, !tbaa !4
  %8 = tail call align 4 dereferenceable(64) i8 addrspace(4)* @llvm.amdgcn.dispatch.ptr()
  %9 = getelementptr inbounds i8, i8 addrspace(4)* %8, i64 12
  %10 = bitcast i8 addrspace(4)* %9 to i32 addrspace(4)*
  %11 = load i32, i32 addrspace(4)* %10, align 4, !tbaa !8
  %12 = getelementptr i8, i8 addrspace(4)* %8, i64 4
  %13 = bitcast i8 addrspace(4)* %12 to i16 addrspace(4)*
  %14 = load i16, i16 addrspace(4)* %13, align 4, !range !17, !invariant.load !18
...
33:                                               ; preds = %33, %31
  ...
  store float %46, float* %26, align 4, !tbaa !20
  %47 = or i32 %34, 2
  %48 = mul nsw i32 %47, %1
  %49 = add i32 %48, %24
  ...
  store float %52, float* %26, align 4, !tbaa !20
  %53 = or i32 %34, 3
  %54 = mul nsw i32 %53, %1
  %55 = add i32 %54, %24
  ...
  store float %58, float* %26, align 4, !tbaa !20
  %59 = or i32 %34, 4
  %60 = mul nsw i32 %59, %1
  %61 = add i32 %60, %24
  ...
  store float %64, float* %26, align 4, !tbaa !20
  %65 = or i32 %34, 5
  %66 = mul nsw i32 %65, %1
  %67 = add i32 %66, %24
  ...
  store float %70, float* %26, align 4, !tbaa !20
  %71 = or i32 %34, 6
  %72 = mul nsw i32 %71, %1
  %73 = add i32 %72, %24
  ...
  store float %76, float* %26, align 4, !tbaa !20
  %77 = or i32 %34, 7
  %78 = mul nsw i32 %77, %1
  %79 = add i32 %78, %24
  %80 = zext i32 %79 to i64
  %81 = getelementptr inbounds float, float addrspace(1)* %0, i64 %80
  %82 = load float, float addrspace(1)* %81, align 4, !tbaa !20
  store float %82, float* %26, align 4, !tbaa !20
  %83 = add nuw nsw i32 %34, 8
  %84 = add i32 %35, 8
  %85 = icmp eq i32 %84, %32
  br i1 %85, label %86, label %33, !llvm.loop !22

86:                                               ; preds = %33, %22
  %87 = phi i32 [ 0, %22 ], [ %83, %33 ]
  %88 = icmp eq i32 %29, 0
  br i1 %88, label %100, label %89

89:                                               ; preds = %86, %89
  %90 = phi i32 [ %97, %89 ], [ %87, %86 ]
  %91 = phi i32 [ %98, %89 ], [ 0, %86 ]
  %92 = mul nsw i32 %90, %1
  %93 = add i32 %92, %24
  %94 = zext i32 %93 to i64
  %95 = getelementptr inbounds float, float addrspace(1)* %0, i64 %94
  %96 = load float, float addrspace(1)* %95, align 4, !tbaa !20
  store float %96, float* %26, align 4, !tbaa !20
...
!33 = !{i64 7137}
!34 = !{!35, !13, i64 8}
!35 = !{!"kind_info_s", !13, i64 0, !13, i64 4, !13, i64 8, !13, i64 12, !13, i64 16, !13, i64 20, !13, i64 24, !13, i64 28}
!36 = !{!37, !14, i64 108552}
!37 = !{!"heap_s", !11, i64 0, !11, i64 2048, !11, i64 4096, !11, i64 6144, !11, i64 8192, !11, i64 10240, !11, i64 108544, !14, i64 108552, !11, i64 108560, !11, i64 108672}
!38 = !{!35, !13, i64 20}
!39 = !{!35, !13, i64 0}
!40 = !{!35, !13, i64 16}
!41 = !{!13, !13, i64 0}
...
!43 = !{!11, !11, i64 0}
!44 = !{!45, !13, i64 4}
!45 = !{!"slab_s", !13, i64 0, !13, i64 4, !11, i64 8, !13, i64 12, !11, i64 16}
!46 = !{!35, !13, i64 4}
!47 = !{!48, !11, i64 8}
!48 = !{!"sdata_s", !11, i64 0, !11, i64 8, !11, i64 16}
!49 = !{!45, !13, i64 0}
!50 = !{!35, !13, i64 28}
!51 = !{!35, !13, i64 12}
!52 = !{i64 751}
...
!54 = !{i64 2662}
!55 = !{!56, !15, i64 0}
!56 = !{!"", !15, i64 0, !15, i64 8, !16, i64 16, !14, i64 24, !14, i64 32, !14, i64 40}
!57 = !{!56, !14, i64 40}
!58 = !{!56, !15, i64 8}
!59 = !{!60, !13, i64 16}
!60 = !{!"", !14, i64 0, !14, i64 8, !13, i64 16, !13, i64 20}
!61 = !{!60, !14, i64 8}
!62 = !{!60, !13, i64 20}
!63 = !{!60, !14, i64 0}
!64 = !{!65, !14, i64 16}
!65 = !{!"amd_signal_s", !14, i64 0, !11, i64 8, !14, i64 16, !13, i64 24, !13, i64 28, !14, i64 32, !14, i64 40, !11, i64 48, !11, i64 56}
!66 = !{!65, !13, i64 24}

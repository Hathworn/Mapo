; ModuleID = '../data/hip_kernels/11212/19/main.cu'
source_filename = "../data/hip_kernels/11212/19/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ12histo_kernelPhlPjE4temp = internal addrspace(3) global [256 x i32] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z12histo_kernelPhlPj(i8 addrspace(1)* nocapture readonly %0, i64 %1, i32 addrspace(1)* nocapture %2) local_unnamed_addr #0 {
  %4 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !4
  %5 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ12histo_kernelPhlPjE4temp, i32 0, i32 %4
...
25:                                               ; preds = %3, %25
  %26 = phi i64 [ %34, %25 ], [ %23, %3 ]
  %27 = phi i32 [ %33, %25 ], [ %16, %3 ]
  %28 = getelementptr inbounds i8, i8 addrspace(1)* %0, i64 %26
  %29 = load i8, i8 addrspace(1)* %28, align 1, !tbaa !20, !amdgpu.noclobber !10
  %30 = zext i8 %29 to i32
  %31 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ12histo_kernelPhlPjE4temp, i32 0, i32 %30
...
36:                                               ; preds = %25, %3
  ...
  %39 = load i32, i32 addrspace(3)* %5, align 4, !tbaa !5

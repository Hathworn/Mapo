; ModuleID = '../data/hip_kernels/8669/0/main.cu'
source_filename = "../data/hip_kernels/8669/0/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z10matrix_mulPiS_S_iii(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture writeonly %2, i32 %3, i32 %4, i32 %5) local_unnamed_addr #0 {
...
137:                                              ; preds = %35, %30
  %138 = phi i32 [ undef, %30 ], [ %133, %35 ]
  %139 = phi i32 [ 0, %30 ], [ %134, %35 ]
  %140 = phi i32 [ 0, %30 ], [ %133, %35 ]
...
160:                                              ; preds = %137, %142, %27
  %161 = phi i32 [ 0, %27 ], [ %138, %137 ], [ %156, %142 ]
  %162 = mul nsw i32 %23, %5

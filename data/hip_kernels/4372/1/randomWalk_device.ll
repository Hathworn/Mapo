; ModuleID = '../data/hip_kernels/4372/1/main.cu'
source_filename = "../data/hip_kernels/4372/1/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z10randomWalkPdPiiididdi(double addrspace(1)* nocapture %0, i32 addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3, double %4, i32 %5, double %6, double %7, i32 %8) local_unnamed_addr #0 {
...
20:                                               ; preds = %9
  ...
  %28 = xor i32 %27, 746559103
  %29 = lshr i64 %26, 32
  %30 = trunc i64 %29 to i32
  %31 = xor i32 %30, -1607034933
  %32 = mul i32 %28, 1228688033
  %33 = mul i32 %31, 2073658381
  %34 = mul i32 %18, %3
  %35 = sext i32 %18 to i64
  %36 = getelementptr inbounds i32, i32 addrspace(1)* %1, i64 %35
  store i32 0, i32 addrspace(1)* %36, align 4, !tbaa !7
  %37 = sext i32 %34 to i64
  %38 = getelementptr inbounds double, double addrspace(1)* %0, i64 %37
  store double 0.000000e+00, double addrspace(1)* %38, align 8, !tbaa !11
  %39 = add nsw i32 %34, %3
  %40 = icmp sgt i32 %3, 1
...
41:                                               ; preds = %20
  %42 = add nsw i32 %34, 1
  %43 = add i32 %32, 6615241
  %44 = add i32 %43, %33
  %45 = add i32 %32, 5783321
  %46 = xor i32 %33, 88675123
  %47 = add i32 %33, 521288629
  %48 = xor i32 %32, 362436069
  %49 = add i32 %32, 123456789
  %50 = sitofp i32 %2 to double
  %51 = sitofp i32 %3 to double
  %52 = fdiv contract double %50, %51
  %53 = fmul contract double %52, %4
  %54 = fcmp olt double %52, 0x1000000000000000
...
76:                                               ; preds = %41, %331
  %77 = phi double [ 0.000000e+00, %41 ], [ %317, %331 ]
  %78 = phi i32 [ %42, %41 ], [ %333, %331 ]
  %79 = phi i32 [ %34, %41 ], [ %78, %331 ]
  %80 = phi i1 [ false, %41 ], [ %332, %331 ]
  %81 = phi i32 [ %44, %41 ], [ %313, %331 ]
  %82 = phi i32 [ %45, %41 ], [ %312, %331 ]
  %83 = phi i32 [ 0, %41 ], [ %311, %331 ]
  %84 = phi i32 [ %46, %41 ], [ %310, %331 ]
  %85 = phi double [ undef, %41 ], [ %309, %331 ]
  %86 = phi i32 [ %49, %41 ], [ %308, %331 ]
  %87 = phi i32 [ %48, %41 ], [ %307, %331 ]
  %88 = phi i32 [ %47, %41 ], [ %306, %331 ]
  %89 = icmp eq i32 %83, 0
...
304:                                              ; preds = %90, %93
  ...
  %315 = fadd contract double %53, %305
  %316 = fmul contract double %75, %314
  %317 = fadd contract double %316, %315
  %318 = sext i32 %78 to i64
  %319 = getelementptr inbounds double, double addrspace(1)* %0, i64 %318
  store double %317, double addrspace(1)* %319, align 8, !tbaa !11
  %320 = fcmp contract ult double %317, %7
  %321 = select i1 %80, i1 true, i1 %320
  br i1 %321, label %324, label %322

322:                                              ; preds = %304
  %323 = sub nsw i32 %78, %34
  br label %329

324:                                              ; preds = %304
  br i1 %80, label %331, label %325

325:                                              ; preds = %324
  %326 = fcmp contract ugt double %317, %6
...
329:                                              ; preds = %327, %322
  ...
  store i32 %330, i32 addrspace(1)* %36, align 4, !tbaa !7
  br label %331

331:                                              ; preds = %329, %325, %324
  %332 = phi i1 [ true, %324 ], [ false, %325 ], [ true, %329 ]
  %333 = add nsw i32 %78, 1
  %334 = icmp slt i32 %333, %39
  br i1 %334, label %76, label %335, !llvm.loop !13

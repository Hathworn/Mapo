; ModuleID = '../data/hip_kernels/15858/1/main.cu'
source_filename = "../data/hip_kernels/15858/1/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [42 x i8] c"Hello World from block %d and thread %d!\0A\00", align 1

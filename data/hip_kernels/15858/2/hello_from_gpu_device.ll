; ModuleID = '../data/hip_kernels/15858/2/main.cu'
source_filename = "../data/hip_kernels/15858/2/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [48 x i8] c"Hello World from block-%d and thread-(%d, %d)!\0A\00", align 1
...
define protected amdgpu_kernel void @_Z14hello_from_gpuv() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([48 x i8], [48 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %9, label %13
...
454:                                              ; preds = %443, %9
  ...
  %456 = tail call i32 @llvm.amdgcn.workitem.id.y(), !range !11
  %457 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !11
  %458 = tail call i32 @llvm.amdgcn.workgroup.id.x()

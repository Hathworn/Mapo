; ModuleID = '/home/LiuS/LS-CAT-HIP/data/hip_kernels/824/33/downSanple422_gpu.cu'
source_filename = "/home/LiuS/LS-CAT-HIP/data/hip_kernels/824/33/downSanple422_gpu.cu"
...
define protected amdgpu_kernel void @_Z17downSanple422_gpuP13__hip_textureS0_PhS1_mm(%struct.__hip_texture addrspace(1)* %0, %struct.__hip_texture addrspace(1)* %1, i8 addrspace(1)* nocapture writeonly %2, i8 addrspace(1)* nocapture writeonly %3, i64 %4, i64 %5) local_unnamed_addr #0 {
...
29:                                               ; preds = %6
  ...
  %33 = select i1 %31, i8 addrspace(1)* %2, i8 addrspace(1)* %3
  ...
  %82 = fmul float %71, %81
  %83 = select i1 %60, float %82, float %79
  %84 = tail call float @llvm.amdgcn.image.sample.lz.2d.f32.f32(i32 1, float %83, float %70, <8 x i32> %65, <4 x i32> %62, i1 false, i32 0, i32 0)
  ...
  %91 = add i64 %89, %90
  %92 = lshr i64 %91, 1
  %93 = getelementptr inbounds i8, i8 addrspace(1)* %33, i64 %92
  store i8 %88, i8 addrspace(1)* %93, align 1, !tbaa !12
  br label %94

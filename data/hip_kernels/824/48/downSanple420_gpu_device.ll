; ModuleID = '/home/LiuS/LS-CAT-HIP/data/hip_kernels/824/48/downSanple420_gpu.cu'
source_filename = "/home/LiuS/LS-CAT-HIP/data/hip_kernels/824/48/downSanple420_gpu.cu"
...
define protected amdgpu_kernel void @_Z17downSanple420_gpuP13__hip_textureS0_PsS1_mm(%struct.__hip_texture addrspace(1)* %0, %struct.__hip_texture addrspace(1)* %1, i16 addrspace(1)* nocapture writeonly %2, i16 addrspace(1)* nocapture writeonly %3, i64 %4, i64 %5) local_unnamed_addr #0 {
...
30:                                               ; preds = %18
  ...
  %34 = select i1 %32, i16 addrspace(1)* %2, i16 addrspace(1)* %3
  ...
  %85 = fmul float %72, %84
  %86 = select i1 %61, float %85, float %82
  %87 = tail call float @llvm.amdgcn.image.sample.lz.2d.f32.f32(i32 1, float %86, float %71, <8 x i32> %66, <4 x i32> %63, i1 false, i32 0, i32 0)
  ...
  %95 = fmul float %67, %94
  %96 = select i1 %61, float %95, float %92
  %97 = tail call float @llvm.amdgcn.image.sample.lz.2d.f32.f32(i32 1, float %76, float %96, <8 x i32> %66, <4 x i32> %63, i1 false, i32 0, i32 0)
  %98 = bitcast float %97 to i32
  %99 = shl i32 %98, 16
  %100 = ashr exact i32 %99, 16
  %101 = tail call float @llvm.amdgcn.image.sample.lz.2d.f32.f32(i32 1, float %86, float %96, <8 x i32> %66, <4 x i32> %63, i1 false, i32 0, i32 0)
  ...
  %111 = ashr exact i32 %27, 1
  %112 = sext i32 %111 to i64
  %113 = mul i64 %112, %4
  %114 = ashr exact i32 %38, 1
  %115 = sext i32 %114 to i64
  %116 = add i64 %113, %115
  %117 = getelementptr inbounds i16, i16 addrspace(1)* %34, i64 %116
  store i16 %110, i16 addrspace(1)* %117, align 2, !tbaa !12
  br label %118

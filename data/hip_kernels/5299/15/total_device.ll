; ModuleID = '../data/hip_kernels/5299/15/main.cu'
source_filename = "../data/hip_kernels/5299/15/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ5totalPfS_iE10partialSum = internal unnamed_addr addrspace(3) global [64 x float] undef, align 16
...
13:                                               ; preds = %3, %9
  ...
  %15 = getelementptr inbounds [64 x float], [64 x float] addrspace(3)* @_ZZ5totalPfS_iE10partialSum, i32 0, i32 %4
  store float %14, float addrspace(3)* %15, align 4
  fence syncscope("workgroup") release
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %16 = add nuw nsw i32 %4, 32
  %17 = add i32 %16, %6
...
23:                                               ; preds = %13, %19
  ...
  %25 = getelementptr inbounds [64 x float], [64 x float] addrspace(3)* @_ZZ5totalPfS_iE10partialSum, i32 0, i32 %16
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %26 = icmp ult i32 %4, 32
  br i1 %26, label %27, label %32

27:                                               ; preds = %23
  %28 = getelementptr inbounds [64 x float], [64 x float] addrspace(3)* @_ZZ5totalPfS_iE10partialSum, i32 0, i32 %16
...
32:                                               ; preds = %27, %23
  ...
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %33 = icmp ult i32 %4, 16
  br i1 %33, label %34, label %40

34:                                               ; preds = %32
  %35 = add nuw nsw i32 %4, 16
  %36 = getelementptr inbounds [64 x float], [64 x float] addrspace(3)* @_ZZ5totalPfS_iE10partialSum, i32 0, i32 %35
...
42:                                               ; preds = %40
  %43 = add nuw nsw i32 %4, 8
  %44 = getelementptr inbounds [64 x float], [64 x float] addrspace(3)* @_ZZ5totalPfS_iE10partialSum, i32 0, i32 %43
...
50:                                               ; preds = %48
  %51 = add nuw nsw i32 %4, 4
  %52 = getelementptr inbounds [64 x float], [64 x float] addrspace(3)* @_ZZ5totalPfS_iE10partialSum, i32 0, i32 %51
...
58:                                               ; preds = %56
  ...
  %60 = getelementptr inbounds [64 x float], [64 x float] addrspace(3)* @_ZZ5totalPfS_iE10partialSum, i32 0, i32 %59
...
66:                                               ; preds = %64
  ...
  %68 = getelementptr inbounds [64 x float], [64 x float] addrspace(3)* @_ZZ5totalPfS_iE10partialSum, i32 0, i32 %67
...
74:                                               ; preds = %72
  %75 = load float, float addrspace(3)* getelementptr inbounds ([64 x float], [64 x float] addrspace(3)* @_ZZ5totalPfS_iE10partialSum, i32 0, i32 0), align 16, !tbaa !5

; ModuleID = '../data/hip_kernels/14345/7/main.cu'
source_filename = "../data/hip_kernels/14345/7/main.cu"
...
define protected amdgpu_kernel void @_Z14iReduceSingle2PiS_j(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
18:                                               ; preds = %18, %16
  %19 = phi i32 [ 0, %16 ], [ %69, %18 ]
  %20 = phi i32 [ 0, %16 ], [ %68, %18 ]
  %21 = phi i32 [ 0, %16 ], [ %70, %18 ]
  %22 = add nuw i32 %10, %19
...
72:                                               ; preds = %18, %13
  ...
  %74 = phi i32 [ 0, %13 ], [ %69, %18 ]
  %75 = phi i32 [ 0, %13 ], [ %68, %18 ]
  %76 = icmp eq i32 %14, 0
  br i1 %76, label %89, label %77

77:                                               ; preds = %72, %77
  %78 = phi i32 [ %86, %77 ], [ %74, %72 ]
  %79 = phi i32 [ %85, %77 ], [ %75, %72 ]
  %80 = phi i32 [ %87, %77 ], [ 0, %72 ]
  %81 = add nuw i32 %10, %78
...
98:                                               ; preds = %93
  %99 = add i32 %96, %94
  %100 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @sdata, i32 0, i32 %99
  %101 = load i32, i32 addrspace(3)* %100, align 4, !tbaa !7
  %102 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @sdata, i32 0, i32 %96
  %103 = load i32, i32 addrspace(3)* %102, align 4, !tbaa !7
  %104 = add nsw i32 %103, %101
  store i32 %104, i32 addrspace(3)* %102, align 4, !tbaa !7
  br label %105
...
109:                                              ; preds = %107
  %110 = load i32, i32 addrspace(3)* getelementptr inbounds ([0 x i32], [0 x i32] addrspace(3)* @sdata, i32 0, i32 0), align 4, !tbaa !7
  store i32 %110, i32 addrspace(1)* %1, align 4, !tbaa !7
  br label %111

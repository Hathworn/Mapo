; ModuleID = '../data/hip_kernels/14345/10/main.cu'
source_filename = "../data/hip_kernels/14345/10/main.cu"
...
define protected amdgpu_kernel void @_Z10iReduceSumPiS_j(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
102:                                              ; preds = %96
  %103 = add i32 %97, %4
  %104 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @sdata, i32 0, i32 %103
  %105 = load i32, i32 addrspace(3)* %104, align 4, !tbaa !7
  %106 = load i32, i32 addrspace(3)* %94, align 4, !tbaa !7
  %107 = add nsw i32 %106, %105
  store i32 %107, i32 addrspace(3)* %94, align 4, !tbaa !7
  br label %108

; ModuleID = '../data/hip_kernels/14345/6/main.cu'
source_filename = "../data/hip_kernels/14345/6/main.cu"
...
define protected amdgpu_kernel void @_Z13iReduceSinglePiS_i(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
99:                                               ; preds = %93
  %100 = add i32 %94, %4
  %101 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @sdata, i32 0, i32 %100
  %102 = load i32, i32 addrspace(3)* %101, align 4, !tbaa !7
  %103 = load i32, i32 addrspace(3)* %91, align 4, !tbaa !7
  %104 = add nsw i32 %103, %102
  store i32 %104, i32 addrspace(3)* %91, align 4, !tbaa !7
  br label %105

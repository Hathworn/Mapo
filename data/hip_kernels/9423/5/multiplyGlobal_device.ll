; ModuleID = '../data/hip_kernels/9423/5/main.cu'
source_filename = "../data/hip_kernels/9423/5/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z14multiplyGlobalPKjS0_Pjm(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture writeonly %2, i64 %3) local_unnamed_addr #0 {
...
29:                                               ; preds = %32
  ...
  store i32 %43, i32 addrspace(1)* %31, align 4, !tbaa !7
  br label %47

32:                                               ; preds = %27, %32
  %33 = phi i64 [ 0, %27 ], [ %45, %32 ]
  %34 = phi i32 [ 0, %27 ], [ %43, %32 ]
  %35 = add i64 %33, %28

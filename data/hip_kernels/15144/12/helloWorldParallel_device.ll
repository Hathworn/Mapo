; ModuleID = '../data/hip_kernels/15144/12/main.cu'
source_filename = "../data/hip_kernels/15144/12/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [28 x i8] c"Hello world from GPU %d/%d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z18helloWorldParallelv() local_unnamed_addr #1 {

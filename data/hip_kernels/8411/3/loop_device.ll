; ModuleID = '../data/hip_kernels/8411/3/main.cu'
source_filename = "../data/hip_kernels/8411/3/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [29 x i8] c"This is iteration number %d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z4loopv() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([29 x i8], [29 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %13, label %17
...
458:                                              ; preds = %447, %13
  ...
  %460 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !13
  %461 = tail call i32 @llvm.amdgcn.workgroup.id.x()
  %462 = zext i16 %4 to i32
  %463 = mul i32 %461, %462
  %464 = add i32 %463, %460

; ModuleID = '../data/hip_kernels/15402/0/main.cu'
source_filename = "../data/hip_kernels/15402/0/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [17 x i8] c"GPU says hello.\0A\00", align 1
...
define protected amdgpu_kernel void @_Z10cudaKernelv() local_unnamed_addr #1 {
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([17 x i8], [17 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %9, label %13
...
16:                                               ; preds = %442, %13
  %17 = phi i64 [ select (i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([17 x i8], [17 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), i64 0, i64 add (i64 ptrtoint (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([17 x i8], [17 x i8] addrspace(4)* @.str, i64 0, i64 16) to i8*) to i64), i64 add (i64 sub (i64 0, i64 ptrtoint ([17 x i8]* addrspacecast ([17 x i8] addrspace(4)* @.str to [17 x i8]*) to i64)), i64 1))), %13 ], [ %450, %442 ]
  %18 = phi i8 addrspace(4)* [ getelementptr inbounds ([17 x i8], [17 x i8] addrspace(4)* @.str, i64 0, i64 0), %13 ], [ %451, %442 ]

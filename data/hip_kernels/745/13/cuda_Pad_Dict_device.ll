; ModuleID = '../data/hip_kernels/745/13/main.cu'
source_filename = "../data/hip_kernels/745/13/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z13cuda_Pad_DictPfS_iiiii(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6) local_unnamed_addr #0 {
  ...
  %24 = add i32 %23, %17
  %25 = mul nsw i32 %4, %2
  %26 = icmp ult i32 %16, %3
  %27 = icmp ult i32 %24, %2
  %28 = select i1 %26, i1 %27, i1 false
  %29 = icmp slt i32 %24, %25
  %30 = select i1 %28, i1 %29, i1 false
  br i1 %30, label %31, label %46

31:                                               ; preds = %7, %31
  %32 = phi i32 [ %44, %31 ], [ %24, %7 ]
  %33 = phi i32 [ %43, %31 ], [ %24, %7 ]
  %34 = mul nsw i32 %33, %3
  %35 = add i32 %34, %16

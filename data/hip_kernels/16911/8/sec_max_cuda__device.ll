; ModuleID = '../data/hip_kernels/16911/8/main.cu'
source_filename = "../data/hip_kernels/16911/8/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z13sec_max_cuda_iiPfPiS_(i32 %0, i32 %1, float addrspace(1)* nocapture readonly %2, i32 addrspace(1)* nocapture readonly %3, float addrspace(1)* nocapture writeonly %4) local_unnamed_addr #0 {
...
42:                                               ; preds = %49, %36
  %43 = phi float [ 0xFFF0000000000000, %36 ], [ %58, %49 ]
...
49:                                               ; preds = %36, %49
  ...
  %51 = phi float [ %58, %49 ], [ 0xFFF0000000000000, %36 ]
  %52 = mul nsw i32 %50, %1
  ...
  %57 = fcmp contract ogt float %56, %51

; ModuleID = '../data/hip_kernels/2824/27/main.cu'
source_filename = "../data/hip_kernels/2824/27/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z5poli3Pfi(float addrspace(1)* nocapture %0, i32 %1) local_unnamed_addr #0 {
...
16:                                               ; preds = %2
  ...
  %19 = fmul contract float %14, %17
  %20 = fadd contract float %18, %19
  %21 = fmul contract float %14, %19
  %22 = fadd contract float %20, %21
  %23 = fmul contract float %14, %21
  %24 = fadd contract float %22, %23
  %25 = fmul contract float %14, %23
  %26 = fadd contract float %24, %25
  store float %26, float addrspace(1)* %13, align 4, !tbaa !7
  br label %27

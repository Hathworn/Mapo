; ModuleID = '../data/hip_kernels/2824/105/main.cu'
source_filename = "../data/hip_kernels/2824/105/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ13shared4R24opsPfS_S_iE4Smem = internal unnamed_addr addrspace(3) global [512 x float] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z13shared4R24opsPfS_S_i(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2, i32 %3) local_unnamed_addr #0 {
...
15:                                               ; preds = %4
  ...
  %19 = getelementptr inbounds [512 x float], [512 x float] addrspace(3)* @_ZZ13shared4R24opsPfS_S_iE4Smem, i32 0, i32 %12
...
21:                                               ; preds = %20
  ...
  %40 = fdiv contract float %24, 9.000000e+00
  %41 = fmul contract float %27, 1.300000e+01
  %42 = fadd contract float %40, %41
  %43 = fdiv contract float %39, %42
  %44 = fadd contract float %43, -8.000000e+00
  %45 = add nuw nsw i32 %12, 1
  %46 = and i32 %45, 511
  %47 = getelementptr inbounds [512 x float], [512 x float] addrspace(3)* @_ZZ13shared4R24opsPfS_S_iE4Smem, i32 0, i32 %46
  ...
  %52 = and i32 %51, 511
  %53 = getelementptr inbounds [512 x float], [512 x float] addrspace(3)* @_ZZ13shared4R24opsPfS_S_iE4Smem, i32 0, i32 %52
  ...
  %58 = and i32 %57, 511
  %59 = getelementptr inbounds [512 x float], [512 x float] addrspace(3)* @_ZZ13shared4R24opsPfS_S_iE4Smem, i32 0, i32 %58
  ...
  %64 = and i32 %63, 511
  %65 = getelementptr inbounds [512 x float], [512 x float] addrspace(3)* @_ZZ13shared4R24opsPfS_S_iE4Smem, i32 0, i32 %64
  %66 = load float, float addrspace(3)* %65, align 4, !tbaa !7
  %67 = fmul contract float %24, %66

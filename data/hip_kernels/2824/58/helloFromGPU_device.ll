; ModuleID = '../data/hip_kernels/2824/58/main.cu'
source_filename = "../data/hip_kernels/2824/58/main.cu"
...
3:                                                ; preds = %0
  ...
  %8 = load i64, i64 addrspace(4)* %7, align 8, !tbaa !5
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([26 x i8], [26 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %13, label %17

; ModuleID = '../data/hip_kernels/2824/4/main.cu'
source_filename = "../data/hip_kernels/2824/4/main.cu"
...
define protected amdgpu_kernel void @_Z13stencilConst1PfS_ii(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3) local_unnamed_addr #0 {

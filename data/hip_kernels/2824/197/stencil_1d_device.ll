; ModuleID = '../data/hip_kernels/2824/197/main.cu'
source_filename = "../data/hip_kernels/2824/197/main.cu"
...
@_ZZ10stencil_1dPfS_E4smem = internal unnamed_addr addrspace(3) global [38 x float] undef, align 16
...
define protected amdgpu_kernel void @_Z10stencil_1dPfS_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1) local_unnamed_addr #0 {
  ...
  %16 = getelementptr inbounds [38 x float], [38 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %12
...
18:                                               ; preds = %2
  ...
  %23 = getelementptr inbounds [38 x float], [38 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %3
  ...
  %28 = add nuw nsw i32 %3, 35
  %29 = getelementptr inbounds [38 x float], [38 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %28
...
30:                                               ; preds = %18, %2
  ...
  %32 = add nuw nsw i32 %3, 4
  %33 = getelementptr inbounds [38 x float], [38 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %32
  %34 = load float, float addrspace(3)* %33, align 4, !tbaa !7
  %35 = add nuw nsw i32 %3, 2
  %36 = getelementptr inbounds [38 x float], [38 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %35
  ...
  %42 = add nuw nsw i32 %3, 5
  %43 = getelementptr inbounds [38 x float], [38 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %42
  %44 = load float, float addrspace(3)* %43, align 4, !tbaa !7
  %45 = add nuw nsw i32 %3, 1
  %46 = getelementptr inbounds [38 x float], [38 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %45
  ...
  %52 = add nuw nsw i32 %3, 6
  %53 = getelementptr inbounds [38 x float], [38 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %52
  %54 = load float, float addrspace(3)* %53, align 4, !tbaa !7
  %55 = getelementptr inbounds [38 x float], [38 x float] addrspace(3)* @_ZZ10stencil_1dPfS_E4smem, i32 0, i32 %3
  ...
  %60 = getelementptr inbounds float, float addrspace(1)* %1, i64 %13

; ModuleID = '../data/hip_kernels/2824/20/main.cu'
source_filename = "../data/hip_kernels/2824/20/main.cu"
...
define protected amdgpu_kernel void @_Z13stencilConst2PfS_i(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {

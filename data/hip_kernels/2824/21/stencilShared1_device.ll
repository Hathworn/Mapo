; ModuleID = '../data/hip_kernels/2824/21/main.cu'
source_filename = "../data/hip_kernels/2824/21/main.cu"
...
@_ZZ14stencilShared1PfS_iE6buffer = internal unnamed_addr addrspace(3) global [1045 x float] undef, align 16
...
define protected amdgpu_kernel void @_Z14stencilShared1PfS_i(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, i32 %2) local_unnamed_addr #0 {
...
16:                                               ; preds = %3, %16
  ...
  %22 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %17
...
25:                                               ; preds = %13
  ...
  %26 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %11
  ...
  %32 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %31
  ...
  %38 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %37
  ...
  %44 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %43
  ...
  %50 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %49
  ...
  %56 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %55
  ...
  %62 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %61
  ...
  %68 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %67
  ...
  %74 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %73
  ...
  %80 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %79
  ...
  %86 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %85
  ...
  %92 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %91
  ...
  %98 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %97
  ...
  %104 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %103
  ...
  %110 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %109
  ...
  %116 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %115
  ...
  %122 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %121
  ...
  %128 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %127
  ...
  %134 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %133
  ...
  %140 = getelementptr inbounds [1045 x float], [1045 x float] addrspace(3)* @_ZZ14stencilShared1PfS_iE6buffer, i32 0, i32 %139

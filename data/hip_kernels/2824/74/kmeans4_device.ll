; ModuleID = '../data/hip_kernels/2824/74/main.cu'
source_filename = "../data/hip_kernels/2824/74/main.cu"
...
17:                                               ; preds = %5
  ...
  %113 = atomicrmw add i32 addrspace(1)* %112, i32 %63 syncscope("agent-one-as") monotonic, align 4
  %114 = add nuw nsw i32 %110, 1
  %115 = zext i32 %114 to i64
  %116 = getelementptr inbounds i32, i32 addrspace(1)* %2, i64 %115
  %117 = atomicrmw add i32 addrspace(1)* %116, i32 %65 syncscope("agent-one-as") monotonic, align 4
  %118 = add nuw nsw i32 %110, 2
  %119 = zext i32 %118 to i64
  %120 = getelementptr inbounds i32, i32 addrspace(1)* %2, i64 %119
  %121 = atomicrmw add i32 addrspace(1)* %120, i32 %67 syncscope("agent-one-as") monotonic, align 4
  %122 = add nuw nsw i32 %110, 3
  %123 = zext i32 %122 to i64
  %124 = getelementptr inbounds i32, i32 addrspace(1)* %2, i64 %123
  %125 = atomicrmw add i32 addrspace(1)* %124, i32 %69 syncscope("agent-one-as") monotonic, align 4
  %126 = zext i32 %109 to i64
  %127 = getelementptr inbounds i32, i32 addrspace(1)* %3, i64 %126
  %128 = atomicrmw add i32 addrspace(1)* %127, i32 1 syncscope("agent-one-as") monotonic, align 4
  br label %129

; ModuleID = '../data/hip_kernels/10003/4/main.cu'
source_filename = "../data/hip_kernels/10003/4/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z12weightUpdatePfS_S_(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %20 = load i32, i32 addrspace(4)* %19, align 8, !tbaa !7
  %21 = mul i32 %13, %17
  ...
  %38 = fmul contract float %37, 0x3FB99999A0000000
  ...
  store float %43, float addrspace(1)* %33, align 4, !tbaa !16
  ret void
}

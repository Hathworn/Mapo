; ModuleID = '../data/hip_kernels/10003/8/main.cu'
source_filename = "../data/hip_kernels/10003/8/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [5 x i8] c"%f \0A\00", align 1
...
define protected amdgpu_kernel void @_Z10printErrorPfS_(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1) local_unnamed_addr #1 {
...
470:                                              ; preds = %459, %25
  ...
  %472 = fsub contract float %14, %16
  %473 = fpext float %472 to double
  %474 = extractelement <2 x i64> %471, i64 0
  %475 = bitcast double %473 to i64
  %476 = and i64 %474, -227
  %477 = or i64 %476, 34
  %478 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %22, i64 noundef %477, i64 noundef %475, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  ret void
}

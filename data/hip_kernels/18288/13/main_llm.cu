...
#include "depthwise_input_backward_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
depthwise_input_backward<<<gridBlock, threadBlock>>>(B,N,M,F,C,r,K,nnIndex,nnCount,binIndex,input,filter,gradOutput,gradInput);

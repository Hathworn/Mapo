; ModuleID = '../data/hip_kernels/14075/6/main.cu'
source_filename = "../data/hip_kernels/14075/6/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z17copy_kernel_tobufPcS_iiiiiiiiiiiiiiiiii(i8 addrspace(1)* nocapture writeonly %0, i8 addrspace(1)* nocapture readonly %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 %10, i32 %11, i32 %12, i32 %13, i32 %14, i32 %15, i32 %16, i32 %17, i32 %18, i32 %19) local_unnamed_addr #0 {
...
112:                                              ; preds = %106, %112
  %113 = phi i8 addrspace(1)* [ %127, %112 ], [ %108, %106 ]
  %114 = phi i8 addrspace(1)* [ %128, %112 ], [ %111, %106 ]
...
130:                                              ; preds = %112, %106
  ...
  %132 = phi i8 addrspace(1)* [ %111, %106 ], [ %128, %112 ]
  %133 = phi i8 addrspace(1)* [ %108, %106 ], [ %127, %112 ]

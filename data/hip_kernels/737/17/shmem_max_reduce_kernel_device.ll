; ModuleID = '../data/hip_kernels/737/17/main.cu'
source_filename = "../data/hip_kernels/737/17/main.cu"
...
define protected amdgpu_kernel void @_Z23shmem_max_reduce_kernelPfPKf(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1) local_unnamed_addr #0 {

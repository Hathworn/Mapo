; ModuleID = '../data/hip_kernels/737/9/main.cu'
source_filename = "../data/hip_kernels/737/9/main.cu"
...
17:                                               ; preds = %2, %17
  ...
  store float %24, float addrspace(1)* %14, align 4, !tbaa !7
  fence syncscope("workgroup") release
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %25 = lshr i32 %18, 1
  %26 = icmp ult i32 %18, 2
  br i1 %26, label %15, label %17, !llvm.loop !11

27:                                               ; preds = %15
  %28 = load float, float addrspace(1)* %14, align 4, !tbaa !7

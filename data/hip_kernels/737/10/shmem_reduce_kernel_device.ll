; ModuleID = '../data/hip_kernels/737/10/main.cu'
source_filename = "../data/hip_kernels/737/10/main.cu"
...
define protected amdgpu_kernel void @_Z19shmem_reduce_kernelPfPKf(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %16 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @sdata, i32 0, i32 %3
...
19:                                               ; preds = %2, %19
  %20 = phi i32 [ %8, %2 ], [ %26, %19 ]
  %21 = add nuw nsw i32 %20, %3
  %22 = getelementptr inbounds [0 x float], [0 x float] addrspace(3)* @sdata, i32 0, i32 %21
  %23 = load float, float addrspace(3)* %22, align 4, !tbaa !7
  %24 = load float, float addrspace(3)* %16, align 4, !tbaa !7
  %25 = fadd contract float %23, %24
  store float %25, float addrspace(3)* %16, align 4, !tbaa !7
  fence syncscope("workgroup") release
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire
  %26 = lshr i32 %20, 1
  %27 = icmp ult i32 %20, 2
  br i1 %27, label %17, label %19, !llvm.loop !11

28:                                               ; preds = %17
  %29 = load float, float addrspace(3)* getelementptr inbounds ([0 x float], [0 x float] addrspace(3)* @sdata, i32 0, i32 0), align 4, !tbaa !7
  %30 = zext i32 %9 to i64
  %31 = getelementptr inbounds float, float addrspace(1)* %0, i64 %30
  store float %29, float addrspace(1)* %31, align 4, !tbaa !7
  br label %32

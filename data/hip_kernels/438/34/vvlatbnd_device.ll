; ModuleID = '../data/hip_kernels/438/34/main.cu'
source_filename = "../data/hip_kernels/438/34/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z8vvlatbndiiPf(i32 %0, i32 %1, float addrspace(1)* nocapture %2) local_unnamed_addr #0 {
  ...
  %21 = mul i32 %20, %0
  %22 = add i32 %21, %12
  %23 = icmp ult i32 %12, %0
  %24 = icmp ult i32 %20, %1
  %25 = select i1 %23, i1 %24, i1 false
  br i1 %25, label %26, label %52

26:                                               ; preds = %3
  %27 = tail call i32 @llvm.usub.sat.i32(i32 %20, i32 1)
  %28 = add nsw i32 %1, -1
  %29 = mul i32 %27, %0
  %30 = add i32 %29, %12
...
49:                                               ; preds = %46
  ...
  store float %33, float addrspace(1)* %51, align 4, !tbaa !7
  br label %52

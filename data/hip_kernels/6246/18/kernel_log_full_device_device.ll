; ModuleID = '../data/hip_kernels/6246/18/main.cu'
source_filename = "../data/hip_kernels/6246/18/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z22kernel_log_full_devicePiS_ji(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3) local_unnamed_addr #0 {
...
27:                                               ; preds = %24, %27
  ...
  %48 = getelementptr inbounds i32, i32 addrspace(1)* %1, i64 %29
  store i32 %47, i32 addrspace(1)* %48, align 4, !tbaa !16
  %49 = add i32 %28, %22
  %50 = icmp ult i32 %49, %2
  br i1 %50, label %27, label %26, !llvm.loop !20
}

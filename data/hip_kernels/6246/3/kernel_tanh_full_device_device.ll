; ModuleID = '../data/hip_kernels/6246/3/main.cu'
source_filename = "../data/hip_kernels/6246/3/main.cu"
...
define protected amdgpu_kernel void @_Z23kernel_tanh_full_devicejPiS_(i32 %0, i32 addrspace(1)* nocapture readnone %1, i32 addrspace(1)* nocapture writeonly %2) local_unnamed_addr #0 {
...
24:                                               ; preds = %3, %24
  %25 = phi i32 [ %28, %24 ], [ %15, %3 ]
  %26 = zext i32 %25 to i64
  %27 = getelementptr inbounds i32, i32 addrspace(1)* %2, i64 %26
  store i32 0, i32 addrspace(1)* %27, align 4, !tbaa !16
  %28 = add i32 %25, %21

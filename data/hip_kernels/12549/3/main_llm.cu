...
#include "lin2lin_resmpl_messy_gpu_kernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
lin2lin_resmpl_messy_gpu_kernel<<<gridBlock, threadBlock>>>(dev_in_img,dev_out_img,dev_C0_tmp,dev_C1_tmp,dev_C2_tmp,org_wd,org_ht,dst_wd,dst_ht,n_channels,r,hn,wn,xbd0,xbd1,ybd0,ybd1,xas_const,xbs_const,xwts_const,yas_const,ybs_const,ywts_const);

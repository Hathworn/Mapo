...
#include "int2lin_resmpl_good_gpu_kernel_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
int2lin_resmpl_good_gpu_kernel<<<gridBlock, threadBlock>>>(dev_in_img,dev_out_img,dev_C0_tmp,dev_C1_tmp,dev_C2_tmp,org_wd,org_ht,dst_wd,dst_ht,n_channels,r,yas_const,ybs_const);

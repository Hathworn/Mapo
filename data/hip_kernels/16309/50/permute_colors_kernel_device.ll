; ModuleID = '../data/hip_kernels/16309/50/main.cu'
source_filename = "../data/hip_kernels/16309/50/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z21permute_colors_kerneliPiS_(i32 %0, i32 addrspace(1)* nocapture %1, i32 addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
...
24:                                               ; preds = %17, %24
  ...
  store i32 %31, i32 addrspace(1)* %27, align 4, !tbaa !16
  %32 = add i32 %23, %25

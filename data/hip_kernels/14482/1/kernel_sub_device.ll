; ModuleID = '../data/hip_kernels/14482/1/main.cu'
source_filename = "../data/hip_kernels/14482/1/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z10kernel_subPcS_S_iiPi(i8 addrspace(1)* nocapture %0, i8 addrspace(1)* nocapture readonly %1, i8 addrspace(1)* nocapture readonly %2, i32 %3, i32 %4, i32 addrspace(1)* nocapture readnone %5) local_unnamed_addr #0 {
...
39:                                               ; preds = %30, %33
  %40 = phi i32 [ %38, %33 ], [ %31, %30 ]
  %41 = zext i32 %7 to i64
  %42 = getelementptr inbounds i8, i8 addrspace(1)* %0, i64 %41
  %43 = load i8, i8 addrspace(1)* %42, align 1, !tbaa !5
  %44 = trunc i32 %40 to i8
  %45 = add i8 %43, %44
  store i8 %45, i8 addrspace(1)* %42, align 1, !tbaa !5
  br label %46

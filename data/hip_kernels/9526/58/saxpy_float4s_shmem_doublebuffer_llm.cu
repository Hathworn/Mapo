...
__global__ void saxpy_float4s_shmem_doublebuffer(float* y, float* x, float a, clock_t* timer_vals)
{
    ...
    float* sdata_x0_0 = sdata;
    float* sdata_x1_0 = sdata_x0_0 + COMPUTE_THREADS_PER_CTA;
    float* sdata_x2_0 = sdata_x1_0 + COMPUTE_THREADS_PER_CTA;
    float* sdata_x3_0 = sdata_x2_0 + COMPUTE_THREADS_PER_CTA;
    float* sdata_y0_0 = sdata_x3_0 + COMPUTE_THREADS_PER_CTA;
    float* sdata_y1_0 = sdata_y0_0 + COMPUTE_THREADS_PER_CTA;
    float* sdata_y2_0 = sdata_y1_0 + COMPUTE_THREADS_PER_CTA;
    float* sdata_y3_0 = sdata_y2_0 + COMPUTE_THREADS_PER_CTA;
    float* sdata_x0_1 = sdata_y3_0 + COMPUTE_THREADS_PER_CTA;
    float* sdata_x1_1 = sdata_x0_1 + COMPUTE_THREADS_PER_CTA;
    float* sdata_x2_1 = sdata_x1_1 + COMPUTE_THREADS_PER_CTA;
    float* sdata_x3_1 = sdata_x2_1 + COMPUTE_THREADS_PER_CTA;
    float* sdata_y0_1 = sdata_x3_1 + COMPUTE_THREADS_PER_CTA;
    float* sdata_y1_1 = sdata_y0_1 + COMPUTE_THREADS_PER_CTA;
    float* sdata_y2_1 = sdata_y1_1 + COMPUTE_THREADS_PER_CTA;
    float* sdata_y3_1 = sdata_y2_1 + COMPUTE_THREADS_PER_CTA;
    ...
    // Final calculation for the last iteration
    result_y.x = a * sdata_x0_1[tid] + sdata_y0_1[tid];
    result_y.y = a * sdata_x1_1[tid] + sdata_y1_1[tid];
    result_y.z = a * sdata_x2_1[tid] + sdata_y2_1[tid];
    result_y.w = a * sdata_x3_1[tid] + sdata_y3_1[tid];

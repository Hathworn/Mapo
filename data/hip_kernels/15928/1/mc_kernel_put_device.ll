; ModuleID = '../data/hip_kernels/15928/1/main.cu'
source_filename = "../data/hip_kernels/15928/1/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z13mc_kernel_putPffffffffS_jj(float addrspace(1)* nocapture writeonly %0, float %1, float %2, float %3, float %4, float %5, float %6, float %7, float addrspace(1)* nocapture readonly %8, i32 %9, i32 %10) local_unnamed_addr #0 {
...
136:                                              ; preds = %120, %115
  ...
  %138 = fcmp contract olt float %137, %2
  %139 = fsub contract float %2, %137

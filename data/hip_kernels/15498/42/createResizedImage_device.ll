; ModuleID = '/home/LiuS/LS-CAT-HIP/data/hip_kernels/15498/42/createResizedImage.cu'
source_filename = "/home/LiuS/LS-CAT-HIP/data/hip_kernels/15498/42/createResizedImage.cu"
...
define protected amdgpu_kernel void @_Z18createResizedImagePhifP13__hip_texture(i8 addrspace(1)* nocapture writeonly %0, i32 %1, float %2, %struct.__hip_texture addrspace(1)* nocapture readonly %3) local_unnamed_addr #0 {
  ...
  %28 = bitcast %struct.__hip_texture addrspace(1)* %3 to i32 addrspace(1)*
  ...
  %51 = bitcast %struct.__hip_texture addrspace(1)* %3 to <8 x i32> addrspace(1)*
  ...
  %62 = fmul float %59, %61
  %63 = select i1 %48, float %62, float %25
  ...
  store i8 %66, i8 addrspace(1)* %68, align 1, !tbaa !12
  ret void
}

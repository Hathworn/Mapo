; ModuleID = '../data/hip_kernels/15498/43/main.cu'
source_filename = "../data/hip_kernels/15498/43/main.cu"
...
24:                                               ; preds = %3, %24
  %25 = phi i32 [ %29, %24 ], [ %15, %3 ]
  %26 = sext i32 %25 to i64
  %27 = getelementptr inbounds float, float addrspace(1)* %1, i64 %26
  store float 1.000000e+00, float addrspace(1)* %27, align 4, !tbaa !16
  %28 = getelementptr inbounds float, float addrspace(1)* %2, i64 %26
  store float 2.000000e+00, float addrspace(1)* %28, align 4, !tbaa !16
  %29 = add nsw i32 %25, %21
  %30 = icmp slt i32 %29, %0
  br i1 %30, label %24, label %23, !llvm.loop !20
}

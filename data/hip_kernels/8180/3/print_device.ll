; ModuleID = '../data/hip_kernels/8180/3/main.cu'
source_filename = "../data/hip_kernels/8180/3/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [23 x i8] c"index = %d value = %d\0A\00", align 1
...
define protected amdgpu_kernel void @_Z5printPii(i32 addrspace(1)* nocapture readonly %0, i32 %1) local_unnamed_addr #1 {
  %3 = icmp sgt i32 %1, 0
...
12:                                               ; preds = %4, %464
  %13 = phi i32 [ 0, %4 ], [ %475, %464 ]
  %14 = zext i32 %13 to i64
  %15 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %14
  %16 = load i32, i32 addrspace(1)* %15, align 4, !tbaa !8
  %17 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %10, i64 noundef 33, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %18 = extractelement <2 x i64> %17, i64 0
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([23 x i8], [23 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %19, label %23

19:                                               ; preds = %12
  %20 = and i64 %18, -225
  %21 = or i64 %20, 32
  %22 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %10, i64 noundef %21, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  br label %464
...
440:                                              ; preds = %400, %440
  ...
  %445 = load i8, i8 addrspace(4)* %444, align 1, !tbaa !12
...
453:                                              ; preds = %440, %402, %400
  ...
  %458 = and i64 %38, -225
  %459 = or i64 %458, %457
  %460 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %10, i64 noundef %459, i64 noundef %98, i64 noundef %158, i64 noundef %218, i64 noundef %278, i64 noundef %338, i64 noundef %398, i64 noundef %454) #10
  %461 = sub i64 %28, %36
...
464:                                              ; preds = %453, %19
  ...
  %467 = and i64 %466, -225
  %468 = or i64 %467, 32
  %469 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %10, i64 noundef %468, i64 noundef %14, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %470 = extractelement <2 x i64> %469, i64 0
  %471 = zext i32 %16 to i64
  %472 = and i64 %470, -227
  %473 = or i64 %472, 34
  %474 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* noundef %10, i64 noundef %473, i64 noundef %471, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0, i64 noundef 0) #10
  %475 = add nuw nsw i32 %13, 1
  %476 = icmp eq i32 %475, %1
  br i1 %476, label %11, label %12, !llvm.loop !15
}

; ModuleID = '../data/hip_kernels/553/10/main.cu'
source_filename = "../data/hip_kernels/553/10/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z19CalculateDiffSamplePfS_ii(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture %1, i32 %2, i32 %3) local_unnamed_addr #0 {
...
25:                                               ; preds = %4
  ...
  %32 = getelementptr inbounds float, float addrspace(1)* %0, i64 %29
  %33 = load float, float addrspace(1)* %32, align 4, !tbaa !7, !amdgpu.noclobber !5
  %34 = fsub contract float %33, %31
  ...
  %46 = getelementptr inbounds float, float addrspace(1)* %0, i64 %43
  %47 = load float, float addrspace(1)* %46, align 4, !tbaa !7, !amdgpu.noclobber !5
  %48 = fsub contract float %47, %45
  store float %48, float addrspace(1)* %46, align 4, !tbaa !7
  store float 0.000000e+00, float addrspace(1)* %30, align 4, !tbaa !7
  store float 0.000000e+00, float addrspace(1)* %37, align 4, !tbaa !7
  store float 0.000000e+00, float addrspace(1)* %44, align 4, !tbaa !7
  br label %49

; ModuleID = '../data/hip_kernels/13682/11/main.cu'
source_filename = "../data/hip_kernels/13682/11/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [19 x i8] c"[GPU] %d + %d = %d\00", align 1
...
define protected amdgpu_kernel void @_Z9addScalariiPi(i32 %0, i32 %1, i32 addrspace(1)* nocapture writeonly %2) local_unnamed_addr #1 {
  %4 = add nsw i32 %1, %0
  store i32 %4, i32 addrspace(1)* %2, align 4, !tbaa !4
  ...
  %8 = load i64, i64 addrspace(4)* %7, align 8, !tbaa !8
  ...
  br i1 icmp eq (i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([19 x i8], [19 x i8] addrspace(4)* @.str, i64 0, i64 0) to i8*), i8* null), label %13, label %17
...
76:                                               ; preds = %34, %76
  ...
  %81 = load i8, i8 addrspace(4)* %80, align 1, !tbaa !12
  ...
  br i1 %88, label %89, label %76, !llvm.loop !13
...
136:                                              ; preds = %94, %136
  ...
  %141 = load i8, i8 addrspace(4)* %140, align 1, !tbaa !12
...
196:                                              ; preds = %154, %196
  ...
  %201 = load i8, i8 addrspace(4)* %200, align 1, !tbaa !12
...
256:                                              ; preds = %214, %256
  ...
  %261 = load i8, i8 addrspace(4)* %260, align 1, !tbaa !12
...
316:                                              ; preds = %274, %316
  ...
  %321 = load i8, i8 addrspace(4)* %320, align 1, !tbaa !12
...
376:                                              ; preds = %334, %376
  ...
  %381 = load i8, i8 addrspace(4)* %380, align 1, !tbaa !12
...
434:                                              ; preds = %394, %434
  ...
  %439 = load i8, i8 addrspace(4)* %438, align 1, !tbaa !12
...
!19 = !{i64 2662}
!20 = !{!21, !16, i64 0}
!21 = !{!"", !16, i64 0, !16, i64 8, !22, i64 16, !9, i64 24, !9, i64 32, !9, i64 40}
!22 = !{!"hsa_signal_s", !9, i64 0}
!23 = !{!21, !9, i64 40}
!24 = !{!21, !16, i64 8}
!25 = !{!"exec"}
!26 = !{!27, !18, i64 16}
!27 = !{!"", !9, i64 0, !9, i64 8, !18, i64 16, !18, i64 20}
!28 = !{!27, !9, i64 8}
!29 = !{!27, !18, i64 20}
!30 = !{!27, !9, i64 0}
!31 = !{!32, !9, i64 16}
!32 = !{!"amd_signal_s", !9, i64 0, !10, i64 8, !9, i64 16, !18, i64 24, !18, i64 28, !9, i64 32, !9, i64 40, !10, i64 48, !10, i64 56}
!33 = !{!32, !18, i64 24}

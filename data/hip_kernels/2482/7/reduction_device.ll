; ModuleID = '../data/hip_kernels/2482/7/main.cu'
source_filename = "../data/hip_kernels/2482/7/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ9reductionPfiE6s_data = internal unnamed_addr addrspace(3) global [512 x float] undef, align 16
...
define protected amdgpu_kernel void @_Z9reductionPfi(float addrspace(1)* nocapture %0, i32 %1) local_unnamed_addr #0 {
  ...
  %15 = getelementptr inbounds [512 x float], [512 x float] addrspace(3)* @_ZZ9reductionPfiE6s_data, i32 0, i32 %3
...
23:                                               ; preds = %19
  ...
  %25 = getelementptr inbounds [512 x float], [512 x float] addrspace(3)* @_ZZ9reductionPfiE6s_data, i32 0, i32 %24
...
31:                                               ; preds = %17
  %32 = load float, float addrspace(3)* %15, align 4, !tbaa !7

; ModuleID = '../data/hip_kernels/11602/1/main.cu'
source_filename = "../data/hip_kernels/11602/1/main.cu"
...
define protected amdgpu_kernel void @_Z4calcPfii(float addrspace(1)* nocapture %0, i32 %1, i32 %2) local_unnamed_addr #0 {
  ...
  %37 = select i1 %36, float %35, float %25
  store float %37, float addrspace(1)* %24, align 4, !tbaa !7
  ret void
}

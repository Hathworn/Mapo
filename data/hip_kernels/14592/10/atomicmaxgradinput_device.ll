; ModuleID = '../data/hip_kernels/14592/10/main.cu'
source_filename = "../data/hip_kernels/14592/10/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: mustprogress nofree norecurse nounwind
define protected amdgpu_kernel void @_Z18atomicmaxgradinputPfS_S_S_iiiiiii(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 %10) local_unnamed_addr #0 {
  %12 = sub nsw i32 %6, %8
  %13 = sdiv i32 %12, %10
  %14 = add nsw i32 %13, 1
  %15 = sub nsw i32 %5, %7
...
56:                                               ; preds = %53, %90
  %57 = phi i32 [ %35, %53 ], [ %91, %90 ]
  br i1 %54, label %90, label %58
...
67:                                               ; preds = %58, %67
  ...
  %87 = atomicrmw fadd float addrspace(1)* %86, float %76 syncscope("agent-one-as") monotonic, align 4
  %88 = add nuw nsw i32 %68, %24
  %89 = icmp sgt i32 %88, %13
  br i1 %89, label %90, label %67, !llvm.loop !20

90:                                               ; preds = %67, %56
  %91 = add nsw i32 %57, %41
  %92 = icmp sgt i32 %91, %16
  br i1 %92, label %93, label %56, !llvm.loop !22

; ModuleID = '../data/hip_kernels/11890/16/main.cu'
source_filename = "../data/hip_kernels/11890/16/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z15lower_right_optPiS_S_iiii(i32 addrspace(1)* nocapture writeonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture readonly %2, i32 %3, i32 %4, i32 %5, i32 %6) local_unnamed_addr #0 {
...
23:                                               ; preds = %7
  ...
  %32 = add i32 %31, %29
  %33 = add i32 %32, 1
  %34 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !6
  %35 = add i32 %34, %5
  %36 = add i32 %35, %24
  %37 = add i32 %36, 1
  %38 = icmp slt i32 %33, %3
...
46:                                               ; preds = %41
  ...
  %70 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %55

; ModuleID = '../data/hip_kernels/11579/2/main.cu'
source_filename = "../data/hip_kernels/11579/2/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z8multiplyPiS_S_(i32 addrspace(1)* nocapture %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %22 = load i32, i32 addrspace(1)* %14, align 4, !tbaa !7
  %23 = add nsw i32 %22, %21
  store i32 %23, i32 addrspace(1)* %14, align 4, !tbaa !7
  %24 = add i32 %10, 1
  %25 = zext i32 %24 to i64
  %26 = getelementptr inbounds i32, i32 addrspace(1)* %1, i64 %25
  %27 = load i32, i32 addrspace(1)* %26, align 4, !tbaa !7
  %28 = add nuw nsw i32 %11, %9
  ...
  store i32 %33, i32 addrspace(1)* %14, align 4, !tbaa !7
  ret void
}

; ModuleID = '../data/hip_kernels/9444/18/main.cu'
source_filename = "../data/hip_kernels/9444/18/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z26kern_FindLeafSinkPotentialPfS_S_S_fi(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, float %4, i32 %5) local_unnamed_addr #0 {
...
44:                                               ; preds = %6
  ...
  %50 = getelementptr inbounds float, float addrspace(1)* %3, i64 %42
  %51 = load float, float addrspace(1)* %50, align 4, !tbaa !17, !amdgpu.noclobber !6
  %52 = fmul contract float %51, %4
  %53 = fadd contract float %49, %52
  %54 = getelementptr inbounds float, float addrspace(1)* %0, i64 %42

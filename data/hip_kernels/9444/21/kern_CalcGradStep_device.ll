; ModuleID = '../data/hip_kernels/9444/21/main.cu'
source_filename = "../data/hip_kernels/9444/21/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z17kern_CalcGradStepPfS_S_S_ffi(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture %2, float addrspace(1)* nocapture readonly %3, float %4, float %5, i32 %6) local_unnamed_addr #0 {
...
46:                                               ; preds = %7
  %47 = getelementptr inbounds float, float addrspace(1)* %0, i64 %43
  %48 = load float, float addrspace(1)* %47, align 4, !tbaa !17, !amdgpu.noclobber !6
  %49 = load float, float addrspace(1)* %44, align 4, !tbaa !17, !amdgpu.noclobber !6
  %50 = fadd contract float %48, %49
  %51 = getelementptr inbounds float, float addrspace(1)* %1, i64 %43
  %52 = load float, float addrspace(1)* %51, align 4, !tbaa !17, !amdgpu.noclobber !6
  %53 = fsub contract float %50, %52
  %54 = getelementptr inbounds float, float addrspace(1)* %3, i64 %43
  %55 = load float, float addrspace(1)* %54, align 4, !tbaa !17, !amdgpu.noclobber !6
  %56 = fmul contract float %55, %5
  %57 = fsub contract float %53, %56
  %58 = fmul contract float %57, %4
  store float %58, float addrspace(1)* %44, align 4, !tbaa !17
  br label %59

; ModuleID = '../data/hip_kernels/9444/35/main.cu'
source_filename = "../data/hip_kernels/9444/35/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z18kern_NormLogBufferPfS_fis(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture writeonly %1, float %2, i32 %3, i16 %4) local_unnamed_addr #0 {
...
79:                                               ; preds = %74
  ...
  %81 = fdiv contract float %77, %2
  %82 = select contract i1 %80, float %81, float 1.000000e+00
  %83 = getelementptr inbounds float, float addrspace(1)* %1, i64 %41
  store float %82, float addrspace(1)* %83, align 4, !tbaa !17
  br label %84

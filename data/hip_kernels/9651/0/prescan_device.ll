; ModuleID = '../data/hip_kernels/9651/0/main.cu'
source_filename = "../data/hip_kernels/9651/0/main.cu"
...
define protected amdgpu_kernel void @_Z7prescanPfS_i(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, i32 %2) local_unnamed_addr #0 {

; ModuleID = '../data/hip_kernels/3265/68/main.cu'
source_filename = "../data/hip_kernels/3265/68/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z11naiveKerneliPdS_(i32 %0, double addrspace(1)* nocapture readonly %1, double addrspace(1)* nocapture %2) local_unnamed_addr #0 {
...
14:                                               ; preds = %3
  ...
  %18 = load double, double addrspace(1)* %17, align 8, !tbaa !7
...
24:                                               ; preds = %45, %19
  %25 = phi double [ undef, %19 ], [ %87, %45 ]
  %26 = phi double [ %18, %19 ], [ %87, %45 ]
  %27 = phi i32 [ 0, %19 ], [ %88, %45 ]
  %28 = icmp eq i32 %20, 0
  br i1 %28, label %40, label %29

29:                                               ; preds = %24, %29
  %30 = phi double [ %36, %29 ], [ %26, %24 ]
  ...
  store double %36, double addrspace(1)* %17, align 8, !tbaa !7
...
40:                                               ; preds = %24, %29, %14
  %41 = phi double [ %18, %14 ], [ %25, %24 ], [ %36, %29 ]
  %42 = sitofp i32 %0 to double
  %43 = getelementptr inbounds double, double addrspace(1)* %2, i64 %16
  %44 = fdiv contract double %41, %42
  store double %44, double addrspace(1)* %43, align 8, !tbaa !7
  br label %91

45:                                               ; preds = %45, %22
  %46 = phi double [ %18, %22 ], [ %87, %45 ]
  ...
  store double %52, double addrspace(1)* %17, align 8, !tbaa !7
  %53 = or i32 %47, 1
  ...
  store double %72, double addrspace(1)* %17, align 8, !tbaa !7
  %73 = or i32 %47, 5

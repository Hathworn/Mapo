; ModuleID = '../data/hip_kernels/3265/3/main.cu'
source_filename = "../data/hip_kernels/3265/3/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z9simKerneliiPdS_S_PiS0_S0_S_S_S0_d(i32 %0, i32 %1, double addrspace(1)* nocapture readonly %2, double addrspace(1)* nocapture readonly %3, double addrspace(1)* nocapture readonly %4, i32 addrspace(1)* nocapture readonly %5, i32 addrspace(1)* nocapture %6, i32 addrspace(1)* nocapture %7, double addrspace(1)* nocapture %8, double addrspace(1)* nocapture writeonly %9, i32 addrspace(1)* nocapture %10, double %11) local_unnamed_addr #0 {
...
31:                                               ; preds = %23
  ...
  %33 = getelementptr inbounds double, double addrspace(1)* %9, i64 %25
  %34 = getelementptr inbounds double, double addrspace(1)* %8, i64 %25
...
36:                                               ; preds = %31, %87
  ...
  %46 = getelementptr inbounds double, double addrspace(1)* %4, i64 %42
  %47 = load double, double addrspace(1)* %46, align 8, !tbaa !11
  %48 = fadd contract double %47, %11
  %49 = fcmp contract ogt double %45, %48
  %50 = fneg contract double %47
  %51 = fsub contract double %50, %11
  %52 = fcmp contract olt double %45, %51
...
58:                                               ; preds = %55
  %59 = fadd contract double %44, %47
  %60 = fadd contract double %59, %11
  store double %60, double addrspace(1)* %33, align 8, !tbaa !11
  %61 = sub nsw i32 1, %56
  %62 = sitofp i32 %61 to double
  %63 = fmul contract double %60, %62
  %64 = load double, double addrspace(1)* %34, align 8, !tbaa !11
  %65 = fsub contract double %64, %63
  br label %78
...
70:                                               ; preds = %67
  %71 = fsub contract double %44, %47
  %72 = fsub contract double %71, %11
  store double %72, double addrspace(1)* %33, align 8, !tbaa !11
  %73 = add nuw nsw i32 %68, 1
  %74 = sitofp i32 %73 to double
  %75 = fmul contract double %72, %74
  %76 = load double, double addrspace(1)* %34, align 8, !tbaa !11
  %77 = fadd contract double %75, %76
  br label %78

78:                                               ; preds = %58, %70
  %79 = phi double [ %77, %70 ], [ %65, %58 ]
  %80 = phi i32 [ %73, %70 ], [ %61, %58 ]
  %81 = phi i32 [ -1, %70 ], [ 1, %58 ]
  store double %79, double addrspace(1)* %34, align 8, !tbaa !11

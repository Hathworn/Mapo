; ModuleID = '../data/hip_kernels/6565/18/main.cu'
source_filename = "../data/hip_kernels/6565/18/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z22calcSigmoidBackwardGPUPfS_S_S_i(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture %1, float addrspace(1)* nocapture %2, float addrspace(1)* nocapture readnone %3, i32 %4) local_unnamed_addr #0 {
...
27:                                               ; preds = %5
  ...
  %49 = select i1 %38, float 1.000000e+00, float %48
  %50 = select i1 %37, float 0.000000e+00, float %49
  %51 = fsub contract float 1.000000e+00, %50
  %52 = fmul contract float %50, %51
  %53 = fmul contract float %33, %52
  %54 = getelementptr inbounds float, float addrspace(1)* %2, i64 %28
  %55 = load float, float addrspace(1)* %54, align 4, !tbaa !16
  %56 = fadd contract float %55, %53
  store float %56, float addrspace(1)* %54, align 4, !tbaa !16
  br label %57

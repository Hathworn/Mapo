...
#include "calcConvolutionForwardPaddedInGPU_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
calcConvolutionForwardPaddedInGPU<<<gridBlock, threadBlock>>>(in,padded_in,batch_size,in_size_x,in_size_y,in_size_z,padding);

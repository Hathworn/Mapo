; ModuleID = '../data/hip_kernels/6565/6/main.cu'
source_filename = "../data/hip_kernels/6565/6/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z24calcLeakyReluBackwardGPUPfS_S_S_i(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture %1, float addrspace(1)* nocapture %2, float addrspace(1)* nocapture readonly %3, i32 %4) local_unnamed_addr #0 {
...
27:                                               ; preds = %5
  ...
  %38 = select contract i1 %36, double 1.000000e-02, double %37
  %39 = getelementptr inbounds float, float addrspace(1)* %2, i64 %28
  %40 = load float, float addrspace(1)* %39, align 4, !tbaa !16
  %41 = fpext float %40 to double
  %42 = fadd contract double %38, %41
  %43 = fptrunc double %42 to float
  store float %43, float addrspace(1)* %39, align 4, !tbaa !16
  br label %44

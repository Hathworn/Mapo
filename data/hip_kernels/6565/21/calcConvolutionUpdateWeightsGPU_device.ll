; ModuleID = '../data/hip_kernels/6565/21/main.cu'
source_filename = "../data/hip_kernels/6565/21/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z31calcConvolutionUpdateWeightsGPUPfS_iiifffi(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture %1, i32 %2, i32 %3, i32 %4, float %5, float %6, float %7, i32 %8) local_unnamed_addr #0 {
...
31:                                               ; preds = %9
  ...
  %54 = fmul contract float %53, %5
  %55 = fadd contract float %49, %54
  store float %55, float addrspace(1)* %52, align 4, !tbaa !16
  ...
  %61 = fmul contract float %60, %7
  %62 = fsub contract float %58, %61
  store float %62, float addrspace(1)* %57, align 4, !tbaa !16
  br label %63

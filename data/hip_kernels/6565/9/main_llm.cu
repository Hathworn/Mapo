...
#include "calcDenseForwardGPU_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
calcDenseForwardGPU<<<gridBlock, threadBlock>>>(in,out,weights,biases,batch_size,in_size_x,in_size_y,in_size_z,out_size_x,out_size_y,out_size_z);

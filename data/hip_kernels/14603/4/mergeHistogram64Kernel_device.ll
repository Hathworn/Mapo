; ModuleID = '../data/hip_kernels/14603/4/main.cu'
source_filename = "../data/hip_kernels/14603/4/main.cu"
...
8:                                                ; preds = %12, %3
  %9 = phi i32 [ 0, %3 ], [ %20, %12 ]
  %10 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %4
...
23:                                               ; preds = %8
  ...
  %25 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %24
...
31:                                               ; preds = %29
  ...
  %33 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %32
...
39:                                               ; preds = %37
  ...
  %41 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %40
...
47:                                               ; preds = %45
  ...
  %49 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %48
...
55:                                               ; preds = %53
  ...
  %57 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %56
...
63:                                               ; preds = %61
  ...
  %65 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %64
...
71:                                               ; preds = %69
  ...
  %73 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %72
...
79:                                               ; preds = %77
  ...
  %81 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 %80
  ...
  %85 = load i32, i32 addrspace(3)* getelementptr inbounds ([256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPjS_jE4data, i32 0, i32 0), align 16, !tbaa !5

; ModuleID = '../data/hip_kernels/14603/8/main.cu'
source_filename = "../data/hip_kernels/14603/8/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ22mergeHistogram64KernelPfS_jE4data = internal unnamed_addr addrspace(3) global [256 x i32] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z22mergeHistogram64KernelPfS_j(float addrspace(1)* nocapture writeonly %0, float addrspace(1)* nocapture readonly %1, i32 %2) local_unnamed_addr #0 {
...
8:                                                ; preds = %12, %3
  %9 = phi i32 [ 0, %3 ], [ %22, %12 ]
  %10 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPfS_jE4data, i32 0, i32 %4
...
25:                                               ; preds = %8
  ...
  %27 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPfS_jE4data, i32 0, i32 %26
...
33:                                               ; preds = %31
  ...
  %35 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPfS_jE4data, i32 0, i32 %34
...
41:                                               ; preds = %39
  ...
  %43 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPfS_jE4data, i32 0, i32 %42
...
49:                                               ; preds = %47
  ...
  %51 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPfS_jE4data, i32 0, i32 %50
...
57:                                               ; preds = %55
  ...
  %59 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPfS_jE4data, i32 0, i32 %58
...
65:                                               ; preds = %63
  ...
  %67 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPfS_jE4data, i32 0, i32 %66
...
73:                                               ; preds = %71
  ...
  %75 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPfS_jE4data, i32 0, i32 %74
...
81:                                               ; preds = %79
  ...
  %83 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPfS_jE4data, i32 0, i32 %82
  ...
  %87 = load i32, i32 addrspace(3)* getelementptr inbounds ([256 x i32], [256 x i32] addrspace(3)* @_ZZ22mergeHistogram64KernelPfS_jE4data, i32 0, i32 0), align 16, !tbaa !5

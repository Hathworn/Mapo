; ModuleID = '../data/hip_kernels/17041/25/main.cu'
source_filename = "../data/hip_kernels/17041/25/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z24find_all_sums_hub_kernelPiiPfS_S_S0_S0_(i32 addrspace(1)* nocapture readonly %0, i32 %1, float addrspace(1)* nocapture readonly %2, i32 addrspace(1)* nocapture readonly %3, i32 addrspace(1)* nocapture readonly %4, float addrspace(1)* nocapture writeonly %5, float addrspace(1)* nocapture writeonly %6) local_unnamed_addr #0 {
...
29:                                               ; preds = %32, %18
  %30 = phi float [ 0.000000e+00, %18 ], [ %41, %32 ]
  %31 = getelementptr inbounds float, float addrspace(1)* %6, i64 %22
  store float %30, float addrspace(1)* %31, align 4, !tbaa !11
  br label %45

32:                                               ; preds = %18, %32
  %33 = phi i32 [ %43, %32 ], [ %26, %18 ]
  %34 = phi float [ %41, %32 ], [ 0.000000e+00, %18 ]
  ...
  %42 = getelementptr inbounds float, float addrspace(1)* %5, i64 %35
  store float %41, float addrspace(1)* %42, align 4, !tbaa !11
  %43 = add nsw i32 %33, 1

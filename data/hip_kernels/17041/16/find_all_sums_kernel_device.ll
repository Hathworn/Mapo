; ModuleID = '../data/hip_kernels/17041/16/main.cu'
source_filename = "../data/hip_kernels/17041/16/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z20find_all_sums_kernelPbPdPiS1_S0_S0_ii(i8 addrspace(1)* nocapture readonly %0, double addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture readonly %2, i32 addrspace(1)* nocapture readonly %3, double addrspace(1)* nocapture writeonly %4, double addrspace(1)* nocapture writeonly %5, i32 %6, i32 %7) local_unnamed_addr #0 {
...
46:                                               ; preds = %49, %36
  %47 = phi double [ 0.000000e+00, %36 ], [ %58, %49 ]
  %48 = getelementptr inbounds double, double addrspace(1)* %5, i64 %32
  store double %47, double addrspace(1)* %48, align 8, !tbaa !14
  br label %62

49:                                               ; preds = %36, %49
  %50 = phi i32 [ %60, %49 ], [ %42, %36 ]
  %51 = phi double [ %58, %49 ], [ 0.000000e+00, %36 ]
  ...
  %57 = load double, double addrspace(1)* %56, align 8, !tbaa !14
  %58 = fadd contract double %51, %57
  %59 = getelementptr inbounds double, double addrspace(1)* %4, i64 %52
  store double %58, double addrspace(1)* %59, align 8, !tbaa !14
  %60 = add nsw i32 %50, 1

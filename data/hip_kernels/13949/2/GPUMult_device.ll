; ModuleID = '../data/hip_kernels/13949/2/main.cu'
source_filename = "../data/hip_kernels/13949/2/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z7GPUMultPiS_S_i(i32 addrspace(1)* nocapture readonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture writeonly %2, i32 %3) local_unnamed_addr #0 {
...
17:                                               ; preds = %45, %10
  %18 = phi i32 [ undef, %10 ], [ %143, %45 ]
  %19 = phi i32 [ 0, %10 ], [ %144, %45 ]
  %20 = phi i32 [ 0, %10 ], [ %143, %45 ]
  %21 = icmp eq i32 %13, 0
  br i1 %21, label %40, label %22

22:                                               ; preds = %17, %22
  %23 = phi i32 [ %37, %22 ], [ %19, %17 ]
  %24 = phi i32 [ %36, %22 ], [ %20, %17 ]
...
40:                                               ; preds = %22, %17
  %41 = phi i32 [ %18, %17 ], [ %36, %22 ]
  %42 = add nsw i32 %11, %5
  %43 = sext i32 %42 to i64
  %44 = getelementptr inbounds i32, i32 addrspace(1)* %2, i64 %43
  store i32 %41, i32 addrspace(1)* %44, align 4, !tbaa !5
  br label %147

45:                                               ; preds = %45, %15
  %46 = phi i32 [ 0, %15 ], [ %144, %45 ]
  %47 = phi i32 [ 0, %15 ], [ %143, %45 ]
  ...
  %136 = load i32, i32 addrspace(1)* %135, align 4, !tbaa !5, !amdgpu.noclobber !9
  %137 = mul nsw i32 %132, %3
  %138 = add nsw i32 %137, %5
  %139 = sext i32 %138 to i64
  %140 = getelementptr inbounds i32, i32 addrspace(1)* %1, i64 %139
  %141 = load i32, i32 addrspace(1)* %140, align 4, !tbaa !5, !amdgpu.noclobber !9

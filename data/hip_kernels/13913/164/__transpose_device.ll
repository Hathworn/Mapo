; ModuleID = '../data/hip_kernels/13913/164/main.cu'
source_filename = "../data/hip_kernels/13913/164/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ11__transposePfiS_iiiE4tile = internal unnamed_addr addrspace(3) global [32 x [33 x float]] undef, align 16

; Function Attrs: convergent mustprogress norecurse nounwind
define protected amdgpu_kernel void @_Z11__transposePfiS_iii(float addrspace(1)* nocapture readonly %0, i32 %1, float addrspace(1)* nocapture writeonly %2, i32 %3, i32 %4, i32 %5) local_unnamed_addr #0 {
...
61:                                               ; preds = %56, %61
  ...
  %69 = getelementptr inbounds [32 x [33 x float]], [32 x [33 x float]] addrspace(3)* @_ZZ11__transposePfiS_iiiE4tile, i32 0, i32 %41, i32 %68
  store float %67, float addrspace(3)* %69, align 4, !tbaa !18
  %70 = add i32 %62, %27
...
78:                                               ; preds = %73, %78
  ...
  %81 = getelementptr inbounds [32 x [33 x float]], [32 x [33 x float]] addrspace(3)* @_ZZ11__transposePfiS_iiiE4tile, i32 0, i32 %80, i32 %41
  %82 = load float, float addrspace(3)* %81, align 4, !tbaa !18
  %83 = mul nsw i32 %79, %3
  %84 = add i32 %83, %50
  %85 = zext i32 %84 to i64
  %86 = getelementptr inbounds float, float addrspace(1)* %2, i64 %85
  store float %82, float addrspace(1)* %86, align 4, !tbaa !18
  %87 = add i32 %79, %27

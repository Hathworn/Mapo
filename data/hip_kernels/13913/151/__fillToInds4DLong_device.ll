; ModuleID = '../data/hip_kernels/13913/151/main.cu'
source_filename = "../data/hip_kernels/13913/151/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z18__fillToInds4DLongxPxiiiPiiS0_iS0_iS0_i(i64 %0, i64 addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3, i32 %4, i32 addrspace(1)* readonly %5, i32 %6, i32 addrspace(1)* readonly %7, i32 %8, i32 addrspace(1)* readonly %9, i32 %10, i32 addrspace(1)* readonly %11, i32 %12) local_unnamed_addr #0 {
...
103:                                              ; preds = %99, %97
  ...
  %112 = getelementptr inbounds i64, i64 addrspace(1)* %1, i64 %111
  store i64 %0, i64 addrspace(1)* %112, align 8, !tbaa !21

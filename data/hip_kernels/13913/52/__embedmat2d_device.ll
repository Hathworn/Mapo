; ModuleID = '../data/hip_kernels/13913/52/main.cu'
source_filename = "../data/hip_kernels/13913/52/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z12__embedmat2dPdPxiii(double addrspace(1)* nocapture readonly %0, i64 addrspace(1)* nocapture writeonly %1, i32 %2, i32 %3, i32 %4) local_unnamed_addr #0 {
...
45:                                               ; preds = %28, %45
  %46 = phi i32 [ %25, %28 ], [ %66, %45 ]
  %47 = sext i32 %46 to i64
  %48 = getelementptr inbounds double, double addrspace(1)* %0, i64 %47
  %49 = bitcast double addrspace(1)* %48 to i64 addrspace(1)*
  %50 = load i64, i64 addrspace(1)* %49, align 8, !tbaa !17, !amdgpu.noclobber !6
  %51 = and i64 %50, 2147483648
  %52 = icmp eq i64 %51, 0
  %53 = and i64 %50, 2147483647
  %54 = sub nsw i64 0, %53
  %55 = select i1 %52, i64 %50, i64 %54
  %56 = sdiv i32 %46, %2
  %57 = add nsw i32 %56, 1
  %58 = sub i32 %3, %56
  ...
  %65 = getelementptr inbounds i64, i64 addrspace(1)* %1, i64 %47
  store i64 %64, i64 addrspace(1)* %65, align 8, !tbaa !21
  %66 = add i32 %43, %46
  %67 = icmp slt i32 %66, %26
  br i1 %67, label %45, label %44, !llvm.loop !23
}

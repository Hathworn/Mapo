; ModuleID = '../data/hip_kernels/13913/21/main.cu'
source_filename = "../data/hip_kernels/13913/21/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

@_ZZ13__radixcountsPfiiPjE2ic = internal addrspace(3) global [256 x i32] undef, align 16
...
define protected amdgpu_kernel void @_Z13__radixcountsPfiiPj(float addrspace(1)* nocapture readonly %0, i32 %1, i32 %2, i32 addrspace(1)* nocapture writeonly %3) local_unnamed_addr #1 {
...
33:                                               ; preds = %4
  ...
  %35 = add i32 %34, %6
  %36 = shl i32 %35, 8
  %37 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ13__radixcountsPfiiPjE2ic, i32 0, i32 %31
  %38 = bitcast float addrspace(5)* %5 to i8 addrspace(5)*
...
56:                                               ; preds = %41, %56
  ...
  call void @llvm.lifetime.start.p5i8(i64 4, i8 addrspace(5)* %38) #6
  %58 = sext i32 %57 to i64
  %59 = getelementptr inbounds float, float addrspace(1)* %0, i64 %58
  %60 = load float, float addrspace(1)* %59, align 4, !tbaa !22
  store float %60, float addrspace(5)* %5, align 4, !tbaa !22
  %61 = load i8, i8 addrspace(5)* %39, align 1, !tbaa !24
  %62 = zext i8 %61 to i32
  %63 = getelementptr inbounds [256 x i32], [256 x i32] addrspace(3)* @_ZZ13__radixcountsPfiiPjE2ic, i32 0, i32 %62
  %64 = tail call i32 @llvm.amdgcn.atomic.inc.i32.p3i32(i32 addrspace(3)* %63, i32 2147418112, i32 2, i32 4, i1 false)
  call void @llvm.lifetime.end.p5i8(i64 4, i8 addrspace(5)* %38) #6

; ModuleID = '../data/hip_kernels/13913/140/main.cu'
source_filename = "../data/hip_kernels/13913/140/main.cu"
...
define protected amdgpu_kernel void @_Z17__fillToIndsLongXxPxx(i64 %0, i64 addrspace(1)* nocapture writeonly %1, i64 %2) local_unnamed_addr #0 {
  ...
  %22 = mul i32 %21, %9
  %23 = add i32 %22, %4
  %24 = getelementptr inbounds i8, i8 addrspace(4)* %5, i64 16
...
42:                                               ; preds = %34, %42
  %43 = phi i64 [ %32, %34 ], [ %45, %42 ]
  %44 = getelementptr inbounds i64, i64 addrspace(1)* %1, i64 %43
  store i64 %0, i64 addrspace(1)* %44, align 8, !tbaa !17
  %45 = add nsw i64 %43, %41
  %46 = icmp slt i64 %45, %2
  br i1 %46, label %42, label %47, !llvm.loop !21

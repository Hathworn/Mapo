; ModuleID = '../data/hip_kernels/13913/61/main.cu'
source_filename = "../data/hip_kernels/13913/61/main.cu"
...
@.str = private unnamed_addr addrspace(4) constant [46 x i8] c"Warning, L2dist not supported on arch <= 200\0A\00", align 1
...
define protected amdgpu_kernel void @_Z8__l2distPdiS_iS_iiiid(double addrspace(1)* nocapture readnone %0, i32 %1, double addrspace(1)* nocapture readnone %2, i32 %3, double addrspace(1)* nocapture readnone %4, i32 %5, i32 %6, i32 %7, i32 %8, double %9) local_unnamed_addr #1 {

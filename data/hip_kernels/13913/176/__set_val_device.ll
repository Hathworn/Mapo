; ModuleID = '../data/hip_kernels/13913/176/main.cu'
source_filename = "../data/hip_kernels/13913/176/main.cu"
...
define protected amdgpu_kernel void @_Z9__set_valPffi(float addrspace(1)* nocapture writeonly %0, float %1, i32 %2) local_unnamed_addr #0 {
...
41:                                               ; preds = %25, %41
  ...
  store float %1, float addrspace(1)* %44, align 4, !tbaa !17
  %45 = add i32 %39, %42

...
hipFree(0);
wlcss_cuda_kernel<<<gridBlock, threadBlock>>>(d_mss,d_mss_offsets,d_ts,d_ss,d_tlen,d_toffsets,d_slen,d_soffsets,d_params,d_tmp_windows,d_tmp_windows_offsets);

; ModuleID = '../data/hip_kernels/1769/1/main.cu'
source_filename = "../data/hip_kernels/1769/1/main.cu"
...
define protected amdgpu_kernel void @_Z17wlcss_cuda_kernelPiS_S_S_S_S_S_S_S_(i32 addrspace(1)* nocapture writeonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture readonly %2, i32 addrspace(1)* nocapture readonly %3, i32 addrspace(1)* nocapture readonly %4, i32 addrspace(1)* nocapture readonly %5, i32 addrspace(1)* nocapture readonly %6, i32 addrspace(1)* nocapture readonly %7, i32 addrspace(1)* nocapture readonly %8) local_unnamed_addr #1 {
  ...
  %62 = tail call fastcc i8 addrspace(1)* @__ockl_dm_alloc(i64 %61) #14
  %63 = ptrtoint i8 addrspace(1)* %62 to i64
  %64 = bitcast i8 addrspace(1)* %62 to i32 addrspace(1)*
  tail call void @llvm.memset.p1i8.i64(i8 addrspace(1)* align 4 %62, i8 0, i64 %60, i1 false)
...
84:                                               ; preds = %9
  ...
  %88 = getelementptr inbounds i32, i32 addrspace(1)* %64, i64 %87
  %89 = sext i32 %15 to i64
  %90 = getelementptr inbounds i32, i32 addrspace(1)* %64, i64 %89
  %91 = and i32 %15, 1
  %92 = icmp eq i32 %15, 1
  %93 = and i32 %15, -2
  %94 = icmp eq i32 %91, 0
...
100:                                              ; preds = %95
  ...
  %102 = getelementptr inbounds i32, i32 addrspace(1)* %68, i64 %101
...
119:                                              ; preds = %106
  ...
  %124 = getelementptr inbounds i32, i32 addrspace(1)* %64, i64 %123
...
131:                                              ; preds = %119, %116
  ...
  %134 = getelementptr inbounds i32, i32 addrspace(1)* %64, i64 %108
...
135:                                              ; preds = %131, %103, %97
  ...
  %138 = getelementptr inbounds i32, i32 addrspace(1)* %70, i64 %136
...
141:                                              ; preds = %100, %196
  ...
  %146 = getelementptr inbounds i32, i32 addrspace(1)* %66, i64 %145
  ...
  %151 = getelementptr inbounds i32, i32 addrspace(1)* %64, i64 %145
...
157:                                              ; preds = %141
  ...
  %161 = getelementptr inbounds i32, i32 addrspace(1)* %64, i64 %160
...
168:                                              ; preds = %157, %154
  ...
  %171 = getelementptr inbounds i32, i32 addrspace(1)* %64, i64 %145
  ...
  %174 = getelementptr inbounds i32, i32 addrspace(1)* %66, i64 %173
  ...
  %179 = getelementptr inbounds i32, i32 addrspace(1)* %64, i64 %173
...
185:                                              ; preds = %168
  ...
  %189 = getelementptr inbounds i32, i32 addrspace(1)* %64, i64 %188
...
196:                                              ; preds = %185, %182
  ...
  %199 = getelementptr inbounds i32, i32 addrspace(1)* %64, i64 %173
...
202:                                              ; preds = %135, %9
  %203 = icmp eq i8 addrspace(1)* %62, addrspacecast (i8* null to i8 addrspace(1)*)
  br i1 %203, label %205, label %204

204:                                              ; preds = %202
  tail call fastcc void @__ockl_dm_dealloc(i64 %63) #14
  br label %205

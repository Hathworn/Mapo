; ModuleID = '../data/hip_kernels/1769/8/main.cu'
source_filename = "../data/hip_kernels/1769/8/main.cu"
...
define protected amdgpu_kernel void @_Z17wlcss_cuda_kernelPiS_S_S_S_S_S_S_S_S_(i32 addrspace(1)* nocapture writeonly %0, i32 addrspace(1)* nocapture readonly %1, i32 addrspace(1)* nocapture readonly %2, i32 addrspace(1)* nocapture readonly %3, i32 addrspace(1)* nocapture readonly %4, i32 addrspace(1)* nocapture readonly %5, i32 addrspace(1)* nocapture readonly %6, i32 addrspace(1)* nocapture readonly %7, i32 addrspace(1)* nocapture readonly %8, i32 addrspace(1)* nocapture readonly %9) local_unnamed_addr #1 {
  ...
  %27 = load i32, i32 addrspace(4)* %26, align 4, !tbaa !10
  %28 = getelementptr i8, i8 addrspace(4)* %24, i64 4
  %29 = bitcast i8 addrspace(4)* %28 to i16 addrspace(4)*
  %30 = load i16, i16 addrspace(4)* %29, align 4, !range !19, !invariant.load !9
  ...
  %36 = add i32 %32, %35
  %37 = mul i32 %36, %11
  %38 = getelementptr inbounds i8, i8 addrspace(4)* %24, i64 16
  %39 = bitcast i8 addrspace(4)* %38 to i32 addrspace(4)*
  %40 = load i32, i32 addrspace(4)* %39, align 8, !tbaa !20
  %41 = getelementptr i8, i8 addrspace(4)* %24, i64 6
  %42 = bitcast i8 addrspace(4)* %41 to i16 addrspace(4)*
  %43 = load i16, i16 addrspace(4)* %42, align 2, !range !19, !invariant.load !9
  ...
  %60 = tail call { i64, i1 } @llvm.umul.with.overflow.i64(i64 %59, i64 4)
  %61 = extractvalue { i64, i1 } %60, 1
  %62 = extractvalue { i64, i1 } %60, 0
  %63 = select i1 %61, i64 -1, i64 %62
  %64 = tail call i64 @llvm.umax.i64(i64 %63, i64 1)
  %65 = tail call fastcc i8 addrspace(1)* @__ockl_dm_alloc(i64 %64) #14
  %66 = ptrtoint i8 addrspace(1)* %65 to i64
  %67 = bitcast i8 addrspace(1)* %65 to i32 addrspace(1)*
  tail call void @llvm.memset.p1i8.i64(i8 addrspace(1)* align 4 %65, i8 0, i64 %63, i1 false)
...
85:                                               ; preds = %10
  ...
  %89 = getelementptr inbounds i32, i32 addrspace(1)* %67, i64 %88
  %90 = sext i32 %16 to i64
  %91 = getelementptr inbounds i32, i32 addrspace(1)* %67, i64 %90
  %92 = and i32 %16, 1
  %93 = icmp eq i32 %16, 1
  %94 = and i32 %16, -2
  %95 = icmp eq i32 %92, 0
...
96:                                               ; preds = %85, %139
  %97 = phi i32 [ 0, %85 ], [ %143, %139 ]
  br i1 %86, label %101, label %98

98:                                               ; preds = %96
  %99 = load i32, i32 addrspace(1)* %89, align 4, !tbaa !5
  %100 = zext i32 %97 to i64
  br label %139

101:                                              ; preds = %96
  %102 = zext i32 %97 to i64
  %103 = getelementptr inbounds i32, i32 addrspace(1)* %71, i64 %102
  br i1 %93, label %104, label %145

104:                                              ; preds = %206, %101
  %105 = phi i32 [ undef, %101 ], [ %208, %206 ]
  %106 = phi i32 [ 0, %101 ], [ %191, %206 ]
  br i1 %95, label %139, label %107

107:                                              ; preds = %104
  %108 = load i32, i32 addrspace(1)* %103, align 4, !tbaa !5
  %109 = mul nsw i32 %108, 26
  %110 = zext i32 %106 to i64
  %111 = getelementptr inbounds i32, i32 addrspace(1)* %69, i64 %110
  %112 = load i32, i32 addrspace(1)* %111, align 4, !tbaa !5
  %113 = add nsw i32 %109, %112
  %114 = sext i32 %113 to i64
  %115 = getelementptr inbounds i32, i32 addrspace(1)* %9, i64 %114
  %116 = load i32, i32 addrspace(1)* %115, align 4, !tbaa !5
  %117 = icmp sgt i32 %116, %83
  %118 = getelementptr inbounds i32, i32 addrspace(1)* %67, i64 %110
  %119 = load i32, i32 addrspace(1)* %118, align 4, !tbaa !5
  br i1 %117, label %123, label %120

120:                                              ; preds = %107
  %121 = add nsw i32 %119, %75
  %122 = load i32, i32 addrspace(1)* %89, align 4, !tbaa !5
  br label %135

123:                                              ; preds = %107
  %124 = add nuw nsw i32 %106, 1
  %125 = mul nsw i32 %116, %79
  %126 = sub nsw i32 %119, %125
  %127 = zext i32 %124 to i64
  %128 = getelementptr inbounds i32, i32 addrspace(1)* %67, i64 %127
  %129 = load i32, i32 addrspace(1)* %128, align 4, !tbaa !5
  %130 = sub nsw i32 %129, %125
  %131 = load i32, i32 addrspace(1)* %89, align 4, !tbaa !5
  %132 = sub nsw i32 %131, %125
  %133 = tail call i32 @llvm.smax.i32(i32 %130, i32 %132)
  %134 = tail call i32 @llvm.smax.i32(i32 %126, i32 %133)
  br label %135

135:                                              ; preds = %123, %120
  %136 = phi i32 [ %131, %123 ], [ %122, %120 ]
  %137 = phi i32 [ %134, %123 ], [ %121, %120 ]
  %138 = getelementptr inbounds i32, i32 addrspace(1)* %67, i64 %110
  store i32 %136, i32 addrspace(1)* %138, align 4, !tbaa !5
  store i32 %137, i32 addrspace(1)* %89, align 4, !tbaa !5
  br label %139

139:                                              ; preds = %135, %104, %98
  %140 = phi i64 [ %100, %98 ], [ %102, %104 ], [ %102, %135 ]
  %141 = phi i32 [ %99, %98 ], [ %105, %104 ], [ %137, %135 ]
  store i32 %141, i32 addrspace(1)* %91, align 4, !tbaa !5
  %142 = getelementptr inbounds i32, i32 addrspace(1)* %57, i64 %140
  store i32 %141, i32 addrspace(1)* %142, align 4, !tbaa !5
  store i32 0, i32 addrspace(1)* %89, align 4, !tbaa !5
  %143 = add nuw nsw i32 %97, 1
  %144 = icmp eq i32 %143, %19
  br i1 %144, label %212, label %96, !llvm.loop !21

145:                                              ; preds = %101, %206
  %146 = phi i32 [ %191, %206 ], [ 0, %101 ]
  %147 = phi i32 [ %210, %206 ], [ 0, %101 ]
  %148 = load i32, i32 addrspace(1)* %103, align 4, !tbaa !5
  %149 = mul nsw i32 %148, 26
  %150 = zext i32 %146 to i64
  %151 = getelementptr inbounds i32, i32 addrspace(1)* %69, i64 %150
  %152 = load i32, i32 addrspace(1)* %151, align 4, !tbaa !5
  %153 = add nsw i32 %149, %152
  %154 = sext i32 %153 to i64
  %155 = getelementptr inbounds i32, i32 addrspace(1)* %9, i64 %154
  %156 = load i32, i32 addrspace(1)* %155, align 4, !tbaa !5
  %157 = icmp sgt i32 %156, %83
  %158 = getelementptr inbounds i32, i32 addrspace(1)* %67, i64 %150
  %159 = load i32, i32 addrspace(1)* %158, align 4, !tbaa !5
  %160 = or i32 %146, 1
  br i1 %157, label %164, label %161

161:                                              ; preds = %145
  %162 = add nsw i32 %159, %75
  %163 = load i32, i32 addrspace(1)* %89, align 4, !tbaa !5
  br label %175

164:                                              ; preds = %145
  %165 = mul nsw i32 %156, %79
  %166 = sub nsw i32 %159, %165
  %167 = zext i32 %160 to i64
  %168 = getelementptr inbounds i32, i32 addrspace(1)* %67, i64 %167
  %169 = load i32, i32 addrspace(1)* %168, align 4, !tbaa !5
  %170 = sub nsw i32 %169, %165
  %171 = load i32, i32 addrspace(1)* %89, align 4, !tbaa !5
...
175:                                              ; preds = %164, %161
  %176 = phi i32 [ %171, %164 ], [ %163, %161 ]
  %177 = phi i32 [ %174, %164 ], [ %162, %161 ]
  %178 = getelementptr inbounds i32, i32 addrspace(1)* %67, i64 %150
  store i32 %176, i32 addrspace(1)* %178, align 4, !tbaa !5
  store i32 %177, i32 addrspace(1)* %89, align 4, !tbaa !5
  %179 = load i32, i32 addrspace(1)* %103, align 4, !tbaa !5
  %180 = mul nsw i32 %179, 26
  %181 = zext i32 %160 to i64
  %182 = getelementptr inbounds i32, i32 addrspace(1)* %69, i64 %181
  %183 = load i32, i32 addrspace(1)* %182, align 4, !tbaa !5
  %184 = add nsw i32 %180, %183
  %185 = sext i32 %184 to i64
  %186 = getelementptr inbounds i32, i32 addrspace(1)* %9, i64 %185
  %187 = load i32, i32 addrspace(1)* %186, align 4, !tbaa !5
  %188 = icmp sgt i32 %187, %83
  %189 = getelementptr inbounds i32, i32 addrspace(1)* %67, i64 %181
  %190 = load i32, i32 addrspace(1)* %189, align 4, !tbaa !5
  %191 = add nuw nsw i32 %146, 2
  br i1 %188, label %195, label %192

192:                                              ; preds = %175
  %193 = add nsw i32 %190, %75
  %194 = load i32, i32 addrspace(1)* %89, align 4, !tbaa !5
  br label %206

195:                                              ; preds = %175
  %196 = mul nsw i32 %187, %79
  %197 = sub nsw i32 %190, %196
  %198 = zext i32 %191 to i64
  %199 = getelementptr inbounds i32, i32 addrspace(1)* %67, i64 %198
  %200 = load i32, i32 addrspace(1)* %199, align 4, !tbaa !5
  %201 = sub nsw i32 %200, %196
  %202 = load i32, i32 addrspace(1)* %89, align 4, !tbaa !5
  %203 = sub nsw i32 %202, %196
  %204 = tail call i32 @llvm.smax.i32(i32 %201, i32 %203)
  %205 = tail call i32 @llvm.smax.i32(i32 %197, i32 %204)
  br label %206

206:                                              ; preds = %195, %192
  %207 = phi i32 [ %202, %195 ], [ %194, %192 ]
  %208 = phi i32 [ %205, %195 ], [ %193, %192 ]
  %209 = getelementptr inbounds i32, i32 addrspace(1)* %67, i64 %181
  store i32 %207, i32 addrspace(1)* %209, align 4, !tbaa !5
  store i32 %208, i32 addrspace(1)* %89, align 4, !tbaa !5
  %210 = add i32 %147, 2
  %211 = icmp eq i32 %210, %94
  br i1 %211, label %104, label %145, !llvm.loop !23

212:                                              ; preds = %139, %10
  %213 = icmp eq i8 addrspace(1)* %65, addrspacecast (i8* null to i8 addrspace(1)*)
  br i1 %213, label %215, label %214

214:                                              ; preds = %212
  tail call fastcc void @__ockl_dm_dealloc(i64 %66) #14
  br label %215

...
#include "CorrelateDataBackward1Subtract_1d_llm.cu"
#include <chrono>
#include <iostream>
using namespace std;
...
hipFree(0);
CorrelateDataBackward1Subtract_1d<<<gridBlock, threadBlock>>>(nthreads,num,item,topwidth,topheight,topchannels,max_displacement,x_shift,neighborhood_grid_width,kernel_radius,stride1,stride2,bottomwidth,bottomheight,pbottomwidth,pbottomheight,bottomchannels,bottomcount,pad_size,bottom0,bottom1,bottom1diff,topdiff);

; ModuleID = '/home/LiuS/LS-CAT-HIP/data/hip_kernels/6426/53/unpackSourceKernelRGBA.cu'
source_filename = "/home/LiuS/LS-CAT-HIP/data/hip_kernels/6426/53/unpackSourceKernelRGBA.cu"
...
define protected amdgpu_kernel void @_Z22unpackSourceKernelRGBAPjjP13__hip_surfacejj(i32 addrspace(1)* nocapture writeonly %0, i32 %1, %struct.__hip_surface addrspace(1)* nocapture readonly %2, i32 %3, i32 %4) local_unnamed_addr #0 {
...
54:                                               ; preds = %48, %50
  ...
  %64 = bitcast i32 addrspace(1)* %63 to float addrspace(1)*
  store float %59, float addrspace(1)* %64, align 4, !tbaa !11
  br label %65
...
declare float @llvm.amdgcn.image.load.2d.f32.i32(i32 immarg, i32, i32, <8 x i32>, i32 immarg, i32 immarg) #2

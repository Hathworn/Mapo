; ModuleID = '/home/LiuS/LS-CAT-HIP/data/hip_kernels/6426/56/unpackSourceKernelF32C1.cu'
source_filename = "/home/LiuS/LS-CAT-HIP/data/hip_kernels/6426/56/unpackSourceKernelF32C1.cu"
...
define protected amdgpu_kernel void @_Z23unpackSourceKernelF32C1PfjP13__hip_surfacejj(float addrspace(1)* nocapture writeonly %0, i32 %1, %struct.__hip_surface addrspace(1)* nocapture readonly %2, i32 %3, i32 %4) local_unnamed_addr #0 {
...
54:                                               ; preds = %48, %50
  ...
  store float %59, float addrspace(1)* %63, align 4, !tbaa !16
  br label %64

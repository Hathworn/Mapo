; ModuleID = '../data/hip_kernels/9369/2/main.cu'
source_filename = "../data/hip_kernels/9369/2/main.cu"
...
define protected amdgpu_kernel void @_Z24initancestors_noresamplePii(i32 addrspace(1)* nocapture writeonly %0, i32 %1) local_unnamed_addr #0 {
...
23:                                               ; preds = %8, %23
  %24 = phi i32 [ %6, %8 ], [ %27, %23 ]
  %25 = sext i32 %24 to i64
  %26 = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %25
  store i32 %24, i32 addrspace(1)* %26, align 4, !tbaa !16
  %27 = add i32 %22, %24

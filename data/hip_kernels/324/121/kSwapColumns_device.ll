; ModuleID = '../data/hip_kernels/324/121/main.cu'
source_filename = "../data/hip_kernels/324/121/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z12kSwapColumnsPfS_S_S_iii(float addrspace(1)* nocapture %0, float addrspace(1)* nocapture %1, float addrspace(1)* nocapture readonly %2, float addrspace(1)* nocapture readonly %3, i32 %4, i32 %5, i32 %6) local_unnamed_addr #0 {
...
29:                                               ; preds = %7, %29
  ...
  %40 = mul nsw i32 %39, %6
  %41 = add i32 %40, %35
  %42 = getelementptr inbounds float, float addrspace(1)* %3, i64 %36
  ...
  store float %52, float addrspace(1)* %48, align 4, !tbaa !16
  store float %49, float addrspace(1)* %51, align 4, !tbaa !16
  %53 = add i32 %30, %25
  %54 = icmp ult i32 %53, %26
  br i1 %54, label %29, label %28, !llvm.loop !20
}

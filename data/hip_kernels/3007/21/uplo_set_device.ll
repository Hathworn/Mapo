; ModuleID = '../data/hip_kernels/3007/21/main.cu'
source_filename = "../data/hip_kernels/3007/21/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn writeonly
define protected amdgpu_kernel void @_Z8uplo_setiiifPfii(i32 %0, i32 %1, i32 %2, float %3, float addrspace(1)* nocapture writeonly %4, i32 %5, i32 %6) local_unnamed_addr #0 {
...
28:                                               ; preds = %7
  %29 = icmp eq i32 %1, 132
  %30 = mul nsw i32 %16, %2
  %31 = mul nsw i32 %24, %2
  %32 = icmp sgt i32 %30, %31
  %33 = icmp sge i32 %30, %31
...
35:                                               ; preds = %28
  ...
  store float %3, float addrspace(1)* %40, align 4, !tbaa !7
  br label %41

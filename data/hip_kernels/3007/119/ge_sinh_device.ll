; ModuleID = '../data/hip_kernels/3007/119/main.cu'
source_filename = "../data/hip_kernels/3007/119/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z7ge_sinhiiPKfiiPfii(i32 %0, i32 %1, float addrspace(1)* nocapture readonly %2, i32 %3, i32 %4, float addrspace(1)* nocapture writeonly %5, i32 %6, i32 %7) local_unnamed_addr #0 {
...
29:                                               ; preds = %8
  ...
  %145 = fsub float %104, %143
  %146 = fsub float %104, %145
  %147 = fsub float %146, %143
  %148 = fadd float %105, %147
  ...
  %153 = fcmp olt float %36, 0x3F30000000000000
  %154 = select i1 %153, float %36, float %152
  %155 = tail call float @llvm.copysign.f32(float %154, float %35)
  %156 = add nsw i32 %17, %6
  %157 = mul nsw i32 %25, %7
  %158 = add nsw i32 %156, %157
  %159 = sext i32 %158 to i64
  %160 = getelementptr inbounds float, float addrspace(1)* %5, i64 %159
  store float %155, float addrspace(1)* %160, align 4, !tbaa !7
  br label %161

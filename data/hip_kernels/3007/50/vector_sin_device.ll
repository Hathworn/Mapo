; ModuleID = '../data/hip_kernels/3007/50/main.cu'
source_filename = "../data/hip_kernels/3007/50/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z10vector_siniPKfiiPfii(i32 %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3, float addrspace(1)* nocapture writeonly %4, i32 %5, i32 %6) local_unnamed_addr #0 {
...
140:                                              ; preds = %26, %34
  ...
  %155 = select i1 %154, float %148, float %152
  %156 = bitcast float %155 to i32
  %157 = shl i32 %143, 30
  %158 = and i32 %157, -2147483648
  %159 = bitcast float %23 to i32
  %160 = xor i32 %141, %159
  %161 = xor i32 %160, %158
  %162 = xor i32 %161, %156
  %163 = bitcast i32 %162 to float
  %164 = tail call i1 @llvm.amdgcn.class.f32(float %24, i32 504)
  %165 = select i1 %164, float %163, float 0x7FF8000000000000
  %166 = mul nsw i32 %16, %6

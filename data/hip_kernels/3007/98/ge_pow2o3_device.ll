; ModuleID = '../data/hip_kernels/3007/98/main.cu'
source_filename = "../data/hip_kernels/3007/98/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z9ge_pow2o3iiPKfiiPfii(i32 %0, i32 %1, float addrspace(1)* nocapture readonly %2, i32 %3, i32 %4, float addrspace(1)* nocapture writeonly %5, i32 %6, i32 %7) local_unnamed_addr #0 {
...
29:                                               ; preds = %8
  ...
  %144 = fmul float %141, 0x3FE5555560000000
  %145 = fneg float %144
  %146 = tail call float @llvm.fma.f32(float %141, float 0x3FE5555560000000, float %145)
  %147 = tail call float @llvm.fma.f32(float %143, float 0x3FE5555560000000, float %146)

; ModuleID = '../data/hip_kernels/3007/116/main.cu'
source_filename = "../data/hip_kernels/3007/116/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z7ge_acosiiPKfiiPfii(i32 %0, i32 %1, float addrspace(1)* nocapture readonly %2, i32 %3, i32 %4, float addrspace(1)* nocapture writeonly %5, i32 %6, i32 %7) local_unnamed_addr #0 {
...
29:                                               ; preds = %8
  ...
  %38 = fmul float %35, %35
  %39 = fcmp ogt float %36, 5.000000e-01
  ...
  %51 = fcmp olt float %35, 0.000000e+00
  %52 = select i1 %51, float %50, float %49
  %53 = tail call float @llvm.fmuladd.f32(float %35, float %46, float %35)
  %54 = fsub float 0x3FF921FB60000000, %53
  %55 = select i1 %39, float %52, float %54
  %56 = add nsw i32 %17, %6
  %57 = mul nsw i32 %25, %7
  %58 = add nsw i32 %56, %57
  %59 = sext i32 %58 to i64
  %60 = getelementptr inbounds float, float addrspace(1)* %5, i64 %59
  store float %55, float addrspace(1)* %60, align 4, !tbaa !7
  br label %61

; ModuleID = '../data/hip_kernels/3007/163/main.cu'
source_filename = "../data/hip_kernels/3007/163/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z10uplo_hypotiiiPKfiiS0_iiPfii(i32 %0, i32 %1, i32 %2, float addrspace(1)* nocapture readonly %3, i32 %4, i32 %5, float addrspace(1)* nocapture readonly %6, i32 %7, i32 %8, float addrspace(1)* nocapture writeonly %9, i32 %10, i32 %11) local_unnamed_addr #0 {
...
40:                                               ; preds = %33
  ...
  %55 = tail call float @llvm.maxnum.f32(float %53, float %54)
  %56 = tail call i32 @llvm.amdgcn.frexp.exp.i32.f32(float %55)
  %57 = sub nsw i32 0, %56
  %58 = tail call float @llvm.amdgcn.ldexp.f32(float %53, i32 %57)
  %59 = tail call float @llvm.amdgcn.ldexp.f32(float %54, i32 %57)
  %60 = fmul float %59, %59
  %61 = tail call float @llvm.fmuladd.f32(float %58, float %58, float %60)
  %62 = tail call float @llvm.sqrt.f32(float %61)
  %63 = tail call float @llvm.amdgcn.ldexp.f32(float %62, i32 %56)
  %64 = tail call float @llvm.fabs.f32(float %55) #3
  %65 = fcmp oeq float %64, 0x7FF0000000000000
  %66 = select i1 %65, float 0x7FF0000000000000, float %63
  %67 = add nsw i32 %21, %10
  %68 = mul nsw i32 %29, %11
  %69 = add nsw i32 %67, %68
  %70 = sext i32 %69 to i64
  %71 = getelementptr inbounds float, float addrspace(1)* %9, i64 %70
  store float %66, float addrspace(1)* %71, align 4, !tbaa !7
  br label %72

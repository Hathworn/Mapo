; ModuleID = '../data/hip_kernels/3007/162/main.cu'
source_filename = "../data/hip_kernels/3007/162/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z9uplo_powxiiiPKfiifPfii(i32 %0, i32 %1, i32 %2, float addrspace(1)* nocapture readonly %3, i32 %4, i32 %5, float %6, float addrspace(1)* nocapture writeonly %7, i32 %8, i32 %9) local_unnamed_addr #0 {
...
38:                                               ; preds = %31
  ...
  %153 = fmul float %150, %6
  %154 = fneg float %153
  %155 = tail call float @llvm.fma.f32(float %6, float %150, float %154)
  %156 = tail call float @llvm.fma.f32(float %6, float %152, float %155)
  ...
  %188 = tail call float @llvm.fabs.f32(float %6)
...
219:                                              ; preds = %38, %210
  %220 = phi float [ %208, %38 ], [ %218, %210 ]
  %221 = fcmp oeq float %45, 0x7FF0000000000000
  %222 = fcmp oeq float %44, 0.000000e+00
  %223 = or i1 %222, %221
  %224 = fcmp olt float %6, 0.000000e+00
  %225 = xor i1 %224, %222
  %226 = select i1 %225, float 0.000000e+00, float 0x7FF0000000000000
  %227 = select i1 %200, float %44, float 0.000000e+00
  %228 = tail call float @llvm.copysign.f32(float %226, float %227)
  %229 = select i1 %223, float %228, float %220
  %230 = fcmp uno float %44, %6
  %231 = select i1 %230, float 0x7FF8000000000000, float %229
  %232 = fcmp oeq float %44, 1.000000e+00
  %233 = fcmp oeq float %6, 0.000000e+00
  %234 = or i1 %233, %232
  %235 = select i1 %234, float 1.000000e+00, float %231
  %236 = add nsw i32 %19, %8
  %237 = mul nsw i32 %27, %9
  %238 = add nsw i32 %236, %237
  %239 = sext i32 %238 to i64
  %240 = getelementptr inbounds float, float addrspace(1)* %7, i64 %239

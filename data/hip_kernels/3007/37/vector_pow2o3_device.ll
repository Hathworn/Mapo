; ModuleID = '../data/hip_kernels/3007/37/main.cu'
source_filename = "../data/hip_kernels/3007/37/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z13vector_pow2o3iPKfiiPfii(i32 %0, float addrspace(1)* nocapture readonly %1, i32 %2, i32 %3, float addrspace(1)* nocapture writeonly %4, i32 %5, i32 %6) local_unnamed_addr #0 {
...
18:                                               ; preds = %7
  ...
  %132 = fmul float %129, 0x3FE5555560000000
  %133 = fneg float %132
  %134 = tail call float @llvm.fma.f32(float %129, float 0x3FE5555560000000, float %133)
  %135 = tail call float @llvm.fma.f32(float %131, float 0x3FE5555560000000, float %134)

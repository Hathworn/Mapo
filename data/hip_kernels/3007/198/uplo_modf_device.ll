; ModuleID = '../data/hip_kernels/3007/198/main.cu'
source_filename = "../data/hip_kernels/3007/198/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z9uplo_modfiiiPKfiiPfiiS1_ii(i32 %0, i32 %1, i32 %2, float addrspace(1)* nocapture readonly %3, i32 %4, i32 %5, float addrspace(1)* nocapture writeonly %6, i32 %7, i32 %8, float addrspace(1)* nocapture writeonly %9, i32 %10, i32 %11) local_unnamed_addr #0 {
...
40:                                               ; preds = %33
  ...
  %52 = tail call float @llvm.trunc.f32(float %46)
  %53 = fsub float %46, %52
  %54 = tail call float @llvm.fabs.f32(float %46) #3
  %55 = fcmp oeq float %54, 0x7FF0000000000000
  %56 = select i1 %55, float 0.000000e+00, float %53
  %57 = tail call float @llvm.copysign.f32(float %56, float %46)
  store float %52, float addrspace(1)* %51, align 4, !tbaa !7
  %58 = add nsw i32 %21, %10
  %59 = mul nsw i32 %29, %11
  %60 = add nsw i32 %58, %59
  %61 = sext i32 %60 to i64
  %62 = getelementptr inbounds float, float addrspace(1)* %9, i64 %61

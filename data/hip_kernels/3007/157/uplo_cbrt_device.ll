; ModuleID = '../data/hip_kernels/3007/157/main.cu'
source_filename = "../data/hip_kernels/3007/157/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z9uplo_cbrtiiiPKfiiPfii(i32 %0, i32 %1, i32 %2, float addrspace(1)* nocapture readonly %3, i32 %4, i32 %5, float addrspace(1)* nocapture writeonly %6, i32 %7, i32 %8) local_unnamed_addr #0 {
...
37:                                               ; preds = %30
  ...
  %49 = fmul float %48, 0x3FD5555560000000
  ...
  %55 = tail call float @llvm.fmuladd.f32(float %54, float 0xBFD5555560000000, float %50)
  %56 = tail call float @llvm.amdgcn.ldexp.f32(float %55, i32 -8)
  %57 = select i1 %45, float %56, float %55
  %58 = tail call i1 @llvm.amdgcn.class.f32(float %43, i32 615)
  %59 = select i1 %58, float %43, float %57

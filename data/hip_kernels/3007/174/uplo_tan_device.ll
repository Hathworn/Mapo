; ModuleID = '../data/hip_kernels/3007/174/main.cu'
source_filename = "../data/hip_kernels/3007/174/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z8uplo_taniiiPKfiiPfii(i32 %0, i32 %1, i32 %2, float addrspace(1)* nocapture readonly %3, i32 %4, i32 %5, float addrspace(1)* nocapture writeonly %6, i32 %7, i32 %8) local_unnamed_addr #0 {
...
160:                                              ; preds = %46, %54
  ...
  %166 = tail call float @llvm.fmuladd.f32(float %165, float 0xBF919DBA60000000, float 0x3FD8A8B0E0000000)
  %167 = tail call float @llvm.fmuladd.f32(float %165, float 0x3F92E29000000000, float 0xBFE07266E0000000)
  %168 = tail call float @llvm.fmuladd.f32(float %165, float %167, float 0x3FF27E84A0000000)
  %169 = tail call float @llvm.amdgcn.rcp.f32(float %168)
  %170 = fmul float %166, %169
  %171 = fmul float %165, %170
  %172 = tail call float @llvm.fma.f32(float %171, float %162, float %162)
  %173 = fsub float %172, %162
  %174 = fneg float %173
  %175 = tail call float @llvm.fma.f32(float %171, float %162, float %174)
  %176 = tail call float @llvm.amdgcn.rcp.f32(float %172)
  %177 = fneg float %176
  %178 = tail call float @llvm.fma.f32(float %172, float %177, float 1.000000e+00)
  %179 = tail call float @llvm.fma.f32(float %175, float %177, float %178)
  %180 = tail call float @llvm.fma.f32(float %179, float %177, float %177)
  %181 = icmp eq i32 %164, 0
  %182 = select i1 %181, float %172, float %180
  %183 = bitcast float %182 to i32
  %184 = bitcast float %43 to i32
  %185 = xor i32 %161, %184
  %186 = xor i32 %185, %183
  %187 = bitcast i32 %186 to float
  %188 = tail call i1 @llvm.amdgcn.class.f32(float %44, i32 504)
  %189 = select i1 %188, float %187, float 0x7FF8000000000000
  %190 = add nsw i32 %18, %7
  %191 = mul nsw i32 %26, %8

; ModuleID = '../data/hip_kernels/3007/102/main.cu'
source_filename = "../data/hip_kernels/3007/102/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z8ge_hypotiiPKfiiS0_iiPfii(i32 %0, i32 %1, float addrspace(1)* nocapture readonly %2, i32 %3, i32 %4, float addrspace(1)* nocapture readonly %5, i32 %6, i32 %7, float addrspace(1)* nocapture writeonly %8, i32 %9, i32 %10) local_unnamed_addr #0 {
...
32:                                               ; preds = %11
  ...
  %47 = tail call float @llvm.maxnum.f32(float %45, float %46)
  %48 = tail call i32 @llvm.amdgcn.frexp.exp.i32.f32(float %47)
  %49 = sub nsw i32 0, %48
  %50 = tail call float @llvm.amdgcn.ldexp.f32(float %45, i32 %49)
  %51 = tail call float @llvm.amdgcn.ldexp.f32(float %46, i32 %49)
  %52 = fmul float %51, %51
  %53 = tail call float @llvm.fmuladd.f32(float %50, float %50, float %52)
  %54 = tail call float @llvm.sqrt.f32(float %53)
  %55 = tail call float @llvm.amdgcn.ldexp.f32(float %54, i32 %48)
  %56 = tail call float @llvm.fabs.f32(float %47) #3
  %57 = fcmp oeq float %56, 0x7FF0000000000000
  %58 = select i1 %57, float 0x7FF0000000000000, float %55
  %59 = add nsw i32 %20, %9
  %60 = mul nsw i32 %28, %10
  %61 = add nsw i32 %59, %60
  %62 = sext i32 %61 to i64
  %63 = getelementptr inbounds float, float addrspace(1)* %8, i64 %62
  store float %58, float addrspace(1)* %63, align 4, !tbaa !7
  br label %64

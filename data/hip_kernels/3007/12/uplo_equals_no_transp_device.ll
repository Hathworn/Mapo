; ModuleID = '../data/hip_kernels/3007/12/main.cu'
source_filename = "../data/hip_kernels/3007/12/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z21uplo_equals_no_transpiiiPKfiiS0_iiPi(i32 %0, i32 %1, i32 %2, float addrspace(1)* nocapture readonly %3, i32 %4, i32 %5, float addrspace(1)* nocapture readonly %6, i32 %7, i32 %8, i32 addrspace(1)* nocapture %9) local_unnamed_addr #0 {
...
38:                                               ; preds = %31
  ...
  %51 = fcmp contract une float %47, %50
  br i1 %51, label %52, label %55

52:                                               ; preds = %38
  %53 = load i32, i32 addrspace(1)* %9, align 4, !tbaa !11, !amdgpu.noclobber !5
  %54 = add nsw i32 %53, 1
  store i32 %54, i32 addrspace(1)* %9, align 4, !tbaa !11
  br label %55

55:                                               ; preds = %10, %38, %52, %31
  ret void
}

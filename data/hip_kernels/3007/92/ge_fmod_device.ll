; ModuleID = '../data/hip_kernels/3007/92/main.cu'
source_filename = "../data/hip_kernels/3007/92/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z7ge_fmodiiPKfiiS0_iiPfii(i32 %0, i32 %1, float addrspace(1)* nocapture readonly %2, i32 %3, i32 %4, float addrspace(1)* nocapture readonly %5, i32 %6, i32 %7, float addrspace(1)* nocapture writeonly %8, i32 %9, i32 %10) local_unnamed_addr #0 {
...
72:                                               ; preds = %59, %48
  ...
  %83 = fadd float %80, %82
  %84 = tail call float @llvm.amdgcn.ldexp.f32(float %83, i32 %53)
  %85 = bitcast float %38 to i32
...
90:                                               ; preds = %32
  %91 = fcmp oeq float %45, %46
  %92 = tail call float @llvm.copysign.f32(float 0.000000e+00, float %38)
  %93 = select i1 %91, float %92, float %38
  br label %94

94:                                               ; preds = %72, %90
  %95 = phi float [ %89, %72 ], [ %93, %90 ]
  %96 = fcmp oeq float %44, 0.000000e+00
  %97 = select i1 %96, float 0x7FF8000000000000, float %95
  %98 = fcmp ord float %44, 0.000000e+00
  %99 = tail call i1 @llvm.amdgcn.class.f32(float %38, i32 504)
  %100 = select i1 %98, i1 %99, i1 false
  %101 = select i1 %100, float %97, float 0x7FF8000000000000
  %102 = add nsw i32 %20, %9
  %103 = mul nsw i32 %28, %10
  %104 = add nsw i32 %102, %103
  %105 = sext i32 %104 to i64
  %106 = getelementptr inbounds float, float addrspace(1)* %8, i64 %105
  store float %101, float addrspace(1)* %106, align 4, !tbaa !7
  br label %107

; ModuleID = '../data/hip_kernels/3007/170/main.cu'
source_filename = "../data/hip_kernels/3007/170/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z10uplo_log10iiiPKfiiPfii(i32 %0, i32 %1, i32 %2, float addrspace(1)* nocapture readonly %3, i32 %4, i32 %5, float addrspace(1)* nocapture writeonly %6, i32 %7, i32 %8) local_unnamed_addr #0 {
...
37:                                               ; preds = %30
  ...
  %50 = fneg float %48
  %51 = tail call float @llvm.fma.f32(float %47, float 0x3FD3441340000000, float %50)
  %52 = tail call float @llvm.fma.f32(float %47, float 0x3E509F79E0000000, float %51)
  %53 = fadd float %48, %52
  %54 = select i1 %49, float %47, float %53
  %55 = select i1 %44, float 0x4023441360000000, float 0.000000e+00
  %56 = fsub float %54, %55
  %57 = add nsw i32 %18, %7
  %58 = mul nsw i32 %26, %8
  ...
  store float %56, float addrspace(1)* %61, align 4, !tbaa !7
  br label %62

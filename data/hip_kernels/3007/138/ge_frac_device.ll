; ModuleID = '../data/hip_kernels/3007/138/main.cu'
source_filename = "../data/hip_kernels/3007/138/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn
define protected amdgpu_kernel void @_Z7ge_fraciiPKfiiPfii(i32 %0, i32 %1, float addrspace(1)* nocapture readonly %2, i32 %3, i32 %4, float addrspace(1)* nocapture writeonly %5, i32 %6, i32 %7) local_unnamed_addr #0 {
...
29:                                               ; preds = %8
  ...
  %36 = tail call float @llvm.trunc.f32(float %35)
  %37 = fsub float %35, %36
  %38 = tail call float @llvm.fabs.f32(float %35) #3
  %39 = fcmp oeq float %38, 0x7FF0000000000000
  %40 = select i1 %39, float 0.000000e+00, float %37
  %41 = tail call float @llvm.copysign.f32(float %40, float %35)
  %42 = add nsw i32 %17, %6
  %43 = mul nsw i32 %25, %7

; ModuleID = '../data/hip_kernels/2758/99/main.cu'
source_filename = "../data/hip_kernels/2758/99/main.cu"
target datalayout = "e-p:64:64-p1:64:64-p2:32:32-p3:32:32-p4:64:64-p5:32:32-p6:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024-v2048:2048-n32:64-S32-A5-G1-ni:7"
target triple = "amdgcn-amd-amdhsa"

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind
define protected amdgpu_kernel void @_Z28forward_maxpool_layer_kerneliiiiiiiiPfS_Pi(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, float addrspace(1)* nocapture readonly %8, float addrspace(1)* nocapture writeonly %9, i32 addrspace(1)* nocapture writeonly %10) local_unnamed_addr #0 {
  %12 = sub i32 %1, %6
  %13 = add i32 %12, %7
  %14 = sdiv i32 %13, %5
  %15 = add nsw i32 %14, 1
...
187:                                              ; preds = %182, %41
  ...
  %192 = getelementptr inbounds i32, i32 addrspace(1)* %10, i64 %190
  store i32 %188, i32 addrspace(1)* %192, align 4, !tbaa !25
  br label %193
